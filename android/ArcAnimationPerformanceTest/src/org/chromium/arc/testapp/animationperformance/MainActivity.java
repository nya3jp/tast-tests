...
public class MainActivity extends Activity {
    ...
    private static final int ANIMATION_START_DELAY_MS = 100;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Needs to wait some time for transition listener to work properly
        // with beginDelayedTransition()
        handler.postDelayed(shuffle, ANIMATION_START_DELAY_MS);
