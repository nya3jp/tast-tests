 ...
 *   added way to display Orientation
...
public class AccelerometerPlayActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mSimulationView.addView(textView);
    }
    ...
    protected void onPause() {
        super.onPause();
        /*
         * When the activity is paused, we make sure to stop the simulation and
    ...
    class SimulationView extends FrameLayout implements SensorEventListener {
        ...
        final private float mXDpi;
        final private float mYDpi;
        final private float mMetersToPixelsX;
        final private float mMetersToPixelsY;
        ...
        class ParticleSystem {
            ...
            final private Particle mBalls[] = new Particle[NUM_PARTICLES];
