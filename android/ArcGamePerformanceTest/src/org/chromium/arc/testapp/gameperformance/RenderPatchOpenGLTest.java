...
public abstract class RenderPatchOpenGLTest extends OpenGLTest {
    ...
    public RenderPatchOpenGLTest(GamePerformanceActivity activity) {
        super(activity);
    }

    protected void setRenderPatches(List<RenderPatchAnimation> renderPatches) {
    ...
    public void draw(GL gl) {
        ...
        for (final RenderPatchAnimation renderPatchAnimation : mRenderPatches) {
            ...
            GLES20.glUniformMatrix4fv(
                    mMVPMatrixHandle, 1, false, renderPatchAnimation.getTransform(mVPMatrix), 0);
