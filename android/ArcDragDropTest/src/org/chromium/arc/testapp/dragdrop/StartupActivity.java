 ...
 *
 * DragDropActivity needs to be launched in the specific position and the size, because autotest
 * plays recorded mouse events which perform the drag and drop operation at the specific position
 * in the screen.
 *
 ...
 *
 * @see <a href="https://chromium.googlesource.com/chromiumos/third_party/autotest/+/master/client/cros/input_playback/README">autotest input_playback</a>
 */
