...
// getMinidumpPaths returns paths of all minidump files on the system.
func getMinidumpPaths() ([]string, error) {
	all := make([]string, 0)
...
func main() {
	...
	if *report {
		...
		if oldMinidumps, err = getMinidumpPaths(); err != nil {
