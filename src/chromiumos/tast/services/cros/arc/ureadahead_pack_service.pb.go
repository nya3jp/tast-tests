...
type UreadaheadPackServiceClient interface {
	...
	CheckMinMemory(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*CheckMinMemoryResponse, error)
}
...
func (c *ureadaheadPackServiceClient) CheckMinMemory(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*CheckMinMemoryResponse, error) {
...
type UreadaheadPackServiceServer interface {
	...
	// CheckMinMemory verifies total memory meets minimum requirement to generate ureadahead pack.
	CheckMinMemory(context.Context, *empty.Empty) (*CheckMinMemoryResponse, error)
}
...
func (*UnimplementedUreadaheadPackServiceServer) CheckMinMemory(context.Context, *empty.Empty) (*CheckMinMemoryResponse, error) {
...
func _UreadaheadPackService_CheckMinMemory_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UreadaheadPackServiceServer).CheckMinMemory(ctx, req.(*empty.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
