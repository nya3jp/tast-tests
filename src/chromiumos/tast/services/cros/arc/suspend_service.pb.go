...
type GetDateOutputsResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *GetDateOutputsResponse) Reset() {
	*x = GetDateOutputsResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *GetDateOutputsResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetDateOutputsResponse) ProtoMessage() {}

func (x *GetDateOutputsResponse) ProtoReflect() protoreflect.Message {
	mi := &file_suspend_service_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetDateOutputsResponse.ProtoReflect.Descriptor instead.
func (*GetDateOutputsResponse) Descriptor() ([]byte, []int) {
	return file_suspend_service_proto_rawDescGZIP(), []int{2}
}

func (x *GetDateOutputsResponse) GetHost() string {
	if x != nil {
		return x.Host
	}
	return ""
...
func (x *GetDateOutputsResponse) GetArc() string {
	if x != nil {
		return x.Arc
	}
	return ""
...
func (x *SuspendServiceParams) Reset() {
	*x = SuspendServiceParams{}
	if protoimpl.UnsafeEnabled {
		mi := &file_suspend_service_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*SuspendServiceParams) Descriptor() ([]byte, []int) {
	return file_suspend_service_proto_rawDescGZIP(), []int{3}
}
...
var file_suspend_service_proto_rawDesc = []byte{
	...
	0x63, 0x22, 0x3e, 0x0a, 0x16, 0x47, 0x65, 0x74, 0x44, 0x61, 0x74, 0x65, 0x4f, 0x75, 0x74, 0x70,
	0x75, 0x74, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x12, 0x0a, 0x04, 0x68,
	0x6f, 0x73, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x68, 0x6f, 0x73, 0x74, 0x12,
	0x10, 0x0a, 0x03, 0x61, 0x72, 0x63, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x61, 0x72,
	...
	0x9a, 0x02, 0x0a, 0x0e, 0x53, 0x75, 0x73, 0x70, 0x65, 0x6e, 0x64, 0x53, 0x65, 0x72, 0x76, 0x69,
	...
	0x65, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x5e, 0x0a, 0x0e,
	0x47, 0x65, 0x74, 0x44, 0x61, 0x74, 0x65, 0x4f, 0x75, 0x74, 0x70, 0x75, 0x74, 0x73, 0x12, 0x23,
	0x2e, 0x74, 0x61, 0x73, 0x74, 0x2e, 0x63, 0x72, 0x6f, 0x73, 0x2e, 0x61, 0x72, 0x63, 0x2e, 0x53,
	0x75, 0x73, 0x70, 0x65, 0x6e, 0x64, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x50, 0x61, 0x72,
	0x61, 0x6d, 0x73, 0x1a, 0x25, 0x2e, 0x74, 0x61, 0x73, 0x74, 0x2e, 0x63, 0x72, 0x6f, 0x73, 0x2e,
	0x61, 0x72, 0x63, 0x2e, 0x47, 0x65, 0x74, 0x44, 0x61, 0x74, 0x65, 0x4f, 0x75, 0x74, 0x70, 0x75,
	0x74, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x42, 0x23, 0x5a, 0x21,
...
var file_suspend_service_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_suspend_service_proto_goTypes = []interface{}{
	...
	(*GetDateOutputsResponse)(nil), // 2: tast.cros.arc.GetDateOutputsResponse
	(*SuspendServiceParams)(nil),   // 3: tast.cros.arc.SuspendServiceParams
	(*duration.Duration)(nil),      // 4: google.protobuf.Duration
	(*empty.Empty)(nil),            // 5: google.protobuf.Empty
}
var file_suspend_service_proto_depIdxs = []int32{
	4, // 0: tast.cros.arc.ClockValues.clock_monotonic:type_name -> google.protobuf.Duration
	4, // 1: tast.cros.arc.ClockValues.clock_boottime:type_name -> google.protobuf.Duration
	...
	5, // 4: tast.cros.arc.SuspendService.Prepare:input_type -> google.protobuf.Empty
	3, // 5: tast.cros.arc.SuspendService.GetClockValues:input_type -> tast.cros.arc.SuspendServiceParams
	3, // 6: tast.cros.arc.SuspendService.GetDateOutputs:input_type -> tast.cros.arc.SuspendServiceParams
	3, // 7: tast.cros.arc.SuspendService.Prepare:output_type -> tast.cros.arc.SuspendServiceParams
	1, // 8: tast.cros.arc.SuspendService.GetClockValues:output_type -> tast.cros.arc.GetClockValuesResponse
	2, // 9: tast.cros.arc.SuspendService.GetDateOutputs:output_type -> tast.cros.arc.GetDateOutputsResponse
...
func file_suspend_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_suspend_service_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetDateOutputsResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_suspend_service_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
...
type SuspendServiceClient interface {
	...
	GetDateOutputs(ctx context.Context, in *SuspendServiceParams, opts ...grpc.CallOption) (*GetDateOutputsResponse, error)
}
...
func (c *suspendServiceClient) GetDateOutputs(ctx context.Context, in *SuspendServiceParams, opts ...grpc.CallOption) (*GetDateOutputsResponse, error) {
	out := new(GetDateOutputsResponse)
	err := c.cc.Invoke(ctx, "/tast.cros.arc.SuspendService/GetDateOutputs", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type SuspendServiceServer interface {
	...
	GetDateOutputs(context.Context, *SuspendServiceParams) (*GetDateOutputsResponse, error)
}
...
func (*UnimplementedSuspendServiceServer) GetDateOutputs(context.Context, *SuspendServiceParams) (*GetDateOutputsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetDateOutputs not implemented")
}
...
func _SuspendService_GetDateOutputs_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SuspendServiceParams)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SuspendServiceServer).GetDateOutputs(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tast.cros.arc.SuspendService/GetDateOutputs",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SuspendServiceServer).GetDateOutputs(ctx, req.(*SuspendServiceParams))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _SuspendService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetDateOutputs",
			Handler:    _SuspendService_GetDateOutputs_Handler,
		},
	},
