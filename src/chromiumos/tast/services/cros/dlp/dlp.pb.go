...
const (
	Mode_Block       Mode = 0
	Mode_Report      Mode = 1
	Mode_WarnCancel  Mode = 2
	Mode_WarnProceed Mode = 3
	Mode_Allow       Mode = 4
)
...
type ClipboardCopyPasteRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	Mode        Mode        `protobuf:"varint,2,opt,name=mode,proto3,enum=tast.cros.dlp.Mode" json:"mode,omitempty"`
}

func (x *ClipboardCopyPasteRequest) Reset() {
	*x = ClipboardCopyPasteRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *ClipboardCopyPasteRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ClipboardCopyPasteRequest) ProtoMessage() {}

func (x *ClipboardCopyPasteRequest) ProtoReflect() protoreflect.Message {
	mi := &file_dlp_dlp_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ClipboardCopyPasteRequest.ProtoReflect.Descriptor instead.
func (*ClipboardCopyPasteRequest) Descriptor() ([]byte, []int) {
	return file_dlp_dlp_proto_rawDescGZIP(), []int{1}
}

func (x *ClipboardCopyPasteRequest) GetBrowserType() BrowserType {
	if x != nil {
...
func (x *ClipboardCopyPasteRequest) GetMode() Mode {
	if x != nil {
		return x.Mode
	}
	return Mode_Block
...
var file_dlp_dlp_proto_rawDesc = []byte{
	...
	0x65, 0x6d, 0x70, 0x74, 0x79, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xcf, 0x01, 0x0a, 0x15,
	...
	,
	...
	0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2f, 0x63, 0x72, 0x6f, 0x73, 0x2f, 0x64, 0x6c,
...
var file_dlp_dlp_proto_goTypes = []interface{}{
	...
	(*ClipboardCopyPasteRequest)(nil), // 3: tast.cros.dlp.ClipboardCopyPasteRequest
	(*emptypb.Empty)(nil),             // 4: google.protobuf.Empty
}
var file_dlp_dlp_proto_depIdxs = []int32{
	0, // 0: tast.cros.dlp.ClipboardCopyPasteRequest.browser_type:type_name -> tast.cros.dlp.BrowserType
	1, // 1: tast.cros.dlp.ClipboardCopyPasteRequest.mode:type_name -> tast.cros.dlp.Mode
	2, // 2: tast.cros.dlp.DataLeakPreventionService.EnrollAndLogin:input_type -> tast.cros.dlp.EnrollAndLoginRequest
	3, // 3: tast.cros.dlp.DataLeakPreventionService.ClipboardCopyPaste:input_type -> tast.cros.dlp.ClipboardCopyPasteRequest
	4, // 4: tast.cros.dlp.DataLeakPreventionService.EnrollAndLogin:output_type -> google.protobuf.Empty
	4, // 5: tast.cros.dlp.DataLeakPreventionService.ClipboardCopyPaste:output_type -> google.protobuf.Empty
...
func file_dlp_dlp_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_dlp_dlp_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ClipboardCopyPasteRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
...
type DataLeakPreventionServiceClient interface {
	...
	ClipboardCopyPaste(ctx context.Context, in *ClipboardCopyPasteRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
}
...
func (c *dataLeakPreventionServiceClient) ClipboardCopyPaste(ctx context.Context, in *ClipboardCopyPasteRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
...
type DataLeakPreventionServiceServer interface {
	...
	ClipboardCopyPaste(context.Context, *ClipboardCopyPasteRequest) (*emptypb.Empty, error)
}
...
func (*UnimplementedDataLeakPreventionServiceServer) ClipboardCopyPaste(context.Context, *ClipboardCopyPasteRequest) (*emptypb.Empty, error) {
...
func _DataLeakPreventionService_ClipboardCopyPaste_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ClipboardCopyPasteRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DataLeakPreventionServiceServer).ClipboardCopyPaste(ctx, req.(*ClipboardCopyPasteRequest))
	}
	return interceptor(ctx, in, info, handler)
}
