...
func (x *DimMetrics) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DimMetrics) ProtoMessage() {}

func (x *DimMetrics) ProtoReflect() protoreflect.Message {
	mi := &file_hps_setting_service_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DimMetrics.ProtoReflect.Descriptor instead.
func (*DimMetrics) Descriptor() ([]byte, []int) {
	return file_hps_setting_service_proto_rawDescGZIP(), []int{1}
}

func (x *DimMetrics) GetDimDelay() *duration.Duration {
	if x != nil {
		return x.DimDelay
	}
	return nil
...
func (x *DimMetrics) GetScreenOffDelay() *duration.Duration {
	if x != nil {
...
func (x *DimMetrics) GetLockDelay() *duration.Duration {
	if x != nil {
		return x.LockDelay
	}
	return nil
...
var file_hps_setting_service_proto_rawDesc = []byte{
	...
	0x08, 0x52, 0x06, 0x65, 0x6e, 0x61, 0x62, 0x6c, 0x65, 0x22, 0xbf, 0x01, 0x0a, 0x0a, 0x44, 0x69,
	0x6d, 0x4d, 0x65, 0x74, 0x72, 0x69, 0x63, 0x73, 0x12, 0x35, 0x0a, 0x08, 0x64, 0x69, 0x6d, 0x44,
	...
	0x52, 0x09, 0x6c, 0x6f, 0x63, 0x6b, 0x44, 0x65, 0x6c, 0x61, 0x79, 0x32, 0xa4, 0x03, 0x0a, 0x0a,
	...
	0x47, 0x65, 0x74, 0x44, 0x65, 0x6c, 0x61, 0x79, 0x73, 0x12, 0x1a, 0x2e, 0x67, 0x6f, 0x6f, 0x67,
	0x6c, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2e, 0x42, 0x6f, 0x6f, 0x6c,
	0x56, 0x61, 0x6c, 0x75, 0x65, 0x1a, 0x19, 0x2e, 0x74, 0x61, 0x73, 0x74, 0x2e, 0x63, 0x72, 0x6f,
	0x73, 0x2e, 0x68, 0x70, 0x73, 0x2e, 0x44, 0x69, 0x6d, 0x4d, 0x65, 0x74, 0x72, 0x69, 0x63, 0x73,
	...
	0x72, 0x6f, 0x73, 0x2f, 0x68, 0x70, 0x73, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
...
var file_hps_setting_service_proto_goTypes = []interface{}{
	...
	(*DimMetrics)(nil),         // 1: tast.cros.hps.DimMetrics
...
var file_hps_setting_service_proto_depIdxs = []int32{
	2, // 0: tast.cros.hps.DimMetrics.dimDelay:type_name -> google.protobuf.Duration
	2, // 1: tast.cros.hps.DimMetrics.screenOffDelay:type_name -> google.protobuf.Duration
	2, // 2: tast.cros.hps.DimMetrics.lockDelay:type_name -> google.protobuf.Duration
	...
	4, // 7: tast.cros.hps.HpsService.GetDelays:input_type -> google.protobuf.BoolValue
	...
	1, // 12: tast.cros.hps.HpsService.GetDelays:output_type -> tast.cros.hps.DimMetrics
...
type HpsServiceClient interface {
	...
	GetDelays(ctx context.Context, in *wrappers.BoolValue, opts ...grpc.CallOption) (*DimMetrics, error)
}
...
func (c *hpsServiceClient) GetDelays(ctx context.Context, in *wrappers.BoolValue, opts ...grpc.CallOption) (*DimMetrics, error) {
	out := new(DimMetrics)
	err := c.cc.Invoke(ctx, "/tast.cros.hps.HpsService/GetDelays", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type HpsServiceServer interface {
	...
	// GetDelays gets the quick dim/lock delays after the lol is enabled/disabled
	GetDelays(context.Context, *wrappers.BoolValue) (*DimMetrics, error)
}
...
func (*UnimplementedHpsServiceServer) GetDelays(context.Context, *wrappers.BoolValue) (*DimMetrics, error) {
...
func _HpsService_GetDelays_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(wrappers.BoolValue)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(HpsServiceServer).GetDelays(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tast.cros.hps.HpsService/GetDelays",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HpsServiceServer).GetDelays(ctx, req.(*wrappers.BoolValue))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _HpsService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _HpsService_GetDelays_Handler,
		},
	},
