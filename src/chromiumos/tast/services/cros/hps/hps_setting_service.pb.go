...
type NewHpsSettingRequest struct {
...
func (x *NewHpsSettingRequest) Reset() {
	*x = NewHpsSettingRequest{}
...
func (x *NewHpsSettingRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*NewHpsSettingRequest) ProtoMessage() {}

func (x *NewHpsSettingRequest) ProtoReflect() protoreflect.Message {
	mi := &file_hps_setting_service_proto_msgTypes[0]
...
// Deprecated: Use NewHpsSettingRequest.ProtoReflect.Descriptor instead.
func (*NewHpsSettingRequest) Descriptor() ([]byte, []int) {
	return file_hps_setting_service_proto_rawDescGZIP(), []int{0}
}

func (x *NewHpsSettingRequest) GetSetting() string {
	if x != nil {
		return x.Setting
	}
	return ""
...
func (x *NewHpsSettingRequest) GetEnable() bool {
	if x != nil {
		return x.Enable
	}
	return false
...
var file_hps_setting_service_proto_rawDesc = []byte{
	...
	,
	...
	0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2f, 0x63, 0x72, 0x6f, 0x73, 0x2f, 0x68, 0x70, 0x73, 0x62,
...
var file_hps_setting_service_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_hps_setting_service_proto_goTypes = []interface{}{
	(*NewHpsSettingRequest)(nil), // 0: tast.cros.hps.NewHpsSettingRequest
	(*empty.Empty)(nil),          // 1: google.protobuf.Empty
}
var file_hps_setting_service_proto_depIdxs = []int32{
	0, // 0: tast.cros.hps.HpsService.ChangeSettings:input_type -> tast.cros.hps.NewHpsSettingRequest
	1, // 1: tast.cros.hps.HpsService.WaitForDbus:input_type -> google.protobuf.Empty
	1, // 2: tast.cros.hps.HpsService.CheckForLockScreen:input_type -> google.protobuf.Empty
	1, // 3: tast.cros.hps.HpsService.ChangeSettings:output_type -> google.protobuf.Empty
	1, // 4: tast.cros.hps.HpsService.WaitForDbus:output_type -> google.protobuf.Empty
	1, // 5: tast.cros.hps.HpsService.CheckForLockScreen:output_type -> google.protobuf.Empty
...
func file_hps_setting_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_hps_setting_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*NewHpsSettingRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
...
type HpsServiceClient interface {
	// New HpsRequest
	ChangeSettings(ctx context.Context, in *NewHpsSettingRequest, opts ...grpc.CallOption) (*empty.Empty, error)
...
func (c *hpsServiceClient) ChangeSettings(ctx context.Context, in *NewHpsSettingRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
	err := c.cc.Invoke(ctx, "/tast.cros.hps.HpsService/ChangeSettings", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type HpsServiceServer interface {
	// New HpsRequest
	ChangeSettings(context.Context, *NewHpsSettingRequest) (*empty.Empty, error)
...
func (*UnimplementedHpsServiceServer) ChangeSettings(context.Context, *NewHpsSettingRequest) (*empty.Empty, error) {
...
func _HpsService_ChangeSettings_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(NewHpsSettingRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(HpsServiceServer).ChangeSettings(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tast.cros.hps.HpsService/ChangeSettings",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HpsServiceServer).ChangeSettings(ctx, req.(*NewHpsSettingRequest))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _HpsService_ChangeSettings_Handler,
		},
		{
