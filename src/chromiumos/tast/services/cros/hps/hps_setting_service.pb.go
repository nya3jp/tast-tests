...
func (x *ChangeSettingsRequest) GetSetting() string {
	if x != nil {
		return x.Setting
	}
	return ""
...
func (x *ChangeSettingsRequest) GetEnable() bool {
	if x != nil {
		return x.Enable
	}
	return false
...
var file_hps_setting_service_proto_rawDesc = []byte{
	...
	,
...
var file_hps_setting_service_proto_goTypes = []interface{}{
	(*ChangeSettingsRequest)(nil), // 0: tast.cros.hps.ChangeSettingsRequest
	(*empty.Empty)(nil),           // 1: google.protobuf.Empty
}
var file_hps_setting_service_proto_depIdxs = []int32{
	0, // 0: tast.cros.hps.HpsService.StartUIWithCustomScreenPrivacySetting:input_type -> tast.cros.hps.ChangeSettingsRequest
	...
	1, // 3: tast.cros.hps.HpsService.StartUIWithCustomScreenPrivacySetting:output_type -> google.protobuf.Empty
...
type HpsServiceClient interface {
	// New HpsRequest.
	StartUIWithCustomScreenPrivacySetting(ctx context.Context, in *ChangeSettingsRequest, opts ...grpc.CallOption) (*empty.Empty, error)
...
func (c *hpsServiceClient) StartUIWithCustomScreenPrivacySetting(ctx context.Context, in *ChangeSettingsRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
type HpsServiceServer interface {
	// New HpsRequest.
	StartUIWithCustomScreenPrivacySetting(context.Context, *ChangeSettingsRequest) (*empty.Empty, error)
...
func (*UnimplementedHpsServiceServer) StartUIWithCustomScreenPrivacySetting(context.Context, *ChangeSettingsRequest) (*empty.Empty, error) {
...
func _HpsService_StartUIWithCustomScreenPrivacySetting_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HpsServiceServer).StartUIWithCustomScreenPrivacySetting(ctx, req.(*ChangeSettingsRequest))
	}
