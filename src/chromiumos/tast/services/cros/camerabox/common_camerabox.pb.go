...
func (Facing) Descriptor() protoreflect.EnumDescriptor {
	return file_common_camerabox_proto_enumTypes[0].Descriptor()
}

func (Facing) Type() protoreflect.EnumType {
	return &file_common_camerabox_proto_enumTypes[0]
}
...
func (Facing) EnumDescriptor() ([]byte, []int) {
	return file_common_camerabox_proto_rawDescGZIP(), []int{0}
}
...
func (TestResult) Descriptor() protoreflect.EnumDescriptor {
	return file_common_camerabox_proto_enumTypes[1].Descriptor()
}

func (TestResult) Type() protoreflect.EnumType {
	return &file_common_camerabox_proto_enumTypes[1]
}
...
func (TestResult) EnumDescriptor() ([]byte, []int) {
	return file_common_camerabox_proto_rawDescGZIP(), []int{1}
}

var File_common_camerabox_proto protoreflect.FileDescriptor

var file_common_camerabox_proto_rawDesc = []byte{
	0x0a, 0x16, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x5f, 0x63, 0x61, 0x6d, 0x65, 0x72, 0x61, 0x62,
	0x6f, 0x78, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x13, 0x74, 0x61, 0x73, 0x74, 0x2e, 0x63,
...
var (
	file_common_camerabox_proto_rawDescOnce sync.Once
	file_common_camerabox_proto_rawDescData = file_common_camerabox_proto_rawDesc
)

func file_common_camerabox_proto_rawDescGZIP() []byte {
	file_common_camerabox_proto_rawDescOnce.Do(func() {
		file_common_camerabox_proto_rawDescData = protoimpl.X.CompressGZIP(file_common_camerabox_proto_rawDescData)
	})
	return file_common_camerabox_proto_rawDescData
}

var file_common_camerabox_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
var file_common_camerabox_proto_goTypes = []interface{}{
	(Facing)(0),     // 0: tast.cros.camerabox.Facing
	(TestResult)(0), // 1: tast.cros.camerabox.TestResult
}
var file_common_camerabox_proto_depIdxs = []int32{
...
func init() { file_common_camerabox_proto_init() }
func file_common_camerabox_proto_init() {
	if File_common_camerabox_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_common_camerabox_proto_rawDesc,
			NumEnums:      2,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_common_camerabox_proto_goTypes,
		DependencyIndexes: file_common_camerabox_proto_depIdxs,
		EnumInfos:         file_common_camerabox_proto_enumTypes,
	}.Build()
	File_common_camerabox_proto = out.File
	file_common_camerabox_proto_rawDesc = nil
	file_common_camerabox_proto_goTypes = nil
	file_common_camerabox_proto_depIdxs = nil
}
