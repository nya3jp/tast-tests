...
type ScreenRecorderServiceClient interface {
	...
	// Stop stops and saves the recording to the specified location and
...
func (c *screenRecorderServiceClient) Start(ctx context.Context, in *StartRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
func (c *screenRecorderServiceClient) Stop(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*StopResponse, error) {
...
func _ScreenRecorderService_Stop_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ScreenRecorderServiceServer).Stop(ctx, req.(*empty.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
