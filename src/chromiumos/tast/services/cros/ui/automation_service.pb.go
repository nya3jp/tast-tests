...
type WaitUntilGoneRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *WaitUntilGoneRequest) Reset() {
	*x = WaitUntilGoneRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *WaitUntilGoneRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*WaitUntilGoneRequest) ProtoMessage() {}

func (x *WaitUntilGoneRequest) ProtoReflect() protoreflect.Message {
	mi := &file_automation_service_proto_msgTypes[7]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use WaitUntilGoneRequest.ProtoReflect.Descriptor instead.
func (*WaitUntilGoneRequest) Descriptor() ([]byte, []int) {
	return file_automation_service_proto_rawDescGZIP(), []int{7}
}

func (x *WaitUntilGoneRequest) GetFinder() *Finder {
	if x != nil {
		return x.Finder
	}
	return nil
...
var file_automation_service_proto_rawDesc = []byte{
	...
	0x66, 0x69, 0x6e, 0x64, 0x65, 0x72, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x14, 0x2e, 0x74,
	0x61, 0x73, 0x74, 0x2e, 0x63, 0x72, 0x6f, 0x73, 0x2e, 0x75, 0x69, 0x2e, 0x46, 0x69, 0x6e, 0x64,
	0x65, 0x72, 0x52, 0x06, 0x66, 0x69, 0x6e, 0x64, 0x65, 0x72, 0x22, 0x44, 0x0a, 0x14, 0x57, 0x61,
	0x69, 0x74, 0x55, 0x6e, 0x74, 0x69, 0x6c, 0x47, 0x6f, 0x6e, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65,
	...
	0x66, 0x6f, 0x22, 0xa4, 0x04, 0x0a, 0x08, 0x4e, 0x6f, 0x64, 0x65, 0x49, 0x6e, 0x66, 0x6f, 0x12,
	...
	0x5f, 0x57, 0x49, 0x4e, 0x44, 0x4f, 0x57, 0x10, 0xbd, 0x01, 0x32, 0x84, 0x05, 0x0a, 0x11, 0x41,
	...
	0x22, 0x00, 0x12, 0x4d, 0x0a, 0x0d, 0x57, 0x61, 0x69, 0x74, 0x55, 0x6e, 0x74, 0x69, 0x6c, 0x47,
	0x6f, 0x6e, 0x65, 0x12, 0x22, 0x2e, 0x74, 0x61, 0x73, 0x74, 0x2e, 0x63, 0x72, 0x6f, 0x73, 0x2e,
	0x75, 0x69, 0x2e, 0x57, 0x61, 0x69, 0x74, 0x55, 0x6e, 0x74, 0x69, 0x6c, 0x47, 0x6f, 0x6e, 0x65,
	0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x16, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65,
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x22,
...
var file_automation_service_proto_goTypes = []interface{}{
	...
	(*WaitUntilGoneRequest)(nil),        // 12: tast.cros.ui.WaitUntilGoneRequest
...
var file_automation_service_proto_depIdxs = []int32{
	...
	16, // 1: tast.cros.ui.RightClickRequest.finder:type_name -> tast.cros.ui.Finder
	16, // 2: tast.cros.ui.DoubleClickRequest.finder:type_name -> tast.cros.ui.Finder
	16, // 3: tast.cros.ui.IsNodeFoundRequest.finder:type_name -> tast.cros.ui.Finder
	0,  // 4: tast.cros.ui.MouseClickAtLocationRequest.click_type:type_name -> tast.cros.ui.ClickType
	19, // 5: tast.cros.ui.MouseClickAtLocationRequest.point:type_name -> tast.cros.ui.Point
	16, // 6: tast.cros.ui.WaitUntilExistsRequest.finder:type_name -> tast.cros.ui.Finder
	16, // 7: tast.cros.ui.WaitUntilGoneRequest.finder:type_name -> tast.cros.ui.Finder
	...
	12, // 28: tast.cros.ui.AutomationService.WaitUntilGone:input_type -> tast.cros.ui.WaitUntilGoneRequest
	14, // 29: tast.cros.ui.AutomationService.Info:output_type -> tast.cros.ui.InfoResponse
	23, // 30: tast.cros.ui.AutomationService.LeftClick:output_type -> google.protobuf.Empty
	23, // 31: tast.cros.ui.AutomationService.RightClick:output_type -> google.protobuf.Empty
	23, // 32: tast.cros.ui.AutomationService.DoubleClick:output_type -> google.protobuf.Empty
	9,  // 33: tast.cros.ui.AutomationService.IsNodeFound:output_type -> tast.cros.ui.IsNodeFoundResponse
	23, // 34: tast.cros.ui.AutomationService.MouseClickAtLocation:output_type -> google.protobuf.Empty
	23, // 35: tast.cros.ui.AutomationService.WaitUntilExists:output_type -> google.protobuf.Empty
	23, // 36: tast.cros.ui.AutomationService.WaitUntilGone:output_type -> google.protobuf.Empty
...
func file_automation_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_automation_service_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*WaitUntilGoneRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
...
type AutomationServiceClient interface {
	...
	WaitUntilGone(ctx context.Context, in *WaitUntilGoneRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
}
...
func (c *automationServiceClient) WaitUntilGone(ctx context.Context, in *WaitUntilGoneRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, "/tast.cros.ui.AutomationService/WaitUntilGone", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AutomationServiceServer interface {
	...
	// WaitUntilGone waits until the node found by the input finder is gone.
	WaitUntilGone(context.Context, *WaitUntilGoneRequest) (*emptypb.Empty, error)
}
...
func (*UnimplementedAutomationServiceServer) WaitUntilGone(context.Context, *WaitUntilGoneRequest) (*emptypb.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method WaitUntilGone not implemented")
}
...
func _AutomationService_WaitUntilGone_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(WaitUntilGoneRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AutomationServiceServer).WaitUntilGone(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tast.cros.ui.AutomationService/WaitUntilGone",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AutomationServiceServer).WaitUntilGone(ctx, req.(*WaitUntilGoneRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _AutomationService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "WaitUntilGone",
			Handler:    _AutomationService_WaitUntilGone_Handler,
		},
	},
