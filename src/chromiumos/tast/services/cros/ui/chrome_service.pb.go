...
const (
	LoginMode_UNSPECIFIED LoginMode = 0
	LoginMode_NO_LOGIN    LoginMode = 1 // restart Chrome but don't log in
	LoginMode_FAKE_LOGIN  LoginMode = 2 // fake login with no authentication
	LoginMode_GAIA_LOGIN  LoginMode = 3 // real network-based login using GAIA backend
	LoginMode_GUEST_LOGIN LoginMode = 4 // sign in as ephemeral guest user
)
...
// EvalRequest requests that a piece of javascript be executed and evaluated through tconn.
type EvalRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// Expr is the javascript code to be evaluated.
...
// EvalResponse is the return value of the javascript code executed.
type EvalResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// ResultJson is the return value of the javascript code, encoded as a json object.
...
func (*EvalResponse) Descriptor() ([]byte, []int) {
	return file_chrome_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *NewRequest_Credentials) Reset() {
	*x = NewRequest_Credentials{}
	if protoimpl.UnsafeEnabled {
		mi := &file_chrome_service_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
var file_chrome_service_proto_rawDesc = []byte{
	...
	,
	...
	0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x22, 0x00, 0x12, 0x49, 0x0a, 0x04, 0x45, 0x76, 0x61, 0x6c,
	0x12, 0x1e, 0x2e, 0x74, 0x61, 0x73, 0x74, 0x2e, 0x63, 0x72, 0x6f, 0x73, 0x2e, 0x62, 0x72, 0x6f,
	0x77, 0x73, 0x65, 0x72, 0x2e, 0x45, 0x76, 0x61, 0x6c, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74,
	0x1a, 0x1f, 0x2e, 0x74, 0x61, 0x73, 0x74, 0x2e, 0x63, 0x72, 0x6f, 0x73, 0x2e, 0x62, 0x72, 0x6f,
	0x77, 0x73, 0x65, 0x72, 0x2e, 0x45, 0x76, 0x61, 0x6c, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73,
	0x65, 0x22, 0x00, 0x42, 0x22, 0x5a, 0x20, 0x63, 0x68, 0x72, 0x6f, 0x6d, 0x69, 0x75, 0x6d, 0x6f,
...
var file_chrome_service_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_chrome_service_proto_goTypes = []interface{}{
	...
	(*EvalRequest)(nil),            // 2: tast.cros.browser.EvalRequest
	(*EvalResponse)(nil),           // 3: tast.cros.browser.EvalResponse
	(*NewRequest_Credentials)(nil), // 4: tast.cros.browser.NewRequest.Credentials
...
var file_chrome_service_proto_depIdxs = []int32{
	...
	4, // 1: tast.cros.browser.NewRequest.credentials:type_name -> tast.cros.browser.NewRequest.Credentials
	1, // 2: tast.cros.browser.ChromeService.New:input_type -> tast.cros.browser.NewRequest
	5, // 3: tast.cros.browser.ChromeService.Close:input_type -> google.protobuf.Empty
	2, // 4: tast.cros.browser.ChromeService.Eval:input_type -> tast.cros.browser.EvalRequest
	5, // 5: tast.cros.browser.ChromeService.New:output_type -> google.protobuf.Empty
	5, // 6: tast.cros.browser.ChromeService.Close:output_type -> google.protobuf.Empty
	3, // 7: tast.cros.browser.ChromeService.Eval:output_type -> tast.cros.browser.EvalResponse
...
func file_chrome_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_chrome_service_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
...
type ChromeServiceClient interface {
	...
	// Eval evaluates a javascript expression via tconn.
...
func (c *chromeServiceClient) Eval(ctx context.Context, in *EvalRequest, opts ...grpc.CallOption) (*EvalResponse, error) {
	out := new(EvalResponse)
	err := c.cc.Invoke(ctx, "/tast.cros.browser.ChromeService/Eval", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedChromeServiceServer) Eval(context.Context, *EvalRequest) (*EvalResponse, error) {
...
func _ChromeService_Eval_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(EvalRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ChromeServiceServer).Eval(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tast.cros.browser.ChromeService/Eval",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ChromeServiceServer).Eval(ctx, req.(*EvalRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _ChromeService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "Eval",
			Handler:    _ChromeService_Eval_Handler,
		},
	},
