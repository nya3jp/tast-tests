...
type PowerMenuServiceClient interface {
	...
	// is true. This is used in verifying that in tablet mode, after holding the power button
	// for about one second, the power menu would show up as expected on the screen.
