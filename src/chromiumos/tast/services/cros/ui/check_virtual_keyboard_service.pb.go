...
type CheckVirtualKeyboardServiceClient interface {
	...
	NewChromeLoggedIn(ctx context.Context, in *NewBrowserRequest, opts ...grpc.CallOption) (*empty.Empty, error)
...
func (c *checkVirtualKeyboardServiceClient) NewChromeLoggedIn(ctx context.Context, in *NewBrowserRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
type CheckVirtualKeyboardServiceServer interface {
	// NewChromeLoggedIn Logs into a user session.
	NewChromeLoggedIn(context.Context, *NewBrowserRequest) (*empty.Empty, error)
	// CloseChrome releases the resources obtained by NewChrome.
...
func (*UnimplementedCheckVirtualKeyboardServiceServer) NewChromeLoggedIn(context.Context, *NewBrowserRequest) (*empty.Empty, error) {
