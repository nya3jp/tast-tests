...
var file_audio_service_proto_rawDesc = []byte{
	...
	0x44, 0x65, 0x76, 0x69, 0x63, 0x65, 0x54, 0x79, 0x70, 0x65, 0x32, 0xcf, 0x05, 0x0a, 0x0c, 0x41,
	...
	,
...
var file_audio_service_proto_depIdxs = []int32{
	...
	0, // 7: tast.cros.ui.AudioService.FirstRunningDevice:input_type -> tast.cros.ui.AudioServiceRequest
	...
	2, // 16: tast.cros.ui.AudioService.FirstRunningDevice:output_type -> google.protobuf.Empty
...
type AudioServiceClient interface {
	...
	// FirstRunningDevice will check for audio routing device.
	FirstRunningDevice(ctx context.Context, in *AudioServiceRequest, opts ...grpc.CallOption) (*empty.Empty, error)
...
func (c *audioServiceClient) FirstRunningDevice(ctx context.Context, in *AudioServiceRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
	err := c.cc.Invoke(ctx, "/tast.cros.ui.AudioService/FirstRunningDevice", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AudioServiceServer interface {
	...
	// FirstRunningDevice will check for audio routing device.
	FirstRunningDevice(context.Context, *AudioServiceRequest) (*empty.Empty, error)
	// SetActiveNodeByType will set the provided audio node as Active audio node.
...
func (*UnimplementedAudioServiceServer) FirstRunningDevice(context.Context, *AudioServiceRequest) (*empty.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method FirstRunningDevice not implemented")
}
...
func _AudioService_FirstRunningDevice_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AudioServiceRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AudioServiceServer).FirstRunningDevice(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tast.cros.ui.AudioService/FirstRunningDevice",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AudioServiceServer).FirstRunningDevice(ctx, req.(*AudioServiceRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _AudioService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "FirstRunningDevice",
			Handler:    _AudioService_FirstRunningDevice_Handler,
		},
		{
