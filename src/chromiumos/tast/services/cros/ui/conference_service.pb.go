...
var file_conference_service_proto_rawDesc = []byte{
	...
	0x04, 0x74, 0x69, 0x65, 0x72, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x04, 0x74, 0x69, 0x65,
	0x72, 0x12, 0x1b, 0x0a, 0x09, 0x72, 0x6f, 0x6f, 0x6d, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x18, 0x02,
	0x20, 0x01, 0x28, 0x03, 0x52, 0x08, 0x72, 0x6f, 0x6f, 0x6d, 0x54, 0x79, 0x70, 0x65, 0x12, 0x29,
...
func (c *conferenceServiceClient) RunGoogleMeetScenario(ctx context.Context, in *MeetScenarioRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
...
func (c *conferenceServiceClient) RunZoomScenario(ctx context.Context, in *MeetScenarioRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
...
func (*UnimplementedConferenceServiceServer) RunGoogleMeetScenario(context.Context, *MeetScenarioRequest) (*emptypb.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method RunGoogleMeetScenario not implemented")
}
func (*UnimplementedConferenceServiceServer) RunZoomScenario(context.Context, *MeetScenarioRequest) (*emptypb.Empty, error) {
