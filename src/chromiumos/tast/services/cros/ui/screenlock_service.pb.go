...
type ScreenLockServiceClient interface {
	...
	// would be equivalent to pressing "Search+L" on DUT, and useful for tests
	// that are required to be done at locked screen. For example, in ECTabletMode,
	// DUT is triggered by Lock into the locked screen condition, under which
	// a series of power button actions are tested and verified.
