...
var file_bt_test_service_proto_rawDesc = []byte{
	...
	0x55, 0x6e, 0x70, 0x61, 0x69, 0x72, 0x41, 0x6c, 0x6c, 0x44, 0x65, 0x76, 0x69, 0x63, 0x65, 0x73,
	0x12, 0x16, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62,
	0x75, 0x66, 0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x1a, 0x16, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c,
	0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79,
...
var file_bt_test_service_proto_depIdxs = []int32{
	...
	3, // 5: tast.cros.bluetooth.BTTestService.UnpairAllDevices:input_type -> google.protobuf.Empty
	...
	3, // 11: tast.cros.bluetooth.BTTestService.UnpairAllDevices:output_type -> google.protobuf.Empty
...
type BTTestServiceClient interface {
	...
	UnpairAllDevices(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*emptypb.Empty, error)
...
func (c *bTTestServiceClient) UnpairAllDevices(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, "/tast.cros.bluetooth.BTTestService/UnpairAllDevices", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type BTTestServiceServer interface {
	...
	// UnpairAllDevices removes all bluetooth devices that are paired.
	UnpairAllDevices(context.Context, *emptypb.Empty) (*emptypb.Empty, error)
	// DiscoverDevice confirms that the DUT can discover the provided bluetooth
	// device. Fails if the device is not found or if the discovered matching
	// device's attributes do not match those provided.
...
func (*UnimplementedBTTestServiceServer) UnpairAllDevices(context.Context, *emptypb.Empty) (*emptypb.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UnpairAllDevices not implemented")
}
...
func _BTTestService_UnpairAllDevices_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(emptypb.Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BTTestServiceServer).UnpairAllDevices(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tast.cros.bluetooth.BTTestService/UnpairAllDevices",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BTTestServiceServer).UnpairAllDevices(ctx, req.(*emptypb.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _BTTestService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "UnpairAllDevices",
			Handler:    _BTTestService_UnpairAllDevices_Handler,
		},
		{
