...
func (x *DumpUiTreeRequest) Reset() {
	*x = DumpUiTreeRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *DumpUiTreeRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DumpUiTreeRequest) ProtoMessage() {}

func (x *DumpUiTreeRequest) ProtoReflect() protoreflect.Message {
	mi := &file_bt_test_service_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DumpUiTreeRequest.ProtoReflect.Descriptor instead.
func (*DumpUiTreeRequest) Descriptor() ([]byte, []int) {
	return file_bt_test_service_proto_rawDescGZIP(), []int{3}
}

func (x *DumpUiTreeRequest) GetHasError() bool {
	if x != nil {
		return x.HasError
	}
	return false
...
var file_bt_test_service_proto_rawDesc = []byte{
	...
	0x65, 0x76, 0x69, 0x63, 0x65, 0x22, 0x2f, 0x0a, 0x11, 0x44, 0x75, 0x6d, 0x70, 0x55, 0x69, 0x54,
	0x72, 0x65, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x1a, 0x0a, 0x08, 0x68, 0x61,
	0x73, 0x45, 0x72, 0x72, 0x6f, 0x72, 0x18, 0x02, 0x20, 0x01, 0x28, 0x08, 0x52, 0x08, 0x68, 0x61,
	0x73, 0x45, 0x72, 0x72, 0x6f, 0x72, 0x32, 0xa9, 0x04, 0x0a, 0x0d, 0x42, 0x54, 0x54, 0x65, 0x73,
	...
	0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79,
	0x22, 0x00, 0x12, 0x4e, 0x0a, 0x0a, 0x44, 0x75, 0x6d, 0x70, 0x55, 0x49, 0x54, 0x72, 0x65, 0x65,
	0x12, 0x26, 0x2e, 0x74, 0x61, 0x73, 0x74, 0x2e, 0x63, 0x72, 0x6f, 0x73, 0x2e, 0x62, 0x6c, 0x75,
	0x65, 0x74, 0x6f, 0x6f, 0x74, 0x68, 0x2e, 0x44, 0x75, 0x6d, 0x70, 0x55, 0x69, 0x54, 0x72, 0x65,
	0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x16, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c,
	0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79,
...
var file_bt_test_service_proto_goTypes = []interface{}{
	...
	(*DumpUiTreeRequest)(nil),     // 3: tast.cros.bluetooth.DumpUiTreeRequest
...
var file_bt_test_service_proto_depIdxs = []int32{
	...
	3, // 7: tast.cros.bluetooth.BTTestService.DumpUITree:input_type -> tast.cros.bluetooth.DumpUiTreeRequest
	...
	4, // 14: tast.cros.bluetooth.BTTestService.DumpUITree:output_type -> google.protobuf.Empty
...
func file_bt_test_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_bt_test_service_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*DumpUiTreeRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
...
type BTTestServiceClient interface {
	...
	DumpUITree(ctx context.Context, in *DumpUiTreeRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
}
...
func (c *bTTestServiceClient) DumpUITree(ctx context.Context, in *DumpUiTreeRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
...
type BTTestServiceServer interface {
	...
	// DumpUITree Dumps the current ui tree on error.
	DumpUITree(context.Context, *DumpUiTreeRequest) (*emptypb.Empty, error)
}
...
func (*UnimplementedBTTestServiceServer) DumpUITree(context.Context, *DumpUiTreeRequest) (*emptypb.Empty, error) {
...
func _BTTestService_DumpUITree_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BTTestServiceServer).DumpUITree(ctx, req.(*DumpUiTreeRequest))
	}
	return interceptor(ctx, in, info, handler)
}
