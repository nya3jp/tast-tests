...
type WilcoServiceClient interface {
	...
	TestRoutineCancellation(ctx context.Context, in *ExecuteRoutineRequest, opts ...grpc.CallOption) (*ExecuteRoutineResponse, error)
...
func (c *wilcoServiceClient) TestRoutineCancellation(ctx context.Context, in *ExecuteRoutineRequest, opts ...grpc.CallOption) (*ExecuteRoutineResponse, error) {
	out := new(ExecuteRoutineResponse)
...
type WilcoServiceServer interface {
	...
	TestRoutineCancellation(context.Context, *ExecuteRoutineRequest) (*ExecuteRoutineResponse, error)
...
func (*UnimplementedWilcoServiceServer) TestRoutineCancellation(ctx context.Context, req *ExecuteRoutineRequest) (*ExecuteRoutineResponse, error) {
