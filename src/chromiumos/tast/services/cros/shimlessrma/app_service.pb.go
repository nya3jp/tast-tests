...
type NewShimlessRMARequest struct {
	...
	// ManifestKey provides manifestKey for testing extension.
	ManifestKey string `protobuf:"bytes,1,opt,name=manifestKey,proto3" json:"manifestKey,omitempty"`
	// Reconnect indicates whether it is a re-connect.
	// If yes, then we avoid some operation, like creating empty state file.
...
type WaitForPageToLoadRequest struct {
	...
	// Title provides title of a page.
	Title string `protobuf:"bytes,1,opt,name=title,proto3" json:"title,omitempty"`
	// DurationInSecond provides the waiting periods in seconds.
...
type LeftClickButtonRequest struct {
	...
	// Label provides the label of button.
...
type LeftClickRadioButtonRequest struct {
	...
	// Label provides the label of radio button.
	Label string `protobuf:"bytes,1,opt,name=label,proto3" json:"label,omitempty"`
}
...
var file_app_service_proto_rawDesc = []byte{
	...
	0x6d, 0x6c, 0x65, 0x73, 0x73, 0x72, 0x6d, 0x61, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
