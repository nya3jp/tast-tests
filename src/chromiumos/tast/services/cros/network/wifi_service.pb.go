...
type MonitorSignalType int32

const (
	MonitorSignalType_STOP  MonitorSignalType = 0
	MonitorSignalType_START MonitorSignalType = 1
	MonitorSignalType_READY MonitorSignalType = 2
	MonitorSignalType_DONE  MonitorSignalType = 3
)

var MonitorSignalType_name = map[int32]string{
	0: "STOP",
	1: "START",
	2: "READY",
	3: "DONE",
...
var MonitorSignalType_value = map[string]int32{
	"STOP":  0,
	"START": 1,
	"READY": 2,
	"DONE":  3,
...
func (x MonitorSignalType) String() string {
	return proto.EnumName(MonitorSignalType_name, int32(x))
}

func (MonitorSignalType) EnumDescriptor() ([]byte, []int) {
...
type MonitorShillPropertiesRequest struct {
	...
	Signal               MonitorSignalType `protobuf:"varint,2,opt,name=signal,proto3,enum=tast.cros.network.MonitorSignalType" json:"signal,omitempty"`
	XXX_NoUnkeyedLiteral struct{}          `json:"-"`
	XXX_unrecognized     []byte            `json:"-"`
	XXX_sizecache        int32             `json:"-"`
}

func (m *MonitorShillPropertiesRequest) Reset()         { *m = MonitorShillPropertiesRequest{} }
func (m *MonitorShillPropertiesRequest) String() string { return proto.CompactTextString(m) }
func (*MonitorShillPropertiesRequest) ProtoMessage()    {}
func (*MonitorShillPropertiesRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_7d1eecb28f2859f1, []int{0}
}

func (m *MonitorShillPropertiesRequest) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_MonitorShillPropertiesRequest.Unmarshal(m, b)
}
func (m *MonitorShillPropertiesRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_MonitorShillPropertiesRequest.Marshal(b, m, deterministic)
}
func (m *MonitorShillPropertiesRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MonitorShillPropertiesRequest.Merge(m, src)
}
func (m *MonitorShillPropertiesRequest) XXX_Size() int {
	return xxx_messageInfo_MonitorShillPropertiesRequest.Size(m)
}
func (m *MonitorShillPropertiesRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_MonitorShillPropertiesRequest.DiscardUnknown(m)
}

var xxx_messageInfo_MonitorShillPropertiesRequest proto.InternalMessageInfo

func (m *MonitorShillPropertiesRequest) GetObjectPath() string {
	if m != nil {
		return m.ObjectPath
	}
	return ""
...
func (m *MonitorShillPropertiesRequest) GetSignal() MonitorSignalType {
	if m != nil {
		return m.Signal
	}
	return MonitorSignalType_STOP
}

type ListOfShillVals struct {
	Vals                 []*ShillVal `protobuf:"bytes,1,rep,name=vals,proto3" json:"vals,omitempty"`
	XXX_NoUnkeyedLiteral struct{}    `json:"-"`
	XXX_unrecognized     []byte      `json:"-"`
	XXX_sizecache        int32       `json:"-"`
}

func (m *ListOfShillVals) Reset()         { *m = ListOfShillVals{} }
func (m *ListOfShillVals) String() string { return proto.CompactTextString(m) }
func (*ListOfShillVals) ProtoMessage()    {}
func (*ListOfShillVals) Descriptor() ([]byte, []int) {
	return fileDescriptor_7d1eecb28f2859f1, []int{1}
}

func (m *ListOfShillVals) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_ListOfShillVals.Unmarshal(m, b)
}
func (m *ListOfShillVals) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_ListOfShillVals.Marshal(b, m, deterministic)
}
func (m *ListOfShillVals) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ListOfShillVals.Merge(m, src)
}
func (m *ListOfShillVals) XXX_Size() int {
	return xxx_messageInfo_ListOfShillVals.Size(m)
}
func (m *ListOfShillVals) XXX_DiscardUnknown() {
	xxx_messageInfo_ListOfShillVals.DiscardUnknown(m)
}

var xxx_messageInfo_ListOfShillVals proto.InternalMessageInfo

func (m *ListOfShillVals) GetVals() []*ShillVal {
	if m != nil {
		return m.Vals
	}
	return nil
...
type MonitorShillPropertiesResponse struct {
	Props                map[string]*ListOfShillVals `protobuf:"bytes,1,rep,name=props,proto3" json:"props,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	Signal               MonitorSignalType           `protobuf:"varint,2,opt,name=signal,proto3,enum=tast.cros.network.MonitorSignalType" json:"signal,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                    `json:"-"`
	XXX_unrecognized     []byte                      `json:"-"`
	XXX_sizecache        int32                       `json:"-"`
...
func (m *MonitorShillPropertiesResponse) Reset()         { *m = MonitorShillPropertiesResponse{} }
func (m *MonitorShillPropertiesResponse) String() string { return proto.CompactTextString(m) }
func (*MonitorShillPropertiesResponse) ProtoMessage()    {}
func (*MonitorShillPropertiesResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_7d1eecb28f2859f1, []int{2}
}

func (m *MonitorShillPropertiesResponse) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_MonitorShillPropertiesResponse.Unmarshal(m, b)
}
func (m *MonitorShillPropertiesResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_MonitorShillPropertiesResponse.Marshal(b, m, deterministic)
}
func (m *MonitorShillPropertiesResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MonitorShillPropertiesResponse.Merge(m, src)
}
func (m *MonitorShillPropertiesResponse) XXX_Size() int {
	return xxx_messageInfo_MonitorShillPropertiesResponse.Size(m)
}
func (m *MonitorShillPropertiesResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_MonitorShillPropertiesResponse.DiscardUnknown(m)
}

var xxx_messageInfo_MonitorShillPropertiesResponse proto.InternalMessageInfo

func (m *MonitorShillPropertiesResponse) GetProps() map[string]*ListOfShillVals {
	if m != nil {
		return m.Props
	}
	return nil
...
func (m *MonitorShillPropertiesResponse) GetSignal() MonitorSignalType {
	if m != nil {
		return m.Signal
	}
	return MonitorSignalType_STOP
...
func (*QueryServiceResponse_Wifi) Descriptor() ([]byte, []int) {
	return fileDescriptor_7d1eecb28f2859f1, []int{13, 0}
}
...
func (*ProfileBasicTestRequest_Config) Descriptor() ([]byte, []int) {
	return fileDescriptor_7d1eecb28f2859f1, []int{34, 0}
}
...
func init() {
	proto.RegisterEnum("tast.cros.network.MonitorSignalType", MonitorSignalType_name, MonitorSignalType_value)
	...
	proto.RegisterType((*MonitorShillPropertiesRequest)(nil), "tast.cros.network.MonitorShillPropertiesRequest")
	proto.RegisterType((*ListOfShillVals)(nil), "tast.cros.network.ListOfShillVals")
	proto.RegisterType((*MonitorShillPropertiesResponse)(nil), "tast.cros.network.MonitorShillPropertiesResponse")
	proto.RegisterMapType((map[string]*ListOfShillVals)(nil), "tast.cros.network.MonitorShillPropertiesResponse.PropsEntry")
...
var fileDescriptor_7d1eecb28f2859f1 = []byte{
	...
	,
}
...
type WifiServiceClient interface {
	...
	MonitorShillProperties(ctx context.Context, opts ...grpc.CallOption) (WifiService_MonitorShillPropertiesClient, error)
}
...
func (c *wifiServiceClient) MonitorShillProperties(ctx context.Context, opts ...grpc.CallOption) (WifiService_MonitorShillPropertiesClient, error) {
	stream, err := c.cc.NewStream(ctx, &_WifiService_serviceDesc.Streams[1], "/tast.cros.network.WifiService/MonitorShillProperties", opts...)
	if err != nil {
		return nil, err
	}
	x := &wifiServiceMonitorShillPropertiesClient{stream}
	return x, nil
}

type WifiService_MonitorShillPropertiesClient interface {
	Send(*MonitorShillPropertiesRequest) error
	Recv() (*MonitorShillPropertiesResponse, error)
	grpc.ClientStream
}

type wifiServiceMonitorShillPropertiesClient struct {
	grpc.ClientStream
}

func (x *wifiServiceMonitorShillPropertiesClient) Send(m *MonitorShillPropertiesRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *wifiServiceMonitorShillPropertiesClient) Recv() (*MonitorShillPropertiesResponse, error) {
	m := new(MonitorShillPropertiesResponse)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
type WifiServiceServer interface {
	...
	// a map of the properties and their changes when it receive a stop
	// signal by the client.
	MonitorShillProperties(WifiService_MonitorShillPropertiesServer) error
}
...
func (*UnimplementedWifiServiceServer) MonitorShillProperties(srv WifiService_MonitorShillPropertiesServer) error {
	return status.Errorf(codes.Unimplemented, "method MonitorShillProperties not implemented")
}
...
func _WifiService_MonitorShillProperties_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(WifiServiceServer).MonitorShillProperties(&wifiServiceMonitorShillPropertiesServer{stream})
}

type WifiService_MonitorShillPropertiesServer interface {
	Send(*MonitorShillPropertiesResponse) error
	Recv() (*MonitorShillPropertiesRequest, error)
	grpc.ServerStream
}

type wifiServiceMonitorShillPropertiesServer struct {
	grpc.ServerStream
}

func (x *wifiServiceMonitorShillPropertiesServer) Send(m *MonitorShillPropertiesResponse) error {
	return x.ServerStream.SendMsg(m)
}

func (x *wifiServiceMonitorShillPropertiesServer) Recv() (*MonitorShillPropertiesRequest, error) {
	m := new(MonitorShillPropertiesRequest)
...
var _WifiService_serviceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "MonitorShillProperties",
			Handler:       _WifiService_MonitorShillProperties_Handler,
			ServerStreams: true,
			ClientStreams: true,
		},
	},
