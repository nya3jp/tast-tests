...
type ExpectWifiFrequencyRequest struct {
	Ssid string `protobuf:"bytes,1,opt,name=ssid,proto3" json:"ssid,omitempty"`
	// Expected frequency used to connect to the SSID.
	ActiveFrequency uint32 `protobuf:"varint,2,opt,name=active_frequency,json=activeFrequency,proto3" json:"active_frequency,omitempty"`
...
func (m *ExpectWifiFrequencyRequest) GetActiveFrequency() uint32 {
	if m != nil {
		return m.ActiveFrequency
	}
	return 0
}

func (m *ExpectWifiFrequencyRequest) GetFrequencyList() []uint32 {
	if m != nil {
...
var fileDescriptor_7d1eecb28f2859f1 = []byte{
	...
	,
}
