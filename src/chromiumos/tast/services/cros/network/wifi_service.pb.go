...
type ExpectWifiFrequencyRequest struct {
...
func (m *ExpectWifiFrequencyRequest) Reset()         { *m = ExpectWifiFrequencyRequest{} }
func (m *ExpectWifiFrequencyRequest) String() string { return proto.CompactTextString(m) }
func (*ExpectWifiFrequencyRequest) ProtoMessage()    {}
func (*ExpectWifiFrequencyRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_7d1eecb28f2859f1, []int{10}
}

func (m *ExpectWifiFrequencyRequest) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_ExpectWifiFrequencyRequest.Unmarshal(m, b)
}
func (m *ExpectWifiFrequencyRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_ExpectWifiFrequencyRequest.Marshal(b, m, deterministic)
}
func (m *ExpectWifiFrequencyRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ExpectWifiFrequencyRequest.Merge(m, src)
}
func (m *ExpectWifiFrequencyRequest) XXX_Size() int {
	return xxx_messageInfo_ExpectWifiFrequencyRequest.Size(m)
}
func (m *ExpectWifiFrequencyRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_ExpectWifiFrequencyRequest.DiscardUnknown(m)
}

var xxx_messageInfo_ExpectWifiFrequencyRequest proto.InternalMessageInfo

func (m *ExpectWifiFrequencyRequest) GetSsid() string {
	if m != nil {
		return m.Ssid
	}
	return ""
...
func (m *ExpectWifiFrequencyRequest) GetFrequencies() []uint32 {
	if m != nil {
...
func init() {
	...
	proto.RegisterType((*ExpectWifiFrequencyRequest)(nil), "tast.cros.network.ExpectWifiFrequencyRequest")
}
...
var fileDescriptor_7d1eecb28f2859f1 = []byte{
	...
	,
}
...
type WifiServiceClient interface {
	...
	ExpectWifiFrequency(ctx context.Context, in *ExpectWifiFrequencyRequest, opts ...grpc.CallOption) (*empty.Empty, error)
}
...
func (c *wifiServiceClient) ExpectWifiFrequency(ctx context.Context, in *ExpectWifiFrequencyRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
	err := c.cc.Invoke(ctx, "/tast.cros.network.WifiService/ExpectWifiFrequency", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type WifiServiceServer interface {
	...
	// ExpectWifiFrequency checks if the device discovers the given SSID on the specific frequencies.
	ExpectWifiFrequency(context.Context, *ExpectWifiFrequencyRequest) (*empty.Empty, error)
}
...
func (*UnimplementedWifiServiceServer) ExpectWifiFrequency(ctx context.Context, req *ExpectWifiFrequencyRequest) (*empty.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ExpectWifiFrequency not implemented")
}
...
func _WifiService_ExpectWifiFrequency_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ExpectWifiFrequencyRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(WifiServiceServer).ExpectWifiFrequency(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tast.cros.network.WifiService/ExpectWifiFrequency",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WifiServiceServer).ExpectWifiFrequency(ctx, req.(*ExpectWifiFrequencyRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _WifiService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ExpectWifiFrequency",
			Handler:    _WifiService_ExpectWifiFrequency_Handler,
		},
	},
