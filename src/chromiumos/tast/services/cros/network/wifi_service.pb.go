...
type WifiServiceClient interface {
	...
	// EAPAuthSkipped is a streaming gRPC, which watches the dbus signals from wpa_supplicant
	// and tells that the EAP authentication is skipped (i.e., PMKSA is cached and used) or not.
