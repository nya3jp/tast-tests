...
type WaitForBssesRequest struct {
	Ssid                 string   `protobuf:"bytes,1,opt,name=ssid,proto3" json:"ssid,omitempty"`
	NumBss               int32    `protobuf:"varint,2,opt,name=num_bss,json=numBss,proto3" json:"num_bss,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}

func (m *WaitForBssesRequest) Reset()         { *m = WaitForBssesRequest{} }
func (m *WaitForBssesRequest) String() string { return proto.CompactTextString(m) }
func (*WaitForBssesRequest) ProtoMessage()    {}
func (*WaitForBssesRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_7d1eecb28f2859f1, []int{10}
}

func (m *WaitForBssesRequest) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_WaitForBssesRequest.Unmarshal(m, b)
}
func (m *WaitForBssesRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_WaitForBssesRequest.Marshal(b, m, deterministic)
}
func (m *WaitForBssesRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_WaitForBssesRequest.Merge(m, src)
}
func (m *WaitForBssesRequest) XXX_Size() int {
	return xxx_messageInfo_WaitForBssesRequest.Size(m)
}
func (m *WaitForBssesRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_WaitForBssesRequest.DiscardUnknown(m)
}

var xxx_messageInfo_WaitForBssesRequest proto.InternalMessageInfo

func (m *WaitForBssesRequest) GetSsid() string {
	if m != nil {
		return m.Ssid
	}
	return ""
...
func (m *WaitForBssesRequest) GetNumBss() int32 {
	if m != nil {
		return m.NumBss
	}
	return 0
...
func init() {
	...
	proto.RegisterType((*WaitForBssesRequest)(nil), "tast.cros.network.WaitForBssesRequest")
}
...
var fileDescriptor_7d1eecb28f2859f1 = []byte{
	...
	,
}
...
type WifiServiceClient interface {
	...
	WaitForBsses(ctx context.Context, in *WaitForBssesRequest, opts ...grpc.CallOption) (*empty.Empty, error)
}
...
func (c *wifiServiceClient) WaitForBsses(ctx context.Context, in *WaitForBssesRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
	err := c.cc.Invoke(ctx, "/tast.cros.network.WifiService/WaitForBsses", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type WifiServiceServer interface {
	...
	// WaitForBsses waits for all BSSes associated with given SSID to be discovered.
	WaitForBsses(context.Context, *WaitForBssesRequest) (*empty.Empty, error)
}
...
func (*UnimplementedWifiServiceServer) WaitForBsses(ctx context.Context, req *WaitForBssesRequest) (*empty.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method WaitForBsses not implemented")
}
...
func _WifiService_WaitForBsses_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(WaitForBssesRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(WifiServiceServer).WaitForBsses(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tast.cros.network.WifiService/WaitForBsses",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WifiServiceServer).WaitForBsses(ctx, req.(*WaitForBssesRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _WifiService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "WaitForBsses",
			Handler:    _WifiService_WaitForBsses_Handler,
		},
	},
