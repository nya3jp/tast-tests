...
type ScanConfig struct {
	BgscanMethod string `protobuf:"bytes,1,opt,name=bgscan_method,json=bgscanMethod,proto3" json:"bgscan_method,omitempty"`
	// BgscanShortInterval time in seconds, only value in uint16 range is valid as dbus property type is uint16.
	BgscanShortInterval uint32 `protobuf:"varint,2,opt,name=bgscan_short_interval,json=bgscanShortInterval,proto3" json:"bgscan_short_interval,omitempty"`
	// ScanInterval time in seconds, only value in uint16 range is valid as dbus property type is uint16.
	// This config is shared for foreground scan interval and background scan long interval.
	ScanInterval         uint32   `protobuf:"varint,3,opt,name=scan_interval,json=scanInterval,proto3" json:"scan_interval,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *ScanConfig) GetBgscanMethod() string {
	if m != nil {
		return m.BgscanMethod
	}
	return ""
}

func (m *ScanConfig) GetBgscanShortInterval() uint32 {
	if m != nil {
		return m.BgscanShortInterval
	}
	return 0
}

func (m *ScanConfig) GetScanInterval() uint32 {
	if m != nil {
...
type GetScanConfigResponse struct {
...
func (m *GetScanConfigResponse) Reset()         { *m = GetScanConfigResponse{} }
func (m *GetScanConfigResponse) String() string { return proto.CompactTextString(m) }
func (*GetScanConfigResponse) ProtoMessage()    {}
func (*GetScanConfigResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_7d1eecb28f2859f1, []int{18}
}

func (m *GetScanConfigResponse) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_GetScanConfigResponse.Unmarshal(m, b)
}
func (m *GetScanConfigResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_GetScanConfigResponse.Marshal(b, m, deterministic)
}
func (m *GetScanConfigResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GetScanConfigResponse.Merge(m, src)
}
func (m *GetScanConfigResponse) XXX_Size() int {
	return xxx_messageInfo_GetScanConfigResponse.Size(m)
}
func (m *GetScanConfigResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_GetScanConfigResponse.DiscardUnknown(m)
}

var xxx_messageInfo_GetScanConfigResponse proto.InternalMessageInfo

func (m *GetScanConfigResponse) GetConfig() *ScanConfig {
	if m != nil {
		return m.Config
	}
	return nil
...
type SetScanConfigRequest struct {
	Config               *ScanConfig `protobuf:"bytes,1,opt,name=config,proto3" json:"config,omitempty"`
	XXX_NoUnkeyedLiteral struct{}    `json:"-"`
	XXX_unrecognized     []byte      `json:"-"`
	XXX_sizecache        int32       `json:"-"`
...
func (m *SetScanConfigRequest) Reset()         { *m = SetScanConfigRequest{} }
func (m *SetScanConfigRequest) String() string { return proto.CompactTextString(m) }
func (*SetScanConfigRequest) ProtoMessage()    {}
func (*SetScanConfigRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_7d1eecb28f2859f1, []int{19}
}

func (m *SetScanConfigRequest) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_SetScanConfigRequest.Unmarshal(m, b)
}
func (m *SetScanConfigRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_SetScanConfigRequest.Marshal(b, m, deterministic)
}
func (m *SetScanConfigRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SetScanConfigRequest.Merge(m, src)
}
func (m *SetScanConfigRequest) XXX_Size() int {
	return xxx_messageInfo_SetScanConfigRequest.Size(m)
}
func (m *SetScanConfigRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_SetScanConfigRequest.DiscardUnknown(m)
}

var xxx_messageInfo_SetScanConfigRequest proto.InternalMessageInfo

func (m *SetScanConfigRequest) GetConfig() *ScanConfig {
	if m != nil {
		return m.Config
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*ScanConfig)(nil), "tast.cros.network.ScanConfig")
	proto.RegisterType((*GetScanConfigResponse)(nil), "tast.cros.network.GetScanConfigResponse")
	proto.RegisterType((*SetScanConfigRequest)(nil), "tast.cros.network.SetScanConfigRequest")
...
var fileDescriptor_7d1eecb28f2859f1 = []byte{
	...
	,
}
...
type WifiServiceClient interface {
	...
	// GetScanConfig returns the bgscan configuration the device's WiFi module currently uses.
	GetScanConfig(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*GetScanConfigResponse, error)
	// SetScanConfig sets the device's WiFi module's bgscan configuration.
	SetScanConfig(ctx context.Context, in *SetScanConfigRequest, opts ...grpc.CallOption) (*empty.Empty, error)
...
func (c *wifiServiceClient) GetScanConfig(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*GetScanConfigResponse, error) {
	out := new(GetScanConfigResponse)
	err := c.cc.Invoke(ctx, "/tast.cros.network.WifiService/GetScanConfig", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *wifiServiceClient) SetScanConfig(ctx context.Context, in *SetScanConfigRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
	err := c.cc.Invoke(ctx, "/tast.cros.network.WifiService/SetScanConfig", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type WifiServiceServer interface {
	...
	// GetScanConfig returns the bgscan configuration the device's WiFi module currently uses.
	GetScanConfig(context.Context, *empty.Empty) (*GetScanConfigResponse, error)
	// SetScanConfig sets the device's WiFi module's bgscan configuration.
	SetScanConfig(context.Context, *SetScanConfigRequest) (*empty.Empty, error)
	// AssureDisconnect assures that the WiFi service has disconnected within timeout (nanoseconds).
...
func (*UnimplementedWifiServiceServer) GetScanConfig(ctx context.Context, req *empty.Empty) (*GetScanConfigResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetScanConfig not implemented")
}
func (*UnimplementedWifiServiceServer) SetScanConfig(ctx context.Context, req *SetScanConfigRequest) (*empty.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SetScanConfig not implemented")
}
...
func _WifiService_GetScanConfig_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(empty.Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(WifiServiceServer).GetScanConfig(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tast.cros.network.WifiService/GetScanConfig",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WifiServiceServer).GetScanConfig(ctx, req.(*empty.Empty))
	}
	return interceptor(ctx, in, info, handler)
}

func _WifiService_SetScanConfig_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SetScanConfigRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(WifiServiceServer).SetScanConfig(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tast.cros.network.WifiService/SetScanConfig",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WifiServiceServer).SetScanConfig(ctx, req.(*SetScanConfigRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _WifiService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _WifiService_GetScanConfig_Handler,
		},
		{
			MethodName: "SetScanConfig",
			Handler:    _WifiService_SetScanConfig_Handler,
		},
		{
