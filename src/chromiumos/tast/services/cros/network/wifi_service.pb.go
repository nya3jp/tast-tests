...
type ExpectShillServicePropertyRequest_CheckMethod int32

const (
	// Check if the property value is expected; if not, wait until it is expected.
	ExpectShillServicePropertyRequest_CHECK_WAIT ExpectShillServicePropertyRequest_CheckMethod = 0
	// Check on property change.
	ExpectShillServicePropertyRequest_ON_CHANGE ExpectShillServicePropertyRequest_CheckMethod = 1
	// Check if the property value is expected.
	ExpectShillServicePropertyRequest_CHECK_ONLY ExpectShillServicePropertyRequest_CheckMethod = 2
)

var ExpectShillServicePropertyRequest_CheckMethod_name = map[int32]string{
	0: "CHECK_WAIT",
	1: "ON_CHANGE",
	2: "CHECK_ONLY",
}

var ExpectShillServicePropertyRequest_CheckMethod_value = map[string]int32{
	"CHECK_WAIT": 0,
	"ON_CHANGE":  1,
	"CHECK_ONLY": 2,
}

func (x ExpectShillServicePropertyRequest_CheckMethod) String() string {
	return proto.EnumName(ExpectShillServicePropertyRequest_CheckMethod_name, int32(x))
}

func (ExpectShillServicePropertyRequest_CheckMethod) EnumDescriptor() ([]byte, []int) {
...
type ExpectShillServicePropertyRequest struct {
	...
	Props                []*ExpectShillServicePropertyRequest_Criterion `protobuf:"bytes,2,rep,name=props,proto3" json:"props,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                                       `json:"-"`
	XXX_unrecognized     []byte                                         `json:"-"`
	XXX_sizecache        int32                                          `json:"-"`
}

func (m *ExpectShillServicePropertyRequest) Reset()         { *m = ExpectShillServicePropertyRequest{} }
func (m *ExpectShillServicePropertyRequest) String() string { return proto.CompactTextString(m) }
func (*ExpectShillServicePropertyRequest) ProtoMessage()    {}
func (*ExpectShillServicePropertyRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_7d1eecb28f2859f1, []int{23}
}

func (m *ExpectShillServicePropertyRequest) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_ExpectShillServicePropertyRequest.Unmarshal(m, b)
}
func (m *ExpectShillServicePropertyRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_ExpectShillServicePropertyRequest.Marshal(b, m, deterministic)
}
func (m *ExpectShillServicePropertyRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ExpectShillServicePropertyRequest.Merge(m, src)
}
func (m *ExpectShillServicePropertyRequest) XXX_Size() int {
	return xxx_messageInfo_ExpectShillServicePropertyRequest.Size(m)
}
func (m *ExpectShillServicePropertyRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_ExpectShillServicePropertyRequest.DiscardUnknown(m)
}

var xxx_messageInfo_ExpectShillServicePropertyRequest proto.InternalMessageInfo

func (m *ExpectShillServicePropertyRequest) GetObjectPath() string {
	if m != nil {
		return m.ObjectPath
	}
	return ""
...
func (m *ExpectShillServicePropertyRequest) GetProps() []*ExpectShillServicePropertyRequest_Criterion {
	if m != nil {
		return m.Props
	}
	return nil
...
type ExpectShillServicePropertyRequest_Criterion struct {
	...
	Method               ExpectShillServicePropertyRequest_CheckMethod `protobuf:"varint,4,opt,name=method,proto3,enum=tast.cros.network.ExpectShillServicePropertyRequest_CheckMethod" json:"method,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                                      `json:"-"`
	XXX_unrecognized     []byte                                        `json:"-"`
	XXX_sizecache        int32                                         `json:"-"`
}

func (m *ExpectShillServicePropertyRequest_Criterion) Reset() {
	*m = ExpectShillServicePropertyRequest_Criterion{}
}
func (m *ExpectShillServicePropertyRequest_Criterion) String() string {
	return proto.CompactTextString(m)
}
func (*ExpectShillServicePropertyRequest_Criterion) ProtoMessage() {}
func (*ExpectShillServicePropertyRequest_Criterion) Descriptor() ([]byte, []int) {
	return fileDescriptor_7d1eecb28f2859f1, []int{23, 0}
}

func (m *ExpectShillServicePropertyRequest_Criterion) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_ExpectShillServicePropertyRequest_Criterion.Unmarshal(m, b)
}
func (m *ExpectShillServicePropertyRequest_Criterion) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_ExpectShillServicePropertyRequest_Criterion.Marshal(b, m, deterministic)
}
func (m *ExpectShillServicePropertyRequest_Criterion) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ExpectShillServicePropertyRequest_Criterion.Merge(m, src)
}
func (m *ExpectShillServicePropertyRequest_Criterion) XXX_Size() int {
	return xxx_messageInfo_ExpectShillServicePropertyRequest_Criterion.Size(m)
}
func (m *ExpectShillServicePropertyRequest_Criterion) XXX_DiscardUnknown() {
	xxx_messageInfo_ExpectShillServicePropertyRequest_Criterion.DiscardUnknown(m)
}

var xxx_messageInfo_ExpectShillServicePropertyRequest_Criterion proto.InternalMessageInfo

func (m *ExpectShillServicePropertyRequest_Criterion) GetKey() string {
	if m != nil {
		return m.Key
	}
	return ""
...
func (m *ExpectShillServicePropertyRequest_Criterion) GetAnyOf() []*ShillVal {
	if m != nil {
		return m.AnyOf
	}
	return nil
...
func (m *ExpectShillServicePropertyRequest_Criterion) GetNoneOf() []*ShillVal {
	if m != nil {
		return m.NoneOf
	}
	return nil
...
func (m *ExpectShillServicePropertyRequest_Criterion) GetMethod() ExpectShillServicePropertyRequest_CheckMethod {
	if m != nil {
		return m.Method
	}
	return ExpectShillServicePropertyRequest_CHECK_WAIT
}

type ExpectShillServicePropertyResponse struct {
	Key                  string    `protobuf:"bytes,1,opt,name=key,proto3" json:"key,omitempty"`
...
func (m *ExpectShillServicePropertyResponse) Reset()         { *m = ExpectShillServicePropertyResponse{} }
func (m *ExpectShillServicePropertyResponse) String() string { return proto.CompactTextString(m) }
func (*ExpectShillServicePropertyResponse) ProtoMessage()    {}
func (*ExpectShillServicePropertyResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_7d1eecb28f2859f1, []int{24}
}

func (m *ExpectShillServicePropertyResponse) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_ExpectShillServicePropertyResponse.Unmarshal(m, b)
}
func (m *ExpectShillServicePropertyResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_ExpectShillServicePropertyResponse.Marshal(b, m, deterministic)
}
func (m *ExpectShillServicePropertyResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ExpectShillServicePropertyResponse.Merge(m, src)
}
func (m *ExpectShillServicePropertyResponse) XXX_Size() int {
	return xxx_messageInfo_ExpectShillServicePropertyResponse.Size(m)
}
func (m *ExpectShillServicePropertyResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_ExpectShillServicePropertyResponse.DiscardUnknown(m)
}

var xxx_messageInfo_ExpectShillServicePropertyResponse proto.InternalMessageInfo

func (m *ExpectShillServicePropertyResponse) GetKey() string {
	if m != nil {
		return m.Key
	}
	return ""
...
func (m *ExpectShillServicePropertyResponse) GetVal() *ShillVal {
	if m != nil {
		return m.Val
	}
	return nil
...
func init() {
	proto.RegisterEnum("tast.cros.network.ExpectShillServicePropertyRequest_CheckMethod", ExpectShillServicePropertyRequest_CheckMethod_name, ExpectShillServicePropertyRequest_CheckMethod_value)
	...
	proto.RegisterType((*ExpectShillServicePropertyRequest)(nil), "tast.cros.network.ExpectShillServicePropertyRequest")
	proto.RegisterType((*ExpectShillServicePropertyRequest_Criterion)(nil), "tast.cros.network.ExpectShillServicePropertyRequest.Criterion")
	proto.RegisterType((*ExpectShillServicePropertyResponse)(nil), "tast.cros.network.ExpectShillServicePropertyResponse")
}
...
var fileDescriptor_7d1eecb28f2859f1 = []byte{
	...
	,
}
...
type WifiServiceClient interface {
	...
	// ExpectShillServiceProperty is a streaming gRPC, takes shill service path and expects a list of property
	...
	ExpectShillServiceProperty(ctx context.Context, in *ExpectShillServicePropertyRequest, opts ...grpc.CallOption) (WifiService_ExpectShillServicePropertyClient, error)
}
...
func (c *wifiServiceClient) ExpectShillServiceProperty(ctx context.Context, in *ExpectShillServicePropertyRequest, opts ...grpc.CallOption) (WifiService_ExpectShillServicePropertyClient, error) {
	stream, err := c.cc.NewStream(ctx, &_WifiService_serviceDesc.Streams[0], "/tast.cros.network.WifiService/ExpectShillServiceProperty", opts...)
	if err != nil {
		return nil, err
	}
	x := &wifiServiceExpectShillServicePropertyClient{stream}
...
type WifiService_ExpectShillServicePropertyClient interface {
	Recv() (*ExpectShillServicePropertyResponse, error)
	grpc.ClientStream
}

type wifiServiceExpectShillServicePropertyClient struct {
	grpc.ClientStream
}

func (x *wifiServiceExpectShillServicePropertyClient) Recv() (*ExpectShillServicePropertyResponse, error) {
	m := new(ExpectShillServicePropertyResponse)
...
type WifiServiceServer interface {
	...
	// 2. ON_CHANGE: waits for the property changes to the expected values.
	// 3. CHECK_WAIT: checks if the criterion is met; if not, waits until the property's value is met.
	ExpectShillServiceProperty(*ExpectShillServicePropertyRequest, WifiService_ExpectShillServicePropertyServer) error
}
...
func (*UnimplementedWifiServiceServer) ExpectShillServiceProperty(req *ExpectShillServicePropertyRequest, srv WifiService_ExpectShillServicePropertyServer) error {
	return status.Errorf(codes.Unimplemented, "method ExpectShillServiceProperty not implemented")
}
...
func _WifiService_ExpectShillServiceProperty_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(ExpectShillServicePropertyRequest)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(WifiServiceServer).ExpectShillServiceProperty(m, &wifiServiceExpectShillServicePropertyServer{stream})
}

type WifiService_ExpectShillServicePropertyServer interface {
	Send(*ExpectShillServicePropertyResponse) error
	grpc.ServerStream
}

type wifiServiceExpectShillServicePropertyServer struct {
	grpc.ServerStream
}

func (x *wifiServiceExpectShillServicePropertyServer) Send(m *ExpectShillServicePropertyResponse) error {
...
var _WifiService_serviceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		{
			StreamName:    "ExpectShillServiceProperty",
			Handler:       _WifiService_ExpectShillServiceProperty_Handler,
			ServerStreams: true,
		},
	},
