...
type DeviceMinimumVersionServiceClient interface {
	...
	TestUpdateRequiredScreenIsVisible(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*emptypb.Empty, error)
}
...
func (c *deviceMinimumVersionServiceClient) TestUpdateRequiredScreenIsVisible(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*emptypb.Empty, error) {
...
type DeviceMinimumVersionServiceServer interface {
	...
	// Checks that an update required screen with update now button is visible on the login page.
	// Chrome is closed when function exists. This is used by the test policy.DeviceMinimumVersion.
	TestUpdateRequiredScreenIsVisible(context.Context, *emptypb.Empty) (*emptypb.Empty, error)
}
...
func (*UnimplementedDeviceMinimumVersionServiceServer) TestUpdateRequiredScreenIsVisible(context.Context, *emptypb.Empty) (*emptypb.Empty, error) {
...
func _DeviceMinimumVersionService_TestUpdateRequiredScreenIsVisible_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DeviceMinimumVersionServiceServer).TestUpdateRequiredScreenIsVisible(ctx, req.(*emptypb.Empty))
	}
