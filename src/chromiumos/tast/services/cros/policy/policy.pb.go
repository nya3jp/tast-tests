...
var file_policy_policy_proto_rawDesc = []byte{
	...
	,
...
var file_policy_policy_proto_msgTypes = make([]protoimpl.MessageInfo, 17)
var file_policy_policy_proto_goTypes = []interface{}{
	...
	(*GAIAEnrollForReportingRequest)(nil),        // 3: tast.cros.policy.GAIAEnrollForReportingRequest
	(*CreateFakeDMSDirRequest)(nil),              // 4: tast.cros.policy.CreateFakeDMSDirRequest
	(*RemoveFakeDMSDirRequest)(nil),              // 5: tast.cros.policy.RemoveFakeDMSDirRequest
	(*UpdatePoliciesRequest)(nil),                // 6: tast.cros.policy.UpdatePoliciesRequest
	(*ServePolicyDataRequest)(nil),               // 7: tast.cros.policy.ServePolicyDataRequest
	(*ServePolicyDataResponse)(nil),              // 8: tast.cros.policy.ServePolicyDataResponse
	(*EvalInExtensionRequest)(nil),               // 9: tast.cros.policy.EvalInExtensionRequest
	(*EvalInExtensionResponse)(nil),              // 10: tast.cros.policy.EvalInExtensionResponse
	(*ExtensionFile)(nil),                        // 11: tast.cros.policy.ExtensionFile
	(*Extension)(nil),                            // 12: tast.cros.policy.Extension
	(*VerifyVisibleNotificationRequest)(nil),     // 13: tast.cros.policy.VerifyVisibleNotificationRequest
	(*EvalExpressionInChromeUrlRequest)(nil),     // 14: tast.cros.policy.EvalExpressionInChromeUrlRequest
	(*StartChromeRequest)(nil),                   // 15: tast.cros.policy.StartChromeRequest
	(*ClientIdResponse)(nil),                     // 16: tast.cros.policy.ClientIdResponse
	(*emptypb.Empty)(nil),                        // 17: google.protobuf.Empty
}
var file_policy_policy_proto_depIdxs = []int32{
	12, // 0: tast.cros.policy.EnrollUsingChromeRequest.extensions:type_name -> tast.cros.policy.Extension
	11, // 1: tast.cros.policy.Extension.files:type_name -> tast.cros.policy.ExtensionFile
	17, // 2: tast.cros.policy.PolicyService.StartNewChromeReader:input_type -> google.protobuf.Empty
	17, // 3: tast.cros.policy.PolicyService.WaitForEnrollmentError:input_type -> google.protobuf.Empty
	0,  // 4: tast.cros.policy.PolicyService.EnrollUsingChrome:input_type -> tast.cros.policy.EnrollUsingChromeRequest
	1,  // 5: tast.cros.policy.PolicyService.GAIAEnrollUsingChrome:input_type -> tast.cros.policy.GAIAEnrollUsingChromeRequest
	2,  // 6: tast.cros.policy.PolicyService.GAIAEnrollAndLoginUsingChrome:input_type -> tast.cros.policy.GAIAEnrollAndLoginUsingChromeRequest
	3,  // 7: tast.cros.policy.PolicyService.GAIAEnrollForReporting:input_type -> tast.cros.policy.GAIAEnrollForReportingRequest
	6,  // 8: tast.cros.policy.PolicyService.UpdatePolicies:input_type -> tast.cros.policy.UpdatePoliciesRequest
	17, // 9: tast.cros.policy.PolicyService.CheckChromeAndFakeDMS:input_type -> google.protobuf.Empty
	17, // 10: tast.cros.policy.PolicyService.StopChromeAndFakeDMS:input_type -> google.protobuf.Empty
	15, // 11: tast.cros.policy.PolicyService.StartChrome:input_type -> tast.cros.policy.StartChromeRequest
	17, // 12: tast.cros.policy.PolicyService.StopChrome:input_type -> google.protobuf.Empty
	17, // 13: tast.cros.policy.PolicyService.ContinueLogin:input_type -> google.protobuf.Empty
	4,  // 14: tast.cros.policy.PolicyService.CreateFakeDMSDir:input_type -> tast.cros.policy.CreateFakeDMSDirRequest
	5,  // 15: tast.cros.policy.PolicyService.RemoveFakeDMSDir:input_type -> tast.cros.policy.RemoveFakeDMSDirRequest
	17, // 16: tast.cros.policy.PolicyService.StartExternalDataServer:input_type -> google.protobuf.Empty
	7,  // 17: tast.cros.policy.PolicyService.ServePolicyData:input_type -> tast.cros.policy.ServePolicyDataRequest
	17, // 18: tast.cros.policy.PolicyService.StopExternalDataServer:input_type -> google.protobuf.Empty
	9,  // 19: tast.cros.policy.PolicyService.EvalStatementInExtension:input_type -> tast.cros.policy.EvalInExtensionRequest
	9,  // 20: tast.cros.policy.PolicyService.EvalInExtension:input_type -> tast.cros.policy.EvalInExtensionRequest
	13, // 21: tast.cros.policy.PolicyService.VerifyVisibleNotification:input_type -> tast.cros.policy.VerifyVisibleNotificationRequest
	14, // 22: tast.cros.policy.PolicyService.EvalExpressionInChromeURL:input_type -> tast.cros.policy.EvalExpressionInChromeUrlRequest
	17, // 23: tast.cros.policy.PolicyService.ClientID:input_type -> google.protobuf.Empty
	17, // 24: tast.cros.policy.PolicyService.StartNewChromeReader:output_type -> google.protobuf.Empty
	17, // 25: tast.cros.policy.PolicyService.WaitForEnrollmentError:output_type -> google.protobuf.Empty
	17, // 26: tast.cros.policy.PolicyService.EnrollUsingChrome:output_type -> google.protobuf.Empty
	17, // 27: tast.cros.policy.PolicyService.GAIAEnrollUsingChrome:output_type -> google.protobuf.Empty
	17, // 28: tast.cros.policy.PolicyService.GAIAEnrollAndLoginUsingChrome:output_type -> google.protobuf.Empty
	17, // 29: tast.cros.policy.PolicyService.GAIAEnrollForReporting:output_type -> google.protobuf.Empty
	17, // 30: tast.cros.policy.PolicyService.UpdatePolicies:output_type -> google.protobuf.Empty
	17, // 31: tast.cros.policy.PolicyService.CheckChromeAndFakeDMS:output_type -> google.protobuf.Empty
	17, // 32: tast.cros.policy.PolicyService.StopChromeAndFakeDMS:output_type -> google.protobuf.Empty
	17, // 33: tast.cros.policy.PolicyService.StartChrome:output_type -> google.protobuf.Empty
	17, // 34: tast.cros.policy.PolicyService.StopChrome:output_type -> google.protobuf.Empty
	17, // 35: tast.cros.policy.PolicyService.ContinueLogin:output_type -> google.protobuf.Empty
	17, // 36: tast.cros.policy.PolicyService.CreateFakeDMSDir:output_type -> google.protobuf.Empty
	17, // 37: tast.cros.policy.PolicyService.RemoveFakeDMSDir:output_type -> google.protobuf.Empty
	17, // 38: tast.cros.policy.PolicyService.StartExternalDataServer:output_type -> google.protobuf.Empty
	8,  // 39: tast.cros.policy.PolicyService.ServePolicyData:output_type -> tast.cros.policy.ServePolicyDataResponse
	17, // 40: tast.cros.policy.PolicyService.StopExternalDataServer:output_type -> google.protobuf.Empty
	17, // 41: tast.cros.policy.PolicyService.EvalStatementInExtension:output_type -> google.protobuf.Empty
	10, // 42: tast.cros.policy.PolicyService.EvalInExtension:output_type -> tast.cros.policy.EvalInExtensionResponse
	17, // 43: tast.cros.policy.PolicyService.VerifyVisibleNotification:output_type -> google.protobuf.Empty
	17, // 44: tast.cros.policy.PolicyService.EvalExpressionInChromeURL:output_type -> google.protobuf.Empty
	16, // 45: tast.cros.policy.PolicyService.ClientID:output_type -> tast.cros.policy.ClientIdResponse
