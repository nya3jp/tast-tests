...
type VerifyArcAppConnectivityRequest struct {
	...
	ProxyUsername string `protobuf:"bytes,2,opt,name=proxy_username,json=proxyUsername,proto3" json:"proxy_username,omitempty"`
	// Password to authenticate to the HTTP proxy via the system-proxy dialog.
	ProxyPassword        string   `protobuf:"bytes,3,opt,name=proxy_password,json=proxyPassword,proto3" json:"proxy_password,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
type VerifyArcAppConnectivityResponse struct {
	// The HTTP reponse code or an error.
...
var fileDescriptor_ac3b897852294d6a = []byte{
	...
	,
}
