...
var file_policy_policy_proto_rawDesc = []byte{
	...
	0x6e, 0x74, 0x49, 0x64, 0x32, 0x80, 0x0e, 0x0a, 0x0d, 0x50, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x53,
	0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x59, 0x0a, 0x11, 0x45, 0x6e, 0x72, 0x6f, 0x6c, 0x6c,
	...
	0x08, 0x43, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x49, 0x64, 0x12, 0x16, 0x2e, 0x67, 0x6f, 0x6f, 0x67,
...
var file_policy_policy_proto_depIdxs = []int32{
	...
	3,  // 5: tast.cros.policy.PolicyService.GAIAEnrollForReporting:input_type -> tast.cros.policy.GAIAEnrollForReportingRequest
	6,  // 6: tast.cros.policy.PolicyService.UpdatePolicies:input_type -> tast.cros.policy.UpdatePoliciesRequest
	17, // 7: tast.cros.policy.PolicyService.CheckChromeAndFakeDMS:input_type -> google.protobuf.Empty
	17, // 8: tast.cros.policy.PolicyService.StopChromeAndFakeDMS:input_type -> google.protobuf.Empty
	15, // 9: tast.cros.policy.PolicyService.StartChrome:input_type -> tast.cros.policy.StartChromeRequest
	17, // 10: tast.cros.policy.PolicyService.StopChrome:input_type -> google.protobuf.Empty
	17, // 11: tast.cros.policy.PolicyService.ContinueLogin:input_type -> google.protobuf.Empty
	...
	17, // 14: tast.cros.policy.PolicyService.StartExternalDataServer:input_type -> google.protobuf.Empty
	7,  // 15: tast.cros.policy.PolicyService.ServePolicyData:input_type -> tast.cros.policy.ServePolicyDataRequest
	17, // 16: tast.cros.policy.PolicyService.StopExternalDataServer:input_type -> google.protobuf.Empty
	...
	17, // 21: tast.cros.policy.PolicyService.ClientId:input_type -> google.protobuf.Empty
	17, // 22: tast.cros.policy.PolicyService.EnrollUsingChrome:output_type -> google.protobuf.Empty
	17, // 23: tast.cros.policy.PolicyService.GAIAEnrollUsingChrome:output_type -> google.protobuf.Empty
	17, // 24: tast.cros.policy.PolicyService.GAIAEnrollAndLoginUsingChrome:output_type -> google.protobuf.Empty
	17, // 25: tast.cros.policy.PolicyService.GAIAEnrollForReporting:output_type -> google.protobuf.Empty
	17, // 26: tast.cros.policy.PolicyService.UpdatePolicies:output_type -> google.protobuf.Empty
	17, // 27: tast.cros.policy.PolicyService.CheckChromeAndFakeDMS:output_type -> google.protobuf.Empty
	17, // 28: tast.cros.policy.PolicyService.StopChromeAndFakeDMS:output_type -> google.protobuf.Empty
	17, // 29: tast.cros.policy.PolicyService.StartChrome:output_type -> google.protobuf.Empty
	17, // 30: tast.cros.policy.PolicyService.StopChrome:output_type -> google.protobuf.Empty
	17, // 31: tast.cros.policy.PolicyService.ContinueLogin:output_type -> google.protobuf.Empty
	17, // 32: tast.cros.policy.PolicyService.CreateFakeDMSDir:output_type -> google.protobuf.Empty
	17, // 33: tast.cros.policy.PolicyService.RemoveFakeDMSDir:output_type -> google.protobuf.Empty
	17, // 34: tast.cros.policy.PolicyService.StartExternalDataServer:output_type -> google.protobuf.Empty
	8,  // 35: tast.cros.policy.PolicyService.ServePolicyData:output_type -> tast.cros.policy.ServePolicyDataResponse
	17, // 36: tast.cros.policy.PolicyService.StopExternalDataServer:output_type -> google.protobuf.Empty
	17, // 37: tast.cros.policy.PolicyService.EvalStatementInExtension:output_type -> google.protobuf.Empty
	10, // 38: tast.cros.policy.PolicyService.EvalInExtension:output_type -> tast.cros.policy.EvalInExtensionResponse
	17, // 39: tast.cros.policy.PolicyService.VerifyVisibleNotification:output_type -> google.protobuf.Empty
	17, // 40: tast.cros.policy.PolicyService.EvalExpressionInChromeURL:output_type -> google.protobuf.Empty
	16, // 41: tast.cros.policy.PolicyService.ClientId:output_type -> tast.cros.policy.ClientIdResponse
...
type PolicyServiceClient interface {
	...
	GAIAEnrollForReporting(ctx context.Context, in *GAIAEnrollForReportingRequest, opts ...grpc.CallOption) (*empty.Empty, error)
	...
	ClientId(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*ClientIdResponse, error)
}
...
func (c *policyServiceClient) GAIAEnrollForReporting(ctx context.Context, in *GAIAEnrollForReportingRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
func (c *policyServiceClient) ClientId(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*ClientIdResponse, error) {
...
type PolicyServiceServer interface {
	...
	GAIAEnrollForReporting(context.Context, *GAIAEnrollForReportingRequest) (*empty.Empty, error)
	...
	// Grabs Client ID for the session
	ClientId(context.Context, *empty.Empty) (*ClientIdResponse, error)
}
...
func (*UnimplementedPolicyServiceServer) GAIAEnrollForReporting(context.Context, *GAIAEnrollForReportingRequest) (*empty.Empty, error) {
...
func (*UnimplementedPolicyServiceServer) ClientId(context.Context, *empty.Empty) (*ClientIdResponse, error) {
...
func _PolicyService_ClientId_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PolicyServiceServer).ClientId(ctx, req.(*empty.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
