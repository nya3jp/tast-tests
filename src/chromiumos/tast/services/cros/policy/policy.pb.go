...
var file_policy_policy_proto_rawDesc = []byte{
	...
	0x72, 0x55, 0x52, 0x4c, 0x22, 0x2d, 0x0a, 0x17, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x46, 0x61,
	...
	0x66, 0x65, 0x72, 0x4c, 0x6f, 0x67, 0x69, 0x6e, 0x32, 0xb3, 0x0c, 0x0a, 0x0d, 0x50, 0x6f, 0x6c,
	0x69, 0x63, 0x79, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x53, 0x0a, 0x1f, 0x45, 0x6e,
	...
	,
...
var file_policy_policy_proto_msgTypes = make([]protoimpl.MessageInfo, 14)
...
var file_policy_policy_proto_depIdxs = []int32{
	...
	14, // 2: tast.cros.policy.PolicyService.EnsureTPMAndSystemStateAreReset:input_type -> google.protobuf.Empty
	0,  // 3: tast.cros.policy.PolicyService.EnrollUsingChrome:input_type -> tast.cros.policy.EnrollUsingChromeRequest
	1,  // 4: tast.cros.policy.PolicyService.GAIAEnrollUsingChrome:input_type -> tast.cros.policy.GAIAEnrollUsingChromeRequest
	4,  // 5: tast.cros.policy.PolicyService.UpdatePolicies:input_type -> tast.cros.policy.UpdatePoliciesRequest
	14, // 6: tast.cros.policy.PolicyService.CheckChromeAndFakeDMS:input_type -> google.protobuf.Empty
	14, // 7: tast.cros.policy.PolicyService.StopChromeAndFakeDMS:input_type -> google.protobuf.Empty
	13, // 8: tast.cros.policy.PolicyService.StartChrome:input_type -> tast.cros.policy.StartChromeRequest
	14, // 9: tast.cros.policy.PolicyService.StopChrome:input_type -> google.protobuf.Empty
	14, // 10: tast.cros.policy.PolicyService.ContinueLogin:input_type -> google.protobuf.Empty
	2,  // 11: tast.cros.policy.PolicyService.CreateFakeDMSDir:input_type -> tast.cros.policy.CreateFakeDMSDirRequest
	3,  // 12: tast.cros.policy.PolicyService.RemoveFakeDMSDir:input_type -> tast.cros.policy.RemoveFakeDMSDirRequest
	14, // 13: tast.cros.policy.PolicyService.StartExternalDataServer:input_type -> google.protobuf.Empty
	5,  // 14: tast.cros.policy.PolicyService.ServePolicyData:input_type -> tast.cros.policy.ServePolicyDataRequest
	14, // 15: tast.cros.policy.PolicyService.StopExternalDataServer:input_type -> google.protobuf.Empty
	7,  // 16: tast.cros.policy.PolicyService.EvalStatementInExtension:input_type -> tast.cros.policy.EvalInExtensionRequest
	7,  // 17: tast.cros.policy.PolicyService.EvalInExtension:input_type -> tast.cros.policy.EvalInExtensionRequest
	11, // 18: tast.cros.policy.PolicyService.VerifyVisibleNotification:input_type -> tast.cros.policy.VerifyVisibleNotificationRequest
	12, // 19: tast.cros.policy.PolicyService.EvalExpressionInChromeURL:input_type -> tast.cros.policy.EvalExpressionInChromeUrlRequest
	14, // 20: tast.cros.policy.PolicyService.EnsureTPMAndSystemStateAreReset:output_type -> google.protobuf.Empty
	14, // 21: tast.cros.policy.PolicyService.EnrollUsingChrome:output_type -> google.protobuf.Empty
	14, // 22: tast.cros.policy.PolicyService.GAIAEnrollUsingChrome:output_type -> google.protobuf.Empty
	14, // 23: tast.cros.policy.PolicyService.UpdatePolicies:output_type -> google.protobuf.Empty
	14, // 24: tast.cros.policy.PolicyService.CheckChromeAndFakeDMS:output_type -> google.protobuf.Empty
	14, // 25: tast.cros.policy.PolicyService.StopChromeAndFakeDMS:output_type -> google.protobuf.Empty
	14, // 26: tast.cros.policy.PolicyService.StartChrome:output_type -> google.protobuf.Empty
	14, // 27: tast.cros.policy.PolicyService.StopChrome:output_type -> google.protobuf.Empty
	14, // 28: tast.cros.policy.PolicyService.ContinueLogin:output_type -> google.protobuf.Empty
	14, // 29: tast.cros.policy.PolicyService.CreateFakeDMSDir:output_type -> google.protobuf.Empty
	14, // 30: tast.cros.policy.PolicyService.RemoveFakeDMSDir:output_type -> google.protobuf.Empty
	14, // 31: tast.cros.policy.PolicyService.StartExternalDataServer:output_type -> google.protobuf.Empty
	6,  // 32: tast.cros.policy.PolicyService.ServePolicyData:output_type -> tast.cros.policy.ServePolicyDataResponse
	14, // 33: tast.cros.policy.PolicyService.StopExternalDataServer:output_type -> google.protobuf.Empty
	14, // 34: tast.cros.policy.PolicyService.EvalStatementInExtension:output_type -> google.protobuf.Empty
	8,  // 35: tast.cros.policy.PolicyService.EvalInExtension:output_type -> tast.cros.policy.EvalInExtensionResponse
	14, // 36: tast.cros.policy.PolicyService.VerifyVisibleNotification:output_type -> google.protobuf.Empty
	14, // 37: tast.cros.policy.PolicyService.EvalExpressionInChromeURL:output_type -> google.protobuf.Empty
...
func (c *policyServiceClient) EnsureTPMAndSystemStateAreReset(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
	err := c.cc.Invoke(ctx, "/tast.cros.policy.PolicyService/EnsureTPMAndSystemStateAreReset", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedPolicyServiceServer) EnsureTPMAndSystemStateAreReset(context.Context, *empty.Empty) (*empty.Empty, error) {
...
func _PolicyService_EnsureTPMAndSystemStateAreReset_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(empty.Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PolicyServiceServer).EnsureTPMAndSystemStateAreReset(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tast.cros.policy.PolicyService/EnsureTPMAndSystemStateAreReset",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PolicyServiceServer).EnsureTPMAndSystemStateAreReset(ctx, req.(*empty.Empty))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _PolicyService_EnsureTPMAndSystemStateAreReset_Handler,
		},
		{
