...
var file_bios_service_proto_rawDesc = []byte{
	...
	0x41, 0x50, 0x10, 0x0d, 0x32, 0x8c, 0x03, 0x0a, 0x0b, 0x42, 0x69, 0x6f, 0x73, 0x53, 0x65, 0x72,
...
var file_bios_service_proto_depIdxs = []int32{
	...
	3, // 6: tast.cros.firmware.BiosService.EnableAPSoftwareWriteProtect:input_type -> google.protobuf.Empty
	1, // 7: tast.cros.firmware.BiosService.GetGBBFlags:output_type -> tast.cros.firmware.GBBFlagsState
	3, // 8: tast.cros.firmware.BiosService.ClearAndSetGBBFlags:output_type -> google.protobuf.Empty
	2, // 9: tast.cros.firmware.BiosService.BackupECRW:output_type -> tast.cros.firmware.ECRWPath
	3, // 10: tast.cros.firmware.BiosService.RestoreECRW:output_type -> google.protobuf.Empty
	3, // 11: tast.cros.firmware.BiosService.EnableAPSoftwareWriteProtect:output_type -> google.protobuf.Empty
