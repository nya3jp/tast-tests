...
func (x *FWBackUpInfo) GetSection() string {
	if x != nil {
		return x.Section
	}
	return ""
...
func (x *FWBackUpInfo) GetProgrammer() string {
	if x != nil {
		return x.Programmer
	}
	return ""
...
// FWBackUpSection represents the string containing the image section to back up.
type FWBackUpSection struct {
	...
	Programmer string `protobuf:"bytes,2,opt,name=Programmer,proto3" json:"Programmer,omitempty"`
}
...
func (x *FWBackUpSection) GetSection() string {
	if x != nil {
		return x.Section
	}
	return ""
...
func (x *FWBackUpSection) GetProgrammer() string {
	if x != nil {
		return x.Programmer
	}
	return ""
...
var file_bios_service_proto_rawDesc = []byte{
	...
	,
	...
	0x42, 0x4f, 0x4f, 0x54, 0x5f, 0x46, 0x55, 0x4c, 0x4c, 0x5f, 0x43, 0x41, 0x50, 0x10, 0x0d, 0x32,
	0xdf, 0x02, 0x0a, 0x0b, 0x42, 0x69, 0x6f, 0x73, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12,
...
var file_bios_service_proto_goTypes = []interface{}{
	...
	(*FWBackUpInfo)(nil),    // 2: tast.cros.firmware.FWBackUpInfo
	(*FWBackUpSection)(nil), // 3: tast.cros.firmware.FWBackUpSection
...
var file_bios_service_proto_depIdxs = []int32{
	...
	4, // 2: tast.cros.firmware.BiosService.GetGBBFlags:input_type -> google.protobuf.Empty
	1, // 3: tast.cros.firmware.BiosService.ClearAndSetGBBFlags:input_type -> tast.cros.firmware.GBBFlagsState
	3, // 4: tast.cros.firmware.BiosService.BackupImageSection:input_type -> tast.cros.firmware.FWBackUpSection
	2, // 5: tast.cros.firmware.BiosService.RestoreImageSection:input_type -> tast.cros.firmware.FWBackUpInfo
	1, // 6: tast.cros.firmware.BiosService.GetGBBFlags:output_type -> tast.cros.firmware.GBBFlagsState
	4, // 7: tast.cros.firmware.BiosService.ClearAndSetGBBFlags:output_type -> google.protobuf.Empty
	2, // 8: tast.cros.firmware.BiosService.BackupImageSection:output_type -> tast.cros.firmware.FWBackUpInfo
	4, // 9: tast.cros.firmware.BiosService.RestoreImageSection:output_type -> google.protobuf.Empty
