...
var file_utils_service_proto_rawDesc = []byte{
	...
	0x65, 0x74, 0x4d, 0x6f, 0x64, 0x65, 0x45, 0x6e, 0x61, 0x62, 0x6c, 0x65, 0x64, 0x32, 0xc1, 0x04,
...
var file_utils_service_proto_depIdxs = []int32{
	...
	4, // 5: tast.cros.firmware.UtilsService.ReuseChrome:input_type -> google.protobuf.Empty
	4, // 6: tast.cros.firmware.UtilsService.EvalTabletMode:input_type -> google.protobuf.Empty
	4, // 7: tast.cros.firmware.UtilsService.BlockingSync:output_type -> google.protobuf.Empty
	1, // 8: tast.cros.firmware.UtilsService.ReadServoKeyboard:output_type -> tast.cros.firmware.ReadServoKeyboardResponse
	2, // 9: tast.cros.firmware.UtilsService.FindPhysicalKeyboard:output_type -> tast.cros.firmware.FindPhysicalKeyboardResponse
	4, // 10: tast.cros.firmware.UtilsService.NewChrome:output_type -> google.protobuf.Empty
	4, // 11: tast.cros.firmware.UtilsService.CloseChrome:output_type -> google.protobuf.Empty
	4, // 12: tast.cros.firmware.UtilsService.ReuseChrome:output_type -> google.protobuf.Empty
	3, // 13: tast.cros.firmware.UtilsService.EvalTabletMode:output_type -> tast.cros.firmware.EvalTabletModeResponse
