...
type UtilsServiceClient interface {
	...
	BlockingSync(ctx context.Context, in *google_protobuf.Empty, opts ...grpc.CallOption) (*google_protobuf.Empty, error)
}
...
func (c *utilsServiceClient) BlockingSync(ctx context.Context, in *google_protobuf.Empty, opts ...grpc.CallOption) (*google_protobuf.Empty, error) {
	out := new(google_protobuf.Empty)
	err := grpc.Invoke(ctx, "/tast.cros.firmware.UtilsService/BlockingSync", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UtilsServiceServer interface {
	...
	// BlockingSync syncs the root device and internal device.
	BlockingSync(context.Context, *google_protobuf.Empty) (*google_protobuf.Empty, error)
}
...
func _UtilsService_BlockingSync_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UtilsServiceServer).BlockingSync(ctx, req.(*google_protobuf.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
var fileDescriptor0 = []byte{
	...
	,
}
