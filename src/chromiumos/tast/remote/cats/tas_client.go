...
func QueryDeviceInfoByDutID(dutID string, requestURL string) (*DUTInfo, error) {
	return queryDeviceInfo(dutID, requestURL)
}

// QueryDeviceInfoByDeviceID queries the device info by Device ID.
func QueryDeviceInfoByDeviceID(deviceID string, requestURL string) (*DUTInfo, error) {
	return queryDeviceInfo(deviceID, requestURL)
}

func queryDeviceInfo(id string, requestURL string) (*DUTInfo, error) {
