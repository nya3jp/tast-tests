...
func (e *enrolledFixt) SetUp(ctx context.Context, s *testing.FixtState) interface{} {
	...
	for tries := 1; tries < 5; tries++ {
		...
		if err := enroll(enrollCtx, s.DUT(), s.RPCHint(), e.fdmsDir, attemptDir, vpdError); err != nil {
...
func enroll(ctx context.Context, dut *dut.DUT, rpcHint *testing.RPCHint, fdmsDir, attemptDir string, vpdError error) (retErr error) {
