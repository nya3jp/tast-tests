...
func Stable(ctx context.Context, s *testing.State) {
	...
	currentStableChromeOS := params.Config.MilestoneToChromeOSVersion[params.Config.CurrentStableChrome]
	nextStableChromeOS := params.Config.MilestoneToChromeOSVersion[params.Config.NextStableChrome]
