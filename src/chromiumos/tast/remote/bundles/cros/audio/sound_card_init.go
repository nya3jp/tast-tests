...
func appliedRdc(ctx context.Context, d *rpcdut.RPCDUT, soundCardID, config, amp string, ch int) (*appliedRDC, error) {
	// Run sound_card_init.
...
func runSuccess(ctx context.Context, d *rpcdut.RPCDUT, param subTestParameters) error {
