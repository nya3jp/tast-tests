...
func testWPOverReboot(ctx context.Context, h *firmware.Helper, target wpTarget, testRebootMethod wpTestRebootMethod) error {
	...
	// 	rebootFuncs["shutdown cmd"] = performRebootWithShutdownCmd
	// 	rebootFuncs["power button"] = performRebootWithPowerBtn
	// 	rebootFuncs["reboot cmd"] = performRebootWithRebootCmd
	// }
