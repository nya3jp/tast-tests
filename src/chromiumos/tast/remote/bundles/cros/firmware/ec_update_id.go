...
func ECUpdateID(ctx context.Context, s *testing.State) {
	...
	ecrwPath, err := h.BiosServiceClient.BackupImageSection(ctx, &pb.ImageSectionInfo{Section: pb.ImageSection_ECRWImageSection, Programmer: pb.Programmer_ECProgrammer})
	if err != nil {
	...
	ecrwbPath, err := h.BiosServiceClient.BackupImageSection(ctx, &pb.ImageSectionInfo{Section: pb.ImageSection_ECRWBImageSection, Programmer: pb.Programmer_ECProgrammer})
	if err != nil {
