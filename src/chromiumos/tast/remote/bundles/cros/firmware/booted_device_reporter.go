...
func init() {
	testing.AddTest(&testing.Test{
		Func: BootedDeviceReporter, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Verifies that the BootedDevice reporter identifies which device mode the DUT was booted from",
