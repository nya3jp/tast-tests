...
func init() {
	testing.AddTest(&testing.Test{
		...
		Params: []testing.Param{
			{
				Name:    "power_button_normal_mode_10",
			...
			{
				Name:    "power_button_normal_mode_100",
				Fixture: fixture.NormalMode,
			...
			{
				Name:    "power_button_dev_mode_100",
				Fixture: fixture.DevModeGBB,
				Timeout: 300 * time.Minute,
				Val: argsForConsecutiveBoot{
					bootMethod: consecutiveBootWithPowerBtn,
			...
			{
				Name:    "shutdown_cmd_normal_mode_10",
				Fixture: fixture.NormalMode,
				Timeout: 20 * time.Minute,
				Val: argsForConsecutiveBoot{
			...
			{
				Name:    "shutdown_cmd_normal_mode_100",
				Fixture: fixture.NormalMode,
				Timeout: 300 * time.Minute,
				Val: argsForConsecutiveBoot{
					bootMethod: consecutiveBootWithShutdownCmd,
			...
			{
				Name:    "shutdown_cmd_dev_mode_100",
				Fixture: fixture.DevModeGBB,
				Timeout: 300 * time.Minute,
				Val: argsForConsecutiveBoot{
					bootMethod: consecutiveBootWithShutdownCmd,
