...
func init() {
	testing.AddTest(&testing.Test{
		...
		Params: []testing.Param{
			{
				Name:              "x86",
				ExtraHardwareDeps: hwdep.D(hwdep.X86(), hwdep.SkipOnModel("drinboz", "ezkinil", "morphius", "vilboz", "vilboz360")),
				Val: testParameters{
			...
			},
			{
				...
				Name:              "zork",
				ExtraHardwareDeps: hwdep.D(hwdep.Model("drinboz", "ezkinil", "morphius", "vilboz", "vilboz360")),
				Val: testParameters{
					apBootRegexp: `HC 0x|Port 80|ACPI query|Executing host reboot command`,
