...
// with the FPMCU's ROM/vendor/backdoor bootloader (not EC RO).
...
// status of the FPMCU. That being said, flash_fp_mcu can return fail if the
// FPMCU's FW doesn't respond after being returned to the normal operating mode.
