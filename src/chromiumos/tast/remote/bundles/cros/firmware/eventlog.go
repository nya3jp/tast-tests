	...
	testing.AddTest(&testing.Test{
		...
		Params: []testing.Param{
			...
			// Test eventlog upon dev->dev reboot.
			{
				...
				Val: eventLogParams{
					resetType:         firmware.WarmReset,
					requiredEventSets: [][]string{{`System boot`, `Chrome ?OS Developer Mode \| Developer`}},
			...
			// Test eventlog upon normal->rec reboot.
			{
				...
				Val: eventLogParams{
					...
					requiredEventSets: [][]string{{`System boot`, `Chrome ?OS Recovery Mode \| Manual recovery \| Broken screen \| Recovery Button`}},
