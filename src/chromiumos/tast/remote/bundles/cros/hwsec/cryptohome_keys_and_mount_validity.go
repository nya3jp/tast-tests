...
func testAddRemoveKeyEx(ctx context.Context, utility *hwsec.CryptohomeClient) error {
	...
	if err := utility.RemoveVaultKey(ctx, util.FirstUsername, util.FirstPassword, util.Password2Label); err != nil {
...
func testMigrateKeyEx(ctx context.Context, utility *hwsec.CryptohomeClient) error {
	...
	if err := utility.MountVault(ctx, util.FirstUsername, util.FirstChangedPassword, util.PasswordLabel, false, hwsec.NewVaultConfig()); err != nil {
