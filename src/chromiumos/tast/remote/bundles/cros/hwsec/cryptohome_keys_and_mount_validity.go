...
func testAddRemoveKeyEx(ctx context.Context, utility *hwsec.CryptohomeClient) error {
	...
	if err := utility.MountVault(ctx, util.FirstUsername, util.FirstPassword1, util.Password1Label, false, hwsec.NewVaultConfig()); err != nil {
...
func testMigrateKeyEx(ctx context.Context, utility *hwsec.CryptohomeClient) error {
	...
	if err := utility.MountVault(ctx, util.FirstUsername, util.FirstChangedPassword, util.Password1Label, false, hwsec.NewVaultConfig()); err != nil {
...
func CryptohomeKeysAndMountValidity(ctx context.Context, s *testing.State) {
	...
	func() {
		if err := utility.MountVault(ctx, util.FirstUsername, util.FirstPassword1, util.Password1Label, true, hwsec.NewVaultConfig()); err != nil {
