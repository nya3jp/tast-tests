...
// waitForInstallAttributes will wait for install attributes to be ready.
...
// takeOwnershipAndWaitForInstallAttributes will take ownership and wait for install attributes to be ready.
