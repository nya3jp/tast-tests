...
func getInstallAttributesStates(ctx context.Context, utility *hwsec.UtilityCryptohomeClient) (isReady, isInitialized, isInvalid, isFirstInstall, isSecure bool, count int, returnError error) {
...
func waitForInstallAttributes(ctx context.Context, utility *hwsec.UtilityCryptohomeClient) error {
...
func takeOwnershipAndWaitForInstallAttributes(ctx context.Context, utility *hwsec.UtilityCryptohomeClient, helper *hwsecremote.HelperRemote) error {
...
func checkAllTestAttributes(ctx context.Context, utility *hwsec.UtilityCryptohomeClient) error {
...
func attemptChangeAndCheckShouldSucceed(ctx context.Context, utility *hwsec.UtilityCryptohomeClient) error {
...
func attemptChangeAndCheckShouldFail(ctx context.Context, utility *hwsec.UtilityCryptohomeClient) error {
	if err := utility.InstallAttributesSet(ctx, testAttributes[0], testValues[1]); err == nil {
