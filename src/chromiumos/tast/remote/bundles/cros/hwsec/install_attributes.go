...
func InstallAttributes(ctx context.Context, s *testing.State) {
	...
	if isReady != false || isInitialized != false || isInvalid != false || isFirstInstall != false || count != 0 {
	...
	if err := testing.Poll(ctx, func(ctx context.Context) error {
		...
		if isReady != true || isInitialized != true || isInvalid != false || isFirstInstall != true || count != 0 {
	...
	if isReady != true || isInitialized != true || isInvalid != false || isFirstInstall != false || count != 3 {
