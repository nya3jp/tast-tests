...
func checkKeysLabel(ctx context.Context, utility *hwsec.UtilityCryptohomeBinary, target []string) error {
...
func checkUserVault(ctx context.Context, utility *hwsec.UtilityCryptohomeBinary) error {
	...
	if err := checkKeysLabel(ctx, utility, []string{firstPrimaryLabel}); err != nil {
	...
	if err := checkKeysLabel(ctx, utility, []string{firstPrimaryLabel, firstSecondaryLabel}); err != nil {
	...
	if err := checkKeysLabel(ctx, utility, []string{firstChangedPrimaryLabel}); err != nil {
