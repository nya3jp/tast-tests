...
func testListKeysEx(ctx context.Context, utility *hwsec.UtilityCryptohomeBinary) error {
	...
	if err := checkKeysLabels(ctx, utility, []string{firstPrimaryLabel}); err != nil {
...
func testAddRemoveKeyEx(ctx context.Context, utility *hwsec.UtilityCryptohomeBinary) error {
	...
	if err := checkKeysLabels(ctx, utility, []string{firstPrimaryLabel, firstSecondaryLabel}); err != nil {
...
func testMigrateKeyEx(ctx context.Context, utility *hwsec.UtilityCryptohomeBinary) error {
	...
	if err := testCheckKeyEx(ctx, utility, firstUsername, firstPrimaryLabel, firstChangedPrimaryPassword, firstPrimaryPassword); err != nil {
	...
	if err := testCheckKeyEx(ctx, utility, firstUsername, firstPrimaryLabel, firstPrimaryPassword, firstChangedPrimaryPassword); err != nil {
...
func testUpdateKeyEx(ctx context.Context, utility *hwsec.UtilityCryptohomeBinary) error {
	...
	if err := checkKeysLabels(ctx, utility, []string{firstChangedPrimaryLabel}); err != nil {
...
func checkUserVault(ctx context.Context, utility *hwsec.UtilityCryptohomeBinary) error {
	if err := testCheckKeyEx(ctx, utility, firstUsername, firstPrimaryLabel, firstPrimaryPassword, firstIncorrectPassword); err != nil {
