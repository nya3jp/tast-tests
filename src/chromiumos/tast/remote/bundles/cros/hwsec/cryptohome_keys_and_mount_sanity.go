...
func testAddRemoveKeyEx(ctx context.Context, utility *hwsec.UtilityCryptohomeBinary) error {
	...
	if err := utility.MountVault(ctx, util.FirstUsername, util.FirstPassword, util.PasswordLabel, false, []string{} /* extraFlags */); err != nil {
...
func testMigrateKeyEx(ctx context.Context, utility *hwsec.UtilityCryptohomeBinary) error {
	...
	if err := utility.MountVault(ctx, util.FirstUsername, util.FirstChangedPassword, util.PasswordLabel, false, []string{} /* extraFlags */); err != nil {
...
func testUpdateKeyEx(ctx context.Context, utility *hwsec.UtilityCryptohomeBinary) error {
	...
	if err := utility.MountVault(ctx, util.FirstUsername, util.FirstPassword, util.ChangedPasswordLabel, false, []string{} /* extraFlags */); err != nil {
