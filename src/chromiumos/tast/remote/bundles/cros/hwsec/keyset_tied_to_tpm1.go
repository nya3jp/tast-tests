...
// is tied to the TPM.
func loginTakeOwnershipAndCheckKeysetTiedToTPM(ctx context.Context, s *testing.State, utility *hwsec.UtilityCryptohomeBinary, helper hwsecremote.CmdHelperRemote, reboot bool) {
	// Reset TPM.
