...
// NOTE: This test is largely similar to hwsec.KeysetTiedToTPM (a local test), if change is made to one, it is likely tha the other have to be changed as well.
