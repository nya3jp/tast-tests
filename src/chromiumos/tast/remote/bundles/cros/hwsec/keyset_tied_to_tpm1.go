...
// is tied to the TPM.
func loginTakeOwnershipAndCheckKeysetTiedToTPM(ctx context.Context, s *testing.State, utility *hwsec.UtilityCryptohomeClient, helper *hwsecremote.HelperRemote, reboot bool) {
	// Reset TPM.
