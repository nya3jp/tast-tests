...
func (uiHelper *UIHelper) WriteProtectPageChooseRSU(ctx context.Context) error {
	return uiHelper.writeProtectPageOperation(ctx, "Perform RMA Server Unlock (RSU)")
}
...
func (uiHelper *UIHelper) WriteProtectPageChooseManual(ctx context.Context) error {
	if err := uiHelper.writeProtectPageOperation(ctx, "Manually turn off"); err != nil {
		return err
	}
	if err := uiHelper.disconnectBatteryByCr50(ctx); err != nil {
		return err
	}
	return uiHelper.changeWriteProtectStatus(ctx, servo.FWWPStateOff)
...
func (uiHelper *UIHelper) FinalizingRepairPageOperation(ctx context.Context) error {
	...
	if err := uiHelper.connectBatteryByCr50(ctx); err != nil {
		return err
	}
...
// OpenCCDIfNotOpen opens CCD if CCD is not open yet.
func (uiHelper *UIHelper) OpenCCDIfNotOpen(ctx context.Context) error {
...
func (uiHelper *UIHelper) SetupInitStatus(ctx context.Context) error {
	...
	if err := uiHelper.OpenCCDIfNotOpen(ctx); err != nil {
		return err
	}
	if err := uiHelper.changeWriteProtectStatus(ctx, servo.FWWPStateOn); err != nil {
		return err
...
func (uiHelper *UIHelper) disconnectBatteryByCr50(ctx context.Context) error {
	return uiHelper.FirmwareHelper.Servo.RunCR50Command(ctx, "bpforce disconnect atboot")
}

func (uiHelper *UIHelper) connectBatteryByCr50(ctx context.Context) error {
