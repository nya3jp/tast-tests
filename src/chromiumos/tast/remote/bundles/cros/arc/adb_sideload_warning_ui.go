...
func init() {
	testing.AddTest(&testing.Test{
		Func: AdbSideloadWarningUI, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Enables the Adb Sideloading flag and further checks that a warning UI is displayed at login screen",
		Contacts: []string{
