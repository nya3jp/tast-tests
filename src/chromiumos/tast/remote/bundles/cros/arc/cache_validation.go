...
func init() {
	testing.AddTest(&testing.Test{
		Func: CacheValidation, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Validates that caches match for both modes when pre-generated packages cache is enabled and disabled",
		Contacts: []string{
			"khmel@google.com",
