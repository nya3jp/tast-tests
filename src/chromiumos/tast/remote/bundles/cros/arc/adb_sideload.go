...
func init() {
	testing.AddTest(&testing.Test{
		...
		SoftwareDeps: []string{"reboot", "chrome", "android_p"},
		...
		Vars:         []string{"arc.AdbSideload.signinProfileTestExtensionManifestKey"},
	})
}
...
func doAdbSideloadAction(ctx context.Context, s *testing.State, requestAction string) {
	...
	manifestKey := s.RequiredVar("arc.AdbSideload.signinProfileTestExtensionManifestKey")
