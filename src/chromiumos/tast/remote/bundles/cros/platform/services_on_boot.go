...
func init() {
	testing.AddTest(&testing.Test{
		...
		Params: []testing.Param{
			...
			{
				Name:              "cras",
				Val:               checkStatus("cras", upstart.StartGoal, upstart.RunningState),
				ExtraSoftwareDeps: []string{"cras"},
			},
			{
				Name:              "sound_card_init",
				Val:               checkStatus("sound_card_init", upstart.StopGoal, upstart.WaitingState),
				ExtraSoftwareDeps: []string{"cras"},
			},
		},
	})
...
func checkStatus(jobName string, goal upstart.Goal, state upstart.State) serviceChecker {
