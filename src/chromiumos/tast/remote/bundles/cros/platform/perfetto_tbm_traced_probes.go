...
const (
	...
	// This URL is retrieved from the scripe in https://get.perfetto.dev/trace_processor, with "os" being "linux" and "arch" being "x86_64". We download trace_processor_shell from gs bucket "perfetto". Update the external data file correspondingly when we need to uprev trace_processor_shell.
