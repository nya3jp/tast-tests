...
func init() {
	testing.AddTest(&testing.Test{
		...
		Desc:     "Ensure DUTs Extra Software dependencies with Primary:octopus-sparky360 companion:hana-hana will pass, either or both changed will skip",
		Contacts: []string{"seewaifu@chromium.org", "yichiyan@google.com", "tast-owners@google.com"},
	})
}

func TestparamSw(ctx context.Context, s *testing.State) {
