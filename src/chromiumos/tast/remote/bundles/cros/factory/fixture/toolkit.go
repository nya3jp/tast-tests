...
const (
	...
	// the existence of enabled file determines whether DUT boot with running the toolkit
	toolkitEnabledPath = "/usr/local/factory/enabled"
	// reboot takes 30 seconds to pass the boot option selection in developer mood, plus 1 minute as buffer to wait for the system and networking to be ready
