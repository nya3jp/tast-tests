...
func init() {
	testing.AddTest(&testing.Test{
		...
		// Remove this test from all runs due to incompatible networking
		// changes with Tast lab with factory wiping tool, which breaks
		// the connection and blocks other test, see b/202931696.
