...
const (
	...
	// Per reboot requires 30 seconds for the boot option selection, thus the Prepare and Close requires at least 1 minute + 1 minute as buffer for system to be ready
