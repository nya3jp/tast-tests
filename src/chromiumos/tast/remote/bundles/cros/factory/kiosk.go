...
func init() {
	testing.AddTest(&testing.Test{
		...
		// it can not open the Kiosk page and is not manufactured. Skip
		// volteer as it is not stable.
		HardwareDeps: hwdep.D(hwdep.SkipOnModel("kitty"), hwdep.SkipOnPlatform("nocturne"), hwdep.SkipOnPlatform("volteer")),
	})
}
