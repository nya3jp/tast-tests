...
func init() {
	...
	testing.AddTest(&testing.Test{
		Func: SystemServicesConnectivity, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Test that system services work behind a firewall configured according to our support page",
		Contacts: []string{
