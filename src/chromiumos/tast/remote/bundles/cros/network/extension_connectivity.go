...
func init() {
	...
	testing.AddTest(&testing.Test{
		Func: ExtensionConnectivity, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Test that extensions work behind a firewall configured according to our support page",
		Contacts: []string{
