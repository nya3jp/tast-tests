...
func init() {
	testing.AddTest(&testing.Test{
		Func: DiagSignalStrength, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Tests that the WiFi signal strength network diagnostic routine reports the correct verdict if the signal strength is both attenuated and unattenuated",
		Contacts: []string{
