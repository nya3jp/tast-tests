...
func init() {
	testing.AddTest(&testing.Test{
		Func: DiagSecureWifi, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Tests that the network diagnostic routine for secure WiFi connection gives correct results with different WiFi security protocols",
		Contacts: []string{
