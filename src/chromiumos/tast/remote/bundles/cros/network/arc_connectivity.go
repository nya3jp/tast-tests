...
func init() {
	...
	testing.AddTest(&testing.Test{
		Func: ArcConnectivity, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Test that the PlayStore works behind a firewall configured according to our support page",
		Contacts: []string{
