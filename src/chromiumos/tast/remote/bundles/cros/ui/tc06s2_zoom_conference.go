...
func init() {
	testing.AddTest(&testing.Test{
		Func:         TC06S2ZoomConference,
		Desc:         "Create Zoom video conference, and present slide to another user",
...
func TC06S2ZoomConference(ctx context.Context, s *testing.State) {
	conference.Run(ctx, s, conference.Zoom)
}
