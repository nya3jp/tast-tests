...
type Client interface {
	RunGoogleMeetScenario(ctx context.Context, in *pb.MeetScenarioRequest, opts ...grpc.CallOption) (*empty.Empty, error)
	RunZoomScenario(ctx context.Context, in *pb.MeetScenarioRequest, opts ...grpc.CallOption) (*empty.Empty, error)
}
