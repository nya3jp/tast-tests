...
func init() {
	testing.AddTest(&testing.Test{
		Func: CrosToCrosInContacts, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Checks we can successfully send files from one Cros device to another when they are in each other's contacts list",
