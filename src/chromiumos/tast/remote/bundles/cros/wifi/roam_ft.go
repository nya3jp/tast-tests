...
type roamFTparam struct {
	...
	// TODO(crbug.com/977722): Remove mixedSecConfFac field once the bug is resolved.
...
func RoamFT(ctx context.Context, s *testing.State) {
	...
	*/
	...
	// TODO(crbug.com/977722): Use param.secConfFac directly once the bug is resolved.
	fac := param.secConfFac
	if param.mixedSecConfFac != nil {
		fac = param.mixedSecConfFac
	}
	runOnce(ctx, fac, !param.mixed)
}
