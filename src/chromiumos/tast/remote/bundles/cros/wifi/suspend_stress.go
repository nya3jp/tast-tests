...
func init() {
	testing.AddTest(&testing.Test{
		Func: SuspendStress, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Asserts WiFi connectivity after suspend-resume cycle using powerd_dbus_suspend command",
		Contacts: []string{
