		...
		Params: []testing.Param{
			{
				...
				Val: []axSimpleConnectTestcase{{
					band:       axrouter.Wl2,
					apOpts:     []axrouter.Option{axrouter.Mode(axrouter.Mode80211ax), axrouter.SSID("googleTest0"), axrouter.Hidden(false), axrouter.ChanBandwidth(100, axrouter.Bw80), axrouter.Radio(true)},
					secConfFac: axbase.NewConfigFactory(axrouter.Wl2),
				}, {
					band:       axrouter.Wl2,
					apOpts:     []axrouter.Option{axrouter.Mode(axrouter.Mode80211ax), axrouter.SSID("googleTest1"), axrouter.Hidden(false), axrouter.ChanBandwidth(104, axrouter.Bw80), axrouter.Radio(true)},
					secConfFac: axbase.NewConfigFactory(axrouter.Wl2),
				}},
			}, {
				...
				Val: []axSimpleConnectTestcase{{
					band:       axrouter.Wl2,
					apOpts:     []axrouter.Option{axrouter.Mode(axrouter.Mode80211ax), axrouter.SSID("googleTest0"), axrouter.Hidden(true), axrouter.ChanBandwidth(100, axrouter.Bw80), axrouter.Radio(true)},
					secConfFac: axbase.NewConfigFactory(axrouter.Wl2),
				}, {
					band:       axrouter.Wl2,
					apOpts:     []axrouter.Option{axrouter.Mode(axrouter.Mode80211ax), axrouter.SSID("googleTest1"), axrouter.Hidden(true), axrouter.ChanBandwidth(104, axrouter.Bw80), axrouter.Radio(true)},
					secConfFac: axbase.NewConfigFactory(axrouter.Wl2),
				}},
			},
			{
				...
				Val: []axSimpleConnectTestcase{{
					band:       axrouter.Wl2,
					apOpts:     []axrouter.Option{axrouter.Mode(axrouter.Mode80211ax), axrouter.SSID("googleTest0"), axrouter.Hidden(false), axrouter.ChanBandwidth(100, axrouter.Bw80), axrouter.Radio(true)},
					secConfFac: axwpa.NewConfigFactory(axrouter.Wl2, "helloworld", axrouter.AES, wpa.Mode(wpa.ModePureWPA), wpa.Ciphers(wpa.CipherCCMP)),
				}, {
					band:       axrouter.Wl2,
					apOpts:     []axrouter.Option{axrouter.Mode(axrouter.Mode80211ax), axrouter.SSID("googleTest1"), axrouter.Hidden(false), axrouter.ChanBandwidth(104, axrouter.Bw80), axrouter.Radio(true)},
					secConfFac: axwpa.NewConfigFactory(axrouter.Wl2, "helloworld", axrouter.AES, wpa.Mode(wpa.ModePureWPA), wpa.Ciphers(wpa.CipherCCMP)),
			...
			},
			{
				...
				Val: []axSimpleConnectTestcase{{
					band:       axrouter.Wl2,
					apOpts:     []axrouter.Option{axrouter.Mode(axrouter.Mode80211ax), axrouter.SSID("googleTest0"), axrouter.Hidden(true), axrouter.ChanBandwidth(100, axrouter.Bw40), axrouter.Radio(true)},
					secConfFac: axwpa.NewConfigFactory(axrouter.Wl2, "helloworld", axrouter.AES, wpa.Mode(wpa.ModePureWPA), wpa.Ciphers(wpa.CipherCCMP)),
				}, {
					band:       axrouter.Wl2,
					apOpts:     []axrouter.Option{axrouter.Mode(axrouter.Mode80211ax), axrouter.SSID("googleTest1"), axrouter.Hidden(true), axrouter.ChanBandwidth(104, axrouter.Bw40), axrouter.Radio(true)},
					secConfFac: axwpa.NewConfigFactory(axrouter.Wl2, "helloworld", axrouter.AES, wpa.Mode(wpa.ModePureWPA), wpa.Ciphers(wpa.CipherCCMP)),
				}},
			},
			{
				...
				Val: []axSimpleConnectTestcase{{
					band:       axrouter.Wl2,
					apOpts:     []axrouter.Option{axrouter.Mode(axrouter.Mode80211ax), axrouter.SSID("googleTest0"), axrouter.Hidden(false), axrouter.ChanBandwidth(100, axrouter.Bw40), axrouter.Radio(true)},
					secConfFac: axbase.NewConfigFactory(axrouter.Wl2),
				}},
			},
			{
			...
			},
			{
				...
				Val: []axSimpleConnectTestcase{{
					band:       axrouter.Wl2,
					apOpts:     []axrouter.Option{axrouter.Mode(axrouter.Mode80211ax), axrouter.SSID("googleTest0"), axrouter.Hidden(false), axrouter.ChanBandwidth(100, axrouter.Bw160), axrouter.Radio(true)},
					secConfFac: axbase.NewConfigFactory(axrouter.Wl2),
				}},
			},
		},
...
func AxSimpleConnect(ctx context.Context, s *testing.State) {
	...
	tfOps = append(tfOps, wificell.TFRouterType(common.AxT))
	// Assert WiFi is up.
	...
	backupString, err := rt.SaveConfiguration(ctx)
	if err != nil {
		s.Fatal("Could not save current router configuration: ", err)
	}
	backupMap := make(map[string]axrouter.ConfigParam)
	defer rt.RestoreConfiguration(ctx, backupMap)

	// subroutine to be run by each subtest.
	testOnce := func(ctx context.Context, s *testing.State, band axrouter.BandEnum, options []axrouter.Option, fac security.AxConfigFactory, pingOps []ping.Option, expectedFailure bool) {
