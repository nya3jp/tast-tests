		...
		Params: []testing.Param{
			{
				...
				Val: []axSimpleConnectTestcase{{
					band:       router.Wl2,
					apOpts:     []router.Option{router.Mode(router.Mode80211ax), router.Ssid("googleTest0"), router.Hidden(false), router.ChanBandwidth(100, router.Bw80), router.Radio(true)},
					secConfFac: axbase.NewConfigFactory(router.Wl2),
				}, {
					band:       router.Wl2,
					apOpts:     []router.Option{router.Mode(router.Mode80211ax), router.Ssid("googleTest1"), router.Hidden(false), router.ChanBandwidth(104, router.Bw80), router.Radio(true)},
					secConfFac: axbase.NewConfigFactory(router.Wl2),
				}},
			}, {
				...
				Val: []axSimpleConnectTestcase{{
					band:       router.Wl2,
					apOpts:     []router.Option{router.Mode(router.Mode80211ax), router.Ssid("googleTest0"), router.Hidden(true), router.ChanBandwidth(100, router.Bw80), router.Radio(true)},
					secConfFac: axbase.NewConfigFactory(router.Wl2),
				}, {
					band:       router.Wl2,
					apOpts:     []router.Option{router.Mode(router.Mode80211ax), router.Ssid("googleTest1"), router.Hidden(true), router.ChanBandwidth(104, router.Bw80), router.Radio(true)},
					secConfFac: axbase.NewConfigFactory(router.Wl2),
				}},
			},
			{
				...
				Val: []axSimpleConnectTestcase{{
					band:       router.Wl2,
					apOpts:     []router.Option{router.Mode(router.Mode80211ax), router.Ssid("googleTest0"), router.Hidden(false), router.ChanBandwidth(100, router.Bw80), router.Radio(true)},
					secConfFac: axwpa.NewConfigFactory(router.Wl2, "helloworld", router.AES, wpa.Mode(wpa.ModePureWPA), wpa.Ciphers(wpa.CipherCCMP)),
				}, {
					band:       router.Wl2,
					apOpts:     []router.Option{router.Mode(router.Mode80211ax), router.Ssid("googleTest1"), router.Hidden(false), router.ChanBandwidth(104, router.Bw80), router.Radio(true)},
					secConfFac: axwpa.NewConfigFactory(router.Wl2, "helloworld", router.AES, wpa.Mode(wpa.ModePureWPA), wpa.Ciphers(wpa.CipherCCMP)),
			...
			},
			{
				...
				Val: []axSimpleConnectTestcase{{
					band:       router.Wl2,
					apOpts:     []router.Option{router.Mode(router.Mode80211ax), router.Ssid("googleTest0"), router.Hidden(true), router.ChanBandwidth(100, router.Bw40), router.Radio(true)},
					secConfFac: axwpa.NewConfigFactory(router.Wl2, "helloworld", router.AES, wpa.Mode(wpa.ModePureWPA), wpa.Ciphers(wpa.CipherCCMP)),
				}, {
					band:       router.Wl2,
					apOpts:     []router.Option{router.Mode(router.Mode80211ax), router.Ssid("googleTest1"), router.Hidden(true), router.ChanBandwidth(104, router.Bw40), router.Radio(true)},
					secConfFac: axwpa.NewConfigFactory(router.Wl2, "helloworld", router.AES, wpa.Mode(wpa.ModePureWPA), wpa.Ciphers(wpa.CipherCCMP)),
				}},
			},
			{
				...
				Val: []axSimpleConnectTestcase{{
					band:       router.Wl2,
					apOpts:     []router.Option{router.Mode(router.Mode80211ax), router.Ssid("googleTest0"), router.Hidden(false), router.ChanBandwidth(100, router.Bw40), router.Radio(true)},
					secConfFac: axbase.NewConfigFactory(router.Wl2),
				}},
			},
			{
			...
			},
			{
				...
				Val: []axSimpleConnectTestcase{{
					band:       router.Wl2,
					apOpts:     []router.Option{router.Mode(router.Mode80211ax), router.Ssid("googleTest0"), router.Hidden(false), router.ChanBandwidth(100, router.Bw160), router.Radio(true)},
					secConfFac: axbase.NewConfigFactory(router.Wl2),
				}},
			},
		},
...
func AxSimpleConnect(ctx context.Context, s *testing.State) {
	...
	backupMap := make(map[string]router.AxRouterConfigParam)
