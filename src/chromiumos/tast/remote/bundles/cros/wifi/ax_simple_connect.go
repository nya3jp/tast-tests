...
func init() {
	testing.AddTest(&testing.Test{
		Func: AxSimpleConnect, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Verifies that DUT can connect to an AX host via AP in different WiFi configuration",
		Contacts: []string{
