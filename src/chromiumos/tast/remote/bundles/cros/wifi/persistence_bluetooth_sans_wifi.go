...
func init() {
	testing.AddTest(&testing.Test{
		Func: PersistenceBluetoothSansWifi, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Verifies that Bluetooth remains operational when Wifi is disabled on reboot",
		Contacts: []string{
