...
func init() {
	testing.AddTest(&testing.Test{
		...
		// For some marvell DUT, this test may take more then 15 minutes.
		Timeout: time.Minute * 18,
		// TODO: These models are chosen manually by finding the models that are always failing with NA-error on Autotest network_WiFi_Reset. Replace them with more proper hwdep in the future.
