...
func init() {
	testing.AddTest(&testing.Test{
		Func: DisconnectReason, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Verify the DUT disconnects from an AP and verify the supplicant DisconnectReason for various scenarios",
		Contacts: []string{
