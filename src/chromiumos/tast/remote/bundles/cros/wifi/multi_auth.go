...
/*
This is not a test to check the ability to select the more secure network, it is
to check the ability to identify the target network from APs with similar network
configurations, and connect to the target network correctly, even if it may be
less secure.
*/
