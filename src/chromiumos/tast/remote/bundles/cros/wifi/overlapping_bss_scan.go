...
func OverlappingBSSScan(ctx context.Context, s *testing.State) {
	...
	// outgoing traffic instead of blocking it, this test compares
	// the maximum ping latencies with and without OBSS and make sure
	// the traffic (ping) is not blocked too long.
