		...
		Params: []testing.Param{
			{
				...
				Val: []simpleConnectTestcase{
					{
						apOpts:     []ap.Option{ap.Mode(ap.Mode80211g), ap.Channel(1)},
						secConfFac: wep.NewConfigFactory(wepKeys40(), wep.DefaultKey(0), wep.AuthAlgs(wep.AuthAlgsOpen)),
					},
					{
						apOpts:     []ap.Option{ap.Mode(ap.Mode80211g), ap.Channel(1)},
						secConfFac: wep.NewConfigFactory(wepKeys40(), wep.DefaultKey(1), wep.AuthAlgs(wep.AuthAlgsOpen)),
					},
					{
						apOpts:     []ap.Option{ap.Mode(ap.Mode80211g), ap.Channel(1)},
						secConfFac: wep.NewConfigFactory(wepKeys40(), wep.DefaultKey(2), wep.AuthAlgs(wep.AuthAlgsOpen)),
					},
					{
						apOpts:     []ap.Option{ap.Mode(ap.Mode80211g), ap.Channel(1)},
						secConfFac: wep.NewConfigFactory(wepKeys40(), wep.DefaultKey(3), wep.AuthAlgs(wep.AuthAlgsOpen)),
					},
					{
						apOpts:     []ap.Option{ap.Mode(ap.Mode80211g), ap.Channel(1)},
						secConfFac: wep.NewConfigFactory(wepKeys40(), wep.DefaultKey(0), wep.AuthAlgs(wep.AuthAlgsShared)),
					},
					{
						apOpts:     []ap.Option{ap.Mode(ap.Mode80211g), ap.Channel(1)},
						secConfFac: wep.NewConfigFactory(wepKeys40(), wep.DefaultKey(1), wep.AuthAlgs(wep.AuthAlgsShared)),
					},
					{
						apOpts:     []ap.Option{ap.Mode(ap.Mode80211g), ap.Channel(1)},
						secConfFac: wep.NewConfigFactory(wepKeys40(), wep.DefaultKey(2), wep.AuthAlgs(wep.AuthAlgsShared)),
					},
					{
						apOpts:     []ap.Option{ap.Mode(ap.Mode80211g), ap.Channel(1)},
						secConfFac: wep.NewConfigFactory(wepKeys40(), wep.DefaultKey(3), wep.AuthAlgs(wep.AuthAlgsShared)),
					},
				},
			}, {
				...
				Val: []simpleConnectTestcase{
					{
						apOpts:     []ap.Option{ap.Mode(ap.Mode80211g), ap.Channel(1)},
						secConfFac: wep.NewConfigFactory(wepKeys104(), wep.DefaultKey(0), wep.AuthAlgs(wep.AuthAlgsOpen)),
					},
					{
						apOpts:     []ap.Option{ap.Mode(ap.Mode80211g), ap.Channel(1)},
						secConfFac: wep.NewConfigFactory(wepKeys104(), wep.DefaultKey(1), wep.AuthAlgs(wep.AuthAlgsOpen)),
					},
					{
						apOpts:     []ap.Option{ap.Mode(ap.Mode80211g), ap.Channel(1)},
						secConfFac: wep.NewConfigFactory(wepKeys104(), wep.DefaultKey(2), wep.AuthAlgs(wep.AuthAlgsOpen)),
					},
					{
						apOpts:     []ap.Option{ap.Mode(ap.Mode80211g), ap.Channel(1)},
						secConfFac: wep.NewConfigFactory(wepKeys104(), wep.DefaultKey(3), wep.AuthAlgs(wep.AuthAlgsOpen)),
					},
					{
						apOpts:     []ap.Option{ap.Mode(ap.Mode80211g), ap.Channel(1)},
						secConfFac: wep.NewConfigFactory(wepKeys104(), wep.DefaultKey(0), wep.AuthAlgs(wep.AuthAlgsShared)),
					},
					{
						apOpts:     []ap.Option{ap.Mode(ap.Mode80211g), ap.Channel(1)},
						secConfFac: wep.NewConfigFactory(wepKeys104(), wep.DefaultKey(1), wep.AuthAlgs(wep.AuthAlgsShared)),
					},
					{
						apOpts:     []ap.Option{ap.Mode(ap.Mode80211g), ap.Channel(1)},
						secConfFac: wep.NewConfigFactory(wepKeys104(), wep.DefaultKey(2), wep.AuthAlgs(wep.AuthAlgsShared)),
					},
					{
						apOpts:     []ap.Option{ap.Mode(ap.Mode80211g), ap.Channel(1)},
						secConfFac: wep.NewConfigFactory(wepKeys104(), wep.DefaultKey(3), wep.AuthAlgs(wep.AuthAlgsShared)),
					},
				},
			}, {
				...
				Val: []simpleConnectTestcase{
					{
						...
						secConfFac: wep.NewConfigFactory(wepKeys40Hidden(), wep.AuthAlgs(wep.AuthAlgsOpen)),
					},
					{
						apOpts:     []ap.Option{ap.Mode(ap.Mode80211g), ap.Channel(1), ap.Hidden()},
						secConfFac: wep.NewConfigFactory(wepKeys40Hidden(), wep.AuthAlgs(wep.AuthAlgsShared)),
					},
					{
						apOpts:     []ap.Option{ap.Mode(ap.Mode80211g), ap.Channel(1), ap.Hidden()},
						secConfFac: wep.NewConfigFactory(wepKeys104Hidden(), wep.AuthAlgs(wep.AuthAlgsOpen)),
					},
					{
						apOpts:     []ap.Option{ap.Mode(ap.Mode80211g), ap.Channel(1), ap.Hidden()},
						secConfFac: wep.NewConfigFactory(wepKeys104Hidden(), wep.AuthAlgs(wep.AuthAlgsShared)),
					},
				},
			}, {
