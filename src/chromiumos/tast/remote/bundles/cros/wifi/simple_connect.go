	...
	testing.AddTest(&testing.Test{
		...
		Params: []testing.Param{
			// Parameters generated by simple_connect_test.go. DO NOT EDIT.
			{
				...
				ExtraAttr: []string{"wificell_cq"},
				Val: []simpleConnectTestcase{{
					apOpts: util.CommonAPOptions(ap.SSID("a")),
				}, {
					apOpts: util.CommonAPOptions(ap.SSID(strings.Repeat("MaxLengthSSID", 4)[:32])),
				}},
			}, {
				...
				Val: []simpleConnectTestcase{{
					...
					apOpts: util.CommonAPOptions(ap.SSID(byteSequenceStr(1, 31) + "\x00")),
				}, {
					apOpts: util.CommonAPOptions(ap.SSID(byteSequenceStr(32, 63))),
				}, {
					apOpts: util.CommonAPOptions(ap.SSID(byteSequenceStr(64, 95))),
				}, {
					apOpts: util.CommonAPOptions(ap.SSID(byteSequenceStr(96, 127))),
				}, {
					apOpts: util.CommonAPOptions(ap.SSID(byteSequenceStr(128, 159))),
				}, {
					apOpts: util.CommonAPOptions(ap.SSID(byteSequenceStr(160, 191))),
				}, {
					apOpts: util.CommonAPOptions(ap.SSID(byteSequenceStr(192, 223))),
				}, {
					apOpts: util.CommonAPOptions(ap.SSID(byteSequenceStr(224, 255))),
				}, {
					// Valid Unicode characters.
					apOpts: util.CommonAPOptions(ap.SSID("\xe4\xb8\xad\xe5\x9b\xbd")),
				}, {
					// Single extended ASCII character (a-grave).
					apOpts: util.CommonAPOptions(ap.SSID("\xe0")),
				}, {
					// Mix of ASCII and Unicode characters as SSID.
					apOpts: util.CommonAPOptions(ap.SSID("Chrome\xe7\xac\x94\xe8\xae\xb0\xe6\x9c\xac")),
				}},
