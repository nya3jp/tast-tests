		...
		Params: []testing.Param{
			{
				...
				Val: []simpleConnectTestcase{
					{
						apOpts:     []ap.Option{ap.Mode(ap.Mode80211g), ap.Channel(1)},
						secConfFac: wep.NewConfigFactory(wep40Keys(), wep.DefaultKey(0), wep.AuthAlgs(wep.AuthAlgsOpen)),
					},
					{
						apOpts:     []ap.Option{ap.Mode(ap.Mode80211g), ap.Channel(1)},
						secConfFac: wep.NewConfigFactory(wep40Keys(), wep.DefaultKey(1), wep.AuthAlgs(wep.AuthAlgsOpen)),
					},
					{
						apOpts:     []ap.Option{ap.Mode(ap.Mode80211g), ap.Channel(1)},
						secConfFac: wep.NewConfigFactory(wep40Keys(), wep.DefaultKey(2), wep.AuthAlgs(wep.AuthAlgsOpen)),
					},
					{
						apOpts:     []ap.Option{ap.Mode(ap.Mode80211g), ap.Channel(1)},
						secConfFac: wep.NewConfigFactory(wep40Keys(), wep.DefaultKey(3), wep.AuthAlgs(wep.AuthAlgsOpen)),
					},
					{
						apOpts:     []ap.Option{ap.Mode(ap.Mode80211g), ap.Channel(1)},
						secConfFac: wep.NewConfigFactory(wep40Keys(), wep.DefaultKey(0), wep.AuthAlgs(wep.AuthAlgsShared)),
					},
					{
						apOpts:     []ap.Option{ap.Mode(ap.Mode80211g), ap.Channel(1)},
						secConfFac: wep.NewConfigFactory(wep40Keys(), wep.DefaultKey(1), wep.AuthAlgs(wep.AuthAlgsShared)),
					},
					{
						apOpts:     []ap.Option{ap.Mode(ap.Mode80211g), ap.Channel(1)},
						secConfFac: wep.NewConfigFactory(wep40Keys(), wep.DefaultKey(2), wep.AuthAlgs(wep.AuthAlgsShared)),
					},
					{
						apOpts:     []ap.Option{ap.Mode(ap.Mode80211g), ap.Channel(1)},
						secConfFac: wep.NewConfigFactory(wep40Keys(), wep.DefaultKey(3), wep.AuthAlgs(wep.AuthAlgsShared)),
					},
				},
			}, {
				...
				Val: []simpleConnectTestcase{
					{
						apOpts:     []ap.Option{ap.Mode(ap.Mode80211g), ap.Channel(1)},
						secConfFac: wep.NewConfigFactory(wep104Keys(), wep.DefaultKey(0), wep.AuthAlgs(wep.AuthAlgsOpen)),
					},
					{
						apOpts:     []ap.Option{ap.Mode(ap.Mode80211g), ap.Channel(1)},
						secConfFac: wep.NewConfigFactory(wep104Keys(), wep.DefaultKey(1), wep.AuthAlgs(wep.AuthAlgsOpen)),
					},
					{
						apOpts:     []ap.Option{ap.Mode(ap.Mode80211g), ap.Channel(1)},
						secConfFac: wep.NewConfigFactory(wep104Keys(), wep.DefaultKey(2), wep.AuthAlgs(wep.AuthAlgsOpen)),
					},
					{
						apOpts:     []ap.Option{ap.Mode(ap.Mode80211g), ap.Channel(1)},
						secConfFac: wep.NewConfigFactory(wep104Keys(), wep.DefaultKey(3), wep.AuthAlgs(wep.AuthAlgsOpen)),
					},
					{
						apOpts:     []ap.Option{ap.Mode(ap.Mode80211g), ap.Channel(1)},
						secConfFac: wep.NewConfigFactory(wep104Keys(), wep.DefaultKey(0), wep.AuthAlgs(wep.AuthAlgsShared)),
					},
					{
						apOpts:     []ap.Option{ap.Mode(ap.Mode80211g), ap.Channel(1)},
						secConfFac: wep.NewConfigFactory(wep104Keys(), wep.DefaultKey(1), wep.AuthAlgs(wep.AuthAlgsShared)),
					},
					{
						apOpts:     []ap.Option{ap.Mode(ap.Mode80211g), ap.Channel(1)},
						secConfFac: wep.NewConfigFactory(wep104Keys(), wep.DefaultKey(2), wep.AuthAlgs(wep.AuthAlgsShared)),
					},
					{
						apOpts:     []ap.Option{ap.Mode(ap.Mode80211g), ap.Channel(1)},
						secConfFac: wep.NewConfigFactory(wep104Keys(), wep.DefaultKey(3), wep.AuthAlgs(wep.AuthAlgsShared)),
					},
				},
			}, {
				...
				Val: []simpleConnectTestcase{
					{
						...
						secConfFac: wep.NewConfigFactory(wep40KeysHidden(), wep.AuthAlgs(wep.AuthAlgsOpen)),
					},
					{
						apOpts:     []ap.Option{ap.Mode(ap.Mode80211g), ap.Channel(1), ap.Hidden()},
						secConfFac: wep.NewConfigFactory(wep40KeysHidden(), wep.AuthAlgs(wep.AuthAlgsShared)),
					},
					{
						apOpts:     []ap.Option{ap.Mode(ap.Mode80211g), ap.Channel(1), ap.Hidden()},
						secConfFac: wep.NewConfigFactory(wep104KeysHidden(), wep.AuthAlgs(wep.AuthAlgsOpen)),
					},
					{
						apOpts:     []ap.Option{ap.Mode(ap.Mode80211g), ap.Channel(1), ap.Hidden()},
						secConfFac: wep.NewConfigFactory(wep104KeysHidden(), wep.AuthAlgs(wep.AuthAlgsShared)),
					},
				},
			}, {
