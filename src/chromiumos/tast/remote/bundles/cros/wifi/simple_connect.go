					...
					testcases: []simpleConnectTestcase{
						{
							...
							genSecurityConfig: secconf.WpaGenerator{
								secconf.Psk("chromeos"), secconf.WpaMode(secconf.WpaPure),
					...
					testcases: []simpleConnectTestcase{
						{
							apOptions: []hostapd.Option{hostapd.Mode(hostapd.Mode80211g), hostapd.Channel(1)},
							genSecurityConfig: secconf.WpaGenerator{
								secconf.Psk("chromeos"), secconf.WpaMode(secconf.Wpa2Pure),
					...
					testcases: []simpleConnectTestcase{
						{
							apOptions: []hostapd.Option{hostapd.Mode(hostapd.Mode80211g), hostapd.Channel(1)},
							genSecurityConfig: secconf.WpaGenerator{
								secconf.Psk("chromeos"), secconf.WpaMode(secconf.WpaMixed),
								secconf.WpaCiphers(secconf.CipherTKIP, secconf.CipherCCMP),
								secconf.Wpa2Ciphers(secconf.CipherCCMP),
							},
						},
					...
					testcases: []simpleConnectTestcase{
						{
							apOptions: []hostapd.Option{hostapd.Mode(hostapd.Mode80211g), hostapd.Channel(1)},
							genSecurityConfig: secconf.WpaGenerator{
								secconf.Psk("\xe4\xb8\x80\xe4\xba\x8c\xe4\xb8\x89"), secconf.WpaMode(secconf.WpaPure),
								secconf.WpaCiphers(secconf.CipherTKIP),
							},
						},
						{
							apOptions: []hostapd.Option{hostapd.Mode(hostapd.Mode80211g), hostapd.Channel(1)},
							genSecurityConfig: secconf.WpaGenerator{
								secconf.Psk("\xe4\xb8\x80\xe4\xba\x8c\xe4\xb8\x89"), secconf.WpaMode(secconf.Wpa2Pure),
								secconf.Wpa2Ciphers(secconf.CipherCCMP),
							},
						},
						{
							apOptions: []hostapd.Option{hostapd.Mode(hostapd.Mode80211g), hostapd.Channel(1)},
							genSecurityConfig: secconf.WpaGenerator{
								secconf.Psk("abcdef\xc2\xa2"), secconf.WpaMode(secconf.WpaPure),
								secconf.WpaCiphers(secconf.CipherTKIP),
							},
						},
						{
							apOptions: []hostapd.Option{hostapd.Mode(hostapd.Mode80211g), hostapd.Channel(1)},
							genSecurityConfig: secconf.WpaGenerator{
								secconf.Psk("abcdef\xc2\xa2"), secconf.WpaMode(secconf.Wpa2Pure),
								secconf.Wpa2Ciphers(secconf.CipherCCMP),
							},
						},
						{
							apOptions: []hostapd.Option{hostapd.Mode(hostapd.Mode80211g), hostapd.Channel(1)},
							genSecurityConfig: secconf.WpaGenerator{
								secconf.Psk(" !\"#$%&'()>*+,-./:;<=>?@[\\]^_{|}~"), secconf.WpaMode(secconf.WpaPure),
								secconf.WpaCiphers(secconf.CipherTKIP),
							},
						},
						{
							apOptions: []hostapd.Option{hostapd.Mode(hostapd.Mode80211g), hostapd.Channel(1)},
							genSecurityConfig: secconf.WpaGenerator{
								secconf.Psk(" !\"#$%&'()>*+,-./:;<=>?@[\\]^_{|}~"), secconf.WpaMode(secconf.Wpa2Pure),
								secconf.Wpa2Ciphers(secconf.CipherCCMP),
							},
						},
					},
