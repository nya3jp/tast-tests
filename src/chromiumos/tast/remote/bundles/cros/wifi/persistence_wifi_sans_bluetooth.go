...
func init() {
	testing.AddTest(&testing.Test{
		Func: PersistenceWifiSansBluetooth, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Verifies that WiFi remains operational when Bluetooth is disabled on reboot",
		Contacts: []string{
