...
func init() {
	testing.AddTest(&testing.Test{
		...
		Desc:        "Ensures that the DNS server points portal detection queries to a fake HTTP server that responds with '302 Redirect' with a Redirect URL. This results in a service state of 'redirect-found' for the WiFi service",
