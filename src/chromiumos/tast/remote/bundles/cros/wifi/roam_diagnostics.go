...
const (
	diagnosticsAP1BSSID = "00:11:22:33:44:55"
	diagnosticsAP2BSSID = "00:11:22:33:44:56"
	diagnosticsAP3BSSID = "00:11:22:33:44:57"
)
		...
		Params: []testing.Param{
			{
				Val: roamDiagnosticsTestcase{
					apOpts1:    []hostapd.Option{hostapd.Mode(hostapd.Mode80211nPure), hostapd.Channel(1), hostapd.HTCaps(hostapd.HTCapHT20), hostapd.BSSID(diagnosticsAP1BSSID), hostapd.SSID(roamDiagnosticsSSID)},
					apOpts2:    []hostapd.Option{hostapd.Mode(hostapd.Mode80211nPure), hostapd.Channel(2), hostapd.HTCaps(hostapd.HTCapHT20), hostapd.BSSID(diagnosticsAP2BSSID), hostapd.SSID(roamDiagnosticsSSID)},
					apOpts3:    []hostapd.Option{hostapd.Mode(hostapd.Mode80211nPure), hostapd.Channel(36), hostapd.HTCaps(hostapd.HTCapHT20), hostapd.BSSID(diagnosticsAP3BSSID), hostapd.SSID(roamDiagnosticsSSID)},
					secConfFac: nil,
				},
			},
		},
...
func RoamDiagnostics(ctx context.Context, s *testing.State) {
	...
	param := s.Param().(roamDiagnosticsTestcase)
	...
	executeRoamDiagnosticsTest(ctx, s, [][]hostapd.Option{param.apOpts1, param.apOpts2}, 0, param.secConfFac, &stats)
	executeRoamDiagnosticsTest(ctx, s, [][]hostapd.Option{param.apOpts1, param.apOpts3}, 1, param.secConfFac, &stats)
