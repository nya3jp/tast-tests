...
func init() {
	testing.AddTest(&testing.Test{
		Func: BgscanBackoff, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Verifies that bgscan aborts and/or backs off when there is consistent outgoing traffic",
		Contacts: []string{
