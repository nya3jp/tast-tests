...
func init() {
	testing.AddTest(&testing.Test{
		Func: ReconnectInDarkResume, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Verifies that the DUT can reconnect to an autoconnectable AP during dark resume",
		Contacts: []string{
