		...
		Params: []testing.Param{
			{
				...
				Val: anqpTestCase{
					...
					names:              []hostapd.VenueName{{"eng", "Foo bar"}},
				...
				Val: anqpTestCase{
					...
					names:              []hostapd.VenueName{{"eng", "My favorite hotel"}},
				...
				Val: anqpTestCase{
					...
					names:              []hostapd.VenueName{{"eng", "Foo station"}},
				...
				Val: anqpTestCase{
					...
					names:              []hostapd.VenueName{{"eng", "Bar amphitheater"}},
...
func ANQP(ctx context.Context, s *testing.State) {
	...
	if !reflect.DeepEqual(rcs, tc.roamingConsortiums) {
		s.Fatalf("Roaming consortium OI are not matching: got %v want %v", rcs, tc.roamingConsortiums)
	}
