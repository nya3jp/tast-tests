...
func init() {
	testing.AddTest(&testing.Test{
		Func: FunctionalAfterCSA, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Verifies that the DUT can still connect to the AP when it is disconnected right after receiving a CSA message. This is to make sure the MAC 80211 queues are not stuck after receiving CSA and disconnect events consecutively. Refer to crbug.com/408370 for more information to the test description",
		Contacts: []string{
