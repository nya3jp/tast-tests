...
func init() {
	testing.AddTest(&testing.Test{
		Func:         AppServiceGRPC,
		Desc:         "Check basic functionalities of AppService",
...
// AppServiceGRPC tests basic functionalities of UI AppService.
func AppServiceGRPC(ctx context.Context, s *testing.State) {
	...
	appsSvc := pb.NewAppServiceClient(cl.Conn)
