...
func init() {
	testing.AddTest(&testing.Test{
		Func:         ShutdownPwrbuttonStressTabletMode,
		Desc:         "Verifies stress test shutdown using power button in tabletmode",
...
// ShutdownPwrbuttonStressTabletMode Perform shutdown using power button in tabletmode.
func ShutdownPwrbuttonStressTabletMode(ctx context.Context, s *testing.State) {
	dut := s.DUT()
...
// powerOnDut power on DUT after pwr button long press.
func powerOnDut(ctx context.Context, pxy *servo.Proxy, d *dut.DUT) error {
