...
func HDMIAdapterColdboot(ctx context.Context, s *testing.State) {
	...
	defer func(ctx context.Context) {
		if !dut.Connected(ctx) {
			if err := wakeDUTOn(ctx, pxy, dut); err != nil {
	...
	loginChrome := func(ctx context.Context) {
		...
		if err := extendedDisplayDetection(ctx, dut, 1); err != nil {
...
func extendedDisplayDetection(ctx context.Context, dut *dut.DUT, numberOfDisplays int) error {
...
func wakeDUTOn(ctx context.Context, pxy *servo.Proxy, dut *dut.DUT) error {
