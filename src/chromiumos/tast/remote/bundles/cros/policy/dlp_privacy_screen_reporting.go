...
func init() {
	testing.AddTest(&testing.Test{
		Func:         DlpSPrivacyScreenReporting,
...
func DlpSPrivacyScreenReporting(ctx context.Context, s *testing.State) {
	dlputil.DlpActionReporting(ctx, s, dlputil.PrivacyScreen)
}
