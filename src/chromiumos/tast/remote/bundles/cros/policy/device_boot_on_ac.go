...
func init() {
	testing.AddTest(&testing.Test{
		Func: DeviceBootOnAC, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Tests the DeviceBootOnAcEnabled policy that boots up the DUT from shutdown by plugging in a power supply",
		Contacts: []string{
