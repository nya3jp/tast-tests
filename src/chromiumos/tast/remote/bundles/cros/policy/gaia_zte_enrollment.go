		...
		Params: []testing.Param{
			{
				Name: "autopush",
				Val: testInformation{
					username: "policy.GAIAZTEEnrollment.user_name",
					password: "policy.GAIAZTEEnrollment.password",
					dmserver: "https://crosman-alpha.sandbox.google.com/devicemanagement/data/api",
				},
			},
		},
		Vars: []string{
			"policy.GAIAZTEEnrollment.user_name",
			"policy.GAIAZTEEnrollment.password",
		},
	})
}

func GAIAZTEEnrollment(ctx context.Context, s *testing.State) {
	param := s.Param().(testInformation)
