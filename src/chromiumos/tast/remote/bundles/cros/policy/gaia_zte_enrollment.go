...
func GAIAZTEEnrollment(ctx context.Context, s *testing.State) {
	...
	// Setting the RLZ ping embargo end date. vpd -i RW_VPD -s rlz_embargo_end_date="2022-08-14"
	...
	// This is needed here until rzakarian figures out how to check for enrollment completed screen.
