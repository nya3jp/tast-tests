...
func init() {
	testing.AddTest(&testing.Test{
		...
		// Var "servo" is a ServoV4 Type-A device coupled with a Servo Micro through the micro USB port.
		// This hardware config is connected to DUT on a USB-A port with a lightning bolt or battery icon.
		Vars: []string{"servo"},
	})
}
