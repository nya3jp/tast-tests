...
func init() {
	testing.AddTest(&testing.Test{
		Func: DeviceUSBPowershare, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Tests the DeviceUsbPowerShareEnabled policy that shares power through USB when the device is off",
		Contacts: []string{
