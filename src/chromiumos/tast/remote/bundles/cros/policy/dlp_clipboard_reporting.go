		...
		Params: []testing.Param{
			{
				...
				Val: clipboardTestParams{
					...
					password:         dlputil.RestrictionBlockReportingEnabledUsername,
					mode:             dlp.Mode_BLOCK,
			...
			},
			{
				...
				Val: clipboardTestParams{
					...
					password:         dlputil.RestrictionWarnReportingEnabledUsername,
			...
			},
			{
				...
				Val: clipboardTestParams{
					...
					password:         dlputil.RestrictionReportReportingEnabledUsername,
			...
			},
			{
				...
				Val: clipboardTestParams{
					...
					password:         dlputil.RestrictionAllowReportingEnabledUsername,
					mode:             dlp.Mode_ALLOW,
					browserType:      dlp.BrowserType_ASH,
					reportingEnabled: true,
				},
