...
func init() {
	testing.AddTest(&testing.Test{
		Func: RollbackWithNebraska, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Example test for the enterprise rollback update using Nebraska and test images",
		Contacts: []string{
