...
func BasicNToM(ctx context.Context, s *testing.State) {
	autoupdatelib.NToMTest(ctx, s, &autoupdatelib.Ops{
		PreUpdate:    autoupdatelib.NoOp,
		PostUpdate:   autoupdatelib.NoOp,
		PostRollback: autoupdatelib.NoOp,
		CleanUp:      autoupdatelib.NoOp,
	}, /*deltaM=*/ 3)
}
