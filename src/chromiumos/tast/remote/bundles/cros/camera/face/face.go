...
func GetFaceLumaValue(ctx context.Context, d *dut.DUT, facing pb.Facing, enableFaceAe bool, outdir, sceneLog string) (int64, error) {
	sceneLog = fmt.Sprintf("/tmp/%s_%t.i420", sceneLog, enableFaceAe)
