...
func init() {
	testing.AddTest(&testing.Test{
		Func: CameraboxAlign, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Verifying alignment of chart tablet screen and target facing camera FOV in camerabox setup",
