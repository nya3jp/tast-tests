		...
		Params: []testing.Param{
			{
				...
				ExtraData:         []string{pre.DocumentScene().DataPath()},
			...
			},
			{
				...
				ExtraAttr: []string{"camerabox_facing_back"},
				ExtraData: []string{pre.HumanFaceScene().DataPath()},
				Pre:       pre.HumanFaceScene(),
				Val:       &pb.CCATestRequest{Test: pb.CCATest_PORTRAIT_MODE, Facing: pb.Facing_FACING_BACK},
			},
			{
				...
				ExtraData: []string{pre.HumanFaceScene().DataPath()},
				Pre:       pre.HumanFaceScene(),
				Val:       &pb.CCATestRequest{Test: pb.CCATest_PORTRAIT_MODE, Facing: pb.Facing_FACING_FRONT},
			},
		},
	})
}
