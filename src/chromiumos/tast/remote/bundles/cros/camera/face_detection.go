		...
		Params: []testing.Param{
			testing.Param{
				...
				Val: faceDetectionParams{
					...
					runTestRequest: &pb.RunTestRequest{Test: pb.HAL3CameraTest_FACE_DETECTION, Facing: pb.Facing_FACING_BACK, ExtendedParams: fmt.Sprintf("%d=3", pb.HAL3ExtendedParams_ExpectedNumFaces)},
				},
			...
			testing.Param{
				...
				Val: faceDetectionParams{
					...
					runTestRequest: &pb.RunTestRequest{Test: pb.HAL3CameraTest_FACE_DETECTION, Facing: pb.Facing_FACING_FRONT, ExtendedParams: fmt.Sprintf("%d=3", pb.HAL3ExtendedParams_ExpectedNumFaces)},
				},
				Timeout: 15 * time.Minute,
			},
		},
