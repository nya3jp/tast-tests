	...
	testing.AddTest(&testing.Test{
		...
		Params: []testing.Param{
			testing.Param{
				...
				Val:       &pb.RunTestRequest{Test: pb.HAL3CameraTest_FACE_DETECTION, Facing: pb.Facing_FACING_BACK, ExtendedParams: "3"},
				Timeout:   15 * time.Minute,
			},
			testing.Param{
				Name:      "front",
				ExtraAttr: []string{"camerabox_facing_front"},
				Val:       &pb.RunTestRequest{Test: pb.HAL3CameraTest_FACE_DETECTION, Facing: pb.Facing_FACING_FRONT, ExtendedParams: "3"},
				Timeout:   15 * time.Minute,
			},
		},
	})
