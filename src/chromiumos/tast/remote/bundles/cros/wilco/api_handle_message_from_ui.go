...
func APIHandleMessageFromUi(ctx context.Context, s *testing.State) { // NOLINT
	...
	if _, err := pc.EvalOnTestAPIConn(ctx, &ps.EvalOnTestAPIConnRequest{
		Expression: "chrome.runtime.sendNativeMessage('com.google.wilco_dtc', {'request': 'kProcCpuinfo'}); true",
	}); err != nil {
