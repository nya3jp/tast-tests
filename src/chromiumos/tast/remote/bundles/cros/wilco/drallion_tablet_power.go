...
func DrallionTabletPower(ctx context.Context, s *testing.State) {
	...
	Clamshell mode:
		Power menu appears after power key press of any duration

	Tablet mode:
		Power menu only appears after power key press > 1.5 seconds
		DUT only powers down after power key press > 8.0 seconds
	*/
