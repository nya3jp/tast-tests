...
func init() {
	testing.AddTest(&testing.Test{
		Func: APIGetConfigurationData, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Test sending GetConfigurationData gRPC request from Wilco DTC VM to the Wilco DTC Support Daemon",
		Contacts: []string{
