...
func drive032GDUT(ctx context.Context, dut *utils.Device) error {
...
func cleanup032GDUT(ctx context.Context, dut *utils.Device) {
...
func MTBF032GVideoRecording(ctx context.Context, s *testing.State) {
	...
	report, _, err := androidTest.RunDelegate(ctx, sdk.CaseDescription{
		...
		if err := drive032GDUT(ctx, dutDev); err != nil {
