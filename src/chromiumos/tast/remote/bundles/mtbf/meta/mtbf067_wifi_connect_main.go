...
func init() {
	testing.AddTest(&testing.Test{
		Func:         MTBF067WifiConnectMain,
		Desc:         "Remote main case of MTBF067 802.11.ac wave1 Support. It will call local case MTBF067WifiConnectin DUT",
...
//MTBF067WifiConnectMain Remote main case of MTBF067 802.11.ac wave1 Support. It will call local case MTBF067WifiConnectin DUT
func MTBF067WifiConnectMain(ctx context.Context, s *testing.State) {
	s.Log("Start to run MTBF067WifiConnect sub case")
	localTestName := "wifi.MTBF067WifiConnect"
	...
	if err := common.PollDetachedCaseDone(ctx, s, detachStatusSvr, dutID, localTestName); err != nil {
		s.Fatal(mtbferrors.New(mtbferrors.WIFIDtchPollSubCase, err, "MTBF067"))
	}
