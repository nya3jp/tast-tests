...
func init() {
	testing.AddTest(&testing.Test{
		Func:     MTBF004GYoutubeVideoPlaying,
...
func MTBF004GYoutubeVideoPlaying(ctx context.Context, s *testing.State) {
	...
	report, _, mtbferr := androidTest.RunDelegate(ctx, sdk.CaseDescription{
		...
		if err := verifyYoutubeVideoPlaying(ctx, s, dutDev); err != nil {
