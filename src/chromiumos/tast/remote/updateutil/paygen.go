...
// LoadPaygenFromGS download the paygen.json file, parses it, and return with the Paygen object.
...
// FilterBoardChannelDeltaType filters the Paygen object based on the board, channel and delta type.
...
// FilterMilestone filters the Paygen object based on the milestone.
