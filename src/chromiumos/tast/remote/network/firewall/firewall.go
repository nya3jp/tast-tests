...
const (
	// InputChain chain for packents meant for delivery to local sockets.
...
const (
	...
	// TargetDrop drops packet silantly and stops processing rules.
	TargetDrop Target = "DROP"
	// There ar other targets possible, extend enum if necessary.
)
