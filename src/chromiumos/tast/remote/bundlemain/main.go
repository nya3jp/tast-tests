...
func testHookRemote(ctx context.Context, s *testing.TestHookState) func(ctx context.Context,
	...
	return func(ctx context.Context, s *testing.TestHookState) {
		...
		downloadVarMsgLogs(ctx, s, dir, dut, s.CompanionDUTs())
...
func downloadVarMsgLogs(ctx context.Context, s *testing.TestHookState, outputDir string, primaryDut *dut.DUT, companionDuts map[string]*dut.DUT) {
