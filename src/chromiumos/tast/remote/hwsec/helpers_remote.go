...
func NewHelper(d *dut.DUT) (*helperRemote, error) {
	return &helperRemote{hwsec.Helper{}, d}, nil
}

// EnsureTPMIsReset ensures the TPM is reset when the function returns |nil|.
// Otherwise, returns any encountered error.
func (h *helperRemote) EnsureTPMIsReset(ctx context.Context, r hwsec.CmdRunner, utility hwsec.Utility) error {
