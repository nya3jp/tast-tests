...
func (h *Helper) CheckBootMode(ctx context.Context, bootMode fwCommon.BootMode) (bool, error) {
...
func (h *Helper) RebootToMode(ctx context.Context, toMode fwCommon.BootMode) error {
	if err := h.RequireRPCUtils(ctx); err != nil {
	...
	if ok, err := h.CheckBootMode(ctx, toMode); err != nil {
...
func (h *Helper) poweroff(ctx context.Context) error {
