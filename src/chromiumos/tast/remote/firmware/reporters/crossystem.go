...
var knownCrossystemParams = []CrossystemParam{CrossystemParamMainfwType, CrossystemParamKernkeyVfy}
...
// CrossystemParam returns the value of the key from crossystem <key> command.
func (r *Reporter) CrossystemParam(ctx context.Context, key CrossystemParam) (string, error) {
...
// filterCrossystemParams removes any key from m that are not in keys.
