...
// methods and always reconstruct rpc clients using RPC().
// This is because RPCDUT sets up hooks for Reboot that allow us to
// reconnect the RPC connection, but the rpc client will be invalidated.
//
