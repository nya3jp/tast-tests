...
func expectedFlashProtectOutput(fpBoard FPBoardName, curImage fw.FWCopy, softwareWriteProtectEnabled, hardwareWriteProtectEnabled bool) string {
	expectedOutput := ""
...
func SetSoftwareWriteProtect(ctx context.Context, d *dut.DUT, enable bool) error {
	...
	if err := RebootFpmcu(ctx, d, fw.FWCopyRW); err != nil {
...
func CheckWriteProtectStateCorrect(ctx context.Context, d *dut.DUT, fpBoard FPBoardName, curImage fw.FWCopy, softwareWriteProtectEnabled, hardwareWriteProtectEnabled bool) error {
