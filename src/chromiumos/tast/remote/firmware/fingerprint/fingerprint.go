...
const (
	...
	fwInfoTypeRoVersion fwInfoType = iota
	fwInfoTypeRwVersion fwInfoType = iota
	fwInfoTypeKeyID     fwInfoType = iota
)
...
var firmwareVersionMap = map[string]map[string]firmwareMetadata{
...
func getExpectedFwInfo(fpBoard, buildFwFile string, infoType fwInfoType) (string, error) {
	...
	default:
		return "", errors.Errorf("unable to get firmware info type: %d", infoType)
	}
}
