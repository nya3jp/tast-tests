...
func InitializeKnownState(ctx context.Context, d *rpcdut.RPCDUT, outdir string, pxy *servo.Proxy, fpBoard fp.FPBoardName, firmwareFile FirmwareFile, needsRebootAfterFlashing, removeSWWP bool) error {
