...
[`codelab_basic.go`]: ./codelab_basic.go
...
At this point (after running `gofmt`), your test file should resemble [`codelab_dependency.go`].

[go/tast-deps]: http://goto.google.com/tast-deps
[`codelab_dependency.go`]: ./codelab_dependency.go
...
At this point (after running `gofmt`), your test file should resemble [`codelab_reporter.go`].
...
[`codelab_reporter.go`]: ./codelab_reporter.go
...
At this point (after running `gofmt`), your test file should resemble [`codelab_config.go`].
...
[`codelab_config.go`]: ./codelab_config.go
...
At this point (after running `gofmt`), your test file should resemble [`codelab_servo.go`].
...
[`codelab_servo.go`]: ./codelab_servo.go
...
At this point (after running `gofmt`), your test file should resemble [`codelab_rpc.go`].
...
At this point (after running `gofmt`), your test file should resemble [`codelab_helper.go`].
...
[`codelab_helper.go`]: ./codelab_helper.go
...
At this point (after running `gofmt`), your test file should resemble [`codelab_boot_mode.go`].
...
[`codelab_boot_mode.go`]: ./codelab_boot_mode.go
...
At this point (after running `gofmt`), your test file should resemble [`codelab_pre.go`].
