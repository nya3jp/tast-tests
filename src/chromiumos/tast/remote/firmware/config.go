...
// CfgFilename is the relative path from data/ to the .json file containing all platforms' config data.
// It is intended to be used in the Data field of a testing.Test declaration.
var CfgFilename = filepath.Join(cfgDirName, consolidatedBasename)
...
// cfgFilepath should take s.DataPath(firmware.CfgFilename).
