...
func (d *EmulatedBTPeerDevice) initializeEmulatedBTPeerDevice(ctx context.Context, deviceConfig *EmulatedBTPeerDeviceConfig) error {
	...
	// Configuring pairing agent. Note that there is no need to stop this later,
	// as starting it will also any running agent and ResetStack restarts
	// the bluetooth service on the btpeer.
