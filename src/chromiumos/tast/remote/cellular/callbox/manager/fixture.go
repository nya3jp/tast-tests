...
func (tf *TestFixture) ConnectToCallbox(ctx context.Context, dutConn *ssh.Conn, configureRequestBody *ConfigureCallboxRequestBody) error {
	...
	// modem is now attached, disable, enable, and connect to make sure everything is synced properly between the callbox and DUT
...
// ToggleConnection disables and reconnects to the default cellular service.
