...
type FetchIperfResultResponseBody struct {
	Clients []*IperfClientResult `json:"clients,omitempty"`
	Servers []*IperfServerResult `json:"servers,omitempty"`
}

// IperfServerResult is the current Iperf measurement for an Iperf server instance.
type IperfServerResult struct {
	ID          int     `json:"counter,omitempty"`
	Throughput  float64 `json:"throughput,omitempty"`
	PercentLoss float64 `json:"loss,omitempty"`
}
