...
type attData map[string]map[uint]map[uint]float64

// HostFixedAttenuations is used for mapping fixed line attenuation
// for a given frequency for each atenuator available in the lab.
