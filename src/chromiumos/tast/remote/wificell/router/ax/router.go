...
// Router is used to control an ax wireless router and stores state of the router.
type Router struct {
...
func (r *Router) stageRouterParam(ctx context.Context, band BandEnum, key NVRAMKeyEnum, value string) error {
