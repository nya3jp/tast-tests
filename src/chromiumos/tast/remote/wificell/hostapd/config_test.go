	...
	testcases := []struct {
		...
		},
		{
			ops: []Option{
				Mode(Mode80211a),
				Channel(36),
				R0KHs("02:01:02:03:04:05 r0kh-1.example.com 0123 extra fields"),
			},
			expected:   nil,
		...
		},
		{
			ops: []Option{
				Mode(Mode80211a),
				Channel(36),
				R0KHs("02:01:02:03:0405 r0kh-1.example.com 0123"),
			},
			expected:   nil,
		...
		},
		{
			ops: []Option{
				Mode(Mode80211a),
				Channel(36),
				R1KHs("02:01:02:03:04:05 r0kh-1.example.com 0123"),
			},
			expected:   nil,
		...
		},
		{
			ops: []Option{
				Mode(Mode80211a),
				Channel(36),
				R0KHs("02:01:02:03:04:05 r0kh-1.example.com 01234"),
			},
			expected:   nil,
		...
		},
		{
			ops: []Option{
				...
				R0KHs("02:01:02:03:04:05 r0kh-1.example.com 0123"),
				R1KHs("02:01:02:03:04:05 02:01:02:03:04:05 0123"),
			},
			expected: &Config{
				SSID:           "ssid",
				BSSID:          "00:11:22:33:44:55",
				...
				NasIdentifier:  "r0kh-1.example.com",
				R1KeyHolder:    "112233445566",
				R0KHs:          []string{"02:01:02:03:04:05 r0kh-1.example.com 0123"},
				R1KHs:          []string{"02:01:02:03:04:05 02:01:02:03:04:05 0123"},
			},
			shouldFail: false,
		},
	}
