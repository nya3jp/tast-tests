...
// WpaPsk return a WpaOption which sets psk in WPA config.
...
// WpaMode return a WpaOption which sets WPA mode in WPA config.
...
// WpaCiphers return a WpaOption which sets the used WPA cipher in WPA config.
...
// Wpa2Ciphers return a WpaOption which sets the used WPA2 cipher in WPA config.
...
// WpaPtkRekeyPeriod return a WpaOption which sets maximum lifetime for PTK in WPA config.
...
// WpaGtkRekeyPeriod return a WpaOption which sets time interval for rekeying GTK in WPA config.
...
// WpaGmkRekeyPeriod return a WpaOption which sets time interval for rekeying GMK in WPA config.
...
// WpaUseStrictRekey return a WpaOption which sets strict rekey in WPA config.
...
// WpaFTMode return a WpaOption which sets fast transition mode in WPA config.
