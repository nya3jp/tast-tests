...
// SetAPInterfaceDown brings down the interface that the APIface uses.
func (r *Router) SetAPInterfaceDown(ctx context.Context, ap *APIface) error {
	if err := r.ipr.SetLinkDown(ctx, ap.iface); err != nil {
