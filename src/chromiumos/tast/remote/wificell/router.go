...
// SuperRouter is a supertype of all routers. This is mostly used in tandem with a handler to see which methods are actually supported.
...
// AxRouter contains the funcionality that the ax testbed should support.
type AxRouter interface {
	baseRouter
}

// LegacyRouter contains the functionality the basic WiFi testing system should support.
