...
const (
	// We might need to reboot broken DUT in setup or teardown, give
...
// tastFixtureImpl is the implementation of Tast fixture for wificell setup.
// Notice the difference of tastFixture and TestFixture objects. The "fixture"
// of former is the one in the Tast framework, while the one of the latter is
// is for the fixtures in wificell setup.
