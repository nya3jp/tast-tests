...
func NewTestFixture(ctx context.Context, dut *dut.DUT, rpcHint *testing.RPCHint, routerHostname string) (ret *TestFixture, retErr error) {
	...
	// TODO(crbug.com/1034875): setup pcap, attenuator.
...
func (tf *TestFixture) DeconfigAP(ctx context.Context, h *InterfaceHandle) error {
	return tf.router.StopHostapd(ctx, h)
}
