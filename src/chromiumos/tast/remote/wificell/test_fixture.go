...
// ShillProperty holds a shill property with it's expected and unexpected values.
...
// It takes an array of ShillProperty and returns a function that waites for the expected
// property changes.
func (tf *TestFixture) ExpectShillProperty(ctx context.Context, servicePath string, props []*ShillProperty) (func() error, error) {
