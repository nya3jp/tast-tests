...
// DefaultOpenNetworkAPwithDNS configures the router to provide an 802.11n open wifi and
// enables DNS server and HTTP server on router.
func (tf *TestFixture) DefaultOpenNetworkAPwithDNS(ctx context.Context) (*APIface, error) {
