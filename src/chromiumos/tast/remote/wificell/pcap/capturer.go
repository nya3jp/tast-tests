...
func (c *Capturer) Close(ctx context.Context) error {
	// Wait 2 seconds (2 * libpcap poll timeout) before killing the process.
	// Analysis of the timeout can be found in crrev.com/c/288814.
	// TODO(crbug.com/1034875): Find a better way to wait pcap done.
