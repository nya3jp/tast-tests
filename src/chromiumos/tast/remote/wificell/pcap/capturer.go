...
// Snaplen returns an option which sets a Capturer's snaplen.
...
func (c *Capturer) Close(ctx context.Context) error {
	// TODO(crbug.com/1034875, crbug.com/514384): In Autotest, it sleeps
	// 2*LIBPCAP_POLL_FREQ_SECS before kill to ensure pcap completeness.
	// We'll need similar waiting here.
	// Some previous investigation can be found in crrev.com/c/288814.
	var err error
	if c.cmd != nil {
