...
func newLegacyRouter(ctx, daemonCtx context.Context, host *ssh.Conn, name string) (LegacyRouter, error) {
...
func (r *legacyRouterStruct) GetRouterType() RouterType {
	return r.rtype
}
...
// daemons.
func (r *legacyRouterStruct) initialize(ctx, daemonCtx context.Context) error {
