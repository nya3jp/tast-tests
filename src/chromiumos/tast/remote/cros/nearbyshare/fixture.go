...
func init() {
	testing.AddFixture(&testing.Fixture{
		...
		Impl:     NewNearbyShareFixture(nearbycommon.DataUsageOffline, nearbycommon.VisibilityAllContacts, nearbycommon.OfflineFiles),
	...
	testing.AddFixture(&testing.Fixture{
		...
		Impl:     NewNearbyShareFixture(nearbycommon.DataUsageOffline, nearbycommon.VisibilitySelectedContacts, nearbycommon.OfflineFiles),
		Data:     nearbycommon.OfflineFiles,
		Contacts: []string{"chromeos-sw-engprod@google.com"},
		Vars: []string{
			"nearbyshare.cros_username",
	...
	testing.AddFixture(&testing.Fixture{
		...
		Impl:     NewNearbyShareFixture(nearbycommon.DataUsageOnline, nearbycommon.VisibilityAllContacts, nearbycommon.OnlineFiles),
	...
	testing.AddFixture(&testing.Fixture{
		...
		Impl:     NewNearbyShareFixture(nearbycommon.DataUsageOnline, nearbycommon.VisibilitySelectedContacts, nearbycommon.OnlineFiles),
		Data:     nearbycommon.OnlineFiles,
		Contacts: []string{"chromeos-sw-engprod@google.com"},
		Vars: []string{
			"nearbyshare.cros_username",
	...
	testing.AddFixture(&testing.Fixture{
		...
		Impl:     NewNearbyShareFixture(nearbycommon.DataUsageOnline, nearbycommon.VisibilityNoOne, nearbycommon.OnlineFiles),
		Data:     nearbycommon.OnlineFiles,
		Contacts: []string{"chromeos-sw-engprod@google.com"},
		Vars: []string{
			"nearbyshare.cros_username",
	...
	testing.AddFixture(&testing.Fixture{
		...
		Impl:     NewNearbyShareFixture(nearbycommon.DataUsageOffline, nearbycommon.VisibilityNoOne, nearbycommon.OfflineFiles),
		Data:     nearbycommon.OfflineFiles,
		Contacts: []string{"chromeos-sw-engprod@google.com"},
		Vars: []string{
			"nearbyshare.cros_username",
