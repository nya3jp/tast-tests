...
func NewNearbyShareFixture(dataUsage nearbycommon.DataUsage, visibility nearbycommon.Visibility, testFiles []string) testing.FixtureImpl {
...
var offlineFiles = []string{"small_png.zip", "small_jpg.zip"}
var onlineFiles = []string{"big_txt.zip"}
...
func init() {
	testing.AddFixture(&testing.Fixture{
		...
		Impl:     NewNearbyShareFixture(nearbycommon.DataUsageOffline, nearbycommon.VisibilityAllContacts, offlineFiles),
		Data:     offlineFiles,
	...
	testing.AddFixture(&testing.Fixture{
		...
		Impl:     NewNearbyShareFixture(nearbycommon.DataUsageOffline, nearbycommon.VisibilitySelectedContacts, offlineFiles),
		Data:     offlineFiles,
		Contacts: []string{"chromeos-sw-engprod@google.com"},
		Vars: []string{
			"nearbyshare.cros_username",
	...
	testing.AddFixture(&testing.Fixture{
		...
		Impl:     NewNearbyShareFixture(nearbycommon.DataUsageOnline, nearbycommon.VisibilityAllContacts, onlineFiles),
		Data:     onlineFiles,
		Contacts: []string{"chromeos-sw-engprod@google.com"},
		Vars: []string{
			"nearbyshare.cros_username",
	...
	testing.AddFixture(&testing.Fixture{
		...
		Impl:     NewNearbyShareFixture(nearbycommon.DataUsageOnline, nearbycommon.VisibilitySelectedContacts, onlineFiles),
		Data:     onlineFiles,
		Contacts: []string{"chromeos-sw-engprod@google.com"},
		Vars: []string{
			"nearbyshare.cros_username",
	...
	testing.AddFixture(&testing.Fixture{
		...
		Impl:     NewNearbyShareFixture(nearbycommon.DataUsageOnline, nearbycommon.VisibilityNoOne, onlineFiles),
		Data:     onlineFiles,
		Contacts: []string{"chromeos-sw-engprod@google.com"},
		Vars: []string{
			"nearbyshare.cros_username",
	...
	testing.AddFixture(&testing.Fixture{
		...
		Impl:     NewNearbyShareFixture(nearbycommon.DataUsageOffline, nearbycommon.VisibilityNoOne, offlineFiles),
		Data:     offlineFiles,
		Contacts: []string{"chromeos-sw-engprod@google.com"},
		Vars: []string{
			"nearbyshare.cros_username",
