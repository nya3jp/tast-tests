...
func NewDevice(ctx context.Context, path dbus.ObjectPath) (*Device, error) {
	...
	dbus := &DBus{Interface: dbusDeviceInterface, Object: obj, Conn: conn}
	props, err := NewProperties(ctx, dbus)
	if err != nil {
		return nil, err
	}
	return &Device{dbus: dbus, props: props}, nil
}

// Properties returns existed properties.
...
func (d *Device) SetUsbEthernetMacAddressSource(ctx context.Context, source string) error {
	if err := call(ctx, d.dbus.Object, d.dbus.Interface, "SetUsbEthernetMacAddressSource", source).Err; err != nil {
