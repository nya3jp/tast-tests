...
// DeviceProp is the type for device property names.
type DeviceProp string

// Device property names defined in dbus-constants.h .
const (
	// Device property names.
	DevicePropName DeviceProp = "Interface"

	// Ethernet device property names.
	DevicePropEthernetBusType   DeviceProp = "Ethernet.DeviceBusType"
	DevicePropEthernetLinkUp    DeviceProp = "Ethernet.LinkUp"
	DevicePropEthernetMACSource DeviceProp = "Ethernet.UsbEthernetMacAddressSource"
)
...
func (d *Device) GetProps(ctx context.Context) (map[DeviceProp]interface{}, error) {
	props := make(map[DeviceProp]interface{})
...
// SetMACSource sets USB Ethernet MAC address source for device.
