...
// ExpectIn waits for a change signal of prop with its value in the expected slice.
// The value detected will be returned, if not found before ctx.Done, error is returned.
