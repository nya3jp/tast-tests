...
// Monitor monitors the specified properties until a specific property's value is met.
// It returns the monitor result as a map of the changed properties and their values.
