...
// Writes the process id of the child process to ready once udevadm is ready for
// events, or closes ready without writing anything if an error occurs.
// Returns nil if a matching event is found.
func waitEvent(ctx context.Context, action string, devInfo DevInfo, ready chan<- int) error {
