...
// WithDefaultDescriptors passes the most commonly used USB descriptors.
func WithDefaultDescriptors() Option {
...
// WithDefaultAttributes passes the most commonly used IPP attributes.
func WithDefaultAttributes() Option {
