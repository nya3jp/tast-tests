...
// TraceReplayCommon replays a graphics trace inside a crostini container. The VM disk will be resized for resizeDiskGB > 0.
func TraceReplayCommon(ctx context.Context, s *testing.State, resizeDiskGB uint64) {
