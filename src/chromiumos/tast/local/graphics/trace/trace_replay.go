...
// grepGuestProcesses looks through the currently running processes in the guest and returns
// the comma separated list of process IDs which matches the specified pattern
...
// runTraceReplayInVM calls the trace_replay executable in the guest with args and writes test
...
// runTraceReplayExtendedInVM calls the trace_replay executable in the guest with args.
