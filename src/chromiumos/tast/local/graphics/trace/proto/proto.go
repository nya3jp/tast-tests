...
const (
	...
	// TestResultFailure means one or several tests in a test groupe were failed or other error occurred
...
// HostInfo is used as a container for the host related information
...
// TestGroupResult struct is a part of guest->host comunication protocol and it carries
