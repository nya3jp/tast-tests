...
func (f *graphicsNoChromeFixture) getGPUCrash() ([]string, error) {
	return nil, nil
}
...
func (f *graphicsNoChromeFixture) checkNewCrashes(ctx context.Context, oldCrashes []string) error {
	return nil
}
...
func (f *graphicsNoChromeFixture) checkHangs(ctx context.Context, reader *syslog.Reader) error {
	return nil
}
