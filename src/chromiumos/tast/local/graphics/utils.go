...
// shorten the time between disk flushes so that logs retain as much information
// as possible in case the system hangs/reboots. Note that the specified time is
