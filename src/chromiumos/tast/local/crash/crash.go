...
// shortly before. devcoredumps are typically created and cleared automatically
...
func cleanupDevcoredump(ctx context.Context, wait time.Duration, dirname, filename string) error {
	...
	// devcoredumps are typically created and cleared automatically by crash_reporter,
