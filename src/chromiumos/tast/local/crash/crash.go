...
// CleanupDevcoredump clear the file filter created devcoredump virtual device,
// by writing "0" to /sys/class/devcoredump/devcd%d/data, with up to 30s waiting.
// The existence of these files indicates that devcoredump was invoked
// shortly before. devcoredump is invoked by crash_reporter during crash
// collection and testing, by which a file filter is created to ignore
// core dump files with certain patterns.
