...
// Start notifies Chrome to store a copy of login events for later retrieval.
func (t *LoginEventRecorder) Start(ctx context.Context, tconn *chrome.TestConn) error {
