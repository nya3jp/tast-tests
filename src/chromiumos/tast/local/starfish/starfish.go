...
const configInfoLabelName = "starfish.configInfo"
...
func (s *Starfish) Setup(ctx context.Context) error {
	...
	var sfExists bool = false

	if !sfExists {
		s.supported = false
		testing.ContextLog(ctx, "starfish module not supported")
		return nil
	}
	var sf shim
