...
func (v *Video) WaitUntilVideoReady(ctx context.Context) error {
	return testing.Poll(ctx, func(ctx context.Context) error {
		var ready bool
		if err := v.conn.Call(ctx, &ready, v.generateQuery(isVideoReady)); err != nil {
			return err
		}
...
func (v *Video) Play(ctx context.Context) error {
	if err := v.conn.Call(ctx, nil, v.generateQuery(playVideo)); err != nil {
...
func (v *Video) Pause(ctx context.Context) error {
	if err := v.conn.Call(ctx, nil, v.generateQuery(pauseVideo)); err != nil {
...
func (v *Video) Forward(ctx context.Context) error {
	...
	if err := v.conn.Call(ctx, nil, v.generateQuery(fastForward)); err != nil {
...
func (v *Video) Rewind(ctx context.Context) error {
	...
	if err := v.conn.Call(ctx, nil, v.generateQuery(fastRewind)); err != nil {
...
func (v *Video) CurrentTime(ctx context.Context) (time float64, err error) {
	err = v.conn.Call(ctx, &time, v.generateQuery(getCurrentTime))
	return
}
...
func (v *Video) EnterFullScreen(ctx context.Context) error {
	...
	if err := v.conn.Call(ctx, nil, v.generateQuery(enterFullScreen)); err != nil {
		return err
	}
...
func (v *Video) ExitFullScreen(ctx context.Context) error {
	if err := v.conn.Call(ctx, nil, v.generateQuery(exitFullscreen)); err != nil {
		return err
	}
...
func (v *Video) IsPlaying(ctx context.Context) (bool, error) {
	var paused bool
	err := v.conn.Call(ctx, &paused, v.generateQuery(isVideoPaused))
	return !paused, err
}
...
func (v *Video) IsFullScreen(ctx context.Context) (bool, error) {
	var fullscreen bool
	err := v.conn.Call(ctx, &fullscreen, v.generateQuery(isFullscreen))
...
func (v *Video) generateQuery(act htmlAction) (str string) {
	var (
