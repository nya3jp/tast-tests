...
// fixed size []byte arrays are used here to conform to what the syscall
// expects. C struct can be found here
// third_party/kernel/v4.14/include/uapi/linux/uhid.h?l=45
