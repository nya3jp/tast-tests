...
// WakeScreen wakes up the Android device's screen.
func (d *Device) WakeScreen(ctx context.Context) error {
	return d.ShellCommand(ctx, "input", "keyevent", string(android.KeyCodeWakeup)).Run(testexec.DumpLogOnError)
}
