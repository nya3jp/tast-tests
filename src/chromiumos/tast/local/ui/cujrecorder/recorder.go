...
// NewSmoothnessMetricConfigWithTestConn (deprecated, use non-"WithTestConn"
...
// NewLatencyMetricConfigWithTestConn (deprecated, use non-"WithTestConn"
// version) works like NewLatencyMetricConfig but
...
// NewCustomMetricConfigWithTestConn (deprecated, use non-"WithTestConn"
// version) works like NewCustomMetricConfig but
// allows specifying a TestConn to pull histogram data.
// TODO(b/230676548): Deprecated.
...
func NewRecorder(ctx context.Context, cr *chrome.Chrome, a *arc.ARC, options RecorderOptions, configs ...MetricConfig) (*Recorder, error) {
	...
	r.addCollectedMetrics(r.tconn, configs...)
