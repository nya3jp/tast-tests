...
// collected by all CUJ tests from the Ash process only. These metrics
// are augmentations to the SPERA metrics in
// cujrecorder/common_metrics.go.
...
// be collected by all CUJ tests from the Lacros process only.
...
// Lacros). These metrics are are augmentations to the SPERA metrics in
// cujrecorder/common_metrics.go.
...
// from both Ash and Lacros in parallel). These metrics are augmentations
// to the SPERA metrics in cujrecorder/common_metrics.go.
