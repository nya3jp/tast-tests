...
func BrowserCommonMetricConfigs() []MetricConfig {
	return []MetricConfig{
		...
		NewCustomMetricConfig("Browser.Tabs.TabSwitchResult2.NoSavedFrames_NotLoaded", "ms", perf.SmallerIsBetter),
		NewCustomMetricConfig("Browser.Tabs.TabSwitchResult2.NoSavedFrames_Loaded", "ms", perf.SmallerIsBetter),
		NewCustomMetricConfig("Browser.Tabs.TabSwitchResult2.WithSavedFrames", "ms", perf.SmallerIsBetter),
