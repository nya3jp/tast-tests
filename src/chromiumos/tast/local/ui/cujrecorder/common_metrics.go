...
const (
	// MetricsCollectFullSystem indicte the test wants to collect as many metrics for the full system.
	...
	// MetricsCollectBrowsingSeperated indicte the test wants to collect web browsing releated
