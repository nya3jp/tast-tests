...
type Differ interface {
	Diff(string, *nodewith.Finder) error
	DiffWithOptions(string, DiffTestOptions) error
	DiffAction(string, *nodewith.Finder) uiauto.Action
	DiffActionWithOptions(string, DiffTestOptions) uiauto.Action
...
func (d *differ) Diff(name string, params *nodewith.Finder) error {
...
// DiffAction is the same as Diff, but the return type is suitable for use with the uiauto library.
func (d *differ) DiffAction(name string, params *nodewith.Finder) uiauto.Action {
	return func(_ context.Context) error {
		return d.Diff(name, params)
	}
}

// DiffActionWithOptions is the same as DiffWithOptions, but the return type is suitable for use withe the uiauto library.
func (d *differ) DiffActionWithOptions(name string, options DiffTestOptions) uiauto.Action {
	return func(_ context.Context) error {
		return d.DiffWithOptions(name, options)
	}
}
