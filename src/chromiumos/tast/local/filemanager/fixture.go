...
type fixtureOpenFilesApp struct {
	cr          *chrome.Chrome
	filesWindow *filesapp.FilesApp
}
...
func (f *fixtureOpenFilesApp) SetUp(ctx context.Context, s *testing.FixtState) interface{} {
...
func (f *fixtureInstallPwa) SetUp(ctx context.Context, s *testing.FixtState) interface{} {
	...
	for appIdx := 1; appIdx <= 10; appIdx++ {
		if _, err := installPWAForURL(ctx, cr, fmt.Sprintf("http://127.0.0.%d:%v/pwa_index.html", appIdx, localServerPort), installTimeout); err != nil {
...
func (f *fixtureOpenFilesApp) Reset(ctx context.Context) error                        { return nil }
func (f *fixtureOpenFilesApp) PreTest(ctx context.Context, s *testing.FixtTestState)  {}
func (f *fixtureOpenFilesApp) PostTest(ctx context.Context, s *testing.FixtTestState) {}
func (f *fixtureOpenFilesApp) TearDown(ctx context.Context, s *testing.FixtState)     {}
