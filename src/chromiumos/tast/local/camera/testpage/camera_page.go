...
const (
	...
	// EnvironmnetFacing corresponds to the "environment" facing mode.
	EnvironmnetFacing = "environment"
)
...
// stream.
func (w *CameraWebPage) Open(ctx context.Context, cr *chrome.Chrome) (retErr error) {
