...
// CloseAndMaybeSavedCameraFolder closes the app and also saves the camera folder if there is any JS errors found
func (a *App) CloseAndMaybeSavedCameraFolder(ctx context.Context) error {
