...
// enableDocumentMode toggles the document mode option, which is one of the expert mode options, on if it is currently off.
...
// enableMultiStreamRecording toggles the multi-stream video recording option, which is one of the expert mode options, on if it is currently off.
