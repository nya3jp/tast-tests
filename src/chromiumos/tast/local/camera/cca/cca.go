...
// enableDocumentModeOption toggles the document mode option, which is one of the expert mode options, on if it is currently off.
func (a *App) enableDocumentModeOption(ctx context.Context) error {
	return a.setEnableOption(ctx, "enable-document-mode-on-all-cameras", "#expert-enable-document-mode-on-all-cameras", true)
}
...
func (a *App) EnableDocumentMode(ctx context.Context) error {
	...
	if err := a.enableDocumentModeOption(ctx); err != nil {
...
// setEnableMultiStreamRecordingOption toggles the multi-stream video recording option, which is one of the expert mode options, to the given state.
func (a *App) setEnableMultiStreamRecordingOption(ctx context.Context, enabled bool) error {
	return a.setEnableOption(ctx, "enable-multistream-recording", "#expert-enable-multistream-recording", enabled)
}
...
func (a *App) SetEnableMultiStreamRecording(ctx context.Context, enabled bool) error {
	...
	if err := a.setEnableMultiStreamRecordingOption(ctx, enabled); err != nil {
