...
func (ac *Activity) Resize(border uint, toX, toY int, t time.Duration) error {
	...
	// Touch and hold the touch for a few ms to grab the handle. Seems to be more robust.
...
func originAndDestForBorder(border uint, bounds Rect, toX, toY int) (vertex, vertex) {
