...
// GetCaptionHeight returns the caption height of the activity.
func (ac *Activity) GetCaptionHeight(ctx context.Context) (int, error) {
...
// GetDisplayDensity returns the density of activity's physical display.
func (ac *Activity) GetDisplayDensity(ctx context.Context) (float64, error) {
