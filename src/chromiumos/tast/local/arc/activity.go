...
// MoveWindow behaves as if you were drag-moving the window using using a finger. That
...
// For a list a possible gestures see FlingOrSwipe() in https://cs.chromium.org/chromium/src/ash/wm/workspace/workspace_window_resizer.cc
