...
// to represents the destination of the movement in pixels (Chrome OS display coordinates).
...
// to represents the destination for the resize in pixels (Chrome OS display coordinates).
