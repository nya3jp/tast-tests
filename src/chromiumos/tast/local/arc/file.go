...
// /home/root/<hash>/crosvm/YXJjdm0=.img to the host's /home/root/<hash>/android-data/data as read-only.
func MountVirtioBlkDataDiskImageReadOnly(ctx context.Context, a *ARC, rootCryptDir string) error {
