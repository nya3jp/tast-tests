...
// For example, if the display is rotated, instead of returning W x H, it will return H x W.
...
// stableBounds returns the display bounds. It is not affected by display rotations.
// It always return W x H.
