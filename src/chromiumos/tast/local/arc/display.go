...
// If isStableSize is true, it will return the stable display size. The stable size will not be affected
// by orientation changes, otherwise the size will be the logical size.
