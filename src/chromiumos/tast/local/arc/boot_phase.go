...
const intentHelperTimeout = 20 * time.Second

// WaitBootCompleted waits for Android to finish boot. After this function
...
// package assumes this function has already been called.
...
func waitProp(ctx context.Context, name, value string) error {
	for {
		...
		// Android container is not up yet.
