...
func newAdbForLocalTest(ctx context.Context) (*ADB, error) {
	...
	return nil, &ADB{keyPath: testPrivateKeyPath, home: adbHome, addr: adbAddr}
}

// NewAdbForRemoteTest returns |ADB| instance connecting to |addr|.
...
// ConnectADB connects to the remote ADB daemon.  After this function returns
// successfully, we can assume that ADB connection is ready.
