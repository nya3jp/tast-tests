...
// later be restored with RestoreArcvmDevConf. Care should be taken to only call this function
// once during a test run (either from the test itself or from the fixture) to avoid overwriting
