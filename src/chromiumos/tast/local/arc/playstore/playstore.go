...
// InstallAppFromIntent install an app from the Play Store home page.
// Play Store should be open to the homepage before running this function.
func InstallAppFromIntent(ctx context.Context, a *arc.ARC, d *ui.Device, pkgName string) error {
