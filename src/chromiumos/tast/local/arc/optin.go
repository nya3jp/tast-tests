...
// PerformOptin performs steps through opt-in flow and wait for it to complete.
func PerformOptin(ctx context.Context, cr *chrome.Chrome, tconn *chrome.Conn) error {
