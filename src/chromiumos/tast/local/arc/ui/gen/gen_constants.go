...
type groupInfo struct {
	...
	typeName string // constant type name, e.g. "KeyCodeType"
...
var groups []*groupInfo = []*groupInfo{
	...
	&groupInfo{"META", metaType, "Meta constants"},
}
...
// code describes an individual code.
type constant struct {
	name string // name without the prefix, e.g. "KEYCODE_NUMPAD_9"
	val  int64  // parsed value
}
...
func readConstants(path string) (constantGroups, error) {
	...
	// TODO(ricardoq): Add support for Metas like this one:
...
func writeConstants(consts constantGroups, repoPath, repoRev, path string) error {
	...
	for _, grp := range groups {
		gd := groupData{Type: grp.typeName, Desc: grp.desc, Prefix: grp.prefix}
