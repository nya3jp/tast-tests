...
//
// An instanciated Object does NOT uniquely identify an Android view. Instead,
...
// NewObject creates an Object from given selectors.
//
// Example:
//  b := ui.NewObject(ui.WithResourceId("foo_button"))
func (d *Device) NewObject(opts ...SelectorOption) *Object {
...
func (o *Object) WaitForExists(ctx context.Context) error {
	var success bool
	if err := o.d.call(ctx, "waitForExists", &success, o.s, getTimeout(ctx)); err != nil {
		return err
	}
	if !success {
...
func getTimeout(ctx context.Context) int64 {
	d, ok := ctx.Deadline()
	if !ok {
