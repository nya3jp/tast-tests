...
// Otherwise, artifactPath is ignored. If enable_gpu is set, VM will try to use
// hardware gpu if possible.
func CreateDefaultVM(ctx context.Context, dir, user string, t ContainerType, artifactPath string, enable_gpu bool) (*VM, error) {
	...
	vmInstance.EnableGPU = enable_gpu
