...
func getDBusObject() dbus.BusObject {
	return bus.Object(dbusutil.ConciergeName, dbus.ObjectPath(dbusutil.ConciergePath))
}
...
func (c *Concierge) StartTerminaVM(ctx context.Context) error {
	...
	testing.ContextLogf(ctx, "Started VM %q. cid: %d pid: %d", testName, resp.VmInfo.Cid, resp.VmInfo.Pid)
