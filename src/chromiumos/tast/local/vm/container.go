...
func (c *Container) Start(ctx context.Context) error {
	...
	if err := dbusutil.CallProtoMethod(ctx, c.ciceroneObj, dbusutil.CiceroneInterface+".StartLxdContainer",
...
func (c *Container) GetUsername(ctx context.Context) (string, error) {
	...
	if err := dbusutil.CallProtoMethod(ctx, c.ciceroneObj, dbusutil.CiceroneInterface+".GetLxdContainerUsername",
...
func (c *Container) SetUpUser(ctx context.Context) error {
	...
	if err := dbusutil.CallProtoMethod(ctx, c.ciceroneObj, dbusutil.CiceroneInterface+".SetUpLxdContainerUser",
...
func (c *Container) LinuxPackageInfo(ctx context.Context, path string) (err error, packageId string) {
	...
	if err := dbusutil.CallProtoMethod(ctx, c.ciceroneObj, dbusutil.CiceroneInterface+".GetLinuxPackageInfo",
...
func (c *Container) InstallPackage(ctx context.Context, path string) error {
	...
	if err = dbusutil.CallProtoMethod(ctx, c.ciceroneObj, dbusutil.CiceroneInterface+".InstallLinuxPackage",
		&cpb.LinuxPackageInfoRequest{
			VmName:        c.VM.name,
			ContainerName: c.containerName,
			OwnerId:       c.VM.Concierge.ownerID,
