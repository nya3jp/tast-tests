...
func (c *Container) CheckFileExistsInHomeDir(ctx context.Context, files ...string) error {
	...
	fileslist, err := c.GetFileList(ctx, ".")
	if err != nil {
...
// GetFileList list the files in home directory in container.
// Return a string as file list or error if any.
func (c *Container) GetFileList(ctx context.Context, path string) (fileslist string, err error) {
	// Get file list in home directory in container.
