...
// PolicyServer is a http server that helps serve data for policies that load their data from an external source.
...
func (ps *PolicyServer) ServePolicyData(data []byte) (string, string, error) {
