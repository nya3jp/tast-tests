...
func TestServeURL(t *testing.T) {
	...
	testData := []byte{1, 2, 3}
	expectedHash := "039058c6f2c0cb492c533b0a4d14ef77cc0f78abccced5287d84a1a2011cfb81"

	url, hash, err := eds.ServePolicyData(testData)
	if err != nil {
...
func TestMissingURL(t *testing.T) {
	...
	url, _, err := eds.ServePolicyData([]byte{1, 2, 3, 4})
	if err != nil {
		t.Fatal("Failed to serve: ", err)
	}
	...
	if resp.StatusCode != http.StatusNotFound {
		t.Error("Expected 404 when requesting wrong URL")
	}
}
