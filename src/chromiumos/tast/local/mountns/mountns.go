...
func EnterUserSessionMountNS(ctx context.Context) (err error) {
...
// EnterInitMountNamespace enters the init mount namespace.
func EnterInitMountNamespace(ctx context.Context) {
