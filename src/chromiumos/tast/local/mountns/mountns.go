...
// WithUserSessionMountNS runs the given test function with user session mount namespace.
// This function must be called in the init mount namespace.
func WithUserSessionMountNS(ctx context.Context, f func(ctx context.Context) error) (retErr error) {
