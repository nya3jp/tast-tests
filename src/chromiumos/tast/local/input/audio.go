...
// AudioFromFileAndWait inputs an audio file via active input node and waits until it finishes.
func AudioFromFileAndWait(ctx context.Context, audioFilePath string) error {
