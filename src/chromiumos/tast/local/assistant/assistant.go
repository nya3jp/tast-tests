...
// Response contains a subset of the results returned by the Assistant after making a query.
type Response struct {
	// Fallback contains the fallback text followed with an html response returned from the server.
