...
const (
	...
	// Page title of Google News Web.
	GoogleNewsWebTitle = "Chrome - Google News"
	// Web URL of Google News.
	GoogleNewsWebURL = "https://news.google.com/"
)

// InstallTestApkAndWaitReady installs a test apk and wait that it becomes available.
...
// WaitForGoogleNewsWebBecomesActive waits that Google New Web gets focused.
func WaitForGoogleNewsWebBecomesActive(ctx context.Context, tconn *chrome.TestConn) error {
...
// WaitForGoogleNewsAppBecomesActive waits that Google News Android gets focused.
func WaitForGoogleNewsAppBecomesActive(ctx context.Context, tconn *chrome.TestConn) error {
