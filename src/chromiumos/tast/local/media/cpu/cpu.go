...
// MeasureUsage measures the average utilization across all CPUs and the average
// power consumption during the specified duration. A map is returned containing
// both CPU usage (percentage in [0-100] range) and power consumption (Watts).
// The power consumption will only be present on intel platforms.
