...
// PrepareYUVJSON creates a json file for yuvPath by copying srcYUVJSONPath.
func PrepareYUVJSON(ctx context.Context, yuvPath, srcYUVJSONPath string) (string, error) {
