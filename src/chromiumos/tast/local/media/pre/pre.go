...
var chromeCameraPerfPre = chrome.NewPrecondition("cameraPerf", chromeFakeUIArgs)
...
var chromeCameraPerfWithVP9VaapiEncoder = chrome.NewPrecondition("cameraPerfWithVP9VaapiEncoder", chromeVModuleArgs, chromeFakeUIArgs, chrome.ExtraArgs("--enable-features=VaapiVP9Encoder"))
...
var chromeFakeUIArgs = chrome.ExtraArgs(
	// Avoid the need to grant camera/microphone permissions.
	"--use-fake-ui-for-media-stream")
