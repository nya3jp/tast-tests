...
// said implementations: a "legacy" one and a Direct, VD-based (VD-based) one.
...
var chromeAlternateVideoDecoderPre = chrome.NewPrecondition("alternateVideoDecoderPre", chromeVModuleArgs, chrome.ExtraArgs("--disable-features=ChromeosVideoDecoder"))
