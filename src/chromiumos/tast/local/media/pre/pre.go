...
// ChromeVideoWithFakeWebcamAndVaapiVP9Encoder returns a precondition equal to
...
func ChromeVideoWithFakeWebcamAndVaapiVP9Encoder() testing.Precondition {
	return chromeVideoWithFakeWebcamAndVaapiVP9Encoder
}

var chromeVideoWithFakeWebcamAndVaapiVP9Encoder = chrome.NewPrecondition("videoWithFakeWebcamAndVaapiVP9Encoder", chromeArgs, chromeFakeWebcamArgs, chromeEnableVaapiVP9Encoder)
...
var chromeEnableVaapiVP9Encoder = chrome.ExtraArgs("--enable-features=VaapiVP9Encoder")
