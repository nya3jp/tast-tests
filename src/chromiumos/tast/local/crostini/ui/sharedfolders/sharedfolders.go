...
const (
	...
	MyFiles     = "My files"
	SharedDrive = filesapp.GoogleDrive + " › " + filesapp.MyDrive // Shared name for Drive on the Settings apge.
)
...
// It is the caller's reponsibility to release the returned ShareConfirmDialog.
func (sf *SharedFolders) ShareDrive(ctx context.Context, tconn *chrome.TestConn, filesApp *filesapp.FilesApp) (*ShareConfirmDialog, error) {
