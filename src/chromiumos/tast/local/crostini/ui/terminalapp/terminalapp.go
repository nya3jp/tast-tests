...
// InputStringToAppAndSave input a test string in the given app window and save.
func (ta *TerminalApp) InputStringToAppAndSave(ctx context.Context, keyboard *input.KeyboardEventWriter, tconn *chrome.TestConn, appWindow *ui.Node, testString string) error {
