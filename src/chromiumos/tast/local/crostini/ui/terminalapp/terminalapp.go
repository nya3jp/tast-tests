...
// take a few seconds after running Crostini. However, on some devices
// launching Terminal when restarting Crostini is unexpectedly slow, which
// may take longer than one minute (i.e., b/240366940).
...
// The performance issue will be tracked in furture performance testing.
