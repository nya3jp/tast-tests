...
type InstallationOptions struct {
	...
	AllowSmallerDiskSize bool
	ResultDiskSize       uint64
}
...
func (p *Installer) SetDiskSize(ctx context.Context, minDiskSize uint64, AllowSmallerDiskSize bool) (uint64, error) {
...
func InstallCrostini(ctx context.Context, tconn *chrome.TestConn, iOptions *InstallationOptions) error {
	...
	if iOptions.MinDiskSize != 0 {
		iOptions.ResultDiskSize, err = installer.SetDiskSize(ctx, iOptions.MinDiskSize, iOptions.AllowSmallerDiskSize)
		if err != nil {
