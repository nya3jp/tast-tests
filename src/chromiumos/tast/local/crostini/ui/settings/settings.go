...
// Package settings provides support for the Linux settings on Settings app.
package settings
...
// Windows names for different settings page.
const (
...
func UnshareFolder(ctx context.Context, tconn *chrome.TestConn, folder string) error {
