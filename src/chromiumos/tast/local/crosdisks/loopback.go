...
// GetDevicePath returns the device path in /dev.
func (l *LoopbackDevice) GetDevicePath() string {
	return l.device
}

// GetSysDevicePath returns the device path in /sys.
func (l *LoopbackDevice) GetSysDevicePath() string {
