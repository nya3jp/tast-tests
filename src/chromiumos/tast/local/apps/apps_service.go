...
func init() {
	...
	testing.AddService(&testing.Service{
		Register: func(srv *grpc.Server, s *testing.ServiceState) {
			Service = AppService{sharedObject: common.SharedObjectsForServiceSingleton}
			pb.RegisterAppServiceServer(srv, &Service)
		},
		GuaranteeCompatibility: true,
	})
}

// AppService implements tast.cros.apps.AppService
type AppService struct {
	sharedObject *common.SharedObjectsForService
}

// useTconn performs an action that requires access to tconn. It handles the aquisition and releasing of locks for you.
func (svc *AppService) useTconn(ctx context.Context, fn func(tconn *chrome.TestConn) error) error {
...
func (svc *AppService) LaunchApp(ctx context.Context, req *pb.LaunchAppRequest) (*empty.Empty, error) {
...
func (svc *AppService) GetPrimaryBrowser(ctx context.Context, req *empty.Empty) (*pb.App, error) {
	var result *pb.App
...
func (svc *AppService) LaunchPrimaryBrowser(ctx context.Context, req *empty.Empty) (*pb.App, error) {
