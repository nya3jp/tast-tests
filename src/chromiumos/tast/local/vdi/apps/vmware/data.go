...
// VmwareData holds the UI fragments that are used by Vmware connector. It is
// needed to assign data dependency for fixture that use connection to Wmware.
...
var UIFragments = map[UIFragmentName]string{
	SplashscreenAddBtn: VmwareData[SplashscreenAddBtn],
}
