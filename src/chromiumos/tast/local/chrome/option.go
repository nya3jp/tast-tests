...
// SkipUserMountCheck returns an Option that can be passed to New to disable
// waiting for and validating user mount after login.
func SkipUserMountCheck() Option {
	return func(cfg *config.MutableConfig) error {
