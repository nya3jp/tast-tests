...
// DefaultLacrosConfig is config.DefaultLacrosConfig. It is useful when Lacros defaults to a primary browser mounted from the Rootfs.
...
// It is useful when Lacros should be deployed with the runtime var primariliy in Chromium. This config will precede over any default config.
// TODO: This util could be moved to any other packages (eg, lacros) that make more sense.
