...
var DefaultLacrosConfig = NewLacrosConfig(Rootfs, LacrosPrimary)

// Exported values for lacrosfixt.SetupMode.
const (
	External = lacrosfixt.External
	Omaha    = lacrosfixt.Omaha
	Rootfs   = lacrosfixt.Rootfs
)

// Exported values for lacrosfixt.LacrosMode.
const (
	LacrosSideBySide = lacrosfixt.LacrosSideBySide
	LacrosPrimary    = lacrosfixt.LacrosPrimary
	LacrosOnly       = lacrosfixt.LacrosOnly
	NotSpecified     = lacrosfixt.NotSpecified
)
