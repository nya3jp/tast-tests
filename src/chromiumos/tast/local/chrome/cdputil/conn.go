...
// In case of JavaScript exceptions, errorText and exc are returned.
func (c *Conn) CallFunctionOn(ctx context.Context, objectID runtime.RemoteObjectID, functionDeclaration string, arguments []runtime.CallArgument, out interface{}) (*runtime.CallFunctionOnReply, error) {
