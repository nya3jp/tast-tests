...
const (
	// Portrait is a string representing the portrait layout setting.
	Portrait Layout = "Portrait"
	// Landscape is a string representing the landscape layout setting.
...
func SetPages(ctx context.Context, root *ui.Node, pages string) error {
	...
	// Wait for the custom pages text field to appear.
