...
// Rect returns a coords.Rect struct for the Ubertray, which contains coordinate
// information about the rectangular region it occupies on the screen.
...
// ensureVisible ensures that the ubertray is shown. If the ubertray isn't visible, this function will
// show the ubertray and return a cleanup function to hide the ubertray. If it is already visible,
...
// If the ubertray is not already shown, it will be opened and then closed once the setting is toggled.
