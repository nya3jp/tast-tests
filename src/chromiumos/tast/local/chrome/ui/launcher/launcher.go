...
// Search searches anything in launcher.
...
// SearchAppAndAssert searches with APP name and assert existence.
func SearchAppAndAssert(ctx context.Context, tconn *chrome.TestConn, appName string, timeout time.Duration) (*ui.Node, error) {
