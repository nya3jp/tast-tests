...
// Diagnostics App.
type ConnectivityDiagnosticsApp struct {
...
// Release releases the root node held by the Connectivity Diagnostics app.
func (c *ConnectivityDiagnosticsApp) Release(ctx context.Context) {
	c.Root.Release(ctx)
}
