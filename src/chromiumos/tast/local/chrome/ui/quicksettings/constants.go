...
// CollapseBtn is the finder for the collapse button, which collapses and expands Quick Settings.
var CollapseBtn = nodewith.Role(role.Button).ClassName("CollapseButton")

// LockBtn is the finder for Quick Settings' lock button.
var LockBtn = nodewith.Name("Lock").ClassName("TopShortcutButton")

// SettingsBtn is the finder for the Quick Settings' setting button.
var SettingsBtn = nodewith.Name("Settings").ClassName("TopShortcutButton")

// ShutdownBtn is the finder for the shutdown button in Quick Settings.
var ShutdownBtn = nodewith.Name("Shut down").ClassName("TopShortcutButton")

// SignoutBtn is the finder for the 'Sign out' Quick Settings button.
