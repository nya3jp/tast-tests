...
// GetQuickSettingsNodeParams returns a map that contains descriptive names and its Quick Settings params.
// The params in the map are common to Locked/noLogin/LoggedIn screen Quick Settingsq.
func GetQuickSettingsNodeParams(battery bool) map[string]ui.FindParams {
