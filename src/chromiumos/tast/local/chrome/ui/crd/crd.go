...
// PrepareCRD prepares chrome remote desktop and generates access code to be connected by.
func PrepareCRD(ctx context.Context, cr *chrome.Chrome, tconn *chrome.TestConn) error {
