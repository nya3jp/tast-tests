...
// StoreHistogramsMeanAsMetricsData stores the mean of each histogram as the performance metrics value.
func StoreHistogramsMeanAsMetricsData(ctx context.Context, pv *perf.Values, histograms []*Histogram, metric perf.Metric) error {
