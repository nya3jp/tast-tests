...
func (uc *UserContext) RunActionAsSubTest(ctx context.Context, s *testing.State, name string, action action.Action, uac *UserActionCfg, terminateOnError bool) bool { // NOLINT
	userAction := fromAction(name, action, uc, uac)
