...
// HideVisibleNotifications shows and hides system tray, which should also hide
// any visible notification.
func HideVisibleNotifications(ctx context.Context, tconn *chrome.TestConn) error {
	...
	if err := HideSystemTrayIfVisible(ctx, tconn); err != nil {
...
// CloseNotifications shows the system tray, clicks close button on each
// notification and hides the system tray button.
