...
// EnsureTabletModeEnabledWithKeyboardDisabled makes sure that the tablet mode state
...
func EnsureTabletModeEnabledWithKeyboardDisabled(ctx context.Context) (func(ctx context.Context) error, error) {
