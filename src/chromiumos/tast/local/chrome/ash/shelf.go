...
// SetupAutoHiddenShelf sets shelf auto hide behavior from the wallpaper context menu.
func SetupAutoHiddenShelf(ctx context.Context, tc *chrome.TestConn) error {
	ui := uiauto.New(tc)
