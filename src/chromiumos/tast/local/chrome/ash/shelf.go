...
// SetShelfBehaviorAction returns a uiauto.Action which calls SetShelfBehavior.
...
// WaitForShelfAction returns a uiauto.Action which calls WaitForShelf.
...
// PinAppAction returns a uiauto.Action which calls PinApp.
...
// SetShelfAlignmentAction returns a uiauto.Action which calls SetShelfAlignment.
...
// WaitForChromeAppInstalledAction returns a uiauto.Action which calls WaitForChromeAppInstalled.
...
// ScrollShelfAndWaitUntilFinishAction returns a uiauto.Action which calls ScrollShelfAndWaitUntilFinish.
...
// WaitForAppAction returns a uiauto.Action which calls WaitForApp.
...
// WaitForAppClosedAction returns a uiauto.Action which calls WaitForAppClosed.
...
// WaitForHotseatAnimatingToIdealStateAction returns a uiauto.Action which calls WaitForHotseatAnimatingToIdealState.
...
// SwipeUpHotseatAndWaitForCompletionAction returns a uiauto.Action which calls SwipeUpHotseatAndWaitForCompletion.
func SwipeUpHotseatAndWaitForCompletionAction(tconn *chrome.TestConn, stw *input.SingleTouchEventWriter, tcc *input.TouchCoordConverter) uiauto.Action {
	return uiauto.NamedAction(
		"ash.SwipeUpHotseatAndWaitForCompletionAction(tconn *chrome.TestConn, stw *input.SingleTouchEventWriter, tcc *input.TouchCoordConverter)",
		func(ctx context.Context) error { return SwipeUpHotseatAndWaitForCompletion(ctx, tconn, stw, tcc) })
}

// EnterShelfOverflowAction returns a uiauto.Action which calls EnterShelfOverflow.
func EnterShelfOverflowAction(tconn *chrome.TestConn) uiauto.Action {
	return uiauto.NamedAction(
		"ash.EnterShelfOverflowAction(tconn *chrome.TestConn)",
		func(ctx context.Context) error { return EnterShelfOverflow(ctx, tconn) })
}

// ShowHotseatAction returns a uiauto.Action which calls ShowHotseat.
func ShowHotseatAction(tconn *chrome.TestConn) uiauto.Action {
	return uiauto.NamedAction(
		"ash.ShowHotseatAction(tconn *chrome.TestConn)",
		func(ctx context.Context) error { return ShowHotseat(ctx, tconn) })
}

// PinAppFromShelfAction returns a uiauto.Action which calls PinAppFromShelf.
...
// PinAppFromHotseatAction returns a uiauto.Action which calls PinAppFromHotseat.
...
// WaitForHotseatAnimationToFinishAction returns a uiauto.Action which calls WaitForHotseatAnimationToFinish.
func WaitForHotseatAnimationToFinishAction(tc *chrome.TestConn) uiauto.Action {
	return uiauto.NamedAction(
		"ash.WaitForHotseatAnimationToFinishAction(tc *chrome.TestConn)",
		func(ctx context.Context) error { return WaitForHotseatAnimationToFinish(ctx, tc) })
}

// WaitForStableShelfBoundsAction returns a uiauto.Action which calls WaitForStableShelfBounds.
func WaitForStableShelfBoundsAction(tc *chrome.TestConn) uiauto.Action {
	return uiauto.NamedAction(
		"ash.WaitForStableShelfBoundsAction(tc *chrome.TestConn)",
