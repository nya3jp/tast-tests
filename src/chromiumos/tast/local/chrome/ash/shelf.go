...
// GetShelfAppBoundsForNames returns the screen bounds of the apps specified by appNames.
func GetShelfAppBoundsForNames(ctx context.Context, tconn *chrome.TestConn, ui *uiauto.Context, appNames []string) ([]*coords.Rect, error) {
...
func VerifyShelfAppBounds(ctx context.Context, tconn *chrome.TestConn, ui *uiauto.Context, appNames []string, isHorizontal bool) error {
	...
	boundsArray, err := GetShelfAppBoundsForNames(ctx, tconn, ui, appNames)
	if err != nil {
