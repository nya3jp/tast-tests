...
// GenerateDefaultFakeAppNames generates names for default fake apps.
...
// under the directory of baseDir and returns their path names. Fake apps' names
// are specified in the parameter. `hasIcon` specifies whether a default icon
