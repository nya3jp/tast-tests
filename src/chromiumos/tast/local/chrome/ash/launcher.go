...
// Expected to fail with "Not supported for bubble launcher" error when waiting for state different from "Closed" if
// called for clamshell productivity (bubble) launcher. Waiting for "Closed" state will wait for the fullscreen
// launcher to hide.
