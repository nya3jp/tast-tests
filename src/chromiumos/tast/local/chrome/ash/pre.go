...
var dummyAppsPre = newPrecondition("dummy_apps", 100)
...
// LoggedInWithDummyApps returns the precondition that Chrome is already logged
// in and 100 dummy applications (extensions) are installed. PreValue for the
// test with this precondition is an instance of *chrome.Chrome.
func LoggedInWithDummyApps() testing.Precondition {
	return dummyAppsPre
}
