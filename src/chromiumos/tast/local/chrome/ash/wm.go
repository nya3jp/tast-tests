...
func DragToShowOverview(ctx context.Context, width input.TouchCoord, height input.TouchCoord, stw *input.SingleTouchEventWriter, tconn *chrome.TestConn) error {
	windows, err := GetAllWindows(ctx, tconn)
	if err != nil {
