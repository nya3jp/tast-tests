...
// GetDeskCount asks Ash's DesksController to give it the number of desks that are currently open.
// This call will fail if the returned desk count is 0, which should never happen.
