...
// DesksInfo holds overall desk information.
...
// GetDeskCount asks Ash's DesksController for information about the open
// desks.
...
func GetDeskCount(ctx context.Context, tconn *chrome.TestConn) (int, error) {
	...
	if desks.NumDesks == 0 {
		return desks.NumDesks, errors.New("unexpected desk count of 0")
	}
	return desks.NumDesks, nil
}

// GetDesksInfo retrieves desk information defined in DesksInfo
