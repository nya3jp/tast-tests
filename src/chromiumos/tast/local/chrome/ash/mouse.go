...
// the display.
func MouseClick(ctx context.Context, tconn *chrome.TestConn, location Location, button MouseButton) error {
...
func MouseMove(ctx context.Context, tconn *chrome.TestConn, location Location, duration time.Duration) error {
...
// instantly.
func MouseDrag(ctx context.Context, tconn *chrome.TestConn, start, end Location, duration time.Duration) error {
