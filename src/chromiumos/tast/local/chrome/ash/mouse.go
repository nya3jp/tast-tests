...
// MouseClick causes a click event. The location is in DIP and in the display's
// coordinate.
...
// location is in DIP and in the display's coordinate. It does not support
// to move across multiple displays. When duration is 0, it moves instantly
// to the specified location. Otherwise, the cursor should move linearly during
// the period. Returns after the move event is handled by Ash.
...
// MouseDrag is a helper function to cause a drag of a left button from start to
// end.
