...
// ImmediateLocation returns the location of the node found by the input finders.
// It will not wait for the location to be stable.
func (ac *AutomationContext) ImmediateLocation(ctx context.Context, finders ...*nodewith.Finder) (*coords.Rect, error) {
	q, err := ac.findQuery(finders...)
	if err != nil {
		return nil, err
	}
...
func (ac *AutomationContext) Exists(finders ...*nodewith.Finder) func(context.Context) error {
...
// WaitUntilExists returns a function that waits until the node found by the input finders exists.
func (ac *AutomationContext) WaitUntilExists(finders ...*nodewith.Finder) func(context.Context) error {
	return func(ctx context.Context) error {
		return testing.Poll(ctx, func(ctx context.Context) error {
			return ac.Exists(finders...)(ctx)
		}, &ac.pollOpts)
	}
}
...
func (ac *AutomationContext) Gone(finders ...*nodewith.Finder) func(context.Context) error {
	return func(ctx context.Context) error {
		q, err := ac.findQuery(finders...)
		if err != nil {
			return err
	...
	`, q)
		var exists bool
		if err := ac.tconn.Eval(ctx, query, &exists); err != nil {
			// Deal with special case where finder is generic and too many nodes are found.
			if strings.Contains(err.Error(), "node finder too generic") {
				return err
			}
			return nil
		}
...
// WaitUntilGone returns a function that waits until the node found by the input finders is gone.
func (ac *AutomationContext) WaitUntilGone(finders ...*nodewith.Finder) func(context.Context) error {
	return func(ctx context.Context) error {
		return testing.Poll(ctx, func(ctx context.Context) error {
			return ac.Gone(finders...)(ctx)
		}, &ac.pollOpts)
	}
}
...
// mouseClick returns a function that clicks on the location of the node found by the input finders.
// It will wait until the location is stable before clicking.
// This returns a function to make it chainable in ui.Run.
func (ac *AutomationContext) mouseClick(ct clickType, finders ...*nodewith.Finder) func(context.Context) error {
	return func(ctx context.Context) error {
...
// immediateMouseClick returns a function that clicks on the location of the node found by the input finders.
// It will not wait until the location is stable before clicking.
// This returns a function to make it chainable in ui.Run.
func (ac *AutomationContext) immediateMouseClick(ct clickType, finders ...*nodewith.Finder) func(context.Context) error {
	return func(ctx context.Context) error {
		loc, err := ac.ImmediateLocation(ctx, finders...)
		if err != nil {
			return err
		}
		switch ct {
...
// LeftClick returns a function that left clicks on the location of the node found by the input finders.
// It will wait until the location is stable before clicking.
// This returns a function to make it chainable in ui.Run.
...
// RightClick returns a function that right clicks on the location of the node found by the input finders.
// It will wait until the location is stable before clicking.
// This returns a function to make it chainable in ui.Run.
...
// DoubleClick returns a function that double clicks on the location of the node found by the input finders.
// It will wait until the location is stable before clicking.
// This returns a function to make it chainable in ui.Run.
...
// ImmediateLeftClick returns a function that left clicks on the location of the node found by the input finders.
// It will wait until the location is stable before clicking.
// This returns a function to make it chainable in ui.Run.
...
// ImmediateRightClick returns a function that right clicks on the location of the node found by the input finders.
// It will not wait until the location is stable before clicking.
// This returns a function to make it chainable in ui.Run.
...
// ImmediateDoubleClick returns a function that double clicks on the location of the node found by the input finders.
// It will not wait until the location is stable before clicking.
// This returns a function to make it chainable in ui.Run.
...
func (ac *AutomationContext) LeftClickUntil(condition func(context.Context) error, finders ...*nodewith.Finder) func(context.Context) error {
	return func(ctx context.Context) error {
		if err := ac.LeftClick(finders...)(ctx); err != nil {
			return errors.Wrap(err, "failed to initially click the node")
		}
		return testing.Poll(ctx, func(ctx context.Context) error {
			if err := condition(ctx); err != nil {
				if err := ac.ImmediateLeftClick(finders...)(ctx); err != nil {
