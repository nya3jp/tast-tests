...
func PluginProcesses(path string) ([]*process.Process, error) {
	return processesByArgs(path, pluginRE)
}

// RendererProcesses returns Chrome renderer processes.
func RendererProcesses(path string) ([]*process.Process, error) {
	return processesByArgs(path, rendererRE)
}

// GPUProcesses returns Chrome gpu-process processes.
func GPUProcesses(path string) ([]*process.Process, error) {
	return processesByArgs(path, gpuRE)
}

// BrokerProcesses returns Chrome broker processes.
func BrokerProcesses(path string) ([]*process.Process, error) {
	return processesByArgs(path, brokerRE)
}
