...
// ARCUseHugePages describes the guest memory THP mode.
type ARCUseHugePages bool

// Valid values for HugePagesMode
const (
	HugePagesDisabled ARCUseHugePages = false
...
func (c *Config) ARCUseHugePages() ARCUseHugePages { return c.m.ARCUseHugePages }
...
type MutableConfig struct {
	...
	ARCUseHugePages                 ARCUseHugePages `reuse_match:"true"`
