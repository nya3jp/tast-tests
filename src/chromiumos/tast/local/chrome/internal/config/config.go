...
// CheckUserMount returns whether to check existence of the user mount after login.
func (c *Config) CheckUserMount() bool { return c.m.CheckUserMount }
...
type MutableConfig struct {
	...
	CheckUserMount                  bool       `reuse_match:"true"`
}
