...
// RtReportingAddr returns the address of the Real-time Reporting Server
func (c *Config) RtReportingAddr() string { return c.m.RtReportingAddr }
...
type MutableConfig struct {
	...
	RtReportingAddr                 string    `reuse_match:"true"`
