...
// DontDisableHIDScreenOnOobe returns true if to keep HID detection screen enabled in OOBE.
func (c *Config) DontDisableHIDScreenOnOobe() bool { return c.m.DontDisableHIDScreenOnOobe }
...
type MutableConfig struct {
	...
	DontDisableHIDScreenOnOobe      bool       `reuse_match:"true"`
}
...
func NewConfig(opts []Option) (*Config, error) {
	cfg := &Config{
		m: MutableConfig{
			...
			DontDisableHIDScreenOnOobe:      false,
		},
	}
