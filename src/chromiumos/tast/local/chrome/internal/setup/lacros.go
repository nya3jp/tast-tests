...
// EnsureLacrosReadyForLaunch waits for Lacros to be provisioned and ready for launch.
func EnsureLacrosReadyForLaunch(ctx context.Context, cfg config.LacrosConfig) (string, error) {
