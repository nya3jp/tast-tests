...
func PrepareAndroidNearbyDevice(ctx context.Context, d *adb.Device, apkPath string, dontOverrideGMS bool) (*AndroidNearbyDevice, error) {
	...
	if _, ok := pkgs[nearbySnippetPackage]; !ok {
		...
		testing.ContextLog(ctx, "successfully installed the Nearby snippet to Android device")
	} else {
