...
import (
	...
	commonnearby "chromiumos/tast/common/cros/nearbyshare"
...
func (f *nearbyShareFixture) PostTest(ctx context.Context, s *testing.FixtTestState) {
	...
	if err := nearbytestutils.SaveLogs(ctx, f.ChromeReader, filepath.Join(s.OutDir(), commonnearby.ChromeLog)); err != nil {
