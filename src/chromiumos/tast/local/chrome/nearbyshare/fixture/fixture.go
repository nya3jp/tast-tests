...
// Package fixture holds the fixture for nearby share tests.
package fixture
...
func init() {
	testing.AddFixture(&testing.Fixture{
		...
		Desc:            "Nearby Share enabled and configured with 'Data Uage' set to 'Offline' and 'Visibility' set to 'All Contacts'",
...
func (f *dataOfflineAllContactsFixture) Reset(ctx context.Context) error { return nil }
