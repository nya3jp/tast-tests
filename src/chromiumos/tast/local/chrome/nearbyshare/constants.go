...
// DetectShareTargetTimeout is the timeout for a sender to detect an available receiver and visa-versa.
const DetectShareTargetTimeout = time.Minute

// SmallFileTransferTimeout is the test timeout for small file transfer tests.
...
const LargeFileOnlineTransferTimeout = 1 * time.Minute
...
// TurnaroundTimeout is the standard timeout for activities performed in a test excluding the actual file transfer.
...
const TurnaroundTimeout = 2*DetectShareTargetTimeout + AdditionalTestTime
