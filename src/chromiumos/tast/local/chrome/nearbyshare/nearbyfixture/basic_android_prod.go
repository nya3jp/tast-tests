...
// addBasicAndroidProdFixtures registers fixtures for basic CrOS<->Android sharing tests.
// The Android phone will be signed in with a GAIA account that is not a member of any special Nearby user groups,
// so it will be using the prod Nearby version.
func addBasicAndroidProdFixtures() {
