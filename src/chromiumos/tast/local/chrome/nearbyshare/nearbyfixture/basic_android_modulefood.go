...
// addBasicAndroidModulefoodFixtures registers fixtures for basic CrOS<->Android sharing tests.
// The Android phone will be signed in with a GAIA account that is a member of the Nearby modulefood user group,
// so it will be using the modulefood Nearby version.
func addBasicAndroidModulefoodFixtures() {
	// Fixtures for in-contacts sharing tests.
	testing.AddFixture(&testing.Fixture{
		Name: "nearbyShareDataUsageOfflineAllContactsModulefood",
		...
		Parent:          "nearbyShareGAIALoginAndroidAccountModulefood",
	...
	testing.AddFixture(&testing.Fixture{
		Name: "nearbyShareDataUsageOfflineNoOneModulefood",
