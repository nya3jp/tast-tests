...
const (
	...
	// OobeGaiaPrimaryButtonClickScript is a javascript code to click on the
	// primary action button on the Gaia screen. With GaiaActionButtons
	// enabled - Gaia does not show the "Next" button. It is shown on the
	// OOBE side instead.
