...
// NotSkipOOBEPostLogin returns an Option that can be passed to stay in OOBE after user login.
func NotSkipOOBEPostLogin() Option {
	return func(c *Chrome) {
		c.skipOOBEPostLogin = false
	}
}
...
type Chrome struct {
	...
	keepState              bool
	loginMode              loginMode
	skipOOBEPostLogin      bool // skip OOBE post user login
	region                 string
