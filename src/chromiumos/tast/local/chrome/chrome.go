...
// Reconnect reconnects the chrome session to the browser.
// After the session is reconnected, test API connection needs to be regenerated by the caller by calling
// chrome.TestAPIConn().
