...
func init() {
	testing.AddFixture(&testing.Fixture{
		...
		Impl:     NewProjectorFixture(chrome.EnableFeatures("Projector"), chrome.EnableFeatures("ProjectorAppDebug"), chrome.EnableFeatures("ProjectorAnnotator"), chrome.ExtraArgs("--projector-extended-features-disabled")),
		Vars: []string{
			"ui.gaiaPoolDefault",
		},
