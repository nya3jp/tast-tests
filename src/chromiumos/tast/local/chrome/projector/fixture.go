...
func init() {
	testing.AddFixture(&testing.Fixture{
		Name:     "projectorLoginExtendedFeaturesDisabled",
		Desc:     "Regular user login with Projector feature flag enabled and extended features disabled",
		Contacts: []string{"tobyhuang@chromium.org", "cros-projector@google.com"},
		Impl:     NewProjectorFixture(chrome.EnableFeatures("Projector"), chrome.EnableFeatures("ProjectorAppDebug"), chrome.EnableFeatures("ProjectorAnnotator"), chrome.EnableFeatures("ProjectorTutorialVideoView"), chrome.ExtraArgs("--projector-extended-features-disabled")),
		Vars: []string{
			"ui.gaiaPoolDefault",
		},
