...
type Context interface {
	// Close cleans up its internal resoruce.
	Close() error
...
func New(ctx context.Context, tconn *chrome.TestConn) (Context, error) {
	...
	return NewWithTabletMode(ctx, tconn, isTablet)
}

// NewWithTabletMode creates the COntext instance for the gicen tablet-mode
// state.
func NewWithTabletMode(ctx context.Context, tconn *chrome.TestConn, isTablet bool) (Context, error) {
	if isTablet {
