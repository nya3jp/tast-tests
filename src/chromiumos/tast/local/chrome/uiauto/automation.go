...
// Matches returns whether the NodeInfo matches the Finder. To do this, we find
// all NodeInfos that match the finder and compare each one to |actual|.
func (ac *Context) Matches(ctx context.Context, actual *NodeInfo, finder *nodewith.Finder) (bool, error) {
