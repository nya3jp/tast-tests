...
// WaitForSmartUnlockPasswordPrompt waits for the signin screen indication that the user must login one more time with their password to enable Smart Lock signin.
