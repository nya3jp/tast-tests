...
func ClickSmartLockArrowButton(ctx context.Context, tconn *chrome.TestConn) error {
	ui := uiauto.New(tconn)
	userImage := nodewith.NameContaining("Unlocked by your phone. Tap or click to enter.").ClassName("ArrowButtonView")
...
func WaitForSmartUnlockReady(ctx context.Context, tconn *chrome.TestConn) error {
	finder := nodewith.NameContaining("Unlocked by your phone. Tap or click to enter.").ClassName("ArrowButtonView")
	ui := uiauto.New(tconn)
