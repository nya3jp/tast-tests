...
var (
	...
	// NetworkDetailedViewRevamp is the detailed Network view with
	// QuickSettingsNetworkRevamp flag enabled within the Quick Settings.
	...
	// NetworkDetailedViewWifiToggleButton is the WiFi toggle child within the
	// Network detailed view with QuickSettingsNetworkRevamp flag enabled
	NetworkDetailedViewWifiToggleButton = nodewith.HasClass("TrayToggleButton").NameContaining("Wi-Fi").Ancestor(NetworkDetailedViewRevamp)
)
...
// are already open.
func NavigateToNetworkDetailedView(ctx context.Context, tconn *chrome.TestConn, ravampEnabled bool) error {
