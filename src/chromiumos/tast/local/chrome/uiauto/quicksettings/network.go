...
var (
	...
	// ToggleMobileData is the switch to enable/disable Mobile data within network quick settings
	ToggleMobileData = nodewith.Name("Mobile data").HasClass("TrayToggleButton").Role(role.Switch)
)
