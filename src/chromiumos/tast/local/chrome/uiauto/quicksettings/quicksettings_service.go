...
// are already open.
func (s *Service) NavigateToBluetoothDetailedView(ctx context.Context, e *empty.Empty) (*empty.Empty, error) {
	...
	return &empty.Empty{}, NavigateToBluetoothDetailedView(ctx, tconn)
}
