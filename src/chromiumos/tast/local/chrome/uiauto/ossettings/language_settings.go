...
// ChangeDeviceLanguageAndRestart changes to certain device language and confirm to restart.
func (s *OSSettings) ChangeDeviceLanguageAndRestart(ctx context.Context, tconn *chrome.TestConn, searchKeyword, languageUniqueIdentifier string) error {
