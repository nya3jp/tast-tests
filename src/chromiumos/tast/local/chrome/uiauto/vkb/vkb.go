...
// ShiftStateType describes the shift state of the virtual keyboard.
type ShiftStateType int

// Available virtual keyboard shift state.
// Use ShiftStateUnknown when any errors happen in fetching shift state.
const (
	ShiftStateNone ShiftStateType = iota
	ShiftStateShifted
	ShiftStateLocked
	ShiftStateUnknown
)
...
func (shiftState ShiftStateType) String() string {
	switch shiftState {
	case ShiftStateNone:
		return "none"
...
func (vkbCtx *VirtualKeyboardContext) ShiftState(ctx context.Context) (ShiftStateType, error) {
...
func (vkbCtx *VirtualKeyboardContext) WaitUntilShiftStatus(expectedShiftState ShiftStateType) uiauto.Action {
	return func(ctx context.Context) error {
		return testing.Poll(ctx, func(ctx context.Context) error {
