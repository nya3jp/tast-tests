...
// NOTE: This function is expected to fail with LegacyLauncher when tabletMode is false.
...
// DismissSortNudge will get rid of the sort nudge that appears the first time the productivity launcher is open.
// This method will attemp to trigger an app list sort and then wait until the Undo button exists.
// NOTE: This method is expected to fail with LegacyLauncher.
