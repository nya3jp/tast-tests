...
// StopRecordFromKB stops and saves the record started by StartRecordFromKB.
// It copies the record file to the target dir.
// It also removes the record file from Downloads for cleanup.
func StopRecordFromKB(ctx context.Context, tconn *chrome.TestConn, dir string) error {
