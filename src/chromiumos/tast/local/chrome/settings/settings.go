...
func NightLightSchedule(ctx context.Context, c *chrome.TestConn) (uint, error) {
	var schedule uint
...
func SetNightLightSchedule(ctx context.Context, c *chrome.TestConn, schedule uint) error {
	expr := fmt.Sprintf(
		`new Promise(function(resolve, reject) {
