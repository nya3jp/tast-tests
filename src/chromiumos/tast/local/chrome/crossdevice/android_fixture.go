...
// NewCrossDeviceAndroid creates a fixture that sets up an Android device for multidevice feature testing.
...
func init() {
	...
	testing.AddFixture(&testing.Fixture{
		...
		Desc: "Set up Android device for CrOS multidevice testing",
...
func (f *crossdeviceAndroidFixture) SetUp(ctx context.Context, s *testing.FixtState) interface{} {
	...
	androidUsername := s.RequiredVar("crossdevice.username")
	androidPassword := s.RequiredVar("crossdevice.password")
