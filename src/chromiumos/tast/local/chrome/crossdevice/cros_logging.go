...
func GetCrosAttributes(ctx context.Context, tconn *chrome.TestConn, username string) (*commoncrossdevice.CrosAttributes, error) {
	attrs := commoncrossdevice.CrosAttributes{
		User: username,
	}
