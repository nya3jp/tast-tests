...
import (
	...
	commoncrossdevice "chromiumos/tast/common/cros/crossdevice"
...
type crossdeviceFixture struct {
	...
	crosAttributes                    *commoncrossdevice.CrosAttributes
...
func saveDeviceAttributes(crosAttrs *commoncrossdevice.CrosAttributes, androidAttrs *AndroidAttributes, filepath string) error {
	attributes := struct {
		CrOS    *commoncrossdevice.CrosAttributes
