...
// Calling this function effectively bypasses the multidevice onboarding flow that is triggered from OOBE or OS settings.
...
func (c *AndroidDevice) Pair(ctx context.Context, timeout time.Duration) error {
