...
// Call applies fn as a JavaScript function to given args on this connection.
// Result will be stored to out if given, if it is not nil.
// If given, both args and out must be either JSON serializable/deserializable data,
// or *chrome.JSObject.
// Examples:
//
