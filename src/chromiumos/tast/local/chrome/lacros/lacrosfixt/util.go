...
func WaitForReady(ctx context.Context, vars SetupVars, mode SetupMode) (string, error) {
	testing.ContextLogf(ctx, "Waiting for Lacros ready with vars: %+v, mode: %s", vars, mode)
	if vars.deployed {
