...
// NewConfig creates a new LacrosConfig instance with the default config that
// uses the lacros-chrome in the rootfs partition.
// It is useful when the caller doesn't need to care about the lacros-chrome
// deployed from Chromium CI with the var LacrosDeployedBinary.
