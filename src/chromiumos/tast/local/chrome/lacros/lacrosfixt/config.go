...
// NewConfig creates a new lacros.Config instance with the default config that uses the lacros-chrome in the rootfs partition.
...
// NewConfigFromState creates a new lacros.Config instance.
