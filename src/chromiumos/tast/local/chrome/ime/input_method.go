...
// FranchFrance represents the input method of Franch (France).
var FranchFrance = InputMethod{
	Name: "Franch (France)",
	ID:   "xkb:fr::fra",
}
...
// ChineseCantonese represents the input method of Chinese Cantonese.
var ChineseCantonese = InputMethod{
