...
func StartFakeAdaptiveChargingMLService(ctx context.Context) (*FakeAdaptiveChargingMLService, error) {
	...
	f.conn.Export(introspect.NewIntrospectable(intro), path, "org.freedesktop.DBus.Introspectable")
...
// StopService closes the DBus connection, stopping the fake service.
