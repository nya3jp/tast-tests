...
func StartActivity(ctx context.Context, a *arc.ARC, pkg, activityName string) (CleanupCallback, error) {
...
func StartActivityWithArgs(ctx context.Context, a *arc.ARC, pkg, activityName string, prefixes, suffixes []string) (CleanupCallback, error) {
