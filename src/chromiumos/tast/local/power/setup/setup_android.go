...
// InstallAndroidApp installs an Android APK.
func InstallAndroidApp(ctx context.Context, a *arc.ARC, pkg, apkDataPath string) (CleanupCallback, error) {
	testing.ContextLogf(ctx, "Installing Android app %q from apk %q", pkg, apkDataPath)
...
// StartAndroidActivity starts an Android activity.
func StartAndroidActivity(ctx context.Context, a *arc.ARC, pkg, activityName string) (CleanupCallback, error) {
