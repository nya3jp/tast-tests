...
type cpuidleCounter struct {
	...
	timeMetric, usageMetric perf.Metric
}
...
func (vs cpuidleCounterValues) reportDiff(counters cpuidleCounters, prevValues cpuidleCounterValues, duration time.Duration, p *perf.Values) error {
...
type AggregateCpuidleMetrics struct {
	...
	prevValues []cpuidleCounterValue
}
...
func (a *AggregateCpuidleMetrics) Snapshot(ctx context.Context, p *perf.Values) error {
	...
	values.reportDiff(a.counters, a.prevValues, duration, p)
	a.prevValues = values
	a.prevTime = t1
...
// Stop does nothing.
func (a *AggregateCpuidleMetrics) Stop(ctx context.Context, values *perf.Values) error {
	return nil
}
