...
// readJiffies reads CPU load and total jiffies from /proc/stat. This file
// contains a line for each CPU (core) and an aggregated value of all CPUs.
// The aggregated value (first line) is used in readJiffies. Therefore, a
// reported CPU load value of 1.0 indicates 100% CPU usage on all CPUs.
