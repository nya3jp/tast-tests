...
// setBacklightLux is a setup.Action that sets the screen backlight
// brightness.
...
// given lux level.
func SetBacklightLux(ctx context.Context, lux uint) setup.Action {
...
// setKBBrightness is a setup.Action that sets the keyboard backlight
// brightness.
...
// SetKeyboardBrightness creates a setup.Action that sets the keyboard
// backlight brightness.
func SetKeyboardBrightness(ctx context.Context, brightness uint) setup.Action {
...
// muteAudio is a setup.Action that mutes audio.
...
// MuteAudio creates a setup.Action that sets volume to zero, recording
// gain to zero, and mutes audio.
func MuteAudio(ctx context.Context) setup.Action {
	return &muteAudio{
		ctx:        ctx,
		prevGain:   0.0,
		prevMuted:  false,
