...
// muteAudio is a setup.SetupAction that mutes audio.
...
// MuteAudio creates a setup.SetupAction that sets volume to zero, recording
// gain to zero, and mutes audio.
func MuteAudio(ctx context.Context) setup.SetupAction {
	return &muteAudio{
		ctx:        ctx,
		prevGain:   0.0,
		prevMuted:  false,
...
// disableNetworkInterfaces is a setup.SetupAction that disables all network
...
// DisableNetworkInterfaces creates a setup.SetupAction that disables all
// network interfaces that match a Regexp.
func DisableNetworkInterfaces(ctx context.Context, pattern *regexp.Regexp) setup.SetupAction {
