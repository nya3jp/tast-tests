...
// level.
func SetBatteryDischarge(ctx context.Context, lowBatteryMargin float64, chain CleanupChain) (CleanupChain, error) {
	...
	return SetupSucceeded(setupFailed, chain, func(ctx context.Context) error {
		...
		testing.ContextLog(ctx, "Restored battery discharge to normal")
		return nil
	})
}
