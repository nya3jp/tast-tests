...
// NewPowerManagerEmitter stops real power manager.
...
func (*PowerManagerEmitter) EmitPowerSupplyPoll(ctx context.Context, msg *pmpb.PowerSupplyProperties) error {
	return emitEvent(ctx, msg, "PowerSupplyPoll")
}

// EmitSuspendImminent emits SuspendImminent D-Bus signal.
func (*PowerManagerEmitter) EmitSuspendImminent(ctx context.Context, msg *pmpb.SuspendImminent) error {
	return emitEvent(ctx, msg, "SuspendImminent")
}

// EmitDarkSuspendImminent emits DarkSuspendImminent D-Bus signal.
func (*PowerManagerEmitter) EmitDarkSuspendImminent(ctx context.Context, msg *pmpb.SuspendImminent) error {
	return emitEvent(ctx, msg, "DarkSuspendImminent")
}

// EmitSuspendDone emits SuspendDone D-Bus signal.
func (*PowerManagerEmitter) EmitSuspendDone(ctx context.Context, msg *pmpb.SuspendDone) error {
