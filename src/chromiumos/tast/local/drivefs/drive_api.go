...
func CreateDriveAPI(ctx context.Context, conn *chrome.Conn, oauthCredentials string) (*DriveAPI, error) {
	...
	// Navigate to the URL to provide oauth consent.
	if err := conn.Navigate(ctx, authURL); err != nil {
