...
func init() {
	testing.AddFixture(&testing.Fixture{
		...
		Impl: &kiosk{},
		// SetUp does not require a timeout since it does not need a context.
		// Setting 2 minutes as we create new Chrome connection. Waiting for
		// cryptohome for a user has 80 seconds timeout on itself.
