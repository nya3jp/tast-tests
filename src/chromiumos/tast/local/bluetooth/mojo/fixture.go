...
func (*BTConn) SetUp(ctx context.Context, s *testing.FixtState) interface{} {
...
func (m *BTConn) TearDown(ctx context.Context, s *testing.FixtState) {
	...
	if err := m.Js.Release(ctx); err != nil {
		s.Fatal(errors.Warp(err, "failed to release Bluetooth Mojo JS object")
	}
	*/
}
