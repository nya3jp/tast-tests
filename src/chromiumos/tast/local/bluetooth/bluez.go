...
// AllAdapters creates an Adapter for all bluetooth adapters in the system.
func AllAdapters(ctx context.Context) ([]*Adapter, error) {
	...
	for _, path := range managed[iface] {
