...
func NewAvailableLimit(margin int64) (Limit, error) {
...
func NewAvailableCriticalLimit() (Limit, error) {
...
// OOM killer.
func NewPageReclaimLimit() (Limit, error) {
	infos, err := ReadZoneInfo()
	if err != nil {
...
func NewCompositeLimit(limits ...Limit) Limit {
