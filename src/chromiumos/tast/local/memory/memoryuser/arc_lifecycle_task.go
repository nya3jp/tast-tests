...
// BestEffortTask allows tasks to query if a task successfully ran. Used by
// tasks that are allowed to fail without stopping the test.
type BestEffortTask interface {
...
// BestEffortArcLifecycleTask conforms to BestEffortTask interface.
var _ BestEffortTask = (*BestEffortArcLifecycleTask)(nil)
