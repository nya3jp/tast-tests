...
func (ml *chromeOSCriticalMemLow) Distance(_ context.Context) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "failed to read ChromeOS available")
	}
...
// NewNearOOMMemLow creates a MemLow that measure how far away ChromeOS is from
// the Linux OOM Killer being invoked.
