...
// IsHidDetectionMouseNotDetected checks if there is no mouse detected in
// the OOBE HID Detection page.
func IsHidDetectionMouseNotDetected(ctx context.Context, oobeConn *chrome.Conn, tconn *chrome.TestConn) error {
