...
// Category represents a category flag that can be passed to a cros_healthd
// command.
type Category string

// Categories for cros_healthd commands.
const (
	CategoryBacklight         Category = "backlight"
	CategoryBattery           Category = "battery"
	CategoryCachedVPD         Category = "cached_vpd"
	CategoryCPU               Category = "cpu"
	CategoryFan               Category = "fan"
	CategoryMemory            Category = "memory"
	CategoryStatefulPartition Category = "stateful_partition"
	CategoryStorage           Category = "storage"
	CategoryTimezone          Category = "timezone"
)
...
func FetchTelemetry(ctx context.Context, category Category, outDir string) ([][]string, error) {
