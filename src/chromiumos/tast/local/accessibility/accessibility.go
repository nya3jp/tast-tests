...
// NewChromeVoxExtConn returns a connection to the ChromeVox extension's background page.
...
func NewChromeVoxExtConn(ctx context.Context, c *chrome.Chrome) (*ChromeVoxConn, error) {
