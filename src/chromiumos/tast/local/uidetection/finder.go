...
// maxScreenSize is the maximum width / height of the screen.
...
func above(px int) *coords.Rect {
	return &coords.Rect{Left: 0, Top: 0, Width: maxScreenSize, Height: px}
}

func below(px int) *coords.Rect {
	return &coords.Rect{Left: 0, Top: px, Width: maxScreenSize, Height: maxScreenSize}
}

func leftOf(px int) *coords.Rect {
	return &coords.Rect{Left: 0, Top: 0, Width: px, Height: maxScreenSize}
}

func rightOf(px int) *coords.Rect {
	return &coords.Rect{Left: px, Top: 0, Width: maxScreenSize, Height: maxScreenSize}
}
...
func (f *Finder) locationPx(ctx context.Context, uda *Context, scaleFactor float64) (*Location, error) {
	...
	var imagePng []byte
	var err error
	boundingBox := coords.Rect{Left: 0, Top: 0, Width: maxScreenSize, Height: maxScreenSize}
