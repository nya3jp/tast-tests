...
func (f *Finder) a11yNodeBuilder(other *nodewith.Finder, direction directionFn, side func(coords.Rect) int) *Finder {
	return f.newConstraint(func(ctx context.Context, uda *Context, scaleFactor float64) (*coords.Rect, error) {
		loc, err := uiauto.New(uda.tconn).WithPollOpts(uda.pollOpts).Location(ctx, other)
		if err != nil {
			return nil, err
...
func (f *Finder) AboveA11yNode(other *nodewith.Finder) *Finder {
	return f.a11yNodeBuilder(other, above, func(r coords.Rect) int { return r.Top })
}
...
func (f *Finder) BelowA11yNode(other *nodewith.Finder) *Finder {
	return f.a11yNodeBuilder(other, below, func(r coords.Rect) int { return r.Bottom() })
}
...
func (f *Finder) LeftOfA11yNode(other *nodewith.Finder) *Finder {
	return f.a11yNodeBuilder(other, leftOf, func(r coords.Rect) int { return r.Left })
}
...
func (f *Finder) RightOfA11yNode(other *nodewith.Finder) *Finder {
	return f.a11yNodeBuilder(other, rightOf, func(r coords.Rect) int { return r.Right() })
}
