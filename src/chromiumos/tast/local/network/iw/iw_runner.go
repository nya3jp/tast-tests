...
// NewRunner creates a local iw command runner.
func NewRunner() *Runner {
	return &Runner{}
}

// NewRunnerWithDUT creates a remote iw command runner.
func NewRunnerWithDUT(dut *dut.DUT) *Runner {
	return &Runner{
		dut: dut,
	}
}

// TODO: some better way to generalize this...

func (r *Runner) cmdOutput(ctx context.Context, cmd string, args ...string) ([]byte, error) {
	if r.dut == nil {
		return testexec.CommandContext(ctx, cmd, args...).Output(testexec.DumpLogOnError)
	}
	return r.dut.Command(cmd, args...).Output(ctx)
}

func (r *Runner) cmdRun(ctx context.Context, cmd string, args ...string) error {
	if r.dut == nil {
		return testexec.CommandContext(ctx, cmd, args...).Run(testexec.DumpLogOnError)
	}
	return r.dut.Command(cmd, args...).Run(ctx)
}
...
func (r *Runner) ListInterfaces(ctx context.Context) ([]*NetDev, error) {
	out, err := r.cmdOutput(ctx, "iw", "dev")
	if err != nil {
...
func (r *Runner) ListPhys(ctx context.Context) ([]*Phy, error) {
	out, err := r.cmdOutput(ctx, "iw", "list")
	if err != nil {
...
func (r *Runner) TimedScan(ctx context.Context, iface string,
	...
	startTime := time.Now()
	out, err := r.cmdOutput(ctx, "iw", args...)
...
func (r *Runner) ScanDump(ctx context.Context, iface string) ([]*BSSData, error) {
	out, err := r.cmdOutput(ctx, "iw", "dev", iface, "scan", "dump")
	if err != nil {
...
func (r *Runner) GetLinkValue(ctx context.Context, iface string, iwLinkKey string) (string, error) {
	res, err := r.cmdOutput(ctx, "iw", "dev", iface, "link")
	if err != nil {
...
func (r *Runner) GetOperatingMode(ctx context.Context, iface string) (string, error) {
	out, err := r.cmdOutput(ctx, "iw", "dev", iface, "info")
	if err != nil {
...
func (r *Runner) GetRegulatoryDomain(ctx context.Context) (string, error) {
	out, err := r.cmdOutput(ctx, "iw", "reg", "get")
	if err != nil {
...
func (r *Runner) SetTxPower(ctx context.Context, iface string, mode string, power int) error {
	if err := r.cmdRun(ctx, "iw", "dev", iface, "set", "txpower", mode, strconv.Itoa(power)); err != nil {
...
func (r *Runner) SetFreq(ctx context.Context, iface string, freq int) error {
	if err := r.cmdRun(ctx, "iw", "dev", iface, "set", "freq", strconv.Itoa(freq)); err != nil {
...
func (r *Runner) SetAntennaBitmap(ctx context.Context, phy string, txBitmap int, rxBitmap int) error {
	if err := r.cmdRun(ctx, "iw", "phy", phy, "set", "antenna", strconv.Itoa(txBitmap),
