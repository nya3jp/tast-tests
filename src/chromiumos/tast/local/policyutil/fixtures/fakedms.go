...
type fakeDMSFixture struct {
	...
	// tast-user@managedchrome.com if policyUserVar is not set in fakeDMSFixture.
	policyUser string
	// The policyUserVar is the account variable(i.e. "unicorn.childUser") when using
	// a different account indstead of tast-user@managedchrome.com for policy test.
	// It is used to setup the value of policyUser.
