...
// openedPage store information that allows chaining SettingsPage() and SelectNode() together
...
// SettingsPage open a settings page with given link (e.g. "content/location" -> "chrome://settings/content/location").
...
// OSSettingsPage open the OS settings page with given link (e.g. "osAccessibility" -> "chrome://os-settings/osAccessibility").
// The returned openedPage value can be used to select a node from the node tree (not just from the page).
...
// UnlockOSSettingsPage open the OS settings page with given link (e.g. "osAccessibility" -> "chrome://os-settings/osAccessibility").
// If the opened settings page is password protected, try to authenticate with the given password.
// The returned openedPage value can be used to select a node from the node tree (not just from the page).
func UnlockOSSettingsPage(ctx context.Context, cr *chrome.Chrome, shortLink, password string) *openedPage {
	page := &openedPage{
		cr: cr,
	}
