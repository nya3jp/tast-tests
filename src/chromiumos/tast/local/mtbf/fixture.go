...
func init() {
	testing.AddFixture(&testing.Fixture{
		...
		Contacts:        []string{"xliu@cienet.com", "alfredyu@cienet.com"},
...
func (f *mtbfCleanTabsFixture) PreTest(ctx context.Context, s *testing.FixtTestState) {
	...
	if f.browserType == browser.TypeLacros {
		...
		// Maximize the lacros window to avoid the node laction issue.
		// TODO(b/236799853): remove this once the lacros node laction issue fixed.
		func() {
