...
func GetAudioPlayingTime(ctx context.Context, conn *chrome.Conn) (playtime int, err error) {
...
func GetOSVolume(ctx context.Context, conn *chrome.Conn) (volume int, err error) {
...
func SetOSVolume(ctx context.Context, conn *chrome.Conn, volume int) (err error) {
...
func IsOSVolumeMute(ctx context.Context, conn *chrome.Conn) (isMute bool, err error) {
	javascript := `new Promise((resolve, reject) => {
...
func SetOSVolumeMute(ctx context.Context, conn *chrome.Conn, isMute bool) (err error) {
