...
func RemovableDevices(ctx context.Context) (RemovableDeviceDetail, error) {
	...
	// e.g.:
	/*
		/dev/nvme0n1p1 /run/daemon-store/smbproviderd/220e79f2af3d13a89221495062a6438cdb98f361 ext4 rw,seclabel,nosuid...
		/dev/nvme0n1p1 /run/daemon-store/session_manager/220e79f2af3d13a89221495062a6438cdb98f361 ext4 rw,seclabel...
		/dev/nvme0n1p1 /run/daemon-store/crash/220e79f2af3d13a89221495062a6438cdb98f361 ext4 rw,seclabel,nosuid...
		/dev/nvme0n1p1 /run/daemon-store/dlp/220e79f2af3d13a89221495062a6438cdb98f361 ext4 rw,seclabel,nosuid...
		/dev/nvme0n1p1 /run/daemon-store/usb_bouncer/220e79f2af3d13a89221495062a6438cdb98f361 ext4 rw,seclabel...
		/dev/nvme0n1p1 /run/daemon-store/cdm-oemcrypto/220e79f2af3d13a89221495062a6438cdb98f361 ext4 rw,seclabel...
		/dev/nvme0n1p1 /run/daemon-store/smbfs/220e79f2af3d13a89221495062a6438cdb98f361 ext4 rw,seclabel,nosuid...
		/dev/nvme0n1p1 /run/daemon-store/u2f/220e79f2af3d13a89221495062a6438cdb98f361 ext4 rw,seclabel,nosuid...
		tmpfs /etc/hosts.d tmpfs rw,seclabel,nosuid,nodev,noexec,relatime,mode=755 0 0
		tmpfs /run/arc/sdcard tmpfs rw,seclabel,nosuid,nodev,noexec,relatime,mode=755,uid=655360,gid=665357 0 0
		fusebox: /media/fuse/fusebox fuse.fusebox rw,dirsync,nosuid,nodev,noexec...
		tmpfs /run/arcvm tmpfs rw,seclabel,nosuid,nodev,noexec,relatime,mode=755 0 0
		nsfs /run/namespaces/mnt_concierge nsfs rw,noexec 0 0
