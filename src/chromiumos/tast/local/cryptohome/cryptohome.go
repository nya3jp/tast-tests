...
// ExtendAuthSession extends the internal timer of a given AuthSession with authSessionID.
func ExtendAuthSession(ctx context.Context, authSessionID, extensionDuration string) error {
...
func AuthSessionMountFlow(ctx context.Context, isKioskUser bool, username, password string, createUser bool, extensionDuration string) error {
