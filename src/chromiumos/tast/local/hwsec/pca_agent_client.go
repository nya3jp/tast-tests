...
// HandleEnrollRequest calls pca_agent_client to process the enroll reqeust.
...
// HandleCertificateRequest calls pca_agent_client to process the certificate reqeust.
