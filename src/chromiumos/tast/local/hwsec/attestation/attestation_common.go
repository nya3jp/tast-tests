...
const (
	// DefaultPreparationForEnrolmentTimeout is the defualt timeout of waiting for preparation of enrollment.
	DefaultPreparationForEnrolmentTimeout int = 40 * 1000
	// DefaultTakingOwnershipTimeout is the defualt timeout of waiting for taking ownership
