...
// Console represents the CDP connection to a bt_console page.
type Console struct {
	conn *chrome.Conn
}

// NewConsole creates a bluetooth console to control bluetooth devices.
func NewConsole(ctx context.Context, cr *chrome.Chrome) (*Console, error) {
...
func (c *Console) scanOn(ctx context.Context) error {
...
func (c *Console) IsA2dp(ctx context.Context, btAddress string) (bool, error) {
...
func (c *Console) IsHsp(ctx context.Context, btAddress string) (bool, error) {
	info, err := c.GetDeviceInfo(ctx, btAddress)
...
func (c *Console) GetDeviceInfo(ctx context.Context, address string) (string, error) {
...
func (c *Console) scanOff(ctx context.Context) error {
...
func (c *Console) Connect(ctx context.Context, btDevAddr string) error {
	retry := 0
	connected := false
	var err error
...
func (c *Console) connectBtDevice(ctx context.Context, btDevAddr string) error {
...
func (c *Console) Disconnect(ctx context.Context, btDevAddr string) error {
...
func (c *Console) getTermTxt(ctx context.Context) (string, error) {
	var termTxt string
...
func (c *Console) CheckScanning(ctx context.Context, on bool) (bool, error) {
	var err error
	err = c.scanOn(ctx)
...
func (c *Console) sendCommand(ctx context.Context, command string) error {
