...
func init() {
	testing.AddService(&testing.Service{
		Register: func(srv *grpc.Server, s *testing.ServiceState) {
			svcutil.RegisterCommServiceServer(srv, &CommService{chrome.SvcLoginReusePre{S: s}})
		},
	})
}

// CommService implements tast.mtbf.svcutil.CommService.
...
func (c *CommService) TakeScreenshot(ctx context.Context, req *empty.Empty) (*svcutil.Screenshot, error) {
	...
	return &svcutil.Screenshot{Content: sDec}, nil
