...
func init() {
	testing.AddTest(&testing.Test{
		Func: StartupInSignedInMode, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Starts Google Assistant service in signed-in mode and checks the running status",
