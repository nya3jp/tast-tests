...
func init() {
	testing.AddTest(&testing.Test{
		Func: LauncherToPeekingAnimationPerf, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Measures the animation smoothness of Assistant peeking mode while launcher is open",
