...
func init() {
	testing.AddTest(&testing.Test{
		Func: StartupInSignedOutMode, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Starts Google Assistant service in signed-out mode and checks the running status",
