...
func init() {
	testing.AddTest(&testing.Test{
		...
		Desc:         "Measures the animation smoothness of card elements",
...
// animating card elements in and out of the assistant frame.
...
// runCardQueries performs two card queries in order to test the
// animate in and animate out behavior of the first card.
