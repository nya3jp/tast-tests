...
func CrostiniStartEverything(ctx context.Context, s *testing.State) {
	...
	defer subtestCancel()
	// TODO(timzheng): Pass the ew to all other subtests that use the keyboard.
	...
	if err != nil {
		...
		subtest.AppDisplayDensityThroughLauncher(subtestCtx, s, tconn, ew, cont.VM.Concierge.GetOwnerID(),
