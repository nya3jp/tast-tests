...
main() {
  ...
  alsa_conformance_test.py \
      ...
      -P hw:0,0 --json --rate-criteria-diff-pct 0.1 \
      --json-file /tmp/alsa_conformance_test_playback_results.json
  alsa_conformance_test.py \
      --test-suites test_params test_rates test_all_pairs \
      -C hw:0,0 --json --rate-criteria-diff-pct 0.1 \
      --json-file /tmp/alsa_conformance_test_capture_results.json
}
