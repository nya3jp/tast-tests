...
func init() {
	testing.AddTest(&testing.Test{
		Func: Smartsheet, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Functional test for Smartsheet that installs the app also verifies it is logged in and that the main page is open, checks Smartsheet correctly changes the window state in both clamshell and touchview mode",
