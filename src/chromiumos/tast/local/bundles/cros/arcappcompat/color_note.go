...
var clamshellLaunchForColorNote = []testutil.TestCase{
	{Name: "Launch app in Clamshell", Fn: launchAppForColorNote},
}

// touchviewLaunchForColorNote launches ColorNote in tablet mode.
var touchviewLaunchForColorNote = []testutil.TestCase{
	{Name: "Launch app in Touchview", Fn: launchAppForColorNote},
}

func init() {
	testing.AddTest(&testing.Test{
		Func: ColorNote, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Functional test for ColorNote that installs the app also verifies it is logged in and that the main page is open, checks ColorNote correctly changes the window state in both clamshell and touchview mode",
		...
		Params: []testing.Param{{
			...
			Val: testutil.TestParams{
				LaunchTests: clamshellLaunchForColorNote,
			...
			Name: "tablet_mode",
			Val: testutil.TestParams{
				LaunchTests: touchviewLaunchForColorNote,
