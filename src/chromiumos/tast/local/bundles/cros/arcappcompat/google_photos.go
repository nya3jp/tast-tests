...
var clamshellLaunchForGooglePhotos = []testutil.TestCase{
	{Name: "Launch app in Clamshell", Fn: launchAppForGooglePhotos, Timeout: testutil.LaunchTestCaseTimeout, TType: testutil.Launch},
}

// touchviewLaunchForGooglePhotos launches GooglePhotos in tablet mode.
var touchviewLaunchForGooglePhotos = []testutil.TestCase{
	{Name: "Launch app in Touchview", Fn: launchAppForGooglePhotos, Timeout: testutil.LaunchTestCaseTimeout, TType: testutil.Launch},
}
