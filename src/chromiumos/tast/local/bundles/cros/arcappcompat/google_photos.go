...
func init() {
	testing.AddTest(&testing.Test{
		Func: GooglePhotos, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Functional test for GooglePhotos that installs the app also verifies it is logged in and that the main page is open, checks GooglePhotos correctly changes the window state in both clamshell and touchview mode",
