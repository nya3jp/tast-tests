...
var clamshellLaunchForAdobeIllustratorDraw = []testutil.TestCase{
...
var touchviewLaunchForAdobeIllustratorDraw = []testutil.TestCase{
	{Name: "Launch app in Touchview", Fn: launchAppForAdobeIllustratorDraw},
}

func init() {
	testing.AddTest(&testing.Test{
		Func: AdobeIllustratorDraw, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Functional test for AdobeIllustratorDraw that installs the app also verifies it is logged in and that the main page is open, checks AdobeIllustratorDraw correctly changes the window state in both clamshell and touchview mode",
		...
		Params: []testing.Param{{
			...
			Val: testutil.TestParams{
				LaunchTests: clamshellLaunchForAdobeIllustratorDraw,
			...
			Name: "tablet_mode",
			Val: testutil.TestParams{
				LaunchTests: touchviewLaunchForAdobeIllustratorDraw,
