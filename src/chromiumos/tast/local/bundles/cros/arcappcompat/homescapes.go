...
var clamshellLaunchForHomescapes = []testutil.TestCase{
	{Name: "Launch app in Clamshell", Fn: launchAppForHomescapes, Timeout: testutil.LaunchTestCaseTimeout, TType: testutil.Launch},
}

// touchviewLaunchForHomescapes launches Homescapes in tablet mode.
var touchviewLaunchForHomescapes = []testutil.TestCase{
	{Name: "Launch app in Touchview", Fn: launchAppForHomescapes, Timeout: testutil.LaunchTestCaseTimeout, TType: testutil.Launch},
}
