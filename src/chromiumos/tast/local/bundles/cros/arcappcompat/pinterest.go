...
var clamshellLaunchForPinterest = []testutil.TestCase{
	{Name: "Launch app in Clamshell", Fn: launchAppForPinterest},
}

// touchviewLaunchForPinterest launches Pinterest in tablet mode.
var touchviewLaunchForPinterest = []testutil.TestCase{
	{Name: "Launch app in Touchview", Fn: launchAppForPinterest},
}

func init() {
	testing.AddTest(&testing.Test{
		Func: Pinterest, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Functional test for Pinterest that installs the app also verifies it is logged in and that the main page is open, checks Pinterest correctly changes the window state in both clamshell and touchview mode",
		...
		Params: []testing.Param{{
			...
			Val: testutil.TestParams{
				LaunchTests: clamshellLaunchForPinterest,
			...
			Name: "tablet_mode",
			Val: testutil.TestParams{
				LaunchTests: touchviewLaunchForPinterest,
