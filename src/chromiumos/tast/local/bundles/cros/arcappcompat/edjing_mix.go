...
var clamshellLaunchForEdjingMix = []testutil.TestCase{
	{Name: "Launch app in Clamshell", Fn: launchAppForEdjingMix},
}

// touchviewLaunchForEdjingMix launches EdjingMix in tablet mode.
var touchviewLaunchForEdjingMix = []testutil.TestCase{
	{Name: "Launch app in Touchview", Fn: launchAppForEdjingMix},
}

func init() {
	testing.AddTest(&testing.Test{
		Func: EdjingMix, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Functional test for EdjingMix that installs the app also verifies it is logged in and that the main page is open, checks EdjingMix correctly changes the window state in both clamshell and touchview mode",
		...
		Params: []testing.Param{{
			...
			Val: testutil.TestParams{
				LaunchTests: clamshellLaunchForEdjingMix,
			...
			Name: "tablet_mode",
			Val: testutil.TestParams{
				LaunchTests: touchviewLaunchForEdjingMix,
