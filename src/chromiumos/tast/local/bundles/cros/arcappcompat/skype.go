...
func init() {
	testing.AddTest(&testing.Test{
		Func: Skype, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Functional test for Skype that installs the app also verifies it is logged in and that the main page is open, checks Skype correctly changes the window state in both clamshell and touchview mode",
