...
func init() {
	testing.AddTest(&testing.Test{
		Func: AmazonKindle, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Functional test for AmazonKindle that installs the app also verifies it is logged in and that the main page is open, checks AmazonKindle correctly changes the window state in both clamshell and touchview mode",
