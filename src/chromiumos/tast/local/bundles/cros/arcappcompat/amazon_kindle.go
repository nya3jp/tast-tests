...
var clamshellLaunchForAmazonKindle = []testutil.TestSuite{
...
var touchviewLaunchForAmazonKindle = []testutil.TestSuite{
	...
	testing.AddTest(&testing.Test{
		...
		Params: []testing.Param{{
			...
			Val: testutil.TestParams{
				LaunchTest: clamshellLaunchForAmazonKindle,
			...
			Name: "tablet_mode",
			Val: testutil.TestParams{
				LaunchTest: touchviewLaunchForAmazonKindle,
