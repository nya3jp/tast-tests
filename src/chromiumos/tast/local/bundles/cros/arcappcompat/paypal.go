...
func init() {
	testing.AddTest(&testing.Test{
		Func: Paypal, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Functional test for Paypal that installs the app also verifies it is logged in and that the main page is open, checks Paypal correctly changes the window state in both clamshell and touchview mode",
