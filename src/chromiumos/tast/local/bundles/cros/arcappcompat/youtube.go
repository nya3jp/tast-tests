...
var clamshellLaunchForYoutube = []testutil.TestCase{
	{Name: "Launch app in Clamshell", Fn: launchAppForYoutube, Timeout: testutil.LaunchTestCaseTimeout, TType: testutil.Launch},
}

// touchviewLaunchForYoutube launches Youtube in tablet mode.
var touchviewLaunchForYoutube = []testutil.TestCase{
	{Name: "Launch app in Touchview", Fn: launchAppForYoutube, Timeout: testutil.LaunchTestCaseTimeout, TType: testutil.Launch},
}
