...
func init() {
	testing.AddTest(&testing.Test{
		Func: Discord, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Functional test for Discord that installs the app also verifies it is logged in and that the main page is open, checks Discord correctly changes the window state in both clamshell and touchview mode",
