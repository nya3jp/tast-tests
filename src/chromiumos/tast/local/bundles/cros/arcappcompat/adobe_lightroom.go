...
var clamshellLaunchForAdobeLightroom = []testutil.TestCase{
...
var touchviewLaunchForAdobeLightroom = []testutil.TestCase{
	{Name: "Launch app in Touchview", Fn: launchAppForAdobeLightroom},
}

func init() {
	testing.AddTest(&testing.Test{
		Func: AdobeLightroom, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Functional test for AdobeLightroom that installs the app also verifies it is logged in and that the main page is open, checks AdobeLightroom correctly changes the window state in both clamshell and touchview mode",
		...
		Params: []testing.Param{{
			...
			Val: testutil.TestParams{
				LaunchTests: clamshellLaunchForAdobeLightroom,
			...
			Name: "tablet_mode",
			Val: testutil.TestParams{
				LaunchTests: touchviewLaunchForAdobeLightroom,
