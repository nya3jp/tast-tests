...
func init() {
	testing.AddTest(&testing.Test{
		Func: MicrosoftWord, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Functional test for MicrosoftWord that installs the app also verifies it is logged in and that the main page is open, checks MicrosoftWord correctly changes the window state in both clamshell and touchview mode",
