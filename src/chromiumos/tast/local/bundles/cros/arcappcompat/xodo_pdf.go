...
func init() {
	testing.AddTest(&testing.Test{
		Func: XodoPdf, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Functional test for XodoPdf that installs the app also verifies it is logged in and that the main page is open, checks XodoPdf correctly changes the window state in both clamshell and touchview mode",
