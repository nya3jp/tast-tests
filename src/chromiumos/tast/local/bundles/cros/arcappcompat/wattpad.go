...
func init() {
	testing.AddTest(&testing.Test{
		Func: Wattpad, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Functional test for Wattpad that installs the app also verifies it is logged in and that the main page is open, checks Wattpad correctly changes the window state in both clamshell and touchview mode",
