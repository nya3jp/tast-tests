...
// clamshellLaunchForGachaLife launches GachaLife in clamshell mode.
var clamshellLaunchForGachaLife = []testutil.TestCase{
	{Name: "Launch app in Clamshell", Fn: launchAppForGachaLife},
}

// touchviewLaunchForGachaLife launches GachaLife in tablet mode.
var touchviewLaunchForGachaLife = []testutil.TestCase{
	{Name: "Launch app in Touchview", Fn: launchAppForGachaLife},
}

func init() {
	testing.AddTest(&testing.Test{
		Func: GachaLife, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Functional test for GachaLife that install, launch the app and check that the main page is open, also checks GachaLife correctly changes the window state in both clamshell and touchview mode",
		...
		Params: []testing.Param{{
			...
			Val: testutil.TestParams{
				LaunchTests: clamshellLaunchForGachaLife,
			...
			Name: "tablet_mode",
			Val: testutil.TestParams{
				LaunchTests: touchviewLaunchForGachaLife,
