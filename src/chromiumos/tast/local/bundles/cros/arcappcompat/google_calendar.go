...
var clamshellLaunchForGoogleCalendar = []testutil.TestCase{
...
var touchviewLaunchForGoogleCalendar = []testutil.TestCase{
	{Name: "Launch app in Touchview", Fn: launchAppForGoogleCalendar},
}

func init() {
	testing.AddTest(&testing.Test{
		Func: GoogleCalendar, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Functional test for GoogleCalendar that installs the app also verifies it is logged in and that the main page is open, checks GoogleCalendar correctly changes the window state in both clamshell and touchview mode",
		...
		Params: []testing.Param{{
			...
			Val: testutil.TestParams{
				LaunchTests: clamshellLaunchForGoogleCalendar,
			...
			Name: "tablet_mode",
			Val: testutil.TestParams{
				LaunchTests: touchviewLaunchForGoogleCalendar,
