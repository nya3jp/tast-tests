...
func init() {
	testing.AddTest(&testing.Test{
		Func: PocketCasts, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Functional test for PocketCasts that installs the app also verifies that the main page is open, checks PocketCasts correctly changes the window state in both clamshell and touchview mode",
