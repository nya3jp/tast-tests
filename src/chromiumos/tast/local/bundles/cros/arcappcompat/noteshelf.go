...
var clamshellLaunchForNoteshelf = []testutil.TestCase{
	{Name: "Launch app in Clamshell", Fn: launchAppForNoteshelf},
}

// touchviewLaunchForNoteshelf launches Noteshelf in tablet mode.
var touchviewLaunchForNoteshelf = []testutil.TestCase{
	{Name: "Launch app in Touchview", Fn: launchAppForNoteshelf},
}

func init() {
	testing.AddTest(&testing.Test{
		Func: Noteshelf, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Functional test for Noteshelf that install, launch the app and check that the main page is open, also checks Noteshelf correctly changes the window state in both clamshell and touchview mode",
		...
		Params: []testing.Param{{
			...
			Val: testutil.TestParams{
				LaunchTests: clamshellLaunchForNoteshelf,
			...
			Name: "tablet_mode",
			Val: testutil.TestParams{
				LaunchTests: touchviewLaunchForNoteshelf,
