...
var clamshellLaunchForSoundCloud = []testutil.TestCase{
	{Name: "Launch app in Clamshell", Fn: launchAppForSoundCloud},
}

// touchviewLaunchForSoundCloud launches SoundCloud in tablet mode.
var touchviewLaunchForSoundCloud = []testutil.TestCase{
	{Name: "Launch app in Touchview", Fn: launchAppForSoundCloud},
}

func init() {
	testing.AddTest(&testing.Test{
		Func: SoundCloud, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Functional test for SoundCloud that installs the app also verifies it is logged in and that the main page is open, checks SoundCloud correctly changes the window state in both clamshell and touchview mode",
		...
		Params: []testing.Param{{
			...
			Name: "tablet_mode",
			Val: testutil.TestParams{
				LaunchTests: touchviewLaunchForSoundCloud,
