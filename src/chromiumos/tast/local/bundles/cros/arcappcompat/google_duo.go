...
var clamshellLaunchForGoogleDuo = []testutil.TestCase{
	{Name: "Launch app in Clamshell", Fn: launchAppForGoogleDuo, Timeout: testutil.LaunchTestCaseTimeout, TType: testutil.Launch},
}

// touchviewLaunchForGoogleDuo launches GoogleDuo in tablet mode.
var touchviewLaunchForGoogleDuo = []testutil.TestCase{
	{Name: "Launch app in Touchview", Fn: launchAppForGoogleDuo, Timeout: testutil.LaunchTestCaseTimeout, TType: testutil.Launch},
}
