...
func init() {
	testing.AddTest(&testing.Test{
		Func: GoogleDuo, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Functional test for GoogleDuo that installs the app also verifies it is logged in and that the main page is open, checks GoogleDuo correctly changes the window state in both clamshell and touchview mode",
