...
func init() {
	testing.AddTest(&testing.Test{
		Func: Facebook, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Functional test for Facebook that installs the app also verifies it is logged in and that the main page is open, checks Facebook correctly changes the window state in both clamshell and touchview mode",
