...
func init() {
	testing.AddTest(&testing.Test{
		Func: CrossDJ, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Functional test for CrossDJ that installs the app also verifies it is logged in and that the main page is open, checks CrossDJ correctly changes the window state in both clamshell and touchview mode",
