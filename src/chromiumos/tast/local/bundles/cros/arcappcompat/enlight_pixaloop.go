...
var clamshellLaunchForEnlightPixaloop = []testutil.TestCase{
...
var touchviewLaunchForEnlightPixaloop = []testutil.TestCase{
	{Name: "Launch app in Touchview", Fn: launchAppForEnlightPixaloop},
}

func init() {
	testing.AddTest(&testing.Test{
		Func: EnlightPixaloop, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Functional test for EnlightPixaloop that installs the app also verifies that the main page is open, checks EnlightPixaloop correctly changes the window state in both clamshell and touchview mode",
		...
		Params: []testing.Param{{
			...
			Val: testutil.TestParams{
				LaunchTests: clamshellLaunchForEnlightPixaloop,
			...
			Name: "tablet_mode",
			Val: testutil.TestParams{
				LaunchTests: touchviewLaunchForEnlightPixaloop,
