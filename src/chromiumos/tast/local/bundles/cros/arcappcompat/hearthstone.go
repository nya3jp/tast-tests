...
func Hearthstone(ctx context.Context, s *testing.State) {
	...
	for idx, test := range testSet.Tests {
		...
		s.Run(ctx, test.Name, func(ctx context.Context, s *testing.State) {
			...
			test.Fn(ctx, s, tconn, a, d, appPkgName, appActivity, checkForResizable)
		})
	}
}

// launchAppForHearthstone verifies Hearthstone reached main activity page of the app.
func launchAppForHearthstone(ctx context.Context, s *testing.State, tconn *chrome.TestConn, a *arc.ARC, d *ui.Device, appPkgName, appActivity string, checkForResizable bool) {
