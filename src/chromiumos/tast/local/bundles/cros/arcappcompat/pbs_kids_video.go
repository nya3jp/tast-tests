...
func init() {
	testing.AddTest(&testing.Test{
		Func: PbsKidsVideo, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Functional test for Pbs Kids Video that install, launch the app and check that the main page is open, also checks Pbs Kids Video correctly changes the window state in both clamshell and touchview mode",
