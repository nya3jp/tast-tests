...
func init() {
	testing.AddTest(&testing.Test{
		Func: Soundtrap, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Functional test for Soundtrap that installs the app also verifies it is logged in and that the main page is open, checks Soundtrap correctly changes the window state in both clamshell and touchview mode",
