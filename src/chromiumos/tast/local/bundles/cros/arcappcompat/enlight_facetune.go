...
func init() {
	testing.AddTest(&testing.Test{
		Func: EnlightFacetune, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Functional test for EnlightFacetune that installs the app also verifies that the main page is open, checks EnlightFacetune correctly changes the window state in both clamshell and touchview mode",
