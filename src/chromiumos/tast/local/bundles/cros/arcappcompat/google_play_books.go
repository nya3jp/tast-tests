...
var clamshellLaunchForGooglePlayBooks = []testutil.TestCase{
...
var touchviewLaunchForGooglePlayBooks = []testutil.TestCase{
	{Name: "Launch app in Touchview", Fn: launchAppForGooglePlayBooks},
}

func init() {
	testing.AddTest(&testing.Test{
		Func: GooglePlayBooks, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Functional test for GooglePlayBooks that install, launch the app and check that the main page is open, also checks GooglePlayBooks correctly changes the window state in both clamshell and touchview mode",
		...
		Params: []testing.Param{{
			...
			Val: testutil.TestParams{
				LaunchTests: clamshellLaunchForGooglePlayBooks,
			...
			Name: "tablet_mode",
			Val: testutil.TestParams{
				LaunchTests: touchviewLaunchForGooglePlayBooks,
