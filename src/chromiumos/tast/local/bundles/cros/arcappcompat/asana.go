...
func init() {
	testing.AddTest(&testing.Test{
		Func: Asana, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Functional test for Asana that installs the app also verifies it is logged in and that the main page is open, checks Asana correctly changes the window state in both clamshell and touchview mode",
