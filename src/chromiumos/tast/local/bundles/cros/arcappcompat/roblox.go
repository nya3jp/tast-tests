...
var clamshellLaunchForRoblox = []testutil.TestCase{
	{Name: "Launch app in Clamshell", Fn: launchAppForRoblox, Timeout: testutil.LaunchTestCaseTimeout, TType: testutil.Launch},
}

// touchviewLaunchForRoblox launches Roblox in tablet mode.
var touchviewLaunchForRoblox = []testutil.TestCase{
	{Name: "Launch app in Touchview", Fn: launchAppForRoblox, Timeout: testutil.LaunchTestCaseTimeout, TType: testutil.Launch},
}
...
func init() {
	testing.AddTest(&testing.Test{
		...
		VarDeps: []string{"arcappcompat.Roblox.username", "arcappcompat.Roblox.password"},
	})
}
