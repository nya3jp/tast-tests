...
func init() {
	testing.AddTest(&testing.Test{
		Func: Roblox, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Functional test for Roblox that installs the app also verifies it is logged in and that the main page is open, checks Roblox correctly changes the window state in both clamshell and touchview mode",
