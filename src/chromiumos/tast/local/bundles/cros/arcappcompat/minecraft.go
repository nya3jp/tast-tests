...
var clamshellLaunchForMinecraft = []testutil.TestCase{
	{Name: "Launch app in Clamshell", Fn: launchAppForMinecraft, Timeout: testutil.LaunchTestCaseTimeout, TType: testutil.Launch},
}

// touchviewLaunchForMinecraft launches Minecraft in tablet mode.
var touchviewLaunchForMinecraft = []testutil.TestCase{
	{Name: "Launch app in Touchview", Fn: launchAppForMinecraft, Timeout: testutil.LaunchTestCaseTimeout, TType: testutil.Launch},
}
