...
func init() {
	testing.AddTest(&testing.Test{
		Func: Kinemaster, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Functional test for Kinemaster that installs the app also verifies it is logged in and that the main page is open, checks Kinemaster correctly changes the window state in both clamshell and touchview mode",
