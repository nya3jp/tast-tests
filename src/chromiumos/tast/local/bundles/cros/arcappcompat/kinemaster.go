...
// clamshellLaunchForKinemaster launches Kinemaster in clamshell mode.
var clamshellLaunchForKinemaster = []testutil.TestSuite{
	{Name: "Launch app in Clamshell", Fn: launchAppForKinemaster},
}

// touchviewLaunchForKinemaster launches Kinemaster in tablet mode.
var touchviewLaunchForKinemaster = []testutil.TestSuite{
	...
	testing.AddTest(&testing.Test{
		...
		Params: []testing.Param{{
			...
			Val: testutil.TestParams{
				Tests:      clamshellLaunchForKinemaster,
			...
			Name: "tablet_mode",
			Val: testutil.TestParams{
				Tests:      touchviewLaunchForKinemaster,
