...
var clamshellTestsForGooglePlayMusic = []testutil.TestCase{
...
var touchviewTestsForGooglePlayMusic = []testutil.TestCase{
...
func init() {
	testing.AddTest(&testing.Test{
		...
		Params: []testing.Param{{
			Val:               clamshellTestsForGooglePlayMusic,
			ExtraSoftwareDeps: []string{"android_p"},
			Pre:               pre.AppCompatBooted,
		}, {
			Name:              "tablet_mode",
			Val:               touchviewTestsForGooglePlayMusic,
