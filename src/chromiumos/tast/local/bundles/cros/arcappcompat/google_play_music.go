...
var clamshellLaunchForGooglePlayMusic = []testutil.TestCase{
...
var touchviewLaunchForGooglePlayMusic = []testutil.TestCase{
	{Name: "Launch app in Touchview", Fn: launchAppForGooglePlayMusic},
}

func init() {
	testing.AddTest(&testing.Test{
		Func: GooglePlayMusic, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Functional test for GooglePlayMusic that install, launch the app and check that the main page is open, also checks GooglePlayMusic correctly changes the window state in both clamshell and touchview mode",
		...
		Params: []testing.Param{{
			...
			Val: testutil.TestParams{
				LaunchTests: clamshellLaunchForGooglePlayMusic,
