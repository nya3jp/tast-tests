...
var clamshellLaunchForMathKids = []testutil.TestCase{
	{Name: "Launch app in Clamshell", Fn: launchAppForMathKids},
}

// touchviewLaunchForMathKids launches MathKids in tablet mode.
var touchviewLaunchForMathKids = []testutil.TestCase{
	{Name: "Launch app in Touchview", Fn: launchAppForMathKids},
}

func init() {
	testing.AddTest(&testing.Test{
		Func: MathKids, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Functional test for MathKids that installs the app also verifies that the main page is open, checks MathKids correctly changes the window state in both clamshell and touchview mode",
		...
		Params: []testing.Param{{
			...
			Val: testutil.TestParams{
				LaunchTests: clamshellLaunchForMathKids,
			...
			Name: "tablet_mode",
			Val: testutil.TestParams{
				LaunchTests: touchviewLaunchForMathKids,
