...
func init() {
	testing.AddTest(&testing.Test{
		Func: Dropbox, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Functional test for Dropbox that installs the app also verifies it is logged in and that the main page is open, checks Dropbox correctly changes the window state in both clamshell and touchview mode",
