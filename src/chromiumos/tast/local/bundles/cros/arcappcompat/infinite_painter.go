...
func init() {
	testing.AddTest(&testing.Test{
		Func: InfinitePainter, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Functional test for InfinitePainter that installs the app also verifies it is logged in and that the main page is open, checks InfinitePainter correctly changes the window state in both clamshell and touchview mode",
