...
var clamshellLaunchForBitLife = []testutil.TestCase{
	{Name: "Launch app in Clamshell", Fn: launchAppForBitLife},
}

// touchviewLaunchForBitLife launches BitLife in tablet mode.
var touchviewLaunchForBitLife = []testutil.TestCase{
	{Name: "Launch app in Touchview", Fn: launchAppForBitLife},
}

func init() {
	testing.AddTest(&testing.Test{
		Func: BitLife, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Functional test for BitLife that install, launch the app and check that the main page is open, also checks BitLife correctly changes the window state in both clamshell and touchview mode",
