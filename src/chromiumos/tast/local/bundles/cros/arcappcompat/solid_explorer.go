...
var clamshellLaunchForSolidExplorer = []testutil.TestCase{
...
var touchviewLaunchForSolidExplorer = []testutil.TestCase{
	{Name: "Launch app in Touchview", Fn: launchAppForSolidExplorer},
}

func init() {
	testing.AddTest(&testing.Test{
		Func: SolidExplorer, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Functional test for SolidExplorer that installs the app also verifies it is logged in and that the main page is open, checks SolidExplorer correctly changes the window state in both clamshell and touchview mode",
		...
		Params: []testing.Param{{
			...
			Val: testutil.TestParams{
				LaunchTests: clamshellLaunchForSolidExplorer,
			...
			Name: "tablet_mode",
			Val: testutil.TestParams{
				LaunchTests: touchviewLaunchForSolidExplorer,
