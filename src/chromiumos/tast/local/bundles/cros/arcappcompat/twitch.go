...
func init() {
	testing.AddTest(&testing.Test{
		Func: Twitch, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Functional test for Twitch that installs the app also verifies it is logged in and that the main page is open, checks Twitch correctly changes the window state in both clamshell and touchview mode",
