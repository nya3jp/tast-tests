...
func init() {
	testing.AddTest(&testing.Test{
		Func: Instagram, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Functional test for Instagram that installs the app also verifies it is logged in and that the main page is open, checks Instagram correctly changes the window state in both clamshell and touchview mode",
