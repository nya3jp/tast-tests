...
var clamshellLaunchForWordPress = []testutil.TestCase{
	{Name: "Launch app in Clamshell", Fn: launchAppForWordPress},
}

// touchviewLaunchForWordPress launches WordPress in tablet mode.
var touchviewLaunchForWordPress = []testutil.TestCase{
	{Name: "Launch app in Touchview", Fn: launchAppForWordPress},
}

func init() {
	testing.AddTest(&testing.Test{
		Func: WordPress, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Functional test for WordPress that installs the app also verifies it is logged in and that the main page is open, checks WordPress correctly changes the window state in both clamshell and touchview mode",
		...
		Params: []testing.Param{{
			...
			Val: testutil.TestParams{
				LaunchTests: clamshellLaunchForWordPress,
			...
			Name: "tablet_mode",
			Val: testutil.TestParams{
				LaunchTests: touchviewLaunchForWordPress,
