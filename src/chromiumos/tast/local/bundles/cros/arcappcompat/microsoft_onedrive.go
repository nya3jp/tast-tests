...
func init() {
	testing.AddTest(&testing.Test{
		Func: MicrosoftOnedrive, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Functional test for MicrosoftOnedrive that installs the app also verifies it is logged in and that the main page is open, checks MicrosoftOnedrive correctly changes the window state in both clamshell and touchview mode",
