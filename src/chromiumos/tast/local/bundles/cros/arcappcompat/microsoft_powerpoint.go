...
func init() {
	testing.AddTest(&testing.Test{
		Func: MicrosoftPowerpoint, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Functional test for MicrosoftPowerpoint that installs the app also verifies it is logged in and that the main page is open, checks MicrosoftPowerpoint correctly changes the window state in both clamshell and touchview mode",
