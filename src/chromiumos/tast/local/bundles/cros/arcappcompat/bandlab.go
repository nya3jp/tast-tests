...
var clamshellLaunchForBandlab = []testutil.TestCase{
	{Name: "Launch app in Clamshell", Fn: launchAppForBandlab},
}

// touchviewLaunchForBandlab launches Bandlab in tablet mode.
var touchviewLaunchForBandlab = []testutil.TestCase{
	{Name: "Launch app in Touchview", Fn: launchAppForBandlab},
}

func init() {
	testing.AddTest(&testing.Test{
		Func: Bandlab, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Functional test for Bandlab that installs the app also verifies it is logged in and that the main page is open, checks Bandlab correctly changes the window state in both clamshell and touchview mode",
		...
		Params: []testing.Param{{
			...
			Val: testutil.TestParams{
				LaunchTests: clamshellLaunchForBandlab,
			...
			Name: "tablet_mode",
			Val: testutil.TestParams{
				LaunchTests: touchviewLaunchForBandlab,
