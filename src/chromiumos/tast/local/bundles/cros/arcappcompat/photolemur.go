...
func init() {
	testing.AddTest(&testing.Test{
		Func: Photolemur, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Functional test for Photolemur that installs the app also verifies it is logged in and that the main page is open, checks Photolemur correctly changes the window state in both clamshell and touchview mode",
