...
// clamshellLaunchForSquid launches Squid in clamshell mode.
var clamshellLaunchForSquid = []testutil.TestCase{
	{Name: "Launch app in Clamshell", Fn: launchAppForSquid},
}

// touchviewLaunchForSquid launches Squid in tablet mode.
var touchviewLaunchForSquid = []testutil.TestCase{
	{Name: "Launch app in Touchview", Fn: launchAppForSquid},
}

func init() {
	testing.AddTest(&testing.Test{
		Func: Squid, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Functional test for Squid that install, launch the app and check that the main page is open, also checks Squid correctly changes the window state in both clamshell and touchview mode",
		...
		Params: []testing.Param{{
			...
			Val: testutil.TestParams{
				LaunchTests: clamshellLaunchForSquid,
			...
			Name: "tablet_mode",
			Val: testutil.TestParams{
				LaunchTests: touchviewLaunchForSquid,
