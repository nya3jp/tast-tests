...
var clamshellLaunchForMicrosoftOutlook = []testutil.TestCase{
...
var touchviewLaunchForMicrosoftOutlook = []testutil.TestCase{
	{Name: "Launch app in Touchview", Fn: launchAppForMicrosoftOutlook},
}

func init() {
	testing.AddTest(&testing.Test{
		Func: MicrosoftOutlook, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Functional test for MicrosoftOutlook that installs the app also verifies it is logged in and that the main page is open, checks MicrosoftOutlook correctly changes the window state in both clamshell and touchview mode",
		...
		Params: []testing.Param{{
			...
			Val: testutil.TestParams{
				LaunchTests: clamshellLaunchForMicrosoftOutlook,
			...
			Name: "tablet_mode",
			Val: testutil.TestParams{
				LaunchTests: touchviewLaunchForMicrosoftOutlook,
