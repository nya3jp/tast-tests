...
var clamshellTestsForMicrosoftOutlook = []testutil.TestCase{
...
var touchviewTestsForMicrosoftOutlook = []testutil.TestCase{
...
func init() {
	testing.AddTest(&testing.Test{
		...
		Params: []testing.Param{{
			Val:               clamshellTestsForMicrosoftOutlook,
			ExtraSoftwareDeps: []string{"android_p"},
			Pre:               pre.AppCompatBooted,
		}, {
			Name:              "tablet_mode",
			Val:               touchviewTestsForMicrosoftOutlook,
...
func loginHelperForMicrosoftApp(ctx context.Context, s *testing.State, tconn *chrome.TestConn, a *arc.ARC, d *ui.Device, appPkgName, appActivity string) {
	...
	// Press on KEYCODE_DPAD_DOWN until allow button is visible.
