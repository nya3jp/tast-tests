...
var clamshellLaunchForVLC = []testutil.TestCase{
	{Name: "Launch app in Clamshell", Fn: launchAppForVLC},
}

// touchviewLaunchForVLC launches VLC in tablet mode.
var touchviewLaunchForVLC = []testutil.TestCase{
	{Name: "Launch app in Touchview", Fn: launchAppForVLC},
}

func init() {
	testing.AddTest(&testing.Test{
		Func: VLC, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Functional test for VLC that install, launch the app and check that the main page is open, also checks VLC correctly changes the window state in both clamshell and touchview mode",
		...
		Params: []testing.Param{{
			...
			Val: testutil.TestParams{
				LaunchTests: clamshellLaunchForVLC,
			...
			Name: "tablet_mode",
			Val: testutil.TestParams{
				LaunchTests: touchviewLaunchForVLC,
