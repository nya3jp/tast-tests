...
func init() {
	testing.AddTest(&testing.Test{
		Func: Concepts, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Functional test for Concepts  that installs the app also verifies it is logged in and that the main page is open, checks Gmail correctly changes the window state in both clamshell and touchview mode",
