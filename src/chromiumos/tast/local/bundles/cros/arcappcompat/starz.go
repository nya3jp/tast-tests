...
func init() {
	testing.AddTest(&testing.Test{
		Func: Starz, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Functional test for Starz that installs the app also verifies it is logged in and that the main page is open, checks Starz correctly changes the window state in both clamshell and touchview mode",
