...
func init() {
	testing.AddTest(&testing.Test{
		Func: Audible, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Functional test for Audible that installs the app also verifies that the main page is open, checks Audible correctly changes the window state in both clamshell and touchview mode",
