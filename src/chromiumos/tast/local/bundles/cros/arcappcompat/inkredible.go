	...
	testing.AddTest(&testing.Test{
		...
		Params: []testing.Param{{
			...
			Val: testutil.TestParams{
				LaunchTest: clamshellLaunchForInkredible,
			...
			Name: "tablet_mode",
			Val: testutil.TestParams{
				LaunchTest: touchviewLaunchForInkredible,
