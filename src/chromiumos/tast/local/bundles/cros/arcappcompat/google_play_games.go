...
var clamshellLaunchForGooglePlayGames = []testutil.TestCase{
...
var touchviewLaunchForGooglePlayGames = []testutil.TestCase{
	{Name: "Launch app in Touchview", Fn: launchAppForGooglePlayGames},
}

func init() {
	testing.AddTest(&testing.Test{
		Func: GooglePlayGames, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Functional test for GooglePlayGames that install, launch the app and check that the main page is open, also checks GooglePlayGames correctly changes the window state in both clamshell and touchview mode",
