...
var clamshellLaunchForWPSOffice = []testutil.TestCase{
	{Name: "Launch app in Clamshell", Fn: launchAppForWPSOffice},
}

// touchviewLaunchForWPSOffice launches WPSOffice in tablet mode.
var touchviewLaunchForWPSOffice = []testutil.TestCase{
	{Name: "Launch app in Touchview", Fn: launchAppForWPSOffice},
}

func init() {
	testing.AddTest(&testing.Test{
		Func: WPSOffice, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Functional test for WPSOffice that installs the app also verifies it is logged in and that the main page is open, checks WPSOffice correctly changes the window state in both clamshell and touchview mode",
		...
		Params: []testing.Param{{
			...
			Val: testutil.TestParams{
				LaunchTests: clamshellLaunchForWPSOffice,
