...
var clamshellLaunchForGeometryDashLite = []testutil.TestSuite{
...
var touchviewLaunchForGeometryDashLite = []testutil.TestSuite{
	...
	testing.AddTest(&testing.Test{
		...
		Params: []testing.Param{{
			...
			Val: testutil.TestParams{
				LaunchTest: clamshellLaunchForGeometryDashLite,
			...
			Name: "tablet_mode",
			Val: testutil.TestParams{
				LaunchTest: touchviewLaunchForGeometryDashLite,
