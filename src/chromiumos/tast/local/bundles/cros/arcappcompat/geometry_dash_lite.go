...
// clamshellLaunchForGeometryDashLite launches GeometryDashLite in clamshell mode.
var clamshellLaunchForGeometryDashLite = []testutil.TestCase{
	{Name: "Launch app in Clamshell", Fn: launchAppForGeometryDashLite},
}

// touchviewLaunchForGeometryDashLite launches GeometryDashLite in tablet mode.
var touchviewLaunchForGeometryDashLite = []testutil.TestCase{
	{Name: "Launch app in Touchview", Fn: launchAppForGeometryDashLite},
}

func init() {
	testing.AddTest(&testing.Test{
		Func: GeometryDashLite, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Functional test for GeometryDashLite that install, launch the app and check that the main page is open, also checks GeometryDashLite correctly changes the window state in both clamshell and touchview mode",
		...
		Params: []testing.Param{{
			...
			Val: testutil.TestParams{
				LaunchTests: clamshellLaunchForGeometryDashLite,
			...
			Name: "tablet_mode",
			Val: testutil.TestParams{
				LaunchTests: touchviewLaunchForGeometryDashLite,
