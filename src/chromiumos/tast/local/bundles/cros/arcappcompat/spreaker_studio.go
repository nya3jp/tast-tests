...
func init() {
	testing.AddTest(&testing.Test{
		Func: SpreakerStudio, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Functional test for SpreakerStudio that installs the app also verifies it is logged in and that the main page is open, checks SpreakerStudio correctly changes the window state in both clamshell and touchview mode",
