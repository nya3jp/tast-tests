...
var clamshellTestsForABCSpelling = []testutil.TestCase{
...
var touchviewTestsForABCSpelling = []testutil.TestCase{
...
func init() {
	testing.AddTest(&testing.Test{
		...
		Params: []testing.Param{{
			Val:               clamshellTestsForABCSpelling,
			ExtraSoftwareDeps: []string{"android_p"},
			Pre:               pre.AppCompatBooted,
		}, {
			Name:              "tablet_mode",
			Val:               touchviewTestsForABCSpelling,
