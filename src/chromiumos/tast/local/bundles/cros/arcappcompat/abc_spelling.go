...
func init() {
	testing.AddTest(&testing.Test{
		Func: ABCSpelling, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Functional test for ABCSpelling that installs the app also verifies that the main page is open, checks ABCSpelling correctly changes the window state in both clamshell and touchview mode",
