...
func init() {
	testing.AddTest(&testing.Test{
		Func: AppleMusic, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Functional test for AppleMusic that installs the app also verifies that the main page is open, checks AppleMusic correctly changes the window state in both clamshell and touchview mode",
