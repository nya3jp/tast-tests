...
func init() {
	testing.AddTest(&testing.Test{
		Func: MicrosoftExcel, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Functional test for MicrosoftExcel that installs the app also verifies it is logged in and that the main page is open, checks MicrosoftExcel correctly changes the window state in both clamshell and touchview mode",
