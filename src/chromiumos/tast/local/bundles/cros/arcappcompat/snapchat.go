...
func init() {
	testing.AddTest(&testing.Test{
		Func: Snapchat, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Functional test for Snapchat that installs the app also verifies it is logged in and that the main page is open, checks Snapchat correctly changes the window state in both clamshell and touchview mode",
