...
var clamshellTestsForOneTwoThreeNumbers = []testutil.TestCase{
...
var touchviewTestsForOneTwoThreeNumbers = []testutil.TestCase{
...
func init() {
	testing.AddTest(&testing.Test{
		...
		Params: []testing.Param{{
			Val:               clamshellTestsForOneTwoThreeNumbers,
			ExtraSoftwareDeps: []string{"android_p"},
			Pre:               pre.AppCompatBooted,
		}, {
			Name:              "tablet_mode",
			Val:               touchviewTestsForOneTwoThreeNumbers,
