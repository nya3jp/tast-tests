...
var clamshellLaunchForOneTwoThreeNumbers = []testutil.TestSuite{
...
var touchviewLaunchForOneTwoThreeNumbers = []testutil.TestSuite{
	...
	testing.AddTest(&testing.Test{
		...
		Params: []testing.Param{{
			...
			Val: testutil.TestParams{
				LaunchTest: clamshellLaunchForOneTwoThreeNumbers,
			...
			Name: "tablet_mode",
			Val: testutil.TestParams{
				LaunchTest: touchviewLaunchForOneTwoThreeNumbers,
