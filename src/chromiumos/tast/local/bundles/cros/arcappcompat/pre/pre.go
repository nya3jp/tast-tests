...
var AppCompatBooted = arc.NewPrecondition("arcappcompat_booted", appcompatGaia, nil /* GIALOGINPOOLVARS*/, false /* O_DIRECT */, append(arc.DisableSyncFlags())...)
...
var AppCompatBootedInTabletMode = arc.NewPrecondition("arcappcompat_booted_in_tablet_mode", appcompatGaia, nil /* GIALOGINPOOLVARS*/, false /* O_DIRECT */, append(arc.DisableSyncFlags(), "--force-tablet-mode=touch_view", "--enable-virtual-keyboard")...)
...
var AppCompatBootedForHearthstone = arc.NewPrecondition("arcappcompat_bootedForHearthstone", appcompatHearthstone, nil /* GIALOGINPOOLVARS*/, false /* O_DIRECT */, append(arc.DisableSyncFlags())...)
...
// that Chrome is launched in tablet mode in this precondition.
var AppCompatBootedInTabletModeForHearthstone = arc.NewPrecondition("arcappcompat_booted_in_tablet_modeForHearthstone", appcompatHearthstone, nil /* GIALOGINPOOLVARS*/, false /* O_DIRECT */, append(arc.DisableSyncFlags(), "--force-tablet-mode=touch_view", "--enable-virtual-keyboard")...)
...
var AppCompatBootedForNoteshelf = arc.NewPrecondition("arcappcompat_bootedForNoteshelf", appcompatNoteshelf, nil /* GIALOGINPOOLVARS*/, false /* O_DIRECT */, append(arc.DisableSyncFlags())...)
...
// that Chrome is launched in tablet mode in this precondition.
var AppCompatBootedInTabletModeForNoteshelf = arc.NewPrecondition("arcappcompat_booted_in_tablet_modeForNoteshelf", appcompatNoteshelf, nil /* GIALOGINPOOLVARS*/, false /* O_DIRECT */, append(arc.DisableSyncFlags(), "--force-tablet-mode=touch_view", "--enable-virtual-keyboard")...)
...
var AppCompatBootedForPhotolemur = arc.NewPrecondition("arcappcompat_bootedForPhotolemur", appcompatPhotolemur, nil /* GIALOGINPOOLVARS*/, false /* O_DIRECT */, append(arc.DisableSyncFlags())...)
...
// that Chrome is launched in tablet mode in this precondition.
var AppCompatBootedInTabletModeForPhotolemur = arc.NewPrecondition("arcappcompat_booted_in_tablet_modeForPhotolemur", appcompatPhotolemur, nil /* GIALOGINPOOLVARS*/, false /* O_DIRECT */, append(arc.DisableSyncFlags(), "--force-tablet-mode=touch_view", "--enable-virtual-keyboard")...)
...
var AppCompatBootedForMyscriptNebo = arc.NewPrecondition("arcappcompat_bootedForMyscriptNebo", appcompatMyscriptNebo, nil /* GIALOGINPOOLVARS*/, false /* O_DIRECT */, append(arc.DisableSyncFlags())...)
...
// that Chrome is launched in tablet mode in this precondition.
var AppCompatBootedInTabletModeForMyscriptNebo = arc.NewPrecondition("arcappcompat_booted_in_tablet_modeForMyscriptNebo", appcompatMyscriptNebo, nil /* GIALOGINPOOLVARS*/, false /* O_DIRECT */, append(arc.DisableSyncFlags(), "--force-tablet-mode=touch_view", "--enable-virtual-keyboard")...)
...
var AppCompatBootedForArtrage = arc.NewPrecondition("arcappcompat_bootedForArtrage", appcompatArtrage, nil /* GIALOGINPOOLVARS*/, false /* O_DIRECT */, append(arc.DisableSyncFlags())...)
...
// that Chrome is launched in tablet mode in this precondition.
var AppCompatBootedInTabletModeForArtrage = arc.NewPrecondition("arcappcompat_booted_in_tablet_modeForArtrage", appcompatArtrage, nil /* GIALOGINPOOLVARS*/, false /* O_DIRECT */, append(arc.DisableSyncFlags(), "--force-tablet-mode=touch_view", "--enable-virtual-keyboard")...)
...
var AppCompatBootedForCrossDJ = arc.NewPrecondition("arcappcompat_bootedForCrossDJ", appcompatCrossDJ, nil /* GIALOGINPOOLVARS*/, false /* O_DIRECT */, append(arc.DisableSyncFlags())...)
...
// that Chrome is launched in tablet mode in this precondition.
var AppCompatBootedInTabletModeForCrossDJ = arc.NewPrecondition("arcappcompat_booted_in_tablet_modeForCrossDJ", appcompatCrossDJ, nil /* GIALOGINPOOLVARS*/, false /* O_DIRECT */, append(arc.DisableSyncFlags(), "--force-tablet-mode=touch_view", "--enable-virtual-keyboard")...)
