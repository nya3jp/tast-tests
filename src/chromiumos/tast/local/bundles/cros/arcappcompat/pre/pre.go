...
var AppCompatBootedForHearthstone = arc.NewPrecondition("arcappcompat_bootedForHearthstone", false, appcompatHearthstone, "--arc-disable-app-sync", "--arc-disable-play-auto-install", "--arc-disable-locale-sync", "--arc-play-store-auto-update=off")

// AppCompatVMBootedForHearthstone is a precondition similar to BootedAppCompat(). The only difference from BootedAppCompat() is
// that ARC VM, and not the ARC Container, is enabled in this precondition.
var AppCompatVMBootedForHearthstone = arc.NewPrecondition("arcappcompat_vmbootedForHearthstone", true, appcompatHearthstone, "--arc-disable-app-sync", "--arc-disable-play-auto-install", "--arc-disable-locale-sync", "--arc-play-store-auto-update=off")
...
// that Chrome is launched in tablet mode in this precondition.
var AppCompatBootedInTabletModeForHearthstone = arc.NewPrecondition("arcappcompat_booted_in_tablet_modeForHearthstone", false, appcompatHearthstone, "--force-tablet-mode=touch_view", "--enable-virtual-keyboard", "--arc-disable-app-sync", "--arc-disable-play-auto-install", "--arc-disable-locale-sync", "--arc-play-store-auto-update=off")
...
// that ARC VM, and not the ARC Container, is enabled in this precondition.
var AppCompatVMBootedInTabletModeForHearthstone = arc.NewPrecondition("arcappcompat_vmbooted_in_tablet_modeForHearthstone", true, appcompatHearthstone, "--force-tablet-mode=touch_view", "--enable-virtual-keyboard", "--arc-disable-app-sync", "--arc-disable-play-auto-install", "--arc-disable-locale-sync", "--arc-play-store-auto-update=off")
