...
func init() {
	testing.AddTest(&testing.Test{
		Func: IHeartRadio, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Functional test for IHeartRadio that installs the app also verifies it is logged in and that the main page is open, checks IHeartRadio correctly changes the window state in both clamshell and touchview mode",
