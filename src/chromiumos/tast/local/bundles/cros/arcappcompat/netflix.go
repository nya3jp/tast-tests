...
func signOutOfNetflix(ctx context.Context, s *testing.State, a *arc.ARC, d *ui.Device, appPkgName, appActivity string) {
	...
	// clickOnHamburgerIcon := d.Object(ui.ClassName("android.widget.FrameLayout"), ui.Description("More"))
	...
	// signOutButton := d.Object(ui.ID("com.netflix.mediaclient:id/row_text"), ui.Text("Sign Out"))
