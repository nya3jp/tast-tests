...
var clamshellLaunchForHbomax = []testutil.TestCase{
	{Name: "Launch app in Clamshell", Fn: launchAppForHbomax, Timeout: testutil.LaunchTestCaseTimeout, TType: testutil.Launch},
}

// touchviewLaunchForHbomax launches Hbomax in tablet mode.
var touchviewLaunchForHbomax = []testutil.TestCase{
	{Name: "Launch app in Touchview", Fn: launchAppForHbomax, Timeout: testutil.LaunchTestCaseTimeout, TType: testutil.Launch},
}
