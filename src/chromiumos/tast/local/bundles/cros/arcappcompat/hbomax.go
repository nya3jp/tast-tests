...
func init() {
	testing.AddTest(&testing.Test{
		Func: Hbomax, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Functional test for Hbomax that install, launch the app and check that the main page is open, also checks Hbomax correctly changes the window state in both clamshell and touchview mode",
