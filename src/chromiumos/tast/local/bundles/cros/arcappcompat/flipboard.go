...
func init() {
	testing.AddTest(&testing.Test{
		Func: Flipboard, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Functional test for Flipboard that installs the app also verifies it is logged in and that the main page is open, checks Instagram correctly changes the window state in both clamshell and touchview mode",
