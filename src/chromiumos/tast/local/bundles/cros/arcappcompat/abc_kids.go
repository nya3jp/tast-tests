...
var clamshellLaunchForABCKids = []testutil.TestCase{
	{Name: "Launch app in Clamshell", Fn: launchAppForABCKids},
}

// touchviewLaunchForABCKids launches ABCKids in tablet mode.
var touchviewLaunchForABCKids = []testutil.TestCase{
	{Name: "Launch app in Touchview", Fn: launchAppForABCKids},
}

func init() {
	testing.AddTest(&testing.Test{
		Func: ABCKids, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Functional test for ABCKids that installs the app also verifies that the main page is open, checks ABCKids correctly changes the window state in both clamshell and touchview mode",
		...
		Params: []testing.Param{{
			...
			Val: testutil.TestParams{
				LaunchTests: clamshellLaunchForABCKids,
			...
			Name: "tablet_mode",
			Val: testutil.TestParams{
				LaunchTests: touchviewLaunchForABCKids,
