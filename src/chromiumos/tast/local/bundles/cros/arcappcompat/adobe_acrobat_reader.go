...
func init() {
	testing.AddTest(&testing.Test{
		Func: AdobeAcrobatReader, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Functional test for AdobeAcrobatReader that installs the app also verifies it is logged in and that the main page is open, checks AdobeAcrobatReader correctly changes the window state in both clamshell and touchview mode",
