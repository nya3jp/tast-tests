...
func init() {
	testing.AddTest(&testing.Test{
		...
		Vars:    []string{"arcappcompat.username", "arcappcompat.password", "arcappcompat.Kahoot.emailid", "arcappcompat.Kahoot.password"},
	})
}
...
func launchAppForKahoot(ctx context.Context, s *testing.State, tconn *chrome.TestConn, a *arc.ARC, d *ui.Device, appPkgName, appActivity string) {
	...
	if err := maybeLaterButton.WaitForExists(ctx, testutil.LongUITimeout); err != nil {
