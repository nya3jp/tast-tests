...
var clamshellLaunchForGmail = []testutil.TestCase{
	{Name: "Launch app in Clamshell", Fn: launchAppForGmail, Timeout: testutil.LaunchTestCaseTimeout, TType: testutil.Launch},
}

// touchviewLaunchForGmail launches Gmail in tablet mode.
var touchviewLaunchForGmail = []testutil.TestCase{
	{Name: "Launch app in Touchview", Fn: launchAppForGmail, Timeout: testutil.LaunchTestCaseTimeout, TType: testutil.Launch},
}
