...
var clamshellLaunchForBoostedProductivity = []testutil.TestCase{
...
var touchviewLaunchForBoostedProductivity = []testutil.TestCase{
	{Name: "Launch app in Touchview", Fn: launchAppForBoostedProductivity},
}

func init() {
	testing.AddTest(&testing.Test{
		Func: BoostedProductivity, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Functional test for BoostedProductivity that installs the app also verifies it is logged in and that the main page is open, checks BoostedProductivity correctly changes the window state in both clamshell and touchview mode",
		...
		Params: []testing.Param{{
			...
			Val: testutil.TestParams{
				LaunchTests: clamshellLaunchForBoostedProductivity,
			...
			Name: "tablet_mode",
			Val: testutil.TestParams{
				LaunchTests: touchviewLaunchForBoostedProductivity,
