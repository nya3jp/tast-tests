...
var clamshellLaunchForMyscriptNebo = []testutil.TestCase{
...
var touchviewLaunchForMyscriptNebo = []testutil.TestCase{
	{Name: "Launch app in Touchview", Fn: launchAppForMyscriptNebo},
}

func init() {
	testing.AddTest(&testing.Test{
		Func: MyscriptNebo, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Functional test for MyscriptNebo that installs the app also verifies it is logged in and that the main page is open, checks MyscriptNebo correctly changes the window state in both clamshell and touchview mode",
