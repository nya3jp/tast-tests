...
var clamshellTestsForMyscriptNebo = []testutil.TestCase{
...
var touchviewTestsForMyscriptNebo = []testutil.TestCase{
...
func init() {
	testing.AddTest(&testing.Test{
		...
		Params: []testing.Param{{
			...
			Name:              "tablet_mode",
			Val:               touchviewTestsForMyscriptNebo,
...
func launchAppForMyscriptNebo(ctx context.Context, s *testing.State, tconn *chrome.TestConn, a *arc.ARC, d *ui.Device, appPkgName, appActivity string) {
	...
	// Click on next button until start page exist.
