...
func init() {
	testing.AddTest(&testing.Test{
		Func: Messenger, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Functional test for Messenger that installs the app also verifies it is logged in and that the main page is open, checks Messenger correctly changes the window state in both clamshell and touchview mode",
