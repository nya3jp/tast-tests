...
var clamshellTestsForTurbotax = []testutil.TestCase{
...
var touchviewTestsForTurbotax = []testutil.TestCase{
...
func init() {
	testing.AddTest(&testing.Test{
		...
		Params: []testing.Param{{
			Val:               clamshellTestsForTurbotax,
			ExtraSoftwareDeps: []string{"android_p"},
			Pre:               pre.AppCompatBooted,
		}, {
			Name:              "tablet_mode",
			Val:               touchviewTestsForTurbotax,
...
func launchAppForTurbotax(ctx context.Context, s *testing.State, tconn *chrome.TestConn, a *arc.ARC, d *ui.Device, appPkgName, appActivity string) {
	const (
		...
		letUsConfirmDes          = "Let's confirm it's you"
