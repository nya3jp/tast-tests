...
var clamshellLaunchForTurbotax = []testutil.TestCase{
	{Name: "Launch app in Clamshell", Fn: launchAppForTurbotax},
}

// touchviewLaunchForTurbotax launches Turbotax in tablet mode.
var touchviewLaunchForTurbotax = []testutil.TestCase{
	{Name: "Launch app in Touchview", Fn: launchAppForTurbotax},
}

func init() {
	testing.AddTest(&testing.Test{
		Func: Turbotax, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Functional test for Turbotax that installs the app also verifies it is logged in and that the main page is open, checks Turbotax correctly changes the window state in both clamshell and touchview mode",
		...
		Params: []testing.Param{{
			...
			Val: testutil.TestParams{
				LaunchTests: clamshellLaunchForTurbotax,
			...
			Name: "tablet_mode",
			Val: testutil.TestParams{
				LaunchTests: touchviewLaunchForTurbotax,
