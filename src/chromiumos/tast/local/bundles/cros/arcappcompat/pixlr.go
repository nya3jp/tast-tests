...
// clamshellLaunchForPixlr launches Pixlr in clamshell mode.
var clamshellLaunchForPixlr = []testutil.TestCase{
	{Name: "Launch app in Clamshell", Fn: launchAppForPixlr},
}

// touchviewLaunchForPixlr launches Pixlr in tablet mode.
var touchviewLaunchForPixlr = []testutil.TestCase{
	{Name: "Launch app in Touchview", Fn: launchAppForPixlr},
}

func init() {
	testing.AddTest(&testing.Test{
		Func: Pixlr, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Functional test for Pixlr that install, launch the app and check that the main page is open, also checks Pixlr correctly changes the window state in both clamshell and touchview mode",
		...
		Params: []testing.Param{{
			...
			Val: testutil.TestParams{
				LaunchTests: clamshellLaunchForPixlr,
			...
			Name: "tablet_mode",
			Val: testutil.TestParams{
				LaunchTests: touchviewLaunchForPixlr,
