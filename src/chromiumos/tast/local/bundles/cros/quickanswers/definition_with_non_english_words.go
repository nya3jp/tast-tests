...
// queryInfo contains information related to the test Quick answers query.
...
func DefinitionWithNonEnglishWords(ctx context.Context, s *testing.State) {
	...
	opt := chrome.EnableFeatures("QuickAnswersForMoreLocales")
	if bt == browser.TypeLacros {
		opt = chrome.LacrosEnableFeatures("QuickAnswersForMoreLocales")
	}
	...
	var queries = [...]queryInfo{
		{"pentágono", "Spanish", "es", "cinco lados"},
		{"settimana", "Italian", "it", "sette giorni"},
		{"semaine", "French", "fr", "sept jours"},
		{"futebol", "Portuguese", "pt", "11 jogadores"},
		{"verdreifachen", "German", "de", "dreimal"},
	}
