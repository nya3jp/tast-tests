...
func startChrome(ctx context.Context, s *testing.State, sm *session.SessionManager) *chrome.Chrome {
...
func test(ctx context.Context, s *testing.State, sm *session.SessionManager) {
	...
	wantedSections := []string{"Network", "Bluetooth", "Connected devices", "Accounts", "Device", "Personalization", "Search and Assistant", "Security and Privacy", "Apps", "Accessibility", "Privacy Hub"}
