...
func SetOnlineWallpaperChild(ctx context.Context, s *testing.State) {
	...
	// The notification will interfere with the test if we start the test at the same time.
	// TODO(b/236139025): remove Sleep action if there is a better solution to handle this case.
