...
func init() {
	testing.AddTest(&testing.Test{
		...
		Desc:         "Verify that managed guest session is ephermeral by checking that a toggled setting is lost upon session exit",
		Contacts: []string{
...
func SessionEphemeral(ctx context.Context, s *testing.State) {
	...
	// First MGS is closed, start a new one an verify the setting is back to default.
