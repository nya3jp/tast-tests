...
func init() {
	testing.AddTest(&testing.Test{
		Func: OwnershipNotRetaken, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Subsequent logins after the owner must not clobber the owner's key",
		Contacts: []string{
...
func OwnershipNotRetaken(ctx context.Context, s *testing.State) {
	const (
		ownerKeyFile = "/var/lib/devicesettings/owner.key"
