...
func init() {
	testing.AddTest(&testing.Test{
		Func: UserPolicyKeys, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Verifies that, after policy is pushed, the user policy key winds up stored in the right place",
		Contacts: []string{
