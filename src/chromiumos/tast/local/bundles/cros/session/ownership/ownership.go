...
func BuildPolicy(user string, key *rsa.PrivateKey, oldKey *rsa.PrivateKey, s *enterprise_management.ChromeDeviceSettingsProto) (*enterprise_management.PolicyFetchResponse, error) {
...
func StoreSettings(ctx context.Context, sm *session.SessionManager, user string, key *rsa.PrivateKey, oldKey *rsa.PrivateKey, s *enterprise_management.ChromeDeviceSettingsProto) error {
