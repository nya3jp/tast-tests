...
func init() {
	testing.AddTest(&testing.Test{
		Func: FloatingAccessibilityMenuEnabled, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Start Kiosk application with FloatingAccessibilityMenuEnabled applied to the account",
		Contacts: []string{
