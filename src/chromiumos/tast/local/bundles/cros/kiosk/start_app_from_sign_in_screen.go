...
func init() {
	testing.AddTest(&testing.Test{
		Func: StartAppFromSignInScreen, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Adds 2 Kiosk accounts, checks if both are available then starts one of them",
		Contacts: []string{
