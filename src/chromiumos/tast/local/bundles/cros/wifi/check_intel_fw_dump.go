...
func init() {
	testing.AddTest(&testing.Test{
		...
		// TODO(b:169152720), Remove "no_kernel_upstream" to enable the test to run on boards with upstream
		// kernel when upstream iwlwifi is able to produce valid fw dumps.
