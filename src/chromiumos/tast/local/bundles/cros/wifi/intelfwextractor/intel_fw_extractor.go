...
// for old Intel WiFi chips (StP2 and older) which have memoryAPIMagic fw dump type.
...
// and length of a TLV header for new Intel WiFi chips (ThP2 and newer)which have yoyoMagic fw dump type.
