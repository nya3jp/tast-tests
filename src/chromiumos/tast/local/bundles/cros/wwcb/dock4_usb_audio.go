...
func Dock4UsbAudio(ctx context.Context, s *testing.State) {
	...
	if err := dock4UsbAudioStep3(ctx, dockingID); err != nil {
	...
	// step 5 - play youtube
	youtube, err := dock4UsbAudioStep5(ctx, cr, tconn)
	if err != nil {
...
func dock4UsbAudioStep3(ctx context.Context, dockingID string) error {
...
func dock4UsbAudioStep5(ctx context.Context, cr *chrome.Chrome, tconn *chrome.TestConn) (*ash.Window, error) {
	testing.ContextLog(ctx, "Step 5 - Play youtube")
...
func dock4UsbAudioStep6(ctx context.Context, s *testing.State) error {
	testing.ContextLog(ctx, "Step 6 - Open Camera or Audio Recorder app and records")
