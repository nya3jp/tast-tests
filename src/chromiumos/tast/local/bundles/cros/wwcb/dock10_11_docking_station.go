...
func dock1011DockingStationStep4(ctx context.Context, s *testing.State, tconn *chrome.TestConn, uc *utils.UsbController, extDispID1, ethernetID string, usbsID []string) error {
