...
func Dock1011DockingStation(ctx context.Context, s *testing.State) {
	...
	// 2. Hotplug the dock alone
	if err := dock1011DockingStationStep2(ctx, s); err != nil {
	...
	// 4. Hotplug peripheral(s) - one by one, or in combination - while docking station is plugged to Chromebook device
	if err := dock1011DockingStationStep4(ctx, s, tconn, uc); err != nil {
	...
	if err := dock1011DockingStationStep6(ctx, s, cr, uc); err != nil {
		s.Fatal("Failed to execute step 6: ", err)
	}

	// 7. Plug - Suspend -Unplug -Resume - Plug
	if err := dock1011DockingStationStep7(ctx, s, cr, uc); err != nil {
		s.Fatal("Failed to execute step 7: ", err)
	}

	// 8. Unplug - Suspend - Plug - Resume
	if err := dock1011DockingStationStep8(ctx, s, cr, uc); err != nil {
		s.Fatal("Failed to execute step 8: ", err)
	}

	// 9. into tablet, then repeat above steps
	if err := dock1011DockingStationStep9(ctx, s, cr, uc); err != nil {
		s.Fatal("Failed to execute step 9: ", err)
	}
}

func dock1011DockingStationStep2(ctx context.Context, s *testing.State) error {
...
func dock1011DockingStationStep4(ctx context.Context, s *testing.State, tconn *chrome.TestConn, uc *utils.UsbController) error {
...
func dock1011DockingStationStep6(ctx context.Context, s *testing.State, cr *chrome.Chrome, uc *utils.UsbController) error {
...
func dock1011DockingStationStep7(ctx context.Context, s *testing.State, cr *chrome.Chrome, uc *utils.UsbController) error {
...
func dock1011DockingStationStep8(ctx context.Context, s *testing.State, cr *chrome.Chrome, uc *utils.UsbController) error {
...
func dock1011DockingStationStep9(ctx context.Context, s *testing.State, cr *chrome.Chrome, uc *utils.UsbController) error {
