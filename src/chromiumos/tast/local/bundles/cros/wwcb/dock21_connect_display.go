...
func Dock21ConnectDisplay(ctx context.Context, s *testing.State) {
	...
	// step 7 - verification
	if err := dock21ConnectDisplayStep7(ctx, tconn, extDispID); err != nil {
...
func dock21ConnectDisplayStep7(ctx context.Context, tconn *chrome.TestConn, extDispID string) error {
