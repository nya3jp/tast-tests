...
/***
Test case #5 Wired/WiFi network switching over Dock
Pre-Condition:
...
Verification:
1)  Make sure (Quick Settings Menu) show "Ethernet" connection HideAllNotifications
2)  Make sure video/audio playback without any issue
3)  Make sure (Quick Setting Menu) show "WiFi" connection
4)  Make sure video/audio playback without any issue
*/
