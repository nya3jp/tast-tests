...
func Dock89DonglePower(ctx context.Context, s *testing.State) {
	...
	if err := dock89DonglePowerStep1(ctx, s); err != nil {
		s.Fatal("Failed to execute step 1: ", err)
	}

	// step 2 - power up dongle
	if err := dock89DonglePowerStep2(ctx, s); err != nil {
	...
	if err := dock89DonglePowerStep4(ctx, s, tconn, uc); err != nil {
		s.Fatal("Failed to execute step 4: ", err)
	}

	// Step 5 - unplug, flip & plug-in dongle then check all peripherals
	if err := dock89DonglePowerStep5(ctx, s, tconn, uc); err != nil {
	...
	if err := dock89DonglePowerStep9(ctx, s, cr, uc); err != nil {
	...
	if err := dock89DonglePowerStep10(ctx, s, cr, uc); err != nil {
	...
	if err := dock89DonglePowerStep11(ctx, s, cr, uc); err != nil {
		s.Fatal("Failed to execute step 11: ", err)
	}

	// Step 12 - into tablet, then repeat above steps
	if err := dock89DonglePowerStep12(ctx, s, cr, uc); err != nil {
		s.Fatal("Failed to execute step 12: ", err)
	}
}

func dock89DonglePowerStep1(ctx context.Context, s *testing.State) error {
...
func dock89DonglePowerStep2(ctx context.Context, s *testing.State) error {
...
func dock89DonglePowerStep4(ctx context.Context, s *testing.State, tconn *chrome.TestConn, uc *utils.UsbController) error {
...
func dock89DonglePowerStep5(ctx context.Context, s *testing.State, tconn *chrome.TestConn, uc *utils.UsbController) error {
...
func dock89DonglePowerStep9(ctx context.Context, s *testing.State, cr *chrome.Chrome, uc *utils.UsbController) error {
...
func dock89DonglePowerStep10(ctx context.Context, s *testing.State, cr *chrome.Chrome, uc *utils.UsbController) error {
...
func dock89DonglePowerStep11(ctx context.Context, s *testing.State, cr *chrome.Chrome, uc *utils.UsbController) error {
...
func dock89DonglePowerStep12(ctx context.Context, s *testing.State, cr *chrome.Chrome, uc *utils.UsbController) error {
