...
func Dock89DonglePower(ctx context.Context, s *testing.State) {
	...
	if err := dock89DonglePowerStep3(ctx, s, tconn, uc); err != nil {
	...
	if err := dock89DonglePowerStep12(ctx, s, cr, uc, dockingID); err != nil {
...
func dock89DonglePowerStep3(ctx context.Context, s *testing.State, tconn *chrome.TestConn, uc *utils.UsbController) error {
...
func dock89DonglePowerStep12(ctx context.Context, s *testing.State, cr *chrome.Chrome, uc *utils.UsbController, dockingID string) error {
