...
// DetectAudio checks whether certain words exist in audio file.
...
// DetectVideo checks whether certain frame exist in video file.
// FilePath: file path stored on WWCB server.
...
// GetPiColorHotValue returns hot value from a picture.
// FilePath: file path stored on WWCB server.
