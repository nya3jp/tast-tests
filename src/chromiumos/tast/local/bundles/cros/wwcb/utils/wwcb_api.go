...
// SwitchFixture controls fixtures to connect or disconnect.
...
// ControlAviosys controls aviosys power.
// PowerState: 1 means turning on / 0 means turning off.
// Port: there are 4 ports on aviosys power.
