...
func SuspendChromebook(ctx context.Context, cr *chrome.Chrome) (*chrome.TestConn, error) {

	testing.ContextLog(ctx, "Suspend 15s then reconnect chromebook")
...
func PoweroffChromebook(ctx context.Context) error {
	testing.ContextLog(ctx, "Power off chromebook")
