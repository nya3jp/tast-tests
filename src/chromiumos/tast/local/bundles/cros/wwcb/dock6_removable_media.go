...
func Dock6RemovableMedia(ctx context.Context, s *testing.State) {
	...
	if err := dock6RemovableMediaStep4(ctx); err != nil {
	...
	if err := dock6RemovableMediaStep6(ctx, tconn, kb, testVideo); err != nil {
...
func dock6RemovableMediaStep4(ctx context.Context) error {
...
func dock6RemovableMediaStep6(ctx context.Context, tconn *chrome.TestConn, kb *input.KeyboardEventWriter, testVideo string) error {
