...
func init() {
	testing.AddTest(&testing.Test{
		...
		Params: []testing.Param{{
			...
			Val:               peerconnection.MakeCaptureTestOptions("VP8", peerconnection.Monitor),
			ExtraSoftwareDeps: []string{caps.HWDecodeVP8, caps.HWEncodeVP8},
			Fixture:           "chromeScreenCapture",
		}, {
			Name:              "vp8_hw_capture_window",
			Val:               peerconnection.MakeCaptureTestOptions("VP8", peerconnection.Window),
			ExtraSoftwareDeps: []string{caps.HWDecodeVP8, caps.HWEncodeVP8},
			Fixture:           "chromeWindowCapture",
		}, {
			Name:              "vp8_hw_capture_tab",
			Val:               peerconnection.MakeCaptureTestOptions("VP8", peerconnection.Tab),
			ExtraSoftwareDeps: []string{caps.HWDecodeVP8, caps.HWEncodeVP8},
