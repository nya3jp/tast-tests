...
func init() {
	testing.AddTest(&testing.Test{
		...
		Params: []testing.Param{{
			Name:              "h264_hw",
			Val:               rtcPerfTest{enableHWDecoding: true, enableHWEncoding: true, profile: "H264"},
			ExtraSoftwareDeps: []string{caps.HWDecodeH264, caps.HWEncodeH264, "proprietary_codecs"},
			Fixture:           "chromeVideoWithFakeWebcam",
		}, {
			Name:              "h264_sw",
			Val:               rtcPerfTest{profile: "H264"},
			ExtraSoftwareDeps: []string{"proprietary_codecs"},
			Fixture:           "chromeVideoWithFakeWebcamAndSWDecoding",
		}, {
			Name:              "vp8_hw",
			Val:               rtcPerfTest{enableHWDecoding: true, enableHWEncoding: true, profile: "VP8"},
			ExtraSoftwareDeps: []string{caps.HWDecodeVP8, caps.HWEncodeVP8},
			Fixture:           "chromeVideoWithFakeWebcam",
		}, {
			Name:    "vp8_sw",
			Val:     rtcPerfTest{profile: "VP8"},
			Fixture: "chromeVideoWithFakeWebcamAndSWDecoding",
		}, {
			Name:              "vp9_hw",
			Val:               rtcPerfTest{enableHWDecoding: true, enableHWEncoding: true, profile: "VP9"},
			ExtraSoftwareDeps: []string{caps.HWDecodeVP9, caps.HWEncodeVP9},
			Fixture:           "chromeVideoWithFakeWebcam",
		}, {
			Name:    "vp9_sw",
			Val:     rtcPerfTest{profile: "VP9"},
			Fixture: "chromeVideoWithFakeWebcamAndSWDecoding",
		}, {
			...
			Val:               rtcPerfTest{enableHWDecoding: true, enableHWEncoding: true, profile: "VP9", svc: "L1T2"},
			ExtraSoftwareDeps: []string{caps.HWDecodeVP9, caps.HWEncodeVP9},
			...
			Val:               rtcPerfTest{enableHWDecoding: true, enableHWEncoding: true, profile: "VP9", svc: "L1T3"},
			ExtraSoftwareDeps: []string{caps.HWDecodeVP9, caps.HWEncodeVP9},
			Fixture:           "chromeVideoWithFakeWebcamAndSVCEnabled",
		}, {
			Name:              "vp8_hw_multi_vp9_3x3",
			Val:               rtcPerfTest{enableHWDecoding: true, enableHWEncoding: true, profile: "VP8", videoGridDimension: 3, videoGridFile: "tulip2-320x180.vp9.webm"},
			ExtraSoftwareDeps: []string{caps.HWDecodeVP9, caps.HWEncodeVP8},
			ExtraData:         []string{"tulip2-320x180.vp9.webm"},
			Fixture:           "chromeVideoWithFakeWebcam",
		}, {
			Name:              "vp8_hw_multi_vp9_4x4",
			Val:               rtcPerfTest{enableHWDecoding: true, enableHWEncoding: true, profile: "VP8", videoGridDimension: 4, videoGridFile: "tulip2-320x180.vp9.webm"},
			ExtraSoftwareDeps: []string{caps.HWDecodeVP9, caps.HWEncodeVP8},
			ExtraData:         []string{"tulip2-320x180.vp9.webm"},
			Fixture:           "chromeVideoWithFakeWebcam",
...
func RTCPeerConnectionPerf(ctx context.Context, s *testing.State) {
	...
	if err := peerconnection.RunDecodePerf(ctx, s.FixtValue().(*chrome.Chrome), s.DataFileSystem(), s.OutDir(), testOpt.profile, testOpt.enableHWDecoding, testOpt.enableHWEncoding, testOpt.videoGridDimension, testOpt.videoGridFile, testOpt.svc); err != nil {
