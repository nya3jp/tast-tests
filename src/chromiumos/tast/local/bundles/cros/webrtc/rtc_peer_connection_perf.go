...
func init() {
	testing.AddTest(&testing.Test{
		...
		Params: []testing.Param{{
			Name:    "av1_sw",
			Val:     peerconnection.MakeSWTestParams("AV1", 1280, 720),
			...
			Val:               peerconnection.MakeCaptureTestParams("VP8", 1280, 720, peerconnection.CaptureMonitor),
			ExtraHardwareDeps: hwdep.D(hwdep.InternalDisplay()),
			ExtraSoftwareDeps: []string{caps.HWDecodeVP8, caps.HWEncodeVP8},
			Fixture:           "chromeScreenCapture",
		}, {
			Name:              "vp8_hw_capture_window",
			Val:               peerconnection.MakeCaptureTestParams("VP8", 1280, 720, peerconnection.CaptureWindow),
			ExtraSoftwareDeps: []string{caps.HWDecodeVP8, caps.HWEncodeVP8},
			Fixture:           "chromeWindowCapture",
		}, {
			Name:              "vp8_hw_capture_tab",
			Val:               peerconnection.MakeCaptureTestParams("VP8", 1280, 720, peerconnection.CaptureTab),
			ExtraSoftwareDeps: []string{caps.HWDecodeVP8, caps.HWEncodeVP8},
			...
			Val:               peerconnection.MakeHWTestParamsWithSVC("VP9", 1280, 720, "L1T2", true),
			ExtraSoftwareDeps: []string{caps.HWDecodeVP9, caps.HWEncodeVP9},
			...
			Val:               peerconnection.MakeHWTestParamsWithSVC("VP9", 1280, 720, "L1T3", true),
			ExtraSoftwareDeps: []string{caps.HWDecodeVP9, caps.HWEncodeVP9},
			Fixture:           "chromeVideoWithFakeWebcamAndSVCEnabled",
		}, {
			...
			Val:               peerconnection.MakeHWTestParamsWithSVC("VP9", 1280, 720, "L3T3_KEY", true),
			ExtraSoftwareDeps: []string{caps.HWDecodeVP9, caps.HWEncodeVP9},
			Fixture:           "chromeVideoWithFakeWebcamAndSVCEnabled",
		}, {
			...
			Val:               peerconnection.MakeHWTestParamsWithVideoGrid("VP9", 1280, 720, 3, "tulip2-320x180.vp9.webm"),
			ExtraSoftwareDeps: []string{caps.HWDecodeVP9, caps.HWEncodeVP9},
			ExtraData:         []string{"tulip2-320x180.vp9.webm"},
			Fixture:           "chromeVideoWithFakeWebcam",
		}, {
			...
			Val:               peerconnection.MakeSimulcastTestParams("VP8", 1280, 720, []bool{true, true, true}),
			ExtraSoftwareDeps: []string{caps.HWDecodeVP8, caps.HWEncodeVP8},
			Fixture:           "chromeVideoWithFakeWebcam",
		}, {
...
func RTCPeerConnectionPerf(ctx context.Context, s *testing.State) {
	testOpt := s.Param().(peerconnection.RTCTestParams)
