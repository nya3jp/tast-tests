...
func init() {
	testing.AddTest(&testing.Test{
		...
		Data:         append(utils.LoopbackDataFiles(), "crowd720_25frames.y4m"),
	})
}

func DecodeAccelUsedVP8(ctx context.Context, s *testing.State) {
	video.RunWebRTCVideo(ctx, s, "crowd720_25frames.y4m", constants.RTCVDInitStatus, constants.RTCVDInitSuccess)
}
