...
func init() {
	testing.AddTest(&testing.Test{
		...
		Pre:          pre.ChromeVideo(),
		Data:         append(common.DataFiles(), "third_party/munge_sdp.js", "loopback_camera.html"),
	})
}
...
func PeerConnH264(ctx context.Context, s *testing.State) {
	...
	common.RunWebRTCPeerConn(ctx, s, s.PreValue().(*chrome.Chrome), videotype.H264,
		duration, common.VerboseLogging)
}
