...
// PeerConnMediaRecorder checks that MediaRecorder is able to record a local stream or a
...
func PeerConnMediaRecorder(ctx context.Context, s *testing.State) {
	chromeArgs := []string{
