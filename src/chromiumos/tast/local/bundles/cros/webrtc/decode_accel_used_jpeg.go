...
func init() {
	testing.AddTest(&testing.Test{
		...
		Data:         append(utils.LoopbackDataFiles(), "crowd720_25frames.mjpeg"),
	})
}

func DecodeAccelUsedJPEG(ctx context.Context, s *testing.State) {
	video.RunWebRTCVideo(ctx, s, "crowd720_25frames.mjpeg", constants.RTCJPEGInitStatus, constants.RTCJPEGInitSuccess)
}
