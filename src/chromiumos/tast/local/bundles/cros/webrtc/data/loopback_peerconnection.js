...
async function start(profile, isSimulcast, width = 1280, height = 720) {
  ...
  localPeerConnection.onicecandidate = e => remotePeerConnection.addIceCandidate(e.candidate);
  remotePeerConnection.onicecandidate = e => localPeerConnection.addIceCandidate(e.candidate);
