...
// Package chrome provides utility variables and functions for webrtc.* tests
package rtcchrome
...
// ArgsWithCameraInput returns Chrome extra args as string slice
...
func ArgsWithCameraInput(stream string, verbose bool) []string {
	args := []string{
