...
func init() {
	testing.AddTest(&testing.Test{
		...
		Params: []testing.Param{{
			...
			ExtraSoftwareDeps: []string{caps.HWEncodeH264, "supports_proprietary_codecs"}, // "supports_proprietary_codecs" is needed because H.264 is a proprietary codec.
			Pre:               pre.ChromeVideoWithFakeWebcam(),
		}, {
			Name:              "h264_dec",
			Val:               rtcTest{verifyMode: peerconnection.VerifyHWDecoderUsed, profile: "H264", simulcast: false},
			ExtraSoftwareDeps: []string{caps.HWDecodeH264, "supports_proprietary_codecs"}, // "supports_proprietary_codecs" is needed because H.264 is a proprietary codec.
			Pre:               pre.ChromeVideoWithFakeWebcam(),
		}, {
			Name: "vp8",
			...
			Name:              "h264_enc_cam",
			Val:               rtcTest{verifyMode: peerconnection.VerifyHWEncoderUsed, profile: "H264", simulcast: false},
			ExtraSoftwareDeps: []string{caps.BuiltinCamera, caps.HWEncodeH264, "supports_proprietary_codecs"}, // "supports_proprietary_codecs" is needed because H.264 is a proprietary codec.
			Pre:               pre.ChromeCameraPerf(),
		}, {
			Name:              "vp9_enc_cam",
			Val:               rtcTest{verifyMode: peerconnection.VerifyHWEncoderUsed, profile: "VP9", simulcast: false},
