...
func init() {
	testing.AddTest(&testing.Test{
		Func: MojoReceiveFromAndroid,
		Desc: "Receive a share from a connected Android device using Mojo APIs to control CrOS Nearby Share",
		Contacts: []string{
...
// MojoReceiveFromAndroid tests receiving a share in high-vis mode from an Android phone, controlling CrOS Nearby with Mojo APIs.
func MojoReceiveFromAndroid(ctx context.Context, s *testing.State) {
	// const (
