...
func init() {
	testing.AddTest(&testing.Test{
		Func: SmokeHighVisibilityUI, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Checks that Nearby Share high-visibility receiving can be initiated from Quick Settings",
		Contacts: []string{
