...
func init() {
	testing.AddTest(&testing.Test{
		Func: PhoneToCrosInContacts, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Checks that we can successfully send files between contacts from Android to CrOS",
		Contacts: []string{
