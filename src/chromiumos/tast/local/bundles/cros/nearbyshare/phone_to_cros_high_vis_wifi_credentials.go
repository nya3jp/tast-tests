...
func PhoneToCrosHighVisWifiCredentials(ctx context.Context, s *testing.State) {
	...
	s.Log("Opening known Wi-Fi networks from notificatoin")
	if err := nearbyshare.OpenWiFiNetworkListNotification(ctx, tconn, nearbycommon.WiFiNotificationTimeout); err != nil {
