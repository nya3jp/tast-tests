...
// PhoneToCrosInContactsWifi tests in-contacts Wi-Fi credentials sharing with an Android device as sender and CrOS device as receiver.
func PhoneToCrosInContactsWifi(ctx context.Context, s *testing.State) {
	...
	NetworkCheckAndCleanup(ctx, testWiFi)
}

func (wifi *WifiManager) NetworkCheckAndCleanup(ctx context.Context, ssid string) {
