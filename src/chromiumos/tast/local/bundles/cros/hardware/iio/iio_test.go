...
func TestGetSensors(t *testing.T) {
	...
	expected := []*Sensor{
		{Accel, Lid, 0, .25, 100, 1000, true, Device{"iio:device0"}},
		{Gyro, Base, 1, 0, 0, 0, false, Device{"iio:device1"}},
		{Ring, None, 0, 0, 0, 0, false, Device{"iio:device3"}},
	}
...
func TestGetTriggers(t *testing.T) {
	...
	expected := []*Trigger{
		{RingTrigger, "cros-ec-ring-trigger0", Device{"trigger0"}},
		{SysfsTrigger, "sysfstrig0", Device{"trigger2"}},
	}
