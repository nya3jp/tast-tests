...
func init() {
	testing.AddTest(&testing.Test{
		Func: PlayAndRecordAudio, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Play local audio file and record it simultaneously. Then play the recorded audio and verify if it routes through expected audio node",
