...
func init() {
	testing.AddTest(&testing.Test{
		Func: MicrophoneMuteDebugShortcut,
		Desc: "Tests to ensure that the debug accelerator for microphone mute toggle properly mutes/unmutes the microphone",
		Contacts: []string{
...
func MicrophoneMuteDebugShortcut(ctx context.Context, s *testing.State) {
	cr, err := chrome.New(ctx,
		chrome.ExtraArgs("--ash-debug-shortcuts"))
	if err != nil {
