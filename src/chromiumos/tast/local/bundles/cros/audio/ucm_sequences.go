	...
	testing.AddTest(&testing.Test{
		...
		Params: []testing.Param{
			...
			},
			{
				...
				Val: ucmSequencesParam{
					alsaucmCommander: staticCommander{
						{"EnableSequence", []string{"set", "_enadev", "Speaker"}},
						{"DisableSequence", []string{"set", "_disdev", "Speaker"}},
					},
				},
			},
			{
				...
				Val: ucmSequencesParam{
					alsaucmCommander: staticCommander{
						{"EnableSequence", []string{"set", "_enadev", "Internal Mic"}},
						{"DisableSequence", []string{"set", "_disdev", "Internal Mic"}},
					},
				},
			},
			{
...
type alsaucmCommander interface {
	// commands returns a list of alsaucm commands to run
...
// staticCommander is a ucmSequencesParam that returns a predetermined list of ucmCommands
...
// staticCommands is a ucmSequencesParam that returns a list of ucmCommands
// based on availabe "SectionModifier"s in HiFi.conf
