...
func init() {
	testing.AddTest(&testing.Test{
		Func: MicrophoneMuteKeyboardKey, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Tests to ensure that the dedicated keyboard key for microphone mute toggle properly mutes/unmutes the microphone",
		Contacts: []string{
