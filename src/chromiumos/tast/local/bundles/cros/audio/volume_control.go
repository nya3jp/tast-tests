...
const (
	// Basic test tier will just increase/decrease the audio node volume.
	basic volumeControlTier = iota
	// Plus test tier will generate an audio file and while playing the audio, it increases/decreases the audio node volume.
	plus
)
