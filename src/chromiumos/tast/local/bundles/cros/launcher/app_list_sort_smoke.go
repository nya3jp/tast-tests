...
func AppListSortSmoke(ctx context.Context, s *testing.State) {
	...
	if err := launcher.VerifyFakeAppsOrdered(ctx, ui, appsGrid, fakeAppNamesInOrder /*wait=*/, true); err != nil {
	...
	if err := launcher.VerifyFakeAppsOrdered(ctx, ui, appsGrid, fakeAppNamesInOrder /*wait=*/, false); err != nil {
