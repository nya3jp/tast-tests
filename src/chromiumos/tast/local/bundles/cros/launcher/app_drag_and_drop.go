...
func AppDragAndDrop(ctx context.Context, s *testing.State) {
	...
	if err := dragIconToIcon(ctx, tconn, ui, firstItem, tabletMode); err != nil {
...
func dragIconToIcon(ctx context.Context, tconn *chrome.TestConn, ui *uiauto.Context, firstItem int, tabletMode bool) error {
