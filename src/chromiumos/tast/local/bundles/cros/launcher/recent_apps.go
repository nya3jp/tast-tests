...
// hideLauncherWithOverview hides the launcher and waits until the launcher is hidden or its state
// becomes "hidden".
// Unlike the regular flow that hides the launcher on tablet mode by opening an app, this method
// enters overview mode with the swipe gesture that only works on tablet mode.
