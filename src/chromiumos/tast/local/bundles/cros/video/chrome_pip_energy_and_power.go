...
func init() {
	testing.AddTest(&testing.Test{
		...
		Params: []testing.Param{{
			Name: "small",
			Val:  chromePIPEnergyAndPowerTestParams{bigPIP: false, partlyOccluded: false},
		}, {
			Name: "big",
			Val:  chromePIPEnergyAndPowerTestParams{bigPIP: true, partlyOccluded: false},
		}, {
			Name: "small_occlude",
			Val:  chromePIPEnergyAndPowerTestParams{bigPIP: false, partlyOccluded: true},
		}, {
			Name: "big_occlude",
			Val:  chromePIPEnergyAndPowerTestParams{bigPIP: true, partlyOccluded: true},
		}},
	})
}
