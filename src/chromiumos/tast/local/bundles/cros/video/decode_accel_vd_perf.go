...
func init() {
	testing.AddTest(&testing.Test{
		...
		Params: []testing.Param{{
			...
			Name:              "av1_1080p_60fps_vaapi_lock_disabled",
			Val:               videoDecodeAccelVdPerfTestParam{dataPath: "1080p_60fps_600frames.av1.ivf", disableVaapiLock: true},
			ExtraSoftwareDeps: []string{caps.HWDecodeAV1_60, "thread_safe_libva_backend"},
			ExtraData:         []string{"1080p_60fps_600frames.av1.ivf", "1080p_60fps_600frames.av1.ivf.json"},
		}, {
			Name:              "h264_1080p_60fps_vaapi_lock_disabled",
			Val:               videoDecodeAccelVdPerfTestParam{dataPath: "1080p_60fps_600frames.h264", disableVaapiLock: true},
			ExtraSoftwareDeps: []string{caps.HWDecodeH264_60, "proprietary_codecs", "thread_safe_libva_backend"},
			ExtraData:         []string{"1080p_60fps_600frames.h264", "1080p_60fps_600frames.h264.json"},
		}, {
			Name:              "hevc_1080p_60fps_vaapi_lock_disabled",
			Val:               videoDecodeAccelVdPerfTestParam{dataPath: "1080p_60fps_600frames.hevc", disableVaapiLock: true},
			ExtraSoftwareDeps: []string{caps.HWDecodeHEVC60, "proprietary_codecs", "protected_content", "thread_safe_libva_backend"},
			ExtraData:         []string{"1080p_60fps_600frames.hevc", "1080p_60fps_600frames.hevc.json"},
		}, {
			Name:              "vp8_1080p_60fps_vaapi_lock_disabled",
			Val:               videoDecodeAccelVdPerfTestParam{dataPath: "1080p_60fps_600frames.vp8.ivf", disableVaapiLock: true},
			ExtraSoftwareDeps: []string{caps.HWDecodeVP8_60, "thread_safe_libva_backend"},
			ExtraData:         []string{"1080p_60fps_600frames.vp8.ivf", "1080p_60fps_600frames.vp8.ivf.json"},
		}, {
			Name:              "vp9_1080p_60fps_vaapi_lock_disabled",
			Val:               videoDecodeAccelVdPerfTestParam{dataPath: "1080p_60fps_600frames.vp9.ivf", disableVaapiLock: true},
...
func DecodeAccelVDPerf(ctx context.Context, s *testing.State) {
	...
	if err := decoding.RunAccelVideoPerfTest(ctx, s.OutDir(), s.DataPath(param.dataPath), decoding.TestParams{DecoderType: decoding.VD, DisableVaapiLock: param.disableVaapiLock}); err != nil {
