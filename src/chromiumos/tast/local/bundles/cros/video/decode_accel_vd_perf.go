...
func init() {
	testing.AddTest(&testing.Test{
		Func: DecodeAccelVDPerf, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Measures hardware video decode performance of media::VideoDecoders by running the video_decode_accelerator_perf_tests binary (see go/vd-migration)",
