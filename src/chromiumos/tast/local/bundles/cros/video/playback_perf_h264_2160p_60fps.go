...
func init() {
	testing.AddTest(&testing.Test{
		...
		Data:         []string{"2160p_60fps_600frames.h264.mp4", decode.ChromeMediaInternalsUtilsJSFile},
...
func PlaybackPerfH2642160P60FPS(ctx context.Context, s *testing.State) {
	playback.RunTest(ctx, s, "2160p_60fps_600frames.h264.mp4", playback.DefaultPerfDisabled, playback.VDA)
}
