...
func init() {
	testing.AddTest(&testing.Test{
		...
		Data:         []string{"2160p_60fps_600frames.vp8.webm", decode.ChromeMediaInternalsUtilsJSFile},
...
func PlaybackPerfVP82160P60FPS(ctx context.Context, s *testing.State) {
	playback.RunTest(ctx, s, "2160p_60fps_600frames.vp8.webm", playback.DefaultPerfDisabled, playback.VDA)
}
