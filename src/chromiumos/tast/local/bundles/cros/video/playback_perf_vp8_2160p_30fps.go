...
func init() {
	testing.AddTest(&testing.Test{
		...
		Data:         []string{"2160p_30fps_300frames.vp8.webm", decode.ChromeMediaInternalsUtilsJSFile},
...
func PlaybackPerfVP82160P30FPS(ctx context.Context, s *testing.State) {
	playback.RunTest(ctx, s, "2160p_30fps_300frames.vp8.webm", "vp8_2160p_30fps", playback.DefaultPerfDisabled, playback.VDA)
}
