...
func init() {
	testing.AddTest(&testing.Test{
		Func: DecodeAccel, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Verifies hardware decode acceleration by running the video_decode_accelerator_tests binary",
