...
var chromeVideoPre = chrome.NewPrecondition("video", ChromeVideoExtraArgs)

// ChromeVideoExtraArgs is a chrome.option that fills Chrome extra args for video testing.
var ChromeVideoExtraArgs = chrome.ExtraArgs(
