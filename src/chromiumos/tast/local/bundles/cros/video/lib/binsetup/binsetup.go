...
// CreateDataFileDir creates a world-readable temporary directory using the supplied prefix
...
func CreateDataFileDir(s *testing.State, prefix string, dataFiles []string) string {
