...
func MeasureUsageOnRunningBinary(ctx context.Context, testExec string, args, env []string, outDir string,
	...
	cmd, err := bintest.RunAsync(ctx, testExec, args, env, outDir)
	if err != nil {
