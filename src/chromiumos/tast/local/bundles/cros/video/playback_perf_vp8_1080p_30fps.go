...
func init() {
	testing.AddTest(&testing.Test{
		...
		Data:         []string{"1080p_30fps_300frames.vp8.webm", decode.ChromeMediaInternalsUtilsJSFile},
...
func PlaybackPerfVP81080P30FPS(ctx context.Context, s *testing.State) {
	playback.RunTest(ctx, s, "1080p_30fps_300frames.vp8.webm", playback.DefaultPerfDisabled, playback.VDA)
}
