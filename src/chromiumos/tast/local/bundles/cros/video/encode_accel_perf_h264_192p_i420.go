...
func init() {
	testing.AddTest(&testing.Test{
		...
		Desc:         "Run Chrome video_encode_accelerator_unittest to measure the performance of H264 encoding for 192p I420 video",
...
// EncodeAccelPerfH264192PI420 runs video_encode_accelerator_unittest to measure the performance of encoding H264 with I420 raw data, bear_320x192_40frames.yuv.
