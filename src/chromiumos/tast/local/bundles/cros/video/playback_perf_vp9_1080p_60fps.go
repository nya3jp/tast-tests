...
func init() {
	testing.AddTest(&testing.Test{
		...
		Data:         []string{"1080p_60fps_600frames.vp9.webm", decode.ChromeMediaInternalsUtilsJSFile},
...
func PlaybackPerfVP91080P60FPS(ctx context.Context, s *testing.State) {
	playback.RunTest(ctx, s, "1080p_60fps_600frames.vp9.webm", "vp9_1080p_60fps", playback.DefaultPerfDisabled, playback.VDA)
}
