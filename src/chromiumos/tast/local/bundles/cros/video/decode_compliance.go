...
var videoTestFiles = []string{
	...
	"test_vectors/av1/GTAV-AV1-8bit-1920x1080-2997kbps.ivf",
	"test_vectors/av1/GTAV-AV1-8bit-1920x1080-2997kbps.ivf.json",
	"test_vectors/av1/Netflix_ToddlerFountain-AV1-8bit-1920x1012-3094kbps.ivf",
	"test_vectors/av1/Netflix_ToddlerFountain-AV1-8bit-1920x1012-3094kbps.ivf.json",
