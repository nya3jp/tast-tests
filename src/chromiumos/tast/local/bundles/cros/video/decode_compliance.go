...
var videoTestFiles = []string{
	...
	"test_vectors/av1/test-25fps-192x288-only-tile-cols-is-power-of-2_20210111.ivf",
	"test_vectors/av1/test-25fps-192x288-only-tile-cols-is-power-of-2_20210111.ivf.json",
	"test_vectors/av1/test-25fps-192x288-only-tile-rows-is-power-of-2_20210111.ivf",
	"test_vectors/av1/test-25fps-192x288-only-tile-rows-is-power-of-2_20210111.ivf.json",
	"test_vectors/av1/test-25fps-192x288-tile-rows-3-tile-cols-3_20210111.ivf",
	"test_vectors/av1/test-25fps-192x288-tile-rows-3-tile-cols-3_20210111.ivf.json",
}
