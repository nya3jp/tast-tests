...
var metricDefs = []metricDef{
	{cpuUsageDesc, "percent", perf.SmallerIsBetter, optional: false},
	{powerConsumptionDesc, "watt", perf.SmallerIsBetter, optional: true},
	{droppedFrameDesc, "frames", perf.SmallerIsBetter, optional: false},
	{droppedFramePercentDesc, "percent", perf.SmallerIsBetter, optional: false},
}
...
func measurePerformance(ctx context.Context, fileSystem http.FileSystem, utilsJSPath, videoName string,
	...
	if enableHWAccel {
		if !usesPlatformVideoDecoder {
			return nil, errors.New("hardware encoding accelerator wasn't used")
		}
	} else {
		if usesPlatformVideoDecoder {
			return nil, errors.New("software encoding wasn't used")
		}
	}
