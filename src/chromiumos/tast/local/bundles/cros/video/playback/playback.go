...
func measurePerformance(ctx context.Context, fileSystem http.FileSystem, utilsJSPath string, videoName string,
...
func measureWithConfig(ctx context.Context, fileSystem http.FileSystem, utilsJSPath string, videoName string,
	...
	extraChromeMediaInternalsUtilsJS, err := ioutil.ReadFile(utilsJSPath)
	if err != nil {
	...
	usesPlatformVideoDecoder, err := decode.CheckIfURLUsesPlatformVideoDecoder(ctx, chromeMediaInternalsConn, url)
	if err != nil {
