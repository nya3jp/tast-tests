...
func init() {
	testing.AddTest(&testing.Test{
		...
		Params: []testing.Param{{
			...
			ExtraSoftwareDeps: []string{caps.HWDecodeH264_60, "supports_proprietary_codecs"},
			...
			ExtraSoftwareDeps: []string{caps.HWDecodeH264_4K, "supports_proprietary_codecs"},
			...
			ExtraSoftwareDeps: []string{caps.HWDecodeH264_4K60, "supports_proprietary_codecs"},
			...
			ExtraSoftwareDeps: []string{"supports_proprietary_codecs"},
			ExtraAttr:         []string{"group:graphics", "graphics_video", "graphics_nightly"},
			ExtraData:         []string{"480p_30fps_300frames.h264.mp4"},
			...
			// "supports_proprietary_codecs" is needed because H.264 is a proprietary codec.
			ExtraSoftwareDeps: []string{caps.HWDecodeH264_60, "supports_proprietary_codecs"},
			ExtraData:         []string{"1080p_60fps_600frames.h264.mp4"},
