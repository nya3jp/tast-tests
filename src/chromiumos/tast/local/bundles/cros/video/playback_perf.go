...
func createParams(fileName string, decoderType playback.DecoderType, browserType browser.Type, gridSize int) playbackPerfParams {
...
func createParamsForHwOnAsh(fileName string) playbackPerfParams {
	return createParams(fileName, playback.Hardware, browser.TypeAsh, 1)
}

func createParamsForSwOnAsh(fileName string) playbackPerfParams {
	return createParams(fileName, playback.Software, browser.TypeAsh, 1)
}

func createParamsWithDecoderType(fileName string, decoderType playback.DecoderType, browserType browser.Type) playbackPerfParams {
	return createParams(fileName, decoderType, browserType, 1)
}

func createParamsWithGridSize(fileName string, gridSize int) playbackPerfParams {
	return createParams(fileName, playback.Hardware, browser.TypeAsh, gridSize)
}
...
func init() {
	testing.AddTest(&testing.Test{
		...
		Params: []testing.Param{{
			...
			Val:               createParamsForHwOnAsh("144p_30fps_300frames.h264.mp4"),
			...
			Val:               createParamsForHwOnAsh("240p_30fps_300frames.h264.mp4"),
			ExtraSoftwareDeps: []string{caps.HWDecodeH264, "proprietary_codecs"},
			ExtraAttr:         []string{"group:graphics", "graphics_video", "graphics_nightly"},
			...
			Val:               createParamsForHwOnAsh("360p_30fps_300frames.h264.mp4"),
			ExtraSoftwareDeps: []string{caps.HWDecodeH264, "proprietary_codecs"},
			ExtraAttr:         []string{"group:graphics", "graphics_video", "graphics_nightly"},
			...
			Val:               createParamsForHwOnAsh("480p_30fps_300frames.h264.mp4"),
			ExtraSoftwareDeps: []string{caps.HWDecodeH264, "proprietary_codecs"},
			ExtraAttr:         []string{"group:graphics", "graphics_video", "graphics_nightly"},
			...
			Val:               createParamsForHwOnAsh("720p_30fps_300frames.h264.mp4"),
			ExtraSoftwareDeps: []string{caps.HWDecodeH264, "proprietary_codecs"},
			ExtraAttr:         []string{"group:graphics", "graphics_video", "graphics_nightly"},
			...
			Val:               createParamsWithDecoderType("720p_30fps_300frames.h264.mp4", playback.Hardware, browser.TypeLacros),
			...
			Val:               createParamsWithGridSize("720p_30fps_300frames.h264.mp4", 3),
			ExtraSoftwareDeps: []string{caps.HWDecodeH264, "proprietary_codecs"},
			ExtraAttr:         []string{"group:graphics", "graphics_video", "graphics_nightly"},
			ExtraData:         []string{"720p_30fps_300frames.h264.mp4"},
			Fixture:           "chromeVideo",
			...
			Val:               createParamsForHwOnAsh("1080p_30fps_300frames.h264.mp4"),
			ExtraSoftwareDeps: []string{caps.HWDecodeH264, "proprietary_codecs"},
			ExtraData:         []string{"1080p_30fps_300frames.h264.mp4"},
			Fixture:           "chromeVideo",
		}, {
			Name:              "h264_1080p_60fps_hw",
			Val:               createParamsForHwOnAsh("1080p_60fps_600frames.h264.mp4"),
			...
			Val:               createParamsForHwOnAsh("2160p_30fps_300frames.h264.mp4"),
			...
			Val:               createParamsForHwOnAsh("2160p_60fps_600frames.h264.mp4"),
			...
			Val:               createParamsForHwOnAsh("144p_30fps_300frames.vp8.webm"),
			ExtraAttr:         []string{"group:graphics", "graphics_video", "graphics_nightly"},
			...
			Val:               createParamsForHwOnAsh("240p_30fps_300frames.vp8.webm"),
			ExtraAttr:         []string{"group:graphics", "graphics_video", "graphics_nightly"},
			...
			Val:               createParamsForHwOnAsh("360p_30fps_300frames.vp8.webm"),
			ExtraAttr:         []string{"group:graphics", "graphics_video", "graphics_nightly"},
			...
			Val:               createParamsForHwOnAsh("480p_30fps_300frames.vp8.webm"),
			ExtraAttr:         []string{"group:graphics", "graphics_video", "graphics_nightly"},
			...
			Val:               createParamsForHwOnAsh("720p_30fps_300frames.vp8.webm"),
			ExtraAttr:         []string{"group:graphics", "graphics_video", "graphics_nightly"},
			...
			Val:               createParamsWithGridSize("720p_30fps_300frames.vp8.webm", 3),
			ExtraAttr:         []string{"group:graphics", "graphics_video", "graphics_nightly"},
			ExtraData:         []string{"720p_30fps_300frames.vp8.webm"},
			ExtraSoftwareDeps: []string{caps.HWDecodeVP8},
			Fixture:           "chromeVideo",
			...
			Val:               createParamsForHwOnAsh("240p_30fps_300frames.vp9.webm"),
			ExtraAttr:         []string{"group:graphics", "graphics_video", "graphics_nightly"},
			...
			Val:               createParamsForHwOnAsh("360p_30fps_300frames.vp9.webm"),
			ExtraAttr:         []string{"group:graphics", "graphics_video", "graphics_nightly"},
			...
			Val:               createParamsForHwOnAsh("480p_30fps_300frames.vp9.webm"),
			ExtraAttr:         []string{"group:graphics", "graphics_video", "graphics_nightly"},
			...
			Val:               createParamsForHwOnAsh("720p_30fps_300frames.vp9.webm"),
			ExtraAttr:         []string{"group:graphics", "graphics_video", "graphics_nightly"},
			...
			Val:               createParamsWithDecoderType("720p_30fps_300frames.vp9.webm", playback.Hardware, browser.TypeLacros),
			ExtraAttr:         []string{"group:graphics", "graphics_video", "graphics_nightly"},
			ExtraData:         []string{"720p_30fps_300frames.vp9.webm"},
			...
			Val:               createParamsWithGridSize("720p_30fps_300frames.vp9.webm", 3),
			ExtraAttr:         []string{"group:graphics", "graphics_video", "graphics_nightly"},
			ExtraData:         []string{"720p_30fps_300frames.vp9.webm"},
			ExtraSoftwareDeps: []string{caps.HWDecodeVP9},
			Fixture:           "chromeVideo",
			...
			Val:               createParamsForHwOnAsh("240p_30fps_300frames.hevc.mp4"),
			ExtraSoftwareDeps: []string{caps.HWDecodeHEVC, "proprietary_codecs", "protected_content"},
			ExtraAttr:         []string{"group:graphics", "graphics_video", "graphics_nightly"},
			...
			Val:               createParamsForHwOnAsh("360p_30fps_300frames.hevc.mp4"),
			ExtraSoftwareDeps: []string{caps.HWDecodeHEVC, "proprietary_codecs", "protected_content"},
			ExtraAttr:         []string{"group:graphics", "graphics_video", "graphics_nightly"},
			...
			Val:               createParamsForHwOnAsh("480p_30fps_300frames.hevc.mp4"),
			ExtraSoftwareDeps: []string{caps.HWDecodeHEVC, "proprietary_codecs", "protected_content"},
			ExtraAttr:         []string{"group:graphics", "graphics_video", "graphics_nightly"},
			...
			Val:               createParamsForHwOnAsh("720p_30fps_300frames.hevc.mp4"),
			ExtraSoftwareDeps: []string{caps.HWDecodeHEVC, "proprietary_codecs", "protected_content"},
			ExtraAttr:         []string{"group:graphics", "graphics_video", "graphics_nightly"},
			...
			Val:               createParamsForHwOnAsh("1080p_30fps_300frames.hevc.mp4"),
			ExtraSoftwareDeps: []string{caps.HWDecodeHEVC, "proprietary_codecs", "protected_content"},
			ExtraData:         []string{"1080p_30fps_300frames.hevc.mp4"},
			Fixture:           "chromeVideoWithClearHEVCHWDecoding",
		}, {
			Name:              "hevc_1080p_60fps_hw",
			Val:               createParamsForHwOnAsh("1080p_60fps_600frames.hevc.mp4"),
			...
			Val:               createParamsForHwOnAsh("2160p_30fps_300frames.hevc.mp4"),
			...
			Val:               createParamsForHwOnAsh("2160p_60fps_600frames.hevc.mp4"),
			...
			Val:               createParamsForHwOnAsh("2160p_30fps_300frames.hevc10.mp4"),
			...
			Val:               createParamsForHwOnAsh("2160p_60fps_600frames.hevc10.mp4"),
			...
			Val:               createParamsForSwOnAsh("480p_30fps_300frames.h264.mp4"),
			...
			Val:               createParamsForSwOnAsh("720p_30fps_300frames.h264.mp4"),
			ExtraSoftwareDeps: []string{"proprietary_codecs"},
			ExtraAttr:         []string{"group:graphics", "graphics_video", "graphics_nightly"},
			ExtraData:         []string{"720p_30fps_300frames.h264.mp4"},
			Fixture:           "chromeVideoWithSWDecoding",
			...
			Val:               createParamsForSwOnAsh("1080p_30fps_300frames.h264.mp4"),
			ExtraSoftwareDeps: []string{"proprietary_codecs"},
			ExtraData:         []string{"1080p_30fps_300frames.h264.mp4"},
			Fixture:           "chromeVideoWithSWDecoding",
		}, {
			Name:              "h264_1080p_60fps_sw",
			Val:               createParamsForSwOnAsh("1080p_60fps_600frames.h264.mp4"),
			ExtraSoftwareDeps: []string{"proprietary_codecs"},
			ExtraData:         []string{"1080p_60fps_600frames.h264.mp4"},
			Fixture:           "chromeVideoWithSWDecoding",
		}, {
			Name:      "vp8_480p_30fps_sw",
			Val:       createParamsForSwOnAsh("480p_30fps_300frames.vp8.webm"),
			ExtraAttr: []string{"group:graphics", "graphics_video", "graphics_nightly"},
			ExtraData: []string{"480p_30fps_300frames.vp8.webm"},
			Fixture:   "chromeVideoWithSWDecoding",
		}, {
			Name:      "vp8_720p_30fps_sw",
			Val:       createParamsForSwOnAsh("720p_30fps_300frames.vp8.webm"),
			ExtraAttr: []string{"group:graphics", "graphics_video", "graphics_nightly"},
			ExtraData: []string{"720p_30fps_300frames.vp8.webm"},
			Fixture:   "chromeVideoWithSWDecoding",
		}, {
			Name:      "vp8_1080p_30fps_sw",
			Val:       createParamsForSwOnAsh("1080p_30fps_300frames.vp8.webm"),
			ExtraData: []string{"1080p_30fps_300frames.vp8.webm"},
			Fixture:   "chromeVideoWithSWDecoding",
		}, {
			Name:      "vp8_1080p_60fps_sw",
			Val:       createParamsForSwOnAsh("1080p_60fps_600frames.vp8.webm"),
			ExtraData: []string{"1080p_60fps_600frames.vp8.webm"},
			Fixture:   "chromeVideoWithSWDecoding",
		}, {
			Name:      "vp9_480p_30fps_sw",
			Val:       createParamsForSwOnAsh("480p_30fps_300frames.vp9.webm"),
			ExtraAttr: []string{"group:graphics", "graphics_video", "graphics_nightly"},
			ExtraData: []string{"480p_30fps_300frames.vp9.webm"},
			Fixture:   "chromeVideoWithSWDecoding",
		}, {
			Name:      "vp9_720p_30fps_sw",
			Val:       createParamsForSwOnAsh("720p_30fps_300frames.vp9.webm"),
			ExtraAttr: []string{"group:graphics", "graphics_video", "graphics_nightly"},
			ExtraData: []string{"720p_30fps_300frames.vp9.webm"},
			Fixture:   "chromeVideoWithSWDecoding",
		}, {
			Name:      "vp9_1080p_30fps_sw",
			Val:       createParamsForSwOnAsh("1080p_30fps_300frames.vp9.webm"),
			ExtraData: []string{"1080p_30fps_300frames.vp9.webm"},
			Fixture:   "chromeVideoWithSWDecoding",
		}, {
			Name:      "vp9_1080p_60fps_sw",
			Val:       createParamsForSwOnAsh("1080p_60fps_600frames.vp9.webm"),
			ExtraData: []string{"1080p_60fps_600frames.vp9.webm"},
			Fixture:   "chromeVideoWithSWDecoding",
		}, {
			Name:      "av1_480p_30fps_sw",
			Val:       createParamsForSwOnAsh("480p_30fps_300frames.av1.mp4"),
			ExtraData: []string{"480p_30fps_300frames.av1.mp4"},
			Fixture:   "chromeVideoWithSWDecoding",
		}, {
			Name:      "av1_720p_30fps_sw",
			Val:       createParamsForSwOnAsh("720p_30fps_300frames.av1.mp4"),
			ExtraData: []string{"720p_30fps_300frames.av1.mp4"},
			Fixture:   "chromeVideoWithSWDecoding",
		}, {
			Name:      "av1_720p_60fps_sw",
			Val:       createParamsForSwOnAsh("720p_60fps_600frames.av1.mp4"),
			ExtraData: []string{"720p_60fps_600frames.av1.mp4"},
			Fixture:   "chromeVideoWithSWDecoding",
		}, {
			Name:      "av1_1080p_30fps_sw",
			Val:       createParamsForSwOnAsh("1080p_30fps_300frames.av1.mp4"),
			ExtraData: []string{"1080p_30fps_300frames.av1.mp4"},
			Fixture:   "chromeVideoWithSWDecoding",
		}, {
			Name:      "av1_1080p_60fps_sw",
			Val:       createParamsForSwOnAsh("1080p_60fps_600frames.av1.mp4"),
			ExtraData: []string{"1080p_60fps_600frames.av1.mp4"},
			Fixture:   "chromeVideoWithSWDecoding",
		}, {
			Name:      "av1_2160p_30fps_sw",
			Val:       createParamsForSwOnAsh("2160p_30fps_300frames.av1.mp4"),
			ExtraData: []string{"2160p_30fps_300frames.av1.mp4"},
			Fixture:   "chromeVideoWithSWDecoding",
		}, {
			Name:      "av1_2160p_60fps_sw",
			Val:       createParamsForSwOnAsh("2160p_60fps_600frames.av1.mp4"),
			ExtraData: []string{"2160p_60fps_600frames.av1.mp4"},
			Fixture:   "chromeVideoWithSWDecoding",
		}, {
			Name:              "av1_480p_30fps_sw_gav1",
			Val:               createParamsWithDecoderType("480p_30fps_300frames.av1.mp4", playback.LibGAV1, browser.TypeAsh),
			ExtraSoftwareDeps: []string{"arm"},
			ExtraData:         []string{"480p_30fps_300frames.av1.mp4"},
			Fixture:           "chromeVideoWithSWDecodingAndLibGAV1",
		}, {
			Name:              "av1_720p_30fps_sw_gav1",
			Val:               createParamsWithDecoderType("720p_30fps_300frames.av1.mp4", playback.LibGAV1, browser.TypeAsh),
			ExtraSoftwareDeps: []string{"arm"},
			ExtraData:         []string{"720p_30fps_300frames.av1.mp4"},
			Fixture:           "chromeVideoWithSWDecodingAndLibGAV1",
		}, {
			Name:              "av1_720p_60fps_sw_gav1",
			Val:               createParamsWithDecoderType("720p_60fps_600frames.av1.mp4", playback.LibGAV1, browser.TypeAsh),
			ExtraSoftwareDeps: []string{"arm"},
			ExtraData:         []string{"720p_60fps_600frames.av1.mp4"},
			Fixture:           "chromeVideoWithSWDecodingAndLibGAV1",
		}, {
			Name:              "av1_1080p_30fps_sw_gav1",
			Val:               createParamsWithDecoderType("1080p_30fps_300frames.av1.mp4", playback.LibGAV1, browser.TypeAsh),
			ExtraSoftwareDeps: []string{"arm"},
			ExtraData:         []string{"1080p_30fps_300frames.av1.mp4"},
			Fixture:           "chromeVideoWithSWDecodingAndLibGAV1",
		}, {
			Name:              "av1_1080p_60fps_sw_gav1",
			Val:               createParamsWithDecoderType("1080p_60fps_600frames.av1.mp4", playback.LibGAV1, browser.TypeAsh),
			ExtraSoftwareDeps: []string{"arm"},
			ExtraData:         []string{"1080p_60fps_600frames.av1.mp4"},
			Fixture:           "chromeVideoWithSWDecodingAndLibGAV1",
		}, {
