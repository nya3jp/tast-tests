...
func init() {
	testing.AddTest(&testing.Test{
		...
		Params: []testing.Param{{
			...
			ExtraSoftwareDeps: []string{caps.HWDecodeH264_60, "legacy_video_decoder_only", "proprietary_codecs"},
			ExtraData:         []string{"1080p_60fps_600frames.h264.mp4"},
			...
			ExtraData:         []string{"1080p_60fps_600frames.vp8.webm"},
			ExtraSoftwareDeps: []string{caps.HWDecodeVP8_60, "legacy_video_decoder_only"},
			Pre:               pre.ChromeAlternateVideoDecoder(),
		}, {
			...
			ExtraData:         []string{"1080p_60fps_600frames.vp9.webm"},
			ExtraSoftwareDeps: []string{caps.HWDecodeVP9_60, "legacy_video_decoder_only"},
			Pre:               pre.ChromeAlternateVideoDecoder(),
		}, {
			...
			ExtraData:         []string{"2160p_60fps_600frames.vp9.webm"},
			ExtraSoftwareDeps: []string{caps.HWDecodeVP9_4K60, "legacy_video_decoder_only"},
			Pre:               pre.ChromeAlternateVideoDecoder(),
		}},
	})
}
