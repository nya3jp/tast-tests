...
func init() {
	testing.AddTest(&testing.Test{
		...
		Params: []testing.Param{{
			...
			ExtraAttr:         []string{"group:graphics", "graphics_video", "graphics_nightly"},
			ExtraData:         []string{"video.html", "720p_30fps_300frames.h264.mp4", launcher.DataArtifact},
			...
			ExtraSoftwareDeps: []string{caps.HWDecodeH264, "proprietary_codecs"},
			ExtraData:         []string{"video.html", "video.html", "1080p_30fps_300frames.h264.mp4"},
			Fixture:           "chromeVideo",
		}, {
			...
			ExtraData:         []string{"video.html", "video.html", "1080p_60fps_600frames.h264.mp4"},
			Fixture:           "chromeVideo",
		}, {
			...
			ExtraData:         []string{"video.html", "video.html", "2160p_30fps_300frames.h264.mp4"},
			Fixture:           "chromeVideo",
		}, {
			...
			ExtraAttr:         []string{"group:graphics", "graphics_video", "graphics_nightly"},
			ExtraData:         []string{"video.html", "720p_30fps_300frames.vp9.webm", launcher.DataArtifact},
