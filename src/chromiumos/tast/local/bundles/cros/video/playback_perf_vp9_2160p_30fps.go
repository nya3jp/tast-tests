...
func init() {
	testing.AddTest(&testing.Test{
		Func:         PlaybackPerfVP92160P30FPS,
		Desc:         "Measures video playback performance with/without HW acceleration for VP9 2160p@30fps video",
		Contacts:     []string{"hiroh@chromium.org", "chromeos-video-eng@google.com"},
		Attr:         []string{"group:crosbolt", "crosbolt_perbuild"},
		SoftwareDeps: []string{"chrome"},
		Data:         []string{"2160p_30fps_300frames.vp9.webm", decode.ChromeMediaInternalsUtilsJSFile},
...
func PlaybackPerfVP92160P30FPS(ctx context.Context, s *testing.State) {
	playback.RunTest(ctx, s, "2160p_30fps_300frames.vp9.webm", "vp9_2160p_30fps", playback.DefaultPerfDisabled, playback.VDA)
}
