...
func init() {
	testing.AddTest(&testing.Test{
		...
		Params: []testing.Param{{
			...
			Name:              "switch_h264",
			Val:               seekTest{filename: "bars_resolution_ladder.h264.mp4", numSeeks: 25},
			ExtraAttr:         []string{"group:graphics", "graphics_video", "graphics_perbuild"},
			ExtraData:         []string{"bars_resolution_ladder.h264.mp4"},
			ExtraSoftwareDeps: []string{"chrome_internal"}, // "chrome_internal" is needed because H.264 is a proprietary codec.
			Pre:               pre.ChromeVideo(),
		}, {
			Name:      "switch_vp8",
			Val:       seekTest{filename: "bars_resolution_ladder.vp8.webm", numSeeks: 25},
			ExtraAttr: []string{"group:graphics", "graphics_video", "graphics_perbuild"},
			ExtraData: []string{"bars_resolution_ladder.vp8.webm"},
			Pre:       pre.ChromeVideo(),
		}, {
			Name:      "switch_vp9",
			Val:       seekTest{filename: "bars_resolution_ladder.vp9.webm", numSeeks: 25},
			ExtraAttr: []string{"group:graphics", "graphics_video", "graphics_perbuild"},
			ExtraData: []string{"bars_resolution_ladder.vp9.webm"},
			Pre:       pre.ChromeVideo(),
		}, {
			Name:      "stress_vp8",
