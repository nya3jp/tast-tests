...
func init() {
	testing.AddTest(&testing.Test{
		...
		Params: []testing.Param{{
			...
			ExtraAttr:         []string{"group:graphics", "graphics_video", "graphics_perbuild"},
			ExtraData:         []string{"720_h264.mp4"},
			ExtraSoftwareDeps: []string{caps.HWDecodeH264, "video_alt_decoder_supported", "proprietary_codecs"},
			...
			ExtraAttr:         []string{"group:graphics", "graphics_video", "graphics_perbuild"},
			ExtraData:         []string{"720_vp8.webm"},
			ExtraSoftwareDeps: []string{caps.HWDecodeVP8, "video_alt_decoder_supported"},
			Pre:               pre.ChromeAlternateVideoDecoder(),
		}, {
			Name:              "vp9_alt",
			Val:               seekTest{filename: "720_vp9.webm", numSeeks: 25},
			ExtraAttr:         []string{"group:graphics", "graphics_video", "graphics_perbuild"},
			ExtraData:         []string{"720_vp9.webm"},
			ExtraSoftwareDeps: []string{caps.HWDecodeVP9, "video_alt_decoder_supported"},
			Pre:               pre.ChromeAlternateVideoDecoder(),
		}, {
