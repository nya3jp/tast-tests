...
func init() {
	testing.AddTest(&testing.Test{
		...
		Desc:     "Runs Chrome video_decode_accelerator_tests with an VP8 video on a VideoDecoder (see crbug.com/952730)",
...
// DecodeAccelVDVP8 runs the video_decode_accelerator_tests with test-25fps.vp8
