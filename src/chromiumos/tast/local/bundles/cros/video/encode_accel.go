...
func init() {
	testing.AddTest(&testing.Test{
		...
		Params: []testing.Param{{
			...
			ExtraAttr:         []string{"group:graphics", "graphics_video", "graphics_perday"},
		}, {
			Name: "h264_192p_i420",
			Val: encode.TestOptions{
				Profile:     videotype.H264Prof,
			...
			ExtraSoftwareDeps: []string{caps.HWEncodeVP8},
			ExtraData:         []string{encode.Bear192P.Name},
			ExtraAttr:         []string{"group:mainline", "group:graphics", "graphics_video", "graphics_perday"},
		}, {
			Name: "vp8_360p_i420",
			Val: encode.TestOptions{
				Profile:     videotype.VP8Prof,
			...
			// TODO(b/139846661): Assign a group to it once the Intel encoder driver issue is fixed.
		}},
	})
}
