...
func init() {
	testing.AddTest(&testing.Test{
		...
		Params: []testing.Param{{
			...
			Name: "h264_i420",
			Val: encode.TestOptions{Profile: videotype.H264Prof,
...
func EncodeAccel(ctx context.Context, s *testing.State) {
	...
	// TODO encode.RunAllAccelVideoTestsWithFilter(ctx, s, s.Param().(encode.TestOptions), encode.BitrateTestFilter)
