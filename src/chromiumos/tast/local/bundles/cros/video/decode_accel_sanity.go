...
func init() {
	testing.AddTest(&testing.Test{
		...
		Desc: "Verify that the system doesn't crash when playing a VP9 video with unexpected VP9 profile1/2/3 features",
		Contacts: []string{
		...
		Params: []testing.Param{{
			...
			// "vp9_sanity" is a whitelist of devices that don't crash when playing a VP9 profile0
			// stream with unexpected profile2 features. Currently RK3399 devices may crash so they
			// are excluded. See crbug.com/971032 for details.
			...
			// "vp9_sanity" is a whitelist of devices that don't crash when playing a VP9 profile0
			// stream with unexpected profile3 features. Currently RK3399 devices may crash so they
			// are excluded. See crbug.com/971032 for details.
			ExtraSoftwareDeps: []string{"vp9_sanity"},
		}},
	})
