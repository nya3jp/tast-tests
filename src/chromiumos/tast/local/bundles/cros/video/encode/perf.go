...
// channelStats records statistics of a channel.
...
// update updates statistics with the input value.
...
// frameStats records frame-wise statistics pf YUV and combined channels.
