...
func RunAccelVideoTest(ctxForDefer context.Context, s *testing.State, opts TestOptions, removeArtifacts bool) {
...
func RunAccelVideoPerfTest(ctxForDefer context.Context, s *testing.State, opts TestOptions, removeArtifacts bool) error {
	const (
