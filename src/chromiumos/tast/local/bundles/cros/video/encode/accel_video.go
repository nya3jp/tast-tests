...
// MakeVaapiLockTestOptionsWithNoGlobalVaapiLock creates TestOptions from webMName and profile.
// spatialLayers and temporalLayers are set to 1.
// Always disables the global VAAPI lock.
func MakeVaapiLockTestOptionsWithNoGlobalVaapiLock(webMName string, profile videotype.CodecProfile) TestOptions {
	return TestOptions{
		webMName:               webMName,
		profile:                profile,
		spatialLayers:          1,
