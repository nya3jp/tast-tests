...
// MakeBitrateTestOptions creates TestOptions from webMName, codec and bitrate.
// TemporalLayers is set to 1 and VerifyNV12Input is set to false.
func MakeBitrateTestOptions(webMName string, codec videotype.Codec, bitrate int) TestOptions {
	return TestOptions{
		WebMName:        webMName,
		Codec:           codec,
		TemporalLayers:  1,
