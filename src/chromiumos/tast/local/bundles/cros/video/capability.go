...
var capabilitiesToVerify = map[string]caps.Capability{
	...
	"hw_video_acc_hevc_10bpp":    {Name: caps.HWDecodeHEVC_10BPP, Optional: true},
	...
	"hw_video_acc_hevc_4k":       {Name: caps.HWDecodeHEVC_4K, Optional: true},
	"hw_video_acc_hevc_4k_10bpp": {Name: caps.HWDecodeHEVC_4K10BPP, Optional: true},
