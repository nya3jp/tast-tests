...
var capabilitiesToVerify = map[string]caps.Capability{
	...
	"hw_video_acc_enc_h264_vbr":     {Name: caps.HWEncodeH264VBR, Optional: false},
	"hw_video_acc_enc_vp8":          {Name: caps.HWEncodeVP8, Optional: false},
	"hw_video_acc_enc_vp8_vbr":      {Name: caps.HWEncodeVP8VBR, Optional: false},
	"hw_video_acc_enc_vp9":          {Name: caps.HWEncodeVP9, Optional: false},
	"hw_video_acc_enc_vp9_vbr":      {Name: caps.HWEncodeVP9VBR, Optional: false},
