...
func init() {
	testing.AddTest(&testing.Test{
		...
		Data:         []string{"2160p_30fps_300frames.h264.mp4", decode.ChromeMediaInternalsUtilsJSFile},
...
func PlaybackPerfH2642160P30FPS(ctx context.Context, s *testing.State) {
	playback.RunTest(ctx, s, "2160p_30fps_300frames.h264.mp4", "h264_2160p_30fps", playback.DefaultPerfDisabled, playback.VDA)
}
