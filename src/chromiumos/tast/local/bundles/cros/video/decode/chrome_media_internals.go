...
func CheckIfURLUsesPlatformVideoDecoder(ctx context.Context, chromeMediaInternalsConn *chrome.Conn, theURL string) (usesPlatformVideoDecoder bool, err error) {
