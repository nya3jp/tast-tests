...
func init() {
	testing.AddTest(&testing.Test{
		...
		Params: []testing.Param{
			// Parameters generated by mem_check_test.go. DO NOT EDIT.
			{
				Name: "av1_hw",
				Val: memCheckParams{
				...
				ExtraAttr:         []string{"group:graphics", "graphics_video", "graphics_nightly"},
				ExtraData:         append(play.MSEDataFiles(), "dash_smpte_av1.mp4.mpd", "dash_smpte_144.av1.mp4", "dash_smpte_240.av1.mp4", launcher.DataArtifact),
				ExtraSoftwareDeps: []string{"amd64", "video_overlays", caps.HWDecodeAV1, "lacros"},
				Fixture:           "chromeVideoWithGuestLoginAndHWAV1DecodingLacros",
			}, {
				Name: "h264_hw_switch",
				...
				ExtraAttr:         []string{"group:graphics", "graphics_video", "graphics_nightly"},
				ExtraData:         append(play.MSEDataFiles(), "cars_dash_mp4.mpd", "cars_144_h264.mp4", "cars_240_h264.mp4", launcher.DataArtifact),
				ExtraSoftwareDeps: []string{"amd64", "video_overlays", caps.HWDecodeH264, "proprietary_codecs", "lacros"},
				Fixture:           "chromeVideoWithGuestLoginLacros",
			},
		},
