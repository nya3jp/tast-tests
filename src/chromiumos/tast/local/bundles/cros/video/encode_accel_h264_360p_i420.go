...
func init() {
	testing.AddTest(&testing.Test{
		...
		Data:         []string{encode.Tulip360PI420.Name},
	})
}

// EncodeAccelH264360PI420 runs video_encode_accelerator_unittest to encode H264 encoding with 360p I420 raw data, tulip2-640x360-094bd827de18ca196a83cc6442b7b02f.yuv.
