Bitstream file name: REPFMT_C_VIDYO_2.hevc
...
The rep_format_idx_present_flag = 0. vps_rep_format_idx[ i ] is inferred to be equal to Min( i, vps_num_rep_formats_minus1 ), where i=layer_id
...
- Rep format Layer id map
    ...
    Layer 1 - Rep format 1
    Layer 2 - Rep format 1
