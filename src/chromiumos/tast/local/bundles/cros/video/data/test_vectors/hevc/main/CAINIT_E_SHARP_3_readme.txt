...
Description :
All slices are coded as I or P slices. Each picture contains only one slice. Each slice contains 4 tiles (2 columns of tiles and 2 rows of tiles with uniform spacing). There is one picture parameter set.
