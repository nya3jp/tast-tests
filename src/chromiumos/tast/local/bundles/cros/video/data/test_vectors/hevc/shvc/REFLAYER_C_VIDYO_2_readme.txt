Bitstream file name: REFLAYER_C_VIDYO_2.hevc
...
In this bitstream, NumDirectRefLayers=2 for Layer 2. Various frames may use either Layer 0 or Layer 1 for sample prediction or for motion prediction.
...
Some important params in the Slice segment header for Layer 2 for each frame are as below:
