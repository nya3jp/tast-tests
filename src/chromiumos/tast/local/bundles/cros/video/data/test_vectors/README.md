...
Recommendations and are protected by copyrights laws. The may be used during
product or service development for the purpose of implementing the
corresponding ITU-T Recommendations.

The directory holds test vectors from [ITU-T H.264.1]. The clips are organized
into subdirectories by profile. I.e. baseline, main, extended, ...
