...
Specification:
entropy_coding_sync_enabled_flag is set to 1. A CTU size of 16x16 is used to encode the sequence. The sequence contains six GOPs, which are all 8 pictures long. The first three GOPs have pictures with the following characteristics:
