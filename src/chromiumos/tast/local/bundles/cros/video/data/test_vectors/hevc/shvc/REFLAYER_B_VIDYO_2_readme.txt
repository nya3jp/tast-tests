Bitstream file name: REFLAYER_B_VIDYO_2.hevc
...
- Layer 1 (i = 1)
    direct_dependency_type[ i ][ j ]: 2, i = 1, j = 0 (inter-layer sample prediction & inter-layer motion prediction)
- Layer 2 (i = 2)
    direct_dependency_type[ i ][ j ]: 0, i = 2, j = 0 (inter-layer sample prediction only)
    direct_dependency_type[ i ][ j ]: 2, i = 2, j = 1 (inter-layer sample prediction & inter-layer motion prediction)
