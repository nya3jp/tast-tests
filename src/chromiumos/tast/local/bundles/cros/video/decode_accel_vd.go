...
func init() {
	testing.AddTest(&testing.Test{
		Func: DecodeAccelVD, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Verifies hardware decode acceleration of media::VideoDecoders by running the video_decode_accelerator_tests binary (see go/vd-migration)",
