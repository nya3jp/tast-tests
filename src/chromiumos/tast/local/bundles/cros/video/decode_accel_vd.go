...
type decodeAccelVdTestParams struct {
	dataPath               string
...
func init() {
	testing.AddTest(&testing.Test{
		...
		Params: []testing.Param{{
			...
			Name:              "hevc_10bit",
			Val:               decodeAccelVdTestParams{dataPath: "test-25fps.hevc10"},
			...
			Name:              "vp8",
			Val:               decodeAccelVdTestParams{dataPath: "test-25fps.vp8"},
			ExtraSoftwareDeps: []string{caps.HWDecodeVP8},
			ExtraData:         []string{"test-25fps.vp8", "test-25fps.vp8.json"},
		}, {
			Name:              "vp9",
			Val:               decodeAccelVdTestParams{dataPath: "test-25fps.vp9"},
			ExtraSoftwareDeps: []string{caps.HWDecodeVP9},
			ExtraData:         []string{"test-25fps.vp9", "test-25fps.vp9.json"},
		}, {
			Name:              "vp9_2",
			Val:               decodeAccelVdTestParams{dataPath: "test-25fps.vp9_2"},
			...
			Val:               decodeAccelVdTestParams{dataPath: "vda_smoke-vp90_2_17_show_existing_frame.vp9"},
			ExtraSoftwareDeps: []string{caps.HWDecodeVP9},
			...
			Val:               decodeAccelVdTestParams{dataPath: "test-25fps_basemain.h264"},
			ExtraSoftwareDeps: []string{caps.HWDecodeH264, "proprietary_codecs"},
			...
			Val:               decodeAccelVdTestParams{dataPath: "keyframe_spatial_layers_180p_360p.vp9.ivf"},
			...
			Val:               decodeAccelVdTestParams{dataPath: "test-25fps.vp8", disableGlobalVaapiLock: true},
			ExtraSoftwareDeps: []string{caps.HWDecodeVP8, "thread_safe_libva_backend"},
			ExtraData:         []string{"test-25fps.vp8", "test-25fps.vp8.json"},
		}, {
			Name:              "vp9_global_vaapi_lock_disabled",
			Val:               decodeAccelVdTestParams{dataPath: "test-25fps.vp9", disableGlobalVaapiLock: true},
...
func DecodeAccelVD(ctx context.Context, s *testing.State) {
	params := s.Param().(decodeAccelVdTestParams)
