...
func EncodeAccelVP8180PI420(ctx context.Context, s *testing.State) {
	encode.RunAllAccelVideoTest(ctx, s, encode.TestOptions{Profile: videotype.VP8Prof, Params: encode.Tulip180P, PixelFormat: videotype.I420, InputMode: encode.SharedMemory})
}
