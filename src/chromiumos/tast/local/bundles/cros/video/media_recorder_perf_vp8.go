...
const mediaRecorderVP8StreamFile = "crowd720_25frames.y4m"
...
func init() {
	testing.AddTest(&testing.Test{
		...
		Data:         []string{mediaRecorderVP8StreamFile, "loopback_media_recorder.html"},
...
func MediaRecorderPerfVP8(ctx context.Context, s *testing.State) {
	...
	if err := mediarecorder.MeasurePerf(ctx, s.DataFileSystem(), s.OutDir(), codec, s.DataPath(mediaRecorderVP8StreamFile), fps); err != nil {
