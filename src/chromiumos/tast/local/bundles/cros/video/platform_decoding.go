	...
	testing.AddTest(&testing.Test{
		...
		Params: []testing.Param{
			...
			},
			{
				...
				Timeout:           24 * time.Hour,
				ExtraHardwareDeps: hwdep.D(hwdep.MinMemory(4096)),
			...
			},
			{
				...
				Timeout:           24 * time.Hour,
				ExtraHardwareDeps: hwdep.D(hwdep.SkipOnPlatform("grunt", "zork"), hwdep.MinMemory(4096)),
				ExtraSoftwareDeps: []string{"vaapi", "autotest-capability:hw_dec_vp9_2160_60"},
			...
			},
			{
				...
				Timeout:           24 * time.Hour,
				ExtraHardwareDeps: hwdep.D(hwdep.Platform("trogdor"), hwdep.MinMemory(4096)),
