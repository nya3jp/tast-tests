...
func init() {
	...
	testing.AddTest(&testing.Test{
		...
		Params: []testing.Param{
			...
			{
				Name: "vaapi_h264_baseline_always_passes",
				Val: platformDecodingParams{
...
// h264decodeVAAPIargs provides the argumetns to use with the H264 decoing binary exe for vaapi.
func h264decodeVAAPIargs(filename string) []string {
	return []string{
		"--video=" + filename,
		"--md5",
		"--visible",
