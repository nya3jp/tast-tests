...
func av1decodeVAAPIargs(ctx context.Context, filename string) []string {
	vaapiArgs := append(getVAAPIArgs(ctx, filename), "--codec=AV1")
	return vaapiArgs
}
...
func vp9decodeVAAPIargs(ctx context.Context, filename string) []string {
	vaapiArgs := append(getVAAPIArgs(ctx, filename), "--codec=VP9")
	return vaapiArgs
}
...
func vp8decodeVAAPIargs(ctx context.Context, filename string) []string {
	vaapiArgs := append(getVAAPIArgs(ctx, filename), "--codec=VP8")
	return vaapiArgs
}
...
func h264decodeVAAPIargs(ctx context.Context, filename string) []string {
	vaapiArgs := append(getVAAPIArgs(ctx, filename), "--codec=H264")
	return vaapiArgs
}
