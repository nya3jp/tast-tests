...
// shouldStopOnFailure returns whether the to stop at the first failure. Default
// is "True". Call with tast run with --var=stopOnFailure=false to decode all
// test files regardless of test failure status.
func shouldStopOnFailure(s *testing.State) bool {
	if str, ok := s.Var("stopOnFailure"); ok {
