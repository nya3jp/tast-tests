...
func init() {
	...
	testing.AddTest(&testing.Test{
		Func: PlatformDecoding, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Smoke tests for vaapi libva decoding by running the media/gpu/vaapi/test:decode_test binary, for v4l2 decoding by running the drm-tests/v4l2_decode binary",
		Contacts: []string{
