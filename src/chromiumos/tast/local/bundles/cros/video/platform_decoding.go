...
func init() {
	...
	testing.AddTest(&testing.Test{
		...
		Vars:    []string{"video.PlatformDecoding.stopOnFailure", "video.PlatformDecoding.updateExpectations", "video.PlatformDecoding.expectationsFileType", "video.PlatformDecoding.defaultFailureTicket"},
		Params: []testing.Param{
			...
			},
			{
				...
				Val: platformDecodingParams{
					filenames:      []string{"test_vectors/hevc/main/AMP_A_Samsung_7.hevc", "test_vectors/hevc/main/AMP_B_Samsung_7.hevc", "test_vectors/hevc/main/AMP_D_Hisilicon.hevc", "test_vectors/hevc/main/AMP_E_Hisilicon.hevc", "test_vectors/hevc/main/AMP_F_Hisilicon_3.hevc", "test_vectors/hevc/main/AMVP_A_MTK_4.hevc", "test_vectors/hevc/main/AMVP_B_MTK_4.hevc", "test_vectors/hevc/main/AMVP_C_Samsung_7.hevc", "test_vectors/hevc/main/BUMPING_A_ericsson_1.hevc", "test_vectors/hevc/main/CAINIT_A_SHARP_4.hevc", "test_vectors/hevc/main/CAINIT_B_SHARP_4.hevc", "test_vectors/hevc/main/CAINIT_C_SHARP_3.hevc", "test_vectors/hevc/main/CAINIT_D_SHARP_3.hevc", "test_vectors/hevc/main/CAINIT_E_SHARP_3.hevc", "test_vectors/hevc/main/CAINIT_F_SHARP_3.hevc", "test_vectors/hevc/main/CAINIT_G_SHARP_3.hevc", "test_vectors/hevc/main/CAINIT_H_SHARP_3.hevc", "test_vectors/hevc/main/CIP_A_Panasonic_3.hevc", "test_vectors/hevc/main/cip_B_NEC_3.hevc", "test_vectors/hevc/main/CIP_C_Panasonic_2.hevc", "test_vectors/hevc/main/CONFWIN_A_Sony_1.hevc", "test_vectors/hevc/main/DBLK_A_SONY_3.hevc", "test_vectors/hevc/main/DBLK_B_SONY_3.hevc", "test_vectors/hevc/main/DBLK_C_SONY_3.hevc", "test_vectors/hevc/main/DBLK_D_VIXS_2.hevc", "test_vectors/hevc/main/DBLK_E_VIXS_2.hevc", "test_vectors/hevc/main/DBLK_F_VIXS_2.hevc", "test_vectors/hevc/main/DBLK_G_VIXS_2.hevc", "test_vectors/hevc/main/DELTAQP_A_BRCM_4.hevc", "test_vectors/hevc/main/DELTAQP_B_SONY_3.hevc", "test_vectors/hevc/main/DELTAQP_C_SONY_3.hevc", "test_vectors/hevc/main/DSLICE_A_HHI_5.hevc", "test_vectors/hevc/main/DSLICE_B_HHI_5.hevc", "test_vectors/hevc/main/DSLICE_C_HHI_5.hevc", "test_vectors/hevc/main/ENTP_A_Qualcomm_1.hevc", "test_vectors/hevc/main/ENTP_B_Qualcomm_1.hevc", "test_vectors/hevc/main/ENTP_C_Qualcomm_1.hevc", "test_vectors/hevc/main/EXT_A_ericsson_4.hevc", "test_vectors/hevc/main/FILLER_A_Sony_1.hevc", "test_vectors/hevc/main/HRD_A_Fujitsu_3.hevc", "test_vectors/hevc/main/INITQP_A_Sony_1.hevc", "test_vectors/hevc/main/ipcm_A_NEC_3.hevc", "test_vectors/hevc/main/ipcm_B_NEC_3.hevc", "test_vectors/hevc/main/ipcm_C_NEC_3.hevc", "test_vectors/hevc/main/ipcm_D_NEC_3.hevc", "test_vectors/hevc/main/ipcm_E_NEC_2.hevc", "test_vectors/hevc/main/IPRED_A_docomo_2.hevc", "test_vectors/hevc/main/IPRED_C_Mitsubishi_3.hevc", "test_vectors/hevc/main/LS_A_Orange_2.hevc", "test_vectors/hevc/main/LS_B_Orange_4.hevc", "test_vectors/hevc/main/LTRPSPS_A_Qualcomm_1.hevc", "test_vectors/hevc/main/MAXBINS_A_TI_5.hevc", "test_vectors/hevc/main/MAXBINS_B_TI_5.hevc", "test_vectors/hevc/main/MAXBINS_C_TI_5.hevc", "test_vectors/hevc/main/MERGE_A_TI_3.hevc", "test_vectors/hevc/main/MERGE_B_TI_3.hevc", "test_vectors/hevc/main/MERGE_C_TI_3.hevc", "test_vectors/hevc/main/MERGE_D_TI_3.hevc", "test_vectors/hevc/main/MERGE_E_TI_3.hevc", "test_vectors/hevc/main/MERGE_F_MTK_4.hevc", "test_vectors/hevc/main/MERGE_G_HHI_4.hevc", "test_vectors/hevc/main/MVCLIP_A_qualcomm_3.hevc", "test_vectors/hevc/main/MVDL1ZERO_A_docomo_4.hevc", "test_vectors/hevc/main/MVEDGE_A_qualcomm_3.hevc", "test_vectors/hevc/main/NoOutPrior_A_Qualcomm_1.hevc", "test_vectors/hevc/main/NoOutPrior_B_Qualcomm_1.hevc", "test_vectors/hevc/main/NUT_A_ericsson_5.hevc", "test_vectors/hevc/main/OPFLAG_A_Qualcomm_1.hevc", "test_vectors/hevc/main/OPFLAG_B_Qualcomm_1.hevc", "test_vectors/hevc/main/OPFLAG_C_Qualcomm_1.hevc", "test_vectors/hevc/main/PMERGE_A_TI_3.hevc", "test_vectors/hevc/main/PMERGE_B_TI_3.hevc", "test_vectors/hevc/main/PMERGE_C_TI_3.hevc", "test_vectors/hevc/main/PMERGE_D_TI_3.hevc", "test_vectors/hevc/main/PMERGE_E_TI_3.hevc", "test_vectors/hevc/main/POC_A_Bossen_3.hevc", "test_vectors/hevc/main/PPS_A_qualcomm_7.hevc", "test_vectors/hevc/main/PS_B_VIDYO_3.hevc", "test_vectors/hevc/main/RAP_A_docomo_6.hevc", "test_vectors/hevc/main/RAP_B_Bossen_2.hevc", "test_vectors/hevc/main/RPLM_A_qualcomm_4.hevc", "test_vectors/hevc/main/RPLM_B_qualcomm_4.hevc", "test_vectors/hevc/main/RPS_A_docomo_5.hevc", "test_vectors/hevc/main/RPS_B_qualcomm_5.hevc", "test_vectors/hevc/main/RPS_C_ericsson_5.hevc", "test_vectors/hevc/main/RPS_D_ericsson_6.hevc", "test_vectors/hevc/main/RPS_E_qualcomm_5.hevc", "test_vectors/hevc/main/RPS_F_docomo_2.hevc", "test_vectors/hevc/main/RQT_A_HHI_4.hevc", "test_vectors/hevc/main/RQT_B_HHI_4.hevc", "test_vectors/hevc/main/RQT_C_HHI_4.hevc", "test_vectors/hevc/main/RQT_D_HHI_4.hevc", "test_vectors/hevc/main/RQT_E_HHI_4.hevc", "test_vectors/hevc/main/RQT_F_HHI_4.hevc", "test_vectors/hevc/main/RQT_G_HHI_4.hevc", "test_vectors/hevc/main/SAO_A_MediaTek_4.hevc", "test_vectors/hevc/main/SAO_B_MediaTek_5.hevc", "test_vectors/hevc/main/SAO_C_Samsung_5.hevc", "test_vectors/hevc/main/SAODBLK_A_MainConcept_4.hevc", "test_vectors/hevc/main/SAODBLK_B_MainConcept_4.hevc", "test_vectors/hevc/main/SAO_D_Samsung_5.hevc", "test_vectors/hevc/main/SAO_E_Canon_4.hevc", "test_vectors/hevc/main/SAO_F_Canon_3.hevc", "test_vectors/hevc/main/SAO_G_Canon_3.hevc", "test_vectors/hevc/main/SAO_H_Parabola_1.hevc", "test_vectors/hevc/main/SDH_A_Orange_4.hevc", "test_vectors/hevc/main/SLICES_A_Rovi_3.hevc", "test_vectors/hevc/main/SLIST_A_Sony_5.hevc", "test_vectors/hevc/main/SLIST_B_Sony_9.hevc", "test_vectors/hevc/main/SLIST_C_Sony_4.hevc", "test_vectors/hevc/main/SLIST_D_Sony_9.hevc", "test_vectors/hevc/main/SLPPLP_A_VIDYO_2.hevc", "test_vectors/hevc/main/STRUCT_A_Samsung_7.hevc", "test_vectors/hevc/main/STRUCT_B_Samsung_7.hevc", "test_vectors/hevc/main/TILES_A_Cisco_2.hevc", "test_vectors/hevc/main/TILES_B_Cisco_1.hevc", "test_vectors/hevc/main/TMVP_A_MS_3.hevc", "test_vectors/hevc/main/TSCL_A_VIDYO_5.hevc", "test_vectors/hevc/main/TSCL_B_VIDYO_4.hevc", "test_vectors/hevc/main/TSKIP_A_MS_3.hevc", "test_vectors/hevc/main/TUSIZE_A_Samsung_1.hevc", "test_vectors/hevc/main/VPSID_A_VIDYO_2.hevc", "test_vectors/hevc/main/VPSSPSPPS_A_MainConcept_1.hevc", "test_vectors/hevc/main/WP_A_Toshiba_3.hevc", "test_vectors/hevc/main/WP_B_Toshiba_3.hevc", "test_vectors/hevc/main/WPP_A_ericsson_MAIN_2.hevc", "test_vectors/hevc/main/WPP_B_ericsson_MAIN_2.hevc", "test_vectors/hevc/main/WPP_C_ericsson_MAIN_2.hevc", "test_vectors/hevc/main/WPP_D_ericsson_MAIN_2.hevc", "test_vectors/hevc/main/WPP_E_ericsson_MAIN_2.hevc", "test_vectors/hevc/main/WPP_F_ericsson_MAIN_2.hevc", "test_vectors/hevc/main_still_picture/IPRED_B_Nokia_3.hevc"},
					decoder:        "/usr/local/libexec/chrome-binary-tests/decode_test",
...
// shouldUpdateExpectations loads tast variables for controlling test
// expectations updating.
//
// Using variables to updating an expectation file will only modify the
// expectation file on the device under test. The updated file would still need
// to be copied back to the graphics package and checked into git.
//
// To update test expectations file, run tast with
// --var=video.PlatformDecoding.updateExpectations=true
//
// When updating test expectations the existing file type is used, be it model,
// board, or platform-based. For platforms where no test expectation file
// exists, the new file will default to be platform-based. To override the
// default type with a specific expectations file type, run tast with
// --var=video.PlatformDecoding.expectationsFileType=model|build|board|platform
//
// When updating test expectations files, the YAML entry will not include a
// ticket. To specify a ticket for new failing test cases, run tast with
// --var=video.PlatformDecoding.defaultFailureTicket="b/1234567"
func shouldUpdateExpectations(s *testing.State, defaultFileType expectations.FileType) (bool, expectations.FileType, string) {
	str, ok := s.Var("video.PlatformDecoding.updateExpectations")
	if !ok {
		return false, expectations.NoFile, ""
	}
	b, err := strconv.ParseBool(str)
	if err != nil {
		s.Fatalf("Cannot parse argument %q to updateExpectations: %v", str, err)
	}

	var expectationFileType expectations.FileType = defaultFileType
	if expectationFileType == expectations.NoFile {
		expectationFileType = expectations.PlatformFile
	}
	str, ok = s.Var("video.PlatformDecoding.expectationsFileType")
	if ok {
		expectationFileType = expectations.FileType(str)
	}

	ticket, ok := s.Var("video.PlatformDecoding.defaultFailureTicket")
	if !ok {
		ticket = ""
	}
	return b, expectationFileType, ticket
}

// platformDecodingExpectations contains a map from the decoder binary name to
// a map of the file path to an expectation.Expectation structure. A test case
// will use this type to test to see if there is an expectation that modifies
// the default test behavior. This is filled by loadExpectations.
type platformDecodingExpectations map[string]map[string]expectations.Expectation

// loadExpectations loads the platformDecodingExpectations structure relevant
// for the device under test. The YAML structure looks like:
// [decoder_file_name]:
//   [test_vector_path]:
//     expectation: [PASS|FAILURE|SKIP]
//     ticket: [b/12345 or crbug/12345]
//
// See expectations/README.md for details about expectation files.
func loadExpectations(ctx context.Context, s *testing.State) (platformDecodingExpectations, expectations.FileType) {
	expectationsFileContents := make(platformDecodingExpectations)
	rawContents, fileType, err := expectations.ReadTestExpectations(ctx, s)
	if err == nil {
		err = yaml.Unmarshal(rawContents, expectationsFileContents)
		if err != nil {
			s.Fatal("Failed to parse expectations file: ", err)
		}
	}
	return expectationsFileContents, fileType
}
...
func PlatformDecoding(ctx context.Context, s *testing.State) {
	...
	expectationsFileContents, expectationsFileType := loadExpectations(ctx, s)
	testExpectations := expectationsFileContents[filepath.Base(testOpt.decoder)]

	updateExpectations, expectationsFileType, ticket := shouldUpdateExpectations(s, expectationsFileType)
	var needExpectationsUpdate = false
	...
	for _, filename := range testOpt.filenames {
		expectation, ok := testExpectations[filename]
		if !ok {
			expectation = expectations.Expectation{expectations.ExpectPass, ""}
		}

		if expectation.Expectation == expectations.ExpectSkip {
			testing.ContextLogf(ctx, "Skipping %s due to test expectations file", filename)
			continue
		}

		expectError := expectation.Expectation == expectations.ExpectFailure
		if expectError {
			testing.ContextLog(ctx, "Expecting validation failure due to test expectations file")
		}
		...
		if hadError != expectError {
			if updateExpectations {
				needExpectationsUpdate = true
				if hadError {
					testing.ContextLogf(ctx, "Adding failure expecation for %s", filename)
					if testExpectations == nil {
						// make testExpectations and insert it into expectations
						testExpectations = make(map[string]expectations.Expectation)
						expectationsFileContents[filepath.Base(testOpt.decoder)] = testExpectations
					}
					testExpectations[filename] = expectations.Expectation{Expectation: expectations.ExpectFailure, Ticket: ticket}
				} else {
					testing.ContextLogf(ctx, "Removing unnecessary expecation for %s", filename)
					delete(testExpectations, filename)
				}
			} else {
				output := append(stdout, stderr...)
				testing.ContextLogf(ctx, "%v %s unexpectedly: %s", exec, testBehavior, string(output))
				errorMessage := fmt.Sprintf("%v %s unexpectedly on %s: ", exec, testBehavior, filename)
				if stopOnFailure {
	...
	if needExpectationsUpdate {
		filename, err := expectations.GenerateTestExpectationsFilenameFromTestName(ctx, s.TestName(), expectationsFileType)
		if err != nil {
			s.Fatal("Failed while writing test expectations file: ", err)
		}

		expectationsFileDirectory := filepath.Dir(filename)
		if _, err := os.Stat(expectationsFileDirectory); os.IsNotExist(err) {
			if err := os.MkdirAll(expectationsFileDirectory, os.ModePerm); err != nil {
				s.Fatal("Failed to create test expectations directory")
			}
		}

		yamlBytes, err := yaml.Marshal(expectationsFileContents)
		if err != nil {
			s.Fatal("Failed to serialize test expectations file: ", err)
		}

		if err = ioutil.WriteFile(filename, yamlBytes, 0600); err != nil {
			s.Fatal("Failed to write test expectations file: ", err)
		}

		testing.ContextLogf(ctx, "Wrote test expectations file %s", filename)
	}
}
