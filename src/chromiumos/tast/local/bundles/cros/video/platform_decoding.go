...
func init() {
	...
	testing.AddTest(&testing.Test{
		...
		Params: []testing.Param{
			...
			{
				Name: "vaapi_av1_group2",
				Val: platformDecodingParams{
					filenames:      []string{"test_vectors/av1/8-bit/48_delayed.ivf", "test_vectors/av1/8-bit/frames_refs_short_signaling.ivf"},
					decoder:        "/usr/local/libexec/chrome-binary-tests/decode_test",
					commandBuilder: av1decodeVAAPIargs,
				},
				ExtraSoftwareDeps: []string{"vaapi", "autotest-capability:hw_dec_av1_1080_30"},
				ExtraData:         []string{"test_vectors/av1/8-bit/48_delayed.ivf", "test_vectors/av1/8-bit/48_delayed.ivf.json", "test_vectors/av1/8-bit/frames_refs_short_signaling.ivf", "test_vectors/av1/8-bit/frames_refs_short_signaling.ivf.json"},
			},
			{
				Name: "vaapi_av1_group3",
				Val: platformDecodingParams{
					filenames:      []string{"test_vectors/av1/8-bit/test-25fps-192x288-only-tile-cols-is-power-of-2.ivf", "test_vectors/av1/8-bit/test-25fps-192x288-only-tile-rows-is-power-of-2.ivf", "test_vectors/av1/8-bit/test-25fps-192x288-tile-rows-3-tile-cols-3.ivf"},
					decoder:        "/usr/local/libexec/chrome-binary-tests/decode_test",
					commandBuilder: av1decodeVAAPIargs,
				},
				ExtraSoftwareDeps: []string{"vaapi", "autotest-capability:hw_dec_av1_1080_30"},
				ExtraData:         []string{"test_vectors/av1/8-bit/test-25fps-192x288-only-tile-cols-is-power-of-2.ivf", "test_vectors/av1/8-bit/test-25fps-192x288-only-tile-cols-is-power-of-2.ivf.json", "test_vectors/av1/8-bit/test-25fps-192x288-only-tile-rows-is-power-of-2.ivf", "test_vectors/av1/8-bit/test-25fps-192x288-only-tile-rows-is-power-of-2.ivf.json", "test_vectors/av1/8-bit/test-25fps-192x288-tile-rows-3-tile-cols-3.ivf", "test_vectors/av1/8-bit/test-25fps-192x288-tile-rows-3-tile-cols-3.ivf.json"},
			},
			{
				Name: "v4l2_vp9",
				Val: platformDecodingParams{
