...
func EncodeAccelH264NV12(ctx context.Context, s *testing.State) {
	encode.RunAllAccelVideoTest(ctx, s, encode.TestOptions{Profile: videotype.H264Prof, Params: encode.Bear192P, PixelFormat: videotype.NV12, InputMode: encode.SharedMemory})
}
