...
func init() {
	testing.AddTest(&testing.Test{
		...
		Data:         []string{"arc_video_test.apk", "1080p_30fps_300frames.vp9.webm"},
		Pre:          arc.Booted(),
	})
}
...
func ARCPlaybackPerfVP91080P30FPS(ctx context.Context, s *testing.State) {
	arcplayback.RunTest(ctx, s, s.PreValue().(arc.PreData).ARC, "1080p_30fps_300frames.vp9.webm", "vp9_1080p_30fps")
}
