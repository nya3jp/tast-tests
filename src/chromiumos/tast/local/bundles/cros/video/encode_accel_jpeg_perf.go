...
func parseJPEGEncodeLog(testLogPath string, outputDir string, testFileName string) error {
	...
	if err := scanner.Err(); err != nil {
		return errors.Wrap(err, "scanning test log failed")
	}
