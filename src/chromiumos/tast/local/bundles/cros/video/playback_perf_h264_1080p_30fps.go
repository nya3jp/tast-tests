...
func init() {
	testing.AddTest(&testing.Test{
		...
		Data:         []string{"1080p_30fps_300frames.h264.mp4", decode.ChromeMediaInternalsUtilsJSFile},
...
func PlaybackPerfH2641080P30FPS(ctx context.Context, s *testing.State) {
	playback.RunTest(ctx, s, "1080p_30fps_300frames.h264.mp4", playback.DefaultPerfDisabled, playback.VDA)
}
