...
`hw_dec_vp9_*` (the "minus" symbol is misleading: it does not mean "disable").
Tast ingests these capabilities file(s) and provides them for tests with the
name correspondence defined in the mentioned [`caps` package]. Any test (case)
with a `caps.HWDecodeVP8` listed in its `SoftwareDeps`, for example
[`Play.vp8_hw`], will thus run on Skylake devices, whereas those with
`caps.HWDecodeVP9` listed will not, for example [`Play.vp9_hw`].
...
Chrome's video decode stack performance. Various metrics are collected such as
...
[`video_decode_accelerator_tests`]: https://chromium.googlesource.com/chromium/src/+/master/docs/media/gpu/video_decoder_test_usage.md
[`video_decode_accelerator_perf_tests`]: https://chromium.googlesource.com/chromium/src/+/master/docs/media/gpu/video_decoder_perf_test_usage.md
[`video_encode_accelerator_unittest`]: https://chromium.googlesource.com/chromium/src/+/master/docs/media/gpu/veatest_usage.md
[`video_encode_accelerator_tests`]: https://chromium.googlesource.com/chromium/src/+/master/docs/media/gpu/video_encoder_test_usage.md
[Software Dependencies]: https://chromium.googlesource.com/chromiumos/platform/tast/+/HEAD/docs/test_dependencies.md
[15-chipset-skl-capabilities.yaml]: https://source.chromium.org/chromiumos/chromiumos/codesearch/+/master:src/overlays/chipset-skl/chromeos-base/autotest-capability-chipset-skl/files/15-chipset-skl-capabilities.yaml
...
[`autotest-capability-default`]: https://chromium.googlesource.com/chromiumos/overlays/chromiumos-overlay/+/master/chromeos-base/autotest-capability-default/
...
[`Play.vp9_hw`]: https://source.chromium.org/chromiumos/chromiumos/codesearch/+/master:src/platform/tast-tests/src/chromiumos/tast/local/bundles/cros/video/play.go;l=124
[`Play.vp8_hw`]: https://source.chromium.org/chromiumos/chromiumos/codesearch/+/master:src/platform/tast-tests/src/chromiumos/tast/local/bundles/cros/video/play.go;l=117
