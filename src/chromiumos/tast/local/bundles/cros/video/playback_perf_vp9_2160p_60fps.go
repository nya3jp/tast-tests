...
func init() {
	testing.AddTest(&testing.Test{
		...
		Data:         []string{"2160p_60fps_600frames.vp9.webm", decode.ChromeMediaInternalsUtilsJSFile},
...
func PlaybackPerfVP92160P60FPS(ctx context.Context, s *testing.State) {
	playback.RunTest(ctx, s, "2160p_60fps_600frames.vp9.webm", "vp9_2160p_60fps", playback.DefaultPerfDisabled, playback.VDA)
}
