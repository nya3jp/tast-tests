...
func init() {
	testing.AddTest(&testing.Test{
		...
		Desc:         "Measure video playback performance with/without HW acceleration for VP9 2160p@60fps video",
...
func PlaybackPerfVP92160P60FPS(ctx context.Context, s *testing.State) {
	playback.RunTest(ctx, s, "2160p_60fps_600frames.vp9.webm", "vp9_2160p_60fps")
}
