...
// regExpKeyFramesVP8 is the regexp to find the amount of key frames in a VP8
...
// regExpKeyFramesVP9 is the regexp to find the amount of key frames in a VP9
// bitstream: Key Frames are marked by having a 0x49, 0x83 0x42 sequence, see VP9
// Bitstream superframe and uncompressed header DRAFT Rev 1.0, 2015.12.08 ,
// Sec. 4.1 "Syntax".
var regExpKeyFramesVP9 = regexp.MustCompile(`9d 01 2a`)

// regExpKeyFramesH264 is the regexp to find the amount of key frames in an
// H.264 bitstream. All frames (NALs in the lingo) start with 0x0000001; key
...
// keyFrameCountFn is the function type to count the amount of keyframes in file.
type keyFrameCountFn func(ctx context.Context, file string) (count int, err error)
...
type testParam struct {
	...
	regExpKeyFrames *regexp.Regexp   // Regexp to count the amount of key frames.
}
...
// countHexHits counts the amount of time r is found in a hexdump of file.
