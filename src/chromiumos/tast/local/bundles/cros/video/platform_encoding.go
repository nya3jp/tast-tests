...
func vp8argsVAAPI(ctx context.Context, exe, yuvFile string, size coords.Size, fps int) (command []string, ivfFile string, bitrate int, err error) {
...
func vp9argsVAAPI(ctx context.Context, exe, yuvFile string, size coords.Size, fps int) (command []string, ivfFile string, bitrate int, err error) {
	command = append(command, exe, strconv.Itoa(size.Width), strconv.Itoa(size.Height), yuvFile)
...
func h264argsVAAPI(ctx context.Context, exe, yuvFile string, size coords.Size, fps int) (command []string, h264File string, bitrate int, err error) {
...
func vp8argsVpxenc(ctx context.Context, exe, yuvFile string, size coords.Size, fps int) (command []string, ivfFile string, bitrate int, err error) {
	command = append(command, exe, "-w", strconv.Itoa(size.Width), "-h", strconv.Itoa(size.Height))
