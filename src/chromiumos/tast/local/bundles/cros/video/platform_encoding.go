...
type commandBuilderFn func(ctx context.Context, exe, yuvFile string, size coords.Size, fps int) (command []string, ivfFile string, bitrate int)
...
func PlatformEncoding(ctx context.Context, s *testing.State) {
	...
	command, encodedFile, targetBitrate := testOpt.commandBuilder(ctx, testOpt.command, yuvFile, testOpt.size, int(testOpt.fps))
...
func vp8argsVAAPI(ctx context.Context, exe, yuvFile string, size coords.Size, fps int) (command []string, ivfFile string, bitrate int) {
...
func vp9argsVAAPI(ctx context.Context, exe, yuvFile string, size coords.Size, fps int) (command []string, ivfFile string, bitrate int) {
	command = append(command, exe, strconv.Itoa(size.Width), strconv.Itoa(size.Height), yuvFile)
...
func h264argsVAAPI(ctx context.Context, exe, yuvFile string, size coords.Size, fps int) (command []string, h264File string, bitrate int) {
...
func vp8argsVpxenc(ctx context.Context, exe, yuvFile string, size coords.Size, fps int) (command []string, ivfFile string, bitrate int) {
	command = append(command, exe, "-w", strconv.Itoa(size.Width), "-h", strconv.Itoa(size.Height))
...
func h264argsV4L2(ctx context.Context, exe, yuvFile string, size coords.Size, fps int) (command []string, h264File string, bitrate int) {
	...
	// Query the driver for its preferred input (OUTPUT_queue) video frame format.
	// If v4l2-ctl fails for some reason, we leave it unspecified.
