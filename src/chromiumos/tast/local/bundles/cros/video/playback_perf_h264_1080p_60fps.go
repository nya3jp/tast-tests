...
func init() {
	testing.AddTest(&testing.Test{
		...
		Desc: "Measure video playback performance with/without HW acceleration for H264 1080p@60fps video",
...
func PlaybackPerfH2641080P60FPS(ctx context.Context, s *testing.State) {
	playback.RunTest(ctx, s, "1080p_60fps_600frames.h264.mp4", "h264_1080p_60fps")
}
