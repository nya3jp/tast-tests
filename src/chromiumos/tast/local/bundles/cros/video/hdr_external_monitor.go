		...
		Params: []testing.Param{
			{
				...
				ExtraData: []string{"chromium_trace_all_simple_categories.pbtxt", "video.html", "peru.8k.cut.hdr.vp9.webm"},
				Fixture:   "chromeVideo",
			},
			{
...
func HdrExternalMonitor(ctx context.Context, s *testing.State) {
	...
	traceConfigPath := s.DataPath("system_trace_cfg.pbtxt")
	...
	testOpt := s.Param().(multiMonParams)
