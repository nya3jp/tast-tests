...
func init() {
	testing.AddTest(&testing.Test{
		...
		Params: []testing.Param{{
			...
			Val:               videoDecodeAccelPerfTestParam{dataPath: "perf/h264/1080p_30fps_300frames.h264"},
			...
			Val:               videoDecodeAccelPerfTestParam{dataPath: "perf/h264/1080p_60fps_600frames.h264"},
			...
			Val:               videoDecodeAccelPerfTestParam{dataPath: "perf/h264/1080p_60fps_600frames.h264", disableGlobalVaapiLock: true},
			ExtraSoftwareDeps: []string{caps.HWDecodeH264_60, "proprietary_codecs", "thread_safe_libva_backend"},
			ExtraData:         []string{"perf/h264/1080p_60fps_600frames.h264", "perf/h264/1080p_60fps_600frames.h264.json"},
		}, {
			Name:              "h264_2160p_30fps",
			Val:               videoDecodeAccelPerfTestParam{dataPath: "perf/h264/2160p_30fps_300frames.h264"},
			...
			Val:               videoDecodeAccelPerfTestParam{dataPath: "perf/h264/2160p_60fps_600frames.h264"},
			...
			Val:               videoDecodeAccelPerfTestParam{dataPath: "perf/vp8/1080p_30fps_300frames.vp8.ivf"},
			...
			Val:               videoDecodeAccelPerfTestParam{dataPath: "perf/vp8/1080p_60fps_600frames.vp8.ivf"},
			...
			Val:               videoDecodeAccelPerfTestParam{dataPath: "perf/vp8/1080p_60fps_600frames.vp8.ivf", disableGlobalVaapiLock: true},
			ExtraSoftwareDeps: []string{caps.HWDecodeVP8_60, "thread_safe_libva_backend"},
			ExtraData:         []string{"perf/vp8/1080p_60fps_600frames.vp8.ivf", "perf/vp8/1080p_60fps_600frames.vp8.ivf.json"},
		}, {
			Name:              "vp8_2160p_30fps",
			Val:               videoDecodeAccelPerfTestParam{dataPath: "perf/vp8/2160p_30fps_300frames.vp8.ivf"},
			...
			Val:               videoDecodeAccelPerfTestParam{dataPath: "perf/vp8/2160p_60fps_600frames.vp8.ivf"},
			...
			Val:               videoDecodeAccelPerfTestParam{dataPath: "perf/vp9/1080p_30fps_300frames.vp9.ivf"},
			...
			Val:               videoDecodeAccelPerfTestParam{dataPath: "perf/vp9/1080p_60fps_600frames.vp9.ivf"},
			...
			Val:               videoDecodeAccelPerfTestParam{dataPath: "perf/vp9/1080p_60fps_600frames.vp9.ivf", disableGlobalVaapiLock: true},
			ExtraSoftwareDeps: []string{caps.HWDecodeVP9_60, "thread_safe_libva_backend"},
			ExtraData:         []string{"perf/vp9/1080p_60fps_600frames.vp9.ivf", "perf/vp9/1080p_60fps_600frames.vp9.ivf.json"},
		}, {
			Name:              "vp9_2160p_30fps",
			Val:               videoDecodeAccelPerfTestParam{dataPath: "perf/vp9/2160p_30fps_300frames.vp9.ivf"},
			...
			Val:               videoDecodeAccelPerfTestParam{dataPath: "perf/vp9/2160p_60fps_600frames.vp9.ivf"},
...
func DecodeAccelPerf(ctx context.Context, s *testing.State) {
	...
	if err := decoding.RunAccelVideoPerfTest(ctx, s.OutDir(), s.DataPath(param.dataPath), decoding.TestParams{DecoderType: decoding.VDA, DisableGlobalVaapiLock: param.disableGlobalVaapiLock, TestCases: decoding.CappedFlag | decoding.UncappedFlag}); err != nil {
