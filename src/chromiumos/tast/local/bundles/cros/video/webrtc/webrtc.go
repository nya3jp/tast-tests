...
// TODO(CL:1249401): Codec should be moved to /video/lib/constants.go.
type Codec string
...
// WebRTCCameraResults is a type for decoding JSON objects obtained from /video/data/getusermedia.html.
...
// p is a pointer for perf.Values where data will be stored.
func (r *WebRTCCameraResults) SetPerf(p *perf.Values) {
...
func RunWebRTCCamera(ctx context.Context, s *testing.State, duration time.Duration) WebRTCCameraResults {
...
// WebRTCPeerConnectionWithCameraResult is a struct for decoding JSON objects obtained from /video/data/loopback.html.
...
// SetPerf records performance data of WebRTCPeerConnectionWithCameraResult into p.
// codec is a video codec exercised in testing.
func (r *WebRTCPeerConnectionWithCameraResult) SetPerf(p *perf.Values, codec Codec) {
...
func RunWebRTCPeerConnectionWithCamera(
	ctx context.Context, s *testing.State, codec Codec, duration time.Duration) WebRTCPeerConnectionWithCameraResult {
