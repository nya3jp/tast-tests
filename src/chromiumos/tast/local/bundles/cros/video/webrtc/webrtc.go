...
func (r *WebRTCPeerConnectionWithCameraResult) SetPerf(p *perf.Values, codec constants.Codec) {
...
func RunWebRTCPeerConnectionWithCamera(
	ctx context.Context, s *testing.State, codec constants.Codec, duration time.Duration) WebRTCPeerConnectionWithCameraResult {
