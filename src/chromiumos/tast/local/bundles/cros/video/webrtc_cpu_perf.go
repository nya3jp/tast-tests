...
// WebRTCCPUPerf opens a WebRTC loopback page that loops a given capture stream
// to measure CPU usage.
func WebRTCCPUPerf(ctx context.Context, s *testing.State) {
	webrtc.RunWebRTCCPUPerf(ctx, s, "crowd720_25frames.y4m")
}
