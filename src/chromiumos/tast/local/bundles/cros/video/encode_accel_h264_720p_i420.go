...
func EncodeAccelH264720PI420(ctx context.Context, s *testing.State) {
	encode.RunAllAccelVideoTest(ctx, s, encode.TestOptions{Profile: videotype.H264Prof, Params: encode.Tulip720P, PixelFormat: videotype.I420, InputMode: encode.SharedMemory})
}
