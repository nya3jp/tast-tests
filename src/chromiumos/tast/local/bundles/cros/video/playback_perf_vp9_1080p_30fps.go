...
func init() {
	testing.AddTest(&testing.Test{
		...
		Data:         []string{"1080p_30fps_300frames.vp9.webm", decode.ChromeMediaInternalsUtilsJSFile},
...
func PlaybackPerfVP91080P30FPS(ctx context.Context, s *testing.State) {
	playback.RunTest(ctx, s, "1080p_30fps_300frames.vp9.webm", "vp9_1080p_30fps", playback.DefaultPerfEnabled, playback.VDA)
}
