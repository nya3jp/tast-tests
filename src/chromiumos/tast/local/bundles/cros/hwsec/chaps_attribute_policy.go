...
func ChapsAttributePolicy(ctx context.Context, s *testing.State) {
	...
	pkcs11.Pkcs11ClearObjectOfAllType(ctx, 0, "999999")
	pkcs11.Pkcs11ClearObjectOfAllType(ctx, 0, "888888")

	// Create the software key
	softwareKey, err := pkcs11.Pkcs11CreateRsaSoftwareKey(ctx, utility, "", "testkey1", "999999")
	if err != nil {
