...
// signAndMeasure will sign the content pointed by tmpFile1 with mechanism mechanism and write the signature into tmpFile2 for times times. It'll return the total duration and if an error occurred.
