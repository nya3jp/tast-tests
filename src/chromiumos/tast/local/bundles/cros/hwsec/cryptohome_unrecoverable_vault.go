...
const (
	...
	// This file is in the directory that stores the authentication materials, so it verifies that
	// those authentication materials are indeed removed.
	keysetTestFile1 = "/home/.shadow/%s/test1234.bin"
	// keysetTestFile2 is the same as above.
	// This file is in the actual user's home directory, so it verifies that the home directory mounted
	// is indeed new.
