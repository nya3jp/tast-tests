...
import (
	...
	"chromiumos/tast/local/tpm"
	"chromiumos/tast/testing"
)

func init() {
	testing.AddTest(&testing.Test{
		Func: CryptohomeTpmLiveTest,
...
func CryptohomeTpmLiveTest(ctx context.Context, s *testing.State) {
	if err := tpm.ResetTpmAndSystemStates(ctx); err != nil {
