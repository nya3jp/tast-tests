...
func ChallengeResponseAuthSession(ctx context.Context, s *testing.State) {
	...
	defer cryptohome.CreateUserAuthSessionWithChallengeCredential(ctxForCleanUp, testUser, hwsec.NewChallengeAuthConfig(testUser, dbusName, keyDelegate.DBusPath, pubKeySPKIDER, keyAlg))
