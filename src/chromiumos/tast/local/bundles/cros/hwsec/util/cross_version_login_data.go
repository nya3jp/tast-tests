...
func createPasswordData(ctx context.Context, cryptohome *hwsec.CryptohomeClient) (*CrossVersionLoginConfig, error) {
	const (
		keyLabel   = "legacy-0"
		extraPass  = "extraPass"
...
func PrepareCrossVersionLoginData(ctx context.Context, lf LogFunc, cryptohome *hwsec.CryptohomeClient, daemonController *hwsec.DaemonController, dataPath, configPath string) (retErr error) {
	...
	config, err := createPasswordData(ctx, cryptohome)
	if err != nil {
