...
func createKeysForTestingForUser(ctx context.Context, username string, pkcs11Util *pkcs11.Chaps, scratchpadPath string, keyType int) (keys []*pkcs11.KeyInfo, retErr error) {
	defer func() {
		if retErr != nil {
...
func CreateKeysForTesting(ctx context.Context, r hwsec.CmdRunner, pkcs11Util *pkcs11.Chaps, cryptohomeUtil *hwsec.UtilityCryptohomeBinary, scratchpadPath string, keyType int) (keys []*pkcs11.KeyInfo, retErr error) {
