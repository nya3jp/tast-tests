...
func Pkcs11InitUnderErrors(ctx context.Context, s *testing.State) {
	...
	userDbPath := userChapsPath + "/database"
	...
	// Delibrately corrupt the files in the chaps database direcotry. Chaps should detect the error, regenerate the database, and carry on the test.
