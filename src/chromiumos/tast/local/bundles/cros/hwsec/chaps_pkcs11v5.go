...
func ChapsPKCS11V5(ctx context.Context, s *testing.State) {
	...
	if err = libhwsec.Pkcs11SignVerify(ctx, r, softwareKey, testfile1, testfile2, libhwsec.Pkcs11SHA1RSAPKCS()); err != nil {
		s.Fatal("SignVerify failed: ", err)
	}

	if err = libhwsec.Pkcs11SignVerify(ctx, r, softwareKey, testfile1, testfile2, libhwsec.Pkcs11SHA256RSAPKCS()); err != nil {
		s.Fatal("SignVerify failed: ", err)
	}
