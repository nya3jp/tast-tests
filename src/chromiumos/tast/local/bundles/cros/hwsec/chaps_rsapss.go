...
func ChapsRSAPSS(ctx context.Context, s *testing.State) {
	...
	if err = libhwsec.Pkcs11SignVerify(ctx, helper, softwareKey, testfile1, testfile2, libhwsec.Pkcs11SHA1RSAPKCSPSS()); err != nil {
		s.Fatal("SignVerify failed: ", err)
	}
	if err = libhwsec.Pkcs11SignVerify(ctx, helper, softwareKey, testfile1, testfile2, libhwsec.Pkcs11SHA256RSAPKCSPSS()); err != nil {
		s.Fatal("SignVerify failed: ", err)
	}
	if err = libhwsec.Pkcs11SignVerify(ctx, helper, softwareKey, testfile1, testfile2, libhwsec.Pkcs11SHA1RSAPKCSPSSGeneric()); err != nil {
		s.Fatal("SignVerify failed: ", err)
	}
	if err = libhwsec.Pkcs11SignVerify(ctx, helper, softwareKey, testfile1, testfile2, libhwsec.Pkcs11SHA256RSAPKCSPSSGeneric()); err != nil {
		s.Fatal("SignVerify failed: ", err)
	}
	...
	if err = libhwsec.Pkcs11SignVerify(ctx, helper, generatedKey, testfile1, testfile2, libhwsec.Pkcs11SHA1RSAPKCSPSSGeneric()); err != nil {
		s.Fatal("SignVerify failed: ", err)
	}
	if err = libhwsec.Pkcs11SignVerify(ctx, helper, generatedKey, testfile1, testfile2, libhwsec.Pkcs11SHA256RSAPKCSPSSGeneric()); err != nil {
		s.Fatal("SignVerify failed: ", err)
	}
}
