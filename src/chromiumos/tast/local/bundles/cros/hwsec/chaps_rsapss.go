...
func ChapsRSAPSS(ctx context.Context, s *testing.State) {
	...
	for _, k := range keys {
		...
		for _, m := range []pkcs11.MechanismInfo{pkcs11Util.MechanismSha1RsaPkcsPSS(), pkcs11Util.MechanismSha256RsaPkcsPSS(), pkcs11Util.MechanismSha1RsaPkcsPSSGeneric(), pkcs11Util.MechanismSha256RsaPkcsPSSGeneric()} {
