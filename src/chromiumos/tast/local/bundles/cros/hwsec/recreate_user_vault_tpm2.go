...
// NOTE: This test is largely similar to hwsec.RecreateUserVaultTPM1 (a remote test), if change is made to one, it is likely that the other have to be changed as well.
