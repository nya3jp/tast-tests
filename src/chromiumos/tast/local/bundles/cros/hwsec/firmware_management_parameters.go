...
func checkFWMPCleared(ctx context.Context, utility *hwsec.UtilityCryptohomeClient) error {
...
func clearFWMPAndCheck(ctx context.Context, utility *hwsec.UtilityCryptohomeClient) error {
...
func checkFWMPSet(ctx context.Context, utility *hwsec.UtilityCryptohomeClient, expectedFlags, expectedHash string) error {
...
func setFWMPAndCheck(ctx context.Context, utility *hwsec.UtilityCryptohomeClient, flags, hash string) error {
