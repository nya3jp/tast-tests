...
func init() {
	testing.AddTest(&testing.Test{
		...
		Params: []testing.Param{{
			...
			Val: []string{
				"cross_version_login/data_betty_R94-14150.50.0.tar.xz",
				"cross_version_login/data_betty_R94-14150.0.0.tar.xz",
				"cross_version_login/data_betty_R93-14092.50.0.tar.xz",
				"cross_version_login/data_betty_R93-14092.100.0.tar.xz",
				"cross_version_login/data_betty_R93-14092.0.0.tar.xz",
        "cross_version_login/data_betty_R92-13982.0.0.tar.xz",
				"cross_version_login/data_betty_R91-13904.97.0.tar.xz",
				"cross_version_login/data_betty_R91-13904.83.0.tar.xz",
				"cross_version_login/data_betty_R91-13904.77.0.tar.xz",
				"cross_version_login/data_betty_R91-13904.0.0.tar.xz",
			},
			ExtraData: []string{
				"cross_version_login/data_betty_R94-14150.50.0.tar.xz",
				"cross_version_login/data_betty_R94-14150.0.0.tar.xz",
...
func CrossVersionLogin(ctx context.Context, s *testing.State) {
	...
	for _, fn := range fileNames {
		...
		s.Log("Testing login with: ", filePath)
