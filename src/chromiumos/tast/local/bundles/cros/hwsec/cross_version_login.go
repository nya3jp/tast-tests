...
func init() {
	testing.AddTest(&testing.Test{
		...
		Params: []testing.Param{{
			...
			Val: []string{
				"R90-13816.106.0-custombuild20220712_betty_20220712",
				"R91-13904.0.0_betty_20220712",
				"R92-13982.0.0_betty_20220712",
				"R93-14092.0.0_betty_20220712",
			...
			ExtraData: []string{
				...
				"cross_version_login/R90-13816.106.0-custombuild20220712_betty_20220712_config.json",
				"cross_version_login/R90-13816.106.0-custombuild20220712_betty_20220712_data.tar.gz",
				"cross_version_login/R91-13904.0.0_betty_20220712_config.json",
				"cross_version_login/R91-13904.0.0_betty_20220712_data.tar.gz",
				"cross_version_login/R92-13982.0.0_betty_20220712_config.json",
				"cross_version_login/R92-13982.0.0_betty_20220712_data.tar.gz",
				"cross_version_login/R93-14092.0.0_betty_20220712_config.json",
				"cross_version_login/R93-14092.0.0_betty_20220712_data.tar.gz",
...
func testConfig(ctx context.Context, lf util.LogFunc, cryptohome *hwsec.CryptohomeClient, config *util.CrossVersionLoginConfig) error {
	// Exercise the regular login flow as driven by Chrome Login Screen, to catch any regressions in APIs between Cryptohomed and Chrome.
	// This part of the test is only possible when the snapshot contains mountable user data and not just keysets
	// (see cross_version_login_data.go for details).
	if config.HasUserVault {
...
func testConfigViaChrome(ctx context.Context, config *util.CrossVersionLoginConfig) error {
	...
	// The smart card authentication is not currently supported in this subtest, as it'd require loading
	// fake smart card middleware extensions in Chrome.
	...
	// TODO(b/237120336): Check cryptohome was not recreated, by reading some file that was previously put into the snapshot.
...
// testConfigViaCryptohome verifies the login functionality by making requests via Cryptohome CLI.
