...
func init() {
	testing.AddTest(&testing.Test{
		...
		Params: []testing.Param{{
			...
			Val: []string{
				"R90-13816.106.0_betty_20220702",
			...
			ExtraData: []string{
				...
				"cross_version_login/R90-13816.106.0_betty_20220702_config.json",
				"cross_version_login/R90-13816.106.0_betty_20220702_data.tar.gz",
