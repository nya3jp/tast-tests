...
// is tied to the TPM.
func loginTakeOwnershipAndCheckKeysetTiedToTPM(ctx context.Context, s *testing.State, utility *hwsec.UtilityCryptohomeClient, helper *hwseclocal.HelperLocal, reboot bool) {
	// Reset TPM.
