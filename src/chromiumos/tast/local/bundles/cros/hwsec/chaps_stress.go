...
// - Create a key
// - Remove a key
func runOneTurn(ctx context.Context, state *chapsStressState, cryptohome *hwsec.CryptohomeClient, round roundType, pkcs11Util *pkcs11.Chaps, scratchpadPath string) (retErr error) {
	if round == mountRound {
