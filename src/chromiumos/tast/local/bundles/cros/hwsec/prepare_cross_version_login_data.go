...
func createChallengeResponseData(ctx context.Context, lf hwseclocal.LogFunc, cryptohome *hwsec.CryptohomeClient) (*hwseclocal.CrossVersionLoginConfig, error) {
	const (
	...
	return hwseclocal.NewChallengeAuthCrossVersionLoginConfig(authConfig, keyLabel, rsaKey), nil
}

func createPasswordData(ctx context.Context) (*hwseclocal.CrossVersionLoginConfig, error) {
	...
	return hwseclocal.NewPassAuthCrossVersionLoginConfig(authConfig, "legacy-0"), nil
}
