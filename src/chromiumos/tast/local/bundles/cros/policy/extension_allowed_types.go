...
func init() {
	testing.AddTest(&testing.Test{
		Func: ExtensionAllowedTypes, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Behavior of ExtensionAllowedTypes policy, checking if a theme can be added to Chrome",
		Contacts: []string{
