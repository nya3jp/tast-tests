...
func init() {
	testing.AddTest(&testing.Test{
		...
		Desc:         "Behavior of UserAvatarImagePersHub policy: verify that the user cannot change the device account image when the policy is set, otherwise, the user can change it",
		Contacts: []string{
