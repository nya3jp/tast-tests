...
func init() {
	testing.AddTest(&testing.Test{
		Func: ScreenBrightnessPercent, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Test behavior of ScreenBrightnessPercent policy: check if the screen brightness matches the value of the policy",
		Contacts: []string{
