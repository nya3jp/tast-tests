...
func init() {
	testing.AddTest(&testing.Test{
		Func: ForceGoogleSafeSearch, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Test the behavior of ForceGoogleSafeSearch policy: check if Google safe search is enabled based on the value of the policy",
		Contacts: []string{
