...
func init() {
	testing.AddTest(&testing.Test{
		Func: KeyboardDefaultToFunctionKeys, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Test the KeyboardDefaultToFunctionKeys policy: check that the behavior of function keys is swapped",
		Contacts: []string{
