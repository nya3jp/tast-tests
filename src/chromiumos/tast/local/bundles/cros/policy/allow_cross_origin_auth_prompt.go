...
func init() {
	testing.AddTest(&testing.Test{
		Func: AllowCrossOriginAuthPrompt, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Checks the behavior of 3rd part resources on pages whether it shows auth prompt or not",
		Contacts: []string{
