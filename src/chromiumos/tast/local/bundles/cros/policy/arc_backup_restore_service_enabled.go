...
func init() {
	testing.AddTest(&testing.Test{
		Func: ArcBackupRestoreServiceEnabled, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Test the behavior of ArcBackupRestoreServiceEnabled policy: check the Backup Manager state after setting the policy",
		Contacts: []string{
