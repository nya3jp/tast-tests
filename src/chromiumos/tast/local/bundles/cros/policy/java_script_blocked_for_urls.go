...
func init() {
	testing.AddTest(&testing.Test{
		Func: JavaScriptBlockedForUrls, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Check that the JavaScriptBlockedForUrls policy blocks execution of JavaScript on the given sites",
		Contacts: []string{
