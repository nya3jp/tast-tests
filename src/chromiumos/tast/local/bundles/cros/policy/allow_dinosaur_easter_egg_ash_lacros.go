...
func init() {
	testing.AddTest(&testing.Test{
		Func: AllowDinosaurEasterEggAshLacros, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Behavior of AllowDinosaurEasterEgg policy on both Ash and Lacros browser",
		Contacts: []string{
