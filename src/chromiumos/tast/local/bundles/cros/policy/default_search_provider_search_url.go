...
func init() {
	testing.AddTest(&testing.Test{
		Func: DefaultSearchProviderSearchURL, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Behavior of DefaultSearchProviderSearchURL policy: check if provided search provider is being used",
		Contacts: []string{
