...
func init() {
	testing.AddTest(&testing.Test{
		Func: SearchSuggestEnabled, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Behavior of SearchSuggestEnabled policy, check if a search suggestions are shown based on the value of the policy",
		Contacts: []string{
