...
func PinUnlockMinimumLength(ctx context.Context, s *testing.State) {
	...
	for _, param := range []struct {
	...
	}{
		{
			name: "unset",
			pin:  "123456",
			policies: []policy.Policy{&policy.PinUnlockMinimumLength{Stat: policy.StatusUnset},
				&policy.QuickUnlockModeWhitelist{Val: []string{"PIN"}}},
		},
		{
			name: "Pin minimum length 4",
			pin:  "12345",
			policies: []policy.Policy{&policy.PinUnlockMinimumLength{Val: 4},
				&policy.QuickUnlockModeWhitelist{Val: []string{"PIN"}}},
		},
	} {
