...
func init() {
	testing.AddTest(&testing.Test{
		Func: AllowScreenLock, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Behavior of AllowScreenLock policy, checking whether the screen can be locked after setting the policy",
		Contacts: []string{
