...
func init() {
	testing.AddTest(&testing.Test{
		Func: JavaScriptAllowedForUrls, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Check that the JavaScriptAllowedForUrls policy allows execution of JavaScript only on the given sites",
		Contacts: []string{
