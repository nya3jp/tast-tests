...
func init() {
	testing.AddTest(&testing.Test{
		Func: BookmarkBarEnabled, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Test the behavior of BookmarkBarEnabled policy: check if bookmark bar is shown based on the value of the policy",
		Contacts: []string{
