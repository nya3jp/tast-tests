...
type quickUnlockTestCase struct {
	name                     string
...
func QuickUnlockModeAllowlist(ctx context.Context, s *testing.State) {
	...
	quickUnlockTestCases := []quickUnlockTestCase{
		{
			name:                     "unset",
	...
	if fingerprintSupported {
		quickUnlockTestCases = append(quickUnlockTestCases, quickUnlockTestCase{
			name:                     "fingerprint",
	...
	for _, param := range quickUnlockTestCases {
