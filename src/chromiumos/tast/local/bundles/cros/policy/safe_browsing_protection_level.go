...
func init() {
	testing.AddTest(&testing.Test{
		Func: SafeBrowsingProtectionLevel, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Checks if Google Chrome's Safe Browsing feature is enabled and the mode it operates in",
		Contacts: []string{
