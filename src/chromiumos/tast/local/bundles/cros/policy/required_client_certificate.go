...
func init() {
	testing.AddTest(&testing.Test{
		Func: RequiredClientCertificate, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Behavior of RequiredClientCertificateForDevice/User policies, check if a certificate is issued when the respective policy is set",
		Contacts: []string{
