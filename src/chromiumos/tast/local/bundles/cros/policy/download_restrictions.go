...
func init() {
	testing.AddTest(&testing.Test{
		Func: DownloadRestrictions, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Behavior of DownloadRestrictions policy, check if a file is downloaded or not based on the value of the policy",
		Contacts: []string{
