...
func init() {
	testing.AddTest(&testing.Test{
		Func: ShowHomeButton, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Test the behavior of ShowHomeButton policy: check if a home button is shown based on the value of the policy",
		Contacts: []string{
