...
func init() {
	testing.AddTest(&testing.Test{
		Func: PrintingEnabled, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Behavior of PrintingEnabled policy, checking the correspoding menu item restriction and printing preview dialog after setting the policy",
		Contacts: []string{
