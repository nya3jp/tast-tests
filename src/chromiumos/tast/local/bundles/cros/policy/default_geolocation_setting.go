...
func init() {
	testing.AddTest(&testing.Test{
		Func: DefaultGeolocationSetting, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Behavior of DefaultGeolocationSetting policy, checking the location site settings after setting the policy",
		Contacts: []string{
