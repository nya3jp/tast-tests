...
func init() {
	testing.AddTest(&testing.Test{
		Func: AllowDeletingBrowserHistory, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Behavior of AllowDeletingBrowserHistory policy, checking the correspoding checkbox states (restriction and checked) after setting the policy",
		Contacts: []string{
