...
func init() {
	testing.AddTest(&testing.Test{
		Func: DeviceTargetVersionSelector, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Check of DeviceTargetVersionSelector policy by checking update_engine logs",
		Contacts: []string{
