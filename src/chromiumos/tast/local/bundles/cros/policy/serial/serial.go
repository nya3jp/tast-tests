...
func TestSerialPortRequest(ctx context.Context, cr *chrome.Chrome, br *browser.Browser, host string, wantSerialDialog bool) error {
	conn, err := br.NewConn(ctx, fmt.Sprintf("%s/%s", host, SerialTestPage))
	if err != nil {
