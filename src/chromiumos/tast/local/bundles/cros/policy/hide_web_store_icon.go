...
func init() {
	testing.AddTest(&testing.Test{
		Func: HideWebStoreIcon, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Behavior of HideWebStoreIcon policy, check if a Web Store Icon is displayed in app launcher based on the value of the policy",
		Contacts: []string{
