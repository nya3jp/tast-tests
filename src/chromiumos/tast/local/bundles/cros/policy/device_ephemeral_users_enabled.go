...
func init() {
	testing.AddTest(&testing.Test{
		Func: DeviceEphemeralUsersEnabled, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Verifies whether the ephemeral_users_enabled policy is set on the device or not",
		Contacts: []string{
