...
func init() {
	testing.AddTest(&testing.Test{
		Func: DefaultSearchProviderKeyword, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Behavior of DefaultSearchProviderKeyword policy: check if specified keyword triggers the search for search provider",
		Contacts: []string{
