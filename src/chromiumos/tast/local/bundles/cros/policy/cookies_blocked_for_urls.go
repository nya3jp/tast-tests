...
func init() {
	testing.AddTest(&testing.Test{
		Func: CookiesBlockedForUrls, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Check that the CookiesBlockedForUrls policy blocks setting cookies on the given sites",
		Contacts: []string{
