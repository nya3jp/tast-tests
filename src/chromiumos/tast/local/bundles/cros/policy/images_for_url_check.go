...
func init() {
	testing.AddTest(&testing.Test{
		Func: ImagesForURLCheck, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Checks the behavior of images on URL with DefaultImagesSetting, ImagesAllowedForUrls and ImagesBlockedForUrls user policies",
		Contacts: []string{
