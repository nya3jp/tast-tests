...
func init() {
	testing.AddTest(&testing.Test{
		Func: AllowWakeLocks, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Behavior of AllowWakeLocks policy check whether it shows idle window or not for pages with wake locks requests",
		Contacts: []string{
