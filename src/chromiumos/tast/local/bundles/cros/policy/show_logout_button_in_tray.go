...
func init() {
	testing.AddTest(&testing.Test{
		Func: ShowLogoutButtonInTray, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Behavior of ShowLogoutButtonInTray policy, check if a logout button is shown based on the value of the policy",
		Contacts: []string{
