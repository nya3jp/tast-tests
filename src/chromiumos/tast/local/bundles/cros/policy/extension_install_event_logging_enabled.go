...
func init() {
	testing.AddTest(&testing.Test{
		Func: ExtensionInstallEventLoggingEnabled, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Behavior of ExtensionInstallEventLoggingEnabled policy, checking if all events from the installation of an extension are logged",
		Contacts: []string{
