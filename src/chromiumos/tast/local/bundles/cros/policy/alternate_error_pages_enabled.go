...
func init() {
	testing.AddTest(&testing.Test{
		Func: AlternateErrorPagesEnabled, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Behavior of the AlternateErrorPagesEnabled policy: check that an alternate set of error pages is shown based on the policy",
		Contacts: []string{
