...
// Test API extension which can be used to access various APIs.
...
func ExtensionInstallPolicyCheck(ctx context.Context, s *testing.State) {
	...
	for _, tc := range tcs {
		s.Run(ctx, tc.name, func(ctx context.Context, s *testing.State) {
			...
			// Run actual test.
			if allowInstall, err := canInstallExtension(ctx, tconn, cr); err != nil {
...
func canInstallExtension(ctx context.Context, tconn *chrome.TestConn, cr *chrome.Chrome) (bool, error) {
