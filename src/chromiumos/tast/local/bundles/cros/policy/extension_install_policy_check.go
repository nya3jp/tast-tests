...
func init() {
	testing.AddTest(&testing.Test{
		Func: ExtensionInstallPolicyCheck, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Checks the behavior of ExtensionInstallAllowlist, ExtensionInstallBlocklist policies",
		Contacts: []string{
