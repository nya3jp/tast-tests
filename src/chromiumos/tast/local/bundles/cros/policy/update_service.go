...
func init() {
	testing.AddService(&testing.Service{
		Register: func(srv *grpc.Server, s *testing.ServiceState) {
			ppb.RegisterUpdateServiceServer(srv, &UpdateService{s: s})
		},
	})
}

// UpdateService implements tast.cros.policy.UpdateService.
...
func (Update *UpdateService) CheckForUpdate(ctx context.Context, req *ppb.UpdateRequest) (*empty.Empty, error) {
...
func (Update *UpdateService) LSBReleaseContent(ctx context.Context, req *empty.Empty) (*ppb.LSBRelease, error) {
	lsb, err := lsbrelease.Load()
	if err != nil {
		return &ppb.LSBRelease{}, errors.Wrap(err, "unable to retreive lsbrelease information")
	}

	return &ppb.LSBRelease{
...
func (Update *UpdateService) LSBReleaseOverwriteContent(ctx context.Context, req *empty.Empty) (*ppb.LSBRelease, error) {
	lsb, err := lsbrelease.LoadFrom(statefulPath)
	if err != nil {
		return &ppb.LSBRelease{}, errors.Wrap(err, "unable to retreive lsbrelease information")
	}

	lsbResponse := &ppb.LSBRelease{}
...
func (Update *UpdateService) OverwriteLSBRelease(ctx context.Context, req *ppb.LSBRelease) (*empty.Empty, error) {
