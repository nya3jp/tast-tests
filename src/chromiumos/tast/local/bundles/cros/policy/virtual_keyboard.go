...
func init() {
	testing.AddTest(&testing.Test{
		Func: VirtualKeyboard, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Behavior of VirtualKeyboardEnabled and TouchVirtualKeyboardEnabled policies and their mixing by checking that the virtual keyboard (is/is not) displayed as requested by the policy",
		Contacts: []string{
