...
func init() {
	testing.AddTest(&testing.Test{
		Func: DevicePowerPeakShift, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Tests for DevicePowerPeakShift policies that minimize alternating current (AC) usage during peak hours",
		Contacts: []string{
