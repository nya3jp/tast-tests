...
func init() {
	testing.AddTest(&testing.Test{
		Func: DeviceMinimumVersionNotifications, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Notifications of DeviceMinimumVersion policy when device has reached auto update expiration",
		Contacts: []string{
