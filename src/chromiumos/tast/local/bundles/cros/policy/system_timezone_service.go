...
func (c *SystemTimezoneService) TestLogout(ctx context.Context, req *empty.Empty) (*empty.Empty, error) {
...
func (c *SystemTimezoneService) GetSystemTimezone(ctx context.Context, req *pb.GetSystemTimezoneRequest) (*empty.Empty, error) {
