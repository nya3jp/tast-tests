		...
		Params: []testing.Param{
			// TODO(crbug.com/1186655): Find a way to close/avoid the dialog about disabling autoclick.
			{
				...
				ExtraSearchFlags: []*testing.StringPair{
					pci.SearchFlag("AutoclickEnabled", pci.VerifiedFunctionalityJS),
				},
			},
			{
				...
				ExtraSearchFlags: []*testing.StringPair{
					pci.SearchFlag("CaretHighlightEnabled", pci.VerifiedFunctionalityJS),
				},
			},
			{
				...
				ExtraSearchFlags: []*testing.StringPair{
					pci.SearchFlag("CursorHighlightEnabled", pci.VerifiedFunctionalityJS),
				},
			},
			{
				...
				ExtraSearchFlags: []*testing.StringPair{
					pci.SearchFlag("ScreenMagnifierType", pci.VerifiedFunctionalityJS),
				},
			},
			{
				...
				ExtraSearchFlags: []*testing.StringPair{
					pci.SearchFlag("KeyboardFocusHighlightEnabled", pci.VerifiedFunctionalityJS),
				},
			},
			{
				Name:      "high_contrast",
				...
				ExtraSearchFlags: []*testing.StringPair{
					pci.SearchFlag("HighContrastEnabled", pci.VerifiedFunctionalityJS),
				},
			},
			{
				Name:      "large_cursor",
				...
				ExtraSearchFlags: []*testing.StringPair{
					pci.SearchFlag("LargeCursorEnabled", pci.VerifiedFunctionalityJS),
				},
			},
			{
			...
			},
			{
				...
				ExtraSearchFlags: []*testing.StringPair{
					pci.SearchFlag("SelectToSpeakEnabled", pci.VerifiedFunctionalityJS),
				},
			},
			{
				...
				ExtraSearchFlags: []*testing.StringPair{
					pci.SearchFlag("SpokenFeedbackEnabled", pci.VerifiedFunctionalityJS),
				},
			},
			{
				Name:      "sticky_keys",
				...
				ExtraSearchFlags: []*testing.StringPair{
					pci.SearchFlag("StickyKeysEnabled", pci.VerifiedFunctionalityJS),
				},
			},
			{
				...
				ExtraSearchFlags: []*testing.StringPair{
					pci.SearchFlag("VirtualKeyboardEnabled", pci.VerifiedFunctionalityJS),
				},
			},
		},
	})
