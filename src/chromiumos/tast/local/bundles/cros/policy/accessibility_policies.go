...
func init() {
	testing.AddTest(&testing.Test{
		Func: AccessibilityPolicies, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Checks set values for the Accessability polices in the chrome.accessibilityFeatures map",
		Contacts: []string{
