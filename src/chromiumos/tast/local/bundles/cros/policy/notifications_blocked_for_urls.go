...
func init() {
	testing.AddTest(&testing.Test{
		Func: NotificationsBlockedForUrls, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Behavior of NotificationsBlockedForUrls policy: checking if notifications are blocked for a specified url",
		Contacts: []string{
