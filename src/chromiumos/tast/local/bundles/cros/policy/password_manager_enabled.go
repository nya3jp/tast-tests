...
func init() {
	testing.AddTest(&testing.Test{
		Func: PasswordManagerEnabled, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Behavior of PasswordManagerEnabled policy, checking the correspoding toggle button states (restriction and checked) after setting the policy",
		Contacts: []string{
