...
func init() {
	testing.AddTest(&testing.Test{
		Func: DefaultNotificationsSetting, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Behavior of DefaultNotificationsSetting policy, checks the notification permission in JavaScript at different policy values",
		Contacts: []string{
