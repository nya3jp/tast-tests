...
func init() {
	testing.AddTest(&testing.Test{
		Func: TranslateEnabled, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Behavior of Translate policy, checking if the translate widget shows up or not dependent on the policy setting",
		Contacts: []string{
