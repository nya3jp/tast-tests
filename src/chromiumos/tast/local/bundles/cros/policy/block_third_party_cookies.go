...
func init() {
	testing.AddTest(&testing.Test{
		Func: BlockThirdPartyCookies, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Test the behavior of BlockThirdPartyCookies policy: check if third party cookies are allowed based on policy value",
		Contacts: []string{
