...
func init() {
	testing.AddTest(&testing.Test{
		Func: DeviceWilcoDtcAllowedEnrolled, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Test setting the DeviceWilcoDtcAllowed policy by checking if the Wilco DTC Support Daemon is running",
		Contacts: []string{
