...
// Cleanup is a helper that calls policyutil.ResetChromeAndPolicies
...
// UpdatePolicyBlob is a helper that calls policyutil.UpdatePolicyBlob
func (h *UserPoliciesHelper) UpdatePolicyBlob(ctx context.Context, pb *fakedms.PolicyBlob) error {
	return policyutil.UpdateBlob(ctx, h.FakeDMS, h.Chrome, pb)
}

// UpdatePolicies is a helper that calls policyutil.UpdatePolicies
func (h *UserPoliciesHelper) UpdatePolicies(ctx context.Context, ps []policy.Policy) error {
	return policyutil.UpdatePolicies(ctx, h.FakeDMS, h.Chrome, ps)
}
