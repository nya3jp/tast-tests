...
func init() {
	testing.AddTest(&testing.Test{
		Func: PromptForDownloadLocation, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Test behavior of PromptForDownloadLocation policy: checking if a prompt for the download location appears based on the value of the policy",
		Contacts: []string{
