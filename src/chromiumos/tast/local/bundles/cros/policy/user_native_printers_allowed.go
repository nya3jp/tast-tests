...
func init() {
	testing.AddTest(&testing.Test{
		...
		Desc: "Behavior of UserNativePrintersAllowed policy, check if a virtual keyboard is opened based on the value of the policy",
		Contacts: []string{
...
func UserNativePrintersAllowed(ctx context.Context, s *testing.State) {
	...
	for _, param := range []struct {
		name           string
		wantRestricted bool                              // wantRestricted is the expected restriction state of the "Add Printer".
