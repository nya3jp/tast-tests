...
func init() {
	testing.AddTest(&testing.Test{
		Func: UserNativePrintersAllowed, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Test behavior of UserNativePrintersAllowed policy: check if Add printer button is restricted based on the value of the policy",
		Contacts: []string{
