...
// StartNewChromeReader starts new syslog reader.
func (c *PolicyService) StartNewChromeReader(ctx context.Context, req *ppb.StartNewChromeReaderRequest) (*empty.Empty, error) {
