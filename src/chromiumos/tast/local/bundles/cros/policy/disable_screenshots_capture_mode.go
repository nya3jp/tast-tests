...
func init() {
	testing.AddTest(&testing.Test{
		Func: DisableScreenshotsCaptureMode, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Behavior of the DisableScreenshots policy, check whether screenshot can be taken from capture mode in quick settings",
		Contacts: []string{
