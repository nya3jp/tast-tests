...
func init() {
	testing.AddTest(&testing.Test{
		Func: AllowedLanguages, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Behavior of AllowedLanguages policy, checking the correspoding checkbox states (count) after setting the policy",
		Contacts: []string{
