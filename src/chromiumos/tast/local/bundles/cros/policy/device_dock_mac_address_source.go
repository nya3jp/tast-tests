...
func init() {
	testing.AddTest(&testing.Test{
		Func: DeviceDockMacAddressSource, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Test setting the DeviceDockMacAddressSource policy by checking if the DUT changing MAC address",
		Contacts: []string{
