...
func init() {
	testing.AddTest(&testing.Test{
		Func: SystemTimezoneAutomaticDetection, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Check of SystemTimezoneAutomaticDetection policy by checking the settings page",
		Contacts: []string{
