...
func init() {
	testing.AddTest(&testing.Test{
		Func: SavingBrowserHistoryDisabled, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Behavior of SavingBrowserHistoryDisabled policy, check if browsing history entries are shown based on the value of the policy",
		Contacts: []string{
