...
func init() {
	testing.AddTest(&testing.Test{
		Func: VirtualMachinesAllowed, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Verify that installing Crostini is allowed only when VirtualMachinesAllowed policy is enabled",
		Contacts: []string{
