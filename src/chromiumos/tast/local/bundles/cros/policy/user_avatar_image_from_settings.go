...
func init() {
	testing.AddTest(&testing.Test{
		Func:         UserAvatarImageFromSettings,
		LacrosStatus: testing.LacrosVariantUnneeded,
		Desc:         "Behavior of UserAvatarImageFromSettings policy: verify that the user cannot change the device account image when the policy is set, otherwise, the user can change it",
		Contacts: []string{
...
func UserAvatarImageFromSettings(ctx context.Context, s *testing.State) {
	...
	// Serve UserAvatarImageFromSettings policy data.
