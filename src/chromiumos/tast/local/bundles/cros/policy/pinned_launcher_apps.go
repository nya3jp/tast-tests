...
func init() {
	testing.AddTest(&testing.Test{
		Func: PinnedLauncherApps, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Test the behavior of PinnedLauncherApps policy: apps in the policy are pinned on the shelf and cannot be unpinned",
		Contacts: []string{
