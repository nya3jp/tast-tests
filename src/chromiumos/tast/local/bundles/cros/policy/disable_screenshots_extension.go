...
func init() {
	testing.AddTest(&testing.Test{
		Func: DisableScreenshotsExtension, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Behavior of the DisableScreenshots policy, check whether screenshot can be taken by chrome.tabs.captureVisibleTab extensions API",
		Contacts: []string{
