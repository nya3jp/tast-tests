...
func init() {
	testing.AddTest(&testing.Test{
		Func: AudioCaptureAllowed, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Checking if audio capture is allowed on websites or not, depending on the value of the policy",
		Contacts: []string{
