...
// nameOfInitialBookmark is displayed on the bookmarks bar.
const nameOfInitialBookmark = "Alphabet"

// url of the website that is bookmarked initially before testing starts. Needed to check if already bookmarked
// pages can be accessed after applying policy.
const urlOfInitialBookmark = "https://abc.xyz"

// visibleAddressOfInitialBookmark holds the visible part of the address. This part is needed for validation.
