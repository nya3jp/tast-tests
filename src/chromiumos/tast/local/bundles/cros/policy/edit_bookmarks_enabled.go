...
func init() {
	testing.AddTest(&testing.Test{
		Func: EditBookmarksEnabled, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Behavior of EditBookmarksEnabled policy: check if you can create, edit and remove bookmarks based on the policy value",
		Contacts: []string{
