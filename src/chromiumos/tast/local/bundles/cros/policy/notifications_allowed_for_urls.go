...
func init() {
	testing.AddTest(&testing.Test{
		Func: NotificationsAllowedForUrls, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Behavior of NotificationsAllowedForUrls policy: checking if notifications are allowed for a specified url",
		Contacts: []string{
