...
func init() {
	testing.AddTest(&testing.Test{
		Func: DisableScreenshotsHotkey, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Behavior of the DisableScreenshots policy, check whether screenshot can be taken by pressing hotkeys",
		Contacts: []string{
