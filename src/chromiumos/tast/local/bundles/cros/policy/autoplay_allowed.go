...
func init() {
	testing.AddTest(&testing.Test{
		Func: AutoplayAllowed, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Checking if autoplay is allowed on websites or nor, depending on the value of the policy",
		Contacts: []string{
