...
func init() {
	testing.AddTest(&testing.Test{
		Func: SystemProxySettings, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Test setting the SystemProxySettings policy by checking if the System-proxy daemon and worker processes are running",
		Contacts: []string{
