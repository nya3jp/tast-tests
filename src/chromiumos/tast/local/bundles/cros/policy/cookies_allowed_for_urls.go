...
func init() {
	testing.AddTest(&testing.Test{
		Func: CookiesAllowedForUrls, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Check that the CookiesAllowedForUrls policy allows setting cookies only on the given sites",
		Contacts: []string{
