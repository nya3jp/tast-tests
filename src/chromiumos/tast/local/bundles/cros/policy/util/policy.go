...
func UpdatePolicies(ctx context.Context, fdms *fakedms.FakeDMS, cr *chrome.Chrome, ps []policy.Policy) error {
	...
	pb.AddPolicies(ps)
	return UpdatePolicyBlob(ctx, fdms, cr, pb)
}

// UpdatePolicyBlob updates the policy blob of FakeDMS and refreshes them in Chrome.
func UpdatePolicyBlob(ctx context.Context, fdms *fakedms.FakeDMS, cr *chrome.Chrome, pb *fakedms.PolicyBlob) error {
