...
// node for the New desk button when there are only 1 desk.
...
// enterTabletModeWithOneDesk verified the New desk button when entering tablet mode with only 1 desk.
...
// enterTabletModeWithTwoDesks verified the New desk when there are 2 desks before entering tablet mode.
