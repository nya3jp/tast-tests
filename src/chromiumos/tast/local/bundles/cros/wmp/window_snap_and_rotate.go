...
func WindowSnapAndRotate(ctx context.Context, s *testing.State) {
	...
	if portrait {
		...
		// TODO(crbug/1264617): Update |ash.WindowStateLeftSnapped| and |ash.WindowStateRightSnapped|
		// to |ash.WindowStatePrimarySnapped| and |ash.WindowStateSecondarySnapped| respectively.
