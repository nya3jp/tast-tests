...
func NewL2tpipSecVpnServer(ctx context.Context, authType, interfaceName, address string, networkPrefix int, perfXauthAuth, localIPIsPublicIP bool) *l2tpipSecVpnServer {
