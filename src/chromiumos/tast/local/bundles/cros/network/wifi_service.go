...
// ExpectShillProperty is a streaming gRPC, takes a shill object (e.g. Service or Device) path
// and expects a list of property criteria in order. When a property's value is expected, it
// responds the property's (key, value) pair. The method sends an empty response as the property
...
// value is one of the excluded values, the method fails immediately.
