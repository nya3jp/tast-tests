...
// EAPAuthSkipped is a streaming gRPC, who watches wpa_supplicant's D-Bus signals and tells that the
// EAP authentication is skipped (i.e., PMKSA is cached and used) or not in the next connection.
