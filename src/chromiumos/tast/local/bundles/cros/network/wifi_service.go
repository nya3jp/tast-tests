...
func (s *WifiService) GetCurrentTime(ctx context.Context, req *network.GetCurrentTimeRequest) (*network.GetCurrentTimeResponse, error) {
	return &network.GetCurrentTimeResponse{Now: time.Now().Format(req.Layout)}, nil
}
