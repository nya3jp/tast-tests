...
func init() {
	testing.AddTest(&testing.Test{
		Func: SystemProxyForArc, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Test that ARC++ apps can successfully connect to the remote host through the system-proxy daemon",
		Contacts: []string{
