...
// waitUntilNATIptablesConfigured waits until the NAT rule output of iptables is done configuring.
...
// This function waits until the changes are propagated by waiting until the iptables rules between two iterations are unchanged.
