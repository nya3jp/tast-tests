...
func init() {
	testing.AddTest(&testing.Test{
		Func: DiagFailDNSResolution, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Tests that the DNS resolution network diagnostic test fails when the DNS cannot resolve requests",
		Contacts: []string{
