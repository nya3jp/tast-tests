...
func (d *NetDiagService) SetupDiagAPI(ctx context.Context, req *empty.Empty) (*empty.Empty, error) {
	if d.api != nil {
...
func (d *NetDiagService) Close(ctx context.Context, req *empty.Empty) (*empty.Empty, error) {
