...
func init() {
	...
	testing.AddTest(&testing.Test{
		...
		Desc: "Stable EAP PKCS#11 slot test for shill",
		Contacts: []string{
...
// slot is the possible PKCS#11 slot types ChromeOS are using.
type slot int

const (
	// systemSlot refers to the device-wide slot accessible across users.
	systemSlot slot = iota
...
// The function returns errors on failures or mistmatches.
