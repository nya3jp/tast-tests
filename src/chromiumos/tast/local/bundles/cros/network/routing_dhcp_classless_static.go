...
func init() {
	testing.AddTest(&testing.Test{
		...
		Desc:         "Verify the shill behavior and routing semantics in a DHCP environment with classless static routes",
...
//
//	veth1 --+-- test server --+-- test server (secondary network, not reachable)
//	        |                 |
