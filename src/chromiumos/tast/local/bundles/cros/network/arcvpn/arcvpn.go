...
const (
	...
	ARCVPNService = "org.chromium.arc.hostvpn.ArcHostVpnService"
)
...
// CheckARCServiceState checks if the Android service is running in the `expectedRunning` state.
func CheckARCServiceState(ctx context.Context, a *arc.ARC, pkg, svc string, expectedRunning bool) error {
