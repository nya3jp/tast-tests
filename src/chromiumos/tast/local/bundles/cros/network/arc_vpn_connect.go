...
// Te package name and service name of the ARC-side fake VPN. These need to stay in sync with
...
func ARCVPNConnect(ctx context.Context, s *testing.State) {
	...
	// eth0 is the hardcoded in ARC as the iface of our fake ethernet network that VPN traffic
