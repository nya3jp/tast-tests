...
func init() {
	testing.AddTest(&testing.Test{
		Func: DiagFailFirewall, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Tests that the http/s firewall network diagnostic test fails when traffic is not allowed on certain ports",
		Contacts: []string{
