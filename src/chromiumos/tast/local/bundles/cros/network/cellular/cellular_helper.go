...
// Returns true if AutoConnect was set.
func (h *Helper) SetServiceAutoConnect(autoConnect bool) (bool, error) {
	...
	if err := service.SetProperty(h.ctx, shillconst.ServicePropertyAutoConnect, autoConnect); err != nil {
