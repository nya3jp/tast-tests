...
var denyListMUMIMO = []string{
	Marvell88w8797SDIO,  // (802.11n) according to go/CrConn.
	Marvell88w8897SDIO,  // Tested a DUT.
	Marvell88w8897PCIE,  // Tested a DUT.
	AtherosAR9280,       // (802.11n) according to go/CrConn.
	AtherosAR9382,       // (802.11n) according to go/CrConn.
	AtherosAR9462,       // (802.11n) according to go/CrConn.
