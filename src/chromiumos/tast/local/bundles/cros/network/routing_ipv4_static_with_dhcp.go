...
func RoutingIPv4StaticWithDHCP(ctx context.Context, s *testing.State) {
	...
	// Since we only have IPv4 in this enviroment, service Online means IPv4
	// connectivity. No timeout is needed here.
	...
	// paramaters may flush the routing table, so use a timeout here for the
	// routing setup.
