...
func Routing(ctx context.Context, s *testing.State) {
	...
	// if err := shill.ResetShill(ctx); err != nil {
	...
	testing.ContextLog(ctx, "Sleep for 10 seconds to wait for shill ready")
