...
func dbusEventMonitor(ctx context.Context, env *testEnv) func() ([]string, error) {
...
func assureMethodCalls(ctx context.Context, expectedMethodCalls []string, calledMethods []string, env *testEnv) error {
...
func testLogin(ctx context.Context, env *testEnv) error {
	...
	if err := assureMethodCalls(ctx, expectedCalls, calledMethods, env); err != nil {
		return err
	}
