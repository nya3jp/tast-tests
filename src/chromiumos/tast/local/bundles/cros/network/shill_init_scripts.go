...
func ShillInitScripts(ctx context.Context, s *testing.State) {
	...
	var testFunc = []convert{testStartShill, testStartLoggedIn, testLogin, testLoginGuest, testLoginProfileExists, testLoginMultiProfile, testLogout}
	// Run all the tests.
...
func stopShill(ctx context.Context) error {
	...
	return errors.New("failed shill process does not appear to be dying")
...
func restartShill(ctx context.Context) error {
	...
	return errors.New("failed shill process does not exists")
