...
// dbusEventMonitor monitors the system message bus for expected dbus calls (dbus calls from Shill init Scripts).
// the monitoring stops when it catches the dbus dummySignal.
