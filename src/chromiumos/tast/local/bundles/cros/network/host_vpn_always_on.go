		...
		Params: []testing.Param{
			{
				...
				Val: hostVPNAlwaysOnTestCase{
					mode: shillconst.AlwaysOnVpnStrictMode,
					config: vpn.Config{
			...
			},
			{
				...
				Val: hostVPNAlwaysOnTestCase{
					mode: shillconst.AlwaysOnVpnBestEffortMode,
					config: vpn.Config{
						Type:           vpn.TypeOpenVPN,
						AuthType:       vpn.AuthTypeCert,
						OpenVPNTLSAuth: true,
...
func HostVPNAlwaysOn(ctx context.Context, s *testing.State) {
	...
	user := "chronos"
	switch vpnMode {
	case shillconst.AlwaysOnVpnStrictMode:
	...
	case shillconst.AlwaysOnVpnBestEffortMode:
