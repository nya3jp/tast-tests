...
func init() {
	testing.AddTest(&testing.Test{
		Func: DiagFailDNSResolverPresent, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Tests that the DNS resolver present network diagnostic test fails as expected with malformed DNS names",
		Contacts: []string{
