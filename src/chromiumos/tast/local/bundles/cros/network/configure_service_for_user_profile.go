...
func init() {
	testing.AddTest(&testing.Test{
		Func: ConfigureServiceForUserProfile, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Checks that we can configure a WiFi network for a user profile (guest or normal)",
		Contacts: []string{
