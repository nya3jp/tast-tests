...
var wlanDeviceLookup = map[wlanDeviceInfo]string{
	wlanDeviceInfo{vendor: "0x02df", device: "0x9129"}: marvell88w8797Sdio,
	wlanDeviceInfo{vendor: "0x02df", device: "0x912d"}: marvell88w8897Sdio,
	wlanDeviceInfo{vendor: "0x02df", device: "0x9135"}: marvell88w8887Sdio,
	wlanDeviceInfo{vendor: "0x11ab", device: "0x2b38"}: marvell88w8897Pcie,
	wlanDeviceInfo{vendor: "0x1b4b", device: "0x2b42"}: marvell88w8997Pcie,
	wlanDeviceInfo{vendor: "0x168c", device: "0x002a"}: atherosAr9280,
	wlanDeviceInfo{vendor: "0x168c", device: "0x0030"}: atherosAr9382,
	wlanDeviceInfo{vendor: "0x168c", device: "0x0034"}: atherosAr9462,
	wlanDeviceInfo{vendor: "0x168c", device: "0x003e"}: qualcommAtherosQca6174,
	wlanDeviceInfo{vendor: "0x105b", device: "0xe09d"}: qualcommAtherosQca6174,
	wlanDeviceInfo{vendor: "0x0271", device: "0x050a"}: qualcommAtherosQca6174Sdio,
	wlanDeviceInfo{vendor: "0x8086", device: "0x08b1"}: intel7260,
	wlanDeviceInfo{vendor: "0x8086", device: "0x08b2"}: intel7260,
	wlanDeviceInfo{vendor: "0x8086", device: "0x095a"}: intel7265,
	wlanDeviceInfo{vendor: "0x8086", device: "0x095b"}: intel7265,
	wlanDeviceInfo{vendor: "0x8086", device: "0x9df0"}: intel9000,
	wlanDeviceInfo{vendor: "0x8086", device: "0x31dc"}: intel9000,
	wlanDeviceInfo{vendor: "0x8086", device: "0x2526"}: intel9260,
	wlanDeviceInfo{vendor: "0x8086", device: "0x2723"}: intel22260,
	wlanDeviceInfo{vendor: "0x02d0", device: "0x4354"}: broadcomBcm4354Sdio,
	wlanDeviceInfo{vendor: "0x14e4", device: "0x43ec"}: broadcomBcm4356Pcie,
	wlanDeviceInfo{vendor: "0x14e4", device: "0x440d"}: broadcomBcm4371Pcie,
	wlanDeviceInfo{compatible: "qcom,wcn3990-wifi"}:    qualcommWcn3990,
}
...
func WlanDriver(ctx context.Context, s *testing.State) {
	...
	// TODO(oka): Original test skips if "wifi" is not initizlied (USE="-wifi").
...
func getWlanInterface(ctx context.Context) (string, error) {
	...
	isWlanInterface := func(netIf string) (bool, error) {
		cmd := testexec.CommandContext(ctx, "iw", "dev", strings.TrimSpace(netIf), "info")
...
func getWlanDeviceName(ctx context.Context, netIf string) (string, error) {
	...
	devices := []wlanDeviceInfo{wlanDeviceInfo{vendor: vendorID, device: productID}}
