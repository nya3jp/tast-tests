...
func init() {
	testing.AddTest(&testing.Test{
		...
		Desc:     "Ensures that setting up a virtual ethernet pair with a DNS server that points portal detection queries to an http server that responds via the handler. This results in a service state of |ServiceState| via the params for the virtural ethernet service",
		...
		Params: []testing.Param{{
			...
			Val: &params{
				...
				HTTPResponseHandler: redirectHandler,
			},
		}, {
