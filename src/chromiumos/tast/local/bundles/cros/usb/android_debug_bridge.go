...
//	"chromiumos/tast/errors"
	...
	"chromiumos/tast/local/usb/gadget/adb"
...
func AndroidDebugBridge(ctx context.Context, s *testing.State) {
...
//	cont := pre.Container
	...
	g := gadget.NewGadget(usb.DeviceInfo{
		...
		ProductId      : 0x4ee7,
		Manufacturer   : "Google",
		Product        : "Google Pixel Emulator",
		SerialNumber   : "11119999",
		DeviceRev      : 0x0100,
		UsbRev         : 0x0200,
		DeviceClass    : 0x00,
		DeviceSubClass : 0x00,
