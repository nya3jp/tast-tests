...
type voiceMessage map[ime.LanguageCode]InputData
...
func (message voiceMessage) GetInputData(inputMethodCode ime.InputMethodCode) (InputData, bool) {
...
var VoiceMessageHello = voiceMessage{
	ime.EN: {
		VoiceFile:    "voice_en_hello_20201021.wav",
		ExpectedText: "hello",
	},
	ime.CN_SIMPLIFIED: {
		VoiceFile:    "voice_cn_hello_20201021.wav",
		ExpectedText: "你好",
	},
}
