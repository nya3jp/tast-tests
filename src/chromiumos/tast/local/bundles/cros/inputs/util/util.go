...
// InputEval creates a data structure to define common input function and expected out.
...
// FieldInputEval creates a data structure to define common input function and expected out on certain input field.
