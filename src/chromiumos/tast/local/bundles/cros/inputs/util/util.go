...
// WaitForFieldTextIgnoringCaseToBe returns an action checking whether the input field value equals given text.
// The text is case insensitive.
func WaitForFieldTextIgnoringCaseToBe(tconn *chrome.TestConn, finder *nodewith.Finder, expectedText string) uiauto.Action {
...
func WaitForFieldTextFunc(tconn *chrome.TestConn, finder *nodewith.Finder, expectedText string, ignoreCase bool) uiauto.Action {
	...
	return ui.Retry(5, func(ctx context.Context) error {
