...
func getVars(s *testing.State) *envSettings {
	...
	settings.userType = parseStringVar(s, "userType", "")
	settings.user = parseStringVar(s, "user", "")
	settings.pass = parseStringVar(s, "pass", "")
	settings.contact = parseStringVar(s, "contact", "")
	settings.imeID = parseStringVar(s, "imeID", "")
	settings.region = parseStringVar(s, "region", "")
