...
func init() {
	testing.AddTest(&testing.Test{
		Func:         KeyboardGuest,
		Desc:         "Checks that both physical and virutal keyboards work in guest mode",
...
// KeyboardGuest checks that both physical keyboard and virutal keyboard work in guest mode.
