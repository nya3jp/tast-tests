...
// After input action, it checks whether the outcome equals to expected value.
// This is deprecated, use ValidateVKInputInField instead.
...
// ValidateInputInField returns an action to test keyboard input in the given field.
// After input action, it checks whether the outcome equals to expected value.
func (its *InputsTestServer) ValidateInputInField(s *testing.State, inputModality util.InputModality, inputField InputField, inputData data.InputData) uiauto.Action {
	// TODO(b/195083581): Enable ValidateInputInField for physical keyboard and emoji.
