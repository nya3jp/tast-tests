...
// Node returns the a11y node of the input field.
func (inputField InputField) Node(ctx context.Context, tconn *chrome.TestConn) (*ui.Node, error) {
...
func (inputField InputField) action(ctx context.Context, tconn *chrome.TestConn, f func(node *ui.Node) error) error {
	node, err := inputField.Node(ctx, tconn)
	if err != nil {
