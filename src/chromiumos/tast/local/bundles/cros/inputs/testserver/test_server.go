...
const (
	...
	TextAreaAutoShiftInSentence InputField = "autocapitalize in sensence mode"
...
<textarea rows="3" aria-label="autocapitalize in sensence mode" autocapitalize="sensences" style="width: 100%"></textarea>
<br /><br />
