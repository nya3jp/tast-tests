...
func init() {
	testing.AddTest(&testing.Test{
		Func: PhysicalKeyboardChangeInput, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Checks that changing input method in different ways on physical keyboard",
