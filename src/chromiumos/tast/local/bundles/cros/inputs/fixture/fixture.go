...
const (
	...
	ClamshellNonVKWithGrammerCheck     = "clamshellNonVKWithGrammerCheck"
	TabletVK                           = "tabletVK"
...
func init() {
	...
	testing.AddFixture(&testing.Fixture{
		Name: ClamshellNonVKWithGrammerCheck,
		Desc: "Clamshell mode with VK disabled and grammer check",
		Contacts: []string{
			"alvinjia@google.com",
			"shengjun@chromium.org",
			"essential-inputs-team@google.com",
