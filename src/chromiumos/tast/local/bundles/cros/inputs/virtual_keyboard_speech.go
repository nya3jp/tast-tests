		...
		Params: []testing.Param{
			{
				...
				ExtraData:         data.ExtractExternalFiles(voiceTestMessages, voiceTestIMEs),
				Val:               voiceTestIMEs,
			},
			{
				Name:              "newdata", // This test will be merged into CQ once it is proved to be stable.
				ExtraData:         data.ExtractExternalFiles(voiceTestMessages, voiceTestIMEsNewData),
			...
			{
				Name:              "informational",
				ExtraData:         data.ExtractExternalFiles(voiceTestMessages, append(voiceTestIMEs, voiceTestIMEsNewData...)),
