...
func PhysicalKeyboardMultiwordSuggestion(ctx context.Context, s *testing.State) {
	...
	//   in future runs of the test. Update these tests to capture the candidate shown on screen and
	...
	subtests := []struct {
		...
		{
			// Trigger suggestion "how are you" and insert into textfield with tab.
		...
		{
			// Trigger suggestion "how are you" and insert into textfield with down + enter key.
		...
		{
			// Trigger suggestion "my name is" and dismiss with multiple white space at the end
			// of the text.
		...
		{
			// Trigger suggestion "how are you", partially type suggestion, and dismiss suggestion
			// by deleting text beyond suggestion trigger point.
