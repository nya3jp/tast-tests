...
func init() {
	testing.AddTest(&testing.Test{
		//TODO(b/210370410): Merge VirtualKeyboardTypingOmniboxUserAction to VirtualKeyboardTypingOmnibox.
		Func:         VirtualKeyboardTypingOmniboxUserAction,
...
func VirtualKeyboardTypingOmniboxUserAction(ctx context.Context, s *testing.State) {
