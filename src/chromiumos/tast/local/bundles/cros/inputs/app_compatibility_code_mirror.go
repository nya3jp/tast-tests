...
func init() {
	testing.AddTest(&testing.Test{
		...
		Data:         []string{"app_compatibility_code_mirror.html", "third_party/codemirror/codemirror.min.js", "third_party/codemirror/codemirror.min.css"},
...
func AppCompatibilityCodeMirror(ctx context.Context, s *testing.State) {
	...
	its, err := testserver.LaunchBrowserWithServer(ctx, s.FixtValue().(fixture.FixtData).BrowserType, cr, tconn,
		httptest.NewServer(http.FileServer(s.DataFileSystem())), "app_compatibility_code_mirror.html")
	if err != nil {
