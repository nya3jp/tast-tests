...
// It forces device to be clamshell mode and vk disabled.
// It restart Chrome session and login as new user for each test.
var NonVKClamshellReset = inputsPreCondition("non_vk_clamshell_pre_reset", clamshellMode, false, true)
