...
func init() {
	testing.AddTest(&testing.Test{
		Func: ScreenCaptureNotification, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Test the behavior of screen capture notification and make sure that the clipboard and actions buttons work correctly after taking the screenshot",
