...
func init() {
	testing.AddTest(&testing.Test{
		Func: SilencePhone, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Checks that toggling Phone Hub's \"Silence phone\" pod will toggle do-not-disturb on the Android phone",
		Contacts: []string{
