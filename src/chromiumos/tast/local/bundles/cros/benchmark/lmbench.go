...
const (
	...
	benchmarkFilename = "2160p_60fps_600frames_20181225.h264.mp4"
	// lmbenchPerfPrefix is the performance value prefix
	lmbenchPerfPrefix = "Benchmark.LMBench."
)
...
func LMbench(ctx context.Context, s *testing.State) {
	...
	*/
	...
	frdRun := runInfo{"bw_file_rd", "bw_file_rd", parseBandwidthOutput, []commandOpt{
		...
		{"1k", []string{"1k", "io_only", s.DataPath(benchmarkFilename)}},
		{"512k", []string{"512k", "io_only", s.DataPath(benchmarkFilename)}},
		{"1m", []string{"1m", "io_only", s.DataPath(benchmarkFilename)}},
		{"40m", []string{"40m", "io_only", s.DataPath(benchmarkFilename)}},
	}}
