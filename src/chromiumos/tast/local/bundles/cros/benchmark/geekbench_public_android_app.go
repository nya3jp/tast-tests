...
func init() {
	testing.AddTest(&testing.Test{
		Func: GeekbenchPublicAndroidApp, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Execute Geekbench public Android App to do benchmark testing and retrieve the results",
