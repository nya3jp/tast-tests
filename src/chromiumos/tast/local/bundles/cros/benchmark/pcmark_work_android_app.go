...
func installPCMarkComponents(ctx context.Context, uiDevice *ui.Device) (*ui.Object, error) {
	...
	if err := testing.Poll(ctx, func(ctx context.Context) error {
		if btnRun = findButtonWithText(ctx, uiDevice, "RUN"); btnRun != nil {
			return nil
		}
		if btnInstall = findButtonMatchText(ctx, uiDevice, `INSTALL\(.*\)`); btnInstall != nil {
			return nil
		}
	...
	if btnRun == nil && btnInstall != nil {
		...
		btnConfirm := findButtonWithText(ctx, uiDevice, "INSTALL")
		if btnConfirm == nil {
...
// findButtonWithText finds button with certain text of PCMark.
...
func findButtonWithText(ctx context.Context, d *ui.Device, text string) (obj *ui.Object) {
...
// findButtonMatchText finds button match certain regexp of PCMark.
// can change accross different runs - the text string might be in
// "field: text" or "field: content-description".
// Here use multiple ui.SelectorOption to find a ui object.
func findButtonMatchText(ctx context.Context, d *ui.Device, reg string) (obj *ui.Object) {
