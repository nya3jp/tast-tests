...
func init() {
	testing.AddTest(&testing.Test{
		Func:     Geekbench5AndroidApp,
		Desc:     "Execute Geekbench 5 Android App to do benchmark testing and retrieve the results",
...
func Geekbench5AndroidApp(ctx context.Context, s *testing.State) {
