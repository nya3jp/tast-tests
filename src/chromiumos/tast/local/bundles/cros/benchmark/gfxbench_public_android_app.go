...
func init() {
	testing.AddTest(&testing.Test{
		Func: GFXBenchPublicAndroidApp, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Execute GFXBench public Android App to do benchmark testing and retrieve the results",
