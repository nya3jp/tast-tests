...
func init() {
	testing.AddTest(&testing.Test{
		...
		// which shouldn't be needed until March 2023.  TODO(b/232007196) Double check in November 2022 that the
		// LaCros migration did not introduce any changes that impacted this test.
		Contacts: []string{
			"sukhomlinov@chromium.org", // CR50 certification lead, Test owner
			"mruthven@chromium.org",    // Cr50 Lead.
		},
