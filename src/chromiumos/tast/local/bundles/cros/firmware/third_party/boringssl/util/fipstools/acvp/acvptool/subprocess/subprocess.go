...
// NewCr50 returns a new Subprocess middle layer with the given ReadCloser and WriteCloser
func NewCr50(cmd *exec.Cmd, in io.WriteCloser, out io.ReadCloser) (*Subprocess, error) {
	m := &Subprocess{
		cmd:	cmd,
		stdin:  in,
		stdout: out,
