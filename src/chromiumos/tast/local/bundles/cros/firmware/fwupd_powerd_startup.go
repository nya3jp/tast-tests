...
/* FwupdPowerdEnabled runs fwupdmgr get-plugins, retrieves the output, and checks for powerd */
func FwupdPowerdEnabled(ctx context.Context, s *testing.State) {
