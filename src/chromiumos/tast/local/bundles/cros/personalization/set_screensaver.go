...
func init() {
	testing.AddTest(&testing.Test{
		...
		Params: []testing.Param{
			...
			// For animated themes:
			// * Their image handling is to the topic source, so it would be a waste
			//	 of test time/resources to test all topic sources for each theme.
			// * ArtGallery is chosen as the topic source since some of the photos
			//	 may have attribution text (whereas personal photos do not). This
			//	 gives the test better coverage since attribution text handling is
			//	 not trivial.
			{
