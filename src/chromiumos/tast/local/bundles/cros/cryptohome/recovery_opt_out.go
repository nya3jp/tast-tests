...
func RecoveryOptOut(ctx context.Context, s *testing.State) {
	...
	if err := util.SaveLoginData(ctx, daemonController, dataPath, false /*includeTmp*/); err != nil {
	...
	if err := util.LoadLoginData(ctx, daemonController, dataPath, false /*includeTmp*/); err != nil {
