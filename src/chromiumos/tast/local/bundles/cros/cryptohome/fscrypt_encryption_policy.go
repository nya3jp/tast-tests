...
func init() {
	testing.AddTest(&testing.Test{
		Func: FscryptEncryptionPolicy, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Check fscrypt encryption policy version of a newly created user cryptohome",
		Contacts: []string{
