...
type TestParams struct {
	...
	FrameStats        *perf2.FrameLatencyStats
}
...
func StartBenchmarking(ctx context.Context, params *TestParams) error {
	...
	params.FrameStats = perf2.NewFrameLatencyStats(params.AppPkgName, params.AppActivityName, params.Arc)
	if err := params.FrameStats.StartSurfaceFlinger(ctx); err != nil {
...
func StopBenchmarking(ctx context.Context, params *TestParams) (results BenchmarkResults, err error) {
	...
	r.SurfaceFlingerFPS, r.SurfaceFlingerLatency, err = params.FrameStats.StopSurfaceFlinger(ctx)
	if err != nil {
