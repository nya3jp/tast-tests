...
// GetFramesData gets frames data including decoded frames, dropped frames and dropped frames percent.
func (v *CrosVideo) GetFramesData(ctx context.Context) (decodedFrames, droppedFrames, droppedFramesPer float64, err error) {
