...
func UniformScaleFactor(ctx context.Context, s *testing.State) {
	...
	// Invoke a mouse click (rather than using click from UI automator), as this causes the caption bar
	// to be shown unnecessarily. This occurs as the events from UI automator aren't forwarded to Chrome.
