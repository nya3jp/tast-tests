...
func TestSoftwareDeps(t *gotesting.T) {
	testcheck.SoftwareDeps(t, testcheck.Glob(t, pattern), []string{"chrome", "android|android_vm|android_both|android_p|android_p_both|android_r|android_all|android_all_both"})
}
