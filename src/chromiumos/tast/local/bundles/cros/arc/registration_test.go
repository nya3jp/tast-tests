...
func TestSoftwareDeps(t *testing.T) {
	testcheck.SoftwareDeps(t, pattern, []string{"chrome", "android|android_vm|android_both|android_p|android_p_vm|android_p_both|android_all|android_all_vm|android_all_both"})
}
