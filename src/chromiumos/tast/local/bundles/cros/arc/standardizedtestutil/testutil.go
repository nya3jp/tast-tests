...
func TouchscreenZoom(ctx context.Context, touchScreen *input.TouchscreenEventWriter, testParameters TestFuncParams, selector *ui.Object, zoomType ZoomType) error {
	const (
		zoomDistanceAsPercentOfTouchscreen = .15
	...
	zoomDistancePerFinger := math.Min(float64(touchScreen.Width()), float64(touchScreen.Height())) * zoomDistanceAsPercentOfTouchscreen
