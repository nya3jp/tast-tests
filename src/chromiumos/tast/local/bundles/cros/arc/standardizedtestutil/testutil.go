...
func TouchscreenTap(ctx context.Context, testParameters TestFuncParams, selector *ui.Object, tapType TouchscreenTapType) error {
	touchScreen, err := GetStandardizedTouchscreen(ctx, testParameters.TestConn)
	if err != nil {
...
// GetStandardizedTouchscreen returns a touchscreen that has been configured to
// work on all DUTs.
func GetStandardizedTouchscreen(ctx context.Context, tconn *chrome.TestConn) (*StandardizedTouchscreen, error) {
