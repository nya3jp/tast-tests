...
func init() {
	testing.AddTest(&testing.Test{
		Func: WMResizableClamshell, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Verifies that Window Manager resizable clamshell use-cases behave as described in go/arc-wm-r",
