...
func init() {
	testing.AddTest(&testing.Test{
		...
		// Also, skipping running the test on such devices to save lab time.
...
func CheckAndroidARM64Support(ctx context.Context, s *testing.State) {
	...
	// If Native x86_64 support is present and ARM64 support is absent, test will fail unless board is added in the Hardware dependencies skip list above
