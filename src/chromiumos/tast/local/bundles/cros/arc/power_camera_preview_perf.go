...
func init() {
	testing.AddTest(&testing.Test{
		Func: PowerCameraPreviewPerf, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Measures the battery drain and camera statistics (e.g., dropped frames) during camera preview at 30/60 FPS",
		Contacts: []string{
