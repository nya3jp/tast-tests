...
func init() {
	testing.AddTest(&testing.Test{
		...
		Desc:         "Makes sure that Play Store remains open for several minutes",
...
func waitForDailyHygieneDone(ctx context.Context, s *testing.State) error {
...
func PlayStorePersistent(ctx context.Context, s *testing.State) {
	...
	if err := waitForDailyHygieneDone(ctx, s); err != nil {
