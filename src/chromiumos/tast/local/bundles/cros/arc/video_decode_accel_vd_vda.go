...
func init() {
	testing.AddTest(&testing.Test{
		Func: VideoDecodeAccelVDVDA, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Verifies hardware decode acceleration using a media::VideoDecoder through the VDA interface, by running the video_decode_accelerator_tests binary (see go/vd-migration)",
