...
func init() {
	testing.AddTest(&testing.Test{
		Func: WindowManagerCUJ, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Verifies that Window Manager Critical User Journey behaves as described in go/arc-wm-p",
