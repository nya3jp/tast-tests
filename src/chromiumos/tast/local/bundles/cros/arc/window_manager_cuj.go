...
// For the moment VM and container are sharing the same list of stable and flaky tests.
...
// New and flaky tests should be placed here. These tests should be fixed, and moved them to "stable" ASAP.
var flakyCUJTests = []wmCUJTestParams{
