...
// focusChangeTest tests the virtual keyboard behavior when the focus moves programatically.
func focusChangeTest(ctx context.Context, tconn *chrome.TestConn, d *ui.Device, s *testing.State) {
	...
	// Focusing on the text field programatically should not show the virtual keyboard.
	...
	// when the focus is moved between the text fields programatically.
