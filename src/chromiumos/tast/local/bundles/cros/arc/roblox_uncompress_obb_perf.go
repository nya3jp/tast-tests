...
func init() {
	testing.AddTest(&testing.Test{
		Func: RobloxUncompressOBBPerf, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Measures time it takes to uncompress Roblox OBB file",
		Contacts: []string{
...
func RobloxUncompressOBBPerf(ctx context.Context, s *testing.State) {
	...
	for scanner.Scan() {
		...
		if err != nil {
			s.Fatal("Failed to extract time: ", err)
		}
		break
	}
