...
// Scope is go binding of "scope" attribute in the value
// passed to chrome.proxy.settings.set.
type Scope string

const (
	// ScopeRegular represents "regular" scope.
	ScopeRegular Scope = "regular"
	// Skip other Scope definitions.
)
