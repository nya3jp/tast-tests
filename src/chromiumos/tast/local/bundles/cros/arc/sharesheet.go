...
func Sharesheet(ctx context.Context, s *testing.State) {
	...
	if err := clickAppOnStableSharesheet(ctx, files, &pollOpts, tconn, appShareLabel); err != nil {
...
func clickAppOnStableSharesheet(ctx context.Context, f *filesapp.FilesApp, pollOpts *testing.PollOptions, tconn *chrome.TestConn, appShareLabel string) error {
