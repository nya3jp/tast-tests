...
func init() {
	testing.AddTest(&testing.Test{
		Func:         VideoDecodeAccelVDVDAPerfLacros,
		...
		SoftwareDeps: []string{"arc", "chrome", "video_decoder_direct", "lacros"},
...
func VideoDecodeAccelVDVDAPerfLacros(ctx context.Context, s *testing.State) {
