...
func init() {
	testing.AddTest(&testing.Test{
		Func: GamePerformanceRender, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Captures set of performance metrics for the render and upload it to the server",
