...
type inputDevice struct {
	...
	SupportedKeyCodes map[string]bool `json:"supported_key_codes"`
}
...
func verifyGamepadDeviceInfo(s *testing.State, gp *input.GamepadEventWriter, d *inputDevice) {
	...
	supportedKeyCodeMapping := map[string]bool{
		"96":  true,  // KEYCODE_BUTTON_A
		"97":  true,  // KEYCODE_BUTTON_B
		"108": true,  // KEYCODE_BUTTON_START
		"109": true,  // KEYCODE_BUTTON_SELECT
		"110": true,  // KEYCODE_BUTTON_MODE
		"29":  false, // KEYCODE_A
		"30":  false, // KEYCODE_B
	}
	...
	for keyCode, isSupported := range d.SupportedKeyCodes {
		expectSupport := supportedKeyCodeMapping[keyCode]
		if isSupported != expectSupport {
