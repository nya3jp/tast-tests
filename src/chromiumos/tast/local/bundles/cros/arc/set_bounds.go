...
const (
	...
	setBoundsAppInitHeight = 600
	setBoundsAppInitWidth  = 700
)
...
var setBoundsAppRegularBounds = arc.Rect{Left: 100, Top: 100, Width: 800, Height: 800}
...
var setBoundsAppSmallBounds = arc.Rect{Left: 200, Top: 200, Width: 600, Height: 500}
...
func setBoundsSubTest(ctx context.Context, a *arc.ARC, d *ui.Device, actName string, resizable bool) error {
	...
	if activityBounds.Height != setBoundsAppInitHeight || activityBounds.Width != setBoundsAppInitWidth {
		return errors.Errorf("unexpected initial window size: got (%d, %d); want (%d, %d)", activityBounds.Width, activityBounds.Height, setBoundsAppInitHeight, setBoundsAppInitWidth)
	}
	...
	for _, appControlled := range []bool{false, true} {
		...
		clickButtonAndValidateBounds(regularButtonID, setBoundsAppRegularBounds)
