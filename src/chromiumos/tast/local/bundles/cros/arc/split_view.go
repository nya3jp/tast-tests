...
func SplitView(ctx context.Context, s *testing.State) {
	...
	if err := wm.DragToSnapFirstOverviewWindow(ctx, tconn, ui, pc, true /* primary */); err != nil {
	...
	if err := wm.DragToSnapFirstOverviewWindow(ctx, tconn, ui, pc, false /* primary */); err != nil {
