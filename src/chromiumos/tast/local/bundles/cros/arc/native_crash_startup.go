...
func NativeCrashStartup(ctx context.Context, s *testing.State) {
	...
	// To make the situation that there are some logs when ARCVM boots, stop ArcCrashCollector service, make crashes while it stops, and reboot ARCVM. We cannot kill the service because it restarts automatically.
