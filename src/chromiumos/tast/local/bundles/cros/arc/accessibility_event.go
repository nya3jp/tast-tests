...
func AccessibilityEvent(ctx context.Context, s *testing.State) {
	...
	if err := focusAndIncrementElement(ctx, chromeVoxConn, seekBarLogs, seekBarNode, seekBarExpectedValue); err != nil {
	...
	if err := focusAndIncrementElement(ctx, chromeVoxConn, seekBarDiscreteLogs, seekBarDiscreteNode, seekBarDiscreteExpectedValue); err != nil {
