...
func init() {
	testing.AddTest(&testing.Test{
		Func: VideoDecodeAccelPerf, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Measures ARC++ hardware video decode performance by running the c2_e2e_test APK",
