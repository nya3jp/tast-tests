...
func DragToSnapFirstOverviewWindow(ctx context.Context, tconn *chrome.TestConn, ui *uiauto.Context, pc pointer.Context, primary bool) error {
	...
	if err := pc.Drag(center, ui.Sleep(2*time.Second), pc.DragTo(target, time.Second))(ctx); err != nil {
