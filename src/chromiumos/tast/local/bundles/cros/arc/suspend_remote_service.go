...
func init() {
	testing.AddService(&testing.Service{
		Register: func(srv *grpc.Server, s *testing.ServiceState) {
			arcpb.RegisterSuspendRemoteServiceServer(srv, &SuspendRemoteService{s: s})
		},
	})
}

type SuspendRemoteService struct {
...
func (c *SuspendRemoteService) Prepare(ctx context.Context, req *empty.Empty) (*arcpb.SuspendRemoteServiceParams, error) {
	testing.ContextLog(ctx, "Prepare start")
	...
	res := &arcpb.SuspendRemoteServiceParams{}
	res.ReadClocksPathInArc = readclocksPath
	testing.ContextLog(ctx, "Prepare end")
	return res, nil
}
...
func (c *SuspendRemoteService) GetClockValues(ctx context.Context, params *arcpb.SuspendRemoteServiceParams) (*arcpb.GetClockValuesResponse, error) {
