...
func (c *SuspendRemoteService) GetClockValues(ctx context.Context, req *empty.Empty) (*arcpb.GetClockValuesResponse, error) {
	/*
		const (
	...
	*/
	...
	res.ClockMonotonicNs = 123
	res.ClockBoottimeNs = 456
	res.Tsc = 789
	return res, nil
}
