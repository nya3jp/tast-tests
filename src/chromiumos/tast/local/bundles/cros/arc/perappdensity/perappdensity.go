...
// Package perappdensity contains test logic to change density and confirm changes.
...
// RunTest installs an apk which contains a black square.
// The test then increases and decreases the screen density, confirming that the change occurred by verifying
