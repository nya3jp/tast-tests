...
func VirtualDesks(ctx context.Context, s *testing.State) {
	...
	result, err := deskContainsWindow(ctx, tconn, "Desk_Container_B", "ExoShellSurface")
	if err != nil {
	...
	result, err = deskContainsWindow(ctx, tconn, "Desk_Container_A", "BrowserFrame")
	if err != nil {
		s.Fatal("deskContainsWindow Failed: ", err)
	}
	if !result {
	...
	result, err = deskContainsWindow(ctx, tconn, "Desk_Container_A", "ExoShellSurface")
	if err != nil {
		s.Fatal("deskContainsWindow Failed: ", err)
	}
	if result {
