...
func init() {
	testing.AddTest(&testing.Test{
		Func: StandardizedTrackpadZoom, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Functional test that installs an app and tests standard trackpad zoom in and zoom out functionality. Tests are only performed in clamshell mode as tablets don't support the trackpad",
