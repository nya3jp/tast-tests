...
func TextToSpeech(ctx context.Context, s *testing.State) {
	const (
		...
		// /storage/emulated/0/Android/data/org.chromium.arc.testapp.tts/files/Download/ttsoutput.txt
		//ttsOutputPath = "/storage/emulated/0/Android/data/org.chromium.arc.testapp.tts/files/Download/ttsoutput.txt"
	...
	speakScript := fmt.Sprintf("tast.promisify(chrome.tts.speak(%q, {'voiceName': %q, 'rate': 2.0, 'volume': 0}))", speakText, voiceName)
