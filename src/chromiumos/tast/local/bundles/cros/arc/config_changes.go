...
func init() {
	testing.AddTest(&testing.Test{
		Func: ConfigChanges, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Verifies that configChanges property in AndroidManifest.xml prevents an activity to restart on the configuration update",
