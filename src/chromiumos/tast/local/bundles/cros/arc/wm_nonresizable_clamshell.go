...
func WMNonresizableClamshell(ctx context.Context, s *testing.State) {
	...
	wmApkToInstall := []string{wm.APKNameArcWMTestApp24}
	...
	cleanup, err := ash.EnsureTabletModeEnabled(ctx, tconn, tabletModeEnabled)
...
// Expected behavior is defined in: go/arc-wm-r NC01: non-resizable/clamshell: default launch behavior (slide #50)
