...
func init() {
	testing.AddTest(&testing.Test{
		Func: StandardizedMouseScroll, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Functional test that installs an app and tests that a standard mouse scroll up, an down works",
