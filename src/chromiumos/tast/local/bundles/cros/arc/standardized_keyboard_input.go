...
func init() {
	testing.AddTest(&testing.Test{
		Func:         StandardizedKeyboardInput,
...
// StandardizedKeyboardInput runs all the provided test cases.
func StandardizedKeyboardInput(ctx context.Context, s *testing.State) {
	const (
