...
func init() {
	testing.AddTest(&testing.Test{
		Func: OptInAfterInterruption, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Verify ARC Provisioning completes even with interruptions by restarting Chrome",
		Contacts: []string{
