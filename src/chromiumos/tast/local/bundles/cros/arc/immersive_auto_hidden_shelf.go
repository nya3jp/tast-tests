...
func init() {
	testing.AddTest(&testing.Test{
		Func: ImmersiveAutoHiddenShelf, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Tests that the shelf is auto-hidden after launching an immersive ARC application",
		Contacts: []string{
