...
func init() {
	testing.AddTest(&testing.Test{
		Func: WMNonresizableConversion, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Verifies that Window Manager non-resizable/conversion use-cases behaves as described in go/arc-wm-r",
