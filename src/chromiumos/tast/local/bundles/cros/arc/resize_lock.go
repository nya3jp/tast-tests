...
// testUnresizableResizability verifies that an unresizable app is unresizable.
...
// testResizeLockedResizableActivitySplash verifies that a resize-locked app shows the splash screen for compatibility mode if it's the first launch after installation.
...
// testUnresizableSplash verifies that a unresizable app doesn't show the splash screen for compatibility mode.
