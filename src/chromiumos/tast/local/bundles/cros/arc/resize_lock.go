...
func testResizeLockedAppCUJ(ctx context.Context, tconn *chrome.TestConn, a *arc.ARC, d *ui.Device, cr *chrome.Chrome) error {
	...
	if err := toggleAppManagementPage(ctx, tconn, a, d, cr, activity, resizeLockAppName, resizableResizeLockMode, phoneResizeLockMode); err != nil {
	...
	if err := toggleAppManagementPage(ctx, tconn, a, d, cr, activity, resizeLockAppName, phoneResizeLockMode, resizableResizeLockMode); err != nil {
...
// toggleAppManagementPage opens the app-management page for the given app via the shelf icon, toggles the resize lock setting, and verifies the states of the app and the setting toggle.
func toggleAppManagementPage(ctx context.Context, tconn *chrome.TestConn, a *arc.ARC, d *ui.Device, cr *chrome.Chrome, activity *arc.Activity, appName string, currentMode, nextMode resizeLockMode) error {
