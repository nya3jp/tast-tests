...
//    fs - aggregation per fiel system, for example vda. It includes all operation on this fs
//    fsop - similar to above but provide extra separation per operatio, open, read, page_fault, write
//    file - aggregation per particular file
// |threshold| specifies mininum time to reports in CPU ticks. Note, it is usually mapped to
//  fixed 1.60GHz.
