...
func TestOpenWithAndroidApp(ctx context.Context, s *testing.State, a *arc.ARC, cr *chrome.Chrome, dir Directory, expectations []Expectation) {
	...
	if err := openWithReaderApp(ctx, a, cr, files, dir, expectations); err != nil {
...
func openWithReaderApp(ctx context.Context, a *arc.ARC, cr *chrome.Chrome, files *filesapp.FilesApp, dir Directory, expectations []Expectation) error {
