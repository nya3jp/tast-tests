	...
	testing.AddTest(&testing.Test{
		...
		Params: []testing.Param{
			...
			},
			{
				...
				Timeout: nearbycommon.DetectionTimeout + nearbycommon.ExtraLargeFileOnlineTransferTimeout + largeFileCheckboxTimeout,
			},
			{
...
// shareUIClickWithTimeout sends a "Click" message to an UI Object and verify
// if it exits and is enabled within |t| timeout duration.
...
// shareUIClick calls shareUIClickWithTimeout with default timeout duration.
