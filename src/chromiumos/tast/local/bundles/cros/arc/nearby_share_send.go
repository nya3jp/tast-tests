...
func NearbyShareSend(ctx context.Context, s *testing.State) {
	...
	testCheckBoxItem := d.Object(ui.ClassName(checkBoxClassName), shareUIID(testData.Filename))
	...
	if err = shareUIClick(ctx, d, ui.ClassName(checkBoxClassName), shareUIID(testData.Filename)); err != nil {
