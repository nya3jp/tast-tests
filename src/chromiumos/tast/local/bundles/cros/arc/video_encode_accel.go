...
// deviceBlacklist is the list of devices we want to disable these tests on.
var deviceBlacklist = []string{
...
func init() {
	testing.AddTest(&testing.Test{
		...
		HardwareDeps: hwdep.D(hwdep.SkipOnPlatform(deviceBlacklist...)),
		...
		Params: []testing.Param{{
			...
			// Disabled by default until b/140082257 is finished.
