...
const (
	...
	// With some calculation, we expect the error could be a maximum of 2 pixles, but we use 1-pixel larger value just in case.
...
// waitForNewBoundsWithMergin waits until Chrome animation finishes completely and check the position of an edge of the PIP window.
