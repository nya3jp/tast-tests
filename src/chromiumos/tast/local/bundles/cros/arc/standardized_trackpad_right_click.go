...
func init() {
	testing.AddTest(&testing.Test{
		Func: StandardizedTrackpadRightClick, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Functional test that installs an app and tests standard trackpad right click functionality. Tests are only performed in clamshell mode as tablets don't support the trackpad",
