...
func init() {
	testing.AddTest(&testing.Test{
		...
		SoftwareDeps: []string{"chrome", "android_vm", "lacros"},
		Fixture:      "lacrosWithArcBootedWithVideoLoggingVD",
...
func VideoDecodeAccelVDLacros(ctx context.Context, s *testing.State) {
