...
func RunTestWithWMParams(ctx context.Context, s *testing.State, tconn *chrome.TestConn, d *ui.Device, a *arc.ARC, params *WMTestParams, testName string, testFunc WMTestFunc) {
	t := &WMTestState{}
	...
	s.Run(ctx, params.Name+": "+testName, func(ctx context.Context, s *testing.State) {
