...
func init() {
	testing.AddTest(&testing.Test{
		Func: StandardizedTouchscreenLongTap, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Functional test that installs an app and tests that a standard touchscreen long tap works",
