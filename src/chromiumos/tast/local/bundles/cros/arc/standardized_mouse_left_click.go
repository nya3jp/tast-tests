...
func init() {
	testing.AddTest(&testing.Test{
		Func: StandardizedMouseLeftClick, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Functional test that installs an app and tests standard mouse left click functionality. Tests are only performed in clamshell mode as tablets don't allow mice",
