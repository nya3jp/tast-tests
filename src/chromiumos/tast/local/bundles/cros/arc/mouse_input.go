...
func verifyMouse(ctx context.Context, s *testing.State, tconn *chrome.TestConn, t *motioninput.WMTestState, tester *motioninput.Tester) {
	...
	// The sequence of sequence of events reported for ARC++ P and newer versions differ, and this
	// test takes those into account. In particular, P reports HOVER_EXIT and HOVER_ENTER before
