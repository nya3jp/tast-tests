...
func ResizeActivity(ctx context.Context, s *testing.State) {
	...
	for _, entry := range []struct {
		...
		{arc.BorderRight, bounds.Right + 400, centerHeight, 200 * time.Millisecond},
