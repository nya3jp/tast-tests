...
func ResizeActivity(ctx context.Context, s *testing.State) {
	...
	// Hide shelf. Maximum screen real-estate is needed, specially for devices where its height is as high
	...
	const marginForTouch = 100 // shelf height + extra room for touch
