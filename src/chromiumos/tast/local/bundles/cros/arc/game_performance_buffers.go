...
func init() {
	testing.AddTest(&testing.Test{
		Func: GamePerformanceBuffers, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Captures set of performance metrics for buffers and upload it to the server",
