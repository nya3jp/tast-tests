...
func SmartSelectionChrome(ctx context.Context, s *testing.State) {
	...
	if err := ui.WithTimeout(30 * time.Second).WaitUntilExists(address)(ctx); err != nil {
