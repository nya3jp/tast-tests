...
func init() {
	testing.AddTest(&testing.Test{
		Func: StandardizedMouseHover, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Functional test that installs an app and tests standard mouse hover functionality. Tests are only performed in clamshell mode as tablets don't allow mice",
