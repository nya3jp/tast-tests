...
func init() {
	testing.AddTest(&testing.Test{
		Func: UnicornCannotAddNonEduAccount, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Veirfy that unicorn account cannot add a non-EDU secondary android account",
