...
// StartChrome starts Chrome calling chrome.New() with accessibility enabled.
...
// InstallAndStartAccessibilityApp starts the test application, and checks that UI components exist.
func InstallAndStartAccessibilityApp(ctx context.Context, a *arc.ARC, apkPath string) error {
