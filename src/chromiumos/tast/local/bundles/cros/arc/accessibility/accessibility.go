...
// SendKeystroke invokes the specified keystrokes to ChromeVox, and performs the function afterwards.
func SendKeystroke(ctx context.Context, chromeVoxConn *chrome.Conn, key, wantString string, f func() error) error {
