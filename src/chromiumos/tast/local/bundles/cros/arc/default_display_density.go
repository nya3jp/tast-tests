...
func DefaultDisplayDensity(ctx context.Context, s *testing.State) {
	...
	expectedDpi := getClosestCtsApprovedDensityDpi(calculatedDpi)
...
func getClosestCtsApprovedDensityDpi(dpi float64) (bestDpi int) {
	...
	// If calculated_dpi falls exactly in the middle of two buckets, we pick the larger bucket.
