...
func init() {
	testing.AddTest(&testing.Test{
		Func: WMResizableConversion, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Verifies that Window Manager resizable/conversion use-cases behaves as described in go/arc-wm-r",
