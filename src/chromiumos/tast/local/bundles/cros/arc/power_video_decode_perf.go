...
func PowerVideoDecodePerf(ctx context.Context, s *testing.State) {
	...
	sup.Add(setup.StartActivity(ctx, tconn, a, c2e2etest.Pkg, c2e2etest.ActivityName, arc.WithExtraStringArray("test-args", testArgs), arc.WithExtraString("log-file", filepath.Join(arcFilePath, logFileName))))
