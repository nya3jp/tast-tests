...
func runARCVideoEncoderTest(ctx context.Context, s *testing.State, a *arc.ARC,
	opts encoding.TestOptions, cacheExtractedVideo bool, pv *perf.Values, bas ...binArgs) {
	...
	err = encoding.PrepareYUV(ctx, s.DataPath(params.Name), streamPath, opts.PixelFormat, params.Size)
	if err != nil {
...
func RunARCVideoTest(ctx context.Context, s *testing.State, a *arc.ARC,
	...
	runARCVideoEncoderTest(ctx, s, a, opts, cacheExtractedVideo, nil, binArgs{testFilter: "C2VideoEncoderE2ETest.TestSimpleEncode"})
}
...
func RunARCPerfVideoTest(ctx context.Context, s *testing.State, a *arc.ARC,
	...
	pv := perf.NewValues()
	runARCVideoEncoderTest(ctx, s, a, opts, cacheExtractedVideo, pv,
