...
func AccessibilityTree(ctx context.Context, s *testing.State) {
	accessibility.RunTest(ctx, s, []accessibility.TestActivity{accessibility.MainActivity, accessibility.EditTextActivity}, func(ctx context.Context, a *arc.ARC, cvconn *chrome.Conn, tconn *chrome.TestConn, ew *input.KeyboardEventWriter, currentActivity accessibility.TestActivity) error {
