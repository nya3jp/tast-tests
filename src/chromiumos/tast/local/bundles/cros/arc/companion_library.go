...
func testPopupWindow(ctx context.Context, cr *chrome.Chrome, tconn *chrome.Conn, act *arc.Activity, d *ui.Device) error {
	...
	setWindowBounds(ctx, d, coords.Rect{Left: 0, Top: 0, Width: 0, Height: dispMode.HeightInNativePixels})
...
func testWindowBounds(ctx context.Context, tconn *chrome.Conn, act *arc.Activity, d *ui.Device) error {
	...
	for _, test := range []struct {
		...
		{"trigger min size limit", coords.Rect{Left: 0, Top: 0, Width: 0, Height: 0}, coords.Rect{Left: 0, Top: captionHeight, Width: minimizeSize, Height: minimizeSize}},
		{"trigger min size limit again", coords.Rect{Left: 0, Top: captionHeight / 2, Width: minimizeSize / 2, Height: minimizeSize / 2}, coords.Rect{Left: 0, Top: captionHeight, Width: minimizeSize, Height: minimizeSize}},
		{"fullscreen size", coords.Rect{Left: 0, Top: 0, Width: dispMode.WidthInNativePixels, Height: dispMode.HeightInNativePixels}, coords.Rect{Left: 0, Top: captionHeight, Width: dispMode.WidthInNativePixels, Height: dispMode.HeightInNativePixels - captionHeight - shelfHeightPX}}, // Auto maximize. It means the edge will not over the shelf
	} {
...
func windowBounds(ctx context.Context, d *ui.Device) (coords.Rect, error) {
	...
	parseBoundFromMsg := func(msg *companionLibMessage) (coords.Rect, error) {
		...
		return coords.Rect{Left: left, Top: top, Width: right - left, Height: bottom - top}, nil
	}
