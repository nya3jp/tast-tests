...
func init() {
	testing.AddTest(&testing.Test{
		Func: Cgroups, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Checks that foreground/background status of ARC applications reflects properly in cgroup limits",
