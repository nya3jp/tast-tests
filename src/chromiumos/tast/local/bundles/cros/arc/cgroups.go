...
func Cgroups(ctx context.Context, s *testing.State) {
	...
	// Polling to see when this changes to the right value, wait up to 10 seconds.
	var sharePollOpts *testing.PollOptions = &testing.PollOptions{Timeout: 10 * time.Second}
