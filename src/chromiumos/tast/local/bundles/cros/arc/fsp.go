...
func Fsp(ctx context.Context, s *testing.State) {
	...
	if err := unzipFile(ctx, tconn, "My files", unarchiverName); err != nil {
...
func unzipFile(ctx context.Context, tconn *chrome.TestConn, folder, unarchiver string) error {
