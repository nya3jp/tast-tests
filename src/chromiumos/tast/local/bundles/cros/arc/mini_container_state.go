...
func init() {
	testing.AddTest(&testing.Test{
		Func: MiniContainerState, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Verifies ARC mini container starts right after Chrome OS shows the login screen",
		Contacts: []string{
