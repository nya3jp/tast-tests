...
// GetCaches waits for required caches are ready and copies them to the specified output directory.
func GetCaches(ctx context.Context, a *arc.ARC, outputDir string) error {
	const (
