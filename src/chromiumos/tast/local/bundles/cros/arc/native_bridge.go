...
const (
	// ARM executables compiled from the trivial hello_world.c with NDK tools.
	// Each file is uploaded to gs://chromiumos-test-assets-public/tast/cros/arc/
	// with its upload date appended to the end of the name.
...
func init() {
	testing.AddTest(&testing.Test{
		...
		SoftwareDeps: []string{"android_vm_r", "chrome"},
