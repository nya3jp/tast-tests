...
func runLeftClickTest(ctx context.Context, s *testing.State, testParameters standardizedtestutil.StandardizedTestFuncParams) {
	...
	if err := standardizedtestutil.StandardizedMouseClickObject(ctx, testParameters.TestConn, btnLeftClickSelector, standardizedtestutil.LeftMouseButton); err != nil {
