...
func init() {
	testing.AddTest(&testing.Test{
		...
		Params: []testing.Param{{
			...
			ExtraData: []string{
				arcSurfaceOrientationTestApkFilename,
			},
		}},
	})
}
...
// Values coming from:
// https://cs.android.com/android/platform/superproject/+/master:frameworks/native/libs/nativewindow/include/android/native_window.h;drc=50e37fefe51554d300c28b496c942c0bab299fee
const (
...
func SurfaceOrientation(ctx context.Context, s *testing.State) {
	...
	for _, tc := range []struct {
		...
		if err := d.WaitForIdle(ctx, 1*time.Second); err != nil {
