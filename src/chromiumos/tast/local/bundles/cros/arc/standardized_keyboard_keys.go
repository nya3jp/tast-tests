...
func init() {
	testing.AddTest(&testing.Test{
		Func: StandardizedKeyboardKeys, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Functional test that installs an app and tests standard keyboard keys like arrows, esc, enter, etc. Test are performed in clamshell and touchview mode. This does not test the virtual, on-screen keyboard",
