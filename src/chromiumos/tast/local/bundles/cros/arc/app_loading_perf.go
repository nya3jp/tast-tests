...
var (
	...
	arcAppLoadingRtVcpuVMBooted = arc.NewPrecondition("arcapploading_rt_vcpu_vmbooted", arcAppLoadingGaia, append(arc.DisableSyncFlags(), "--enable-arcvm-rt-vcpu", "--ignore-arcvm-dev-conf", "--arc-disable-media-store-maintenance")...)
)
