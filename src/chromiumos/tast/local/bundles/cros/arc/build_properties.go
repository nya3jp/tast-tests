...
func init() {
	testing.AddTest(&testing.Test{
		Func: BuildProperties, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Checks important Android properties such as first_api_level",
...
func BuildProperties(ctx context.Context, s *testing.State) {
	...
	if arcSerialNo != arcBootSerialNo {
		...
		s.Error("Serial numbers ro.serialno & ro.boot.serialno are not set")
	}
...
// expectedFirstAPILevelMap is a map of device name -> expected first API level.
