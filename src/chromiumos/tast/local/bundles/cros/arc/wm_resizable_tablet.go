...
func init() {
	testing.AddTest(&testing.Test{
		Func: WMResizableTablet, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Verifies that Window Manager resizable tablet use-cases behave as described in go/arc-wm-r",
