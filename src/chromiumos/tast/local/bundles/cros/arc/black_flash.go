...
import (
	...
	"chromiumos/tast/local/bundles/cros/arc/tabletmode"
...
func BlackFlash(ctx context.Context, s *testing.State) {
	...
	tabletmode.RunTest(ctx, s, pkgName, activityName, apkName, false, func(a *arc.ARC, act *arc.Activity, tconn *chrome.Conn, cr *chrome.Chrome) {
