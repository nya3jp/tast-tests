...
func init() {
	testing.AddTest(&testing.Test{
		Func:         VideoEncodeAccelPerfLacros,
		...
		Fixture:      "lacrosWithArcBooted", // TODO(akahuang): Implement new precondition to boot ARC and enable verbose at chromium.
...
func VideoEncodeAccelPerfLacros(ctx context.Context, s *testing.State) {
