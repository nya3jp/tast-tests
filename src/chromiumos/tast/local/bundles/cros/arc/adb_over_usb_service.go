...
// EnableUDC enables or disables UDC. If initial setting is as the same as requested, it will be no-ops.
func (*ADBOverUSBService) EnableUDC(ctx context.Context, request *arcpb.EnableUDCRequest) (*arcpb.EnableUDCResponse, error) {
	...
	command := "dev_enable_udc=" + request.Enable
