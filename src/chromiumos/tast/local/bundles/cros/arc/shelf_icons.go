...
func init() {
	testing.AddTest(&testing.Test{
		Func: ShelfIcons, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Tests that ARC++ windows are represented in the shelf correctly, including grouping of windows and custom icons",
