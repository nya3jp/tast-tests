...
func init() {
	testing.AddTest(&testing.Test{
		Func: APIRoutineEnrolled, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Test sending RunRoutineRequest and GetRoutineUpdate gRPC requests from Wilco DTC VM to the Wilco DTC Support Daemon",
		Contacts: []string{
