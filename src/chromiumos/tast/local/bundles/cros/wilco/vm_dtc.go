...
func init() {
	testing.AddTest(&testing.Test{
		Func: VMDTC,
		Desc: "Starts an instance of the Wilco VM and tests the DTC (Diagnostics and Telemetry Controller) binaries using partner provided utilities",
		Contacts: []string{
...
func VMDTC(ctx context.Context, s *testing.State) {
	...
	if err := wilco.StartVM(startCtx, config); err != nil {
		s.Fatal("unable to start WilcoVM: ", err)
	}
