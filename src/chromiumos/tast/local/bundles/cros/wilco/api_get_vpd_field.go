...
func init() {
	testing.AddTest(&testing.Test{
		Func: APIGetVPDField, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Test sending GetVpdField gRPC request from Wilco DTC VM to the Wilco DTC Support Daemon",
		Contacts: []string{
