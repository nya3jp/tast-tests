...
func init() {
	testing.AddTest(&testing.Test{
		Func: APIHandleMessageFromUIEnrolled, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Test sending a message from a Chromium extension to the Wilco DTC VM",
		Contacts: []string{
