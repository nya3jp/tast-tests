...
func testCancel(
	...
	err := ui.RightClick(
		holdingspace.FindDownloadChip("Downloading " + filename))(ctx)
	if err != nil {
	...
	err = ui.LeftClick(holdingspace.FindContextMenuItem("Cancel"))(ctx)
	if err != nil {
		s.Error("Failed to left click context menu item: ", err)
	}

	// Ensure the download chip is removed with its backing file.
	err = ui.WaitUntilGone(holdingspace.FindDownloadChip(filename))(ctx)
	if err != nil {
...
func testPauseAndResume(
	...
	err = ui.LeftClick(holdingspace.FindContextMenuItem("Pause"))(ctx)
	if err != nil {
		s.Error("Failed to left click context menu item: ", err)
	}
	...
	err = ui.RightClick(
		holdingspace.FindDownloadChip("Download paused " + filename))(ctx)
	if err != nil {
		s.Error("Failed to right click download chip: ", err)
	}
	...
	err = ui.LeftClick(holdingspace.FindContextMenuItem("Resume"))(ctx)
	if err != nil {
		s.Error("Failed to left click context menu item: ", err)
	}

	// Wait for the download to complete.
	err = ui.WaitUntilExists(holdingspace.FindDownloadChip(filename))(ctx)
	if err != nil {
...
func testPin(
	...
	err := ui.RightClick(holdingspace.FindDownloadChip(filename))(ctx)
	if err != nil {
		s.Error("Failed to right click download chip: ", err)
	}
	...
	err = ui.LeftClick(holdingspace.FindContextMenuItem("Pin"))(ctx)
	if err != nil {
		s.Error("Failed to left click context menu item: ", err)
	}

	// Ensure the pinned file chip is created.
	err = ui.WaitUntilExists(holdingspace.FindPinnedFileChip(filename))(ctx)
	if err != nil {
