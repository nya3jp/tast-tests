...
func init() {
	testing.AddTest(&testing.Test{
		...
		Desc:         "Checks that session logs saved from Diagnostics App appears in Holding Space",
		Contacts: []string{
...
func DiagnosticsAppSaveSessionLog(ctx context.Context, s *testing.State) {
	...
	defer faillog.DumpUITreeWithScreenshotOnError(cleanupCtx, s.OutDir(), s.HasError, cr, "ui_tree_diagnostics_app_save_session_log")
