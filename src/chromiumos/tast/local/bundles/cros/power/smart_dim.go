...
func init() {
	testing.AddTest(&testing.Test{
		...
		Params: []testing.Param{{
			Val:     &smartDimParam{browserType: browser.TypeAsh, useFlatbufferModel: false},
			Fixture: "chromeLoggedIn",
		}, {
			Name:      "flatbuffer",
			Val:       &smartDimParam{browserType: browser.TypeAsh, useFlatbufferModel: true},
			Fixture:   "chromeLoggedIn",
			ExtraAttr: []string{"informational"},
		}, {
			Name:              "lacros",
			Val:               &smartDimParam{browserType: browser.TypeLacros, useFlatbufferModel: false},
			Fixture:           "lacros",
			ExtraAttr:         []string{"informational"},
