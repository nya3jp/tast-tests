...
func init() {
	testing.AddService(&testing.Service{
		Register: func(srv *grpc.Server, s *testing.ServiceState) {
			power.RegisterEthernetServiceServer(srv, &EthernetService{s: s})
		},
	})
}

// EthernetService implements tast.cros.power.EthernetService.
...
func (e *EthernetService) Browse(ctx context.Context, request *power.BrowseRequest) (*empty.Empty, error) {
	if e.cr == nil {
		return nil, errors.New("Chrome not available")
	}
...
func (e *EthernetService) SetWifi(ctx context.Context, request *power.WifiRequest) (*empty.Empty, error) {
