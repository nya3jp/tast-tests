...
// If there is an error, the connection will be returned before closing. Otherwise the calling function
...
// Difference is obtained taking the diff of these two arrays.
...
// pollForFocusElement polls until specified UI element has focus, or otherwise, returns error after 30 seconds.
