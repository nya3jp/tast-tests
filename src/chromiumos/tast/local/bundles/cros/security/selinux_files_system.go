...
func SELinuxFilesSystem(ctx context.Context, s *testing.State) {
	...
	testArgs := []selinux.FileTestCase{
		...
		{Path: "/usr/share/cros/init", Context: "cros_init_shell_scripts", Recursive: true, Filter: selinux.IgnorePathsButNotContents([]string{
			...
			"/usr/share/cros/init/logging-post-start.sh",
			"/usr/share/cros/init/logging-exec.sh",
		...
		{Path: "/usr/share/cros/init/logging-pre-start.sh", Context: "cros_init_logging_shell_scripts"},
		{Path: "/usr/share/cros/init/logging-post-start.sh", Context: "cros_init_logging_shell_scripts"},
		{Path: "/usr/share/cros/init/logging-exec.sh", Context: "cros_init_logging_shell_scripts"},
