...
func SELinuxFilesSystem(ctx context.Context, s *testing.State) {
	...
	testArgs := []selinux.FileTestCase{
		...
		{Path: "/usr/bin/chunneld", Context: "cros_chunneld_exec"},
		{Path: "/usr/bin/chrt", Context: "cros_chrt_exec"},
		{Path: "/usr/bin/cras", Context: "cros_cras_exec"},
		{Path: "/usr/bin/cups_proxy", Context: "cros_cups_proxy_exec"},
		...
		{Path: "/usr/bin/seneschal", Context: "cros_seneschal_exec"},
		...
		{Path: "/usr/bin/vm_cicerone", Context: "cros_vm_cicerone_exec"},
		{Path: "/usr/bin/vm_concierge", Context: "cros_vm_concierge_exec"},
		{Path: "/usr/bin/vmlog_forwarder", Context: "cros_vmlog_forwarder_exec"},
		...
		{Path: "/usr/sbin/crosdns", Context: "cros_crosdns_exec"},
