...
func SELinuxFilesSystem(ctx context.Context, s *testing.State) {
	...
	testArgs := []selinux.FileTestCase{
		...
		{Path: "/usr/bin/virtual-file-provider", Context: "cros_virtual_file_provider_exec"},
		{Path: "/usr/bin/virtual-file-provider-jailed", Context: "cros_virtual_file_provider_jailed_exec"},
