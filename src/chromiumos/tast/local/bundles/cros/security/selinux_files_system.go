...
func SELinuxFilesSystem(ctx context.Context, s *testing.State) {
	...
	testArgs := []selinux.FileTestCase{
		...
		{Path: "/usr/bin/ti50-emulator-ec_comm", Context: "cros_ti50-emulator-ec_comm_exec", IgnoreErrors: true},
		{Path: "/usr/bin/ti50-emulator-fw_updater", Context: "cros_ti50-emulator-fw_updater_exec", IgnoreErrors: true},
		{Path: "/usr/bin/ti50-emulator-kernel", Context: "cros_ti50-emulator-kernel_exec", IgnoreErrors: true},
		{Path: "/usr/bin/ti50-emulator-pinweaver", Context: "cros_ti50-emulator-pinweaver_exec", IgnoreErrors: true},
		{Path: "/usr/bin/ti50-emulator-sys_mgr", Context: "cros_ti50-emulator-sys_mgr_exec", IgnoreErrors: true},
		{Path: "/usr/bin/ti50-emulator-tmp2", Context: "cros_ti50-emulator-tpm2_exec", IgnoreErrors: true},
