...
func SELinuxFileLabel(ctx context.Context, s *testing.State) {
	...
	testArgs := []struct {
		...
		{"/etc/hosts.d", "u:object_r:cros_network_conf_file:s0", true, selinux.SkipNotExist},
		...
		{"/run/dbus", "u:object_r:cros_run_dbus:s0", false, nil},
		{"/run/dbus.pid", "u:object_r:cros_dbus_pid_file:s0", false, nil},
		{"/run/dbus/system_bus_socket", "u:object_r:cros_system_bus_socket:s0", false, nil},
		...
		{"/usr/share/cros/init", "u:object_r:cros_init_shell_scripts:s0", true, selinux.IgnorePathsButNotContents([]string{
		...
		{"/usr/share/cros/init/activate_date.sh", "u:object_r:cros_init_activate_date_script:s0", false, nil},
		{"/usr/share/cros/init/crx-import.sh", "u:object_r:cros_init_crx_import_script:s0", false, nil},
		{"/usr/share/cros/init/lockbox-cache.sh", "u:object_r:cros_init_lockbox_cache_script:s0", false, nil},
		{"/usr/share/cros/init/powerd-pre-start.sh", "u:object_r:cros_init_powerd_pre_start_script:s0", false, nil},
		...
		{"/var/lib/dbus", "u:object_r:cros_var_lib_dbus:s0", true, nil},
