...
func SELinuxFileLabel(ctx context.Context, s *testing.State) {
	...
	testArgs := []struct {
		...
		{"/usr/share/cros/init", "u:object_r:cros_init_shell_scripts:s0", true, selinux.IgnorePathsItself([]string{"/usr/share/cros/init/ui-pre-start", "/usr/share/cros/init/ui-respawn"})},
