...
func SELinuxFileLabel(ctx context.Context, s *testing.State) {
	systemCPUFilter := func(p string, fi os.FileInfo) (skipFile, skipSubdir bool) {
		mode := fi.Mode()
	...
	testArgs := []struct {
		...
		{"/bin", "u:object_r:cros_coreutils_exec:s0", true, InvertFilterSkipFile(SkipCoreutilsFile)},
		...
		{"/sys/devices/system/cpu", "u:object_r:sysfs:s0", true, InvertFilterSkipFile(systemCPUFilter)},
		{"/sys/devices/system/cpu", "u:object_r:sysfs_devices_system_cpu:s0", true, systemCPUFilter},
		{"/sys/fs/cgroup", "u:object_r:cgroup:s0", true, IgnorePathItself("/sys/fs/cgroup")},
		{"/sys/fs/cgroup", "u:object_r:tmpfs:s0", false, nil},
		{"/sys/fs/pstore", "u:object_r:pstorefs:s0", false, nil},
		{"/sys/fs/selinux", "u:object_r:null_device:s0", true, InvertFilterSkipFile(IgnorePathItself("/sys/fs/selinux/null"))},
		{"/sys/fs/selinux", "u:object_r:selinuxfs:s0", true, IgnorePathItself("/sys/fs/selinux/null")},
		{"/sys/kernel/config", "u:object_r:configfs:s0", false, SkipNonExist},
		{"/sys/kernel/debug", "u:object_r:debugfs:s0", false, nil},
		{"/sys/kernel/debug/debugfs_tracing_on", "u:object_r:debugfs_tracing:s0", false, SkipNonExist},
		{"/sys/kernel/debug/tracing", "u:object_r:debugfs_tracing:s0", false, nil},
		{"/sys/kernel/debug/tracing/trace_marker", "u:object_r:debugfs_trace_marker:s0", false, SkipNonExist},
		{"/usr/bin", "u:object_r:cros_coreutils_exec:s0", true, InvertFilterSkipFile(SkipCoreutilsFile)},
		...
		{"/usr/bin/midis", "u:object_r:cros_midis_exec:s0", false, SkipNonExist},
		...
		{"/usr/sbin/sslh", "u:object_r:cros_sslh_exec:s0", false, SkipNonExist},
		{"/usr/sbin/sslh-fork", "u:object_r:cros_sslh_exec:s0", false, SkipNonExist},
		{"/usr/sbin/sslh-select", "u:object_r:cros_sslh_exec:s0", false, SkipNonExist},
		...
		{"/var/lib/metrics", "u:object_r:cros_metrics_file:s0", true, IgnorePathItself("/var/lib/metrics/uma-events")},
	...
	for _, testArg := range testArgs {
		...
		CheckContext(s, testArg.path, testArg.context, testArg.recursive, filter)
	}
