...
<<<<<<< HEAD   (888db8 platform.CrosRuntimeProbe*: Skip unknown components)
		...
		chk.NewPattern(chk.Path("encrypted/var/lib/metrics/uma-events"), chk.Users("metrics", "chronos"), chk.Groups("metrics", "chronos"), chk.Mode(0666)),
...
>>>>>>> CHANGE (34ab56 security.StatefulFules: temporary fix for failing test.)
