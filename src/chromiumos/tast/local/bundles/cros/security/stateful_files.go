...
func StatefulFiles(ctx context.Context, s *testing.State) {
	...
	patterns := []*chk.Pattern{
		...
		chk.NewPattern(chk.Path("encrypted/var/lib/policydata"), chk.Users("root"), chk.Groups("policy-readers"), chk.Mode(0750)), // directory itself
		chk.NewPattern(chk.Tree("encrypted/var/lib/policydata"), chk.Users("root"), chk.Groups("root"), chk.NotMode(022)),         // children
