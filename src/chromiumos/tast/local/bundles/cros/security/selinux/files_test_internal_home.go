...
func CheckHomeDirectory(s *testing.State) {
	...
	testCases := []struct {
		...
		// Not logged in users doesn't have real data bind-mounded (cros_home_chronos).
		...
		// Not logged in users doesn't have real data bind-mounded (cros_home_root).
		...
		// Not logged in users doesn't have real data bind-mounded (cros_home_user).
