	...
	for _, sel := range testSelector {
		...
		case Stable:
			testCases = append(testCases, []testCaseType{
				...
				{exe, "/usr/bin/ti50-emulator-ec_comm", matchRegexp, "cros_ti50-emulator-ec_comm", zeroProcs, ""},
				{exe, "/usr/bin/ti50-emulator-fw_updater", matchRegexp, "cros_ti50-emulator-fw_updater", zeroProcs, ""},
				{exe, "/usr/bin/ti50-emulator-kernel", matchRegexp, "cros_ti50-emulator-kernel", zeroProcs, ""},
				{exe, "/usr/bin/ti50-emulator-pinweaver", matchRegexp, "cros_ti50-emulator-pinweaver", zeroProcs, ""},
				{exe, "/usr/bin/ti50-emulator-sys_mgr", matchRegexp, "cros_ti50-emulator-sys_mgr", zeroProcs, ""},
				{exe, "/usr/bin/ti50-emulator-tmp2", matchRegexp, "cros_ti50-emulator-tpm2", zeroProcs, ""},
				{exe, "/usr/bin/ti50-emulator-u2f", matchRegexp, "cros_ti50-emulator-u2f", zeroProcs, ""},
