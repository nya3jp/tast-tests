	...
	for _, sel := range testSelector {
		...
		case Stable:
			testCases = append(testCases, []testCaseType{
				...
				{exe, "/usr/bin/ti50-emulator-ec_comm", matchRegexp, "cros_ti50_emulator_ec_comm", zeroProcs, ""},
				{exe, "/usr/bin/ti50-emulator-fw_updater", matchRegexp, "cros_ti50_emulator_fw_updater", zeroProcs, ""},
				{exe, "/usr/bin/ti50-emulator-kernel", matchRegexp, "cros_ti50_emulator_kernel", zeroProcs, ""},
				{exe, "/usr/bin/ti50-emulator-pinweaver", matchRegexp, "cros_ti50_emulator_pinweaver", zeroProcs, ""},
				{exe, "/usr/bin/ti50-emulator-sys_mgr", matchRegexp, "cros_ti50_emulator_sys_mgr", zeroProcs, ""},
				{exe, "/usr/bin/ti50-emulator-tmp2", matchRegexp, "cros_ti50_emulator_tpm2", zeroProcs, ""},
				{exe, "/usr/bin/ti50-emulator-u2f", matchRegexp, "cros_ti50_emulator_u2f", zeroProcs, ""},
				...
				{exe, "/usr/sbin/iioservice", matchRegexp, "cros_iioservice", zeroProcs, ""},
