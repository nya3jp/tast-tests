...
const domainIsolationErrorMessage = "every daemon must have its own domain. Please follow step 1~3 of https://chromium.googlesource.com/chromiumos/docs/+/master/secrutiy/selinux.md#Practice-in-Examples to create a permissive domain for your daemons."
