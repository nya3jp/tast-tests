...
func testBody(s *testing.State, testType string, ignoredAncestorNames, exclusionsMap map[string]struct{}) {
	...
	// ARCExpectedSharedMountsGuest contains the paths of all mountpoints that are
	...
	for k, v := range ARCExpectedSharedMountsGuest {
	...
	for k, v := range ARCVMExpectedSharedMountsGuest {
