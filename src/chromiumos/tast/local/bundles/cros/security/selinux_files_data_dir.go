...
const (
	...
	baseDataDirPath     = "/home/.shadow/[a-z0-9]*/mount/root/android-data/data/"
	dataDirFileContexts = "/tmp/data_file_contexts"
)

func verifyDirSelinuxContext(ctx context.Context, s *testing.State, dirName string) error {
	directoryPath := baseDataDirPath + dirName
...
func SELinuxFilesDataDir(ctx context.Context, s *testing.State) {
	...
	for _, dir := range dirList {
		if err := verifyDirSelinuxContext(ctx, s, dir); err != nil {
