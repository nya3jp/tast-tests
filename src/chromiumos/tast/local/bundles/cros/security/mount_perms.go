...
func init() {
	testing.AddTest(&testing.Test{
		Func: MountPerms,
		Desc: "Checks permissions of mounted filesystems",
		Attr: []string{"informational"},
	})
}

func MountPerms(ctx context.Context, s *testing.State) {
	...
	// Check that files can't be created in read-only directories.
