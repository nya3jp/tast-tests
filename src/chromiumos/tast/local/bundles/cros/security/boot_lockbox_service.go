...
func (c *BootLockboxService) New(ctx context.Context, req *empty.Empty) (*empty.Empty, error) {
	if c.cr != nil {
...
func (c *BootLockboxService) Close(ctx context.Context, req *empty.Empty) (*empty.Empty, error) {
	if c.cr == nil {
