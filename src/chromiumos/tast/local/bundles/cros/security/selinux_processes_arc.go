...
func init() {
	testing.AddTest(&testing.Test{
		Func: SELinuxProcessesARC, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Checks that host processes are running in correct SELinux domain after ARC boots",
