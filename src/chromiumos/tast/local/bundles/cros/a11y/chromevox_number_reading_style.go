...
func init() {
	testing.AddTest(&testing.Test{
		Func: ChromevoxNumberReadingStyle, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Verifies ChromeVox honors its setting to read numbers as words or as digits",
		Contacts: []string{
