...
func init() {
	testing.AddTest(&testing.Test{
		Func: SelectToSpeak, LacrosStatus: testing.LacrosVariantUnknown, Desc: "A test that invokes Select-to-Speak and verifies the correct speech is given by the Google TTS engine",
		Contacts: []string{
