...
func init() {
	testing.AddTest(&testing.Test{
		Func: ChromevoxPlainTextEditing, LacrosStatus: testing.LacrosVariantUnknown, Desc: "A test that verifies the way ChromeVox can be used to edit text in plain text fields",
		Contacts: []string{
