...
func init() {
	testing.AddTest(&testing.Test{
		Func: Autoclick, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Tests that the automatic clicks feature can be turned on and used to click buttons without physically pressing the mouse",
		Contacts: []string{
