...
func init() {
	testing.AddTest(&testing.Test{
		Func: ChromevoxTTSProcessingWhitespace, LacrosStatus: testing.LacrosVariantUnknown, Desc: "A test that verifies the way ChromeVox processes whitespace for speech in text areas",
		Contacts: []string{
