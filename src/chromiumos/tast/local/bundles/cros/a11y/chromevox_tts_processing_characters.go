...
func init() {
	testing.AddTest(&testing.Test{
		Func: ChromevoxTTSProcessingCharacters, LacrosStatus: testing.LacrosVariantUnknown, Desc: "A test that verifies the way ChromeVox processes some characters for speech",
		Contacts: []string{
