...
func ChromevoxTtsProcessingCharacters(ctx context.Context, s *testing.State) {
	...
	c, err := a11y.NewTabWithHTML(ctx, cr, "<p>.</p><p>x.</p><p>=========</p><p>&bull; &bull;&bull;</p><p>&bull;&bull;&bull;</p><p>C++</p><p>C+++</p><p>&pound; and %23 symbol</p><p>&pound;&pound;&pound;</p><p>C--</p>")
	if err != nil {
