...
func init() {
	testing.AddTest(&testing.Test{
		Func: ChromevoxTTSPitchAndRate, LacrosStatus: testing.LacrosVariantUnknown, Desc: "A test that verifies the way ChromeVox sets Text-to-Speech pitch and rate",
		Contacts: []string{
