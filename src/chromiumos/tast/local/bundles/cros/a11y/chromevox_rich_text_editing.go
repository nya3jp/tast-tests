...
func init() {
	testing.AddTest(&testing.Test{
		Func: ChromevoxRichTextEditing, LacrosStatus: testing.LacrosVariantUnknown, Desc: "A test that verifies the way ChromeVox can be used to edit text in a contenteditable",
		Contacts: []string{
