	...
	testSteps := []struct {
		...
		},
		{
			...
			[]a11y.SpeechExpectation{
				...
				a11y.NewOptionsExpectation("Link", lang, linkPitch, 1.0),
		...
		},
		{
			[]string{"Right"},
			[]a11y.SpeechExpectation{
				a11y.NewOptionsExpectation("Suggest", lang, linkPitch, 1.0),
				a11y.NewOptionsExpectation("Username", lang, 1.0, 1.0),
				a11y.NewOptionsExpectation("Insert", lang, linkPitch, 1.0),
		...
		},
		{
			[]string{"Right"},
			[]a11y.SpeechExpectation{
				a11y.NewOptionsExpectation("Delete", lang, linkPitch, 1.0),
