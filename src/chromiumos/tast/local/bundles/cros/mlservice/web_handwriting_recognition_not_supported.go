...
func init() {
	testing.AddTest(&testing.Test{
		Func: WebHandwritingRecognitionNotSupported, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Checks Web Handwriting Recognition API works, even if ml_service doesn't support ondevice_handwriting",
		Contacts: []string{
