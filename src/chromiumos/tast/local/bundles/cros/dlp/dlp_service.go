...
func (service *DataLeakPreventionService) ClipboardCopyPaste(ctx context.Context, req *pb.ClipboardCopyPasteRequest) (_ *empty.Empty, retErr error) {
...
// Print prints the webpage specified in the request.
// func (service *DataLeakPreventionService) Print(ctx context.Context, req *pb.PrintRequest) (_ *empty.Empty, retErr error) {
