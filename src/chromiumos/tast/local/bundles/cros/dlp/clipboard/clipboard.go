...
// CheckWordsMax is the maximum number of words to check between the pasted and copied strings.
const CheckWordsMax = 10

// CheckWordsMin is the minimum number of words to check between the pasted and copied strings
const CheckWordsMin = 1
