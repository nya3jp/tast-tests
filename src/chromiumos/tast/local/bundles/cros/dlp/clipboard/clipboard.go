...
// ClipText returns clipboard content.
func ClipText(ctx context.Context, tconn *chrome.TestConn) (string, error) {
	var clipData string
...
func CheckClipboardBubble(ctx context.Context, tconn *chrome.TestConn, url string) error {
