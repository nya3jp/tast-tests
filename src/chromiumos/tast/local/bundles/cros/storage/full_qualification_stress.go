...
func setupBenchmarks(ctx context.Context, s *testing.State, rw *stress.FioResultWriter) {
	...
	runFioStressForBootDev(ctx, testConfig.WithJob("seq_write"))
	runFioStressForBootDev(ctx, testConfig.WithJob("seq_read"))
	runFioStressForBootDev(ctx, testConfig.WithJob("4k_write"))
	runFioStressForBootDev(ctx, testConfig.WithJob("4k_read"))
	runFioStressForBootDev(ctx, testConfig.WithJob("16k_write"))
	runFioStressForBootDev(ctx, testConfig.WithJob("16k_read"))
...
func soakTestBlock(ctx context.Context, s *testing.State, rw *stress.FioResultWriter) {
	...
	stressTasks := []func(context.Context){
		func(ctx context.Context) {
			runFioStressForBootDev(ctx, testConfigNoVerify.WithJob("64k_stress"))
			runFioStressForBootDev(ctx, testConfigVerify.WithJob("surfing"))
		},
		func(ctx context.Context) {
...
func retentionTestBlock(ctx context.Context, s *testing.State, rw *stress.FioResultWriter) {
	...
	writeTasks := []func(context.Context){
		func(ctx context.Context) {
			runFioStressForBootDev(ctx, writeConfig)
		},
		func(ctx context.Context) {
	...
	verifyTasks := []func(context.Context){
		func(ctx context.Context) {
			runFioStressForBootDev(ctx, verifyConfig)
		},
		func(ctx context.Context) {
...
func runContinuousStorageStress(ctx context.Context, job string, rw *stress.FioResultWriter) {
	...
	for {
		if err := runFioStressForBootDev(ctx, testConfig); err != nil && errors.As(err, &context.DeadlineExceeded) {
...
func runFioStressForBootDev(ctx context.Context, testConfig TestConfig) error {
