...
func init() {
	testing.AddTest(&testing.Test{
		Func: SyncTime, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Manually sets the time in the guest to an incorrect value, uses 'SyncTimes' to correct it, and verifies that it is correct",
