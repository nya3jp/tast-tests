...
func init() {
	testing.AddTest(&testing.Test{
		Func: RestartIcon, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Tests that we can shut down and restart crostini through clicking the Terminal icon on launcher",
