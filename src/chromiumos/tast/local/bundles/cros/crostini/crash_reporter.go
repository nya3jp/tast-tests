...
func CrashReporter(ctx context.Context, s *testing.State) {
	...
	// TODO: Check that the values in the metadata file make sense
	// In paticular, check that the guest OS release (e.g. "buster") is
	// available and that the board is set to "tatl" or "tael".
}
