...
// FixtureType store fixture type
...
// getFixtureTypeAndIndex return switch fixture type & index
...
// getInterval get time for delaying switch fixture
...
// waitForChromebook waiting for system response
func waitForChromebook(ctx context.Context, needToDelay bool) {
...
// DoSwitchFixture do switch fixture
func DoSwitchFixture(ctx context.Context, s *testing.State, sType, sIndex string, action ActionState, needToDelay bool) error {
	...
	waitForChromebook(ctx, needToDelay)

	return nil
}

// ControlFixture this method may need to update for input argument
...
// ControlFixtureByArgument according to input argument, switch fixture one by one
