...
// according input display sequence
// return correspond tpye and index
...
// send request and compare with response
...
// just send request , let server know
...
// send reuqest and compare with response
...
// return control server result path
// notice: return's path is absolute, is not flexible
// so, if change computer or anything could cause this func failed
...
// Check the 1Khz video/audio playback by test fixture
