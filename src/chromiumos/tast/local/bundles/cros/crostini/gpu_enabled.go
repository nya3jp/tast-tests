...
func init() {
	testing.AddTest(&testing.Test{
		Func: GPUEnabled, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Tests that Crostini starts with the correct GPU device depending on whether the GPU flag is set or not",
