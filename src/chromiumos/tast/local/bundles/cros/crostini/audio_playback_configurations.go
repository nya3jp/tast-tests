...
func init() {
	testing.AddTest(&testing.Test{
		Func: AudioPlaybackConfigurations, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Tests different channel number on the container's audio (through alsa) using a pre-built crostini image",
