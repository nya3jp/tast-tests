...
func GPUEnabledArtifact(ctx context.Context, s *testing.State) {
	// TODO(crbug.com/980335): when the GPU is enabled by default, this expectation will have to change.
