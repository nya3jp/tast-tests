	...
	testing.AddTest(&testing.Test{
		...
		Params: []testing.Param{
			// Parameters generated by launcher_test.go. DO NOT EDIT.
			{
				...
				ExtraData:         []string{vm.ArtifactData(), crostini.GetContainerMetadataArtifact("stretch", false), crostini.GetContainerRootfsArtifact("stretch", false), "launcher_wayland_demo_fixed_size.desktop", "launcher_wayland_demo.png"},
				...
				ExtraAttr:         []string{"informational"},
				ExtraData:         []string{vm.ArtifactData(), crostini.GetContainerMetadataArtifact("buster", false), crostini.GetContainerRootfsArtifact("buster", false), "launcher_wayland_demo_fixed_size.desktop", "launcher_wayland_demo.png"},
				ExtraHardwareDeps: crostini.CrostiniStable,
				...
				ExtraAttr:         []string{"informational"},
				ExtraData:         []string{vm.ArtifactData(), crostini.GetContainerMetadataArtifact("stretch", false), crostini.GetContainerRootfsArtifact("stretch", false), "launcher_x11_demo_fixed_size.desktop", "launcher_x11_demo.png"},
				ExtraHardwareDeps: crostini.CrostiniStable,
				Pre:               crostini.StartedByComponentStretch(),
				Timeout:           7 * time.Minute,
				Val: launcherTestConfig{
				...
				ExtraAttr:         []string{"informational"},
				ExtraData:         []string{vm.ArtifactData(), crostini.GetContainerMetadataArtifact("buster", false), crostini.GetContainerRootfsArtifact("buster", false), "launcher_x11_demo_fixed_size.desktop", "launcher_x11_demo.png"},
				ExtraHardwareDeps: crostini.CrostiniStable,
				Pre:               crostini.StartedByComponentBuster(),
				Timeout:           7 * time.Minute,
				Val: launcherTestConfig{
