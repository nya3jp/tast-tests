...
func init() {
	testing.AddTest(&testing.Test{
		...
		Params: []testing.Param{
			...
			{
				Name:              "local_wayland_component_stretch_stable",
				ExtraData:         []string{vm.ArtifactData(), crostini.GetContainerMetadataArtifact("stretch", false), crostini.GetContainerMetadataArtifact("stretch", false), "launcher_wayland_demo_fixed_size.desktop", "launcher_wayland_demo.png"},
				...
				ExtraData:         []string{crostini.GetContainerMetadataArtifact("stretch", false), crostini.GetContainerMetadataArtifact("stretch", false), "launcher_wayland_demo_fixed_size.desktop", "launcher_wayland_demo.png"},
				...
				Name:              "local_wayland_component_stretch_unstable",
				ExtraAttr:         []string{"informational"},
				ExtraData:         []string{vm.ArtifactData(), crostini.GetContainerMetadataArtifact("stretch", false), crostini.GetContainerMetadataArtifact("stretch", false), "launcher_wayland_demo_fixed_size.desktop", "launcher_wayland_demo.png"},
				...
				Name:              "local_wayland_dlc_stretch_unstable",
				ExtraAttr:         []string{"informational"},
				ExtraData:         []string{crostini.GetContainerMetadataArtifact("stretch", false), crostini.GetContainerMetadataArtifact("stretch", false), "launcher_wayland_demo_fixed_size.desktop", "launcher_wayland_demo.png"},
				ExtraSoftwareDeps: []string{"dlc"},
				ExtraHardwareDeps: crostini.CrostiniUnstable,
				...
				Name:              "local_wayland_component_buster_stable",
				ExtraData:         []string{vm.ArtifactData(), crostini.GetContainerMetadataArtifact("buster", false), crostini.GetContainerMetadataArtifact("buster", false), "launcher_wayland_demo_fixed_size.desktop", "launcher_wayland_demo.png"},
				ExtraHardwareDeps: crostini.CrostiniStable,
				...
				ExtraAttr:         []string{"informational"},
				ExtraData:         []string{crostini.GetContainerMetadataArtifact("buster", false), crostini.GetContainerMetadataArtifact("buster", false), "launcher_wayland_demo_fixed_size.desktop", "launcher_wayland_demo.png"},
				ExtraSoftwareDeps: []string{"dlc"},
				ExtraHardwareDeps: crostini.CrostiniStable,
				...
				Name:              "local_wayland_component_buster_unstable",
				ExtraAttr:         []string{"informational"},
				ExtraData:         []string{vm.ArtifactData(), crostini.GetContainerMetadataArtifact("buster", false), crostini.GetContainerMetadataArtifact("buster", false), "launcher_wayland_demo_fixed_size.desktop", "launcher_wayland_demo.png"},
				ExtraHardwareDeps: crostini.CrostiniUnstable,
				Pre:               crostini.StartedByComponentBuster(),
				...
				Name:              "local_wayland_dlc_buster_unstable",
				ExtraAttr:         []string{"informational"},
				ExtraData:         []string{crostini.GetContainerMetadataArtifact("buster", false), crostini.GetContainerMetadataArtifact("buster", false), "launcher_wayland_demo_fixed_size.desktop", "launcher_wayland_demo.png"},
				ExtraSoftwareDeps: []string{"dlc"},
				ExtraHardwareDeps: crostini.CrostiniUnstable,
				...
				Name:              "local_x11_component_stretch_stable",
				ExtraData:         []string{vm.ArtifactData(), crostini.GetContainerMetadataArtifact("stretch", false), crostini.GetContainerMetadataArtifact("stretch", false), "launcher_x11_demo_fixed_size.desktop", "launcher_x11_demo.png"},
				ExtraHardwareDeps: crostini.CrostiniStable,
				Pre:               crostini.StartedByComponentStretch(),
				Timeout:           7 * time.Minute,
				Val: launcherTestConfig{
				...
				ExtraAttr:         []string{"informational"},
				ExtraData:         []string{crostini.GetContainerMetadataArtifact("stretch", false), crostini.GetContainerMetadataArtifact("stretch", false), "launcher_x11_demo_fixed_size.desktop", "launcher_x11_demo.png"},
				ExtraSoftwareDeps: []string{"dlc"},
				ExtraHardwareDeps: crostini.CrostiniStable,
				Pre:               crostini.StartedByDlcStretch(),
				Timeout:           7 * time.Minute,
				...
				Name:              "local_x11_component_stretch_unstable",
				ExtraAttr:         []string{"informational"},
				ExtraData:         []string{vm.ArtifactData(), crostini.GetContainerMetadataArtifact("stretch", false), crostini.GetContainerMetadataArtifact("stretch", false), "launcher_x11_demo_fixed_size.desktop", "launcher_x11_demo.png"},
				ExtraHardwareDeps: crostini.CrostiniUnstable,
				Pre:               crostini.StartedByComponentStretch(),
				...
				Name:              "local_x11_dlc_stretch_unstable",
				ExtraAttr:         []string{"informational"},
				ExtraData:         []string{crostini.GetContainerMetadataArtifact("stretch", false), crostini.GetContainerMetadataArtifact("stretch", false), "launcher_x11_demo_fixed_size.desktop", "launcher_x11_demo.png"},
				ExtraSoftwareDeps: []string{"dlc"},
				ExtraHardwareDeps: crostini.CrostiniUnstable,
				...
				Name:              "local_x11_component_buster_stable",
				ExtraData:         []string{vm.ArtifactData(), crostini.GetContainerMetadataArtifact("buster", false), crostini.GetContainerMetadataArtifact("buster", false), "launcher_x11_demo_fixed_size.desktop", "launcher_x11_demo.png"},
				ExtraHardwareDeps: crostini.CrostiniStable,
				Pre:               crostini.StartedByComponentBuster(),
				Timeout:           7 * time.Minute,
				Val: launcherTestConfig{
				...
				ExtraAttr:         []string{"informational"},
				ExtraData:         []string{crostini.GetContainerMetadataArtifact("buster", false), crostini.GetContainerMetadataArtifact("buster", false), "launcher_x11_demo_fixed_size.desktop", "launcher_x11_demo.png"},
				ExtraSoftwareDeps: []string{"dlc"},
				ExtraHardwareDeps: crostini.CrostiniStable,
				Pre:               crostini.StartedByDlcBuster(),
				Timeout:           7 * time.Minute,
				...
				Name:              "local_x11_component_buster_unstable",
				ExtraAttr:         []string{"informational"},
				ExtraData:         []string{vm.ArtifactData(), crostini.GetContainerMetadataArtifact("buster", false), crostini.GetContainerMetadataArtifact("buster", false), "launcher_x11_demo_fixed_size.desktop", "launcher_x11_demo.png"},
				ExtraHardwareDeps: crostini.CrostiniUnstable,
				Pre:               crostini.StartedByComponentBuster(),
				...
				Name:              "local_x11_dlc_buster_unstable",
				ExtraAttr:         []string{"informational"},
				ExtraData:         []string{crostini.GetContainerMetadataArtifact("buster", false), crostini.GetContainerMetadataArtifact("buster", false), "launcher_x11_demo_fixed_size.desktop", "launcher_x11_demo.png"},
				ExtraSoftwareDeps: []string{"dlc"},
				ExtraHardwareDeps: crostini.CrostiniUnstable,
				...
				Name:              "system_wayland_component_stretch_stable",
				ExtraData:         []string{vm.ArtifactData(), crostini.GetContainerMetadataArtifact("stretch", false), crostini.GetContainerMetadataArtifact("stretch", false), "launcher_wayland_demo_fixed_size.desktop", "launcher_wayland_demo.png"},
				ExtraHardwareDeps: crostini.CrostiniStable,
				Pre:               crostini.StartedByComponentStretch(),
				Timeout:           7 * time.Minute,
				...
				Name:              "system_wayland_component_stretch_unstable",
				ExtraAttr:         []string{"informational"},
				ExtraData:         []string{vm.ArtifactData(), crostini.GetContainerMetadataArtifact("stretch", false), crostini.GetContainerMetadataArtifact("stretch", false), "launcher_wayland_demo_fixed_size.desktop", "launcher_wayland_demo.png"},
				ExtraHardwareDeps: crostini.CrostiniUnstable,
				Pre:               crostini.StartedByComponentStretch(),
				...
				Name:              "system_wayland_dlc_stretch_unstable",
				ExtraAttr:         []string{"informational"},
				ExtraData:         []string{crostini.GetContainerMetadataArtifact("stretch", false), crostini.GetContainerMetadataArtifact("stretch", false), "launcher_wayland_demo_fixed_size.desktop", "launcher_wayland_demo.png"},
				ExtraSoftwareDeps: []string{"dlc"},
				ExtraHardwareDeps: crostini.CrostiniUnstable,
				...
				Name:              "system_wayland_component_buster_stable",
				ExtraData:         []string{vm.ArtifactData(), crostini.GetContainerMetadataArtifact("buster", false), crostini.GetContainerMetadataArtifact("buster", false), "launcher_wayland_demo_fixed_size.desktop", "launcher_wayland_demo.png"},
				ExtraHardwareDeps: crostini.CrostiniStable,
				Pre:               crostini.StartedByComponentBuster(),
				Timeout:           7 * time.Minute,
				...
				Name:              "system_wayland_component_buster_unstable",
				ExtraAttr:         []string{"informational"},
				ExtraData:         []string{vm.ArtifactData(), crostini.GetContainerMetadataArtifact("buster", false), crostini.GetContainerMetadataArtifact("buster", false), "launcher_wayland_demo_fixed_size.desktop", "launcher_wayland_demo.png"},
				ExtraHardwareDeps: crostini.CrostiniUnstable,
				Pre:               crostini.StartedByComponentBuster(),
				...
				Name:              "system_wayland_dlc_buster_unstable",
				ExtraAttr:         []string{"informational"},
				ExtraData:         []string{crostini.GetContainerMetadataArtifact("buster", false), crostini.GetContainerMetadataArtifact("buster", false), "launcher_wayland_demo_fixed_size.desktop", "launcher_wayland_demo.png"},
				ExtraSoftwareDeps: []string{"dlc"},
				ExtraHardwareDeps: crostini.CrostiniUnstable,
				...
				Name:              "system_x11_component_stretch_stable",
				ExtraData:         []string{vm.ArtifactData(), crostini.GetContainerMetadataArtifact("stretch", false), crostini.GetContainerMetadataArtifact("stretch", false), "launcher_x11_demo_fixed_size.desktop", "launcher_x11_demo.png"},
				ExtraHardwareDeps: crostini.CrostiniStable,
				Pre:               crostini.StartedByComponentStretch(),
				Timeout:           7 * time.Minute,
				...
				Name:              "system_x11_component_stretch_unstable",
				ExtraAttr:         []string{"informational"},
				ExtraData:         []string{vm.ArtifactData(), crostini.GetContainerMetadataArtifact("stretch", false), crostini.GetContainerMetadataArtifact("stretch", false), "launcher_x11_demo_fixed_size.desktop", "launcher_x11_demo.png"},
				ExtraHardwareDeps: crostini.CrostiniUnstable,
				Pre:               crostini.StartedByComponentStretch(),
				...
				Name:              "system_x11_dlc_stretch_unstable",
				ExtraAttr:         []string{"informational"},
				ExtraData:         []string{crostini.GetContainerMetadataArtifact("stretch", false), crostini.GetContainerMetadataArtifact("stretch", false), "launcher_x11_demo_fixed_size.desktop", "launcher_x11_demo.png"},
				ExtraSoftwareDeps: []string{"dlc"},
				ExtraHardwareDeps: crostini.CrostiniUnstable,
				...
				Name:              "system_x11_component_buster_stable",
				ExtraData:         []string{vm.ArtifactData(), crostini.GetContainerMetadataArtifact("buster", false), crostini.GetContainerMetadataArtifact("buster", false), "launcher_x11_demo_fixed_size.desktop", "launcher_x11_demo.png"},
				ExtraHardwareDeps: crostini.CrostiniStable,
				Pre:               crostini.StartedByComponentBuster(),
				Timeout:           7 * time.Minute,
				...
				Name:              "system_x11_component_buster_unstable",
				ExtraAttr:         []string{"informational"},
				ExtraData:         []string{vm.ArtifactData(), crostini.GetContainerMetadataArtifact("buster", false), crostini.GetContainerMetadataArtifact("buster", false), "launcher_x11_demo_fixed_size.desktop", "launcher_x11_demo.png"},
				ExtraHardwareDeps: crostini.CrostiniUnstable,
				Pre:               crostini.StartedByComponentBuster(),
				...
				Name:              "system_x11_dlc_buster_unstable",
				ExtraAttr:         []string{"informational"},
				ExtraData:         []string{crostini.GetContainerMetadataArtifact("buster", false), crostini.GetContainerMetadataArtifact("buster", false), "launcher_x11_demo_fixed_size.desktop", "launcher_x11_demo.png"},
				ExtraSoftwareDeps: []string{"dlc"},
				ExtraHardwareDeps: crostini.CrostiniUnstable,
