	...
	testing.AddTest(&testing.Test{
		...
		Params: []testing.Param{
			// Parameters generated by launcher_test.go. DO NOT EDIT.
			{
				...
				ExtraData:         []string{"launcher_wayland_demo_fixed_size.desktop", "launcher_wayland_demo.png", "crostini_guest_images.tar"},
				...
				ExtraData:         []string{"launcher_x11_demo_fixed_size.desktop", "launcher_x11_demo.png", "crostini_guest_images.tar"},
				ExtraHardwareDeps: crostini.CrostiniStable,
				Pre:               crostini.StartedByArtifact(),
				Timeout:           7 * time.Minute,
				Val: launcherTestConfig{
