...
func init() {
	testing.AddTest(&testing.Test{
		Func: HomeDirectoryRenameFile, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Test renaming a file in Linux files and container using a pre-built crostini image",
