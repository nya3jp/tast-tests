...
func init() {
	testing.AddTest(&testing.Test{
		Func: PackageInstallUninstall, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Installs and then uninstalls a package that we have copied into the container",
