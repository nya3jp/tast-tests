...
func RemoveOk(ctx context.Context, s *testing.State) {
	...
	var developersButton = ui.FindParams{Attributes: map[string]interface{}{"name": regexp.MustCompile(`Developers|Linux.*`)}, Role: ui.RoleTypeButton}
	turnOn, err := ui.FindWithTimeout(ctx, tconn, developersButton, 15*time.Second)
	if err != nil {
