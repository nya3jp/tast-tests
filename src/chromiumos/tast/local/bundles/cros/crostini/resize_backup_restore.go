...
func init() {
	testing.AddTest(&testing.Test{
		Func: ResizeBackupRestore, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Test resizing disk of Crostini from the Settings app between backup and restore",
