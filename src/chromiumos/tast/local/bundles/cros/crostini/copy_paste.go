...
func init() {
	...
	testing.AddTest(&testing.Test{
		...
		Params: []testing.Param{
			...
			{
				Name:              "wayland_to_wayland_artifact_stretch_amd64",
				...
				Name:              "wayland_to_wayland_artifact_stretch_amd64_unstable",
				...
				Name:              "wayland_to_wayland_artifact_stretch_arm",
				...
				Name:              "wayland_to_wayland_artifact_stretch_arm_unstable",
				ExtraAttr:         []string{"informational"},
				ExtraData:         []string{"crostini_vm_arm.zip", "crostini_container_metadata_stretch_arm.tar.xz", "crostini_container_rootfs_stretch_arm.tar.xz"},
				ExtraSoftwareDeps: []string{"arm"},
				ExtraHardwareDeps: crostini.CrostiniUnstable,
				...
				Name:              "wayland_to_wayland_artifact_buster_amd64",
				...
				Name:              "wayland_to_wayland_artifact_buster_amd64_unstable",
				ExtraAttr:         []string{"informational"},
				ExtraData:         []string{"crostini_vm_amd64.zip", "crostini_container_metadata_buster_amd64.tar.xz", "crostini_container_rootfs_buster_amd64.tar.xz"},
				ExtraSoftwareDeps: []string{"amd64"},
				ExtraHardwareDeps: crostini.CrostiniUnstable,
				...
				Name:              "wayland_to_wayland_artifact_buster_arm",
				...
				Name:              "wayland_to_wayland_artifact_buster_arm_unstable",
				ExtraAttr:         []string{"informational"},
				ExtraData:         []string{"crostini_vm_arm.zip", "crostini_container_metadata_buster_arm.tar.xz", "crostini_container_rootfs_buster_arm.tar.xz"},
				ExtraSoftwareDeps: []string{"arm"},
				ExtraHardwareDeps: crostini.CrostiniUnstable,
				...
				Name:              "wayland_to_x11_artifact_stretch_amd64",
				ExtraData:         []string{"crostini_vm_amd64.zip", "crostini_container_metadata_stretch_amd64.tar.xz", "crostini_container_rootfs_stretch_amd64.tar.xz"},
				ExtraSoftwareDeps: []string{"amd64"},
				ExtraHardwareDeps: crostini.CrostiniStable,
				Pre:               crostini.StartedByArtifactStretch(),
				...
				Name:              "wayland_to_x11_artifact_stretch_amd64_unstable",
				ExtraAttr:         []string{"informational"},
				ExtraData:         []string{"crostini_vm_amd64.zip", "crostini_container_metadata_stretch_amd64.tar.xz", "crostini_container_rootfs_stretch_amd64.tar.xz"},
				ExtraSoftwareDeps: []string{"amd64"},
				ExtraHardwareDeps: crostini.CrostiniUnstable,
				...
				Name:              "wayland_to_x11_artifact_stretch_arm",
				ExtraData:         []string{"crostini_vm_arm.zip", "crostini_container_metadata_stretch_arm.tar.xz", "crostini_container_rootfs_stretch_arm.tar.xz"},
				ExtraSoftwareDeps: []string{"arm"},
				ExtraHardwareDeps: crostini.CrostiniStable,
				Pre:               crostini.StartedByArtifactStretch(),
				...
				Name:              "wayland_to_x11_artifact_stretch_arm_unstable",
				ExtraAttr:         []string{"informational"},
				ExtraData:         []string{"crostini_vm_arm.zip", "crostini_container_metadata_stretch_arm.tar.xz", "crostini_container_rootfs_stretch_arm.tar.xz"},
				ExtraSoftwareDeps: []string{"arm"},
				ExtraHardwareDeps: crostini.CrostiniUnstable,
				...
				Name:              "wayland_to_x11_artifact_buster_amd64",
				ExtraData:         []string{"crostini_vm_amd64.zip", "crostini_container_metadata_buster_amd64.tar.xz", "crostini_container_rootfs_buster_amd64.tar.xz"},
				ExtraSoftwareDeps: []string{"amd64"},
				ExtraHardwareDeps: crostini.CrostiniStable,
				Pre:               crostini.StartedByArtifactBuster(),
				...
				Name:              "wayland_to_x11_artifact_buster_amd64_unstable",
				ExtraAttr:         []string{"informational"},
				ExtraData:         []string{"crostini_vm_amd64.zip", "crostini_container_metadata_buster_amd64.tar.xz", "crostini_container_rootfs_buster_amd64.tar.xz"},
				ExtraSoftwareDeps: []string{"amd64"},
				ExtraHardwareDeps: crostini.CrostiniUnstable,
				...
				Name:              "wayland_to_x11_artifact_buster_arm",
				ExtraData:         []string{"crostini_vm_arm.zip", "crostini_container_metadata_buster_arm.tar.xz", "crostini_container_rootfs_buster_arm.tar.xz"},
				ExtraSoftwareDeps: []string{"arm"},
				ExtraHardwareDeps: crostini.CrostiniStable,
				Pre:               crostini.StartedByArtifactBuster(),
				...
				Name:              "wayland_to_x11_artifact_buster_arm_unstable",
				ExtraAttr:         []string{"informational"},
				ExtraData:         []string{"crostini_vm_arm.zip", "crostini_container_metadata_buster_arm.tar.xz", "crostini_container_rootfs_buster_arm.tar.xz"},
				ExtraSoftwareDeps: []string{"arm"},
				ExtraHardwareDeps: crostini.CrostiniUnstable,
				...
				Name:              "x11_to_wayland_artifact_stretch_amd64",
				ExtraData:         []string{"crostini_vm_amd64.zip", "crostini_container_metadata_stretch_amd64.tar.xz", "crostini_container_rootfs_stretch_amd64.tar.xz"},
				ExtraSoftwareDeps: []string{"amd64"},
				ExtraHardwareDeps: crostini.CrostiniStable,
				Pre:               crostini.StartedByArtifactStretch(),
				...
				Name:              "x11_to_wayland_artifact_stretch_amd64_unstable",
				ExtraAttr:         []string{"informational"},
				ExtraData:         []string{"crostini_vm_amd64.zip", "crostini_container_metadata_stretch_amd64.tar.xz", "crostini_container_rootfs_stretch_amd64.tar.xz"},
				ExtraSoftwareDeps: []string{"amd64"},
				ExtraHardwareDeps: crostini.CrostiniUnstable,
				...
				Name:              "x11_to_wayland_artifact_stretch_arm",
				ExtraData:         []string{"crostini_vm_arm.zip", "crostini_container_metadata_stretch_arm.tar.xz", "crostini_container_rootfs_stretch_arm.tar.xz"},
				ExtraSoftwareDeps: []string{"arm"},
				ExtraHardwareDeps: crostini.CrostiniStable,
				Pre:               crostini.StartedByArtifactStretch(),
				...
				Name:              "x11_to_wayland_artifact_stretch_arm_unstable",
				ExtraAttr:         []string{"informational"},
				ExtraData:         []string{"crostini_vm_arm.zip", "crostini_container_metadata_stretch_arm.tar.xz", "crostini_container_rootfs_stretch_arm.tar.xz"},
				ExtraSoftwareDeps: []string{"arm"},
				ExtraHardwareDeps: crostini.CrostiniUnstable,
				...
				Name:              "x11_to_wayland_artifact_buster_amd64",
				ExtraData:         []string{"crostini_vm_amd64.zip", "crostini_container_metadata_buster_amd64.tar.xz", "crostini_container_rootfs_buster_amd64.tar.xz"},
				ExtraSoftwareDeps: []string{"amd64"},
				ExtraHardwareDeps: crostini.CrostiniStable,
				Pre:               crostini.StartedByArtifactBuster(),
				...
				Name:              "x11_to_wayland_artifact_buster_amd64_unstable",
				ExtraAttr:         []string{"informational"},
				ExtraData:         []string{"crostini_vm_amd64.zip", "crostini_container_metadata_buster_amd64.tar.xz", "crostini_container_rootfs_buster_amd64.tar.xz"},
				ExtraSoftwareDeps: []string{"amd64"},
				ExtraHardwareDeps: crostini.CrostiniUnstable,
				...
				Name:              "x11_to_wayland_artifact_buster_arm",
				ExtraData:         []string{"crostini_vm_arm.zip", "crostini_container_metadata_buster_arm.tar.xz", "crostini_container_rootfs_buster_arm.tar.xz"},
				ExtraSoftwareDeps: []string{"arm"},
				ExtraHardwareDeps: crostini.CrostiniStable,
				Pre:               crostini.StartedByArtifactBuster(),
				...
				Name:              "x11_to_wayland_artifact_buster_arm_unstable",
				ExtraAttr:         []string{"informational"},
				ExtraData:         []string{"crostini_vm_arm.zip", "crostini_container_metadata_buster_arm.tar.xz", "crostini_container_rootfs_buster_arm.tar.xz"},
				ExtraSoftwareDeps: []string{"arm"},
				ExtraHardwareDeps: crostini.CrostiniUnstable,
				...
				Name:              "x11_to_x11_artifact_stretch_amd64",
				ExtraData:         []string{"crostini_vm_amd64.zip", "crostini_container_metadata_stretch_amd64.tar.xz", "crostini_container_rootfs_stretch_amd64.tar.xz"},
				ExtraSoftwareDeps: []string{"amd64"},
				ExtraHardwareDeps: crostini.CrostiniStable,
				Pre:               crostini.StartedByArtifactStretch(),
				...
				Name:              "x11_to_x11_artifact_stretch_amd64_unstable",
				ExtraAttr:         []string{"informational"},
				ExtraData:         []string{"crostini_vm_amd64.zip", "crostini_container_metadata_stretch_amd64.tar.xz", "crostini_container_rootfs_stretch_amd64.tar.xz"},
				ExtraSoftwareDeps: []string{"amd64"},
				ExtraHardwareDeps: crostini.CrostiniUnstable,
				...
				Name:              "x11_to_x11_artifact_stretch_arm",
				ExtraData:         []string{"crostini_vm_arm.zip", "crostini_container_metadata_stretch_arm.tar.xz", "crostini_container_rootfs_stretch_arm.tar.xz"},
				ExtraSoftwareDeps: []string{"arm"},
				ExtraHardwareDeps: crostini.CrostiniStable,
				Pre:               crostini.StartedByArtifactStretch(),
				...
				Name:              "x11_to_x11_artifact_stretch_arm_unstable",
				ExtraAttr:         []string{"informational"},
				ExtraData:         []string{"crostini_vm_arm.zip", "crostini_container_metadata_stretch_arm.tar.xz", "crostini_container_rootfs_stretch_arm.tar.xz"},
				ExtraSoftwareDeps: []string{"arm"},
				ExtraHardwareDeps: crostini.CrostiniUnstable,
				...
				Name:              "x11_to_x11_artifact_buster_amd64",
				ExtraData:         []string{"crostini_vm_amd64.zip", "crostini_container_metadata_buster_amd64.tar.xz", "crostini_container_rootfs_buster_amd64.tar.xz"},
				ExtraSoftwareDeps: []string{"amd64"},
				ExtraHardwareDeps: crostini.CrostiniStable,
				Pre:               crostini.StartedByArtifactBuster(),
				...
				Name:              "x11_to_x11_artifact_buster_amd64_unstable",
				ExtraAttr:         []string{"informational"},
				ExtraData:         []string{"crostini_vm_amd64.zip", "crostini_container_metadata_buster_amd64.tar.xz", "crostini_container_rootfs_buster_amd64.tar.xz"},
				ExtraSoftwareDeps: []string{"amd64"},
				ExtraHardwareDeps: crostini.CrostiniUnstable,
				...
				Name:              "x11_to_x11_artifact_buster_arm",
				ExtraData:         []string{"crostini_vm_arm.zip", "crostini_container_metadata_buster_arm.tar.xz", "crostini_container_rootfs_buster_arm.tar.xz"},
				ExtraSoftwareDeps: []string{"arm"},
				ExtraHardwareDeps: crostini.CrostiniStable,
				Pre:               crostini.StartedByArtifactBuster(),
				...
				Name:              "x11_to_x11_artifact_buster_arm_unstable",
				ExtraAttr:         []string{"informational"},
				ExtraData:         []string{"crostini_vm_arm.zip", "crostini_container_metadata_buster_arm.tar.xz", "crostini_container_rootfs_buster_arm.tar.xz"},
				ExtraSoftwareDeps: []string{"arm"},
				ExtraHardwareDeps: crostini.CrostiniUnstable,
