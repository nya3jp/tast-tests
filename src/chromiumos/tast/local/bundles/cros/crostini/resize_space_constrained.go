...
func init() {
	testing.AddTest(&testing.Test{
		Func: ResizeSpaceConstrained, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Test resizing disk of Crostini from the Settings with constrained host disk space",
