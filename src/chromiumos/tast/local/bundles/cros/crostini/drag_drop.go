...
func init() {
	...
	testing.AddTest(&testing.Test{
		...
		Contacts:     []string{"joelhockey@google.com", "clumptini+oncall@google.com"},
		...
		SearchFlags: []*testing.StringPair{
			{
				Key:   "feature_id",
				Value: "screenplay-8ac4061c-453d-485a-8178-681ac18b1bc2",
			},
		},
...
func dragFromCrostini(ctx context.Context, pre crostini.FixtureData, files *filesapp.FilesApp, filesWindow *ash.Window, path string, isFile bool) error {
	...
	myFilesPath, err := cryptohome.MyFilesPath(ctx, pre.Chrome.NormalizedUser())
	if err != nil {
		return errors.Wrap(err, "failed to get user's MyFiles path")
	}
