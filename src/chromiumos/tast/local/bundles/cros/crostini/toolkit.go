...
func init() {
	testing.AddTest(&testing.Test{
		...
		Params: []testing.Param{
			...
			{
				Name:              "gtk3_wayland_artifact",
				ExtraData:         []string{"toolkit_gtk3_demo.py", "crostini_guest_images.tar"},
				...
				Name:              "gtk3_wayland_artifact_unstable",
				...
				Name:      "gtk3_wayland_download_stretch",
				ExtraAttr: []string{"informational"},
				...
				Name:      "gtk3_wayland_download_buster",
				ExtraAttr: []string{"informational"},
				ExtraData: []string{"toolkit_gtk3_demo.py"},
				...
				Name:              "gtk3_x11_artifact_unstable",
				ExtraAttr:         []string{"informational"},
				ExtraData:         []string{"toolkit_gtk3_demo.py", "crostini_guest_images.tar"},
				ExtraHardwareDeps: crostini.CrostiniUnstable,
				Pre:               crostini.StartedByArtifact(),
				...
				Name:      "gtk3_x11_download_stretch",
				ExtraAttr: []string{"informational"},
				ExtraData: []string{"toolkit_gtk3_demo.py"},
				Pre:       crostini.StartedByDownloadStretch(),
				Timeout:   10 * time.Minute,
				...
				Name:              "qt5_artifact",
				ExtraData:         []string{"toolkit_qt5_demo.py", "crostini_guest_images.tar"},
				ExtraHardwareDeps: crostini.CrostiniStable,
				Pre:               crostini.StartedByArtifact(),
				Timeout:           7 * time.Minute,
				Val: toolkitConfig{
				...
				Name:              "tkinter_artifact",
				ExtraData:         []string{"toolkit_tkinter_demo.py", "crostini_guest_images.tar"},
				ExtraHardwareDeps: crostini.CrostiniStable,
				Pre:               crostini.StartedByArtifact(),
				Timeout:           7 * time.Minute,
				Val: toolkitConfig{
				...
				Name:              "tkinter_artifact_unstable",
				ExtraAttr:         []string{"informational"},
				ExtraData:         []string{"toolkit_tkinter_demo.py", "crostini_guest_images.tar"},
				ExtraHardwareDeps: crostini.CrostiniUnstable,
				Pre:               crostini.StartedByArtifact(),
