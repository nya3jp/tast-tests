...
// controlPulse control pulseaudio through systemctl with command `cmd`.
...
func PulseAudioSanity(ctx context.Context, s *testing.State) {
	...
	// cros-pulse-config.service in cros-pulse-config_v0.1.* should load alsa sinks / sources within 1 sec.
