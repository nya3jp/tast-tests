...
func init() {
	testing.AddTest(&testing.Test{
		Func: AudioBasic, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Runs a basic test on the container's audio (through alsa) using a pre-built crostini image",
