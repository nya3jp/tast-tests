...
func ShareFilesToast(ctx context.Context, s *testing.State) {
	...
	if err := sharedFolders.ShareMyfiles(ctx, tconn, filesApp, linuxfiles.MyFilesMsg, true, true); err != nil {
	...
	if err := sharedFolders.Unshare(ctx, tconn, linuxfiles.MyFiles); err != nil {
