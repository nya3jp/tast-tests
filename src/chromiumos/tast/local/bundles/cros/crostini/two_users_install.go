...
func TwoUsersInstall(ctx context.Context, s *testing.State) {
	...
	iOptionsUser1 := crostini.GetInstallerOptions(s, vm.DebianBullseye, false /*largeContainer*/, firstCr.NormalizedUser())
	...
	iOptionsUser2 := crostini.GetInstallerOptions(s, vm.DebianBullseye, false /*largeContainer*/, secondCr.NormalizedUser())
