...
func init() {
	testing.AddTest(&testing.Test{
		...
		Params: []testing.Param{
			...
			{
				Name:              "copy_wayland_component_stretch_amd64_stable",
				...
				Name:              "copy_wayland_dlc_stretch_amd64_stable",
				ExtraAttr:         []string{"informational"},
				ExtraData:         []string{"secure_copy.py", "crostini_test_container_metadata_stretch_amd64.tar.xz", "crostini_test_container_rootfs_stretch_amd64.tar.xz"},
				ExtraSoftwareDeps: []string{"amd64"},
				ExtraHardwareDeps: crostini.CrostiniStable,
				Pre:               crostini.StartedByComponentStretch(),
				Timeout:           7 * time.Minute,
				...
				Name:              "copy_wayland_component_stretch_amd64_unstable",
				ExtraAttr:         []string{"informational"},
				ExtraData:         []string{"secure_copy.py", "crostini_vm_amd64.zip", "crostini_test_container_metadata_stretch_amd64.tar.xz", "crostini_test_container_rootfs_stretch_amd64.tar.xz"},
				ExtraSoftwareDeps: []string{"amd64"},
				...
				Name:              "copy_wayland_dlc_stretch_amd64_unstable",
				ExtraAttr:         []string{"informational"},
				ExtraData:         []string{"secure_copy.py", "crostini_test_container_metadata_stretch_amd64.tar.xz", "crostini_test_container_rootfs_stretch_amd64.tar.xz"},
				ExtraSoftwareDeps: []string{"amd64"},
				ExtraHardwareDeps: crostini.CrostiniUnstable,
				...
				Name:              "copy_wayland_component_stretch_arm_stable",
				...
				Name:              "copy_wayland_dlc_stretch_arm_stable",
				ExtraAttr:         []string{"informational"},
				ExtraData:         []string{"secure_copy.py", "crostini_test_container_metadata_stretch_arm.tar.xz", "crostini_test_container_rootfs_stretch_arm.tar.xz"},
				ExtraSoftwareDeps: []string{"arm"},
				ExtraHardwareDeps: crostini.CrostiniStable,
				Pre:               crostini.StartedByComponentStretch(),
				Timeout:           7 * time.Minute,
				...
				Name:              "copy_wayland_component_stretch_arm_unstable",
				ExtraAttr:         []string{"informational"},
				ExtraData:         []string{"secure_copy.py", "crostini_vm_arm.zip", "crostini_test_container_metadata_stretch_arm.tar.xz", "crostini_test_container_rootfs_stretch_arm.tar.xz"},
				ExtraSoftwareDeps: []string{"arm"},
				ExtraHardwareDeps: crostini.CrostiniUnstable,
				...
				Name:              "copy_wayland_dlc_stretch_arm_unstable",
				ExtraAttr:         []string{"informational"},
				ExtraData:         []string{"secure_copy.py", "crostini_test_container_metadata_stretch_arm.tar.xz", "crostini_test_container_rootfs_stretch_arm.tar.xz"},
				ExtraSoftwareDeps: []string{"arm"},
				ExtraHardwareDeps: crostini.CrostiniUnstable,
				...
				Name:              "copy_wayland_component_buster_amd64_stable",
				...
				Name:              "copy_wayland_dlc_buster_amd64_stable",
				ExtraAttr:         []string{"informational"},
				ExtraData:         []string{"secure_copy.py", "crostini_test_container_metadata_buster_amd64.tar.xz", "crostini_test_container_rootfs_buster_amd64.tar.xz"},
				ExtraSoftwareDeps: []string{"amd64"},
				ExtraHardwareDeps: crostini.CrostiniStable,
				Pre:               crostini.StartedByComponentBuster(),
				Timeout:           7 * time.Minute,
				...
				Name:              "copy_wayland_component_buster_amd64_unstable",
				ExtraAttr:         []string{"informational"},
				ExtraData:         []string{"secure_copy.py", "crostini_vm_amd64.zip", "crostini_test_container_metadata_buster_amd64.tar.xz", "crostini_test_container_rootfs_buster_amd64.tar.xz"},
				ExtraSoftwareDeps: []string{"amd64"},
				ExtraHardwareDeps: crostini.CrostiniUnstable,
				...
				Name:              "copy_wayland_dlc_buster_amd64_unstable",
				ExtraAttr:         []string{"informational"},
				ExtraData:         []string{"secure_copy.py", "crostini_test_container_metadata_buster_amd64.tar.xz", "crostini_test_container_rootfs_buster_amd64.tar.xz"},
				ExtraSoftwareDeps: []string{"amd64"},
				ExtraHardwareDeps: crostini.CrostiniUnstable,
				...
				Name:              "copy_wayland_component_buster_arm_stable",
				...
				Name:              "copy_wayland_dlc_buster_arm_stable",
				ExtraAttr:         []string{"informational"},
				ExtraData:         []string{"secure_copy.py", "crostini_test_container_metadata_buster_arm.tar.xz", "crostini_test_container_rootfs_buster_arm.tar.xz"},
				ExtraSoftwareDeps: []string{"arm"},
				ExtraHardwareDeps: crostini.CrostiniStable,
				Pre:               crostini.StartedByComponentBuster(),
				Timeout:           7 * time.Minute,
				...
				Name:              "copy_wayland_component_buster_arm_unstable",
				ExtraAttr:         []string{"informational"},
				ExtraData:         []string{"secure_copy.py", "crostini_vm_arm.zip", "crostini_test_container_metadata_buster_arm.tar.xz", "crostini_test_container_rootfs_buster_arm.tar.xz"},
				ExtraSoftwareDeps: []string{"arm"},
				ExtraHardwareDeps: crostini.CrostiniUnstable,
				...
				Name:              "copy_wayland_dlc_buster_arm_unstable",
				ExtraAttr:         []string{"informational"},
				ExtraData:         []string{"secure_copy.py", "crostini_test_container_metadata_buster_arm.tar.xz", "crostini_test_container_rootfs_buster_arm.tar.xz"},
				ExtraSoftwareDeps: []string{"arm"},
				ExtraHardwareDeps: crostini.CrostiniUnstable,
				...
				Name:              "copy_x11_component_stretch_amd64_stable",
				ExtraData:         []string{"secure_copy.py", "crostini_vm_amd64.zip", "crostini_test_container_metadata_stretch_amd64.tar.xz", "crostini_test_container_rootfs_stretch_amd64.tar.xz"},
				ExtraSoftwareDeps: []string{"amd64"},
				ExtraHardwareDeps: crostini.CrostiniStable,
				Pre:               crostini.StartedByComponentStretch(),
				...
				Name:              "copy_x11_dlc_stretch_amd64_stable",
				ExtraAttr:         []string{"informational"},
				ExtraData:         []string{"secure_copy.py", "crostini_test_container_metadata_stretch_amd64.tar.xz", "crostini_test_container_rootfs_stretch_amd64.tar.xz"},
				ExtraSoftwareDeps: []string{"amd64"},
				ExtraHardwareDeps: crostini.CrostiniStable,
				...
				Name:              "copy_x11_component_stretch_amd64_unstable",
				ExtraAttr:         []string{"informational"},
				ExtraData:         []string{"secure_copy.py", "crostini_vm_amd64.zip", "crostini_test_container_metadata_stretch_amd64.tar.xz", "crostini_test_container_rootfs_stretch_amd64.tar.xz"},
				ExtraSoftwareDeps: []string{"amd64"},
				ExtraHardwareDeps: crostini.CrostiniUnstable,
				...
				Name:              "copy_x11_dlc_stretch_amd64_unstable",
				ExtraAttr:         []string{"informational"},
				ExtraData:         []string{"secure_copy.py", "crostini_test_container_metadata_stretch_amd64.tar.xz", "crostini_test_container_rootfs_stretch_amd64.tar.xz"},
				ExtraSoftwareDeps: []string{"amd64"},
				ExtraHardwareDeps: crostini.CrostiniUnstable,
				...
				Name:              "copy_x11_component_stretch_arm_stable",
				ExtraData:         []string{"secure_copy.py", "crostini_vm_arm.zip", "crostini_test_container_metadata_stretch_arm.tar.xz", "crostini_test_container_rootfs_stretch_arm.tar.xz"},
				ExtraSoftwareDeps: []string{"arm"},
				ExtraHardwareDeps: crostini.CrostiniStable,
				Pre:               crostini.StartedByComponentStretch(),
				...
				Name:              "copy_x11_dlc_stretch_arm_stable",
				ExtraAttr:         []string{"informational"},
				ExtraData:         []string{"secure_copy.py", "crostini_test_container_metadata_stretch_arm.tar.xz", "crostini_test_container_rootfs_stretch_arm.tar.xz"},
				ExtraSoftwareDeps: []string{"arm"},
				ExtraHardwareDeps: crostini.CrostiniStable,
				...
				Name:              "copy_x11_component_stretch_arm_unstable",
				ExtraAttr:         []string{"informational"},
				ExtraData:         []string{"secure_copy.py", "crostini_vm_arm.zip", "crostini_test_container_metadata_stretch_arm.tar.xz", "crostini_test_container_rootfs_stretch_arm.tar.xz"},
				ExtraSoftwareDeps: []string{"arm"},
				ExtraHardwareDeps: crostini.CrostiniUnstable,
				...
				Name:              "copy_x11_dlc_stretch_arm_unstable",
				ExtraAttr:         []string{"informational"},
				ExtraData:         []string{"secure_copy.py", "crostini_test_container_metadata_stretch_arm.tar.xz", "crostini_test_container_rootfs_stretch_arm.tar.xz"},
				ExtraSoftwareDeps: []string{"arm"},
				ExtraHardwareDeps: crostini.CrostiniUnstable,
				...
				Name:              "copy_x11_component_buster_amd64_stable",
				ExtraData:         []string{"secure_copy.py", "crostini_vm_amd64.zip", "crostini_test_container_metadata_buster_amd64.tar.xz", "crostini_test_container_rootfs_buster_amd64.tar.xz"},
				ExtraSoftwareDeps: []string{"amd64"},
				ExtraHardwareDeps: crostini.CrostiniStable,
				Pre:               crostini.StartedByComponentBuster(),
				...
				Name:              "copy_x11_dlc_buster_amd64_stable",
				ExtraAttr:         []string{"informational"},
				ExtraData:         []string{"secure_copy.py", "crostini_test_container_metadata_buster_amd64.tar.xz", "crostini_test_container_rootfs_buster_amd64.tar.xz"},
				ExtraSoftwareDeps: []string{"amd64"},
				ExtraHardwareDeps: crostini.CrostiniStable,
				...
				Name:              "copy_x11_component_buster_amd64_unstable",
				ExtraAttr:         []string{"informational"},
				ExtraData:         []string{"secure_copy.py", "crostini_vm_amd64.zip", "crostini_test_container_metadata_buster_amd64.tar.xz", "crostini_test_container_rootfs_buster_amd64.tar.xz"},
				ExtraSoftwareDeps: []string{"amd64"},
				ExtraHardwareDeps: crostini.CrostiniUnstable,
				...
				Name:              "copy_x11_dlc_buster_amd64_unstable",
				ExtraAttr:         []string{"informational"},
				ExtraData:         []string{"secure_copy.py", "crostini_test_container_metadata_buster_amd64.tar.xz", "crostini_test_container_rootfs_buster_amd64.tar.xz"},
				ExtraSoftwareDeps: []string{"amd64"},
				ExtraHardwareDeps: crostini.CrostiniUnstable,
				...
				Name:              "copy_x11_component_buster_arm_stable",
				ExtraData:         []string{"secure_copy.py", "crostini_vm_arm.zip", "crostini_test_container_metadata_buster_arm.tar.xz", "crostini_test_container_rootfs_buster_arm.tar.xz"},
				ExtraSoftwareDeps: []string{"arm"},
				ExtraHardwareDeps: crostini.CrostiniStable,
				Pre:               crostini.StartedByComponentBuster(),
				...
				Name:              "copy_x11_dlc_buster_arm_stable",
				ExtraAttr:         []string{"informational"},
				ExtraData:         []string{"secure_copy.py", "crostini_test_container_metadata_buster_arm.tar.xz", "crostini_test_container_rootfs_buster_arm.tar.xz"},
				ExtraSoftwareDeps: []string{"arm"},
				ExtraHardwareDeps: crostini.CrostiniStable,
				...
				Name:              "copy_x11_component_buster_arm_unstable",
				ExtraAttr:         []string{"informational"},
				ExtraData:         []string{"secure_copy.py", "crostini_vm_arm.zip", "crostini_test_container_metadata_buster_arm.tar.xz", "crostini_test_container_rootfs_buster_arm.tar.xz"},
				ExtraSoftwareDeps: []string{"arm"},
				ExtraHardwareDeps: crostini.CrostiniUnstable,
				...
				Name:              "copy_x11_dlc_buster_arm_unstable",
				ExtraAttr:         []string{"informational"},
				ExtraData:         []string{"secure_copy.py", "crostini_test_container_metadata_buster_arm.tar.xz", "crostini_test_container_rootfs_buster_arm.tar.xz"},
				ExtraSoftwareDeps: []string{"arm"},
				ExtraHardwareDeps: crostini.CrostiniUnstable,
				...
				Name:              "paste_wayland_component_stretch_amd64_stable",
				...
				Name:              "paste_wayland_dlc_stretch_amd64_stable",
				ExtraAttr:         []string{"informational"},
				ExtraData:         []string{"secure_paste.py", "crostini_test_container_metadata_stretch_amd64.tar.xz", "crostini_test_container_rootfs_stretch_amd64.tar.xz"},
				ExtraSoftwareDeps: []string{"amd64"},
				ExtraHardwareDeps: crostini.CrostiniStable,
				Pre:               crostini.StartedByComponentStretch(),
				Timeout:           7 * time.Minute,
				...
				Name:              "paste_wayland_component_stretch_amd64_unstable",
				ExtraAttr:         []string{"informational"},
				ExtraData:         []string{"secure_paste.py", "crostini_vm_amd64.zip", "crostini_test_container_metadata_stretch_amd64.tar.xz", "crostini_test_container_rootfs_stretch_amd64.tar.xz"},
				ExtraSoftwareDeps: []string{"amd64"},
				ExtraHardwareDeps: crostini.CrostiniUnstable,
				...
				Name:              "paste_wayland_dlc_stretch_amd64_unstable",
				ExtraAttr:         []string{"informational"},
				ExtraData:         []string{"secure_paste.py", "crostini_test_container_metadata_stretch_amd64.tar.xz", "crostini_test_container_rootfs_stretch_amd64.tar.xz"},
				ExtraSoftwareDeps: []string{"amd64"},
				ExtraHardwareDeps: crostini.CrostiniUnstable,
				...
				Name:              "paste_wayland_component_stretch_arm_stable",
				...
				Name:              "paste_wayland_dlc_stretch_arm_stable",
				ExtraAttr:         []string{"informational"},
				ExtraData:         []string{"secure_paste.py", "crostini_test_container_metadata_stretch_arm.tar.xz", "crostini_test_container_rootfs_stretch_arm.tar.xz"},
				ExtraSoftwareDeps: []string{"arm"},
				ExtraHardwareDeps: crostini.CrostiniStable,
				Pre:               crostini.StartedByComponentStretch(),
				Timeout:           7 * time.Minute,
				...
				Name:              "paste_wayland_component_stretch_arm_unstable",
				ExtraAttr:         []string{"informational"},
				ExtraData:         []string{"secure_paste.py", "crostini_vm_arm.zip", "crostini_test_container_metadata_stretch_arm.tar.xz", "crostini_test_container_rootfs_stretch_arm.tar.xz"},
				ExtraSoftwareDeps: []string{"arm"},
				ExtraHardwareDeps: crostini.CrostiniUnstable,
				...
				Name:              "paste_wayland_dlc_stretch_arm_unstable",
				ExtraAttr:         []string{"informational"},
				ExtraData:         []string{"secure_paste.py", "crostini_test_container_metadata_stretch_arm.tar.xz", "crostini_test_container_rootfs_stretch_arm.tar.xz"},
				ExtraSoftwareDeps: []string{"arm"},
				ExtraHardwareDeps: crostini.CrostiniUnstable,
				...
				Name:              "paste_wayland_component_buster_amd64_stable",
				...
				Name:              "paste_wayland_dlc_buster_amd64_stable",
				ExtraAttr:         []string{"informational"},
				ExtraData:         []string{"secure_paste.py", "crostini_test_container_metadata_buster_amd64.tar.xz", "crostini_test_container_rootfs_buster_amd64.tar.xz"},
				ExtraSoftwareDeps: []string{"amd64"},
				ExtraHardwareDeps: crostini.CrostiniStable,
				Pre:               crostini.StartedByComponentBuster(),
				Timeout:           7 * time.Minute,
				...
				Name:              "paste_wayland_component_buster_amd64_unstable",
				ExtraAttr:         []string{"informational"},
				ExtraData:         []string{"secure_paste.py", "crostini_vm_amd64.zip", "crostini_test_container_metadata_buster_amd64.tar.xz", "crostini_test_container_rootfs_buster_amd64.tar.xz"},
				ExtraSoftwareDeps: []string{"amd64"},
				ExtraHardwareDeps: crostini.CrostiniUnstable,
				...
				Name:              "paste_wayland_dlc_buster_amd64_unstable",
				ExtraAttr:         []string{"informational"},
				ExtraData:         []string{"secure_paste.py", "crostini_test_container_metadata_buster_amd64.tar.xz", "crostini_test_container_rootfs_buster_amd64.tar.xz"},
				ExtraSoftwareDeps: []string{"amd64"},
				ExtraHardwareDeps: crostini.CrostiniUnstable,
				...
				Name:              "paste_wayland_component_buster_arm_stable",
				...
				Name:              "paste_wayland_dlc_buster_arm_stable",
				ExtraAttr:         []string{"informational"},
				ExtraData:         []string{"secure_paste.py", "crostini_test_container_metadata_buster_arm.tar.xz", "crostini_test_container_rootfs_buster_arm.tar.xz"},
				ExtraSoftwareDeps: []string{"arm"},
				ExtraHardwareDeps: crostini.CrostiniStable,
				Pre:               crostini.StartedByComponentBuster(),
				Timeout:           7 * time.Minute,
				...
				Name:              "paste_wayland_component_buster_arm_unstable",
				ExtraAttr:         []string{"informational"},
				ExtraData:         []string{"secure_paste.py", "crostini_vm_arm.zip", "crostini_test_container_metadata_buster_arm.tar.xz", "crostini_test_container_rootfs_buster_arm.tar.xz"},
				ExtraSoftwareDeps: []string{"arm"},
				ExtraHardwareDeps: crostini.CrostiniUnstable,
				...
				Name:              "paste_wayland_dlc_buster_arm_unstable",
				ExtraAttr:         []string{"informational"},
				ExtraData:         []string{"secure_paste.py", "crostini_test_container_metadata_buster_arm.tar.xz", "crostini_test_container_rootfs_buster_arm.tar.xz"},
				ExtraSoftwareDeps: []string{"arm"},
				ExtraHardwareDeps: crostini.CrostiniUnstable,
				...
				Name:              "paste_x11_component_stretch_amd64_stable",
				ExtraData:         []string{"secure_paste.py", "crostini_vm_amd64.zip", "crostini_test_container_metadata_stretch_amd64.tar.xz", "crostini_test_container_rootfs_stretch_amd64.tar.xz"},
				ExtraSoftwareDeps: []string{"amd64"},
				ExtraHardwareDeps: crostini.CrostiniStable,
				Pre:               crostini.StartedByComponentStretch(),
				...
				Name:              "paste_x11_dlc_stretch_amd64_stable",
				ExtraAttr:         []string{"informational"},
				ExtraData:         []string{"secure_paste.py", "crostini_test_container_metadata_stretch_amd64.tar.xz", "crostini_test_container_rootfs_stretch_amd64.tar.xz"},
				ExtraSoftwareDeps: []string{"amd64"},
				ExtraHardwareDeps: crostini.CrostiniStable,
				...
				Name:              "paste_x11_component_stretch_amd64_unstable",
				ExtraAttr:         []string{"informational"},
				ExtraData:         []string{"secure_paste.py", "crostini_vm_amd64.zip", "crostini_test_container_metadata_stretch_amd64.tar.xz", "crostini_test_container_rootfs_stretch_amd64.tar.xz"},
				ExtraSoftwareDeps: []string{"amd64"},
				ExtraHardwareDeps: crostini.CrostiniUnstable,
				...
				Name:              "paste_x11_dlc_stretch_amd64_unstable",
				ExtraAttr:         []string{"informational"},
				ExtraData:         []string{"secure_paste.py", "crostini_test_container_metadata_stretch_amd64.tar.xz", "crostini_test_container_rootfs_stretch_amd64.tar.xz"},
				ExtraSoftwareDeps: []string{"amd64"},
				ExtraHardwareDeps: crostini.CrostiniUnstable,
				...
				Name:              "paste_x11_component_stretch_arm_stable",
				ExtraData:         []string{"secure_paste.py", "crostini_vm_arm.zip", "crostini_test_container_metadata_stretch_arm.tar.xz", "crostini_test_container_rootfs_stretch_arm.tar.xz"},
				ExtraSoftwareDeps: []string{"arm"},
				ExtraHardwareDeps: crostini.CrostiniStable,
				Pre:               crostini.StartedByComponentStretch(),
				...
				Name:              "paste_x11_dlc_stretch_arm_stable",
				ExtraAttr:         []string{"informational"},
				ExtraData:         []string{"secure_paste.py", "crostini_test_container_metadata_stretch_arm.tar.xz", "crostini_test_container_rootfs_stretch_arm.tar.xz"},
				ExtraSoftwareDeps: []string{"arm"},
				ExtraHardwareDeps: crostini.CrostiniStable,
				...
				Name:              "paste_x11_component_stretch_arm_unstable",
				ExtraAttr:         []string{"informational"},
				ExtraData:         []string{"secure_paste.py", "crostini_vm_arm.zip", "crostini_test_container_metadata_stretch_arm.tar.xz", "crostini_test_container_rootfs_stretch_arm.tar.xz"},
				ExtraSoftwareDeps: []string{"arm"},
				ExtraHardwareDeps: crostini.CrostiniUnstable,
				...
				Name:              "paste_x11_dlc_stretch_arm_unstable",
				ExtraAttr:         []string{"informational"},
				ExtraData:         []string{"secure_paste.py", "crostini_test_container_metadata_stretch_arm.tar.xz", "crostini_test_container_rootfs_stretch_arm.tar.xz"},
				ExtraSoftwareDeps: []string{"arm"},
				ExtraHardwareDeps: crostini.CrostiniUnstable,
				...
				Name:              "paste_x11_component_buster_amd64_stable",
				ExtraData:         []string{"secure_paste.py", "crostini_vm_amd64.zip", "crostini_test_container_metadata_buster_amd64.tar.xz", "crostini_test_container_rootfs_buster_amd64.tar.xz"},
				ExtraSoftwareDeps: []string{"amd64"},
				ExtraHardwareDeps: crostini.CrostiniStable,
				Pre:               crostini.StartedByComponentBuster(),
				...
				Name:              "paste_x11_dlc_buster_amd64_stable",
				ExtraAttr:         []string{"informational"},
				ExtraData:         []string{"secure_paste.py", "crostini_test_container_metadata_buster_amd64.tar.xz", "crostini_test_container_rootfs_buster_amd64.tar.xz"},
				ExtraSoftwareDeps: []string{"amd64"},
				ExtraHardwareDeps: crostini.CrostiniStable,
				...
				Name:              "paste_x11_component_buster_amd64_unstable",
				ExtraAttr:         []string{"informational"},
				ExtraData:         []string{"secure_paste.py", "crostini_vm_amd64.zip", "crostini_test_container_metadata_buster_amd64.tar.xz", "crostini_test_container_rootfs_buster_amd64.tar.xz"},
				ExtraSoftwareDeps: []string{"amd64"},
				ExtraHardwareDeps: crostini.CrostiniUnstable,
				...
				Name:              "paste_x11_dlc_buster_amd64_unstable",
				ExtraAttr:         []string{"informational"},
				ExtraData:         []string{"secure_paste.py", "crostini_test_container_metadata_buster_amd64.tar.xz", "crostini_test_container_rootfs_buster_amd64.tar.xz"},
				ExtraSoftwareDeps: []string{"amd64"},
				ExtraHardwareDeps: crostini.CrostiniUnstable,
				...
				Name:              "paste_x11_component_buster_arm_stable",
				ExtraData:         []string{"secure_paste.py", "crostini_vm_arm.zip", "crostini_test_container_metadata_buster_arm.tar.xz", "crostini_test_container_rootfs_buster_arm.tar.xz"},
				ExtraSoftwareDeps: []string{"arm"},
				ExtraHardwareDeps: crostini.CrostiniStable,
				Pre:               crostini.StartedByComponentBuster(),
				...
				Name:              "paste_x11_dlc_buster_arm_stable",
				ExtraAttr:         []string{"informational"},
				ExtraData:         []string{"secure_paste.py", "crostini_test_container_metadata_buster_arm.tar.xz", "crostini_test_container_rootfs_buster_arm.tar.xz"},
				ExtraSoftwareDeps: []string{"arm"},
				ExtraHardwareDeps: crostini.CrostiniStable,
				...
				Name:              "paste_x11_component_buster_arm_unstable",
				ExtraAttr:         []string{"informational"},
				ExtraData:         []string{"secure_paste.py", "crostini_vm_arm.zip", "crostini_test_container_metadata_buster_arm.tar.xz", "crostini_test_container_rootfs_buster_arm.tar.xz"},
				ExtraSoftwareDeps: []string{"arm"},
				ExtraHardwareDeps: crostini.CrostiniUnstable,
				...
				Name:              "paste_x11_dlc_buster_arm_unstable",
				ExtraAttr:         []string{"informational"},
				ExtraData:         []string{"secure_paste.py", "crostini_test_container_metadata_buster_arm.tar.xz", "crostini_test_container_rootfs_buster_arm.tar.xz"},
				ExtraSoftwareDeps: []string{"arm"},
				ExtraHardwareDeps: crostini.CrostiniUnstable,
