...
func init() {
	testing.AddTest(&testing.Test{
		...
		Params: []testing.Param{
			...
			{
				Name:              "copy_wayland_artifact_stretch_amd64",
				...
				Name:              "copy_wayland_artifact_stretch_amd64_unstable",
				...
				Name:              "copy_wayland_artifact_stretch_arm",
				...
				Name:              "copy_wayland_artifact_stretch_arm_unstable",
				ExtraAttr:         []string{"informational"},
				ExtraData:         []string{"secure_copy.py", "crostini_vm_arm.zip", "crostini_container_metadata_stretch_arm.tar.xz", "crostini_container_rootfs_stretch_arm.tar.xz"},
				ExtraSoftwareDeps: []string{"arm"},
				ExtraHardwareDeps: crostini.CrostiniUnstable,
				...
				Name:              "copy_wayland_artifact_buster_amd64",
				...
				Name:              "copy_wayland_artifact_buster_amd64_unstable",
				ExtraAttr:         []string{"informational"},
				ExtraData:         []string{"secure_copy.py", "crostini_vm_amd64.zip", "crostini_container_metadata_buster_amd64.tar.xz", "crostini_container_rootfs_buster_amd64.tar.xz"},
				ExtraSoftwareDeps: []string{"amd64"},
				ExtraHardwareDeps: crostini.CrostiniUnstable,
				...
				Name:              "copy_wayland_artifact_buster_arm",
				...
				Name:              "copy_wayland_artifact_buster_arm_unstable",
				ExtraAttr:         []string{"informational"},
				ExtraData:         []string{"secure_copy.py", "crostini_vm_arm.zip", "crostini_container_metadata_buster_arm.tar.xz", "crostini_container_rootfs_buster_arm.tar.xz"},
				ExtraSoftwareDeps: []string{"arm"},
				ExtraHardwareDeps: crostini.CrostiniUnstable,
				...
				Name:              "copy_x11_artifact_stretch_amd64",
				ExtraData:         []string{"secure_copy.py", "crostini_vm_amd64.zip", "crostini_container_metadata_stretch_amd64.tar.xz", "crostini_container_rootfs_stretch_amd64.tar.xz"},
				ExtraSoftwareDeps: []string{"amd64"},
				ExtraHardwareDeps: crostini.CrostiniStable,
				Pre:               crostini.StartedByArtifactStretch(),
				...
				Name:              "copy_x11_artifact_stretch_amd64_unstable",
				ExtraAttr:         []string{"informational"},
				ExtraData:         []string{"secure_copy.py", "crostini_vm_amd64.zip", "crostini_container_metadata_stretch_amd64.tar.xz", "crostini_container_rootfs_stretch_amd64.tar.xz"},
				ExtraSoftwareDeps: []string{"amd64"},
				ExtraHardwareDeps: crostini.CrostiniUnstable,
				...
				Name:              "copy_x11_artifact_stretch_arm",
				ExtraData:         []string{"secure_copy.py", "crostini_vm_arm.zip", "crostini_container_metadata_stretch_arm.tar.xz", "crostini_container_rootfs_stretch_arm.tar.xz"},
				ExtraSoftwareDeps: []string{"arm"},
				ExtraHardwareDeps: crostini.CrostiniStable,
				Pre:               crostini.StartedByArtifactStretch(),
				...
				Name:              "copy_x11_artifact_stretch_arm_unstable",
				ExtraAttr:         []string{"informational"},
				ExtraData:         []string{"secure_copy.py", "crostini_vm_arm.zip", "crostini_container_metadata_stretch_arm.tar.xz", "crostini_container_rootfs_stretch_arm.tar.xz"},
				ExtraSoftwareDeps: []string{"arm"},
				ExtraHardwareDeps: crostini.CrostiniUnstable,
				...
				Name:              "copy_x11_artifact_buster_amd64",
				ExtraData:         []string{"secure_copy.py", "crostini_vm_amd64.zip", "crostini_container_metadata_buster_amd64.tar.xz", "crostini_container_rootfs_buster_amd64.tar.xz"},
				ExtraSoftwareDeps: []string{"amd64"},
				ExtraHardwareDeps: crostini.CrostiniStable,
				Pre:               crostini.StartedByArtifactBuster(),
				...
				Name:              "copy_x11_artifact_buster_amd64_unstable",
				ExtraAttr:         []string{"informational"},
				ExtraData:         []string{"secure_copy.py", "crostini_vm_amd64.zip", "crostini_container_metadata_buster_amd64.tar.xz", "crostini_container_rootfs_buster_amd64.tar.xz"},
				ExtraSoftwareDeps: []string{"amd64"},
				ExtraHardwareDeps: crostini.CrostiniUnstable,
				...
				Name:              "copy_x11_artifact_buster_arm",
				ExtraData:         []string{"secure_copy.py", "crostini_vm_arm.zip", "crostini_container_metadata_buster_arm.tar.xz", "crostini_container_rootfs_buster_arm.tar.xz"},
				ExtraSoftwareDeps: []string{"arm"},
				ExtraHardwareDeps: crostini.CrostiniStable,
				Pre:               crostini.StartedByArtifactBuster(),
				...
				Name:              "copy_x11_artifact_buster_arm_unstable",
				ExtraAttr:         []string{"informational"},
				ExtraData:         []string{"secure_copy.py", "crostini_vm_arm.zip", "crostini_container_metadata_buster_arm.tar.xz", "crostini_container_rootfs_buster_arm.tar.xz"},
				ExtraSoftwareDeps: []string{"arm"},
				ExtraHardwareDeps: crostini.CrostiniUnstable,
				...
				Name:              "paste_wayland_artifact_stretch_amd64",
				...
				Name:              "paste_wayland_artifact_stretch_amd64_unstable",
				ExtraAttr:         []string{"informational"},
				ExtraData:         []string{"secure_paste.py", "crostini_vm_amd64.zip", "crostini_container_metadata_stretch_amd64.tar.xz", "crostini_container_rootfs_stretch_amd64.tar.xz"},
				ExtraSoftwareDeps: []string{"amd64"},
				ExtraHardwareDeps: crostini.CrostiniUnstable,
				...
				Name:              "paste_wayland_artifact_stretch_arm",
				...
				Name:              "paste_wayland_artifact_stretch_arm_unstable",
				ExtraAttr:         []string{"informational"},
				ExtraData:         []string{"secure_paste.py", "crostini_vm_arm.zip", "crostini_container_metadata_stretch_arm.tar.xz", "crostini_container_rootfs_stretch_arm.tar.xz"},
				ExtraSoftwareDeps: []string{"arm"},
				ExtraHardwareDeps: crostini.CrostiniUnstable,
				...
				Name:              "paste_wayland_artifact_buster_amd64",
				...
				Name:              "paste_wayland_artifact_buster_amd64_unstable",
				ExtraAttr:         []string{"informational"},
				ExtraData:         []string{"secure_paste.py", "crostini_vm_amd64.zip", "crostini_container_metadata_buster_amd64.tar.xz", "crostini_container_rootfs_buster_amd64.tar.xz"},
				ExtraSoftwareDeps: []string{"amd64"},
				ExtraHardwareDeps: crostini.CrostiniUnstable,
				...
				Name:              "paste_wayland_artifact_buster_arm",
				...
				Name:              "paste_wayland_artifact_buster_arm_unstable",
				ExtraAttr:         []string{"informational"},
				ExtraData:         []string{"secure_paste.py", "crostini_vm_arm.zip", "crostini_container_metadata_buster_arm.tar.xz", "crostini_container_rootfs_buster_arm.tar.xz"},
				ExtraSoftwareDeps: []string{"arm"},
				ExtraHardwareDeps: crostini.CrostiniUnstable,
				...
				Name:              "paste_x11_artifact_stretch_amd64",
				ExtraData:         []string{"secure_paste.py", "crostini_vm_amd64.zip", "crostini_container_metadata_stretch_amd64.tar.xz", "crostini_container_rootfs_stretch_amd64.tar.xz"},
				ExtraSoftwareDeps: []string{"amd64"},
				ExtraHardwareDeps: crostini.CrostiniStable,
				Pre:               crostini.StartedByArtifactStretch(),
				...
				Name:              "paste_x11_artifact_stretch_amd64_unstable",
				ExtraAttr:         []string{"informational"},
				ExtraData:         []string{"secure_paste.py", "crostini_vm_amd64.zip", "crostini_container_metadata_stretch_amd64.tar.xz", "crostini_container_rootfs_stretch_amd64.tar.xz"},
				ExtraSoftwareDeps: []string{"amd64"},
				ExtraHardwareDeps: crostini.CrostiniUnstable,
				...
				Name:              "paste_x11_artifact_stretch_arm",
				ExtraData:         []string{"secure_paste.py", "crostini_vm_arm.zip", "crostini_container_metadata_stretch_arm.tar.xz", "crostini_container_rootfs_stretch_arm.tar.xz"},
				ExtraSoftwareDeps: []string{"arm"},
				ExtraHardwareDeps: crostini.CrostiniStable,
				Pre:               crostini.StartedByArtifactStretch(),
				...
				Name:              "paste_x11_artifact_stretch_arm_unstable",
				ExtraAttr:         []string{"informational"},
				ExtraData:         []string{"secure_paste.py", "crostini_vm_arm.zip", "crostini_container_metadata_stretch_arm.tar.xz", "crostini_container_rootfs_stretch_arm.tar.xz"},
				ExtraSoftwareDeps: []string{"arm"},
				ExtraHardwareDeps: crostini.CrostiniUnstable,
				...
				Name:              "paste_x11_artifact_buster_amd64",
				ExtraData:         []string{"secure_paste.py", "crostini_vm_amd64.zip", "crostini_container_metadata_buster_amd64.tar.xz", "crostini_container_rootfs_buster_amd64.tar.xz"},
				ExtraSoftwareDeps: []string{"amd64"},
				ExtraHardwareDeps: crostini.CrostiniStable,
				Pre:               crostini.StartedByArtifactBuster(),
				...
				Name:              "paste_x11_artifact_buster_amd64_unstable",
				ExtraAttr:         []string{"informational"},
				ExtraData:         []string{"secure_paste.py", "crostini_vm_amd64.zip", "crostini_container_metadata_buster_amd64.tar.xz", "crostini_container_rootfs_buster_amd64.tar.xz"},
				ExtraSoftwareDeps: []string{"amd64"},
				ExtraHardwareDeps: crostini.CrostiniUnstable,
				...
				Name:              "paste_x11_artifact_buster_arm",
				ExtraData:         []string{"secure_paste.py", "crostini_vm_arm.zip", "crostini_container_metadata_buster_arm.tar.xz", "crostini_container_rootfs_buster_arm.tar.xz"},
				ExtraSoftwareDeps: []string{"arm"},
				ExtraHardwareDeps: crostini.CrostiniStable,
				Pre:               crostini.StartedByArtifactBuster(),
				...
				Name:              "paste_x11_artifact_buster_arm_unstable",
				ExtraAttr:         []string{"informational"},
				ExtraData:         []string{"secure_paste.py", "crostini_vm_arm.zip", "crostini_container_metadata_buster_arm.tar.xz", "crostini_container_rootfs_buster_arm.tar.xz"},
				ExtraSoftwareDeps: []string{"arm"},
				ExtraHardwareDeps: crostini.CrostiniUnstable,
