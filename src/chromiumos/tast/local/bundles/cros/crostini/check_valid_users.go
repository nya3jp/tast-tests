...
// checkUsersAndInstall checks a group a valid users,
// make sure that there is no error msg and button Install is enabled.
// It also go through the installation process with the last username in users.
