...
type meetTest struct {
	...
	batteryMode setup.BatteryDischargeMode // Whether to force discharging the battery.
}
...
func init() {
	testing.AddTest(&testing.Test{
		...
		Params: []testing.Param{
			// Parameters generated by meet_cuj_test.go. DO NOT EDIT.
			{
			...
			{
				// Base case. Note this runs a 30 min meet call (nobatterymetrics)
				Name:    "4p_nobatterymetrics",
				Timeout: 40 * time.Minute,
				Val: meetTest{
					num:         4,
					layout:      meetLayoutTiled,
			...
			{
				// Small meeting (nobatterymetrics)
				Name:    "4p_present_notes_split_nobatterymetrics",
				Timeout: defaultTestTimeout,
				Val: meetTest{
					num:         4,
					layout:      meetLayoutTiled,
			...
			{
				// Big meeting (nobatterymetrics)
				Name:    "16p_nobatterymetrics",
				Timeout: defaultTestTimeout,
				Val: meetTest{
					num:         16,
					layout:      meetLayoutTiled,
			...
			{
				// Even bigger meeting (nobatterymetrics)
				Name:    "49p_nobatterymetrics",
				Timeout: defaultTestTimeout,
				Val: meetTest{
					num:         49,
					layout:      meetLayoutTiled,
			...
			{
				// Big meeting with tracing (nobatterymetrics)
				Name:    "16p_trace_nobatterymetrics",
				Timeout: 20 * time.Minute,
				Val: meetTest{
					num:         16,
					layout:      meetLayoutTiled,
			...
			{
				// Validation test for big meeting (nobatterymetrics)
				Name:    "16p_validation_nobatterymetrics",
				Timeout: 20 * time.Minute,
				Val: meetTest{
					num:         16,
					layout:      meetLayoutTiled,
			...
			{
				// Big meeting with notes (nobatterymetrics)
				Name:    "16p_notes_nobatterymetrics",
				Timeout: defaultTestTimeout,
				Val: meetTest{
					num:         16,
					layout:      meetLayoutTiled,
			...
			{
				// 16p with jamboard test (nobatterymetrics)
				Name:    "16p_jamboard_nobatterymetrics",
				Timeout: defaultTestTimeout,
				Val: meetTest{
					num:         16,
					layout:      meetLayoutTiled,
			...
			{
				// Lacros 4p (nobatterymetrics)
				Name:    "lacros_4p_nobatterymetrics",
				Timeout: defaultTestTimeout,
				Val: meetTest{
					num:         4,
					layout:      meetLayoutTiled,
			...
			{
				// 49p with vp8 video codec (nobatterymetrics)
				Name:    "49p_vp8_nobatterymetrics",
				Timeout: defaultTestTimeout,
				Val: meetTest{
					num:         49,
					layout:      meetLayoutTiled,
