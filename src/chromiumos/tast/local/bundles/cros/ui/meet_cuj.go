...
func MeetCUJ(ctx context.Context, s *testing.State) {
	...
	if err := recorder.Run(ctx, func(ctx context.Context) error {
		...
		// TODO(yichenz): use hrTelemetryApi once it supports setting the number of the maximum tiles.
		...
		if meet.present {
			...
			// TODO(yichenz): use hrTelemetryApi once it supports starting presentation.
