...
// getNumberOfRegisteredSystemApps returns the number of system web apps that
// should be installed, by querying System Web App Manager using the test API.
...
// getNumberOfInstalledSystemApps returns the number of system web apps that
// are actually installed, by querying the App Service.
...
func SystemWebAppsReinstall(ctx context.Context, s *testing.State) {
	...
	// Second login, this reuses the previous state, so System Apps are
	// already installed.
