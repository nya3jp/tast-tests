...
func init() {
	testing.AddTest(&testing.Test{
		Func: PinUnpinFolder,
		Desc: "Pin/Unpin a folder from Files app, verify that the folder is in the tote or not",
		Contacts: []string{
			"sun.tsai@cienet.com",
...
// PinUnpinFolder verifies the folder's pin/unpin functionality from Files app, and verifies that the folder is in the tote or not.
func PinUnpinFolder(ctx context.Context, s *testing.State) {
