...
func init() {
	testing.AddTest(&testing.Test{
		...
		Params: []testing.Param{
			// Parameters generated by video_cuj_test.go. DO NOT EDIT.
			{
				Name:    "clamshell",
			...
			{
				Name:    "clamshell_nobatterymetrics",
				Fixture: "loggedInToCUJUser",
				Val: videoCUJTestParam{
					bt:          browser.TypeAsh,
			...
			{
				Name:    "clamshell_trace_nobatterymetrics",
				Fixture: "loggedInToCUJUser",
				Val: videoCUJTestParam{
					bt:          browser.TypeAsh,
					tracing:     true,
			...
			{
				Name:    "lacros_tablet_nobatterymetrics",
				Fixture: "loggedInToCUJUserLacros",
				Val: videoCUJTestParam{
					bt:          browser.TypeLacros,
					tablet:      true,
