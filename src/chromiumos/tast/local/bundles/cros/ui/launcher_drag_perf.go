...
func LauncherDragPerf(ctx context.Context, s *testing.State) {
	...
	//   of the screen.
	bottom := coords.Point{X: primaryBounds.Left + primaryBounds.Width/4, Y: primaryBounds.Top + (primaryBounds.Height+primaryWorkArea.Height)/2}
	top := coords.Point{X: bottom.X, Y: primaryBounds.Top + 10}
