...
func storeShelfScrollAnimationSmoothnessData(ctx context.Context, pv *perf.Values, histograms []*metrics.Histogram) error {
...
func HotseatScrollPerf(ctx context.Context, s *testing.State) {
	...
	for _, setting := range settings {
		...
		if err := storeShelfScrollAnimationSmoothnessData(ctx, pv, histograms); err != nil {
