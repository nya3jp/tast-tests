...
func init() {
	testing.AddTest(&testing.Test{
		Func: WindowControl, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Check if the performance around window controlling is good enough; go/cros-ui-perftests-cq#heading=h.fwfk0yg3teo1",
		Contacts: []string{
			"oshima@chromium.org",
