...
func MashLogin(ctx context.Context, s *testing.State) {
	...
	// TODO(jamescook): Check that a mash process is running. The test used to
	// do this (see git history) but we had to stop due to flake from chrome's
	// command line sometimes being truncated. https://crbug.com/891470
}
