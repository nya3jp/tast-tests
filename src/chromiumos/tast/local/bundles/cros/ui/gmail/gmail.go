...
func New(ctx context.Context, tconn *chrome.TestConn, kb *input.KeyboardEventWriter, d *ui.Device) (*Gmail, error) {
	gmail := &Gmail{}
	if err := launcher.SearchAndLaunch(tconn, kb, gmailAppName)(ctx); err != nil {
