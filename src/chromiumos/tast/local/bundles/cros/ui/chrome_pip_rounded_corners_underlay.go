...
func init() {
	testing.AddTest(&testing.Test{
		Func: ChromePIPRoundedCornersUnderlay, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Verifies that Chrome PIP rounded corners are implemented with a hardware underlay",
