...
func init() {
	testing.AddTest(&testing.Test{
		...
		Params: []testing.Param{{
			...
			// TODO(b/255641264): Remove gimble when the test can pass on it.
			// TODO(b/255636769): Remove rusty and steelix when the test can pass on them.
			ExtraHardwareDeps: hwdep.D(hwdep.SkipOnModel("cave", "chell", "gimble", "rusty", "steelix")),
			...
			// TODO(b/246573749): Remove cave and chell when the test can pass on them.
			// TODO(b/255641264): Remove gimble when the test can pass on it.
			ExtraHardwareDeps: hwdep.D(hwdep.SkipOnModel("cave", "chell", "gimble")),
			...
			// TODO(b/255641264): Remove gimble when the test can pass on it.
			// TODO(b/255636769): Remove rusty and steelix when the test can pass on them.
			ExtraHardwareDeps: hwdep.D(hwdep.Model("cave", "chell", "gimble", "rusty", "steelix")),
			Fixture:           "chromeGraphics",
			Val:               browser.TypeAsh,
		}, {
			Name:              "failing_lacros",
			...
			// TODO(b/246573749): Remove cave and chell when the test can pass on them.
			// TODO(b/255641264): Remove gimble when the test can pass on it.
			ExtraHardwareDeps: hwdep.D(hwdep.Model("cave", "chell", "gimble")),
			Fixture:           "chromeGraphicsLacros",
			Val:               browser.TypeLacros,
		}},
	})
