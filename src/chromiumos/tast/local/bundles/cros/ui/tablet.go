...
func init() {
	testing.AddTest(&testing.Test{
		Func: Tablet,
		Desc: "Check if the performance around controlling of tablet mode is good enough; see also go/cros-ui-perftests-cq#heading=h.fwfk0yg3teo1",
		Contacts: []string{
			"xdai@chromium.org",
...
func Tablet(ctx context.Context, s *testing.State) {
	expects := perfutil.CreateExpectations(ctx,
		...
		"Ash.SplitViewResize.PresentationTime",
