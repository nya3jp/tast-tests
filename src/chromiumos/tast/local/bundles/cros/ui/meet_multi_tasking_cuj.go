...
func MeetMultiTaskingCUJ(ctx context.Context, s *testing.State) {
	...
	if err := recorder.Run(ctx, func(ctx context.Context) error {
		...
		if err := maximizeAllWindows(); err != nil {
			return err
		}
		...
		if err := twoFingerScrollDown(docsTimeout); err != nil {
			return err
		}
		...
		if err := twoFingerScrollDown(gmailTimeout); err != nil {
			return err
		}
