...
func DesktopControl(ctx context.Context, s *testing.State) {
	...
	uiperf.RunMultiple(ctx, r, s.Run, "launcher", perfutil.RunAndWaitAll(tconn, func(ctx context.Context) error {
	...
	uiperf.RunMultiple(ctx, r, s.Run, "quick-settings", perfutil.RunAndWaitAll(tconn, func(ctx context.Context) error {
