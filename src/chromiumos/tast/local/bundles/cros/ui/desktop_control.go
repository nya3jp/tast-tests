...
func init() {
	testing.AddTest(&testing.Test{
		Func: DesktopControl, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Check if the performance around desktop UI components is good enough; see also go/cros-ui-perftests-cq#heading=h.fwfk0yg3teo1",
		Contacts: []string{
