...
func init() {
	testing.AddTest(&testing.Test{
		Func: VideoCUJ2, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Measures the smoothess of switch between full screen YouTube video and another browser window",
