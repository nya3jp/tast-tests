...
func init() {
	testing.AddTest(&testing.Test{
		Func:         TC04S3EverydayMultiTaskingCUJSpotifyTabletBT,
...
func TC04S3EverydayMultiTaskingCUJSpotifyTabletBT(ctx context.Context, s *testing.State) {
	et.Run(ctx, s, et.Spotify)
}
