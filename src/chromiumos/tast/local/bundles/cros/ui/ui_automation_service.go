...
func init() {
	testing.AddService(&testing.Service{
		Register: func(srv *grpc.Server, s *testing.ServiceState) {
			ui.RegisterUIAutomationServiceServer(srv, &UIAutomationService{s: s})
		},
		GuaranteeCompatibility: true,
	})
}

// UIAutomationService implements tast.cros.ui.UIAutomationService
type UIAutomationService struct {
...
func (n *UIAutomationService) NewChromeLogin(ctx context.Context, req *empty.Empty) (*empty.Empty, error) {
...
func (n *UIAutomationService) CloseChrome(ctx context.Context, req *empty.Empty) (*empty.Empty, error) {
	if n.cr == nil {
