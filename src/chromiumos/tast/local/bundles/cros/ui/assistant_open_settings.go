...
// AssistantOpenSettings tests that the Settings app can be opened by the Assistant
func AssistantOpenSettings(ctx context.Context, s *testing.State) {
