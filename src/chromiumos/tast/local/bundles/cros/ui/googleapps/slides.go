...
// RenameSlide retunrs an action that renames google slide.
...
// EditSlideTitle retunrs an action that edits google slide title and subtitle.
...
// DeleteSlide retuns an action that deletes google slide.
