...
func init() {
	testing.AddTest(&testing.Test{
		...
		Params: []testing.Param{
			// Parameters generated by window_arrangement_cuj_test.go. DO NOT EDIT.
			{
				Name: "clamshell_mode",
			...
			{
				Name: "clamshell_mode_nobatterymetrics",
				Val: windowarrangementcuj.TestParam{
					BrowserType: browser.TypeAsh,
			...
			{
				Name: "tablet_mode_nobatterymetrics",
				Val: windowarrangementcuj.TestParam{
					BrowserType: browser.TypeAsh,
					Tablet:      true,
					BatteryMode: setup.NoBatteryDischarge,
			...
			{
				Name: "tablet_mode_trace_nobatterymetrics",
				Val: windowarrangementcuj.TestParam{
					BrowserType: browser.TypeAsh,
					Tablet:      true,
					Tracing:     true,
			...
			{
				Name: "tablet_mode_validation_nobatterymetrics",
				Val: windowarrangementcuj.TestParam{
					BrowserType: browser.TypeAsh,
					Tablet:      true,
					Validation:  true,
...
func WindowArrangementCUJ(ctx context.Context, s *testing.State) {
	...
	powerCleanup, err := setup.PowerTest(ctx, conns.TestConn, setup.PowerTestOptions{
		Wifi:       setup.DisableWifiInterfaces,
		Battery:    testParam.BatteryMode,
	...
	defer func() {
		if err := powerCleanup(closeCtx); err != nil {
