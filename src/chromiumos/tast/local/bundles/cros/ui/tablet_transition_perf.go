...
func TabletTransitionPerf(ctx context.Context, s *testing.State) {
	...
	// The top window needs to be normal window state otherwise no animation will occur.
	...
	for i := 0; i < 10; i++ {
		...
		// TODO(sammiequon): Update this to poll until the window animation completes.
