...
type quickCheckCUJParams struct {
...
func init() {
	testing.AddTest(&testing.Test{
		...
		Params: []testing.Param{
			// Parameters generated by quick_check_cuj_test.go. DO NOT EDIT.
			{
...
func QuickCheckCUJ(ctx context.Context, s *testing.State) {
	...
	test := s.Param().(quickCheckCUJParams)

	var cs ash.ConnSource
	var cr *chrome.Chrome

	if test.browserType == browser.TypeAsh {
		cr = s.FixtValue().(cuj.FixtureData).Chrome
		cs = cr
	} else {
		var err error
		var l *lacros.Lacros
		cr, l, cs, err = lacros.Setup(ctx, s.FixtValue(), test.browserType)
		if err != nil {
