...
func MetricConfigs() []MetricConfig {
	configs := []MetricConfig{
		...
		NewCustomMetricConfig("PageLoad.PaintTiming.NavigationToFirstContentfulPaint", "ms", perf.SmallerIsBetter, []int64{800, 1600}),
		...
		NewCustomMetricConfig("Event.Latency.EndToEnd.KeyPress", "microseconds", perf.SmallerIsBetter, []int64{14000, 60000}),
		NewCustomMetricConfig("Event.Latency.EndToEnd.Mouse", "microseconds", perf.SmallerIsBetter, []int64{14000, 60000}),
		NewCustomMetricConfig("Event.Latency.EndToEnd.TouchpadPinch", "microseconds", perf.SmallerIsBetter, []int64{14000, 60000}),
		NewCustomMetricConfig("Event.Latency.EndToEnd.TouchpadPinch2", "microseconds", perf.SmallerIsBetter, []int64{14000, 60000}),
