...
func (r *Recorder) StopRecording(ctx, runCtx context.Context) (e error) {
	...
	// logMetricsSource logs the non-zero metrics collected from a particular test API connection.
	logMetricsSource := func(connName string, hists []*metrics.Histogram) {
