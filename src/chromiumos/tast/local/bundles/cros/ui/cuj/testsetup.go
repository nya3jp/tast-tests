...
type TastTest struct {
	...
	Tpw             *input.TrackpadEventWriter
	Tw              *input.TouchEventWriter
...
func (t *TastTest) Unravel() (context.Context,
	context.Context,
	*chrome.Chrome,
	ash.ConnSource,
	*lacros.Lacros,
	*chrome.TestConn,
	*chrome.TestConn,
	*cujrecorder.Recorder,
	*input.KeyboardEventWriter,
	*input.TrackpadEventWriter,
	*input.TouchEventWriter,
	*display.Info) {
	return t.Ctx, t.CloseCtx, t.Cr, t.Cs, t.L, t.Tconn, t.Btconn, t.Recorder, t.Kw, t.Tpw, t.Tw, t.DisplayInfo
}
...
func (t *TastTest) SetupMultiTouchWriter(s *testing.State, numTouches int) *input.TouchEventWriter {
	...
	tw, err := t.Tpw.NewMultiTouchWriter(2)
	if err != nil {
