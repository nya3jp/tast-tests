...
func init() {
	testing.AddTest(&testing.Test{
		Func:         LockScreenSwitchToPassword,
		Desc:         "Test to view/hide password on lockscreen when PIN autosubmit is enabled",
...
// LockScreenSwitchToPassword tests the functionality of Show password button and Hide password button on lockscreen when PIN autosubmit is enabled.
func LockScreenSwitchToPassword(ctx context.Context, s *testing.State) {
	const (
	...
	// With autosubmit enabled, Show password button appears only for the password field.
	...
	// Click 'Switch to password' button to view the password field.
	...
	s.Log("Test Show/Hide password button on lockscreen password field after clicking 'Switch to password' button")
	if err := showpassword.ShowAndHidePassword(ctx, tconn, username, password, false); err != nil {
		s.Fatal("Show/Hide password button failed to work for lockscreen password field after clicking 'Switch to password' button: ", err)
	}
}
