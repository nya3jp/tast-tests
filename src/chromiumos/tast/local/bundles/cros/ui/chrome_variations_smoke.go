...
func init() {
	testing.AddTest(&testing.Test{
		Func: ChromeVariationsSmoke, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Checks that Chrome doesn't crash and basic web content rendering is functional when loading a given variations seed",
		Contacts: []string{
