...
func DragTabInClamshellPerf(ctx context.Context, s *testing.State) {
	...
	// TODO(crbug.com/1290987): Calling uiauto.RootDebugInfo or faillog.DumpUITreeOnError here is needed to let ac.NodesInfo return two tabs as expected. Otherwise, none of tab info returns. It fails only for lacros-chrome, not for ash-chrome.
