...
func init() {
	testing.AddTest(&testing.Test{
		...
		Params: []testing.Param{{
			...
			// TODO(crbug.com/1352290): Move the attr up for all parameterized tests once mouse.Drag is fixed for lacros. Until then, let's keep lacros test only for manual run.
