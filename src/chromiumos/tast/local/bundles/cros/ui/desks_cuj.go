...
func DesksCUJ(ctx context.Context, s *testing.State) {
	const docURL = "https://docs.google.com/document/d/1MW7lAk9RZ-6zxpObNwF0r80nu-N1sXo5f7ORG4usrJQ/edit?disco=AAAAP6EbSF8"
	...
	if err := ash.CreateWindows(ctx, tconn, cs, docURL, 8); err != nil {
	...
	// Ensure that the display is awake and will stay awake for the performance measurement.
	if err := mouse.Move(tconn, info.Bounds.CenterPoint(), 0)(ctx); err != nil {
