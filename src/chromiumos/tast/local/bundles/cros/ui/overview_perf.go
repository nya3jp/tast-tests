...
// init the test. This test uses contents from external sources, including
// blob.html and its dependencies (.js files), which are under Google
// copyright. For license information, please see README.txt in blob.zip.
func init() {
