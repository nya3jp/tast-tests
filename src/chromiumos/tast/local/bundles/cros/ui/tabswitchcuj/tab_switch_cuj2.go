...
var allTargets = []struct {
	...
	{cuj.WikipediaMain, newPageInfo(Basic, wikipedia, `/Main_Page`, `/Wikipedia:Contents`)},
	{cuj.WikipediaCurrentEvents, newPageInfo(Basic, wikipedia, `/Portal:Current_events`, `/Special:Random`)},
	{cuj.WikipediaAbout, newPageInfo(Basic, wikipedia, `/Wikipedia:About`, `/Wikipedia:Contact_us`)},
	{cuj.WikipediaHelp, newPageInfo(Plus, wikipedia, `/Help:Contents`, `/Help:Introduction`)},
	{cuj.WikipediaCommunity, newPageInfo(Plus, wikipedia, `/Wikipedia:Community_portal`, `/Special:RecentChanges`)},
	{cuj.WikipediaPandemic, newPageInfo(Premium, wikipedia, `/COVID-19_pandemic`, `/Coronavirus_disease_2019`)},

	{cuj.RedditWallstreet, newPageInfo(Basic, reddit, `/r/wallstreetbets/hot/`, `/r/wallstreetbets/new/`)},
	{cuj.RedditTechNews, newPageInfo(Basic, reddit, `/r/technews/hot/`, `/r/technews/new/`)},
	{cuj.RedditOlympics, newPageInfo(Basic, reddit, `/r/olympics/hot/`, `/r/olympics/new/`)},
	{cuj.RedditProgramming, newPageInfo(Plus, reddit, `/r/programming/hot/`, `/r/programming/new/`)},
	{cuj.RedditApple, newPageInfo(Plus, reddit, `/r/apple/hot/`, `/r/apple/new/`)},
	{cuj.RedditBrooklyn, newPageInfo(Premium, reddit, `/r/brooklynninenine/hot/`, `/r/brooklynninenine/new/`)},

	{cuj.MediumBusiness, newPageInfo(Basic, medium, `/business`, `/entrepreneurship`)},
	{cuj.MediumStartup, newPageInfo(Basic, medium, `/startup`, `/leadership`)},
	{cuj.MediumWork, newPageInfo(Plus, medium, `/work`, `/productivity`)},
	{cuj.MediumSoftware, newPageInfo(Premium, medium, `/software-engineering`, `/programming`)},
	{cuj.MediumAI, newPageInfo(Premium, medium, `/artificial-intelligence`, `/technology`)},

	{cuj.YahooUS, newPageInfo(Basic, yahooNews, `/us/`, `/politics/`)},
	{cuj.YahooWorld, newPageInfo(Basic, yahooNews, `/world/`, `/health/`)},
	{cuj.YahooScience, newPageInfo(Plus, yahooNews, `/science/`, `/tagged/skullduggery/`)},
	{cuj.YahooOriginals, newPageInfo(Premium, yahooNews, `/originals/`, `/videos`)},

	{cuj.CnnWorld, newPageInfo(Plus, cnn, `/world`, `/africa`)},
	{cuj.CnnAmericas, newPageInfo(Plus, cnn, `/americas`, `/asia`)},
	{cuj.CnnAustralia, newPageInfo(Plus, cnn, `/australia`, `/china`)},
	{cuj.CnnEurope, newPageInfo(Premium, cnn, `/europe`, `/india`)},
	{cuj.CnnMiddleEast, newPageInfo(Premium, cnn, `/middle-east`, `/uk`)},

	{cuj.EspnNfl, newPageInfo(Plus, espn, `/nfl/scoreboard`, `/nfl/schedule`)},
	{cuj.EspnNba, newPageInfo(Plus, espn, `/nba/scoreboard`, `/nba/schedule`)},
	{cuj.EspnCollegeBasketball, newPageInfo(Plus, espn, `/mens-college-basketball/scoreboard`, `/mens-college-basketball/schedule`)},
	{cuj.EspnTennis, newPageInfo(Premium, espn, `/tennis/dailyResults`, `/tennis/schedule`)},
	{cuj.EspnSoccer, newPageInfo(Premium, espn, `/soccer/scoreboard`, `/soccer/schedule`)},

	{cuj.HuluMovies, newPageInfo(Plus, hulu, `/hub/movies`, `/hub/originals`)},
	{cuj.HuluKids, newPageInfo(Premium, hulu, `/hub/kids`, `/hub/networks`)},

	{cuj.Pinterest, newPageInfo(Plus, pinterest, `/ideas/`, `/ideas/holidays/910319220330/`)},

	{cuj.Netflix, newPageInfo(Premium, netflix, `/en`, `/en/legal/termsofuse`)},

	{cuj.Youtube, newPageInfo(Premium, youtube, `/`, `/feed/explore`)},
}
