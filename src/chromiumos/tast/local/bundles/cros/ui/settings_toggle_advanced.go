...
func SettingsToggleAdvanced(ctx context.Context, s *testing.State) {
	...
	// Without this delay, the Launch function won't go through for the Settings app.
	...
	testing.Sleep(ctx, time.Second) // button click doesn't go through immediately after Focus
