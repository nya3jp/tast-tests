...
// If i is 0, the desk will just be initialized, because the first desk
// is created and activated by default. |i| is the desk index of the new
// desk. Each url in |urls| is opened in a separate window. Each
