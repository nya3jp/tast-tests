...
func ArcYoutubeCUJ(ctx context.Context, s *testing.State) {
	...
	if err := recorder.Run(ctx, func(ctx context.Context) error {
		...
		// Go to https://www.youtube.com/watch?v=EPlRnpgY2bY
		if err := a.SendIntentCommand(ctx, "android.intent.action.VIEW", "vnd.youtube:EPlRnpgY2bY").Run(testexec.DumpLogOnError); err != nil {
			return errors.Wrap(err, "failed to open https://www.youtube.com/watch?v=EPlRnpgY2bY")
		}
