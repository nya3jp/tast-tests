...
func ChromeLoginGaia(ctx context.Context, s *testing.State) {
	...
	testChromeLoginGaia(ctx, s, sm, server.URL, content, user, password)
}

func testChromeLoginGaia(ctx context.Context, s *testing.State, sm *session.SessionManager, url, expected, user, password string) {
