...
func ChromeLoginGaia(ctx context.Context, s *testing.State) {
	...
	testChromeLogin(ctx, s, sm, server.URL, content, user, password)
}

func testChromeLogin(ctx context.Context, s *testing.State, sm *session.SessionManager, url, expected, user, password string) {
