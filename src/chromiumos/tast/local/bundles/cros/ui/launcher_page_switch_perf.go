...
func init() {
	testing.AddTest(&testing.Test{
		...
		Contacts:     []string{"mukai@chromium.org", "andrewxu@chromium.org"},
...
func LauncherPageSwitchPerf(ctx context.Context, s *testing.State) {
	...
	if !inTabletMode {
		// Press the search key to close the app-list at the end.
