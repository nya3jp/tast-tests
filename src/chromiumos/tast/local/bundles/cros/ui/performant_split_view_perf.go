...
func init() {
	testing.AddTest(&testing.Test{
		Func: PerformantSplitViewPerf, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Measures smoothness of resizing split view windows with and without performant split view enabled",
