...
// TC02T2QuickCheckCUJ measures the smoothess of screen unlock and open an gmail thread
func TC02T2QuickCheckCUJ(ctx context.Context, s *testing.State) {
	tabletMode := true
