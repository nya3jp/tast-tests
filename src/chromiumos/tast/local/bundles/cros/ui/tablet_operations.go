...
func TabletOperations(ctx context.Context, s *testing.State) {
	...
	uiperf.RunMultiple(ctx, r, s.Run, "tablet-mode", perfutil.RunAndWaitAll(tconn, func(ctx context.Context) error {
	...
	uiperf.RunMultiple(ctx, r, s.Run, "hotseat-revealing", perfutil.RunAndWaitAll(tconn, func(ctx context.Context) (err error) {
		defer func() {
			if err != nil {
	...
	uiperf.RunMultiple(ctx, r, s.Run, "overview-splitview", perfutil.RunAndWaitAll(tconn, func(ctx context.Context) (err error) {
