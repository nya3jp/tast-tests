...
func init() {
	testing.AddTest(&testing.Test{
		Func: TabletOperations, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Check if the performance around user operations for tablet mode is good enough; see also go/cros-ui-perftests-cq#heading=h.fwfk0yg3teo1",
		Contacts: []string{
			"xdai@chromium.org",
