...
func TabletOperations(ctx context.Context, s *testing.State) {
	...
	r.RunMultiple(ctx, "tablet-mode", uiperf.Run(s.Run, perfutil.RunAndWaitAll(tconn, func(ctx context.Context) error {
	...
	r.RunMultiple(ctx, "hotseat-revealing", uiperf.Run(s.Run, perfutil.RunAndWaitAll(tconn, func(ctx context.Context) (err error) {
		defer func() {
			if err != nil {
	...
	r.RunMultiple(ctx, "overview-splitview", uiperf.Run(s.Run, perfutil.RunAndWaitAll(tconn, func(ctx context.Context) (err error) {
