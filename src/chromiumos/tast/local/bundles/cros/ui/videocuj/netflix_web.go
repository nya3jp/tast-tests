...
func openAndPlayNetflixWeb(ctx context.Context, s *testing.State, tconn *chrome.TestConn, cr *chrome.Chrome,
	kb *input.KeyboardEventWriter, playbackSettings string, extendedDisplay bool) (*netflix.Netflix, error) {
