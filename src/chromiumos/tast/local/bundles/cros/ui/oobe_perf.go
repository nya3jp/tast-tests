...
func init() {
	testing.AddTest(&testing.Test{
		Func: OobePerf, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Test waits for out-of-box-experience (OOBE) Welcome screen and measures the time of the WebUI loading",
		Contacts: []string{
			"rsorokin@google.com",
