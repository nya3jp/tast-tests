		...
		Params: []testing.Param{
			{
				...
				Fixture:           "loggedInAndKeepState",
				ExtraSoftwareDeps: []string{"arc"},
				ExtraHardwareDeps: hwdep.D(setup.PefCujBasicDevices()),
			}, {
				Name:              "plus_noproxy",
				Timeout:           40 * time.Minute,
				...
				Fixture:           "loggedInAndKeepState",
				ExtraSoftwareDeps: []string{"arc"},
				ExtraHardwareDeps: hwdep.D(setup.PefCujPlusDevices()),
			}, {
				...
				Fixture:           "loggedInAndKeepState",
				ExtraSoftwareDeps: []string{"arc"},
				ExtraHardwareDeps: hwdep.D(setup.PefCujPremiumDevices()),
			},
		},
	})
}
