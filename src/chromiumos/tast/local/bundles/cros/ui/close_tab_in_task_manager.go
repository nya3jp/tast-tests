...
// CloseTabInTaskManager tests the entry should be removed in task manager automatically after closing tab.
func CloseTabInTaskManager(ctx context.Context, s *testing.State) {
