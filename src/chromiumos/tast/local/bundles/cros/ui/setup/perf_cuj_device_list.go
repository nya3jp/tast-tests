...
// PerfCUJDevices returns list of DUT model in all tiers.
// Allowed  hardware models will be alowed-listed here.
func PerfCUJDevices() hwdep.Condition {
	return hwdep.Model("volta", "morphius", "dratini", "voema")
}
