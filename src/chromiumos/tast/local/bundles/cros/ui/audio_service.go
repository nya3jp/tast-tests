...
// FirstRunningDevice will check for audio routing device status.
func (as *AudioService) FirstRunningDevice(ctx context.Context, req *ui.AudioServiceRequest) (*empty.Empty, error) {
	if as.cr == nil {
		return nil, errors.New("Chrome not available")
	}
