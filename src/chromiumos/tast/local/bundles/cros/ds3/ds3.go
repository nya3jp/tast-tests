...
func DS3(ctx context.Context, s *testing.State) {
	...
	// comment for review: I don't know if tagging is an acceptable
	// practice in go but it was the strategy suggested to break out of
	// a loop while in a switch statement given in this issue:
	// https://github.com/golang/go/issues/85#issuecomment-66047948
	for !deviceInfoSet {
