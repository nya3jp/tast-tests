...
// LSBReleaseOverwriteContent gets the content of /mnt/stateful_partition/etc/lsb-release.
...
// OverwriteLSBRelease edits /mnt/stateful_partition/etc/lsb-release.
// It overwrites the values of existing keys, or add the key, value pair if it is a new key.
