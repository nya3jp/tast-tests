...
// ChooseShareMetricsOrNot verifies user can share metrics or not.
func ChooseShareMetricsOrNot(ctx context.Context, s *testing.State) {
	cleanupCtx := ctx
