...
func init() {
	testing.AddTest(&testing.Test{
		...
		Desc:         "Show missing description error message when continue without issue description",
		Contacts: []string{
...
func ShowMissingDescriptionErrorMessage(ctx context.Context, s *testing.State) {
	...
	missingDescriptionErrorMessage := nodewith.Name("Description is required").Role(role.StaticText).Ancestor(
		feedbackRootNode)
