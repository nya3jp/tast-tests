...
func DeleteDescriptionUpdateSearchResult(ctx context.Context, s *testing.State) {
	...
	defaultFirstLinkName, err := firstLinkName(ctx, ui, s)
	if err != nil {
	...
	updatedFirstLinkName, err := firstLinkName(ctx, ui, s)
	if err != nil {
	...
	newFirstLinkName, err := firstLinkName(ctx, ui, s)
	if err != nil {
...
func firstLinkName(ctx context.Context, ui *uiauto.Context, s *testing.State) (
	string, error) {
