...
const chromebookHelpForumAddress = "support.google.com/chromebook/?hl=en#topic=3399709"
...
func OpenChromebookHelpForum(ctx context.Context, s *testing.State) {
	...
	s.Log("===============this is length: ", len(tabs))
	s.Log("===============this is ID: ", tabs[0].ID)
	s.Log("===============this is Title: ", tabs[0].Title)
	s.Log("===============this is Index: ", tabs[0].Index)
	s.Log("===============this is url: ", tabs[0].URL)
	s.Log("===============this is Active: ", tabs[0].Active)
}
