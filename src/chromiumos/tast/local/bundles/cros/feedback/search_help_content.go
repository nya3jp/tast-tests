...
func init() {
	testing.AddTest(&testing.Test{
		...
		Desc:         "Suggested help content will be updated as user enters issue description",
		Contacts: []string{
...
func SearchHelpContent(ctx context.Context, s *testing.State) {
	...
	updatedTitle := nodewith.Name("Suggested help content").Role(role.StaticText).Ancestor(feedbackRootNode)
