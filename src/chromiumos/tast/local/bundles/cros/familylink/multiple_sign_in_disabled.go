...
func init() {
	testing.AddTest(&testing.Test{
		Func: MultipleSignInDisabled, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Verifies that multiple sign-in is disabled for Unicorn users. Geller users should behave similarly",
		Contacts: []string{
