...
func NonEducoexistenceInsession(ctx context.Context, s *testing.State) {
	...
	if err := familylink.AddEduSecondaryAccount(ctx, cr, tconn, unicornParentFirstName, unicornParentLastName, unicornParentUser, unicornParentPass, gellerParentUser, gellerParentPass, false); err != nil {
