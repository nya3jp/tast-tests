...
func UnicornExtensions(ctx context.Context, s *testing.State) {
	...
	if err := familylink.NavigateExtensionApprovalFlow(ctx, cr, tconn, s.Param().(browser.Type), s.RequiredVar("unicorn.parentUser"), s.RequiredVar("unicorn.parentPassword")); err != nil {
