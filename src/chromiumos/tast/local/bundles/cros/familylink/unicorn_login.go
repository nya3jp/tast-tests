...
func UnicornLogin(ctx context.Context, s *testing.State) {
	...
	// TODO set browser type to be Ash or LaCrOS based on param
	if err := familylink.VerifyUserSignedIntoBrowser(ctx, cr, tconn, browser.TypeAsh, s.RequiredVar("unicorn.childUser")); err != nil {
