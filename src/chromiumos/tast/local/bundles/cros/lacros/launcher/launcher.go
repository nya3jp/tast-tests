...
func LaunchLinuxChrome(ctx context.Context, p PreData, httpPort int, httpsPort int) (*linuxChrome, error) {
	const (
	...
	testing.ContextLog(ctx, "asdf2 : ", resolverRulesFlag)
	testing.ContextLog(ctx, "asdf2 : ", spkiListFlag)
	args := []string{
