...
func (l *linuxChrome) NewConnForTarget(ctx context.Context, tm cdputil.TargetMatcher) (*chrome.Conn, error) {
...
func (l *linuxChrome) TestAPIConn(ctx context.Context) (*chrome.TestConn, error) {
	...
	var err error
	if l.testExtConn, err = l.NewConnForTarget(ctx, cdputil.MatchTargetURL(bgURL)); err != nil {
		return nil, err
	}
