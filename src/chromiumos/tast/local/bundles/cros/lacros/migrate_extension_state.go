...
func MigrateExtensionState(ctx context.Context, s *testing.State) {
	...
	prepareExtensionState(ctx, s, extDir)
...
func prepareExtensionState(ctx context.Context, s *testing.State, extDir string) {
...
// verifyExtensionStateOnLacros checks if the extension states can be retrieved on Lacros.
