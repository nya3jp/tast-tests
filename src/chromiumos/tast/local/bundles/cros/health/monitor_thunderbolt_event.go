...
func init() {
	testing.AddTest(&testing.Test{
		Func: MonitorThunderboltEvent, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Monitors the Thunderbolt event detected proper or not after plug/unplug Thunderbolt devices",
