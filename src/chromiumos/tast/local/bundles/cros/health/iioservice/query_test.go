...
2022-09-29T03:01:44.415951Z INFO iioservice_query: [query_impl.cc(120)] (30747) GetAttributesCallback(): Device id: 5
2022-09-29T03:01:44.415954Z INFO iioservice_query: [query_impl.cc(123)] (30747) GetAttributesCallback(): Type: MAGN
2022-09-29T03:01:44.415957Z INFO iioservice_query: [query_impl.cc(126)] (30747) GetAttributesCallback(): name: cros-ec-mag
2022-09-29T03:01:44.416000Z INFO iioservice_query: [query_impl.cc(126)] (30747) GetAttributesCallback(): location: base
...
func TestExpectedSensorAttributes(t *testing.T) {
	...
	sensorNames := []string{"cros-ec-accel", "cros-ec-lid-angle", "cros-ec-accel",
		"cros-ec-gyro", "acpi-als", "cros-ec-mag", "iioservice-gravity"}
