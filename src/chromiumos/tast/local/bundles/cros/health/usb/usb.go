...
// matchFwupdDevice returns whether the device matching vendorID:prodID:serial.
// The matching of serial will be skipped when it is empty.
...
// devices have more than one distinct version. The matching of serial will be
// skipped when it is empty. The version info is extracted from fwupd via the
// command line tool.
