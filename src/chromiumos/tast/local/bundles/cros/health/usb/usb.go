...
// Device holds the result from usb-devices.
type Device struct {
	VendorID   string
	ProdID     string
	DeviceName string
...
// Interface holds the result from usb-devices.
...
// usbDevices returns a list of devices. Each device is represented as a list of
// string. Each string contains some attributes related to the device.
