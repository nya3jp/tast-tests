...
func init() {
	testing.AddTest(&testing.Test{
		Func: LaunchGalleryFromNotifications, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Verify Gallery launches correctly when opening image from notifications",
		Contacts: []string{
