...
func init() {
	testing.AddTest(&testing.Test{
		Func: LaunchReleaseNotesFromSettings, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Help app release notes can be launched from Settings",
		Contacts: []string{
...
func LaunchReleaseNotesFromSettings(ctx context.Context, s *testing.State) {
	...
	whatsNewTabFinder := nodewith.NameRegex(regexp.MustCompile("What's new|What’s New")).Role(role.Heading).Ancestor(helpapp.RootFinder)
