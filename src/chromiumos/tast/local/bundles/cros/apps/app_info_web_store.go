...
func init() {
	testing.AddTest(&testing.Test{
		...
		Desc:         "Test Web Store app info from the context menu on shelf and app list",
		Contacts: []string{
...
func AppInfoWebStore(ctx context.Context, s *testing.State) {
	...
	s.Run(ctx, "check_webstore_appinfo_on_app_list", func(ctx context.Context, s *testing.State) {
