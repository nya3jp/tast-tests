...
func init() {
	testing.AddTest(&testing.Test{
		...
		Desc:         "Test Web Store app info from the context menu in the app list",
		Contacts: []string{
...
func AppInfoWebStore(ctx context.Context, s *testing.State) {
	...
	if err := uiauto.Combine("check context menu of Web Store app in app list",
		launcher.Open(tconn),
		...
		ui.WaitUntilExists(manageTxt))(ctx); err != nil {
