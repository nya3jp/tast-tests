...
const (
	...
	LacrosWithArcBootedAndMediaAppPhotosIntegrationImageFeatureFlag = "lacrosWithArcBootedAndMediaAppPhotosIntegrationImageFeatureFlag"
)
...
func init() {
	...
	testing.AddFixture(&testing.Fixture{
		Name:     LacrosWithArcBootedAndMediaAppPhotosIntegrationImageFeatureFlag,
