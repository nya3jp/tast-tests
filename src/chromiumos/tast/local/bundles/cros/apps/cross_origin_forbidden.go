...
const mainAppFile = "cross_origin_forbidden_index.html"
const serverKeyFile = "cross_origin_forbidden_key.pem"
const serverCertificateFile = "cross_origin_forbidden_certificate.pem"
const certificateAuthorityFile = "cross_origin_forbidden_ca_cert.pem"
...
func CrossOriginForbidden(ctx context.Context, s *testing.State) {
	...
	serverAddress := isolatedapp.StartServer(httpsServerConfiguration)
