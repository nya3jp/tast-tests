...
func AddAccountOSSettings(ctx context.Context, s *testing.State) {
	...
	if err := accountmanager.CheckAccountPresentInArcAction(tconn, d, username)(ctx); err != nil {
	...
	if err := accountmanager.CheckAccountNotPresentInArcAction(tconn, d, username)(ctx); err != nil {
