...
func init() {
	testing.AddTest(&testing.Test{
		Func: Compliance, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Verifies that DUT satisfies all requirements to run Telemetry Extension such as has all required VPD fields and correct CrOSConfig",
		Contacts: []string{
