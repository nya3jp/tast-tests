...
func init() {
	testing.AddTest(&testing.Test{
		Func: TelemetryExtension, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Tests TelemetryExtension core functionalities such as APIs, permissions, communication with PWA",
		Contacts: []string{
