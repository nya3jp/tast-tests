...
// replaceCrashFilterIn replaces or removes --filter_in= parameter of the
// crash reporter.
// The kernel is set up to call the crash reporter with the core dump
// as stdin when a process dies. This function adds a filter to the command
// line used to call the crash reporter. This is used to ignore
// crashes in which we have no interest.
// The order of the commandline arguments will not be preserved.
