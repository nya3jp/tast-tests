...
func init() {
	testing.AddTest(&testing.Test{
		...
		Data: []string{
			crashtest.MockMetricsOnPolicyFile,
			crashtest.MockMetricsOwnerKeyFile,
		},
	})
}
...
func UdevCrash(ctx context.Context, s *testing.State) {
	...
	if err := crashtest.SetConsent(ctx, s.DataPath(crashtest.MockMetricsOnPolicyFile), s.DataPath(crashtest.MockMetricsOwnerKeyFile)); err != nil {
