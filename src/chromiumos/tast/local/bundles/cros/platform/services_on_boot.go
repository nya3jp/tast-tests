	...
	testing.AddTest(&testing.Test{
		...
		Params: []testing.Param{
			...
			},
			{
				...
				// TODO(b/254566972): hwdep.SmartAmpBootTimeCalibration() is narrower than having /etc/init/sound_card_init.conf
...
//  1. A reboot is needed to avoid events that happen before the test is run
