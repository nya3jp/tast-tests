...
// watchDiscardSignal sets up a D-Bus signal watcher, and returns a channel.
// The signal watcher runs as a goroutine and waits for a D-Bus discard signal
// from chrome, then signals its arrival by closing the channel.
func watchDiscardSignal(ctx context.Context) (discard, stop chan struct{}, err error) {
