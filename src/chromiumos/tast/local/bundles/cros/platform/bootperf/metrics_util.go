...
const (
	...
	// Generated by `date '+%Y%m%d%H%M%S'` in the chromeos_shutdown script.
...
var (
	...
	uptimeFileGlob = "/tmp/" + uptimePrefix + "*"
	diskFileGlob   = "/tmp/" + diskPrefix + "*"
...
func GatherTimestampFiles(raw map[string][]byte) {
	...
	statlist = append(statlist, firmwareTimeFile)
