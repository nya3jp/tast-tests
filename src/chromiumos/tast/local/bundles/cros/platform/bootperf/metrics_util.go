...
func getRamoopsRebootTime() (float64, error) {
...
func GatherRebootMetrics(results *platform.GetBootPerfMetricsResponse) error {
	...
	kernelShutdownKmsgTime, err := getRamoopsRebootTime()
	if err != nil {
	...
	// local_clock and CLOCK_MONOTONIC -- which itself is equivalent to CLOCK_BOOTIME
