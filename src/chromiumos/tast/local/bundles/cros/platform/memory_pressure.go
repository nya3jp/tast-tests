...
// runAndLogSwapStats runs function and outputs swap stats that correspond to its
// execution.
func runAndLogSwapStats(ctx context.Context, function func(), meter *kernelmeter.Meter) {
	meter.Reset()
	function()
	stats, err := meter.VMStats()
	if err != nil {
