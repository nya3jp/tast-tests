...
func init() {
	testing.AddTest(&testing.Test{
		...
		SoftwareDeps: []string{"chrome", "android", "android_p"},
	})
}

// MemoryPressureARC is the main test function.
func MemoryPressureARC(ctx context.Context, s *testing.State) {
