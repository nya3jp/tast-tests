...
var (
	...
	// Example CSD text containing Pre EOL information. 0x02 means Warning,
	// consumed 80% of reserved blocks. 0x03 means Urgent.
	//   "Pre EOL information [PRE_EOL_INFO: 0x02]"
	//     i.e. Warning
	// We want to detect either 0x02 for the Warning case or 0x03 for the Urgent case.
	// That indicates that the eMMC is near the end of life.
	emmcFailing = regexp.MustCompile(`.*(?P<param>PRE_EOL_INFO]?: 0x0[23])`)
