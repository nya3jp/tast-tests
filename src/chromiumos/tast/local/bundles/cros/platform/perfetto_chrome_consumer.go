...
func init() {
	testing.AddTest(&testing.Test{
		Func: PerfettoChromeConsumer, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Tests Chrome DevTools protocol for collecting a system-wide trace via the system tracing service",
