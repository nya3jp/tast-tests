...
func CheckTracingServices(ctx context.Context) (int, int, error) {
	...
	_, _, tracedProbesPid, err := upstart.JobStatus(ctx, TracedProbesJobName)
	if err != nil {
		return 0, 0, err
	}
