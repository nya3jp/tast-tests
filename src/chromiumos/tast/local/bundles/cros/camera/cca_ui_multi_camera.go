...
func init() {
	testing.AddTest(&testing.Test{
		...
		Data:         []string{"cca_ui.js", "cca_ui_multi_camera.js"},
		Pre:          chrome.LoggedIn(),
	})
}
...
func CCAUIMultiCamera(ctx context.Context, s *testing.State) {
	...
	app, err := cca.New(ctx, cr, []string{s.DataPath("cca_ui.js"), s.DataPath("cca_ui_multi_camera.js")})
	if err != nil {
	...
	if numCameras > 1 {
		// Set grid option.
		gridEnabled := false
		if gridEnabled, err = app.ToggleGridOption(ctx); err != nil {
