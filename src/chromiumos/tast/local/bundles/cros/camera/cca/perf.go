...
func MeasurePerformance(ctx context.Context, env *testutil.TestEnvironment, cr *chrome.Chrome, scripts []string, options MeasurementOptions) (retErr error) {
	...
	app, err := New(ctx, env, scripts, options.OutputDir)
	if err != nil {
