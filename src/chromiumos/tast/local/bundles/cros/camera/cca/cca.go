...
var (
	...
	ResolutionSettingBackButton = UIComponent{"resolution setting back button", []string{
		"#resolutionsettings .menu-header button", "#view-resolution-settings .menu-header button"}}
	// PhotoResolutionSettingBackButton is back button for closing photo resolution setting menu.
	PhotoResolutionSettingBackButton = UIComponent{"photo resolution setting back button", []string{
		"#photoresolutionsettings .menu-header button", "#view-photo-resolution-settings .menu-header button"}}
	// VideoResolutionSettingBackButton is back button for closing video resolution setting menu.
	VideoResolutionSettingBackButton = UIComponent{"video resolution setting back button", []string{
		"#videoresolutionsettings .menu-header button", "#view-video-resolution-settings .menu-header button"}}
