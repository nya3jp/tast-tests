...
// CollectPerfEvents collects all perf events from launch until now.
func (a *App) CollectPerfEvents(ctx context.Context) ([]PerfEvent, error) {
...
func (a *App) Close(ctx context.Context) error {
	...
	// TODO(crbug.com/1020484): Handle the error. Currently Conn.Close returns
	// an error if the target is already closed.
	a.conn.Close()
	a.conn = nil
