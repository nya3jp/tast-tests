...
func init() {
	testing.AddTest(&testing.Test{
		Func: CCAUIDocumentScanning, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Verifies that CCA can take a photo for document and generate the document file via file VCD",
