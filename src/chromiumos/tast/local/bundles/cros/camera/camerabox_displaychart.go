...
func CameraboxDisplaychart(ctx context.Context, s *testing.State) {
	...
	Because we need to make sure this python script works properly in autotest and tast
	So we need to run by shell script in golang to make sure display_chart.py is working properly
	*/
