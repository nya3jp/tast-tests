...
func NewTestBridge(ctx context.Context, cr *chrome.Chrome, useSWA bool) (*TestBridge, error) {
	pageConn, bridge, err := constructTestBridge(ctx, cr, useSWA)
	if err != nil {
		return nil, err
	}
...
func constructTestBridge(ctx context.Context, cr *chrome.Chrome, useSWA bool) (*chrome.Conn, *chrome.JSObject, error) {
...
func (t *TestBridge) Reset(ctx context.Context) error {
	...
	pageConn, bridge, err := constructTestBridge(ctx, t.cr, t.useSWA)
	if err != nil {
...
func (t *TestBridge) TearDown(ctx context.Context) error {
	...
	return tearDownBridgePageConnection(ctx, t.cr, t.pageConn, t.useSWA)
}
