...
// TestBridge is used to comminicate with CCA for non-production logic, such as set-up/tear-down flow, performance/error monitoring.
...
func (t *TestBridge) AppWindow(ctx context.Context) (*chrome.JSObject, error) {
