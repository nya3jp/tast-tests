...
func matchSpeeches(ctx context.Context, sm *a11y.SpeechMonitor, fnodename string, s *testing.State) error {
	fnodename = strings.Replace(fnodename, "+", "plus", -1)
	...
	matched, err := regexp.MatchString(fnodename, spoken)
	if err != nil {
