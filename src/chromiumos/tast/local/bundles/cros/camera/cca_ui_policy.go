...
func servePolicy(ctx context.Context, env *cca.TestEnvironment, cr *chrome.Chrome, ps []policy.Policy) error {
...
func testNoPolicy(ctx context.Context, env *cca.TestEnvironment, cr *chrome.Chrome, scripts []string, outDir string) error {
...
func testBlockCCAExtension(ctx context.Context, env *cca.TestEnvironment, cr *chrome.Chrome) error {
...
func testBlockCameraFeature(ctx context.Context, env *cca.TestEnvironment, cr *chrome.Chrome) error {
...
func testBlockVideoCapture(ctx context.Context, env *cca.TestEnvironment, cr *chrome.Chrome, scripts []string, outDir string) error {
