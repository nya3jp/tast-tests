...
var facingMap = map[cameraboxpb.Facing]cca.Facing{
	// Most of the devices have front camera but might not have back camera.
	// Therefore, map to front camera if it is unset.
...
func tempFilePathForScriptContent(ctx context.Context, script []byte) (string, error) {
