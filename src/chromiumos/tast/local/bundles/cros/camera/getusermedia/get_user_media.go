...
const (
	// VerboseLogging enables verbose logging. This is an alias for using in camera/get_user_media.go and camera/get_user_media_.go.
	VerboseLogging = camera.VerboseLogging
	// NoVerboseLogging disables verbose logging. This is an alias for using in camera/get_user_media.go and camera/get_user_media_.go.
	NoVerboseLogging = camera.NoVerboseLogging
)
