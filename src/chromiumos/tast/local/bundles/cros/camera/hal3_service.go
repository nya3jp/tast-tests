...
func createOutDir() (string, error) {
	...
	if err := os.Chown(outDir, uid, -1); err != nil {
		return "", errors.Wrap(err, "failed to chown temp output directory to arc-camera")
	}
	return outDir, nil
}
