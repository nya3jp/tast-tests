...
func MojoChangeESimNickname(ctx context.Context, s *testing.State) {
	...
	installResult, profile, err := euicc.InstallProfileFromActivationCode(ctx, string(activationCode), "")
	if err != nil {
