...
func init() {
	testing.AddTest(&testing.Test{
		...
		Params: []testing.Param{{
			...
			Val:       testParam{"amari_null_attach_ipv4v6.pbf", "", "amari_ipv4v6"},
			...
			Name:      "attach_ipv6",
			Val:       testParam{"amari_attach_ipv6.pbf", "amari_ipv6", "amari_ipv6"},
			ExtraData: []string{"amari_attach_ipv6.pbf"},
		}, {
			Name:      "default_attach_different_connect_apn_ipv4",
			Val:       testParam{"amari_default_attach_different_connect_apn_ipv4v6.pbf", "amari_default_attach", "amari_ipv4v6"},
