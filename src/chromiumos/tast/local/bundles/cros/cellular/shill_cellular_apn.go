...
func init() {
	testing.AddTest(&testing.Test{
		...
		Params: []testing.Param{{
			...
			Val:       testParam{"callbox_round_robin_attach.pbf", "callbox_ipv4", "callbox_ipv4", nil},
			ExtraData: []string{"callbox_round_robin_attach.pbf"},
		}, {
			Name:      "round_robin_connect_ipv4_default_attach",
			Val:       testParam{"callbox_round_robin_connect_ipv4_default_attach.pbf", "callbox_default_attach", "callbox_ipv4", nil},
			ExtraData: []string{"callbox_round_robin_connect_ipv4_default_attach.pbf"},
		}, {
			Name:      "null_attach_ipv4v6",
			Val:       testParam{"callbox_null_attach_ipv4v6.pbf", "", "callbox_ipv4v6", nil},
			ExtraData: []string{"callbox_null_attach_ipv4v6.pbf"},
		}, {
			Name:      "null_attach_ipv6",
			Val:       testParam{"callbox_null_attach_ipv6.pbf", "", "callbox_ipv6", nil},
			ExtraData: []string{"callbox_null_attach_ipv6.pbf"},
		}, {
			Name:      "null_attach_ipv4",
			Val:       testParam{"callbox_null_attach_ipv4.pbf", "", "callbox_ipv4", nil},
			ExtraData: []string{"callbox_null_attach_ipv4.pbf"},
		}, {
			Name:      "attach_ipv6",
			Val:       testParam{"callbox_attach_ipv6.pbf", "callbox_ipv6", "callbox_ipv6", nil},
			ExtraData: []string{"callbox_attach_ipv6.pbf"},
		}, {
			Name: "attach_ip_default",
			// Unknown authentication should fallback to CHAP
			Val:       testParam{"callbox_attach_ip_default.pbf", "callbox_ipv4", "callbox_ipv4", nil},
			ExtraData: []string{"callbox_attach_ip_default.pbf"},
		}, {
			Name: "attach_authentication_unknown",
			// Unknown authentication should fallback to CHAP
			Val:       testParam{"callbox_attach_auth_unknown.pbf", "callbox_ipv4_chap", "callbox_ipv4_chap", nil},
			ExtraData: []string{"callbox_attach_auth_unknown.pbf"},
		}, {
			Name:      "attach_authentication_pap",
			Val:       testParam{"callbox_attach_auth_pap.pbf", "callbox_ipv4_pap", "callbox_ipv4_pap", nil},
			ExtraData: []string{"callbox_attach_auth_pap.pbf"},
		}, {
			Name:      "attach_authentication_chap",
			Val:       testParam{"callbox_attach_auth_chap.pbf", "callbox_ipv4_chap", "callbox_ipv4_chap", nil},
			ExtraData: []string{"callbox_attach_auth_chap.pbf"},
		}, {
			Name:      "default_attach_different_connect_apn_ipv4",
			Val:       testParam{"callbox_default_attach_different_connect_apn_ipv4.pbf", "callbox_default_attach", "callbox_ipv4", nil},
			ExtraData: []string{"callbox_default_attach_different_connect_apn_ipv4.pbf"},
		}, {
			Name:      "default_attach_different_connect_apn_ipv4v6",
			Val:       testParam{"callbox_default_attach_different_connect_apn_ipv4v6.pbf", "callbox_default_attach", "callbox_ipv4v6", nil},
