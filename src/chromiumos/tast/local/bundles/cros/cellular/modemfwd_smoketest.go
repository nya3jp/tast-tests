...
// ModemfwdSmoketest Test
func ModemfwdSmoketest(ctx context.Context, s *testing.State) {
	...
	if err := modemfwd.StartAndWaitForFlashing(ctx); err != nil {
