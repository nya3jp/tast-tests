...
func init() {
	testing.AddTest(&testing.Test{
		...
		Params: []testing.Param{{
			...
			Val:       testParam2{"callbox_unknown_carrier.pbf", "callbox_default_attach", "callbox_ipv4", map[string]interface{}{"apn": "wrong_attach"}, map[string]interface{}{"apn": "callbox_ipv4"}},
