...
func init() {
	testing.AddTest(&testing.Test{
		...
		// This is the list of boards which have their FW in DLCs, but no longer have them in the rootfs.
		// When the FWs are removed from the rootfs, add that board to the list to skip this test.
		//HardwareDeps: hwdep.D(hwdep.ChromeEC(), hwdep.SkipOnPlatform("guybrush")),
	})
}
...
// cleanUp ensures that dlcservice is fully started.
