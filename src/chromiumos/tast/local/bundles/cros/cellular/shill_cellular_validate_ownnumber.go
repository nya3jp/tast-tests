...
func init() {
	testing.AddTest(&testing.Test{
		...
		Desc:     "Verifies that Cellular Device could fetch OwnNumber property from modemmanager and shill device",
...
func ShillCellularValidateOwnnumber(ctx context.Context, s *testing.State) {
	...
	s.Log("Modem properties: ", modemProps)
	...
	s.Log("shill deviceprops: ", deviceProps)
	if err != nil {
	...
	if err != nil {
		s.Fatal("Failed to get Device.Cellular.OwnNumbers property: ", err)
	}
	...
	// Ensure that Shill creates a Service.
