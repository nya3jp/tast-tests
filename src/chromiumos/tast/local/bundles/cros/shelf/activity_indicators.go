...
// expectNumberOfActivityIndicators checks the number of shelf app button indicator views that exist and compares that to expectedNumberOfIndicators.
// If the number of indicators is different than expected, then an error is returned.
