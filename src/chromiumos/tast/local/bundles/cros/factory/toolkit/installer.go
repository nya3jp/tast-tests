...
type Installer struct {
	...
	// not supported.
	ImagePath string
	// NoEnable configures the install option --no-enable, which stops
	// running factory test after install if set to true.
	NoEnable bool
}
...
func (i *Installer) installFactoryToolKitFromFactoryImage(ctx context.Context) (version string, err error) {
	...
	installerPath := "toolkit/install_factory_toolkit.run"
