...
func GetReport(ctx context.Context, processRNum func(*uhid.Device, uhid.RNumType) ([]byte, error), d *uhid.Device, buf []byte) error {
	...
	var data []byte
	var err error
	if data, err = processRNum(d, event.RNum); err != nil {
