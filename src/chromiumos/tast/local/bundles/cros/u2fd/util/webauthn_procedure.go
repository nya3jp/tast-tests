...
func WebAuthnInWebAuthnIo(ctx context.Context, cr *chrome.Chrome, authCallback func(context.Context, *uiauto.Context) error) error {
	...
	if err := CheckMakeCredentialSuccessInWebAuthnIo(ctx, conn, ui); err != nil {
	...
	if err := CheckGetAssertionSuccessInWebAuthnIo(ctx, conn, ui); err != nil {
...
func CheckMakeCredentialSuccessInWebAuthnIo(ctx context.Context, conn *chrome.Conn, ui *uiauto.Context) error {
...
func CheckGetAssertionSuccessInWebAuthnIo(ctx context.Context, conn *chrome.Conn, ui *uiauto.Context) error {
	return testing.Poll(ctx, func(context.Context) error {
		result := true
