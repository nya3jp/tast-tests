...
func init() {
	testing.AddTest(&testing.Test{
		...
		Contacts:     []string{"jeff.lin@cienet.com", "xliu@cienet.com", "hcutts@google.com", "cros-peripherals@google.com"},
...
func InputKeyboardConnectAndDisconnect(ctx context.Context, s *testing.State) {
	...
	if err := uiauto.Combine("verify virtual keyboard appears and disappears in the device list",
		...
		// Make the virtual keyboard visible for 5 seconds before disconnecting it.
