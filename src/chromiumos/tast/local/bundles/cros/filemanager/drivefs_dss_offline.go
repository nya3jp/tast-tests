...
func init() {
	testing.AddTest(&testing.Test{
		Func: DrivefsDssOffline, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Verify that making a Docs/Sheets/Slides file available offline through Files App works",
		Contacts: []string{
