...
func init() {
	testing.AddTest(&testing.Test{
		...
		// TODO(https://crbug.com/1140884): Test is disabled until it
		// can be fixed. When reenabling this test, please also
		// remember to regenerate the subtest parameters to add back
		// the "informational" attribute.  Please see smb_test.go for
		// more details.
