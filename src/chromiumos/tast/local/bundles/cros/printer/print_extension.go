...
func PrintExtension(ctx context.Context, s *testing.State) {
	...
	if err := tconn.Call(ctx, nil, "chrome.autotestPrivate.updatePrinter", map[string]string{"printerName": printerName, "printerId": printerID, "printerDesc": printerDesc, "printerUri": "socket://127.0.0.1/", "printerPpd": ppdFilePath}); err != nil {
