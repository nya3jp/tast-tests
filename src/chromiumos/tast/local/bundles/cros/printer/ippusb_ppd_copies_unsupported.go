...
func init() {
	testing.AddTest(&testing.Test{
		Func: IPPUSBPPDCopiesUnsupported, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Verifies that the 'copies-supported' attribute of the printer is used to populate the cupsManualCopies and cupsMaxCopies values in the corresponding generated PPD",
