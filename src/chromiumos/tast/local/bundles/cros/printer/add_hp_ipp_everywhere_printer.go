...
func init() {
	testing.AddTest(&testing.Test{
		Func: AddHPIPPEverywherePrinter,
...
func AddHPIPPEverywherePrinter(ctx context.Context, s *testing.State) {
	lpprint.Run(ctx, s, "hp_ipp_everywhere.ppd", "to_print.pdf", "printer_add_hp_ipp_everywhere_golden.pwg")
}
