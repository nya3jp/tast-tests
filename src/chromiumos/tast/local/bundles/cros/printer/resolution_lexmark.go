	...
	testing.AddTest(&testing.Test{
		...
		Params: []testing.Param{{
			...
			Val: &ippprint.Params{
				...
				OutDiffFile:  "printer_resolution_default_diff.bin",
			},
			...
			Val: &ippprint.Params{
				...
				OutDiffFile:  "printer_resolution_600dpi_diff.bin",
			...
			Val: &ippprint.Params{
				...
				OutDiffFile:  "printer_resolution_1200dpi_diff.bin",
			...
			Val: &ippprint.Params{
				...
				OutDiffFile:  "printer_resolution_2400x600dpi_diff.bin",
