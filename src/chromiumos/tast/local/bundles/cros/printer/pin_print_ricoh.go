	...
	testing.AddTest(&testing.Test{
		...
		Params: []testing.Param{{
			...
			Val: &ippprint.Params{
				...
				OutDiffFile:  "jobpassword_no-pin_diff.bin",
			},
			...
			Val: &ippprint.Params{
				...
				OutDiffFile:  "jobpassword_pin_diff.bin",
			...
			Val: &ippprint.Params{
				...
				OutDiffFile:  "lockedprintpassword_no-pin_diff.bin",
			},
			...
			Val: &ippprint.Params{
				...
				OutDiffFile:  "lockedprintpassword_pin_diff.bin",
				Options:      []ippprint.Option{ippprint.WithJobPassword("1234")},
			},
			...
			Val: &ippprint.Params{
				...
				OutDiffFile:  "password_no-pin_diff.bin",
			},
			...
			Val: &ippprint.Params{
				...
				OutDiffFile:  "password_pin_diff.bin",
				Options:      []ippprint.Option{ippprint.WithJobPassword("1234")},
			},
