...
func init() {
	testing.AddTest(&testing.Test{
		Func:         HardwareCriticalCombinations,
		LacrosStatus: testing.LacrosVariantUnneeded,
		Desc:         "Tests that the Scan app can be used on real hardware with critical combinations",
		Contacts: []string{
...
func HardwareCriticalCombinations(ctx context.Context, s *testing.State) {
	...
	scanning.RunHardwareTests(ctx, s, cr, scanner, scanning.HardwareTestRunCriticalCombinations)
}
