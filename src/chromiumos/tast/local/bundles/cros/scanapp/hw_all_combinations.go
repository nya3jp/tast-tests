...
func init() {
	testing.AddTest(&testing.Test{
		Func: HWAllCombinations,
		Desc: "Tests that the Scan app can be used on real hardware with all combinations",
		Contacts: []string{
...
func HWAllCombinations(ctx context.Context, s *testing.State) {
	...
	scanning.RunHardwareTests(ctx, s, cr, scanner, scanning.HardwareTestRunAllCombinations)
}
