...
func init() {
	testing.AddTest(&testing.Test{
		Func: LargePaperScans, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Tests that the Scan app supports large paper size selection when available from printer",
