...
func init() {
	testing.AddTest(&testing.Test{
		...
		Attr:         []string{"group:graphics", "graphics_trace", "graphics_prebuild"},
...
func TraceReplayGlxgears(ctx context.Context, s *testing.State) {
	...
	var entries = []trace.TestEntryConfig {
		trace.TestEntryConfig {
			Name: "glxgears",
	...
	trace.RunTraceReplayTest(ctx, s, pre.Container, entries)
}
