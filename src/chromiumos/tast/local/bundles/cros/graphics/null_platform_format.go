...
func init() {
	testing.AddTest(&testing.Test{
		Func: NullPlatformFormat, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Checks that the null_platform_test passes for at least one format with a given color depth",
		Contacts: []string{
