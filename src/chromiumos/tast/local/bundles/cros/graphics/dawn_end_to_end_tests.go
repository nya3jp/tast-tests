...
func init() {
	testing.AddTest(&testing.Test{
		Func: DawnEndToEndTests,
		Desc: "Verifies dawn_end2end_tests runs successfully",
		Contacts: []string{
			"hob@chromium.org",
...
func DawnEndToEndTests(ctx context.Context, s *testing.State) {
	const exec = "/usr/libexec/chrome-binary-tests/dawn_end2end_tests"
