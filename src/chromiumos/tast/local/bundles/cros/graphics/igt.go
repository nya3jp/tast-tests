...
func init() {
	testing.AddTest(&testing.Test{
		...
		Params: []testing.Param{{
			...
			Timeout:           5 * time.Minute,
			ExtraHardwareDeps: hwdep.D(hwdep.SkipOnPlatform(supportedQcom...)),
		}, {
			...
			Timeout:           5 * time.Minute,
			ExtraHardwareDeps: hwdep.D(hwdep.Platform(supportedQcom...)),
		}, {
			Name: "kms_big_fb",
			Val: igtTest{
				exe: "kms_big_fb",
			...
			Timeout:           5 * time.Minute,
			ExtraHardwareDeps: hwdep.D(hwdep.SkipOnPlatform(supportedMtk...)),
		}, {
			...
			Timeout:           5 * time.Minute,
			ExtraHardwareDeps: hwdep.D(hwdep.Platform(supportedMtk...)),
		}, {
			Name: "kms_concurrent",
			Val: igtTest{
				exe: "kms_concurrent",
			...
			Timeout:           15 * time.Minute,
			ExtraHardwareDeps: hwdep.D(hwdep.SkipOnPlatform(supportedAmd...)),
		}, {
			...
			Timeout:           15 * time.Minute,
			ExtraHardwareDeps: hwdep.D(hwdep.Platform(supportedAmd...)),
		}, {
			...
			ExtraHardwareDeps: hwdep.D(hwdep.SkipOnPlatform(append(supportedAmd, supportedQcom...)...)),
		}, {
			...
			Timeout:           20 * time.Minute,
			ExtraHardwareDeps: hwdep.D(hwdep.Platform(append(supportedAmd, supportedQcom...)...)),
		}, {
			Name: "kms_dp_aux_dev",
			Val: igtTest{
				exe: "kms_dp_aux_dev",
			...
			ExtraHardwareDeps: hwdep.D(hwdep.SkipOnPlatform(append(append(supportedAmd, supportedQcom...), supportedMtk...)...)),
		}, {
			...
			Timeout:           30 * time.Minute,
			ExtraHardwareDeps: hwdep.D(hwdep.Platform(append(append(supportedAmd, supportedQcom...), supportedMtk...)...)),
		}, {
