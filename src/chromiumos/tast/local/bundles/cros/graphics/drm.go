...
func init() {
	testing.AddTest(&testing.Test{
		...
		Params: []testing.Param{{
			...
			ExtraSoftwareDeps: []string{"display_backlight", "drm_atomic", "no_qemu"},
			...
			ExtraSoftwareDeps: []string{"display_backlight", "no_qemu"},
		}, {
			Name:              "dmabuf_test",
			...
			Val:               []string{"vk_glow"},
			Timeout:           30 * time.Second,
			ExtraSoftwareDeps: []string{"display_backlight", "vulkan", "no_qemu"},
			ExtraAttr:         []string{"informational"},
		}},
