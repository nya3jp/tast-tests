...
func VTSwitch(ctx context.Context, s *testing.State) {
	...
	savePerf(maxDifferenceRatio[1], "percent_VT1_screenshot_max_difference", "percent", pv)
	savePerf(maxDifferenceRatio[2], "percent_VT2_screenshot_max_difference", "percent", pv)
