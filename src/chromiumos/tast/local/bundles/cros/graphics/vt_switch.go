...
func VTSwitch(ctx context.Context, s *testing.State) {
	...
	savePerf(100.00*maxDifferenceRatio[1], "ratio_VT1_screenshot_max_difference", "percent", pv)
	savePerf(100.00*maxDifferenceRatio[2], "ratio_VT2_screenshot_max_difference", "percent", pv)
