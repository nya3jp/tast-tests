...
func savePerfFloat(number float64, name, unit string, pv *perf.Values) {
...
func savePerfInt(number int, name, unit string, pv *perf.Values) {
	direction := perf.BiggerIsBetter
	if unit == "percent" {
		direction = perf.SmallerIsBetter
	}
...
func VTSwitch(ctx context.Context, s *testing.State) {
	...
	savePerfFloat(maxDifferenceRatio[1], "percent_VT1_screenshot_max_difference", "percent", pv)
	savePerfFloat(maxDifferenceRatio[2], "percent_VT2_screenshot_max_difference", "percent", pv)
	savePerfInt(identicalScreenshots[1], "num_identical_vt1_screenshots", "count", pv)
	savePerfInt(identicalScreenshots[2], "num_identical_vt2_screenshots", "count", pv)
