...
func init() {
	testing.AddTest(&testing.Test{
		Func: VKBench, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Run vkbench (a benchmark that times graphics intensive activities for vulkan), check results and report its performance",
		Contacts: []string{
			"pwang@chromium.org",
