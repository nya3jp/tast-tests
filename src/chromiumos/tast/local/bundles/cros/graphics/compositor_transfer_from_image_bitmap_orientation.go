...
func init() {
	testing.AddTest(&testing.Test{
		Func: CompositorTransferFromImageBitmapOrientation, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Verifies that transferFromImageBitmap is oriented correctly",
		Contacts: []string{
