...
func init() {
	testing.AddTest(&testing.Test{
		Func: TraceReplayExtended, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Repeatedly replay a 3D graphics trace file in Crostini VM for a fixed duration",
