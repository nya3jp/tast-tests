	...
	testing.AddTest(&testing.Test{
		...
		Params: []testing.Param{
			// Parameters generated by glbench_test.go. DO NOT EDIT.
			{
				...
				Name:              "crostini_hasty_component_amd64",
				...
				Name:              "crostini_hasty_component_amd64_unstable",
				ExtraAttr:         []string{"group:graphics", "graphics_perbuild", "group:mainline", "informational"},
				ExtraData:         []string{"crostini_vm_amd64.zip", "crostini_container_metadata_buster_amd64.tar.xz", "crostini_container_rootfs_buster_amd64.tar.xz"},
				ExtraSoftwareDeps: []string{"chrome", "crosvm_gpu", "vm_host", "amd64"},
				...
				Name:              "crostini_hasty_component_arm",
				ExtraAttr:         []string{"group:graphics", "graphics_perbuild", "group:mainline", "informational"},
				ExtraData:         []string{"crostini_vm_arm.zip", "crostini_container_metadata_buster_arm.tar.xz", "crostini_container_rootfs_buster_arm.tar.xz"},
				ExtraSoftwareDeps: []string{"chrome", "crosvm_gpu", "vm_host", "arm"},
				ExtraHardwareDeps: crostini.CrostiniStable,
				...
				Name:              "crostini_hasty_component_arm_unstable",
				ExtraAttr:         []string{"group:graphics", "graphics_perbuild", "group:mainline", "informational"},
				ExtraData:         []string{"crostini_vm_arm.zip", "crostini_container_metadata_buster_arm.tar.xz", "crostini_container_rootfs_buster_arm.tar.xz"},
				ExtraSoftwareDeps: []string{"chrome", "crosvm_gpu", "vm_host", "arm"},
				ExtraHardwareDeps: crostini.CrostiniUnstable,
