...
func init() {
	testing.AddTest(&testing.Test{
		Func: GLBench, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Run glbench (a benchmark that times graphics intensive activities), check results and report its performance",
		Contacts: []string{
