...
func init() {
	testing.AddTest(&testing.Test{
		...
		Params: []testing.Param{
			...
			{
				Name:              "glxgears_component_buster_amd64",
				...
				Name:              "glxgears_component_buster_amd64_unstable",
				...
				Name:              "glxgears_component_buster_arm",
				...
				Name:              "glxgears_component_buster_arm_unstable",
				ExtraAttr:         []string{"informational"},
				ExtraData:         []string{"crostini_vm_arm.zip", "crostini_container_metadata_buster_arm.tar.xz", "crostini_container_rootfs_buster_arm.tar.xz"},
				ExtraSoftwareDeps: []string{"arm"},
				ExtraHardwareDeps: trace.HwDepsUnstable,
