...
var dpPlusModels = []string{
	...
	"delbin", "eldrid", "lillipup", "lindar", "volteer", "volteer2",
}

func init() {
	testing.AddTest(&testing.Test{
		Func: Connector, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Checks the validity of display connector configurations",
		Contacts: []string{
			"pwang@chromium.org",
