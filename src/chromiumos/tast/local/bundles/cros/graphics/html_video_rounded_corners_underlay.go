...
func init() {
	testing.AddTest(&testing.Test{
		Func: HTMLVideoRoundedCornersUnderlay, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Verifies that HTML <video> rounded corners are implemented with a hardware underlay",
