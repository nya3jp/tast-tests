...
// "dEQP-GLES2.info.vendor" in its own command (which means, e.g., a new context
// for the test). env lists the environment variables to set when running the
// test, e.g., "SHELL=/bin/bash". The test's log is written to a file named
// <test>.log within logDir.
//
