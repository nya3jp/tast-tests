...
func init() {
	testing.AddTest(&testing.Test{
		...
		// We need two LoginTimeouts because we log on once to create a user and then reboot (reboot is
		// almost as expensive as login). We then perform some fast UI operations.
