...
// disableNonCelluarInterfaces disable all non cellular interfaces
func (h *helper) disableNonCelluarInterfaces(ctx context.Context) error {
...
// restoreNonCellularInterfaces enable previously disabled interfaces
func (h *helper) restoreNonCellularInterfaces(ctx context.Context) {
...
func (h *helper) runTestOffline(ctx context.Context, testBody func(ctx context.Context) error) error {
	...
	if err := h.disableNonCelluarInterfaces(ctx); err != nil {
		return errors.Wrap(err, "failed to disable non cellular interface")
	}
	defer h.restoreNonCellularInterfaces(ctx)
