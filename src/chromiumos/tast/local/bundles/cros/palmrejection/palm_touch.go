...
func init() {
	testing.AddTest(&testing.Test{
		...
		Params: []testing.Param{{
			...
			Val: testParam{
				dataFiles: []string{"kohaku_palmedgeinmiddle.csv", "kohaku_palm.csv"},
			},
		}, {
			Name:              "coachz",
		...
		Data: []string{"palm_touch_index.html", "palm_touch_script.mjs", "palm_touch_kohaku_palmedgeinmiddle.csv", "palm_touch_coachz_palmedgeinmiddle.csv", "palm_touch_kohaku_palm.csv"},
	})
}
