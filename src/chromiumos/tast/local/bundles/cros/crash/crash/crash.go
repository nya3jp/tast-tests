...
const (
	...
	crashReporterLogFormat          = crashReporterLogPrefix + " %s[%d] sig 11, user %s group %s (handling)"
	crashReporterNoConsentLogPrefix = "No consent. Not handling invocation: /sbin/crash_reporter"
	crashReporterNoConsentLogFormat = crashReporterNoConsentLogPrefix + " --user=%d:11:%s:%s:%s"
