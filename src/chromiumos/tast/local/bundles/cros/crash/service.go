...
func init() {
	testing.AddService(&testing.Service{
		Register: func(srv *grpc.Server, s *testing.ServiceState) {
			crash_service.RegisterServiceServer(srv, &Service{s: s})
		},
	})
}

// Service implements tast.cros.crash.Service
type Service struct {
...
func (c *Service) SetUp(ctx context.Context, req *empty.Empty) (*empty.Empty, error) {
	if c.cr != nil {
...
func (c *Service) TearDown(ctx context.Context, req *empty.Empty) (*empty.Empty, error) {
	if c.cr == nil {
