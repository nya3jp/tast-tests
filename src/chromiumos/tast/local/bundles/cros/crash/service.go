...
func (c *FixtureService) SetCrashFilter(ctx context.Context, req *crash_service.SetCrashFilterRequest) (*empty.Empty, error) {
	return &empty.Empty{}, crash.EnableCrashFiltering(req.Name)
}

func (c *FixtureService) UnsetCrashFilter(context.Context, *empty.Empty) (*empty.Empty, error) {
