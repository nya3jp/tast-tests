...
func ManualTicketEditConfiguration(ctx context.Context, s *testing.State) {
	...
	// Create a ticket with custom lifitime and check if it was actually added.
	...
	// Check that configuration can not be saved if the syntaxis is wrong.
