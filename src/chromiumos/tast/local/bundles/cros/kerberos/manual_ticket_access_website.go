...
func init() {
	testing.AddTest(&testing.Test{
		Func: ManualTicketAccessWebsite, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Checks the behavior of accessing website secured by Kerberos after adding Kerberos ticket",
		Contacts: []string{
