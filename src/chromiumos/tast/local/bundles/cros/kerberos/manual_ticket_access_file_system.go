...
func init() {
	testing.AddTest(&testing.Test{
		Func: ManualTicketAccessFileSystem, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Checks the behavior of accessing file system secured with Kerberos after adding Kerberos ticket",
		Contacts: []string{
