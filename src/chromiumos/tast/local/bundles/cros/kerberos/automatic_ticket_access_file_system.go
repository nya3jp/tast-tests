...
func init() {
	testing.AddTest(&testing.Test{
		Func: AutomaticTicketAccessFileSystem, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Checks the behavior of accessing file system secured with Kerberos using Kerberos account",
		Contacts: []string{
