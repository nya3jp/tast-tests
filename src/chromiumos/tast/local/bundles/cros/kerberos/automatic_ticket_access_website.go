...
func init() {
	testing.AddTest(&testing.Test{
		Func: AutomaticTicketAccessWebsite, LacrosStatus: testing.LacrosVariantUnknown, Desc: "Checks the behavior of accessing website secured with kerberos using KerberosAccount policy",
		Contacts: []string{
