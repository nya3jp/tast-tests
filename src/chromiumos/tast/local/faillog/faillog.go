...
func SaveScreenshot(ctx context.Context, dir string, suffix string) {
...
func saveScreenshotNative(ctx context.Context, dir string, suffix string) error {
...
func saveScreenshotCDP(ctx context.Context, dir string, suffix string) error {
