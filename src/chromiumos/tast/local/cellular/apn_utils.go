...
var (
	...
	carrierAPNs = map[carrier][]KnownAPN{
		...
		carrierDocomo: []KnownAPN{
			...
			KnownAPN{Optional: false, APNInfo: map[string]string{apn: "mopera.net", attach: attachTrue}},
			KnownAPN{Optional: false, APNInfo: map[string]string{apn: "lte-d.ocn.ne.jp", attach: attachTrue, username: "mobileid@ocn", password: "mobile"}},
		},
