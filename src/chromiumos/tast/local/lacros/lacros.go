...
// LinuxChromeState contains all state associated with a linux-chrome instance
...
func (l *LinuxChromeState) Close(ctx context.Context) error {
	l.Devsess = nil
	if l.cmd != nil {
...
func LaunchLinuxChrome(ctx context.Context, p PreData) (*LinuxChromeState, error) {
