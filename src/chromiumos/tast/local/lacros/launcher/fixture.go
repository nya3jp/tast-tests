...
type FixtData struct {
	...
	IsChromeBranded bool             // True if lacros-chrome is chrome branded instead of chromium.
}
...
func (f *fixtureImpl) buildFixtData(ctx context.Context, s *testing.FixtState) FixtData {
	...
	return FixtData{f.cr, f.tconn, f.mode, f.lacrosPath, f.isChromeBranded}
}
