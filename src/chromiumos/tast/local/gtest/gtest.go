...
// runner defines the thin APIs to implement GTest.Run() and Start().
...
func (*crosRunner) mktemp(ctx context.Context, name string) (string, error) {
...
func (t *GTest) createRunner() runner {
	if t.a == nil {
		return &crosRunner{}
	}
...
func (t *GTest) Start(ctx context.Context) (*testexec.Cmd, error) {
	return t.startCommand(ctx, t.createRunner(), "" /* output */)
}
