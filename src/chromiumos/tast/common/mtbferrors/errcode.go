...
// Local Test Allion API Error
const (
	Err3750 MTBFErrCode = iota + 3750
	Err3751
	Err3752
	Err3753
	Err3754
...
var errCodeToString = map[MTBFErrCode]string{
	...
	Err2900: `failed to run tast %v (last line: %q)`,
	Err2901: `couldn't open results.json file`,
	Err2902: `couldn't decode results from %v`,
	...
	Err3324: `%v failed`,
	Err3325: `Error while seeking, completed %d/%d seeks.`,
	Err3326: `Getting currentTime from media element failed.`,
	Err3327: `Getting currentTime second time from media element failed.`,
	Err3328: `Fast jump to time is inconsistent, startTime(%f), endTime(%f).`,
	Err3329: `Verify pause failed: startTime(%f), endTime(%f).`,
	Err3330: `Media element did not play(current time: %.2f, previous time: %.2f).`,
	Err3331: `Media element isn't playing forward(Current time: %.2f, previous time: %.2f): elapsed time is less than %.2f (%.2f)second.`,
	Err3332: `Media element fast jumps failed.`,
	...
	Err3406: `Verify failed, system audio is not mute.`,
	Err3407: `Failed to create audio player struct`,
	Err3408: `No message received`,
	Err3409: `Verification failed, volume is %d`,
	Err3410: `Failed to verify Audio Player is paused, audio player isn't pausing(Current time: %s, previous time: %s): elapsed time is less than %.2f second.`,
	...
	Err3416: `Audio player isn't playing forward(Current time: %s, previous time: %s): elapsed time is less than %.2f second.`,
	Err3417: `Input volume value is not a number(%s).`,
	Err3418: `Verify failed, system audio does not change volume(%d, %d).`,
	...
	Err3700: `Failed in %v()`,
	Err3750: `Failed to invoke Allion API url: %v`,
	Err3751: `Failed to control USB through Allion API. deviceId=%v option=%v resultCode=%v resultTxt=%v`,
	Err3752: `Failed to control ethernet through Allion API. deviceId=%v option=%v resultCode=%v resultTxt=%v`,
	Err3753: `Failed to mannually change WiFi strength through Allion API. SSID=%v strength=%v resultCode=%v resultTxt=%v`,
	Err3754: `Failed to set WiFi strength to auto through Allion API. SSID=%v min-strength=%v max-strength=%v resultCode=%v resultTxt=%v`,
	Err4100: `MBTF re-login failed`,
	Err4101: `Failed to open crosh`,
	Err4102: `Test variable not found! varName=%v`,
	Err4103: `Cannot get hostname of DUT`,
	...
	Err4315: `Failed to measure CPU usage %v`,
	Err4316: `Decoder did not run long enough for measuring CPU usage`,
