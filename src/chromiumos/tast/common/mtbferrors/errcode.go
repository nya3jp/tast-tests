...
var (
	...
	VideoHistNotGrow = MTBFErrCode{3336, `Histogram value not grow, before: %d, after: %d`}
	// VideoHistNotEqual error definition.
	VideoHistNotEqual = MTBFErrCode{3337, `Histogram %s value isn't correct, expected: %d, got: %d`}
	...
	VideoSevereFramedrops = MTBFErrCode{3342, `Video has a serious framedrop, current time(%.2f), framedrop(%d), running time(%.2f)`}
	...
	// VideoVeriPlay error definition.
	VideoVeriPlay = MTBFErrCode{4304, `VerifyPlaying failed`}
	// VideoChgQuality2 error definition.
	...
	// GRPCTransportClosing error difinition for transport is closing.
	GRPCTransportClosing = MTBFErrCode{5003, `GRPC Transport Closing`}
	// GRPCBase64Decode error difinition for base64 decode failed.
	GRPCBase64Decode = MTBFErrCode{5004, `Base64 decode error`}
	// GRPCOutDirNotSet error difinition for no OutDir.
	GRPCOutDirNotSet = MTBFErrCode{5005, `No Decode`}
	// GRPCCreateFileErr error difinition for file create.
	GRPCCreateFileErr = MTBFErrCode{5006, `Create File Error [%s]`}
	// GRPCWriteFileErr error difinition for file write.
	...
	CatsErr6002 = MTBFErrCode{6002, `Failed to querry the device info`}
	...
	CatsErr6006 = MTBFErrCode{6006, `Failed to new a catsClient`}
...
// CatsErrCode The erro for CATS Node.
