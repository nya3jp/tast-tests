...
var (
	...
	VideoPlayFailed = MTBFErrCode{3300, `Cannot play video: %s`}
	...
	BTConnectFailed = MTBFErrCode{3515, `Bluetooth device (%v) connect failed`}
	// BTServiceNotReady error definition.
	BTServiceNotReady = MTBFErrCode{3516, `Bluetooth (bluez) service not ready`}
	// BTBluezConnError error definition.
	BTBluezConnError = MTBFErrCode{3517, `Failed to connect due to BluezError`}
