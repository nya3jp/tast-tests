...
// duration. When succeeds, it also returns the list of bot IDs and the number
...
// RemoveAllBots removes all bots from the specified conference room. When succeeds,
// it also returns the list of bot IDs that failed to be removed and the
// list of bot IDs that's not found.
