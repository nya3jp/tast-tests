...
const (
	// Endpoint1 - for internal use
	Endpoint1 = "https://bond-pa.sandbox.googleapis.com"
	// Endpoint2 - for external use
	Endpoint2 = "https://botsondemand.googleapis.com"
...
// WithInternalEndpoint specifies the internal endpoint
func WithInternalEndpoint() NewClientOption {
	return func(opt *newClientOption) {
		opt.endpoint = Endpoint1
	}
}

// WithExternalEndpoint specifies the external endpoint
func WithExternalEndpoint() NewClientOption {
	return func(opt *newClientOption) {
		opt.endpoint = Endpoint2
	}
}
...
// Internal BOND API:
// google3/java/com/google/communication/meetings/testing/bots/service/proto/controller.proto
// google3/java/com/google/communication/meetings/testing/bots/service/proto/common.proto
...
// google3/google/communications/botsondemand/v1/bond_external.proto
// google3/google/communications/botsondemand/botsondemand.yaml
