...
// ToMap copies the fields of AudioDataFormat to a map, as expected by
// chameleond.
func (adf *AudioDataFormat) ToMap() map[string]interface{} {
	formatMap := make(map[string]interface{})
	formatMap["file_type"] = adf.FileType.ToString()
	formatMap["sample_format"] = adf.SampleFormat.ToString()
...
func MapToAudioDataFormat(formatMap map[string]interface{}) (*AudioDataFormat, error) {
	...
	var fileType string
	if err := getStringFromGenericMap(formatMap, "file_type", &fileType); err != nil {
		return nil, err
	}
	format.FileType = AudioFileType(fileType)
	var sampleFormat string
	if err := getStringFromGenericMap(formatMap, "sample_format", &sampleFormat); err != nil {
		return nil, err
	}
	format.SampleFormat = AudioSampleFormat(sampleFormat)
	if err := getIntFromGenericMap(formatMap, "channel", &format.Channel); err != nil {
		return nil, err
	}
	if err := getIntFromGenericMap(formatMap, "rate", &format.Rate); err != nil {
		return nil, err
	}
	return format, nil
}

func getStringFromGenericMap(srcMap map[string]interface{}, key string, dstStr *string) error {
...
func getIntFromGenericMap(srcMap map[string]interface{}, key string, dstInt *int) error {
	if genericValue, ok := srcMap[key]; ok {
...
func getBoolFromGenericMap(srcMap map[string]interface{}, key string, dstBool *bool) error {
	if genericValue, ok := srcMap[key]; ok {
...
func getFloat64FromGenericMap(srcMap map[string]interface{}, key string, dstFloat64 *float64) error {
	if genericValue, ok := srcMap[key]; ok {
...
func MapToVideoParams(paramsMap map[string]interface{}) (*VideoParams, error) {
	params := &VideoParams{}
	if err := getFloat64FromGenericMap(paramsMap, "clock", &params.Clock); err != nil {
		return nil, err
	}
	if err := getIntFromGenericMap(paramsMap, "htotal", &params.HTotal); err != nil {
		return nil, err
	}
	if err := getIntFromGenericMap(paramsMap, "hactive", &params.HActive); err != nil {
		return nil, err
	}
	if err := getIntFromGenericMap(paramsMap, "hsync_width", &params.HSyncWidth); err != nil {
		return nil, err
	}
	if err := getIntFromGenericMap(paramsMap, "hsync_offset", &params.HSyncOffset); err != nil {
		return nil, err
	}
	if err := getIntFromGenericMap(paramsMap, "hsync_polarity", &params.HSyncPolarity); err != nil {
		return nil, err
	}
	if err := getIntFromGenericMap(paramsMap, "vtotal", &params.VTotal); err != nil {
		return nil, err
	}
	if err := getIntFromGenericMap(paramsMap, "vactive", &params.VActive); err != nil {
		return nil, err
	}
	if err := getIntFromGenericMap(paramsMap, "vsync_width", &params.VSyncWidth); err != nil {
		return nil, err
	}
	if err := getIntFromGenericMap(paramsMap, "vsync_offset", &params.VSyncOffset); err != nil {
		return nil, err
	}
	if err := getIntFromGenericMap(paramsMap, "vsync_polarity", &params.VSyncPolarity); err != nil {
		return nil, err
	}
	if err := getIntFromGenericMap(paramsMap, "bpc", &params.BPC); err != nil {
		return nil, err
	}
	if err := getBoolFromGenericMap(paramsMap, "interlaced", &params.Interlaced); err != nil {
		return nil, err
	}
	return params, nil
}
...
type Chameleond interface {
	...
	// GetAudioBoardDevice returns an RPC interface for making RPC calls to the
	// chameleon audio board device.
	GetAudioBoardDevice() devices.ChameleonDevice

	// GetAVSyncProbeDevice returns an RPC interface for making RPC calls to the
	// chameleon AV sync probe device.
	GetAVSyncProbeDevice() devices.ChameleonDevice

	// GetBLEFastPair returns an RPC interface for making RPC calls to the
	// chameleon bluetooth LE fast pair device.
	GetBLEFastPair() bluetooth.FastPairPeripheral

	// GetBLEKeyboard returns an RPC interface for making RPC calls to the
	// chameleon bluetooth LE keyboard device.
	GetBLEKeyboard() bluetooth.KeyboardPeripheral

	// GetBLEMouse returns an RPC interface for making RPC calls to the
	// chameleon bluetooth LE mouse device.
	GetBLEMouse() bluetooth.MousePeripheral

	// GetBLEPhone returns an RPC interface for making RPC calls to the
	// chameleon bluetooth LE phone device.
	GetBLEPhone() bluetooth.PhonePeripheral

	// GetBluetoothA2DPSink returns an RPC interface for making RPC calls to the
	// chameleon bluetooth A2DP sink device.
	GetBluetoothA2DPSink() devices.ChameleonDevice

	// GetBluetoothAudioDevice returns an RPC interface for making RPC calls to
	// the chameleon bluetooth audio device.
	GetBluetoothAudioDevice() bluetooth.AudioPeripheral

	// GetBluetoothBaseDevice returns an RPC interface for making RPC calls to the
	// chameleon bluetooth base device.
	GetBluetoothBaseDevice() bluetooth.BasePeripheral

	// GetBluetoothKeyboardDevice returns an RPC interface for making RPC calls to
	// the chameleon bluetooth keyboard device.
	GetBluetoothKeyboardDevice() bluetooth.KeyboardPeripheral

	// GetBluetoothMouseDevice returns an RPC interface for making RPC calls to
	// the chameleon bluetooth mouse device.
	GetBluetoothMouseDevice() bluetooth.MousePeripheral

	// GetBluetoothTesterDevice returns an RPC interface for making RPC calls to
	// the chameleon bluetooth tester device.
	GetBluetoothTesterDevice() devices.ChameleonDevice

	// GetMotorBoardDevice returns an RPC interface for making RPC calls to the
	// chameleon motor board device.
	GetMotorBoardDevice() devices.ChameleonDevice

	// GetPrinterDevice returns an RPC interface for making RPC calls to the
	// chameleon printer device.
	GetPrinterDevice() devices.ChameleonDevice
}
...
func (c *CommonChameleond) HasDevice(ctx context.Context, deviceID PortID) (bool, error) {
	return c.RPC("HasDevice").Args(deviceID.ToInt()).CallForBool(ctx)
}
...
func (c *CommonChameleond) IsPhysicalPlugged(ctx context.Context, portID PortID) (bool, error) {
	return c.RPC("IsPhysicalPlugged").Args(portID.ToInt()).CallForBool(ctx)
}
...
func (c *CommonChameleond) GetConnectorType(ctx context.Context, portID PortID) (string, error) {
	return c.RPC("GetConnectorType").Args(portID.ToInt()).CallForString(ctx)
}
...
func (c *CommonChameleond) IsPlugged(ctx context.Context, portID PortID) (bool, error) {
	return c.RPC("IsPlugged").Args(portID.ToInt()).CallForBool(ctx)
}
...
func (c *CommonChameleond) Plug(ctx context.Context, portID PortID) error {
	return c.RPC("Plug").Args(portID.ToInt()).Call(ctx)
}
...
func (c *CommonChameleond) Unplug(ctx context.Context, portID PortID) error {
	return c.RPC("Unplug").Args(portID.ToInt()).Call(ctx)
}
...
func (c *CommonChameleond) HasAudioSupport(ctx context.Context, portID PortID) (bool, error) {
	return c.RPC("HasAudioSupport").Args(portID.ToInt()).CallForBool(ctx)
}
...
func (c *CommonChameleond) GetAudioChannelMapping(ctx context.Context, portID PortID) ([]int, error) {
	return c.RPC("GetAudioChannelMapping").Args(portID.ToInt()).CallForInts(ctx)
}
...
func (c *CommonChameleond) GetAudioFormat(ctx context.Context, portID PortID) (*AudioDataFormat, error) {
	formatMap := make(map[string]interface{})
	err := c.RPC("GetAudioFormat").Args(portID.ToInt()).Returns(&formatMap).Call(ctx)
	if err != nil {
		return nil, err
	}
...
func (c *CommonChameleond) StartCapturingAudio(ctx context.Context, portID PortID, hasFile bool) error {
	return c.RPC("StartCapturingAudio").Args(portID.ToInt(), hasFile).Call(ctx)
}
...
func (c *CommonChameleond) StopCapturingAudio(ctx context.Context, portID PortID) (path string, format AudioSampleFormat, err error) {
	...
	err = c.RPC("StopCapturingAudio").Args(portID.ToInt()).Returns(&path, &formatStr).Call(ctx)
	if err != nil {
		return "", "", err
	}
...
func (c *CommonChameleond) StartPlayingAudio(ctx context.Context, portID PortID, path string, format *AudioDataFormat) error {
	return c.RPC("StartPlayingAudio").Args(portID.ToInt(), path, format.ToMap()).Call(ctx)
}
...
func (c *CommonChameleond) StartPlayingEcho(ctx context.Context, portID, inputID PortID) error {
	return c.RPC("StartPlayingEcho").Args(portID.ToInt(), inputID.ToInt()).Call(ctx)
}
...
func (c *CommonChameleond) StopPlayingAudio(ctx context.Context, portID PortID) error {
	return c.RPC("StopPlayingAudio").Args(portID.ToInt()).Call(ctx)
}

// AudioBoardConnect calls the Chameleond RPC method of the same name.
// This implements Chameleond.AudioBoardConnect, see that for more details.
func (c *CommonChameleond) AudioBoardConnect(ctx context.Context, busNumber int, endpoint AudioBusEndpoint) error {
	return c.RPC("AudioBoardConnect").Args(busNumber, endpoint.ToString()).Call(ctx)
}

// AudioBoardDisconnect calls the Chameleond RPC method of the same name.
// This implements Chameleond.AudioBoardDisconnect, see that for more details.
func (c *CommonChameleond) AudioBoardDisconnect(ctx context.Context, busNumber int, endpoint AudioBusEndpoint) error {
	return c.RPC("AudioBoardDisconnect").Args(busNumber, endpoint.ToString()).Call(ctx)
}

// AudioBoardGetRoutes calls the Chameleond RPC method of the same name.
// This implements Chameleond.AudioBoardGetRoutes, see that for more details.
func (c *CommonChameleond) AudioBoardGetRoutes(ctx context.Context, busNumber int) ([]AudioBoardRoute, error) {
	var rawResult [][]interface{}
	err := c.RPC("AudioBoardGetRoutes").Args(busNumber).Call(ctx)
	if err != nil {
		return nil, err
	}
...
func (c *CommonChameleond) AudioBoardClearRoutes(ctx context.Context, busNumber int) error {
	return c.RPC("AudioBoardClearRoutes").Args(busNumber).Call(ctx)
}
...
func (c *CommonChameleond) SetUSBDriverPlaybackConfigs(ctx context.Context, playbackDataFormat *AudioDataFormat) error {
	return c.RPC("SetUSBDriverPlaybackConfigs").Args(playbackDataFormat.ToMap()).Call(ctx)
}
...
func (c *CommonChameleond) SetUSBDriverCaptureConfigs(ctx context.Context, captureDataFormat *AudioDataFormat) error {
	return c.RPC("SetUSBDriverCaptureConfigs").Args(captureDataFormat.ToMap()).Call(ctx)
}
...
func (c *CommonChameleond) TriggerLinkFailure(ctx context.Context, portID PortID) error {
	return c.RPC("TriggerLinkFailure").Args(portID.ToInt()).Call(ctx)
}
...
func (c *CommonChameleond) HasVideoSupport(ctx context.Context, portID PortID) (bool, error) {
	return c.RPC("HasVideoSupport").Args(portID.ToInt()).CallForBool(ctx)
}
...
func (c *CommonChameleond) SetVgaMode(ctx context.Context, portID PortID, mode string) error {
	return c.RPC("SetVgaMode").Args(portID.ToInt(), mode).Call(ctx)
}
...
func (c *CommonChameleond) WaitVideoInputStable(ctx context.Context, portID PortID, timeoutSeconds float64) (stableBeforeTimeout bool, err error) {
	return c.RPC("WaitVideoInputStable").Args(portID.ToInt(), timeoutSeconds).CallForBool(ctx)
}
...
func (c *CommonChameleond) SetDdcState(ctx context.Context, portID PortID, enabled bool) error {
	return c.RPC("SetDdcState").Args(portID.ToInt(), enabled).Call(ctx)
}
...
func (c *CommonChameleond) IsDdcEnabled(ctx context.Context, portID PortID) (bool, error) {
	return c.RPC("IsDdcEnabled").Args(portID.ToInt()).CallForBool(ctx)
}
...
func (c *CommonChameleond) ReadEdid(ctx context.Context, portID PortID) (edid []byte, err error) {
	return c.RPC("ReadEdid").Args(portID.ToInt()).CallForBytes(ctx)
}
...
func (c *CommonChameleond) ApplyEdid(ctx context.Context, portID PortID, edidID int) error {
	return c.RPC("ApplyEdid").Args(portID.ToInt(), edidID).Call(ctx)
}
...
func (c *CommonChameleond) UnplugHPD(ctx context.Context, portID PortID) error {
	return c.RPC("UnplugHPD").Args(portID.ToInt()).Call(ctx)
}
...
func (c *CommonChameleond) FireHpdPulse(ctx context.Context, portID PortID, deAssertIntervalMicroSec, assertIntervalMicroSec, repeatCount, endLevel int) error {
	return c.RPC("FireHpdPulse").Args(portID.ToInt(), deAssertIntervalMicroSec, assertIntervalMicroSec, repeatCount, endLevel).Call(ctx)
}
...
func (c *CommonChameleond) FireMixedHpdPulses(ctx context.Context, portID PortID, widthsMsec []int) error {
	return c.RPC("FireMixedHpdPulses").Args(portID.ToInt(), widthsMsec).Call(ctx)
}
...
func (c *CommonChameleond) ScheduleHpdToggle(ctx context.Context, portID PortID, delayMs int, risingEdge bool) error {
	return c.RPC("ScheduleHpdToggle").Args(portID.ToInt(), delayMs, risingEdge).Call(ctx)
}
...
func (c *CommonChameleond) SetContentProtection(ctx context.Context, portID PortID, enabled bool) error {
	return c.RPC("SetContentProtection").Args(portID.ToInt(), enabled).Call(ctx)
}
...
func (c *CommonChameleond) IsContentProtectionEnabled(ctx context.Context, portID PortID) (bool, error) {
	return c.RPC("IsContentProtectionEnabled").Args(portID.ToInt()).CallForBool(ctx)
}
...
func (c *CommonChameleond) IsVideoInputEncrypted(ctx context.Context, portID PortID) (bool, error) {
	return c.RPC("IsVideoInputEncrypted").Args(portID.ToInt()).CallForBool(ctx)
}
...
func (c *CommonChameleond) GetMaxFrameLimit(ctx context.Context, portID PortID, width, height int) (int, error) {
	return c.RPC("GetMaxFrameLimit").Args(portID.ToInt(), width, height).CallForInt(ctx)
}
...
func (c *CommonChameleond) DetectResolution(ctx context.Context, portID PortID) (width, height int, err error) {
	err = c.RPC("DetectResolution").Args(portID.ToInt()).Returns(&width, &height).Call(ctx)
	if err != nil {
		return 0, 0, err
	}
	return width, height, nil
...
func (c *CommonChameleond) GetVideoParams(ctx context.Context, portID PortID) (*VideoParams, error) {
	...
	err := c.RPC("GetVideoParams").Args(portID.ToInt()).Returns(paramsMap).Call(ctx)
	if err != nil {
		return nil, err
	}
...
func (c *CommonChameleond) GetLastInfoFrame(ctx context.Context, portID PortID, infoFrameType InfoFrameType) (version int, payload []byte, length int, err error) {
	err = c.RPC("GetLastInfoFrame").Args(portID.ToInt(), infoFrameType.ToString()).Returns(&version, &payload, &length).Call(ctx)
	if err != nil {
		return 0, nil, 0, err
	}
...
// GetAudioBoardDevice returns an RPC interface for making RPC calls to the
// chameleon audio board device.
func (c *CommonChameleond) GetAudioBoardDevice() devices.ChameleonDevice {
	return c.audioBoardDevice
}

// GetAVSyncProbeDevice returns an RPC interface for making RPC calls to the
// chameleon AV sync probe device.
func (c *CommonChameleond) GetAVSyncProbeDevice() devices.ChameleonDevice {
	return c.aVSyncProbeDevice
}

// GetBLEFastPair returns an RPC interface for making RPC calls to the
// chameleon bluetooth LE fast pair device.
func (c *CommonChameleond) GetBLEFastPair() bluetooth.FastPairPeripheral {
	return c.bLEFastPair
}

// GetBLEKeyboard returns an RPC interface for making RPC calls to the
// chameleon bluetooth LE keyboard device.
func (c *CommonChameleond) GetBLEKeyboard() bluetooth.KeyboardPeripheral {
	return c.bLEKeyboard
}

// GetBLEMouse returns an RPC interface for making RPC calls to the
// chameleon bluetooth LE mouse device.
func (c *CommonChameleond) GetBLEMouse() bluetooth.MousePeripheral {
	return c.bLEMouse
}

// GetBLEPhone returns an RPC interface for making RPC calls to the
// chameleon bluetooth LE phone device.
func (c *CommonChameleond) GetBLEPhone() bluetooth.PhonePeripheral {
	return c.bLEPhone
}

// GetBluetoothA2DPSink returns an RPC interface for making RPC calls to the
// chameleon bluetooth A2DP sink device.
func (c *CommonChameleond) GetBluetoothA2DPSink() devices.ChameleonDevice {
	return c.bluetoothA2DPSink
}

// GetBluetoothAudioDevice returns an XMLRPC interface for making XMLRPC calls
// to the chameleon bluetooth audio device.
func (c *CommonChameleond) GetBluetoothAudioDevice() bluetooth.AudioPeripheral {
	return c.bluetoothAudioDevice
}

// GetBluetoothBaseDevice returns an XMLRPC interface for making XMLRPC calls to
// the chameleon bluetooth base device.
func (c *CommonChameleond) GetBluetoothBaseDevice() bluetooth.BasePeripheral {
	return c.bluetoothBaseDevice
}

// GetBluetoothKeyboardDevice returns an XMLRPC interface for making XMLRPC
// calls to the chameleon bluetooth keyboard device.
func (c *CommonChameleond) GetBluetoothKeyboardDevice() bluetooth.KeyboardPeripheral {
	return c.bluetoothKeyboardDevice
}

// GetBluetoothMouseDevice returns an XMLRPC interface for making XMLRPC calls
// to the chameleon bluetooth mouse device.
func (c *CommonChameleond) GetBluetoothMouseDevice() bluetooth.MousePeripheral {
	return c.bluetoothMouseDevice
}

// GetBluetoothTesterDevice returns an XMLRPC interface for making XMLRPC calls
// to the chameleon bluetooth tester device.
func (c *CommonChameleond) GetBluetoothTesterDevice() devices.ChameleonDevice {
	return c.bluetoothTesterDevice
}

// GetMotorBoardDevice returns an XMLRPC interface for making XMLRPC calls to
// the chameleon motor board device.
func (c *CommonChameleond) GetMotorBoardDevice() devices.ChameleonDevice {
	return c.motorBoardDevice
}

// GetPrinterDevice returns an XMLRPC interface for making XMLRPC calls to the
// chameleon printer device.
func (c *CommonChameleond) GetPrinterDevice() devices.ChameleonDevice {
