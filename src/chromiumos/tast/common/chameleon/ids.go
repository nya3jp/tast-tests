...
// ToInt returns this PortID as an int.
func (p PortID) ToInt() int {
	return int(p)
}
...
// ToString returns this AudioFileType as a string.
func (aft AudioFileType) ToString() string {
	return string(aft)
}
...
// ToString returns this AudioSampleFormat as a string.
func (asf AudioSampleFormat) ToString() string {
	return string(asf)
}
...
// ToString returns this AudioBusEndpoint as a string.
func (abe AudioBusEndpoint) ToString() string {
	return string(abe)
}
...
// ToString returns this InfoFrameType as a string.
func (ift InfoFrameType) ToString() string {
	return string(ift)
}
