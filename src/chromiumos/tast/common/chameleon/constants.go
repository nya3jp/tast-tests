...
const (
	...
	FPGALineIn             AudioBusEndpoint = "Chameleon FPGA line-in"
	FPGALineOut            AudioBusEndpoint = "Chameleon FPGA line-out"
...
var SupportedAudioDataFormat = map[string]interface{}{
	"file_type":     Raw,
	"sample_format": S32LE,
	"channel":       8,
	"rate":          48000,
