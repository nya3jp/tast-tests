...
// rewrites a testing.Test literal in file with params. Otherwise, this function
// checks if parameterized test parameters in file matches with params, and if
// any mismatch is found, it reports a test error with a message prompting users
// to regenerate parameterized test parameters.
