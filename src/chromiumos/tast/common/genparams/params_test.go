...
func callEnsure(t *testing.T, code, params string) (errors []string, newCode string) {
	...
	var ft fakeTestingT
	// Return errors even if ft.Fatalf is called.
	defer func() {
		if recover() != nil {
			errors = ft.Errors
		}
	...
	os.Setenv(envName, "")
	Ensure(&ft, filename, params)

	// Second, call Ensure in the update mode.
	os.Setenv(envName, "1")
	Ensure(&fakeTestingT{}, filename, params)

	newBytes, err := ioutil.ReadFile(filename)
	if err != nil {
		t.Fatal(err)
	}
	return ft.Errors, string(newBytes)
}
...
func init() {
	testing.AddTest(&testing.Test{
		...
		Params: []testing.Param{
			// Parameters generated by code_test.go. DO NOT EDIT.
			{Name: "a", Val: 1},
			{Name: "b", Val: 2},
		},
	})
