...
func (p *Chaps) CreateCopiedKey(ctx context.Context, origKey *KeyInfo, objID string, attributes map[string]string) (*KeyInfo, string, error) {
	// Set the object ID.
...
func (p *Chaps) GetObjectAttribute(ctx context.Context, key *KeyInfo, objType, attributeName string) (string, string, error) {
...
func (p *Chaps) SetObjectAttribute(ctx context.Context, key *KeyInfo, objType, attributeName, attributeValue string) (string, error) {
	// Execute the command and convert its output.
