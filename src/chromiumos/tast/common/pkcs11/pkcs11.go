...
// ImportPrivateKeyBySlot creates a key by importing it from existing DER format private key file specified by opt.PrivKeyPath. The key will be inserted into the token specified by opt.Slot. The object will have an ID of ObjID.
