...
const (
	// Proto2PowerCycleFilename is the name of the script that power-cycles the proto2 board.
	Proto2PowerCycleFilename = "proto2-power-cycle.py"
...
const (
	// DeviceTypeDevboard is Santa proto2 board plugged using USB.
...
func EnsureLatestFirmware(hctx *HpsContext) error {
	...
	//
	// In order to update it manually run ./scripts/proto2-stage0-run in hps-firmware on gLinux box.
