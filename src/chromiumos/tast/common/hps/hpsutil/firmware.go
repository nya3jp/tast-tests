...
// GetRunningFirmwareVersion reads out the version of the firmware currently running on HPS.
//
// This assumes HPS is powered on and running in the application
// (that is, hpsd has finished enabling features).
func GetRunningFirmwareVersion(hctx *HpsContext) (int32, error) {
...
// GetFirmwareVersionFromImage determines the version of the firmware stored in
// the ChromeOS image running on the DUT.
func GetFirmwareVersionFromImage(hctx *HpsContext) (int32, error) {
