...
type HpsContext struct {
	Ctx context.Context
	// Script to power-cycle proto2 devboard.
	proto2PowerCycleFilename string
...
func NewHpsContext(ctx context.Context, proto2PowerCycleFilename string, deviceType DeviceType, outDir string, dutConn *ssh.Conn) (*HpsContext, error) {
	var device string
	switch deviceType {
	...
	return &HpsContext{
		Ctx:                      ctx,
		proto2PowerCycleFilename: proto2PowerCycleFilename,
		CmdNum:                   1,
		deviceType:               deviceType,
		Device:                   device,
		OutDir:                   outDir,
...
func (hctx *HpsContext) HpsContext(ctx context.Context, outDir string) *HpsContext {
	return &HpsContext{
		Ctx:                      ctx,
		proto2PowerCycleFilename: hctx.proto2PowerCycleFilename,
		CmdNum:                   1,
...
func (hctx *HpsContext) PowerCycle() error {
	...
	case DeviceTypeDevboard:
		...
		if err := RunWithLog(hctx, hctx.OutDir, "proto2-power-cycle", &hctx.CmdNum,
			"python", hctx.proto2PowerCycleFilename); err != nil {
			return err
		}
