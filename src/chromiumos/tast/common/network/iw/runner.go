...
func parseHT(attrs *sectionAttributes, sectionName, contents string) error {
...
func parseVHT(attrs *sectionAttributes, sectionName, contents string) error {
...
func parseHE(attrs *sectionAttributes, sectionName, contents string) error {
