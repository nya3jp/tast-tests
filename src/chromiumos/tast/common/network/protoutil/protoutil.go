...
// ShillValMapList is a type alias of map[string]*network.ListOfShillVals. It can be sent through protobuf.
type ShillValMapList map[string]*network.ListOfShillVals
...
// EncodeToShillValMapList converts a map that contains list of supported value type to protocol buffer network.ListOfShillVals.
func EncodeToShillValMapList(conf map[string][]interface{}) (ShillValMapList, error) {
	ret := make(ShillValMapList)
...
// DecodeFromShillValMapList converts a ShillValMapList to a (key, []value) map.
func DecodeFromShillValMapList(conf ShillValMapList) (map[string][]interface{}, error) {
	ret := make(map[string][]interface{})
