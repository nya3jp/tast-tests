...
//  }
//
// Remote usage example, in protocol buffer definition:
//  import "values.proto";
...
// for an example.
//
// Remote usage example, in service:
