...
// IsConnectState asserts that the property value of shillconst.ServicePropertyState is equal to one of the shillconst.ServiceConnectedStates.
func IsConnectState(value interface{}) bool {
