...
// ExpectHasAuthIntent checks whether the intents set contains the given value.
func ExpectHasAuthIntent(intents []uda.AuthIntent, expectedIntent uda.AuthIntent) error {
