...
const (
	...
	// SmallPNGFileName is the name of the small PNG file used for offline transfers.
	SmallPNGFileName = "small_png.zip"
	// SmallJPGFileName is the name of the small JPG file used for offline transfers.
