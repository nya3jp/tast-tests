...
type DefaultLaunchContainer struct {
	DefaultLaunchContainer DefaultLaunchContainer `json:"defaultLaunchContainer"`
}

func (p *DefaultLaunchContainer) MarshalJSON(orgunit string) ([]byte, error) {
	return marshalJSON(orgunit, "chrome.devices.managedguest.apps.DefaultLaunchContainer", p, []string{"defaultLaunchContainer"})
}
...
func (p *ManagedConfiguration) MarshalJSON(orgunit string) ([]byte, error) {
	return marshalJSON(orgunit, "chrome.devices.kiosk.apps.ManagedConfiguration", p, []string{})
}
...
func (p *InstallationUrl) MarshalJSON(orgunit string) ([]byte, error) {
	return marshalJSON(orgunit, "chrome.devices.kiosk.apps.InstallationUrl", p, []string{})
}
