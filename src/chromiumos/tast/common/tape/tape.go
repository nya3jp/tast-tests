...
// policyValue is part of the requests struct and holds the url to the PolicySchema and the values
// which should be set by the setPolicy call.
type policyValue struct {
	PolicySchema string      `json:"policySchema"`
	Value        interface{} `json:"value"`
}

// updateMask is part of the requests struct and holds names of the parameters which should be set.
