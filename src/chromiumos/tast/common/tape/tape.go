...
// marshalJSON creates a json wit a request to set a PolicySchema. It takes an orgunit string representing the orgunit
...
func RequestAccount(ctx context.Context, timeout time.Duration) (*Account, error) {
	...
	// Shorten the context to 30 seconds as the call should not take longer.
...
func (acc *Account) CleanUp(ctx context.Context) error {
	...
	// Shorten the context to 60 seconds as the call should not take longer.
