...
type Config struct {
	...
	// Parity is none, Stop bits is 1, Data bits is 8.
	// Added and pipe these through in OpenPort if needed.
}

// ConnectedPortOpener opens a directly connected port on the localhost.  In a
// dut context during remote bundle execution, the localhost is the dut.
