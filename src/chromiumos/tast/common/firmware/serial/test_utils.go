...
func createPTYPair(ctx context.Context, cmd iCmd) (s1, s2 string, cancel func(), done <-chan error, err error) {
...
func DoTestFlush(ctx context.Context, logf func(...interface{}), p1, p2 Port) error {
	...
	err = testing.Poll(ctx, func(ctx context.Context) error {
		...
		return err
	}, &testing.PollOptions{Timeout: 5 * time.Second, Interval: 10 * time.Millisecond})
	if err != nil {
