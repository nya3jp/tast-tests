...
func GBBFlagsStatesEqual(a, b pb.GBBFlagsState) bool {
	...
	return gbbflagsEqual(canonicalA.Clear, canonicalB.Clear) && gbbflagsEqual(canonicalA.Set, canonicalB.Set)
}
...
//gbbflagsEqual returns true if a and b are equal (have to be in the same order).
func gbbflagsEqual(a, b []pb.GBBFlag) bool {
