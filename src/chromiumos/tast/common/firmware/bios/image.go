...
const (
	...
	// DEVICEEXTENSIONImageSection is the DEVICE_EXTENSION section of the firmware.
	DEVICEEXTENSIONImageSection ImageSection = "DEVICE_EXTENSION"
	// UNUSEDHOLEImageSection is the UNUSED_HOLE section of the firmware.
	UNUSEDHOLEImageSection ImageSection = "UNUSED_HOLE"
	// IFWIImageSection is the IFWI section of the firmware.
	IFWIImageSection ImageSection = "IFWI"
	// FPFSTATUSImageSection is the FPF_STATUS section of the firmware.
	FPFSTATUSImageSection ImageSection = "FPF_STATUS"
	...
	// RWVARMRCCACHEImageSection is the RW_VAR_MRC_CACHE section of the firmware.
	RWVARMRCCACHEImageSection ImageSection = "RW_VAR_MRC_CACHE"
	...
	// MISCRWImageSection is the MISC_RW section of the firmware.
	MISCRWImageSection ImageSection = "MISC_RW"
	// BIOSUNUSABLEImageSection is the BIOS_UNUSABLE section of the firmware.
	BIOSUNUSABLEImageSection ImageSection = "BIOS_UNUSABLE"
	// RWPRESERVEImageSection is the RW_PRESERVE section of the firmware.
	RWPRESERVEImageSection ImageSection = "RW_PRESERVE"
	// VBLOCKDEVImageSection is the VBLOCK_DEV section of the firmware.
	VBLOCKDEVImageSection ImageSection = "VBLOCK_DEV"
...
var sectionToSectionEnum = map[ImageSection]pb.ImageSection{
	...
	FPFSTATUSImageSection:       pb.ImageSection_FPFSTATUSImageSection,
	DEVICEEXTENSIONImageSection: pb.ImageSection_DEVICEEXTENSIONImageSection,
	UNUSEDHOLEImageSection:      pb.ImageSection_UNUSEDHOLEImageSection,
	IFWIImageSection:            pb.ImageSection_IFWIImageSection,
	...
	RWVARMRCCACHEImageSection:    pb.ImageSection_RWVARMRCCACHEImageSection,
	...
	MISCRWImageSection:       pb.ImageSection_MISCRWImageSection,
	BIOSUNUSABLEImageSection: pb.ImageSection_BIOSUNUSABLEImageSection,
	RWPRESERVEImageSection:   pb.ImageSection_RWPRESERVEImageSection,
	VBLOCKDEVImageSection:    pb.ImageSection_VBLOCKDEVImageSection,
