...
func (p *BrowserGuestModeEnabled) SetProto(blob *Blob) {
	policyProtoValue := reflect.ValueOf(&blob.UserPolicies.BrowserGuestModeEnabled).Elem()
	SetUserPolicyProto(&policyProtoValue, p.Val)
}
...
func (p *BrowserAddPersonEnabled) SetProto(blob *Blob) {
	policyProtoValue := reflect.ValueOf(&blob.UserPolicies.BrowserAddPersonEnabled).Elem()
	SetUserPolicyProto(&policyProtoValue, p.Val)
}
...
func (p *OriginAgentClusterDefaultEnabled) SetProto(blob *Blob) {
	policyProtoValue := reflect.ValueOf(&blob.UserPolicies.OriginAgentClusterDefaultEnabled).Elem()
	SetUserPolicyProto(&policyProtoValue, p.Val)
}
...
func (p *DefaultWindowPlacementSetting) SetProto(blob *Blob) {
	policyProtoValue := reflect.ValueOf(&blob.UserPolicies.DefaultWindowPlacementSetting).Elem()
	SetUserPolicyProto(&policyProtoValue, p.Val)
}
...
func (p *WebHidAllowAllDevicesForUrls) SetProto(blob *Blob) {
	policyProtoValue := reflect.ValueOf(&blob.UserPolicies.WebHidAllowAllDevicesForUrls).Elem()
	SetUserPolicyProto(&policyProtoValue, p.Val)
}
...
func (p *WebHidAllowDevicesForUrls) SetProto(blob *Blob) {
	policyProtoValue := reflect.ValueOf(&blob.UserPolicies.WebHidAllowDevicesForUrls).Elem()
	SetUserPolicyProto(&policyProtoValue, p.Val)
}
...
func (p *WebHidAllowDevicesWithHidUsagesForUrls) SetProto(blob *Blob) {
	policyProtoValue := reflect.ValueOf(&blob.UserPolicies.WebHidAllowDevicesWithHidUsagesForUrls).Elem()
	SetUserPolicyProto(&policyProtoValue, p.Val)
}
...
func (p *SecondaryGoogleAccountUsage) SetProto(blob *Blob) {
	policyProtoValue := reflect.ValueOf(&blob.UserPolicies.SecondaryGoogleAccountUsage).Elem()
	SetUserPolicyProto(&policyProtoValue, p.Val)
}
...
func (p *FloatingWorkspaceEnabled) SetProto(blob *Blob) {
	policyProtoValue := reflect.ValueOf(&blob.UserPolicies.FloatingWorkspaceEnabled).Elem()
	SetUserPolicyProto(&policyProtoValue, p.Val)
}
...
func (p *WindowPlacementAllowedForUrls) SetProto(blob *Blob) {
	policyProtoValue := reflect.ValueOf(&blob.UserPolicies.WindowPlacementAllowedForUrls).Elem()
	SetUserPolicyProto(&policyProtoValue, p.Val)
}
...
func (p *WindowPlacementBlockedForUrls) SetProto(blob *Blob) {
	policyProtoValue := reflect.ValueOf(&blob.UserPolicies.WindowPlacementBlockedForUrls).Elem()
	SetUserPolicyProto(&policyProtoValue, p.Val)
}
...
func (p *CloudReportingUploadFrequency) SetProto(blob *Blob) {
	policyProtoValue := reflect.ValueOf(&blob.UserPolicies.CloudReportingUploadFrequency).Elem()
	SetUserPolicyProto(&policyProtoValue, p.Val)
}
...
func (p *OptimizationGuideFetchingEnabled) SetProto(blob *Blob) {
	policyProtoValue := reflect.ValueOf(&blob.UserPolicies.OptimizationGuideFetchingEnabled).Elem()
	SetUserPolicyProto(&policyProtoValue, p.Val)
}
...
func (p *WebAuthnFactors) SetProto(blob *Blob) {
	policyProtoValue := reflect.ValueOf(&blob.UserPolicies.WebAuthnFactors).Elem()
	SetUserPolicyProto(&policyProtoValue, p.Val)
}
...
func (p *WebAuthenticationRemoteProxiedRequestsAllowed) SetProto(blob *Blob) {
	policyProtoValue := reflect.ValueOf(&blob.UserPolicies.WebAuthenticationRemoteProxiedRequestsAllowed).Elem()
	SetUserPolicyProto(&policyProtoValue, p.Val)
}
