...
type UsageTimeLimitValueTimeUsageLimit struct {
	Friday    *RefTimeUsageLimitEntry `json:"friday,omitempty"`
	Monday    *RefTimeUsageLimitEntry `json:"monday,omitempty"`
	ResetAt   *RefTime                `json:"reset_at"`
	Saturday  *RefTimeUsageLimitEntry `json:"saturday,omitempty"`
	Sunday    *RefTimeUsageLimitEntry `json:"sunday,omitempty"`
	Thursday  *RefTimeUsageLimitEntry `json:"thursday,omitempty"`
	Tuesday   *RefTimeUsageLimitEntry `json:"tuesday,omitempty"`
	Wednesday *RefTimeUsageLimitEntry `json:"wednesday,omitempty"`
}
