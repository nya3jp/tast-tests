...
func setDeviceLocalAccountsProto(m *protoreflect.Message, policyName, fieldName string, val interface{}) {
	...
	for _, v := range deviceLocalAccountsInfoValue {
		deviceLocalAccountProto := enterprise_management_proto.DeviceLocalAccountInfoProto{}
		if v.AccountID != nil {
			deviceLocalAccountProto.AccountId = v.AccountID
		}
		if v.AccountType != nil {
			deviceLocalAccountProto.Type = &[]enterprise_management_proto.DeviceLocalAccountInfoProto_AccountType{enterprise_management_proto.DeviceLocalAccountInfoProto_AccountType(*v.AccountType)}[0]
		}
		...
		if v.AndroidKioskAppInfo != nil {
			androidKioskProto := enterprise_management_proto.AndroidKioskAppInfoProto{}
