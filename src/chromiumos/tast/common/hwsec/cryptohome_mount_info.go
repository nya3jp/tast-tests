...
func (c *CryptohomeMountInfo) validatePermanentPartition(p *disk.PartitionStat) bool {
	switch p.Fstype {
	case "ext4":
...
// user mount.
func (c *CryptohomeMountInfo) validateGuestPartition(p *disk.PartitionStat) bool {
	switch p.Fstype {
	case "ext4":
