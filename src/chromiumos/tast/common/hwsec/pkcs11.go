...
func Pkcs11CreateRsaSoftwareKey(ctx context.Context, r CmdRunner, u pkcs11Util, username string, keyname string, objID string) (Pkcs11KeyInfo, error) {
...
func Pkcs11CreateRsaGeneratedKey(ctx context.Context, r CmdRunner, u pkcs11Util, username string, keyname string, objID string) (Pkcs11KeyInfo, error) {
	// Locate chaps first.
	chapsPath := GetChapsCryptokiModule()
	if chapsPath == "" {
