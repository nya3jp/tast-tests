...
// UtilityTPMManagerClient wraps and the functions of TpmManagerBinary and parses the outputs to
// structured data.
type UtilityTPMManagerClient struct {
	binary *TpmManagerBinary
}

// NewUtilityTPMManagerClient creates a new UtilityTPMManagerClient.
func NewUtilityTPMManagerClient(r CmdRunner) (*UtilityTPMManagerClient, error) {
	binary, err := NewTpmManagerBinary(r)
	if err != nil {
		return nil, err
	}
	return &UtilityTPMManagerClient{binary}, nil
}
...
func (u *UtilityTPMManagerClient) DefineSpace(ctx context.Context, size int, bindToPCR0 bool, index string, attributes []string, password string) (string, error) {
...
// Will return nil for error iff the operation completes successfully. The string returned, msg, is the message from the command line, if any.
func (u *UtilityTPMManagerClient) DestroySpace(ctx context.Context, index string) (string, error) {
...
func (u *UtilityTPMManagerClient) WriteSpaceFromFile(ctx context.Context, index, inputFile, password string) (string, error) {
...
func (u *UtilityTPMManagerClient) ReadSpaceToFile(ctx context.Context, index, outputFile, password string) (string, error) {
...
func (u *UtilityTPMManagerClient) TakeOwnership(ctx context.Context) (string, error) {
...
func (u *UtilityTPMManagerClient) Status(ctx context.Context) (string, error) {
...
func (u *UtilityTPMManagerClient) GetNonsensitiveStatus(ctx context.Context) (info *NonsensitiveStatusInfo, returnedError error) {
...
func (u *UtilityTPMManagerClient) GetNonsensitiveStatusIgnoreCache(ctx context.Context) (info *NonsensitiveStatusInfo, returnedError error) {
...
func (u *UtilityTPMManagerClient) GetDAInfo(ctx context.Context) (info *DAInfo, returnedError error) {
...
func (u *UtilityTPMManagerClient) ResetDALock(ctx context.Context) (string, error) {
