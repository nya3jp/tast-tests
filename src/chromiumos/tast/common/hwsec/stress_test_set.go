...
type vaultController interface {
	...
	MountVault(ctx context.Context, username, password, label string, create bool) error

	// Checks the vault for |username|.
	CheckVault(ctx context.Context, username, password, label string) (bool, error)
