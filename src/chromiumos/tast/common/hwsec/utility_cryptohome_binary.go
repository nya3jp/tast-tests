...
func (u *UtilityCryptohomeBinary) InstallAttributesGet(ctx context.Context, attributeName string) (string, error) {
	out, err := u.proxy.InstallAttributesGet(ctx, attributeName)
	if err != nil {
...
func (u *UtilityCryptohomeBinary) InstallAttributesSet(ctx context.Context, attributeName string, attributeValue string) error {
	out, err := u.proxy.InstallAttributesSet(ctx, attributeName, attributeValue)
	if err != nil {
...
func (u *UtilityCryptohomeBinary) InstallAttributesFinalize(ctx context.Context) error {
	out, err := u.proxy.InstallAttributesFinalize(ctx)
	if err != nil {
...
func (u *UtilityCryptohomeBinary) InstallAttributesCount(ctx context.Context) (int, error) {
	out, err := u.proxy.InstallAttributesCount(ctx)
	if err != nil {
...
func (u *UtilityCryptohomeBinary) InstallAttributesIsReady(ctx context.Context) (bool, error) {
	out, err := u.proxy.InstallAttributesIsReady(ctx)
...
func (u *UtilityCryptohomeBinary) InstallAttributesIsSecure(ctx context.Context) (bool, error) {
	out, err := u.proxy.InstallAttributesIsSecure(ctx)
...
func (u *UtilityCryptohomeBinary) InstallAttributesIsInvalid(ctx context.Context) (bool, error) {
	out, err := u.proxy.InstallAttributesIsInvalid(ctx)
...
func (u *UtilityCryptohomeBinary) InstallAttributesIsFirstInstall(ctx context.Context) (bool, error) {
	out, err := u.proxy.InstallAttributesIsFirstInstall(ctx)
...
func (u *UtilityCryptohomeBinary) CreateVault(ctx context.Context, username string, password string) (bool, error) {
	_, err := u.binary.MountEx(ctx, username, password, true)
	if err != nil {
...
func (u *UtilityCryptohomeBinary) CheckVault(ctx context.Context, username string, password string) (bool, error) {
	_, err := u.binary.CheckKeyEx(ctx, username, password)
	if err != nil {
