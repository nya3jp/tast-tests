...
// InstallAttributesGet retrieve the install attributes with the name of |attributeName|, and returns the tuple (value, error), whereby |value| is the value of the attributes, and |error| is nil iff the operation is successful, otherwise |error| is the error that occurred.
...
// InstallAttributesSet set the install attributes with the name of |attributeName| with the value |attributeValue|, and returns |error|, whereby |error| is nill iff the operation is successful, otherwise |error| is the error that occurred.
