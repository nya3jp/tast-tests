...
// addCryptohomeRecoveryAuthFactor calls "cryptohome --action=add_auth_factor --recovery_mediator_pub_key=mediatorPubKeyHex".
func (c *cryptohomeBinary) addCryptohomeRecoveryAuthFactor(ctx context.Context, authSessionID, label, mediatorPubKeyHex string) ([]byte, error) {
...
// getRecoveryRequest calls "cryptohome --action=get_recovery_request --recovery_epoch_response=epochResponseHex".
func (c *cryptohomeBinary) getRecoveryRequest(ctx context.Context, authSessionID, label, epochResponseHex string) ([]byte, error) {
