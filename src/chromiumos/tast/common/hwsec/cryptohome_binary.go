...
func NewCryptohomeBinary(ctx context.Context, h *Helper) (*CryptohomeBinary, error) {
	return &CryptohomeBinary{ctx, h}, nil
}
...
func (c *CryptohomeBinary) callCryptohome(args ...string) ([]byte, error) {
	return c.helper.Run(c.ctx, "cryptohome", args...)
}
