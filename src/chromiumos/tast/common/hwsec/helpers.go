...
type Helper struct {
	cmdRunner        CmdRunner
	cryptohomeUtil   *UtilityCryptohomeClient
	tpmManagerUtil   *UtilityTPMManagerClient
	daemonController *DaemonController
}

// NewHelper creates a new Helper, with r responsible for CmdRunner.
func NewHelper(r CmdRunner) (*Helper, error) {
	cryptohomeUtil, err := NewUtilityCryptohomeClient(r)
	if err != nil {
		return nil, err
	}
	tpmManagerUtil, err := NewUtilityTPMManagerClient(r)
	if err != nil {
		return nil, err
	}
...
func (h *Helper) CryptohomeUtil() *UtilityCryptohomeClient { return h.cryptohomeUtil }

// TPMManagerUtil exposes the tpmManagerUtil of helper
func (h *Helper) TPMManagerUtil() *UtilityTPMManagerClient { return h.tpmManagerUtil }
