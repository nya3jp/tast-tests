...
func (h *helperImpl) CryptohomeClient() *CryptohomeClient { return h.cryptohome }

// TPMManagerClient exposes the tpmManager of helper
func (h *helperImpl) TPMManagerClient() *TPMManagerClient { return h.tpmManager }
...
func (h *helperImpl) AttestationClient() *AttestationClient { return h.attestation }
