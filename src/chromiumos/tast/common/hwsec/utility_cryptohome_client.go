...
// UtilityCryptohomeClient wraps and the functions of cryptohomeBinary and parses the outputs to
// structured data.
type UtilityCryptohomeClient struct {
...
// NewUtilityCryptohomeClient creates a new UtilityCryptohomeClient.
func NewUtilityCryptohomeClient(r CmdRunner) (*UtilityCryptohomeClient, error) {
	...
	return &UtilityCryptohomeClient{binary, cryptohomePathBinary, true}, nil
}
...
func (u *UtilityCryptohomeClient) GetStatusJSON(ctx context.Context) (map[string]interface{}, error) {
...
func (u *UtilityCryptohomeClient) IsTPMReady(ctx context.Context) (bool, error) {
...
func (u *UtilityCryptohomeClient) IsPreparedForEnrollment(ctx context.Context) (bool, error) {
	const waitForDBus = 15 * time.Second
...
func (u *UtilityCryptohomeClient) IsEnrolled(ctx context.Context) (bool, error) {
	const waitForDBus = 15 * time.Second
...
func (u *UtilityCryptohomeClient) EnsureOwnership(ctx context.Context) (bool, error) {
...
func (u *UtilityCryptohomeClient) CreateEnrollRequest(ctx context.Context, pcaType PCAType) (string, error) {
	return u.binary.tpmAttestationStartEnroll(ctx, pcaType, u.attestationAsyncMode)
}

// FinishEnroll handles enroll response.
func (u *UtilityCryptohomeClient) FinishEnroll(ctx context.Context, pcaType PCAType, resp string) error {
...
func (u *UtilityCryptohomeClient) CreateCertRequest(
	ctx context.Context,
	pcaType PCAType,
...
func (u *UtilityCryptohomeClient) FinishCertRequest(ctx context.Context, resp, username, label string) error {
...
func (u *UtilityCryptohomeClient) SignEnterpriseVAChallenge(
	ctx context.Context,
	vaType VAType,
	username,
	label,
...
func (u *UtilityCryptohomeClient) SignSimpleChallenge(
	ctx context.Context,
	username,
	label string,
	challenge []byte) (string, error) {
...
func (u *UtilityCryptohomeClient) GetPublicKey(
	ctx context.Context,
	username,
...
func (u *UtilityCryptohomeClient) getKeyStatus(
	ctx context.Context,
	username,
...
func (u *UtilityCryptohomeClient) InstallAttributesGet(ctx context.Context, attributeName string) (string, error) {
...
func (u *UtilityCryptohomeClient) InstallAttributesSet(ctx context.Context, attributeName, attributeValue string) error {
...
func (u *UtilityCryptohomeClient) InstallAttributesFinalize(ctx context.Context) error {
...
func (u *UtilityCryptohomeClient) InstallAttributesCount(ctx context.Context) (int, error) {
...
func (u *UtilityCryptohomeClient) InstallAttributesIsReady(ctx context.Context) (bool, error) {
...
func (u *UtilityCryptohomeClient) InstallAttributesIsSecure(ctx context.Context) (bool, error) {
...
func (u *UtilityCryptohomeClient) InstallAttributesIsInvalid(ctx context.Context) (bool, error) {
...
func (u *UtilityCryptohomeClient) InstallAttributesIsFirstInstall(ctx context.Context) (bool, error) {
...
func (u *UtilityCryptohomeClient) IsMounted(ctx context.Context) (bool, error) {
...
func (u *UtilityCryptohomeClient) Unmount(ctx context.Context, username string) (bool, error) {
...
func (u *UtilityCryptohomeClient) UnmountAll(ctx context.Context) error {
...
func (u *UtilityCryptohomeClient) MountVault(ctx context.Context, username, password, label string, create bool, config *VaultConfig) error {
	const (
...
func (u *UtilityCryptohomeClient) GetSanitizedUsername(ctx context.Context, username string, useDBus bool) (string, error) {
...
func (u *UtilityCryptohomeClient) GetSystemSalt(ctx context.Context, useDBus bool) (string, error) {
...
func (u *UtilityCryptohomeClient) CheckVault(ctx context.Context, username, password, label string) (bool, error) {
...
func (u *UtilityCryptohomeClient) ListVaultKeys(ctx context.Context, username string) ([]string, error) {
...
func (u *UtilityCryptohomeClient) AddVaultKey(ctx context.Context, username, password, label, newPassword, newLabel string, lowEntropy bool) error {
...
func (u *UtilityCryptohomeClient) RemoveVaultKey(ctx context.Context, username, password, removeLabel string) error {
...
func (u *UtilityCryptohomeClient) ChangeVaultPassword(ctx context.Context, username, password, label, newPassword string) error {
...
func (u *UtilityCryptohomeClient) RemoveVault(ctx context.Context, username string) (bool, error) {
...
func (u *UtilityCryptohomeClient) UnmountAndRemoveVault(ctx context.Context, username string) error {
...
func (u *UtilityCryptohomeClient) LockToSingleUserMountUntilReboot(ctx context.Context, username string) error {
...
func (u *UtilityCryptohomeClient) IsTPMWrappedKeySet(ctx context.Context, username string) (bool, error) {
...
func (u *UtilityCryptohomeClient) CheckTPMWrappedUserKeyset(ctx context.Context, user string) error {
...
func (u *UtilityCryptohomeClient) GetEnrollmentID(ctx context.Context) (string, error) {
...
func (u *UtilityCryptohomeClient) GetOwnerPassword(ctx context.Context) (string, error) {
	out, err := u.binary.tpmStatus(ctx)
	if err != nil {
...
func (u *UtilityCryptohomeClient) ClearOwnerPassword(ctx context.Context) error {
	_, err := u.binary.tpmClearStoredPassword(ctx)
	return err
}

// GetKeyPayload gets the payload associated with the specified key.
func (u *UtilityCryptohomeClient) GetKeyPayload(
	ctx context.Context,
	username,
	label string) (string, error) {
...
func (u *UtilityCryptohomeClient) SetKeyPayload(
	ctx context.Context,
	username,
	label,
...
func (u *UtilityCryptohomeClient) RegisterKeyWithChapsToken(
	ctx context.Context,
	username,
...
func (u *UtilityCryptohomeClient) SetAttestationAsyncMode(ctx context.Context, async bool) error {
	u.attestationAsyncMode = async
	return nil
}

// DeleteKeys delete all the |usernames|'s keys with label having prefix.
func (u *UtilityCryptohomeClient) DeleteKeys(ctx context.Context, username, prefix string) error {
...
func (u *UtilityCryptohomeClient) GetTokenInfoForUser(ctx context.Context, username string) (returnedLabel, returnedPin string, returnedSlot int, returnedErr error) {
	cmdOutput := ""
	if username == "" {
...
func (u *UtilityCryptohomeClient) GetTokenForUser(ctx context.Context, username string) (int, error) {
...
func (u *UtilityCryptohomeClient) WaitForUserToken(ctx context.Context, username string) error {
...
func (u *UtilityCryptohomeClient) GetFirmwareManagementParameters(ctx context.Context) (flags, hash string, returnedError *FWMPError) {
...
func (u *UtilityCryptohomeClient) SetFirmwareManagementParameters(ctx context.Context, flags, hash string) (string, error) {
...
// msg is the command line output from cryptohome command; error is nil iff the operation is successful.
func (u *UtilityCryptohomeClient) RemoveFirmwareManagementParameters(ctx context.Context) (string, error) {
...
func (u *UtilityCryptohomeClient) BackupFWMP(ctx context.Context) (*FirmwareManagementParametersInfo, error) {
...
func (u *UtilityCryptohomeClient) RestoreFWMP(ctx context.Context, fwmp *FirmwareManagementParametersInfo) error {
...
func (u *UtilityCryptohomeClient) GetAccountDiskUsage(ctx context.Context, username string) (diskUsage int64, returnedError error) {
...
func (u *UtilityCryptohomeClient) GetHomeUserPath(ctx context.Context, username string) (string, error) {
