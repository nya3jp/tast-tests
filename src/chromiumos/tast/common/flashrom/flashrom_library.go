...
const (
	V   VerbosityLevel = iota // low verbosity
	VV                        // medium verbosity
	VVV                       // high verbosity (the most verbose)
)
...
// WPStatus requests write-protect status of the chip
...
// ProbeAndWPStatus probes and requests write-protect status of the chip
...
// ProbeAndWPRegion probes and sets write-protect reqion on the chip
...
// ProbeAndWPToggle probes and toggles write-protect on the chip.
...
// ProbeAndWPEnableAndWPRange probes, enables write-protect and sets write-protect range on the chip
