...
2) Run Probe() method on the Builder to complete initialisation of your
    instance and probe the chip. Probe() method returns Instance which is
    ready to use.
 ...
 Instance instance := Builder
 	...
 	.SelectFile("tmp/dump.bin")
	.ProgrammerInit(Programmer.host, "")
	.Probe()

 retCode, err := instance.Read(ctx)
...
// SelectFile selects file to operate on
func (b *Builder) SelectFile(fileName string) (*Builder, error) {
	// TODO b:247668196 implement
...
func (i *Instance) Read(ctx context.Context) (int, error) {
	// TODO b:247668196 implement
...
func (i *Instance) Write(ctx context.Context, noverifyAll, noverify bool, flashcontentsImage string) (int, error) {
	// TODO b:247668196 implement
