...
func WPRegion(ctx context.Context, commonParams CommonParams, modParams ModificationParams, wpRegionName string) (int, error) {
	// TODO b:247668196 implement
...
func WPToggle(ctx context.Context, commonParams CommonParams, modParams ModificationParams, enable bool) (int, error) {
	// TODO b:247668196 implement
...
func WPEnableAndWPRange(ctx context.Context, commonParams CommonParams, modParams ModificationParams, wpRange string) (int, error) {
	// TODO b:247668196 implement
