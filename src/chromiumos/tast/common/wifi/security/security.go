...
type Config interface {
	...
	// Note that InstallRouterCredentials() may update some states and should be called
	// before HostapdConfig().
	...
	// Note that InstallClientCredentials() may update some states and should be called
	// before ShillServiceProperties().
