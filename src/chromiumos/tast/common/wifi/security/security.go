...
type Config interface {
	// Class returns the SecurityClass (defined in shill/service.go) of the WiFi service to configure.
	Class() string
...
// Noted that the creation of a Factory object must not emit an error to satisfy the
