...
func TestTPMID(t *testing.T) {
	for testi, test := range []struct {
		...
		{NewConfigFactory("A", serverCred(), FileSuffix("F"), TPMID("00")), false},
		{NewConfigFactory("A", serverCred(), FileSuffix("F"), TPMID("aA")), false},
		{NewConfigFactory("A", serverCred(), FileSuffix("F"), TPMID("FF")), false},
		{NewConfigFactory("A", serverCred(), FileSuffix("F"), TPMID("Af")), false},
		{NewConfigFactory("A", serverCred(), FileSuffix("F"), TPMID("0123456789abcdefABCDEF")), false},

		{NewConfigFactory("A", serverCred(), FileSuffix("F"), TPMID("1")), true},
		{NewConfigFactory("A", serverCred(), FileSuffix("F"), TPMID("123")), true},
		{NewConfigFactory("A", serverCred(), FileSuffix("F"), TPMID("zz")), true},
	} {
