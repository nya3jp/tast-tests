	...
	runTestGen(t, []testGenStruct{
		{
			...
			factory: NewConfigFactory(
				"chromeos",
				Mode(ModePureWPA),
				CiphersWPA(CipherTKIP, CipherCCMP),
				CiphersWPA2(CipherCCMP),
			),
			expected:   nil,
			...
			expected: &Config{
				PSK:            "chromeos",
				Mode:           ModeMixed,
				CiphersWPA:     []Cipher{CipherTKIP, CipherCCMP},
				CiphersWPA2:    []Cipher{CipherCCMP},
				FTMode:         FTModeNone,
				GMKRekeyPeriod: 86400,
				GTKRekeyPeriod: 86400,
				PTKRekeyPeriod: 600,
