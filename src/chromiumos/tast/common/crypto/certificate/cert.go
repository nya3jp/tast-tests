...
var testExpiredCert = Certificate{
	Cert: `-----BEGIN CERTIFICATE-----
...
// GetTestCertificate2 provides the certs generated with a different CA from GetTestCertificate.
// Both the private key and the Common Name of the CA are different.
func GetTestCertificate2() Certificate {
	return testCert2
}

// GetTestExpiredCertificate provides the certs generated with the same CA as GetTestCertificate but are expired.
// Note that it doesn't provide client cert/key.
func GetTestExpiredCertificate() Certificate {
	return testExpiredCert
}
