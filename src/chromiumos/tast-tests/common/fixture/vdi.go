...
// Fixtures defined in chromiumos/tast-tests/local/vdi/fixtures/vdi.go.
const (
...
// Fixtures defined in chromiumos/tast-tests/local/vdi/fixtures/vdi_msg.go.
const (
...
// Fixtures defined in chromiumos/tast-tests/local/vdi/fixtures/vdi_kiosk.go.
const (
