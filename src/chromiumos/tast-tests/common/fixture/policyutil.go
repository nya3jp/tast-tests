...
// Fixture defined in chromiumos/tast-tests/remote/policyutil/enrolled_fixture.go.
const (
	// Enrolled is a fixture name.
	Enrolled = "enrolled"
)

// Fixtures defined in chromiumos/tast-tests/local/policyutil/fixtures/fakedms.go.
const (
...
// Fixtures defined in chromiumos/tast-tests/local/policyutil/fixtures/chrome.go.
const (
...
// Fixtures defined in chromiumos/tast-tests/local/mgs/fixture.go.
const (
	ManagedGuestSession               = "managedGuestSession"
	ManagedGuestSessionWithExtensions = "managedGuestSessionWithExtensions"
)

// Fixtures defined in chromiumos/tast-tests/local/policyutil/fixtures/lacros.go.
const (
...
// Fixtures defined in chromiumos/tast-tests/local/policyutil/fixtures/persistent.go.
const (
