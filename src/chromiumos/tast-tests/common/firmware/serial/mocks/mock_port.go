...
// Source: chromiumos/tast-tests/common/firmware/serial (interfaces: Port)

// Package mocks is a generated GoMock package.
// CGO_ENABLED=0 GOPATH=/usr/lib/gopath:/mnt/host/source/src/platform/tast-tests:/mnt/host/source/src/platform/tast mockgen -destination=mock_port.go -self_package=chromiumos/tast-tests/common/firmware/serial/mocks -package mocks chromiumos/tast-tests/common/firmware/serial Port
package mocks
