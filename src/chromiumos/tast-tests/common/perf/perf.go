...
// src/chromiumos/tast-tests/common/perf/perfpb/ to the protoc command in your
// service's gen.go file. See src/chromiumos/tast-tests/services/cros/arc/gen.go
// for an example.
//
// Service:
//  import "chromiumos/tast-tests/common/perf"
//  import "chromiumos/tast-tests/common/perf/perfpb"
...
import (
	...
	"chromiumos/tast-tests/common/perf/perfpb"
