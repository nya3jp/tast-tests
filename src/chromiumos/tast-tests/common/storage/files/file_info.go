...
import (
	...
	"chromiumos/tast-tests/common/hwsec"
...
const (
	...
	// maxIterationData is the maximum amount of data in bytes to write in an iteration.
	maxIterationData = 10 * 1024 * 1024 // 10MiB

	// minIterationData is the minimum amount of data in bytes to write in an iteration.
	minIterationData = 32 * 1024 // 32 KiB
)
...
func (f *FileInfo) getIterationLength(iteration int) int {
	...
	result := int(math.Round(resultFloat))
	// Round it down to multiples of 32.
