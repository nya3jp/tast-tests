...
// ~/trunk/src/platform/tast/tools/go.sh test -count=1 chromiumos/tast-tests/local/bundles/...
// parameter regeneration can be done with
// TAST_GENERATE_UPDATE=1 ~/trunk/src/platform/tast/tools/go.sh test -count=1 chromiumos/tast-tests/local/bundles/...
//
