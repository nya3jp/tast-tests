...
import (
	...
	"chromiumos/tast-tests/local/kioskmode"
	"chromiumos/tast-tests/local/policyutil/fixtures"
	"chromiumos/tast-tests/local/uidetection"
	vdiApps "chromiumos/tast-tests/local/vdi/apps"
	"chromiumos/tast-tests/local/vdi/apps/citrix"
	"chromiumos/tast-tests/local/vdi/apps/vmware"
