...
import (
	...
	"chromiumos/tast-tests/local/crash"
	"chromiumos/tast-tests/local/disk"
	"chromiumos/tast-tests/local/faillog"
	hwseclocal "chromiumos/tast-tests/local/hwsec"
	"chromiumos/tast-tests/local/ready"
