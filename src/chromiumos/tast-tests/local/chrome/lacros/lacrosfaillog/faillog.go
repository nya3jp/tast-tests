...
import (
	...
	"chromiumos/tast-tests/local/chrome/lacros/lacrosinfo"
...
// For more, see https://chromium.googlesource.com/chromiumos/platform/tast-tests/+/refs/heads/main/src/chromiumos/tast-tests/local/chrome/uiauto/screen_recorder.go
