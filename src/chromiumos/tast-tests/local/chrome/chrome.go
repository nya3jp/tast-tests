...
import (
	...
	"chromiumos/tast-tests/local/chrome/ash/ashproc"
	"chromiumos/tast-tests/local/chrome/browser"
	"chromiumos/tast-tests/local/chrome/internal/cdputil"
	"chromiumos/tast-tests/local/chrome/internal/config"
	"chromiumos/tast-tests/local/chrome/internal/driver"
	"chromiumos/tast-tests/local/chrome/internal/extension"
	"chromiumos/tast-tests/local/chrome/internal/login"
	"chromiumos/tast-tests/local/chrome/internal/setup"
	"chromiumos/tast-tests/local/chrome/jslog"
	"chromiumos/tast-tests/local/cryptohome"
	"chromiumos/tast-tests/local/logsaver"
	"chromiumos/tast-tests/local/minidump"
...
var prePackages = []string{
	...
	"chromiumos/tast-tests/local/policyutil/pre",
	"chromiumos/tast-tests/local/bundles/cros/ui/cuj",
	"chromiumos/tast-tests/local/bundles/cros/inputs/fixture",
	"chromiumos/tast-tests/local/bundles/cros/inputs/pre",
	"chromiumos/tast-tests/local/bundles/crosint/arc",
	"chromiumos/tast-tests/local/bundles/crosint/pita/pre",
	"chromiumos/tast-tests/local/bundles/pita/pita/pre",
	"chromiumos/tast-tests/local/chrome",
	"chromiumos/tast-tests/local/chrome/crossdevice",
	"chromiumos/tast-tests/local/chrome/nearbyshare/nearbyfixture",
	"chromiumos/tast-tests/local/chrome/familylink",
	"chromiumos/tast-tests/local/chrome/mtp",
	"chromiumos/tast-tests/local/accountmanager",
	"chromiumos/tast-tests/local/crostini",
	"chromiumos/tast-tests/local/drivefs",
	"chromiumos/tast-tests/local/kioskmode/fixtures",
	"chromiumos/tast-tests/local/chrome/lacros/lacrosfixt",
	"chromiumos/tast-tests/local/multivm",
	"chromiumos/tast-tests/local/policyutil/fixtures",
	"chromiumos/tast-tests/local/policyutil/pre",
	"chromiumos/tast-tests/local/vdi/fixtures",
	"chromiumos/tast-tests/local/wpr",
}
