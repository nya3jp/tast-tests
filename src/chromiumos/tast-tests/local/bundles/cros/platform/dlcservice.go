...
import (
	...
	dlctest "chromiumos/tast-tests/local/bundles/cros/platform/dlc"
	"chromiumos/tast-tests/local/bundles/cros/platform/nebraska"
	"chromiumos/tast-tests/local/dlc"
