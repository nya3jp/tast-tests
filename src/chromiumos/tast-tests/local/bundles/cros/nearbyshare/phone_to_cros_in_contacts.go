...
import (
	...
	"chromiumos/tast-tests/common/android"
	nearbycommon "chromiumos/tast-tests/common/cros/nearbyshare"
	"chromiumos/tast-tests/local/chrome/nearbyshare"
	"chromiumos/tast-tests/local/chrome/nearbyshare/nearbyfixture"
	"chromiumos/tast-tests/local/chrome/nearbyshare/nearbysnippet"
	"chromiumos/tast-tests/local/chrome/nearbyshare/nearbytestutils"
	"chromiumos/tast-tests/local/chrome/uiauto/faillog"
	"chromiumos/tast-tests/local/chrome/uiauto/filesapp"
	"chromiumos/tast-tests/local/screenshot"
