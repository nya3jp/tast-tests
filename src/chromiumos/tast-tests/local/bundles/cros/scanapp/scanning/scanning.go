...
import (
	...
	"chromiumos/tast-tests/local/chrome/uiauto/scanapp"
	"chromiumos/tast-tests/local/printing/cups"
	"chromiumos/tast-tests/local/printing/document"
	"chromiumos/tast-tests/local/printing/ippusbbridge"
	"chromiumos/tast-tests/local/printing/usbprinter"
