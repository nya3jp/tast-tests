Bitstream file name: SREXT_A_FUJITSU_1.hevc

Bitstream feature name: 2 Monochrome SNR layers

Bitstream feature description:
2 Monochrome Layers coded with SNR scalability where layer 0 and layer 1 follow the Monochrome profile.
...
- OLS_1 -   Layer: 0, PTL Idx: 1 (Monochrome)
            Layer: 1, PTL Idx: 2 (Scalable Monochrome)
- DefaultTargetOutputLayerIdc   : 1

Profile, Tier, Level information: Num PTL = 3
- PTL_Idx 0 - Profile: MONOCHROME [Whole Bitstream PTL]
              Level: 4
- PTL_Idx 1 - Profile: MONOCHROME [Base layer PTL]
              Level: 4
- PTL_Idx 2 - Profile: SCALABLE MONOCHROME [Enhancement layer PTL]
              Level: 4
			
Each layer resolution:
- Layer 0 resolution - Output: 512x512, 8 bits, monochrome
                       Coded:  512x512, 8 bits
- Layer 1 resolution - Output: 512x512, 8 bits, monochrome
                       Coded:  512x512, 8 bits
