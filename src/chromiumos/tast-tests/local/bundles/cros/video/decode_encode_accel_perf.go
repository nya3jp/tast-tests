...
import (
	...
	"chromiumos/tast-tests/local/bundles/cros/video/encode"
	"chromiumos/tast-tests/local/bundles/cros/video/videovars"
	"chromiumos/tast-tests/local/chrome"
	"chromiumos/tast-tests/local/coords"
	"chromiumos/tast-tests/local/cpu"
	"chromiumos/tast-tests/local/gtest"
	mediacpu "chromiumos/tast-tests/local/media/cpu"
	"chromiumos/tast-tests/local/media/encoding"
	"chromiumos/tast-tests/local/media/videotype"
	"chromiumos/tast-tests/local/sysutil"
