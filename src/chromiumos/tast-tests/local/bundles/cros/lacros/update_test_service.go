...
import (
	...
	lacroscommon "chromiumos/tast-tests/common/cros/lacros"
	...
	"chromiumos/tast-tests/local/chrome/lacros/lacrosfaillog"
	"chromiumos/tast-tests/local/chrome/lacros/lacrosfixt"
	"chromiumos/tast-tests/local/chrome/lacros/lacrosproc"
	lacrosservice "chromiumos/tast-tests/services/cros/lacros"
