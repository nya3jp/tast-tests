...
import (
	...
	_ "chromiumos/tast-tests/local/bundles/cros/lacros/fixtures" // Include the speedometer specific lacros WPR fixture.
	"chromiumos/tast-tests/local/chrome"
	"chromiumos/tast-tests/local/chrome/ash"
	"chromiumos/tast-tests/local/chrome/browser"
	"chromiumos/tast-tests/local/chrome/lacros/lacrosperf"
