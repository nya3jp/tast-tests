...
import (
	...
	"chromiumos/tast-tests/common/action"
	"chromiumos/tast-tests/common/bond"
	"chromiumos/tast-tests/common/perf"
	...
	"chromiumos/tast-tests/local/chrome/lacros"
	"chromiumos/tast-tests/local/chrome/metrics"
	"chromiumos/tast-tests/local/chrome/uiauto"
	"chromiumos/tast-tests/local/chrome/uiauto/faillog"
	"chromiumos/tast-tests/local/chrome/uiauto/mouse"
	"chromiumos/tast-tests/local/chrome/uiauto/nodewith"
	"chromiumos/tast-tests/local/chrome/uiauto/pointer"
	"chromiumos/tast-tests/local/chrome/uiauto/role"
	"chromiumos/tast-tests/local/coords"
	"chromiumos/tast-tests/local/graphics"
	"chromiumos/tast-tests/local/hwsec"
	"chromiumos/tast-tests/local/input"
	"chromiumos/tast-tests/local/profiler"
	"chromiumos/tast-tests/local/ui/cujrecorder"
