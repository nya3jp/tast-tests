...
import (
	...
	"chromiumos/tast-tests/local/bundles/cros/ui/cuj/bluetooth"
	et "chromiumos/tast-tests/local/bundles/cros/ui/everydaymultitaskingcuj"
	"chromiumos/tast-tests/local/bundles/cros/ui/setup"
