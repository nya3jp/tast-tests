...
import (
	...
	"chromiumos/tast-tests/local/bundles/cros/network/dumputil"
	"chromiumos/tast-tests/local/bundles/cros/network/vpn"
	localping "chromiumos/tast-tests/local/network/ping"
