...
import (
	...
	"chromiumos/tast/rpc"
	"chromiumos/tast-tests/services/cros/baserpc"
	crashservice "chromiumos/tast-tests/services/cros/crash"
...
// See src/chromiumos/tast-tests/local/bundles/cros/platform/user_crash.go
