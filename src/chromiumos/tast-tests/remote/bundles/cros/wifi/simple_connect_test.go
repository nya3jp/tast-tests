...
// TAST_GENERATE_UPDATE=1 ~/trunk/src/platform/tast/tools/go.sh test -count=1 chromiumos/tast-tests/remote/bundles/cros/wifi
// To check only, run:
// ~/trunk/src/platform/tast/fast_build.sh -t chromiumos/tast-tests/remote/bundles/cros/wifi
