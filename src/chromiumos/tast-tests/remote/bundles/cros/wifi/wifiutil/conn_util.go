...
// Then, it deconfigs the AP and waits the AP disconnection event
// of the DUT without explicit disconnect call. The object path
// of connected service is returned.
