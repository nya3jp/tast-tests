...
import (
	...
	"chromiumos/tast-tests/remote/bundles/cros/camera/camerabox"
	"chromiumos/tast-tests/remote/bundles/cros/camera/pre"
	"chromiumos/tast/rpc"
	pb "chromiumos/tast-tests/services/cros/camerabox"
...
func init() {
	testing.AddTest(&testing.Test{
		...
		// src/platform/tast-tests/src/chromiumos/tast-tests/local/bundles/cros/camera/hal3_*.go
