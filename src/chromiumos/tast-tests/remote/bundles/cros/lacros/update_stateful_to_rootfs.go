...
import (
	...
	"chromiumos/tast-tests/remote/bundles/cros/lacros/provision"
	"chromiumos/tast-tests/remote/bundles/cros/lacros/update"
	lacrosupdate "chromiumos/tast-tests/remote/bundles/cros/lacros/update"
	"chromiumos/tast-tests/remote/bundles/cros/lacros/version"
	"chromiumos/tast/rpc"
