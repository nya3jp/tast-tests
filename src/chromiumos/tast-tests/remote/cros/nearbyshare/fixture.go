...
import (
	...
	"chromiumos/tast-tests/common/cros/nearbyshare"
...
func (f *nearbyShareFixture) SetUp(ctx context.Context, s *testing.FixtState) interface{} {
	...
	const (
		prebuiltLocalDataPath = "/usr/local/tast/data/chromiumos/tast-tests/remote/bundles/cros/nearbyshare/data"
		builtLocalDataPath    = "../platform/tast-tests/src/chromiumos/tast-tests/remote/bundles/cros/nearbyshare/data"
	)
