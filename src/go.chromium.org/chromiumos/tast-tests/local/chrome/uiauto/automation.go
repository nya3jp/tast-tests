...
// For more details, refer to https://source.chromium.org/chromiumos/chromiumos/codesearch/+/main:src/platform/tast-tests/src/go.chromium.org/chromiumos/tast-tests/local/chrome/useractions/README.md.
