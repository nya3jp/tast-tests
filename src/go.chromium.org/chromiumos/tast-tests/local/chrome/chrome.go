...
import (
	...
	"go.chromium.org/chromiumos/tast/caller"
	"go.chromium.org/chromiumos/tast/errors"
	"go.chromium.org/chromiumos/tast-tests/local/chrome/ash/ashproc"
	...
	"go.chromium.org/chromiumos/tast-tests/local/chrome/internal/login"
	"go.chromium.org/chromiumos/tast-tests/local/chrome/internal/setup"
	"go.chromium.org/chromiumos/tast-tests/local/chrome/jslog"
	"go.chromium.org/chromiumos/tast-tests/local/cryptohome"
	"go.chromium.org/chromiumos/tast-tests/local/logsaver"
	"go.chromium.org/chromiumos/tast-tests/local/minidump"
...
var prePackages = []string{
	...
	"go.chromium.org/chromiumos/tast-tests/local/mgs",
	"go.chromium.org/chromiumos/tast-tests/local/policyutil/pre",
	...
	"go.chromium.org/chromiumos/tast-tests/local/bundles/crosint/arc",
	"go.chromium.org/chromiumos/tast-tests/local/bundles/crosint/pita/pre",
	"go.chromium.org/chromiumos/tast-tests/local/bundles/pita/pita/pre",
	"go.chromium.org/chromiumos/tast-tests/local/chrome",
	"go.chromium.org/chromiumos/tast-tests/local/chrome/crossdevice",
	"go.chromium.org/chromiumos/tast-tests/local/chrome/nearbyshare/nearbyfixture",
	"go.chromium.org/chromiumos/tast-tests/local/chrome/familylink",
	"go.chromium.org/chromiumos/tast-tests/local/chrome/mtp",
	"go.chromium.org/chromiumos/tast-tests/local/accountmanager",
	"go.chromium.org/chromiumos/tast-tests/local/crostini",
	"go.chromium.org/chromiumos/tast-tests/local/drivefs",
	"go.chromium.org/chromiumos/tast-tests/local/kioskmode/fixtures",
	"go.chromium.org/chromiumos/tast-tests/local/chrome/lacros/lacrosfixt",
	"go.chromium.org/chromiumos/tast-tests/local/multivm",
	"go.chromium.org/chromiumos/tast-tests/local/policyutil/fixtures",
	"go.chromium.org/chromiumos/tast-tests/local/policyutil/pre",
	"go.chromium.org/chromiumos/tast-tests/local/vdi/fixtures",
