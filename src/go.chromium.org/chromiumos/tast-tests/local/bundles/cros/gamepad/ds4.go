...
import (
	...
	"go.chromium.org/chromiumos/tast-tests/local/bundles/cros/gamepad/dualshock"
	"go.chromium.org/chromiumos/tast-tests/local/bundles/cros/gamepad/jstest"
	"go.chromium.org/chromiumos/tast-tests/local/uhid"
