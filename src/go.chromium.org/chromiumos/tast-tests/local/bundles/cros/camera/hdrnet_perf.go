...
import (
	...
	"go.chromium.org/chromiumos/tast-tests/local/camera/features"
	camperf "go.chromium.org/chromiumos/tast-tests/local/camera/perf"
	"go.chromium.org/chromiumos/tast-tests/local/camera/testpage"
