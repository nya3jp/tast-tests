...
import (
	...
	"go.chromium.org/chromiumos/tast-tests/local/bundles/cros/dlp/clipboard"
	"go.chromium.org/chromiumos/tast-tests/local/bundles/cros/dlp/dragdrop"
	"go.chromium.org/chromiumos/tast-tests/local/bundles/cros/dlp/policy"
