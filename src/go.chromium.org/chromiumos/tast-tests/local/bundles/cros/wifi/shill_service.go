...
import (
	...
	network_iface "go.chromium.org/chromiumos/tast-tests/local/network/iface"
	local_ping "go.chromium.org/chromiumos/tast-tests/local/network/ping"
	"go.chromium.org/chromiumos/tast-tests/local/power"
	"go.chromium.org/chromiumos/tast-tests/local/shill"
	"go.chromium.org/chromiumos/tast-tests/local/upstart"
	"go.chromium.org/chromiumos/tast-tests/local/wpasupplicant"
