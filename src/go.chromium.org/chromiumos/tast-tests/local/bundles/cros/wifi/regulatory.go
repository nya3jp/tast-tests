...
import (
	...
	"go.chromium.org/chromiumos/tast-tests/local/bundles/cros/wifi/regdb"
	network_iface "go.chromium.org/chromiumos/tast-tests/local/network/iface"
	"go.chromium.org/chromiumos/tast-tests/local/network/iw"
	...
	"go.chromium.org/chromiumos/tast/testing/wlan"
)
