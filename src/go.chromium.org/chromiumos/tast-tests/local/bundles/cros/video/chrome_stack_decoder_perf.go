	...
	testing.AddTest(&testing.Test{
		...
		Params: []testing.Param{
			...
			},
			{
				...
				ExtraSoftwareDeps: []string{"autotest-capability:hw_dec_hevc_1080_30", "proprietary_codecs", "protected_content"},
			...
			},
			{
				...
				ExtraSoftwareDeps: []string{"autotest-capability:hw_dec_hevc_1080_60", "proprietary_codecs", "protected_content"},
			...
			},
			{
				...
				ExtraSoftwareDeps: []string{"autotest-capability:hw_dec_hevc_2160_30", "proprietary_codecs", "protected_content"},
			...
			},
			{
				...
				ExtraSoftwareDeps: []string{"autotest-capability:hw_dec_hevc_2160_60", "proprietary_codecs", "protected_content"},
			...
			},
			{
				...
				ExtraSoftwareDeps: []string{"autotest-capability:hw_dec_hevc_1080_60", "proprietary_codecs", "protected_content", "thread_safe_libva_backend"},
				ExtraData:         []string{"perf/hevc/1080p_60fps_600frames.hevc", "perf/hevc/1080p_60fps_600frames.hevc.json"},
				ExtraAttr:         []string{"graphics_video_decodeaccel"},
			},
			{
