...
import (
	...
	"go.chromium.org/chromiumos/tast-tests/local/audio/crastestclient"
	"go.chromium.org/chromiumos/tast-tests/local/bundles/cros/ui/cuj"
	"go.chromium.org/chromiumos/tast-tests/local/bundles/cros/ui/windowarrangementcuj"
...
func WindowArrangementCUJ(ctx context.Context, s *testing.State) {
	...
	if !tabletMode {
		f = func(ctx context.Context) error {
			return windowarrangementcuj.RunClamShell(ctx, closeCtx, conns.TestConn, ui, pc, conns.ARCUI, conns.ArcVideoActivity, conns.WithTestVideo)
		}
	} else {
		f = func(ctx context.Context) error {
			return windowarrangementcuj.RunTablet(ctx, closeCtx, conns.TestConn, ui, pc, conns.ARCUI, conns.ArcVideoActivity, conns.WithTestVideo)
		}
	}
