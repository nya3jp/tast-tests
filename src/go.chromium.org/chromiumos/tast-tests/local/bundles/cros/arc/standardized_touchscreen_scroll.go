...
import (
	...
	"go.chromium.org/chromiumos/tast-tests/local/bundles/cros/arc/standardizedtestutil"
...
func runStandardizedTouchScreenScrollTest(ctx context.Context, testParameters standardizedtestutil.TestFuncParams) error {
	touchScreen, err := standardizedtestutil.NewStandardizedTouchscreen(ctx, testParameters.TestConn)
	if err != nil {
