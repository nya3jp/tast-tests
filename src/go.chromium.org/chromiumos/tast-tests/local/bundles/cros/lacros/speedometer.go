...
import (
	...
	_ "go.chromium.org/chromiumos/tast-tests/local/bundles/cros/lacros/fixtures" // Include the speedometer specific lacros WPR fixture.
	...
	"go.chromium.org/chromiumos/tast-tests/local/chrome/lacros/lacrosperf"
