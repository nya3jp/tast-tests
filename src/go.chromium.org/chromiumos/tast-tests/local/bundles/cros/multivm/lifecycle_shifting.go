...
import (
	...
	"go.chromium.org/chromiumos/tast-tests/local/memory"
	"go.chromium.org/chromiumos/tast-tests/local/memory/kernelmeter"
	"go.chromium.org/chromiumos/tast-tests/local/memory/memoryuser"
	"go.chromium.org/chromiumos/tast-tests/local/memory/metrics"
