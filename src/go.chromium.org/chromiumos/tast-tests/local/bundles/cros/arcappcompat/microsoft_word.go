...
var clamshellLaunchForMicrosoftWord = []testutil.TestCase{
...
var touchviewLaunchForMicrosoftWord = []testutil.TestCase{
	...
	testing.AddTest(&testing.Test{
		...
		Params: []testing.Param{{
			...
			Val: testutil.TestParams{
				LaunchTests: clamshellLaunchForMicrosoftWord,
			...
			Name: "tablet_mode",
			Val: testutil.TestParams{
				LaunchTests: touchviewLaunchForMicrosoftWord,
		...
		VarDeps: []string{"arcappcompat.MicrosoftWord.emailid", "arcappcompat.MicrosoftWord.password"},
	})
}
