...
var clamshellLaunchForSpreakerStudio = []testutil.TestCase{
...
var touchviewLaunchForSpreakerStudio = []testutil.TestCase{
	...
	testing.AddTest(&testing.Test{
		...
		Params: []testing.Param{{
			...
			Val: testutil.TestParams{
				LaunchTests: clamshellLaunchForSpreakerStudio,
			...
			Name: "tablet_mode",
			Val: testutil.TestParams{
				LaunchTests: touchviewLaunchForSpreakerStudio,
		...
		VarDeps: []string{"arcappcompat.SpreakerStudio.emailid", "arcappcompat.SpreakerStudio.password"},
	})
}
