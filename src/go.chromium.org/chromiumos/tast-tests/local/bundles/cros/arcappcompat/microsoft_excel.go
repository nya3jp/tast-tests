...
var clamshellLaunchForMicrosoftExcel = []testutil.TestCase{
...
var touchviewLaunchForMicrosoftExcel = []testutil.TestCase{
	...
	testing.AddTest(&testing.Test{
		...
		Params: []testing.Param{{
			...
			Val: testutil.TestParams{
				LaunchTests: clamshellLaunchForMicrosoftExcel,
			...
			Name: "tablet_mode",
			Val: testutil.TestParams{
				LaunchTests: touchviewLaunchForMicrosoftExcel,
		...
		VarDeps: []string{"arcappcompat.MicrosoftExcel.emailid", "arcappcompat.MicrosoftExcel.password"},
	})
}
