...
import (
	...
	"go.chromium.org/chromiumos/tast-tests/common/android/ui"
	"go.chromium.org/chromiumos/tast-tests/local/arc"
	"go.chromium.org/chromiumos/tast-tests/local/bundles/cros/arcappcompat/pre"
	"go.chromium.org/chromiumos/tast-tests/local/bundles/cros/arcappcompat/testutil"
...
// clamshellLaunchForOneTwoThreeNumbers launches OneTwoThreeNumbers in clamshell mode.
var clamshellLaunchForOneTwoThreeNumbers = []testutil.TestCase{
	{Name: "Launch app in Clamshell", Fn: launchAppForOneTwoThreeNumbers},
}

// touchviewLaunchForOneTwoThreeNumbers launches OneTwoThreeNumbers in tablet mode.
var touchviewLaunchForOneTwoThreeNumbers = []testutil.TestCase{
	{Name: "Launch app in Touchview", Fn: launchAppForOneTwoThreeNumbers},
}
	...
	testing.AddTest(&testing.Test{
		...
		Params: []testing.Param{{
			...
			Val: testutil.TestParams{
				LaunchTests: clamshellLaunchForOneTwoThreeNumbers,
			...
			Name: "tablet_mode",
			Val: testutil.TestParams{
				LaunchTests: touchviewLaunchForOneTwoThreeNumbers,
...
// OneTwoThreeNumbers test uses library for opting into the playstore and installing app.
// Checks OneTwoThreeNumbers correctly changes the window states in both clamshell and touchview mode.
func OneTwoThreeNumbers(ctx context.Context, s *testing.State) {
	const (
		appPkgName  = "com.rvappstudios.numbers123.toddler.counting.tracing"
...
// launchAppForOneTwoThreeNumbers verifies OneTwoThreeNumbers reached main activity page of the app.
func launchAppForOneTwoThreeNumbers(ctx context.Context, s *testing.State, tconn *chrome.TestConn, a *arc.ARC, d *ui.Device, appPkgName, appActivity string) {
	const (
