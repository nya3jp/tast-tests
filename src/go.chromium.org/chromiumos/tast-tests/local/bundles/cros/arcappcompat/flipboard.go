	...
	testing.AddTest(&testing.Test{
		...
		Params: []testing.Param{{
			...
			Val: testutil.TestParams{
				LaunchTests: clamshellLaunchForFlipboard,
			...
			Name: "tablet_mode",
			Val: testutil.TestParams{
				LaunchTests: touchviewLaunchForFlipboard,
		...
		VarDeps: []string{"arcappcompat.Flipboard.username", "arcappcompat.Flipboard.password"},
	})
}
