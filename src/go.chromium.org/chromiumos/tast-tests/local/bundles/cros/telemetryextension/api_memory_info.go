...
import (
	...
	"go.chromium.org/chromiumos/tast-tests/local/bundles/cros/telemetryextension/dep"
	"go.chromium.org/chromiumos/tast-tests/local/bundles/cros/telemetryextension/fixture"
