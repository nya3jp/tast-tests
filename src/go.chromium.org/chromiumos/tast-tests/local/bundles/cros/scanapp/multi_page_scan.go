...
import (
	...
	"go.chromium.org/chromiumos/tast-tests/local/bundles/cros/scanapp/scanning"
	...
	"go.chromium.org/chromiumos/tast-tests/local/chrome/uiauto/scanapp"
	"go.chromium.org/chromiumos/tast-tests/local/printing/cups"
	"go.chromium.org/chromiumos/tast-tests/local/printing/document"
	"go.chromium.org/chromiumos/tast-tests/local/printing/ippusbbridge"
	"go.chromium.org/chromiumos/tast-tests/local/printing/usbprinter"
