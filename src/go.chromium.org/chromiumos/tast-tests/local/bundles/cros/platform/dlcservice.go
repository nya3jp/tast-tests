...
import (
	...
	dlctest "go.chromium.org/chromiumos/tast-tests/local/bundles/cros/platform/dlc"
	"go.chromium.org/chromiumos/tast-tests/local/bundles/cros/platform/nebraska"
	"go.chromium.org/chromiumos/tast-tests/local/dlc"
