...
import (
	...
	vdiApps "go.chromium.org/chromiumos/tast-tests/local/vdi/apps"
	"go.chromium.org/chromiumos/tast-tests/local/vdi/apps/citrix"
	"go.chromium.org/chromiumos/tast-tests/local/vdi/apps/vmware"
