...
// The most of the frame implementation is in go.chromium.org/chromiumos/tast/bundle package,
...
import (
	...
	"go.chromium.org/chromiumos/tast/bundle"
	...
	"go.chromium.org/chromiumos/tast-tests/local/disk"
	"go.chromium.org/chromiumos/tast-tests/local/faillog"
	hwseclocal "go.chromium.org/chromiumos/tast-tests/local/hwsec"
	"go.chromium.org/chromiumos/tast-tests/local/ready"
