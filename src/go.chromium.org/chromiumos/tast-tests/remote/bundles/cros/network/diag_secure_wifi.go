...
import (
	...
	"go.chromium.org/chromiumos/tast-tests/common/crypto/certificate"
	"go.chromium.org/chromiumos/tast-tests/common/network/diag"
	...
	"go.chromium.org/chromiumos/tast-tests/common/wifi/security/dynamicwep"
	"go.chromium.org/chromiumos/tast-tests/common/wifi/security/wep"
	"go.chromium.org/chromiumos/tast-tests/common/wifi/security/wpa"
	...
	"go.chromium.org/chromiumos/tast-tests/services/cros/network"
