...
import (
	...
	"go.chromium.org/chromiumos/tast-tests/remote/bundles/cros/lacros/update"
	lacrosupdate "go.chromium.org/chromiumos/tast-tests/remote/bundles/cros/lacros/update"
