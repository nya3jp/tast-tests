...
import (
	...
	crashservice "go.chromium.org/chromiumos/tast-tests/services/cros/crash"
...
// See src/go.chromium.org/chromiumos/tast-tests/local/bundles/cros/platform/user_crash.go
