...
import (
	...
	common "go.chromium.org/chromiumos/tast-tests/common/firmware"
	commonbios "go.chromium.org/chromiumos/tast-tests/common/firmware/bios"
	"go.chromium.org/chromiumos/tast-tests/common/servo"
	"go.chromium.org/chromiumos/tast-tests/remote/firmware/bios"
	"go.chromium.org/chromiumos/tast-tests/remote/firmware/fixture"
	pb "go.chromium.org/chromiumos/tast-tests/services/cros/firmware"
