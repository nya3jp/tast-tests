...
import (
	...
	"go.chromium.org/chromiumos/tast-tests/remote/bundles/cros/camera/camerabox"
	"go.chromium.org/chromiumos/tast-tests/remote/bundles/cros/camera/pre"
	"go.chromium.org/chromiumos/tast/rpc"
	pb "go.chromium.org/chromiumos/tast-tests/services/cros/camerabox"
...
func init() {
	testing.AddTest(&testing.Test{
		...
		// src/platform/tast-tests/src/go.chromium.org/chromiumos/tast-tests/local/bundles/cros/camera/hal3_*.go
