...
import (
	...
	"go.chromium.org/chromiumos/tast-tests/remote/bundles/cros/meta/tastrun"
		...
		Params: []testing.Param{{
			...
			Val: runTestsParam{
				...
				wantFiles: map[string]string{
					...
					"fixtures/metaLocalDataFilesFixture/fixture_data_internal.txt": "This is an internal data file.\n",
