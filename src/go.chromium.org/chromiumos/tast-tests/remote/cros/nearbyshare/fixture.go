...
import (
	...
	"go.chromium.org/chromiumos/tast-tests/common/cros/nearbyshare"
	...
	"go.chromium.org/chromiumos/tast-tests/services/cros/nearbyservice"
...
func (f *nearbyShareFixture) SetUp(ctx context.Context, s *testing.FixtState) interface{} {
	...
	const (
		prebuiltLocalDataPath = "/usr/local/tast/data/go.chromium.org/chromiumos/tast-tests/remote/bundles/cros/nearbyshare/data"
		builtLocalDataPath    = "../platform/tast-tests/src/go.chromium.org/chromiumos/tast-tests/remote/bundles/cros/nearbyshare/data"
	)
