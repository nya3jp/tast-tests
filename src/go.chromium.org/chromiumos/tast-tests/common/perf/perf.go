...
// src/go.chromium.org/chromiumos/tast-tests/common/perf/perfpb/ to the protoc command in your
// service's gen.go file. See src/go.chromium.org/chromiumos/tast-tests/services/cros/arc/gen.go
// for an example.
//
// Service:
//  import "go.chromium.org/chromiumos/tast-tests/common/perf"
//  import "go.chromium.org/chromiumos/tast-tests/common/perf/perfpb"
...
import (
	...
	"go.chromium.org/chromiumos/tast-tests/common/perf/perfpb"
